为方便PHP开发者调试和接入云API， 我们提供了基于PHP的SDK。

Github地址：https://github.com/QcloudApi/qcloudapi-sdk-php
...
2) [下载SDK](https://github.com/QcloudApi/qcloudapi-sdk-php)，放入到您的程序目录。详细使用方法请参考下面的示例。
