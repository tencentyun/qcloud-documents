为方便.NET开发者调试和接入云API， 我们提供了基于.NET的SDK。

Github地址：https://github.com/QcloudApi/qcloudapi-sdk-dotnet
...
2) [下载SDK](https://github.com/QcloudApi/qcloudapi-sdk-dotnet)，放入到您的程序目录。详细使用方法请参考下面的示例。
