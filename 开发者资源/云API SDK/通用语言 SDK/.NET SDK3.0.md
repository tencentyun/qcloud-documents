...
本文以云服务器查询实例列表接口为例，介绍 SDK 的基础用法。开发者可以在 GitHub 仓库中 [TencentCloudExamples 目录](https://github.com/TencentCloud/tencentcloud-sdk-dotnet/tree/master/TencentCloudExamples) 下查看更多更详细的示例。
