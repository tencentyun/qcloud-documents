...
| secretKey | 否   | String | 待更换的密钥key，更新自定义密钥时，该字段为必传。长度 10-50 字符 字母数字 英文下划线。 | 

*注意：
secretKey 更换自定义密钥时填写，若您是自动生成的密钥不需要填写此字段，若在创建时是自定义密钥，请确认您已开通白名单，开通可联系您的客户经理或 提交工单（https://console.cloud.tencent.com/workorder/category） 申请开启
