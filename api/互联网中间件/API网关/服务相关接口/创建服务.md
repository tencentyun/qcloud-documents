...
## 接口描述
	...
	API网关使用的最大单元为服务，每个服务中可创建多个API接口。每个服务有一个默认域名供客户调用，客户也可绑定自定义域名到此服务中，此接口用于创建服务。
...
| protocol    | 是 |     String  | 服务的前端请求类型。如http、https、http和https。 |
...
| serviceId   | String    | 服务唯一Id，由系统生成，全局唯一。                       |
