...
本接口 (GetTopicAttributes) 用于在用户获取 MQ IoT 实例的主题属性。
...
| maxMsgSize | Int | 单条消息的最大长度，单位 Byte |
...
```
 https://domain/v2/index.php?Action=GetTopicAttributes&instanceId=mqtt-xxooa0&topicName=topictest&<公共请求参数>
```
