...
|strategyWeight | 否 |	String |	按权重回源。源站仅允许配置 IP，且 Key 值与“origin” 字段配置源站相同，value 为权重，权重范围1 - 100，示例：{"1.1.1.1:8080":10,"2.2.2.2":20} 。|
|backupOrigin | 否 | String	|备份源站。仅支持一主一备，且备份源站仅允许配置 IP，示例：["1.2.3.4:8080"]。 |
