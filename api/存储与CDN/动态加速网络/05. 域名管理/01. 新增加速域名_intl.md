...
|origin| Yes | String | Origin server address. You can configure a domain name or multiple origin server IPs (supported format: 'domain name: port' or 'ip:port'). The port number should be between 0 and 65535, and multiple IPs are separated with semicolons. |
