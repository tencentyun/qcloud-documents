...
>- 未指定查询目标时，默认按账号维度统计带宽数据；  
>- 当指定查询项目列表时，按项目维度统计带宽数据；
>- 当指定查询域名列表时，按域名维度统计带宽数据；
...
## 示例二 按项目维度查询 
### 查询需求说明 
同时查询两个项目在2018-04-19的峰值带宽，项目ID分别为100873和1006363。
### GET 请求
...
## 示例三 按域名维度查询 
### 查询需求说明 
查询域名dsa.test.qcloud.com 2018-04-19的带宽监控数据，查询时间粒度5分钟。
### GET 请求
