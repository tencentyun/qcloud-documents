...
| 2-7天 |  15 | 15,30,60,120,240,1440 |
| 7| 30 | 30,60,120,240,1440 |
...
|参数名称|类型|描述|
|------ | ----------| ----------|
|code|Int|公共错误码</br>0 表示成功，其他值表示失败</br>详见错误码页面的 [公共错误码](https://cloud.tencent.com/document/product/570/13937 "点击查看公共错误码")。|
