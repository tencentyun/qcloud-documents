...
## 2. 输入参数###
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上[公共请求参数](https://cloud.tencent.com/doc/api/231/4473 "点击查看公共请求参数")，见公共请求参数页面。其中，此接口的Action字段为GetDsaHostList。   
...
###4.2 GET请求
	...
	https//openapi.dsa.tencentyun.com/interface.php?
        	...
        	"hosts": [
        	    {
            	    ...
            	    "project_id": 0,
            	    "host": "www.test1.com",
            	    "cname": "www.test1.com.dsa.dnsv1.com",
            	    "status": "online",
					"deleted": 0,
            	    "message": ""
            	},
            	{
            	    ...
            	    "project_id": 0,
            	    "host": "www.test2.com",
            	    "cname": "www.test2.com.dsa.dnsv1.com",
            	    "status": "offline",
            	    "deleted": 0,
            	    "message": ""
            	}
