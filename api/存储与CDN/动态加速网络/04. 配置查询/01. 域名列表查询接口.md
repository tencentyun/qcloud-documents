...
## 输入参数
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上 [公共请求参数](https://cloud.tencent.com/document/product/570/13932)，见公共请求参数页面。其中，此接口的Action字段为GetDsaHostList。   
...
|参数名称|类型|描述|
|------ | -----| -----| 
|hosts|Array|域名详细信息数组，详细字段见下文 [hosts 字段说明](#hostsinfo)|
|total|Int|账户下域名总数|
