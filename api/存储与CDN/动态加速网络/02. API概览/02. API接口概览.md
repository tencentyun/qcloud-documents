...
|查询Https域名列表 | [GetDsaHttpsHostList](https://cloud.tencent.com/document/product/570/17907)  | 获取客户账号下所有开启Https加速功能的域名列表     |
...
|接口名称|Action Name|功能描述|
|----|----|----|
| 访问日志下载链接查询接口 | [GetDsaHostLogs](https://cloud.tencent.com/document/product/570/16836) | 查询DSA用户访问日志下载链接  |