...
```
Action=GetDsaHostList&Nonce=13029&SecretId=AKIDT8G5**********ooNq1rFSw1fyBVCX9D &Timestamp=1463122059&length=10&offset=0
```
...
```
GETdsa.api.qcloud.com/v2/index.php?Action=GetDsaHostList&Nonce=13029&SecretId=AKIDT8G5**********ooNq1rFSw1fyBVCX9D&Timestamp=1463122059&length=10&offset=0
```

若为 POST 请求，示例的拼接结果为：

```
POSTdsa.api.qcloud.com/v2/index.php?Action=GetDsaHostList&Nonce=13029&SecretId=AKIDT8G5**********ooNq1rFSw1fyBVCX9D&Timestamp=1463122059&offset=0
```
...
```
$secretKey = 'pxPgRWD******qBTDk7WmeRZSmPco0';
$srcStr = 'GETdsa.api.qcloud.com/v2/index.php?Action=GetDsaHostList&Nonce=13029&SecretId=AKIDT8G5**********ooNq1rFSw1fyBVCX9D&Timestamp=1463122059&length=10&offset=0';
