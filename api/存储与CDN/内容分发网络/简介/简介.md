...
<p>基于 API 2.0 接口访问时延较高和使用复杂的考虑，我们将于北京时间2022年11月30日下线 2.0 版本。若您的业务仍在使用 CDN 的 API 2.0 相关接口，建议尽快将服务升级至 CDN API 3.0 接口，避免对您的业务造成影响。具体详情可参见 <a href="https://cloud.tencent.com/document/api/228/80982">迁移指引</a>。</p>
</blockquote>
