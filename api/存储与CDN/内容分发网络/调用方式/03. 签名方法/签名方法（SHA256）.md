...
```
Action=DescribeCdnHosts&Nonce=48059&SecretId=************************************&SignatureMethod=HmacSHA256&Timestamp=1502197934&limit=10&offset=0
```
...
```
GETcdn.api.qcloud.com/v2/index.php?Action=DescribeCdnHosts&Nonce=48059&SecretId=************************************&SignatureMethod=HmacSHA256&Timestamp=1502197934&limit=10&offset=0
```

若为 POST 请求，示例的拼接结果为：

```
POSTcdn.api.qcloud.com/v2/index.php?Action=DescribeCdnHosts&Nonce=48059&SecretId=**************************************&SignatureMethod=HmacSHA256&Timestamp=1502197934&limit=10&offset=0
```
...
```
$secretKey = '******************************';
$srcStr = 'GETcdn.api.qcloud.com/v2/index.php?Action=DescribeCdnHosts&Nonce=48059&SecretId=************************************&SignatureMethod=HmacSHA256&Timestamp=1502197934&limit=10&offset=0';
