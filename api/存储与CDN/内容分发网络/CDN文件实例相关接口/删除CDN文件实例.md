...
本接口（DeleteCdnEntity）只适用于托管源且使用SVN去管理CDN源文件的场景，不适用于自有源或者FTP托管源这样的场景。该接口用于删除SVN下某CDN文件实例。

 接口请求域名：<font style="color:red">cdn.api.qcloud.com</font>

## 2. 输入参数
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](https://www.qcloud.com/doc/api/231/4473)页面。其中，此接口的Action字段为DeleteCdnEntity。
