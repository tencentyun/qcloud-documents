...
日志下载链接 API_V1 版本：[GenerateLogList](https://www.qcloud.com/document/product/228/3950)

## 2. 输入参数

以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](https://www.qcloud.com/doc/api/231/4473)页面。其中，此接口的Action字段为 GetCdnLogList。
