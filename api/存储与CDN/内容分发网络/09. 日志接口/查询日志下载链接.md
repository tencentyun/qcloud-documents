...
+ 未填充startDate和endDate时，默认查询区间为当前时间前推30天；
+ startDate为查询开始日期，endDate未查询结束日期，假设 startDate=20160813，endDate=20160815，实际查询的日期为8-13、8-14、8-15三天的日志下载链接，每天一个链接。
...
| 参数名称 | 类型     | 描述                                     |
| ---- | ------ | -------------------------------------- |
| date | Int    | 当前日期，Unix时间戳                           |
| type | Int    | 是否有日志；1：有日志；0：无日志                      |
| name | String | 日志名称，格式为：日期-域名，如 20160503-www.test.com |
| link | String | 下载链接                                   |
    ...
    "list":[
  		{
  	  		"date":2016-03-20,
  	  		"type":1,
  	  		"name":"20160320-tcloud.qq.com",
  	  		"link":"http://log-download.cdn.qcloud.com/20160320/20160320-www.test.com.gz?st=XXXXXXXXXXXXXXXXX&e=1461928041"
		},
      	...
	]
  }
