...
+ 未填充startDate和endDate时，默认查询区间为当前时间前推30天，每天的日志提供一个下载链接；
+ startDate为查询开始日期，endDate为查询结束日期，假设 startDate=20160813，endDate=20160815，实际查询的日期为8-13、8-14、8-15三天的日志下载链接，每天一个链接。
