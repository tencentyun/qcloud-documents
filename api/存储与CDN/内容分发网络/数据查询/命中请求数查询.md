...
**GetCdnHostsDetailStatistics** 查询域名指定时间区间的命中请求数明细数据。

请求域名：<font style="color:red">cdn.api.qcloud.com</font>

<font style="color:orange">接口通过statType不同可指定查询带宽、流量、请求数、命中请求数、命中流量、状态码明细数据，此文档对命中请求数明细查询进行了说明</font>
...
| statType  | 是    | String | 统计量类型<br/>"hit_requests"：表示命中流量明细        |
| hosts.n   | 是    | String | 域名                                       |
...
| requests_total | Array  | 多域名总命中请求数明细，单位为 次（个） |
