<font style="color:Brown">The API GetCdnOriginStat is used to query the origin-pull bandwidth, origin-pull traffic, the number of origin-pull requests, the number of failed origin-pull requests, and origin-pull failure rate based on the input parameter statType. This document describes how to query the details of origin-pull traffic.</font>

## API Description

**GetCdnOriginStat** is used to query the details of origin-pull traffic within a specified time period for a domain name.
...
| statType | Yes | String | Statistical type<br/>"flux": origin-pull traffic |
...
| flux | Array | Details of origin-pull traffic (in bytes) |
