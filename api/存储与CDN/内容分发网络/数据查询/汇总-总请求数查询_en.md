<font style="color:Brown">The API DescribeCdnHostInfo is used to query peak bandwidth, total traffic, total number of requests, and average hit rate of requests based on the input parameter statType. This document describes how to query the total number of requests.</font>

## API Description

**DescribeCdnHostInfo** can be used to query the total number of requests within a specified time range for a domain name.

Domain name for API request: <font style="color:red">cdn.api.qcloud.com</font>

**Note:**

+ You can submit multiple domain names or projects at a time to query the total number of requests for the submitted domain names or the domain names under each project.
+ The statistic value of number of requests is generated every 5 minutes, and the total number of requests is the sum of the statistic values within the specified time range.
...
+ Parameter projectId is required to query the total number of requests for a domain name.
...
| statType | Yes | String | Statistic type<br/>"requests" indicates total number of requests |
...
| host_type | String | Domain name type<br/>"cname" indicates the domain name accessing a self-owned origin<br/>"cos" indicates the domain name accessing a COS origin |
| host_value | Int | Total number of requests |
