<font style="color:Brown">The API GetCdnOriginStat is used to query the origin-pull bandwidth, origin-pull traffic, the number of origin-pull requests, the number of failed origin-pull requests, and origin-pull failure rate based on the input parameter statType. This document describes how to query the details of the number of failed origin-pull requests.</font>

## API Description

**GetCdnOriginStat** is used to query the details of the number of failed origin-pull requests within a specified time period for a domain name.
...
- By default, the data granularity is 5 minutes for the data within a time range of 3 days, 1 hour for the data within 4-7 days (total failures), and 1 day for the data within 8 or more days (total failures).
...
| statType | Yes | String | Statistical type<br/>"fail_requests" indicates the number of failed origin-pull requests |
...
| fail_total | Array | The total number of failed origin-pull requests |
| fail_5xx | Array | Number of failed requests due to 5XX error |
| fail_http_error | Array | Number of failed requests due to incompatible protocol |
| fail_origin_close | Array | Number of failed requests due to origin server disconnection |
| fail_timeout | Array | Number of failed requests due to timeout |
