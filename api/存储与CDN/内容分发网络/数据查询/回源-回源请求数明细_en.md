<font style="color:Brown">The API GetCdnOriginStat is used to query the origin-pull bandwidth, origin-pull traffic, the number of origin-pull requests, the number of failed origin-pull requests, and origin-pull failure rate based on the input parameter statType. This document describes how to query the details of the number of origin-pull requests.</font>

## API Description

**GetCdnOriginStat** is used to query the details of the number of origin-pull requests within a specified time period for a domain name.

Domain name for API request: <font style="color:red">cdn.api.qcloud.com</font>

**Notes:**

- You can submit a maximum of 20 domain names at a time to query the real-time number of origin-pull requests for each domain name.
- The statistic value of the number of origin-pull bandwidth requests is generated at an interval of 5 minutes, with the delay of real-time data being 5-10 minutes.
...
| statType | Yes | String | Statistical type<br/>"requests": Number of origin-pull requests |
...
| requests | Array | The number of origin-pull requests |
