...
<font style="color:orange">接口通过statType不同可指定查询峰值带宽、总流量、总请求数、平均请求数命中率数据，此文档对平均请求数命中率查询的进行了说明</font>
...
| projects.n | 是    | String | 项目 ID，[查看项目ID](https://console.qcloud.com/project) |
