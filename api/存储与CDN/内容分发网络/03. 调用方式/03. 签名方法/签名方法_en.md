...
Take [Query Domain Information](https://www.qcloud.com/document/product/228/3937) request as an example. When the user calls the API, the request parameters are as follows:
