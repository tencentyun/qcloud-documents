...
Take [Query Domain Information by Domain](https://www.qcloud.com/doc/api/231/3938) (GetHostInfoByHost) as an example. This API supports the following API request parameters:
...
&hosts.1=www.def.com
```
A complete request needs two types of request parameters: common request parameters and API request parameters. Only API request parameters are listed above. For information on common request parameters, refer to [Common Request Parameters](https://www.qcloud.com/doc/api/231/4473) section.
