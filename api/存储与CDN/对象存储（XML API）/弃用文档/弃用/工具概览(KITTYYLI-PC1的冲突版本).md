...
| 工具 | 功能说明 | 版本限制|
|---------|---------|---------|
| [COSCMD 工具](/doc/product/436/10976) | 本工具支持用户使用简单的命令行指令实现对对象的批量上传、下载、删除等操作。| 适用于 COS V4、V5 版本 |
...
|[FTP Server 工具](/doc/product/436/7214)|本工具支持用户使用 FTP 客户端从 COS 上传、下载文件。| 适用于 COS V5 版本|
