...
| AttachmentFull                      | ACL 和 Policy 数量到达上限。详情请参见 [规格与限制](https://cloud.tencent.com/document/product/436/14518) | 400 Bad Request                     |
| BadDigest                           | 提供的 Content-MD5 值与服务端收到的请求体的 MD5 哈希值不一致 | 400 Bad Request                     |
| EntityTooLarge                      | 上传的对象大小超过规定的最大值。详情请参见 [规格与限制](https://cloud.tencent.com/document/product/436/14518) | 400 Bad Request                     |
| EntityTooSmall                      | 上传的对象大小不足规定的最小值，常见于分块上传，详情请参见 [规格与限制](https://cloud.tencent.com/document/product/436/14518) | 400 Bad Request                     |
| IncorrectNumberOfFilesInPostRequest | POST 请求每次只允许上传一个对象                              | 400 Bad Request                     |
| InvalidArgument                     | 请求参数不合法。请参见 [请求签名](https://cloud.tencent.com/document/product/436/7778) 文档检查请求参数 | 400 Bad Request                     |
| InvalidBucketName                   | 存储桶名称不合法。详情请参见存储桶 [命名规范](https://cloud.tencent.com/document/product/436/13312#.E5.91.BD.E5.90.8D.E8.A7.84.E8.8C.83) | 400 Bad Request                     |
...
| InvalidPartOrder                    | 分块的编号不连续                                             | 400 Bad Request                     |
| InvalidRegionName                   | 不合法的地域名。请参见 [地域和访问域名](https://cloud.tencent.com/document/product/436/6224) 检查地域名称 | 400 Bad Request                     |
| InvalidRequest                      | 请求不合法。请参见 [请求签名](https://cloud.tencent.com/document/product/436/7778) 文档检查请求参数 | 400 Bad Request                     |
| InvalidSHA1Digest                   | 请求内容 SHA1 校验不合法。请参见 [请求签名](https://cloud.tencent.com/document/product/436/7778) 文档检查请求参数 | 400 Bad Request                     |
| InvalidURI                          | URI 不合法                                                   | 400 Bad Request                     |
| KeyTooLong                          | 对象键过长。详情请参见 [规格与限制](https://cloud.tencent.com/document/product/436/14518) | 400 Bad Request                     |
...
| MissingAppid                        | 请求头中缺少 [APPID](https://console.cloud.tencent.com/cam/capi) | 400 Bad Request                     |
...
| PolicyFull                          | ACL 和 Policy 数量到达上限。详情请参见 [规格与限制](https://cloud.tencent.com/document/product/436/14518) | 400 Bad Request                     |
| RequestTimeOut                      | 读取数据超时，检查网络是否过慢或上传并发数过大               | 400 Bad Request                     |
| TooManyBuckets                      | 存储桶数目达到上限200。详情请参见 [规格与限制](https://cloud.tencent.com/document/product/436/14518) | 400 Bad Request                     |
...
| AccessDenied                        | 签名或者权限不正确，拒绝访问。请参见 [请求签名](https://cloud.tencent.com/document/product/436/7778) 文档检查请求参数 | 403 Forbidden                       |
...
| InvalidObjectStorage                | 不合法的 [存储类型](https://cloud.tencent.com/document/product/436/33417)                                             | 403 Forbidden                       |
