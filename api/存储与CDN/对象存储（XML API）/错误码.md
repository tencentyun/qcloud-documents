...
| 400 Bad Request | MAZOperationNotSupportOnOAZBucket | 单可用区（单 AZ）存储桶不支持多可用区（多 AZ）操作。关于多 AZ 特性及使用限制的说明请参见 [多 AZ 特性概述](https://cloud.tencent.com/document/product/436/40548)
...
| 400 Bad Request | OAZOperationNotSupportOnMAZBucket | 多可用区存储桶不支持单可用区操作。关于多 AZ 特性及使用限制的说明请参见 [多 AZ 特性概述](https://cloud.tencent.com/document/product/436/40548)
