...
**例如：**`36bcd76dbb8c9f066472fec403df8a34cab34c77`
...
其中，没有 value 的参数认为 value 为空字符串，如请求路径为 `/?acl`，则认为是 `/?acl=`。
2. 对 KeyList 按照字典序排序。
...
其中，(empty string) 代表长度为 0 的空字符串，(new line) 代表此处有一个空行。
