...
q-sign-time|参数[*SignTime*]|本签名的有效起止时间，通过 Unix 时间戳<sup><font size=-2><a href="#add">注1</a></font></sup>描述起始和结束时间，以秒为单位，格式为 [*start-seconds*];[*end-seconds*]。<br>**例如：** 1480932292;1481012298 。|是
...
var sha1_http_string = crypto.createHash('sha1').update('ExampleHttpString').digest('hex');
