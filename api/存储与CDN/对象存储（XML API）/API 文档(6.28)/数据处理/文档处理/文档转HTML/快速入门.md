...
文档 转 HTML 功能支持对多种文档类型的文件生成 HTML 格式预览，满足 PC、App 等多个用户端的文档在线浏览需求，适用于在线教育、企业 OA、在线知识库、网盘文档预览等业务场景。

>? 
>- 对象存储封装预览 Js SDK，只需要一条 URL 即可接入 HTML 预览服务。
>- 如需在小程序内使用，请 [联系我们](https://cloud.tencent.com/document/product/436/37708)，并提供小程序授权码进行配置。
>
