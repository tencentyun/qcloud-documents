...
此接口仅使用数据万象的公共请求头部，详情请参见数据万象 [公共请求头部](https://cloud.tencent.com/document/product/460/42865) 文档。
...
此接口仅返回数据万象的公共响应头部，详情请参见数据万象 [公共响应头部](https://cloud.tencent.com/document/product/460/42866) 文档。
...
此接口遵循统一的错误响应和错误码，详情请参见数据万象 [错误码](https://cloud.tencent.com/document/product/460/42867) 文档。
...
```shell
GET /auditing/vab1ca9fc8a3ed11ea834c525400863904 HTTP/1.1
Accept: */*
