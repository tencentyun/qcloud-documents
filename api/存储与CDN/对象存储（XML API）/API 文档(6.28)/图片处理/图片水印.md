...
| /spcent/     | 与 scatype 搭配使用：<li>当 scatype 设置为1时，该有效值为[1, 1000]，单位为千分比。<li>当 scatype 设置为2时，该有效值为[1, 1000]，单位为千分比。<li>当 scatype 设置为3时，该有效值为[1, 250]，单位为千分比。示例：`http://examples-1251000004.cos.ap-shanghai.myqcloud.com/sample.jpeg?watermark/1/image/xxxxxxx/scatype/3/spcent/250`                      |
