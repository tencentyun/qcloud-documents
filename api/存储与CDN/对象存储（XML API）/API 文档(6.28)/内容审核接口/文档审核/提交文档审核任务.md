...
本接口用于提交一个文档审核任务。文档审核功能为异步任务方式，您可以通过提交文档审核任务审核您的文档文件，然后通过 [查询文档审核任务接口](https://cloud.tencent.com/document/product/436/59382) 或 [文档审核回调](https://cloud.tencent.com/document/product/436/62389) 查询审核结果。
