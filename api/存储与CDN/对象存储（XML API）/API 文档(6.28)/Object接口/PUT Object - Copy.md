...
x-cos-grant-read|string|否|赋予被授权者读的权限。格式：x-cos-grant-(): id="[OwnerUin]"
x-cos-grant-write|string|否|赋予被授权者写的权限。格式：x-cos-grant-(): id="[OwnerUin]"
x-cos-grant-full-control|string|否|赋予被授权者所有的权限。格式：x-cos-grant-(): id="[OwnerUin]"
