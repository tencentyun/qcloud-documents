...
| dstType    | 转换输出目标文件类型：<br><li>png，转成 png 格式的图片文件<br><li>jpg，转成 jpg 格式的图片文件<br><li>pdf，转成pdf格式的图片文件。无法选择页码，page参数不生效<br><li>txt，转成 txt 格式文件<br/>如果传入的格式未能识别，默认使用 jpg 格式 | String | 否       |
