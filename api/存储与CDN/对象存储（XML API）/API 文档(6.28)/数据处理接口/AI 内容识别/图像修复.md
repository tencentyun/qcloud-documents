...
| 参数         | 含义                                                         | 类型   | 是否必选 |
| :----------- | :----------------------------------------------------------- | :----- | :------- |
| download_url | 文件的访问链接，具体构成为`<BucketName-APPID>.cos.<Region>.myqcloud.com/<picture name>`， 例如 `examplebucket-1250000000.cos.ap-shanghai.myqcloud.com/picture.jpeg` | String | 是       |
