...
| x-cos-grant-read | 赋予被授权者读的权限。格式：`x-cos-grant-read: id="qcs::cam::uin/<OwnerUin>:uin/<SubUin>"` ；</br> 当需要给子账户授权时，`id="qcs::cam::uin/<OwnerUin>:uin/<SubUin>"`，当需要给根账户授权时，`uin="<OwnerUin>"` | String |  否 |
| x-cos-grant-write| 赋予被授权者写的权限。格式：`x-cos-grant-write: id="qcs::cam::uin/<OwnerUin>:uin/<SubUin>"`；</br>当需要给子账户授权时，`id="qcs::cam::uin/<OwnerUin>:uin/<SubUin>"`，当需要给根账户授权时，`uin="<OwnerUin>" `|String |  否 |
| x-cos-grant-full-control | 赋予被授权者读写权限。格式：`x-cos-grant-full-control: id="qcs::cam::uin/<OwnerUin>:uin/<SubUin>"`；</br>当需要给子账户授权时，`id="qcs::cam::uin/<OwnerUin>:uin/<SubUin>"`，当需要给根账户授权时，`uin="<OwnerUin>"` | String|  否 |
