...
>- 支持对腾讯云 CAM 主账号、匿名用户、子用户授予权限，如需授予用户组权限请参考[为用户组添加/接触策略](https://cloud.tencent.com/document/product/598/37299)。有关 ACL 的详细说明，请参见 [ACL 概述](https://cloud.tencent.com/document/product/436/30752)。
