...
GET Bucket inventory 接口用于查询存储桶中用户的某个清单任务信息。用户在提起该请求时，需要用户提供清单任务的名称，发起该请求时需获得请求签名，表明该请求已获得许可。有关清单的详细特性，请参阅 [清单功能概述](https://cloud.tencent.com/document/product/***/****)。
...
| Id                      | Inventory Configuration | 清单的名称，与请求参数中的id对应。                           | Container |
