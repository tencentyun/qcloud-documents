## 功能描述
GET Bucket replication 接口用于查询存储桶中用户跨区域复制配置信息。用户发起该请求时需获得请求签名，表明该请求已获得许可。
...
|错误代码|   描述 | 状态码 |
|---|---|---|---|
|ReplicationConfigurationNotFoundError|无查询的跨区域复制规则|404 Not Found||
## 实际案例
### 请求
...
<ReplicationConfiguration>
	...
	<Rule>
		...
		<Destination>
			<Bucket>qcs::cos:ap-guangzhou::sevenyousouthtest-7319456</Bucket>
		</Destination>
	</Rule>
</ReplicationConfiguration>
```
