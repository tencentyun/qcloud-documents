...
>- 仅可对腾讯云 CAM 主账号或匿名用户授予权限，如需授予授予子用户或用户组权限请使用 [PUT Bucket policy](https://cloud.tencent.com/document/product/436/8282) 接口。有关 ACL 的详细说明，请参阅 [ACL 概述](https://cloud.tencent.com/document/product/436/30752)
