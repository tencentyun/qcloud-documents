...
| API                                                          | 操作名         | 操作描述                                         |
| ------------------------------------------------------------ | -------------- | ------------------------------------------------ |
| [CommonElements](https://cloud.tencent.com/document/product/436/38607) | 公共元素       | 批量处理功能的公共元素                           |
...
| [ErrorResponse](https://cloud.tencent.com/document/product/436/38610) | 错误响应       | 列举了常见的批量处理任务错误响应                 |
