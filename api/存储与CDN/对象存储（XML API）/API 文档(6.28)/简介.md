...
>为了能更高效的使用腾讯云对象存储服务的 XML API，请在查阅其他的 API 文档之前，先详细阅读 [请求签名](https://www.qcloud.com/document/product/436/7778) 。
...
| Region|	域名中的地域信息。枚举值参见 [可用地域](https://www.qcloud.com/document/product/436/6224) 文档，如：ap-beijing, ap-hongkong, eu-frankfurt 等 |
