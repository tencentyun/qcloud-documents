...
>- 如果您需要获得 JSON 格式的响应，推荐您使用 [COS SDK](https://cloud.tencent.com/document/product/436/6474)，在 SDK 中可以设置响应体为 JSON 格式的响应。
>- 其他腾讯云产品的 API 格式，请参见 [API 中心介绍](https://cloud.tencent.com/document/api)。
