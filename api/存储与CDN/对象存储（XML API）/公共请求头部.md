...
<td>integer</td>
<td>针对 PUT 和 POST 请求（指定 Transfer-Encoding 请求头部的 PUT Object 请求除外），此头部是必选项。<br>针对 GET、HEAD、DELETE 和 OPTIONS 请求，不能指定此头部。</td>
</tr>
<tr>
<td>Content-Type</td>
<td>RFC 2616中定义的 HTTP 请求内容类型（MIME）<br>例如<code>application/xml</code>或<code>image/jpeg</code>。</td>
<td>string</td>
<td>针对有请求体的 PUT 和 POST 请求，此头部是必选项。<br>针对 GET、HEAD、DELETE 和 OPTIONS 请求，不能指定此头部。</td>
</tr>
<tr>
<td>Content-MD5</td>
...
<td>string</td>
<td>针对有请求体的 PUT 和 POST 请求（除 POST Object），此头部是必选项。<br>针对 GET、HEAD、DELETE 和 OPTIONS 请求，不能指定此头部。</td>
</tr>
<tr>
<td>Date</td>
