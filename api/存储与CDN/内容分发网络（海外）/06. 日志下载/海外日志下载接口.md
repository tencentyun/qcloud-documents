...
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](https://www.qcloud.com/doc/api/231/4473)页面。其中，此接口的Action字段为 GetOverseaCdnLogList。
...
| name | String | 日志名称，格式为：日期小时-域名，如 2016050301-[www.test.com](www.test.com) |
| link | String | 下载链接                                     |
...
> host: [www.test.com](www.test.com)
>
