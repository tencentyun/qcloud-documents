...
1) Request domain: The request domain to query consumption details (GetCdnOverseaStat) is cdn.api.qcloud.com. The actual request domain varies depending on the module to which the API belongs. For more information ,refer to descriptions of APIs.
