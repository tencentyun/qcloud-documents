...
Each Tencent Cloud API request should contain two kinds of parameters, common request parameters and API request parameters. Common request parameters are the parameters common to all APIs (see [Common Request Parameters](https://www.qcloud.com/doc/api/445/6384)), while API request parameters are parameters specific to each API.
