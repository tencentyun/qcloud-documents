...
## 2. 输入参数
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](https://www.qcloud.com/doc/api/231/4473)页面。其中，此接口的Action字段为GetCdnOverseaPv。
...
| 参数名称     | 类型    | 描述       |
| -------- | ----- | -------- |
| requests | Array | 请求数统计量数组 |


**注意事项：**
+ requests为Int类型数组，从指定查询日期0点开始，每5分钟一个数据；
+ 00:05:00 点的统计量代表了 00:00:00 - 00:04:59 期间的统计量。
