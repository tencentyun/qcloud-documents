...
|num|	本次查询所要列出的目录总数,最大支持 199	|Int|是	|
...
|参数名称|描述|类型|
|---|-- |--|
| context | 创建时间，10 位 Unix 时间戳 | String |
...
| ctime | 创建时间，10 位 Unix 时间戳| Number |
| mtime | 修改时间，10 位 Unix 时间戳 | Number |
| access_url	 | 生成的资源可访问的cdn url，当类型为文件时返回 | String |
