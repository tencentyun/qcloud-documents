...
``` http
POST http://region.file.myqcloud.com/files/v1/10000202/buckettest/foldertest/test_upload.pptx HTTP/1.1
Host: sh.file.myqcloud.com
Accept: /
...

{
    ...
    "data": {
        ...
        "url": "http://region.file.myqcloud.com/files/v1/foldertest/test_upload.pptx"
    }
}
```
### 删除文件
