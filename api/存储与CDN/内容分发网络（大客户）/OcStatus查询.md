## 接口描述
**GetCdnEdgeStatus** 用于查询腾讯云CDN边缘节点 IP、省份、运营商、状态等信息。
...
## 入参说明
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](https://cloud.tencent.com/doc/api/231/4473)页面。其中，此接口的Action字段为 GetCdnEdgeStatus。
