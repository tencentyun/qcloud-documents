...
| 名称                 | 描述                                       | 类型     | 必选   |
| ------------------ | ---------------------------------------- | ------ | ---- |
| Type               | 任务类型， 枚举值: `archive-retrieval` ，`inventory-retrieval`，当检索Archive时，此处填写`archive-retrieval`。| String | 是    |
...
| 名称                           | 描述                                       | 类型     | 必选   |
| ---------------------------- | ---------------------------------------- | ------ | ---- |
| Type                         | 任务类型， 枚举值: `archive-retrieval` ，`inventory-retrieval`，当检索Archive列表时，此处填写`inventory-retrieval` 。| String | 是    |
| Description                  | 任务的描述  。                                  | String | 否    |
