## 1.工程结构
从github下载移动直播代码，使用Android Studio打开工程后，您将看到如下的目录结构：
...
| logic| 移动直播逻辑层代码|
| ui| 移动直播界面层代码|
| ui/customviews| 移动直播ui用到的自定义控件|
| jniLibs| 移动直播依赖的腾讯相关sdk，主要是BuglySDK、TLSSDK、IMSDK及RTMPSDK|
### 依赖第三方库 
- 网络：volley，gson
...
### 消息
#### 模块介绍
- 移动直播的互动消息功能主要基于[ImSDK](https://www.qcloud.com/doc/product/269/1561)的群聊功能实现，需要在IMSDK登录后才能调用
