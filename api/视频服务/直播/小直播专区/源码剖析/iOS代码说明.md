...
- 目前小直播的TLS登录模块的界面部分单独封装成TLSUI.framework
...
- UI:
	- TCLoginViewController: TLS登录相关界面层代码，如果需要重新登录，则拉起TLSUI登录界面，否则直接调用ImSDK的登录接口
...
- IMSDK提供了消息自定义的功能，开发者能以JSON的格式实现不同格式与内容的[自定义消息](https://www.qcloud.com/doc/product/269/1569#1.7-.E8.87.AA.E5.AE.9A.E4.B9.89.E6.B6.88.E6.81.AF.E5.8F.91.E9.80.81)
