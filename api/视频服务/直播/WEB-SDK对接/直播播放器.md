...
|缺少视频数据|视频源数据缺失|
|直播已经结束啦 |NetStream.Play.Stop 事件|
|直播已经结束啦 |连接不到直播源,直播源没有推送视频内容|
...
| 3     | 直播源已结束(hls) |Manifest不是合法的m3u8文件，或直播源已结束 |
|113	| 连接超时，请稍后再试|参数错误|
...
| 20113 | 直播已经结束啦|LIVE\_NOT\_EXSIT 直播源不存在              |
| 20110 | 密码错误，请重新输入|无效密码                                   |
|20201  |直播已经结束啦|get upstream info error'  查询推流错误|
