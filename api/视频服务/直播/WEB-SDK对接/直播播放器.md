...
| x5_type           | String | 无   | 通过video属性“x5-video-player-type”声明启用同层H5播放器，支持的值：h5 (该属性为TBS内核内置属性，非TBS内核不支持，具体介绍参照TBS文档) [TBS文档](http://x5.tencent.com/guide?id=4000)                            |
| x5_fullscreen     | String | 无   | 视频播放时将会进入到全屏模式，支持的值： true:开启 (该属性为TBS内核内置属性，非TBS内核不支持，具体介绍参照TBS文档) [TBS文档](http://x5.tencent.com/guide?id=4000)                                                       |
