...
|Param.s.record_type|录制文件类型|string| 默认video<br>当record_type取值“video”时，file_format 可以取值 “flv”,"hls", "mp4"<br>当record_type取值“flv”时，file_format 可以取值 "aac", “flv”,"hls", "mp4"|N|
