...
## 兼容说明
直播码最初是腾讯云针对VIP客户所设计的一套直播解决方案，直到不久之前都是只能通过内部申请才能开通的，所以方案设计之初并没有需求跟[频道托管](https://www.qcloud.com/doc/api/258/5659)模式相兼容。
...
## 开启直播码
### 1.开启视频直播服务
进入腾讯云[直播管理控制台](https://console.qcloud.com/live)，如果您还没有开通直播服务，先把它开通了。
...
（2）页面顶部多了一个bizid的数字，该数字是用来拼装推流地址用的，详情可以[参考文档](https://www.qcloud.com/doc/api/258/5649#.E6.8E.A8.E6.B5.81.E5.9C.B0.E5.9D.80)。
