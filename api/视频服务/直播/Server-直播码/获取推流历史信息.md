...
- **地址**
  - API调用地址为：http://tatcgi.video.qcloud.com/common_access
...
|---------|---------|---------|------------------|--------------|
|time	|推流时刻	|string	|||	
|client_ip|推流客户端IP	|string	|什么查询时间内的ip列表还是什么？||	
|server_ip	|接流服务器IP|	string|什么查询时间内的ip列表还是什么？||		
|fps	|推流帧率	|int	|是查询时间内的平均帧率吗？||
|speed|	推流码率|	int	|是查询时间内的品均码率吗？|单位：bps|
