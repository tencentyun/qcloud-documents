...
| -4     | 请求中的 app   ip不允许                             | 若失败请联系 QGSK 接入支持                      |
...
| -22    | openid 非法                                         | 确认 appid、openid 的准确性，若失败请联系QGSK接入支持 |
| -23    | openkey 非法                                        | 请重新授权                                                     |
| -24    | openid   openkey 验证失败                           | 重新授权                                                     |
| -25    | 0x71f   0x5b:timestamp 与系统当前时间相差超过10分钟 | 确认appid、appkey、openkey 的一致性，若失败请联系 QGSK 接入支持 |
...
| 100008 | 该 appid 不存在                                      | 确认appid的准确性，若失败请联系 QGSK 接入支持    |
| 100009 | appkey(client_secret)   不合法                     | 确认appid、appkey的准确性，若失败请联系 QGSK 接入支持 |
