...
| regionId | 否 | Int | 地域ID，请使用[查看地域ID列表](/doc/api/238/9137)  |
| zoneId | 否 | Int | 可用区ID，请使用[查看可用区ID列表](/doc/api/238/9137)|
| status | 否 | Int | 实例状态值，请使用[查看实例状态列表](/doc/api/238/9137) |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| code | Int | 公共错误码, 0表示成功，其他值表示失败。详见错误码页面的<a href='https://www.qcloud.com/doc/api/238/%E9%94%99%E8%AF%AF%E7%A0%81#1.E3.80.81.E5.85.AC.E5.85.B1.E9.94.99.E8.AF.AF.E7.A0.81' title='公共错误码'>公共错误码</a>。|
...
| status | Int | 实例状态，请使用[查看实例状态列表](/doc/api/238/9137) |
| vip | String | 实例访问ip |
| vport | Int | 实例访问端口 |
...
&<<a href="https://www.qcloud.com/doc/api/238/7328">公共请求参数</a>>
&regionId=1
