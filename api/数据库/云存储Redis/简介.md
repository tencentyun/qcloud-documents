>?
>- 当前页面接口为旧版 API，未来可能停止维护。云数据库 Redis API 3.0 版本接口定义更加规范，访问时延下降显著，建议您使用 [云数据库 Redis API 3.0](https://cloud.tencent.com/document/product/239/20002)。
>- 如果您需要访问云数据库 Redis 旧版 API，可参见 [API 概览](https://cloud.tencent.com/document/product/239/1749)。
