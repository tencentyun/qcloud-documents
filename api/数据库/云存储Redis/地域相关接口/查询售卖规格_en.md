...
|---------|---------|---------|---------|
| zoneIds.n | No | String | An array of availability zone IDs, with the array subscript starting from 0. If this parameter is not specified, the product information of all the availability zones will be returned. The available values are subject to the returned values of API [Query Supported Availability Zones](http://www.qcloud.com/doc/api/260/4951) |
