## 1. API Description
This API (InquiryRedisPrice) is used to query the prices for purchasing and renewing an instance. To query the price for upgrading an instance, please see [Query Price for Instance Upgrade](http://www.qcloud.com/doc/api/260/5327).
...
|---------|---------|---------|---------|
| zoneId | Yes | UInt | The availability zone to which the instance belongs. This value is subject to the returned values of API [Query Supported Availability Zones](http://www.qcloud.com/doc/api/260/4951) |
| typeId | Yes | UInt | Instance type. 1 - Cluster; 2 - Standalone |
| memSize | Yes | UInt | Capacity of instance, which is an integral multiple of 1024 (in MB). This value is subject to the returned values of API [Query Supported Specifications](http://www.qcloud.com/doc/api/260/4974) |
| goodsNum | Yes | UInt | Number of instances. This value is subject to the returned values of API [Query Supported Specifications](http://www.qcloud.com/doc/api/260/4974) |
