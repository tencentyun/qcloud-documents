...
</td><td> Error code on the result. 0: Succeed; other values: Failed. For detailed meanings of error codes, please see the <a href="/doc/api/261/错误码" title="Error Codes">Error Codes</a> page
</td></tr>
<tr>
<td> message
</td><td> String
