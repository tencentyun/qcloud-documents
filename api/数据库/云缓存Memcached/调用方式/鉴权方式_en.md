...
** Note: 1. "Parameter value" is the original value instead of url encoded value. If an input parameter contains an underscore"_", you need to convert it to ".".**
...
2) Request CVM: The request domain for [View List of Instances](/doc/api/229/查看实例列表) (DescribeInstances) is cvm.api.qcloud.com. The actual request domain varies depending on the module to which the API belongs. For more information, please see descriptions of APIs.
