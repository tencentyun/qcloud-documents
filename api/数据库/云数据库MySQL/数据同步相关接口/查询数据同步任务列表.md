...
| srcInfo | Object | 源实例信息，包含regionId和cdbUInstanceId|
| dstInfo | Object | 目的实例信息，包含regionId和cdbUInstanceId | 
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| stopStatus | Int | 数据同步任务中止状态码，100-任务强行中止中，101-任务中止成功，102-任务中止失败 |
