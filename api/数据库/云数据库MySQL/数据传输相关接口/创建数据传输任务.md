...
1. 通过本接口创建数据传输任务之后，需使用[开始校验数据传输任务](/document/product/236/7726)接口发起校验，主要内容包括：源MySQL和目标实例是否满足迁移条件；
...
4. 如果校验失败，您可以使用[修改数据传输任务](/document/product/236/7725)接口来修改任务参数，之后再回到第一步重新发起任务校验；
