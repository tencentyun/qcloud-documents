## 1. 接口描述
本接口(GetCdbDataMigrationTaskInfo)用于查询数据传输任务信息，返回数据传输任务的详细信息。
...
| 参数名称 | 是否必选  | 类型 | 描述 |
|---------|---------|---------|---------|
| jobId | 是 | Int | 数据传输任务ID，请使用[DescribeProject](/doc/api/229/1330)接口查询任务ID |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| jobId | String | 数据传输任务 ID |
| jobName | String | 数据传输任务名称 |
