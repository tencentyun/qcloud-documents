...
| dbPriv | 否 | String | 数据库权限参数|
| tbPriv | 否 | String | 库表权限参数|
| colPriv | 否 | String | 列权限参数|
其中， dbPriv 参数的元素构成如下：
