...
| type | 否 | Array | 任务类型，值包括：<br>1-源实例为公网自建MySQL，<br>2-源实例为基础网络自建MySQL，<br>3-源实例为VPC网络自建MySQL，<br>4-源实例通过专线接入，<br>5-源实例通过云VPN接入，<br>6-源实例通过自建VPN接入 |
...
| jobId | Int | 数据迁移任务 ID |
| type | Int | 数据迁移任务类型，值包括：<br>1-源实例为公网自建MySQL，<br>2-源实例为基础网络自建MySQL，<br>3-源实例为VPC网络自建MySQL，<br>4-源实例通过专线接入，<br>5-源实例通过云VPN接入，<br>6-源实例通过自建VPN接入|
