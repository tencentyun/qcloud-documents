## 1. 接口描述
本接口(GetCdbDeviceMonitorInfo)用于查询云数据库物理机当天的监控信息，<font style="color:red">**暂只支持最高配置实例(内存488G，硬盘6T)查询**</font>。
接口请求域名：<font style="color:red">cdb.api.qcloud.com</font>


## 2. 输入参数
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见<a href='/doc/api/253/1739' title='公共请求参数'>公共请求参数</a>页面。其中，此接口的Action字段为GetCdbDeviceMonitorInfo。
