...
You can also use API  API [Query Prices (Pay by Usage)](/doc/api/253/5176) to query the prices of creatable instances, and use API  [Create Instance (Pay by Usage)](/doc/api/253/5175) to create a new instance.
