...
创建云数据库实例前，我们首先要查看所选地域下支持哪些可创建的实例规格，这个接口只需传<a href='/doc/api/253/1739' title='公共请求参数'>公共请求参数</a>。

结合<a href='/doc/api/253/1739' title='公共请求参数'>公共请求参数</a>和接口请求参数，最终得到的请求形式如下：
