...
| Groupid | String | 分组的 Id，对于分布式数据库有效 |
...
| IllegalLogSaveDays | 修改 log 保存天数时过小或过大 |
## 5. 示例
输入
<pre>
https://tdsql.api.qcloud.com/v2/index.php?Action=ModifyTdsqlLogFileSaveDays
...
{
	"Response": {
		"RequestId": "b6220398-1e98-47d9-87c6-9e61a12cab9a",
        "CdbInstanceId": "tdsql-fdpjf5zh",
        "Groupid": ""
    }
}
