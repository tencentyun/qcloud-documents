## 1. API Description
This API (CdbTdsqlGetPerformanceInfoDetail) is used to view detailed data about instance performance.
...
). The Action field for this API is CdbTdsqlGetPerformanceInfoDetail.
...
Slightly different from API [View Instance Performance Data](/doc/api/309/5409), this API returns the detailed data of master/slave. The API [View Instance Performance Data](/doc/api/309/5409)
