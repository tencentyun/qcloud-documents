## 1. API Description
This API (CdbTdsqlCloseWanIP) is used to close Internet address.
Domain for API request: tdsql.api.qcloud.com



## 2. Input Parameters
The following request parameter list only provides API request parameters. Common request parameters are also needed when the API is called. For more information, please see <a href='/doc/api/309/7016' title='Common Request Parameters'>Common Request Parameters</a>. The Action field for this API is CdbTdsqlCloseWanIP.
...
| data.flowId | Int | Task flow ID. New flow will not be generated if the Internet address has been closed | 
## 4. Error Codes
