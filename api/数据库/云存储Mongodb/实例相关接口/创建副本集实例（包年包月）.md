...
1. 首先请使用[查询可创建实例规格](http://www.qcloud.com/document/product/240/8318)接口查询可创建的实例规格信息，然后请使用[查询副本集实例价格（包年包月）](http://www.qcloud.com/document/product/240/8311)接口查询可创建实例的售卖价格；
