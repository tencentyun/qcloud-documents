...
| endpoint| 是| String| 接收投递消息的endpoint，根据协议 protocol 区分：对于 HTTP，endpoint 必须以 “http://” 开头，host 可以是域名或 IP，endpoint长度最大为500， **目前推送服务不能推送到私有网络中**  ，因此 endpoint 填写为私有网络域名或地址将接收不到推送的消息，目前支持推送到公网和基础网络；对于 Queue，则填 queueName。|
