...
|rewindSeconds|否|Int|队列是否开启回溯消息能力，该参数取值范围0-43200秒,即消息最长可以回溯12小时，0表示不开启。|
## 3. 输出参数
...
</td><td> 队列名字格式错误。<a href="https://www.qcloud.com/doc/api/431/5832">规则</a>详见创建队列接口的queueName字段说明。
</td></tr>
<tr>
<td> 4450
</td><td> 10220
