...
| 错误代码 | 模块错误代码 | 英文提示 | 描述 |
| ----| ---- | ---- | ---- |
| 4400 | 10230 | exceed maximum message size | 存在至少一条消息达到了最大消息大小限制。可以通过 GetQueueAttributes 接口查看队列的最大消息大小。|
| 4000 | 10120 | message body can't be empty| msgBody 消息体不能为空。至少是 1Byte。|
| 4410 | 10240 | reach maximum retention number of message | 达到队列的最大消息堆积数。可以通过 GetQueueAttributes 查看队列的最大消息堆积数。|
