...
>**注意：**
>何时候，包括内测期间，如果使用外网域名产生公网下行流量，都会收取流量费用。 所以强烈建议服务在腾讯云上的用户使用 **内网** 域名，内网不会产生流量费用。
...
</td><td>msgBody 消息体不能为空。至少是 1Byte。
</td></tr>
<tr>
<td> 4410
</td><td> 10240
</td><td> reach maximum retention number of message
</td><td> 达到队列的最大消息堆积数。可以通过 <a  href="https://cloud.tencent.com/doc/api/431/5834">GetQueueAttributes</a> 查看队列的最大消息堆积数。
</td></tr>
</tbody></table>
