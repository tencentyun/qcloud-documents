...
For more information about the generation rules of parameter Signature, refer to [Signature Method](https://www.qcloud.com/document/product/406/5906).
...
| pollingWaitSeconds | [Waiting time for messages to be received when using long-polling](https://www.qcloud.com/doc/product/406/4552). The value ranges from 0 to 30 seconds. Default is 0. | 30 |
