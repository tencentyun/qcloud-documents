...
| 4450   | 10220      | number of queues has reached the limit                       | 当前队列个数已经达到最大值                                   | 您创建的队列数已经达到配额上线，如果有特殊需求请您，[提交工单](https://console.cloud.tencent.com/workorder/categoryy) 进行咨询 |
