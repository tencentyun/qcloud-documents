...
| 6000   | 10050      | server internal error                              | 服务内部错误                          | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
...
| 6000   | 10090      | send message failed                                          | 发送消息失败                                                 | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
| 4000   | 10120      | message body can't be empty                                  | 消息内容不能为空                                             | 发送的消息内容不能为空，请您设置消息内容                     |
| 6000   | 10130      | recieve message failed                                       | 接收消息失败                                                 | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
| 6000   | 10140      | delete message failed                                        | 删除消息失败                                                 | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
| 6010   | 10150      | delete message partially failed                              | 删除部分消息失败                                             | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
| 6000   | 10160      | get queue attributes failed                                  | 获取队列属性失败                                             | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
| 6000   | 10170      | set queue attributes failed                                  | 设置队列属性失败                                             | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
| 6000   | 10180      | delete queue failed                                          | 删除队列失败                                                 | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
| 6000   | 10190      | list queue failed                                            | 获取队列列表失败                                             | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
...
| 6020   | 10290      | batch delete message failed                                  | 批量删除操作失败                                             | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
...
| 6040   | 10750      | transaction confirmation failed                              | 确认事务消息失败                                             | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
| 6040   | 10760      | transaction   confirmation partially failed                  | 确认事务消息部分失败                                         | 内部错误，请 [提交工单](https://console.cloud.tencent.com/workorder/categor) 技术人员查看日志 |
