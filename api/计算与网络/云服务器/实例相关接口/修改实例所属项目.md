...
| projectId|是 |Int | 项目ID。项目可以使用 [AddProject](https://www.qcloud.com/doc/api/403/4398) 创建，后续使用 [DescribeInstances](https://www.qcloud.com/doc/api/229/831) 查询实例时，项目ID可用于过滤结果。
