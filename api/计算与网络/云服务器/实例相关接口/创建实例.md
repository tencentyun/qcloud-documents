...
|EnhancedService|[EnhancedService](/document/api/213/9451#enhancedservice) object|否|增强服务。通过该参数可以指定是否开启云安全、云监控等服务。<font style="color:red">若不指定该参数，则默认开启云监控、云安全服务。</font>|
