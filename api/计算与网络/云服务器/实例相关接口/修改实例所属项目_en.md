...
| ProjectId | Integer | Yes | Project ID. A project can be created using the API [AddProject](/doc/api/403/4398). During the query of instance using the API [DescribeInstances](/document/api/213/9388), the project ID can be used to filter the results.
