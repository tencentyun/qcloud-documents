...
| projectId | Yes | Int | Project ID. A project can be created using [AddProject](https://www.qcloud.com/doc/api/403/4398). During the query of instance using [DescribeInstances](https://www.qcloud.com/doc/api/229/831), the project ID can be used to filter the results.
