...
| InstanceChargeType | String | No | Instance [billing type](https://cloud.tencent.com/document/product/213/2180). <br><li>POSTPAID_BY_HOUR: postpaid by hour <br>Default: POSTPAID_BY_HOUR. |
