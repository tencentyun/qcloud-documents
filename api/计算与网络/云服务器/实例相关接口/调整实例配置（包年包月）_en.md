...
* This API only applies to the instances with an annual or monthly plan. To make adjustments to charge-by-quantity instances, please refer to [ResizeInstanceHour](https://www.qcloud.com/doc/api/229/1344).
...
|---------|---------|---------|---------|
| instanceId | Yes | String | ID of the instance to be operated. It can be obtained from unInstanceId in the returned value of [DescribeInstances](https://www.qcloud.com/doc/api/229/831) API.
