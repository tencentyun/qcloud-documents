...
* The instances created by API are subject to the number limit described in the [Restrictions on CVM Instance Purchase](https://www.qcloud.com/doc/product/213/CVM%E5%AE%9E%E4%BE%8B%E8%B4%AD%E4%B9%B0%E9%99%90%E5%88%B6), and share the quota with instances created on Console.
...
* If you need to change the bandwidth, change it using the [UpdateInstanceBandwidth](https://www.qcloud.com/doc/api/229/1251) API. <font style="color:red">**The bandwidth of public network is 0 by default if not specified**</font>.
...
| imageId | Yes | String | Image ID, which can be obtained from "unImgId" from the result of [DescribeImages](http://www.qcloud.com/doc/api/229/查询可用的镜像列表) API. |
...
| zoneId | No | Int | [Availability zone](https://www.qcloud.com/doc/product/213/497#2.-.E5.8F.AF.E7.94.A8.E5.8C.BA) ID. It defaults to the first availability zone of each region. |
...
| vpcId | No | String | [Virtual Private Cloud](https://www.qcloud.com/doc/product/215/535) ID. Required in VPC, not required in basic network.
