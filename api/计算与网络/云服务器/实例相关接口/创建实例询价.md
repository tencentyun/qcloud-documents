...
|VirtualPrivateCloud|[VirtualPrivateCloud](https://cloud.tencent.com/document/api/213/9451#virtualprivatecloud) object|否|私有网络相关信息配置。通过该参数可以指定私有网络的 ID，子网 ID 等信息。若不指定该参数，则默认使用基础网络。若在此参数中指定了私有网络ip，那么 InstanceCount 参数只能为1。|
