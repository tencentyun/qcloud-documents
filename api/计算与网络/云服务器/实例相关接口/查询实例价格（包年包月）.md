...
| storageType| 否| Int| 硬盘类型。1:本地盘、2:云硬盘、3:SSD本地盘、4:SSD云盘，默认为本地盘。关于数据盘的类型选择请参考[硬盘产品简介](https://cloud.tencent.com/doc/product/213/498)。|
...
| storageType| 否| Int| 数据盘类型。1:本地盘、2:云硬盘、3:SSD本地盘、4:SSD云盘。|
...
PermissionDenied|您没有权限调整本地盘类型系统盘的大小，请联系官方客服。
PermissionDenied|您没有权限调整云盘类型系统盘的大小，请联系官方客服。
