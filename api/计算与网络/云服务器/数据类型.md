...
| 名称      |    类型 |  是否必选 |描述|
|---------|---------|---------|---------|
|DiskType|String|否|系统盘类型。系统盘类型限制详见[CVM实例配置](/document/product/213/2177)。取值范围：<br><li>LOCAL_BASIC：普通本地盘<br><li>LOCAL_SSD：SSD本地盘<br><li>CLOUD_BASIC：普通云盘<br><li>CLOUD_SSD：SSD云盘<br><br>默认取值：LOCAL_BASIC。|
...
| 名称      |    类型 |  是否必选 | 描述|
|---------|---------|---------|---------|
|DiskType|String|否|数据盘类型。数据盘类型限制详见[CVM实例配置](/document/product/213/2177)。取值范围：<br><li>LOCAL_BASIC：普通本地盘<br><li>LOCAL_SSD：SSD本地盘<br><li>CLOUD_BASIC：普通云盘<br><li>CLOUD_PREMIUM：高效云盘<br><li>CLOUD_SSD：SSD云盘<br><br>默认取值：LOCAL_BASIC。<br><br>该参数对`ResizeInstanceDisk`接口无效。|
|DiskId|String|否|系统盘ID。LOCAL_BASIC 和 LOCAL_SSD 类型没有ID。暂时不支持该参数。|
