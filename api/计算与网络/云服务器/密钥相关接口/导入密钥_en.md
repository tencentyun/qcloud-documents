...
* This API only imports a key to user's account and does not automatically bind the key to an instance. If you want to bind the key to an instance using API, refer to [BindInstanceKey](https://www.qcloud.com/doc/api/229/1947) API.
