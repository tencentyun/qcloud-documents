...
|---------|---------|---------|---------|
| instanceIds.n | Yes | String | Instance ID (This API allows passing multiple IDs at a time. For the format of this parameter, refer to `id.n` section of API [Introduction](https://www.qcloud.com/doc/api/229/568)). |
