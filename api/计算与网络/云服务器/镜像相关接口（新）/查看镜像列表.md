...
| Filters |[  array of Filter ](https://www.qcloud.com/document/api/213/9451#filter)|否 | 查询过滤器 。 可选值包括 `image-id`, `image-type`
...
| ImageSet |[  array of Image ](https://www.qcloud.com/document/api/213/9451#image)| 一个关于镜像详细信息的结构体，主要包括镜像的主要状态与属性
...
>&Filters.0.Values.1=img-xja1nd13
