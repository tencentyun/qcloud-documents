...
* 目前只支持扩容随实例购买的数据盘，且[数据盘类型](https://www.qcloud.com/document/api/213/9452#block_device)为：`CLOUD_BASIC`、`CLOUD_PREMIUM`、`CLOUD_SSD`。
* 目前不支持[CDH](https://www.qcloud.com/document/product/416)实例使用该接口扩容数据盘。
