...
* 目前只支持[系统盘类型](https://www.qcloud.com/document/api/213/9452#block_device)是`CLOUD_BASIC`、`CLOUD_PREMIUM`、`CLOUD_SSD`类型的实例使用该接口进行机型调整。
* 目前不支持[CDH](https://www.qcloud.com/document/product/416)实例使用该接口调整机型。
