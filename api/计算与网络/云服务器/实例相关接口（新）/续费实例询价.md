...
|InstanceChargePrepaid |[ InstanceChargePrepaid object](https://www.qcloud.com/document/api/213/9451#instancechargeprepaid7)| 是 |预付费模式，即包年包月相关参数设置。通过该参数可以指定包年包月实例的续费时长、是否设置自动续费等属性。|
