...
| InstanceIds.N| array of Strings| 否| 按照一个或者多个实例ID查询。实例ID形如：`ins-11112222`。此参数的具体格式可参考API[简介](https://www.qcloud.com/doc/api/229/568)的`id.N`一节）。
...
| InstanceStatusSet|[ array of [InstanceStatus]() objects](https://www.qcloud.com/document/api/213/9451#instancestatus16)| [实例状态](/document/api/213/9452#INSTANCE_STATE)列表。|
