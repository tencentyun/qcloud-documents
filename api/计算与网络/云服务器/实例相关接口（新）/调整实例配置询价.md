...
* 目前只支持[系统盘类型](https://www.qcloud.com/document/api/213/9452#block_device)是`CLOUD_BASIC`、`CLOUD_PREMIUM`、`CLOUD_SSD`类型的实例使用该接口进行调整机型询价。
* 目前不支持[CDH](https://www.qcloud.com/document/product/416)实例使用该接口调整机型询价。
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
|Price|[Price](https://www.qcloud.com/document/api/213/9451#price) object|该参数表示调整成对应机型实例的价格。|
