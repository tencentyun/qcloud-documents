...
|ImageId|String|是|[镜像](/document/product/213/4940)ID。每一个镜像都有唯一ID标识。镜像类型分为以下四种：<br/><li>公共镜像</li><li>自定义镜像</li><li>共享镜像</li><li>服务市场镜像</li><br/>`公共镜像`、`自定义镜像`、`共享镜像`的镜像ID可通过登录[控制台](https://console.cloud.tencent.com/cvm/image?rid=1&imageType=PUBLIC_IMAGE)查询；`服务镜像市场`的镜像ID可通过[云市场](https://market.cloud.tencent.com/list)查询。<br/><br/>用户也可通过调用接口 [DescribeImages](/document/api/213/9418) ，从返回的镜像列表中获取镜像ID。|
