## 1. API Description
This API (DescribeZoneAbility) is used to query the capacities of availability zones, including [Cloud Block Storage](https://www.qcloud.com/document/product/439/6329) and [Virtual Private Cloud](https://www.qcloud.com/doc/product/215/535).
...
| capacity.n| Yes | String | The capacity to query. Query for CBS and VPC capacities is supported currently (This API allows passing multiple IDs at a time. For the format of this parameter, refer to `id.n` section in [API Introduction](https://www.qcloud.com/doc/api/229/568)).
