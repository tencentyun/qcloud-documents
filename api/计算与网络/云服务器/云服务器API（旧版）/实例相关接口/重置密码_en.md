...
This API (ResetInstancePassword) is used to reset the password of the instance's operating system to a user-specified value.
...
* Batch operation is supported to modify the passwords of multiple CVM instances to the same password.
* Password resetting is only allowed for instances that have been shut down.
...
| password | Yes | String | Password of instance. <br>Linux instance's password should be a combination of 8-16 characters comprised of at least two of the following types: letters [a-z, A-Z], numbers [0-9], and special symbols [( ) &#96; ~ ! @ # $ % ^ & * - + = &#124; { } [ ] : ; ' , . ? / ]. <br><br>Windows instance's password should be a combination of 12-16 characters comprised of at least three of the following types: lowercase letters [a-z], uppercase letters [A-Z], numbers [0-9] and special symbols [( ) &#96; ~ ! @ # $ % ^ & * - + = { } [ ] : ; ' , . ? /]. |
