...
在创建实例前，我们首先需要确定其配置，因为它决定了用户所创建实例的性能。有关配置用户可以参考[实例规格](https://cloud.tencent.com/document/product/213/11518) 和 [CVM实例配置](https://cloud.tencent.com/doc/product/213/2177)。
