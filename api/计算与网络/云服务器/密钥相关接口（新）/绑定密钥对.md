...
| InstanceIds.N  | array of Strings | 是 | 一个或多个待操作的实例`ID`，每次请求批量实例的上限为100。可通过[`DescribeInstances`](https://www.qcloud.com/doc/api/229/831)接口返回值中的`InstanceId`获取，实例`ID`也可以通过登录[控制台](https://console.cloud.tencent.com/cvm/index)查询。|
