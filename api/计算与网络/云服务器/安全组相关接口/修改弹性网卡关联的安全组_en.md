...
## 2. Input Parameters
The following request parameter list only provides API request parameters. Public request parameters need to be added when the API is called. See the Public Request Parameters page for details. The Action field for this API is ModifySecurityGroupsOfNetworkInterface.
...
<tr>
<td> networkInterfaceSet <td> Yes <td> Array <td> Data list for NIC and security group association
</tbody></table> 

Data fields for elastic NIC and security group association
<table class="t"><tbody><tr>
<th><b>Parameter Name</b></th>
<th><b>Required</b></th>
<th><b>Type</b></th>
<th><b>Description</b></th>
<tr>
<td> networkInterfaceId <td> Yes <td> String <td> Elastic NIC ID; associates all the passed NICs with all the passed security groups in order
<tr>
