...
|---------|---------|---------|
| code | Int | Error code; 0: Succeeded; other values: Failed. For more information, refer to <a href="http://intl.cloud.tencent.com/document/product/377/8946" title="错误码">Error Code</a> page.
...
Take calling API via [Final Request](https://intl.cloud.tencent.com/document/product/377/8939) as an example, the possible instruction return parameters when the call succeeds and fails are as follows:
