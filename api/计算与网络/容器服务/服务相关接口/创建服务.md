...
| nodeAffinity |  节点亲和性 | Object Array  |否 |
| podAffinity |  Pod亲和性 | Object Array  |否 |
...
|values |指定节点亲和性Label的value值，可有多个值|String Array|
...
|---------|---------|---------|
|key |卷名称 |String| 
|operator |卷在容器中的挂载点 |String| 
|values |容器对卷的访问方式，ro 为只读，rw 为读写|String|
