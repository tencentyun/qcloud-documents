...
>
## 接口描述
本接口（DescribeClusterServiceText）用于获取服务的文本信息。
...
| bSimple| 是否使用删减不必要字段的 yaml | Int | 否 |
...
| serviceText | yaml 配置详情完整版文本 | String |
| servicePureText | yaml 配置详情纯净版文本 | String |

## 示例
### 输入
```
 https://domain/v2/index.php?Action=DescribeClusterServiceText
  &clusterId=cls-xxxxx
  &namespace=default
  &serviceName=nginx
  &其它公共参数
...
```
{
    "data":{
        ...
        "codeDesc":"Success",
        "data":{
            "serviceText":"xxxxxyaml详情完整版",
			"servicePureText": "xxxxxyaml详情纯净版"
        }
    },
    "message":"",
    "code":0
