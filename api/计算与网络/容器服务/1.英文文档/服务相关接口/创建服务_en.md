## 1. API Description
This API (CreateClusterService ) is used to create service.
...
| envs.n | Container environment variable array. For more information, please see envs. Variable name can only contain uppercase and lowercase letters, numbers and underscores, and cannot start with a number. | Object Array | No |
