...
|instances.n|实例名称数组，请填写 [查询服务实例列表](https://cloud.tencent.com/document/api/457/9433) 接口中返回的 instances.name 字段|  String| 是|
|namespace | 命名空间，请填写 [查询服务列表](https://cloud.tencent.com/document/api/457/9440) 接口中返回的 namespace 字段，默认为 default|String |否 | 
