...
2. 单击【云产品】，选择【访问与审计】栏下的【访问管理】，进入访问管理页面。
3. 选择左侧导航栏的【访问密钥】>【API密钥管理】，在 [ API密钥管理](https://console.cloud.tencent.com/capi) 页面，单击【新建密钥】即可以创建一对 SecretId/SecretKey。
...
| 4101 | 未被开发商授权访问本接口 | 该子用户未被授权调用此接口。请联系开发商授权，详情请查阅 [策略](https://cloud.tencent.com/document/product/598/10601)。|
| 4102 | 未被开发商授权访问本接口中所操作的资源 | 请求的资源参数中，存在未被开发商授权访问的资源，请在 message 字段中查看无权查看的资源 ID。</br>请联系开发商授权，详情请查阅 [策略](https://cloud.tencent.com/document/product/598/10601)。|
