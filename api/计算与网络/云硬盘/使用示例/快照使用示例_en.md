In order to help you get started with snapshot API quickly, we provide an example on how to use it.

In this example, we first create a snapshot for the specified cloud disk, and then roll this snapshot back to the cloud disk.
...
| --- | --- | --- |
| storageId | ID of the cloud disk that needs to create snapshots |  disk-nmnaafrh |
...
| storageId | ID of the cloud disk to which the snapshot is to be rolled back | disk-nmnaafrh |
