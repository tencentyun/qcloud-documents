...
|---------|---------|---------|
| code | Int | Common error code; 0: Succeeded; other values: Failed. For more information, refer to<a href="https://intl.cloud.tencent.com/document/product/362/4207" title="Common request parameters">Common Error Code</a>. |
