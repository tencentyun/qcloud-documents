...
| storageType | 是 | String | 云硬盘类型。普通云硬盘：cloudBasic；高性能云硬盘：cloudPremium；SSD云硬盘：cloudSSD|
| storageSize | 是 | Int | 云硬盘大小，单位为 GB。<br>普通云硬盘最小 10GB，高性能云硬盘最小 50GB，SSD 云硬盘最小 100GB，步长均为10GB。|
| goodsNum | 是 | Int | 购买云硬盘的数量，最大值为 50 | 
