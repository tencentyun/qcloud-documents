...
使用限制：
1. 只支持续费弹性云盘。云硬盘类型可以通过[DescribeCbsStorages（查询云硬盘信息）](https://www.qcloud.com/doc/api/364/2519)接口查询，见输出参数中`portable`字段解释 
...
| 16000 | DiskNotFound | 磁盘不存在 |
| 9006 | ServerInternalError | 服务器后台错误 |
