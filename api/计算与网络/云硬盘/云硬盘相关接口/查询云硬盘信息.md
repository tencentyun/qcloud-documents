...
| zone | 否 | string | 云盘所处的可用区，取值详见[地域和可用区](https://www.qcloud.com/document/product/213/6091) |
...
| zone | string | 云盘所处的可用区，取值详见[地域和可用区](https://www.qcloud.com/document/product/213/6091) 
