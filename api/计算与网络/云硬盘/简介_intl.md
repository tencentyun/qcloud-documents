...
Cloud Block Storage (CBS) is a highly available, highly reliable, low-cost, customizable network block storage device. For more information, please refer to [CBS Product Overview](https://intl.cloud.tencent.com/doc/product/362/2345).

Users can perform relevant operations (such as creating elastic cloud storage, creating snapshot or roll backing snapshot etc.) on cloud disk or snapshots with the APIs described in this document by referring to [API Overview](https://intl.cloud.tencent.com/doc/api/231/1723).

Before using these APIs, please make sure that you have a thorough understanding of [CBS Product Overview](https://intl.cloud.tencent.com/doc/product/362/2345), [Tips on Usage](https://intl.cloud.tencent.com/doc/product/362/2922) and [Billing Methods](https://intl.cloud.tencent.com/doc/product/362/2413).
...
| Description | This refers to distributed block storage independently developed by Tencent Cloud and called Could Storage for short. For more information, please refer to [CBS Product Overview](https://intl.cloud.tencent.com/doc/product/362/%E4%BA%A7%E5%93%81%E6%A6%82%E8%BF%B0).It includes cloud disk purchased with CVM and elastic cloud storage purchased separately. |
...
| snapshot |   [Cloud Disk Snapshot](https://cloud.tencent.com/doc/product/213/502) 
...
1. Create an elastic cloud storage: You can use the API [CreateCbsStorages (Create Elastic Cloud Storage)](https://cloud.tencent.com/document/api/364/2524) to create an elastic cloud storage.
...
2. Rollback the cloud disk snapshot: If necessary, you can use the API [ApplySnapshot (rollback snapshot)](https://cloud.tencent.com/document/api/364/2533) to roll back the snapshot to the specified cloud disk.


## 3. Usage Restriction

For restrictions on the usage of CBS and snapshot, please refer to [CBS Usage Restrictions](https://intl.cloud.tencent.com/doc/product/362/5145). For restrictions on specific parameters, please refer to the descriptions of output parameters in the related API's documentation.
