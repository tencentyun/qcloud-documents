...
| 参数名称 | 类型 | 是否必选 | 描述 |
|---------|---------|---------|---------|
| snapshot-id | String | 否 |（过滤条件）按照快照的ID过滤。云盘ID形如：`snap-11112222`|
...
| SnapshotSet | array of SnapshotSet objects | 快照的详情列表。 |
...
<pre>
https://cvm.api.qcloud.com/v2/index.php?Action=DescribeSnapshots
&Version=2017-03-12
