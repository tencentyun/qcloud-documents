...
SecretId：`AKIDz8kr*****FkmLPx3gnPhESA`
...
| SecretId | 密钥 ID | `AKIDz8kr*****FkmLPx3gnPhESA` | 
...
```php
$secretKey = 'Gu5t9xGARNpq*****N3Cozk1qA';
$srcStr = 'GETckafka.api.qcloud.com/v2/index.php?Action=ListInstances&Nonce=11886&Region=ap-guangzhou&SecretId=AKIDz8kr*****FkmLPx3gnPhESA&SignatureMethod=HmacSHA256&Timestamp=1465185768';
...
$srcStr = 'GETcckafka.api.qcloud.com/v2/index.php?Action=ListInstances&Nonce=11886&Region=ap-guangzhou&SecretId=AKIDz8kr*****FkmLPx3gnPhESA&SignatureMethod=HmacSHA1&Timestamp=1465185768';
...
| 4102 | 未被开发商授权访问本接口中所操作的资源 | 请问的资源参数中，存在未被开发商授权授权访问的资源，请在 message 字段中查看无权查看的资源 ID。请联系开发商授权，详情请查阅 [授权策略](https://cloud.tencent.com/document/product/378/4513)。|
