...
|defaultNumPartitions|否|Int|自动创建主题分区个数，可选，如果autoCreateTopicEnable设置为true没有设置该值时，默认设置为3。|
|defaultReplicationFactor|否|Int|自动创建主题副本数，可选，如果autoCreateTopicEnable设置为true 没有指定该值时默认设置为2。|
