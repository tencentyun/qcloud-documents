...
| routeTableName | 否 |  String | 路由表名称，可任意命名，但不得超过60个字符。同一个VPC下名称不可重复。 |
...
| RouteLimitExceeded | 路由表策略数超过上限。如果需要更多资源，请联系客服申请。更多vpc资源限制信息详见<a href="https://www.qcloud.com/doc/product/215/537" title="VPC使用限制">VPC使用限制</a>。 |
