...
| ipPool.n | No | Array |  IP range of sslVPN terminal. |
...
| acl.n.sourceCidr | String | Yes | Source IP or source network segment. |
| acl.n.destinationCidr | String | Yes | Destination IP or network segment. |
