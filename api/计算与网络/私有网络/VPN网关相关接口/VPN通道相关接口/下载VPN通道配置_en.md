...
This API (GetVpnConnConfig) is used to download VPN channel configuration.
...
| interfaceName | Yes | String | Name of the physical interface for channel access device.  |  
