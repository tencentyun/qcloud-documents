...
|---------|---------|---------|---------|
| userGwId | Yes | String | Peer gateway ID, for example: cgw-ekrvxcdv. You can query peer gateways by using the <a href="https://www.qcloud.com/doc/api/245/%e6%9f%a5%e8%af%a2%e5%af%b9%e7%ab%af%e7%bd%91%e5%85%b3?viewType=preview" title="DescribeUserGw">DescribeUserGw</a> API.  |
