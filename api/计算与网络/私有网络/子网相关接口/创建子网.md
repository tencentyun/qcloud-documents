...
| subnetSet.n.zoneId | 是 | String | 子网所在的可用区 ID，不同子网选择不同可用区可以做跨可用区灾备，取值详见<a href="https://cloud.tencent.com/document/product/215/20057#.E5.8F.AF.E7.94.A8.E5.8C.BA.EF.BC.88zone.EF.BC.89"> VPC 可用区说明</a>。 |
...
| InvalidZone.NotFound | 无效的可用区 ID，您输入的可用区不存在或者该可用区不支持私有网络，更多可用区信息参见<a href="https://cloud.tencent.com/document/product/215/20057#.E5.8F.AF.E7.94.A8.E5.8C.BA.EF.BC.88zone.EF.BC.89"> 私有网络可用区说明</a>。 |
