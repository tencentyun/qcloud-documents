...
| zoneIds | No | Array | Availability zone ID. Refer to <a href="https://www.qcloud.com/doc/product/215/4927#.E5.8F.AF.E7.94.A8.E5.8C.BA.EF.BC.88zone.EF.BC.89">VPC Availability Zone Instruction</a> for details.  |
...
| data.n.networkAclId | String | ID of the network ACL that is bound to the subnet (0 if there is no ACL bound to the subnet). For example: acl-e9dbyl8s. Refer to <a href="https://www.qcloud.com/doc/api/245/1441" title="查询网络ACL"> Network ACL related APIs</a> for details. |
