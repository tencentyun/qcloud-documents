...
本接口（ModifyLocalIPTranslationAclRule）用于修改本端 IP 转换 ACL 策略。
接口请求域名：vpc.api.qcloud.com


## 2. 输入参数
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，详情请参见<a href="https://cloud.tencent.com/document/product/215/4772" title="公共请求参数"> 公共请求参数 </a>页面。其中，此接口的 Action 字段为 ModifyLocalIPTranslationAclRule。
...
| aclRules.n.aclRuleId | 是 | Int | 系统分配的 acl ID，例如25。 |
