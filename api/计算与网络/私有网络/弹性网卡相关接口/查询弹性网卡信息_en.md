...
This API (DescribeNetworkInterfaces) is used to query the information of elastic NIC.
...
|---------|---------|---------|---------|
| vpcId | No | String | Virtual private cloud ID of elastic NIC, for example: vpc-7t9nf3pu |
| networkInterfaceId | No | String | Elastic NIC ID assigned by the system, for example: eni-m6dyj72l |
| eniName | No | String | Elastic NIC name, support fuzzy search |
| eniDescription | No | String | Elastic NIC description, support fuzzy search |
...
| totalCount | Int | Total number of elastic NICs |
| data.n | Array | Elastic NIC information array |
**data array:**

| Parameter Name | Type | Description |
|---------|---------|---------|
| data.n.vpcId | String | Virtual private cloud ID of elastic NIC, for example: vpc-8e0ypm3z | 
| data.n.subnetId | String | Subnet ID of elastic NIC,  for example: subnet-0ap8nwca | 
| data.n.zoneId | int | Availability zone ID of the subnet of elastic NIC, for example: 200001 | 
| data.n.eniName | String | Elastic NIC name, support fuzzy search | 
| data.n.eniDescription| String | Elastic NIC description | 
| data.n.networkInterfaceId | String | Elastic NIC ID, for example: eni-m6dyj72l | 
| data.n.primary | Bool | Indicate whether it is a primary NIC. true: primary NIC; false: ordinary NIC | 
| data.n.macAddress| String | Elastic NIC mac address | for example: 02: 81: 60: cb: 27: 37 | 
| data.n.privateIpAddressesSet | Array | IP information bound to elastic NIC | 
| data.n.instanceSet | Array | CVM information bound to elastic NIC | 
| data.n.groupSet | Array | Security group information bound to elastic NIC | 
