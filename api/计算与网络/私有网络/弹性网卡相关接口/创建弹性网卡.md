...
| eniName | 是 | String | 弹性网卡名称，可任意命名，但不得超过60个字符。在同一个VPC内名称不能重复。 |
...
| NetworkInterfaceLimitExceeded | 创建的弹性网卡数量超过上限。如果需要更多资源，请联系客服申请。更多VPC资源限制信息详见<a href="https://www.qcloud.com/doc/product/215/537" title="VPC使用限制">VPC使用限制</a> |
