...
This API (AttachNetworkInterface) is used to request private IP for elastic NICs.
Domain for API request: <font style="color:red">vpc.api.qcloud.com</font>

1) A CVM can bind multiple elastic NICs but one primary NIC. For more information on VPC resources restrictions, refer to <a href="https://www.qcloud.com/doc/product/215/537" title="VPC Usage Restrictions">VPC Usage Restrictions</a>.
2) An elastic NIC can only be bound to a CVM simultaneously.
...
4) Elastic NICs must be bound to a VPC CVM, and the availability zone of the CVM must be the same as that of elastic NICs.
