...
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见<a href="/doc/api/372/4153" title="公共请求参数">公共请求参数</a>页面。其中，此接口的Action字段为 CreateService

| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| serviceName | 是 | String | 协议端口名称 |
| service | 是 | Array| 协议端口列表 |
| service.n | 是 | String | 协议端口。支持多种格式，详见<a href='https://www.qcloud.com/document/product/215/9882#.E7.AE.80.E4.BB.8B' title='参数模板产品文档'>参数模板产品文档</a> |
