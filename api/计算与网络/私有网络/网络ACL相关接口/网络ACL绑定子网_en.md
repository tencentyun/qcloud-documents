...
| networkAclId | Yes | String | Network ACL ID assigned by the system. For example: acl-e9dbyl8s. Can be queried via the API <a href="https://www.qcloud.com/doc/api/245/1441" title="DescribeNetworkAcl">DescribeNetworkAcl</a>.  | 
