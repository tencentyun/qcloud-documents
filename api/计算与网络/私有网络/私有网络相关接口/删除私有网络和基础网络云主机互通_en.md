...
| instanceIds.n | Yes | Array | Basic network CVM ID, for example: instanceIds.0=ins-df454d. It can be queried via API <a href="https://www.qcloud.com/doc/api/229/831" title="Query Instance List">DescribeInstances</a>.  |
...
| taskId | Int | Task ID. The operation result can be queried with taskId. For more information, please see <a href="https://www.qcloud.com/doc/api/245/%e6%9f%a5%e8%af%a2%e4%bb%bb%e5%8a%a1%e6%89%a7%e8%a1%8c%e7%bb%93%e6%9e%9c%e6%8e%a5%e5%8f%a3">Query Task Execution Result</a>. |
...
|---------|---------|
| InvalidInstance.NotFound | The CVM does not exist. Please verify that the instanceId you entered is correct. To query the CVMs under the VPC, please see <a href="https://www.qcloud.com/doc/api/229/831" title="Query CVM Instance List">Query CVM Instance List</a>.  |
