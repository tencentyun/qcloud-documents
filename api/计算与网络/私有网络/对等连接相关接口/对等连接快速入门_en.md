...
If you are receiver, you can use API [Accept Regional Peering Connection](/doc/api/372/2106) to accept the regional peering connection created by the initiator's developer.
...
The cross-regional interconnection is configured in the same way as regional interconnection. For application scenarios of peering connection, refer to <a href="https://www.qcloud.com/doc/product/215/5000" title="对等连接">Peering Connection Overview</a>
