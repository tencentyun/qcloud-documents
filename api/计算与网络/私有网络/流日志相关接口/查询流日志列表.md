...
| resourceType | 否 | String | 流日志所属资源类型，NETWORKINTERFACE。 |
| resourceId | 否 | String | 资源唯一 ID，如 eni-08dhim。 |
...
| data.n.resourceType | String | 流日志所属资源类型，NETWORKINTERFACE。 |
| data.n.resourceId | String | 资源唯一 ID，如 eni-08dhim。 |
