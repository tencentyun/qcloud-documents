...
## 2. 请求参数
   以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](/doc/api/244/4183)页面。其中，此接口的Action字段为 ModifyBmLoadBalancerAttributes。
...
<a href="/doc/api/244/4007">DescribeBmLoadBalancersTaskResult</a>接口来查询任务操作结果。
</tbody></table>
