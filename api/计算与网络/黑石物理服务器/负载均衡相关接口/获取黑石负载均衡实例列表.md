...
## 2. 请求参数
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](/doc/api/244/4183)页面。其中，此接口的Action字段为DescribeBmLoadBalancers。
...
&COMMON_PARAM
&loadBalancerIds.0=lb-ncsb0c7j
&loadBalancerIds.1=lb-rg1b0d9h
&loadBalancerType=2
```
...
```
{
    ...
    "loadBalancerSet": [
        {
            "loadBalancerId": "lb-ncsb0c7j",
            "loadBalancerName": "12f-LB",
            "loadBalancerType": 2,
        ...
        {
            "loadBalancerId": "lb-rg1b0d9h",
            "loadBalancerName": "130-LB",
            "loadBalancerType": 2,
