...
| 参数名称 | 是否必选  | 类型 | 描述 |
|---------|---------|---------|---------|
|rules.n.domainId|是|String|负载均衡七层转发域名ID，可通过接口[DescribeBmForwardRules](/doc/api/386/9285)查询。|
|rules.n.locationId|是|String|负载均衡七层转发路径ID，可通过接口[DescribeBmForwardRules](/doc/api/386/9285)查询。|
