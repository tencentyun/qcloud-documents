...
## 2. 请求参数
   以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](/doc/api/386/6718)页面。其中，此接口的Action字段为 ModifyBmLoadBalancerAttributes。
...
<td> 是
<td> String
<td>  负载均衡实例ID，可通过<a href="/doc/api/386/9306" title="DescribeLoadBalancers">DescribeBmLoadBalancers</a>接口查询。
...
<a href="/doc/api/386/9308">DescribeBmLoadBalancersTaskResult</a>接口来查询任务操作结果。
</tbody></table>
