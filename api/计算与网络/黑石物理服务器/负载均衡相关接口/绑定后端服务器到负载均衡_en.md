...
This API (RegisterInstancesWithLoadBalancer) is used to bind backend CPMs to a BM load balancer instance.
...
| 12013 | InvalidResource.BindedCVMNumberOverLimit | The number of CPMs bound to this BM load balancer has exceeded the limit |
