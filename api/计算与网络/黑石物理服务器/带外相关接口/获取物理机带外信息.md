...
输入
```
https://bm.api.qcloud.com/v2/index.php?Action=GetDeviceOutBandInfo&SecretId=AKID52SKw5uMEy3jhpMUBqSylEBJBby6E0KC&Nonce=44687&Timestamp=1476432466&Region=bj&appId=1251001002&instanceId=cpm-d1pryrrb&Signature=l6nVFp%2BijJjLGRakoQ3imrCjFks%3D
```
输出
```
{
