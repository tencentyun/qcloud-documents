...
| data | Array | Returned operation task ID. You can query the creation result by calling API <a href="" title="Query Task Status of Binding Subnet to BM NAT Gateway">Query Task Status of Binding Subnet to BM NAT Gateway</a> |
