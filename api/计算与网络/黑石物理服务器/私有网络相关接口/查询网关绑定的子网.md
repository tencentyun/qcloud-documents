...
| data.n.subnets.n.name |  vpc 网络名称 |String |
| data.n.subnets.n.unSubnetId | 子网统一 ID | String |
| data.n.subnets.n.subnetId |  子网 ID |Int |
| data.n.subnets.n.subnetNatType |  子网绑定的类型, 0 表示绑定部分IP的子网，1表示绑定全部 IP 的子网 |Int |
