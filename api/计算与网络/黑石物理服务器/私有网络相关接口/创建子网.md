...
| subnetSet.n.distributedFlag | 否 | Int | 是否开启子网分布式网关，默认传1，传0为关闭子网分布式网关。关闭分布式网关子网用于虚拟化子网，此子网中只能有一台物理机，同时此物理机及其上子机只能在此子网中。 |
...
| subnetSet.n.distributedFlag | Int | 子网分布式开关参数，1为开启，0为关闭。|
