...
2) 单击【云产品】，选择【基础产品】栏下【管理工具】中的【云API密钥】，进入云API密钥管理页面。
...
>!“参数值”为原始值而非url编码后的值。2、若输入参数中包含下划线，则需要将其转换为“.”。
...
2) 请求主机:[绑定服务器 EIP](/document/product/386/6673)(EipBmBindRs)的请求域名为：bmeip.api.qcloud.com。实际的请求域名根据接口所属模块的不同而不同, 详见各接口说明。
...
>!如果用户的请求方法是GET，则对所有请求参数值均需要做URL编码。
如上一步生成的签名串为iMn4MF6H0mDBCTOhx/t/LjMWs2g=，则其编码后为iMn4MF6H0mDBCTOhx%2ft%2fLjMWs2g%3d。因此，最终得到的签名串请求参数(Signature)为：iMn4MF6H0mDBCTOhx%2ft%2fLjMWs2g%3d，它将用于生成最终的请求 URL。
