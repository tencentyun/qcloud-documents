## 1. API Description
This API (StartDevice) is used to start a CPM.
Domain: <font style="color:red">bm.api.qcloud.com</font>
...
| 12002 | OperationDenied.IncorrectInstanceStatus | Cannot start the device |
