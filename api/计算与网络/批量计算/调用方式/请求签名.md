...
## 申请安全凭证
在第一次使用腾讯云 API 之前，用户需要在【腾讯云控制台】> 【[API密钥管理](https://console.cloud.tencent.com/cam/capi) 】上申请安全凭证。安全凭证包括 SecretId 和 SecretKey，其中：
...
2. 单击【云产品】，选择【访问管理】栏下的【访问密钥】>【API密钥管理】，进入 API 密钥管理页面。
