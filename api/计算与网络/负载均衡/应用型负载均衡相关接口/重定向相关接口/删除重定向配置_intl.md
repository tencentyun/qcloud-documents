...
| delRewriteInfo | Yes | Array | Forwarding rules of redirect relationship. Batch operations are supported. |
...
delRewriteInfo is a list and each element is a redirect configuration that is composed of the following fields:
