...
|参数名称|必选|类型|描述|	 
|-|-|-|-|
|loadBalancerIds.n|是|String|应用型负载均衡实例 ID，可通过 <a href="https://cloud.tencent.com/document/api/214/1261" title="DescribeLoadBalancers">DescribeLoadBalancers</a> 接口同时入参 forward 字段为1 或者-1来查询，本接口限制负载均衡的个数不超过30。|
