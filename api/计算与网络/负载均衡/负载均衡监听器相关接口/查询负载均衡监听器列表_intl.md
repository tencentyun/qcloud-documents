...
| httpCode | Int | Health check return code of the conventional public network-based load balancer listener with HTTP or HTTPS protocol. For more information, please see [Create Listener](https://cloud.tencent.com/document/product/214/1255). |
