...
## 请求参数
   ...
   以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见 [公共请求参数](/doc/api/244/4183) 页面。其中，此接口的 Action 字段为 ModifyLoadBalancerListener。
...
|listenerId|是|String|负载均衡监听器 ID，可通过 <a href="https://cloud.tencent.com/document/api/214/1260" title=" DescribeLoadBalancerListeners"> DescribeLoadBalancerListeners</a> 接口查询。|
