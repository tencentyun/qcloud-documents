...
## 负载均衡相关接口
>?如下旧版负载均衡 API 接口已升级到 3.0 版本，旧版 API 接口未来可能停止维护，目前不展示在左侧导航。负载均衡 API 3.0 版本接口定义更加规范，访问时延下降显著，建议使用 [负载均衡 API 3.0](https://cloud.tencent.com/document/product/214/30667#.E8.B4.9F.E8.BD.BD.E5.9D.87.E8.A1.A1.E7.9B.B8.E5.85.B3.E6.8E.A5.E5.8F.A3)。
