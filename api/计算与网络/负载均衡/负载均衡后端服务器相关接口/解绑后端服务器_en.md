## 1. API Description
 ...
 DeregisterInstancesFromLoadBalancer API is used to unbind one or more CVMs from the cloud load balancer instance.
 
Domain for API access: lb.api.qcloud.com

## 2. Request Parameters
   The following request parameter list only provides API request parameters. Common request parameters need to be added when the API is called. For more information, refer to [Common Request Parameters](/doc/api/244/4183). The Action field for this API is DeregisterInstancesFromLoadBalancer.
