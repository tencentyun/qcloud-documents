>!
- 腾讯自然语言处理已于2019年7月09日正式发布新版，接口功能更全面，服务更加稳定，且公测期间免费试用。
- 老版本接口我们不再继续维护，且不支持新客户开通调用，建议您使用 [新版 API 文档](https://cloud.tencent.com/document/product/271/35484)，体验更优服务。
