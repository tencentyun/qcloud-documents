...
希望您在**2020年2月29日前**将现有接口服务调用迁移为 API 2018-05-04，从**2020年3月1日起**，云搜接口 API 2017 将会下线，未及时迁移将会影响您的正常使用。

在迁移过程中出现的任何问题都可以在技术支持 QQ 群（腾讯云搜 API 迁移技术支持群，QQ 群号：9834402360）中咨询，我们将竭诚为您解答。
