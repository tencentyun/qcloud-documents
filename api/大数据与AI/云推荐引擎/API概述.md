...
API 详情可参见 [行为数据上报 API](https://cloud.tencent.com/document/product/625/11475)。
...
用户完成用户行为数据和物料数据提交后，便可以通过相应的推荐 API 获取推荐结果。API 详情可参见 [推荐服务请求 API](https://cloud.tencent.com/document/product/625/11474)。
