...
| [增加人脸](/document/product/867/17583#.E5.A2.9E.E5.8A.A0.E4.BA.BA.E8.84.B8) | 将一组 face 加入到一个 person 中。注意，一个 face只能被加入到一个 person 中。 一个 person 最多允许包含 20个 face ；加入几乎相同的人脸会返回错误。 |
