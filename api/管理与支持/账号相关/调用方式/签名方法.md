...
2. 单击【云产品】，选择【监控与管理】栏下的【访问密钥】，进入云 API 密钥管理页面。
3. 在 [云 API 访问密钥管理](https://console.cloud.tencent.com/capi) 页面，单击【新建密钥】即可以创建一对 SecretId/SecretKey，每个账号最多可以拥有两对 SecretId/SecretKey。
