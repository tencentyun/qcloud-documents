...
| paging.index | 必选 | Integer | 页面索引，0 表示第 1 页 |
...
| transRules | [obj,…] | Array | 攻击详情数组，数组元素如下：</br>{</br>"id": "rule-00000001",</br>"protocol": "http" </br>"domain": "www.qq.com",</br>"sourceType": 1/2,</br>"ipList": "1.2.3.4；1.1.1.1",</br>"certType": 1,</br>"cert": "",</br>"privateKey": "",</br>"status": 1/2/3,</br>"ssl_id": ""</br>} |
