## API Description
This API (BGPIPGetServicePacks) is used to obtain all the High-Defense IP lists under a specified user name, in which each entry contains information about High-Defense IP.
Protocol: `HTTPS`
...
| transRules |12 | Integer | Number of forwarding rules of the High-Defense IP |
