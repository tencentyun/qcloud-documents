...
>  SecretId: AKID**********ZQpn74WFkmLPx3gnPhESA
...
| SecretId | 密钥Id | AKID**********ZQpn74WFkmLPx3gnPhESA | 
...
```
Action=DescribeInstances&Nonce=11886&Region=gz&SecretId=AKID**********ZQpn74WFkmLPx3gnPhESA&Timestamp=1465185768&instanceIds.0=ins-09dx96dg&limit=20&offset=0
```
...
```
GETcvm.api.qcloud.com/v2/index.php?Action=DescribeInstances&Nonce=11886&Region=gz&SecretId=AKID**********ZQpn74WFkmLPx3gnPhESA&Timestamp=1465185768&instanceIds.0=ins-09dx96dg&limit=20&offset=0
```
...
$srcStr = 'GETcvm.api.qcloud.com/v2/index.php?Action=DescribeInstances&Nonce=11886&Region=gz&SecretId=AKID**********ZQpn74WFkmLPx3gnPhESA&Timestamp=1465185768&instanceIds.0=ins-09dx96dg&limit=20&offset=0';
