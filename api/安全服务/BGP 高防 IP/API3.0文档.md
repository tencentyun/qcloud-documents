...
您可以使用 API 3.0接口文档介绍的 API，并参照相应的示例，对 DDoS 高防 IP 进行相关操作：如四层接入配置、销毁、CC 防护策略配置、获取 DDoS 攻击数据等。由于当前 DDoS 防护产品（包括 DDoS 基础防护、DDoS 高防包和 DDoS 高防 IP）共用一份 API 文档，该公共 API 文档在 DDoS 高防包产品文档下，因此 DDoS 高防 IP 的相关 API 接口，请参见 [API 概览](https://cloud.tencent.com/document/api/1021/39215)。
