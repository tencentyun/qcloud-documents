...
QMS 请求域名接口和说明可参考 [地域和域名说明](https://cloud.tencent.com/document/api/213/6976)。
> 注意：
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| code | Int | 请参考 [错误码](https://cloud.tencent.com/document/product/847/16547)|
...
| alias| 否| String| 作为密钥更容易辨识，更容易被人看懂的别名。|可为空。0-32 个字符。|
...
| type | Int| 指定 key 类型，1 为普通类型，2 为量子类型。||||
