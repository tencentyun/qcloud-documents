...
Taking the CVM API "View Instance Status List" (DescribeInstancesStatus) (version 2017-03-12) as an example, if it is successfully called, the possible returned result is as follows:
