...
For an incremental migration task, when the migration is ready to complete, call this API to complete the migration of incremental data.
This API is called only to complete an ongoing migration task that is ready to complete.
