...
This API is used to cancel a data migration task.
This API can be called to cancel a migration task during the migration process. The task will fail once canceled.
...
### Example 1 Cancel a data migration task
