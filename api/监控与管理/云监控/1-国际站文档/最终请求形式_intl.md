...
1) Request domain: The request domain of [Get the List of Monitoring Metrics](https://intl.cloud.tencent.com/document/api/248/7630) (DescribeMetrics) is monitor.api.qcloud.com. The actual request domain varies depending on the module to which the API belongs. For more information, please see descriptions of APIs.
