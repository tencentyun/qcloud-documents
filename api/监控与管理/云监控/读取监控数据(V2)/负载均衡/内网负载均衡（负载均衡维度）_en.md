...
qce/lb_private is a namespace in private network load balancer dimension, and can be used to query monitoring data in the private network load balancer dimension.

qce/lb_private is used to query monitoring data based on 2 dimension groups below. The values for input parameters are as follows:

### 1.1 Values of Input Parameters for the Private Network Load Balancer Dimension
...
### 1.2 Values of Input Parameters for the Private Network Load Balancer Port Dimension
