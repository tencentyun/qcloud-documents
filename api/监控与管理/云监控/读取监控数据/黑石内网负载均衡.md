...
| connum     | 当前连接数（四层监听器） | 个    | protocol,vip,vport,rsip,rsport,vpcid |
| req     | 请求个数（七层监听器） | 个    | protocol,vip,vport,rsip,rsport,vpcid |
