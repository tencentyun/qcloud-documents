...
| dimensions.0.instanceId  | 是    | String   | instanceId        | Ckafka实例id。                           |
| dimensions.0.value | 是    | String   | 实例Id|  用户需要查看监控的实例Id。

| dimensions.1.instanceId  | 是    | String   | instanceId        | Ckafka实例id。                           |
| dimensions.1.value | 是    | String   | 实例Id|  用户需要查看监控的实例Id。

| dimensions.2.instanceId  | 是    | String   | instanceId        | Ckafka实例id。                           |
| dimensions.2.value | 是    | String   | 实例Id|  用户需要查看监控的实例Id。


| dimensions.3.instanceId  | 是    | String   | instanceId        | Ckafka实例id。                           |
| dimensions.3.value | 是    | String   | 实例Id|  用户需要查看监控的实例Id。

| dimensions.4.instanceId  | 是    | String   | instanceId        | Ckafka实例id。                           |
| dimensions.4.value | 是    | String   | 实例Id|  用户需要查看监控的实例Id。
...
| instance_pro_flow       | 实例生产流量    | MB    | instanceId   |
| instance_con_flow        | 实例消费流量   | MB    | instanceId   |
