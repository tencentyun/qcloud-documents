...
Value of dimension name: vpcId, peeringConnectionId
...
| dimensions.1.name  | Yes    | String   | vpcId               | Input parameter is the local vpcId                               |
| dimensions.1.value | Yes    | String   | Specific local vpcId          | Enter specific vpcId, such as vpc-82fov4vf                 |
...
| ---------- | ---- | ---- | ------------------------- |
| inpkg      | Inbound packets  | Packets/sec  | vpcId, peeringConnectionId |
| intraffic  | Inbound bandwidth  | Mbps | vpcId, peeringConnectionId |
| outpkg     | Outbound packets  | Packets/sec  | vpcId, peeringConnectionId |
