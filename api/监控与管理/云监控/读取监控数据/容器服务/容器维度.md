...
| 英文          | 中文含义                                     |
| ----------- | ---------------------------------------- |
| clusterId   | 请填写[查询集群列表](https://www.qcloud.com/document/api/457/9448)接口中返回的clusterId(集群的Id)字段 |
| serviceName | 请填写[查询服务列表](https://www.qcloud.com/document/api/457/9440)接口中返回的serviceName(服务名)字段 |
| namespace   | 请填写[查询服务列表](https://www.qcloud.com/document/api/457/9440)接口中返回的namespace(命名空间)字段 |
| podName     | 请填写[查询服务实例列表](https://www.qcloud.com/document/api/457/9433)接口中返回的name(实例名称)字段 |
