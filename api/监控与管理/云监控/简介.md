...
>?
>- 当前页面接口为旧版 API，未来可能停止维护。云监控 API 3.0 版本接口定义更加规范，访问时延下降显著，建议您使用 [云监控 API 3.0](https://cloud.tencent.com/document/product/248/30342)。
>- 如果您需要访问云服务器旧版 API，可参见[ API 概览](https://cloud.tencent.com/document/product/248/4474)。
