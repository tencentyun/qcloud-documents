...
Dimensions.N.resourceId：实例的资源 Id
...
拉取某个云数据库SQL Server某段时间内统计周期为5分钟的实例CPU消耗的百分比监控数据
...
&Dimensions.0.resourceId=mssql-dh01nvsb
&<公共请求参数>
```
...
拉取三个云数据库SQL Server某段时间内统计周期为5分钟的实例CPU消耗的百分比监控数据
...
&StartTime=2018-04-16 20:00:00
&EndTime=2018-04-16 20:05:00
&Dimensions.0.resourceId=mssql-aaaaaa
&Dimensions.1.resourceId=mssql-bbbbb
&Dimensions.2.resourceId=mssql-ccccc
&<公共请求参数>
```
