...
Dimensions.N.topicId：CMQ 主题实例id
Dimensions.N.subscriptionId：CMQ 订阅实例id
...
拉取某个Topic某段时间内统计周期为5分钟的已发布消息的数量监控数据
...
&Dimensions.0.topicId=topic-06c1jrku
&<公共请求参数>
```
...
拉取三个Topic某段时间内统计周期为5分钟的已发布消息的数量监控数据
...
&StartTime=2018-04-16 20:00:00
&EndTime=2018-04-16 20:05:00
&Dimensions.0.topicId=topic-aaaaaa
&Dimensions.1.topicId=topic-bbbbb
&Dimensions.2.topicId=topic-aaaaaa
&<公共请求参数>
```
