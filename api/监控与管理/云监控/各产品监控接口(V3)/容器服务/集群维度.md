...
Namespace：qce/cvm
Dimensions.N.docker_clusterid：集群ID
...
拉取某个集群某段时间内统计周期为5分钟的集群CPU利用率监控数据
...
&Dimensions.0.docker_clusterid=cls-xxxxx
&<公共请求参数>
```
...
拉取三个集群某段时间内统计周期为5分钟的集群CPU利用率监控数据
...
&StartTime=2018-04-16 20:00:00
&EndTime=2018-04-16 20:05:00
&Dimensions.0.clusterid=cls-aaaaaa
