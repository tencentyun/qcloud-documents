...
拉取某个VPN网关某段时间内统计周期为5分钟的入包量监控数据
...
&Dimensions.0.vpnGwId=vpngw-q7v069tf
&<公共请求参数>
```
...
拉取三个VPN网关某段时间内统计周期为5分钟的入包量监控数据
...
&StartTime=2018-04-16 20:00:00
&EndTime=2018-04-16 20:05:00
&Dimensions.0.vpnGwId=vpngw-aaaaaa
&Dimensions.1.vpnGwId=vpngw-bbbbb
&Dimensions.2.vpnGwId=vpngw-ccccc
&<公共请求参数>
```
