...
查询内容分发网络CDN监控数据，入参取值如下：
Namespace：qce/cdn
Dimensions.N.projectid：项目ID
Dimensions.N.domain：域名
...
&Dimensions.0.projectid=aaaaa
&Dimensions.0.domain=www.test.com
&<公共请求参数>
```
...
&Dimensions.0.projectid=aaaaa
&Dimensions.0.domain=www.test.com
&Dimensions.1.projectid=bbbbb
&Dimensions.1.domain=www.test.com
&Dimensions.2.projectid=ccccc
&Dimensions.2.domain=www.test.com
&<公共请求参数>
```
