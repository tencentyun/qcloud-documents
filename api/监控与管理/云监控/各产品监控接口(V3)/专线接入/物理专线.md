...
查询物理专线监控数据，入参取值如下：
Namespace：qce/dc
Dimensions.N.directconnectid：专线ID
...
&Dimensions.0.directconnectid=dc-e6p0gw5f
&<公共请求参数>
```
...
&StartTime=2018-04-16 20:00:00
&EndTime=2018-04-16 20:05:00
&Dimensions.0.directconnectid=dc-aaaaaaa
&Dimensions.1.directconnectid=dc-bbbbbbb
&Dimensions.2.directconnectid=dc-ccccccc
&<公共请求参数>
```
