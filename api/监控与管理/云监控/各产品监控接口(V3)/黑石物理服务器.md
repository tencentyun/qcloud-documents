...
Namespace：qce/cpm
Dimensions.N.instanceId：黑石物理机的实例ID
...
拉取某台黑石物理服务器某段时间内统计周期为5分钟的CPU利用率监控数据
...
&Dimensions.0.instanceId=cpm-xxxx
&<公共请求参数>
```
...
拉取三台黑石物理服务器某段时间内统计周期为5分钟的CPU利用率监控数据
...
&StartTime=2018-04-16 20:00:00
&EndTime=2018-04-16 20:05:00
&Dimensions.0.instanceId=cpm-aaaaaa
&Dimensions.1.instanceId=cpm-bbbbb
&Dimensions.2.instanceId=cpm-ccccc
&<公共请求参数>
```
