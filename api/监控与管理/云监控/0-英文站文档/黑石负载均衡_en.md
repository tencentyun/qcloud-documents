...
This API (GetMonitorData) is used to query the monitoring data of BM load balancer product. The values for input parameters are as follows:
namespace: qce/bm_lb
...
| ---------- | ----- | ---- | ------------------------------------ |
| inpkg      | Inbound packets   | pck/sec  | protocol, vip, vport, rsip, rsport, vpcid |
| outpkg     | Outbound packets   | pck/sec  | protocol, vip, vport, rsip, rsport, vpcid |
| intraffic  | Inbound bandwidth   | Mbps | protocol, vip, vport, rsip, rsport, vpcid |
| outtraffic | Outbound bandwidth   | Mbps | protocol, vip, vport, rsip, rsport, vpcid |
| connum     | Number of current connections | -    | protocol, vip, vport, rsip, rsport, vpcid |
