...
Cloud Load Balancer is a service used to distribute traffic to multiple CVMs. For more information, please see <a href="/doc/product/214/概述" title="Overview">Cloud Load Balancer</a> page.
...
qce/lb_public is namespace of the public network load balancer, through which you can query all the monitoring data of the public network load balancer.

This API (GetMonitorData) is used to query monitoring data based on 4 dimension groups below. The values for input parameters of the 4 dimension groups are as follows:

### 1.1 Values of Input Parameters for the Public Network Load Balancer Dimension
...
### 1.2 Values of Input Parameters for the Public Network Load Balancer Port Dimension

namespace: qce/lb_public
dimensions.0.name=vip
dimensions.0.value is the IP address
&dimensions.1.name=loadBalancerPort
&dimensions.1.value is the port number
&dimensions.2.name=protocol
&dimensions.2.value is the protocol type



### 1.3 Values of Input Parameters for the Public Network Load Balancer Backend CVM Dimension
...
&dimensions.3.value is ID of the VPC in which the load balancer resides
&dimensions.4.name=lanIp
&dimensions.4.value is IP of the machine bound to the load balancer



### 1.4 Values of Input Parameters for the Public Network Load Balancer Backend CVM Port Dimension
...
| dimensions.1.name  | loadBalancerPort | Load balancer port        | Dimension name of String type: loadBalancerPort |
| dimensions.1.value | loadBalancerPort | Load balancer port        | Specific port number, such as 80                     |
| dimensions.2.name  | protocol         | Protocol            | Dimension name of String type: protocol         |
| dimensions.2.value | protocol         | Protocol            | String type, such as http                |
| dimensions.3.name  | vpcId            | ID of the VPC, in which the load balancer resides | Dimension name of String type: vpcId            |
| dimensions.3.value | vpcId            | ID of the VPC, in which the load balancer resides | Specific VPC ID, such as 1111                |
