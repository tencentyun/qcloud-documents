...
This API (GetMonitorData) is used to query the monitoring data of basic network cross-region interconnection product. The values for input parameters are as follows:
namespace: qce/pcx
Value of dimension name: peeringConnectionId
dimensions.0.name=peeringConnectionId
dimensions.0.value is basic network cross-region interconnection ID
...
| dimensions.0.name  | Yes    | String   | peeringConnectionId | Input parameter is basic network cross-region interconnection ID                           |
| dimensions.0.value | Yes    | String   | Specific basic network cross-region interconnection ID      | Enter specific peeringConnectionId                  |
