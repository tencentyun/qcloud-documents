...
| dimensions.0.value | 是    | String   | 具体的 CMQ 队列实例id | 输入具体queueId，如queue-3abkyggi              |
| dimensions.1.name  | 是    | String   | queueName     | 入参为 CMQ 队列实例名称                            |
| dimensions.1.value | 是    | String   | 具体的 CMQ 队列实例名称 | 输入具体queueName，如 test1                    |
