...
dimensions.4.value 为负载均衡实例所属的私有网络整形 ID，可通过 [查询私有网络列表](/document/product/386/6646) 返回的字段 vpcId 获得
...
| dimensions.n.value | 是    | String   | 对应的维度的值 | 对应的维度的值，具体维度名称见第1节，与 dimensions.n.name 配合使用。 |
