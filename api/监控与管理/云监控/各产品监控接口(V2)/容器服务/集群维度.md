...
| 英文               | 中文含义                                     |
| ---------------- | ---------------------------------------- |
| docker_clusterid | 请填写 [查询集群列表](https://cloud.tencent.com/document/product/457/9448) 接口中返回的 clusterId（集群的 ID）字段 |
...
| dimensions.0.name  | 是    | String   | docker_clusterid | 入参为集群 ID                                  |
