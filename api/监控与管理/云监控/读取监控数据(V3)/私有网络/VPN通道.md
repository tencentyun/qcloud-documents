...
Namespace：qce/vpnx
Dimensions.N.vpnConnId：VPN通道ID
...
拉取某个VPN通道某段时间内统计周期为5分钟的入包量监控数据
...
&Dimensions.0.vpnConnId=vpnx-q7v069tf
&<公共请求参数>
```
...
拉取三个VPN通道某段时间内统计周期为5分钟的入包量监控数据
...
&StartTime=2018-04-16 20:00:00
&EndTime=2018-04-16 20:05:00
&Dimensions.0.vpnConnId=vpnx-aaaaaa
&Dimensions.1.vpnConnId=vpnx-bbbbb
&Dimensions.2.vpnConnId=vpnx-ccccc
&<公共请求参数>
```
