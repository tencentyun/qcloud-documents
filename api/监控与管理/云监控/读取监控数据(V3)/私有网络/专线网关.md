...
查询专线网关产品监控数据，入参取值如下：
Namespace：qce/dcg
Dimensions.N.directConnectGatewayId：专线网关ID
...
&Dimensions.0.directConnectGatewayId=dcg-4d545d
&<公共请求参数>
```
...
```
{
  "Response": {
    "DataPoints": [
      {
        "Dimensions": {
          "directConnectGatewayId": "dcg-4d545d"
        },
        "Points": [
          0,
          0
...
&StartTime=2018-04-16 20:00:00
&EndTime=2018-04-16 20:05:00
&Dimensions.0.directConnectGatewayId=dcg-aaaaaa
&Dimensions.1.directConnectGatewayId=dcg-bbbbb
&Dimensions.2.directConnectGatewayId=dcg-ccccc
&<公共请求参数>
```
...
```
{
  "Response": {
    "DataPoints": [
      {
        "Dimensions": {
          "directConnectGatewayId": "dcg-aaaaaa"
        },
        "Points": [
          0,
          0
      ...
      {
        "Dimensions": {
          "directConnectGatewayId": "dcg-bbbbb"
        },
        "Points": [
          0,
          0
      ...
      {
        "Dimensions": {
          "directConnectGatewayId": "dcg-ccccc"
        },
        "Points": [
          0,
          0
