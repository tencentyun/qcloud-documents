...
| 指标名称       | 含义    | 单位   | 维度                                   |
| ---------- | ----- | ---- | ------------------------------------ |
| listenser_inpkg      | 入包量   | 个/秒  | protocol,vip,vport |
| listenser_outpkg     | 出包量   | 个/秒  | protocol,vip,vport |
| listenser_intraffic  | 入带宽   | Mbps  | protocol,vip,vport |
| listenser_outtraffic | 出带宽   | Mbps  | protocol,vip,vport |
