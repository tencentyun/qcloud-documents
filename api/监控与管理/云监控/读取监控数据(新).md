...
dimensions.2.name=podName
dimensions.2.value为实例名称，请填写[查询服务实例列表](https://www.qcloud.com/document/api/457/9433)接口中返回的name(实例名称)字段
...
dimensions.2.name=containerId
dimensions.2.value为容器ID，请填写[查询服务实例列表](https://www.qcloud.com/document/api/457/9433)接口中返回的containerId(容器id)字段。<font style="color:red"><strong>注意：容器Id只用取开头12位即可</strong></font>
