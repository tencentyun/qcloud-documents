...
|字段|是否必选|类型|描述|
| ------------ | ------------ | ------------ | ------------ |
|policyDocument|是|string|角色的信任策略文档，示例：{"version":"2.0","statement":[{"action":"name/sts:AssumeRole","effect":"allow","principal":{"service":["cloudaudit.cloud.tencent.com","cls.cloud.tencent.com"]}}]}，principal用于指定角色的授权对象。获取该参数可参阅 获取该参数可参阅  [获取角色详情](https://cloud.tencent.com/document/product/598/36221)  输出参数RoleInfo。   |
