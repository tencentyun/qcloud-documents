...
| 4000 | InvalidParameter.principal.Error                | 策略文档中 principal 字段错误                                | 请参考文档中 [principal](https://cloud.tencent.com/document/product/598/19381#.E4.B8.BA.E8.BA.AB.E4.BB.BD.E6.8F.90.E4.BE.9B.E5.95.86.E5.88.9B.E5.BB.BA.E8.A7.92.E8.89.B22) 字段的描述                      |
| 4000 | InvalidParameter.action.Error                   | 策略文档中 action 字段错误                                   | 请参考文档中 [action](https://cloud.tencent.com/document/product/598/19381#.E4.B8.BA.E8.BA.AB.E4.BB.BD.E6.8F.90.E4.BE.9B.E5.95.86.E5.88.9B.E5.BB.BA.E8.A7.92.E8.89.B22) 字段的描述                         |
| 4000 | InvalidParameter.effect.Error                   | 策略文档中 effect 字段错误                                   | 请参考文档中 effect 字段的描述                         |
| 4000 | MissingParameter.action                         | 策略文档缺少 action 字段                                     | 请在策略文档中添加 [action](https://cloud.tencent.com/document/product/598/19381#.E4.B8.BA.E8.BA.AB.E4.BB.BD.E6.8F.90.E4.BE.9B.E5.95.86.E5.88.9B.E5.BB.BA.E8.A7.92.E8.89.B22) 字段                         |
...
| 4000 | InvalidParameter.policyDocument.LengthOverlimit | 策略文档长度超过限制，限制大小是4096个字节                   | 请减少策略描述长度，策略内容过多时可拆分为多条策略     |
| 4000 | InvalidParameter.condition.Error                | 策略文档 condition 字段错误                                  | 请检查策略文档中的 condition  是否正确                 |
| 4000 | MissingParameter.resource                       | 策略文档缺少 resource 字段                                   | 请填入 resource  参数                                   |
| 4000 | InvalidParameter.resource.Error                 | 策略文档 resource 字段错误                                   | 请检查策略文档中的 resource 格式是否正确               |
| 4000 | InvalidParameter.resource.user.Error            | 策略文档的 resource 不是自己账户的资源                       | 请将策略文档中的 resource 的资源拥有者填写为当前主账号 |
