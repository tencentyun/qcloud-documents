...
| 4000 | InvalidParameter.principal.Error                | 策略语法中 principal 字段错误                                | 请参考文档中 [principal](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B) 字段的描述 |
| 4000 | InvalidParameter.action.Error                   | 策略语法中 action 字段错误                                   | 请参考文档中 [action](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B) 字段的描述 |
| 4000 | InvalidParameter.effect.Error                   | 策略语法中 effect 字段错误                                   | 请参考文档中 effect 字段的描述                               |
| 4000 | MissingParameter.action                         | 策略语法缺少 action 字段                                     | 请在策略语法中添加 [action](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B) 字段 |
...
| 4000 | MissingParameter.version                        | 策略语法缺少 version 字段                                    | 请填入 [version](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B) 参数 |
| 4000 | InvalidParameter.version.Error                  | 策略语法 version 字段错误                                    | 请检查策略语法中的 [version](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B) 格式是否正确 |
| 4000 | MissingParameter.statement                      | 策略语法缺少 statement 字段                                  | 请填入 [statement](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B) 参数 |
| 4000 | InvalidParameter.statement.Error                | 策略语法 statement 字段错误                                  | 请检查策略语法中的 [statement](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B) 格式是否正确 |
| 4000 | InvalidParameter.policyDocument.LengthOverlimit | 策略语法长度超过限制，限制大小是4096个字节                   | 请减少策略描述长度，策略内容过多时可拆分为多条策略           |
| 4000 | InvalidParameter.condition.Error                | 策略语法 condition 字段错误                                  | 请检查策略语法中的 [condition](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B)  是否正确 |
| 4000 | MissingParameter.resource                       | 策略语法缺少 resource 字段                                   | 请填入 [resource](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B)  参数 |
| 4000 | InvalidParameter.resource.Error                 | 策略语法 resource 字段错误                                   | 请检查策略语法中的 [resource](https://cloud.tencent.com/document/product/598/10603#8..E7.AD.96.E7.95.A5.E6.A0.B7.E4.BE.8B) 格式是否正确 |
