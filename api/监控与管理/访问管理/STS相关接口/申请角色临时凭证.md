...
|字段|是否必选|类型|描述|
| ------------ | ------------ | ------------ | ------------ |
|roleArn|是|String|角色的资源描述。例如：qcs::cam::uin/12345678:role/4611686018427397919、qcs::cam::uin/12345678:roleName/testRoleName。uin 表示资源拥有者 owneruin；roleName 表示角色名称；role 表示角色 id|
