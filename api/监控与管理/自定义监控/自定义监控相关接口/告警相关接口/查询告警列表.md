...
|recoverTime| String |告警恢复时间，当告警未恢复时，恢复时间为0000-00-00 00:00:00|
...
告警发生时间说明：
上报数据第一次满足告警条件时的时间。例如用户指定磁盘利用率在10分钟内其平均值大于80%触发告警，告警时间11:00表示在10：50-11:00内，
磁盘使用率的最大值大于80%。
告警恢复时间说明：
查询告警列表时，告警依旧没有恢复，告警恢复时间的值为0000-00-00 00:00:00，表示当前告警未恢复。
