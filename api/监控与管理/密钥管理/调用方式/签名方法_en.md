...
**Note: 1. The parameter value means original value, not a URL encoded value. 2. If an underscore is included in the input parameters, then convert it into ".".**
...
For example, the previous generated signature string is NSI3UqqD99b/UJb4tbG/xZpRW64=. It will be NSI3UqqD99b%2FUJb4tbG%2FxZpRW64%3D after encoded. Therefore, the final Signature is NSI3UqqD99b%2FUJb4tbG%2FxZpRW64%3D, which will be used to generate the final request URL.
