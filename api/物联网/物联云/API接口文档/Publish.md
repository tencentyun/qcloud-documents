...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| topic | 是 | String | 消息发往的主题。命名规则：${productName}/${deviceName}/[a-zA-Z0-9:_-]{1,128}。|
...
<pre>
  https://iothub.api.qcloud.com/v2/index.php?Action=Publish
  &topic=${productName}/${deviceName}/get
  &payload=test
