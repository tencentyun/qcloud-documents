...
|    命令               | 介绍                | 参数   |
| :-------------------- | :-----------------  |:------ | 
|qcloudcli help 		| 主命令的帮助查看    |否      |
|qcloudcli configure    | 设置默认账号的配置  |否      |
|qcloudcli showconfigure| 查看当前的配置信息  |否      |
|qcloudcli addprofile   | 添加用户配置        |否      |
|qcloudcli delprofile   | 删除用户配置        |--name  |
|qcloudcli useprofile   | 添加新用户配置      |--name  |


###各模块介绍
腾讯云命令行工具是基于腾讯云API封装的一个便于开发者使用的产品，每个命令模块对应API不同的模块，命令模块下的接口同云API的接口。更详细的接口文档可查看API文档
详细接口请查看[腾讯云API文档](https://www.qcloud.com/doc/api)

| 主命令模块            | 介绍                | 部分接口  							    |更多API接口                                             |
|:----------------------| :-------------------|:----------------------------------------|:-------------------------------------------------------| 
|qcloudcli account      |用户账号相关命令     |包括新增项目、查看项目、查看用户组等命令 |[查看详情](https://www.qcloud.com/doc/api/403/4368)     |
|qcloudcli bm           |黑石物理服务器相关命令|包括查看实例、绑定EIP等命令             |暂无文档                                                |
...
|qcloudcli cns          |域名相关命令         |包括域名解析和域名备案的相关命令         |[域名解析](https://www.qcloud.com/doc/api/383/4031) [域名备案](https://www.qcloud.com/doc/api/263/1213)                          |
...
|qcloudcli cam          |用户权限控制相关命令 |包括策略管理、用户管理等命令             |暂无文档                                                |
...
|qcloudcli configuredayu|(网络安全)大禹相关命令|包括刷新URL，查看流量等命令             |[查看详情](https://www.qcloud.com/doc/api/361/2315)     |
...
|qcloudcli market       |服务市场相关命令     |暂无说明                                 |暂无文档                                                |
|qcloudcli redis        |云存储Redis相关命令  |包括增、删、改、查CRS实例等命令          |[查看详情](https://www.qcloud.com/doc/api/260)          |
|qcloudcli snapshottrade|快照相关命令         |包括创建、删除、回滚快照等命令           |[查看详情](https://www.qcloud.com/doc/api/364/2446#3.-.E5.BF.AB.E7.85.A7.E7.9B.B8.E5.85.B3.E6.8E.A5.E5.8F.A3)|
