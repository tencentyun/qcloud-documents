...
![](//mccdn.qcloud.com/static/img/606fc6dc7e5a3e27584f58755e7bca53/image.png)
	...
	- Click **New** to add a new scheduled task;
...
If you want to create a scheduled task on a recurring schedule, you can specify a start time. AS performs the action at this time, and then performs the action based on the recurring schedule. If you specify an end time, AS does not perform the action after this time.
