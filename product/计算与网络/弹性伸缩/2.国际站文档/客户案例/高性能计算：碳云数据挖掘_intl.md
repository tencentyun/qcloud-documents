...
**Listed as 2017 Top 10 Most Innovative Companies in China by FastCompany, together with Alibaba, Tencent, Xiaomi, BBK Electronics, Huawei, and Wanda Group.**
...
- For multi-omics detection, the computing cluster must be able to scale up to 1,000+ cores and 100+ TB any time.
- The preparation for the environment of the computing nodes in the detection workflow is cumbersome and labor-intensive.
