...
In the AS [Console](https://console.qcloud.com/autoscaling), click **New** and select the load balancer you need from the **Load Balance** option at the bottom of the page. If you did not create it in advance, click the **New** below the option to create a new load balancer.
