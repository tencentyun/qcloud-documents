...
## Revenue
Assume that the original solution needs two 4-core 4GB CVMs. The new solution changes it to one 4-core 4GB CVM and a temporary CVM working for 4 hours every day, which can save you around 30% in expenses.
