...
- Cluster servers need to actively make external access;
...
Now, even without public IP, your server in this subnet can actively get external access via the fixed IP of the NAT gateway, during which this IP is shown to be fixed externally.
