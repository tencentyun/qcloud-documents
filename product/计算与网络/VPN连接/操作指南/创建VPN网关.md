...
## 前提条件
如需创建 VPC 类型的 VPN 网关，请提前创建好同地域的 VPC 网络。
...
<tr>
<td>关联网络</td>
<td>此处表示您将创建云联网类型 VPN 还是私有网络类型的 VPN，通常我们也称为 CCN 型 VPN 网关、VPC 型 VPN 网关。<li>如果您需要通过 VPN 连接实现与多 VPC 网络，或其他专线网络的互通，您可以勾选【云联网】。请注意：当前暂不支持 CCN 型 VPN 网关在创建时直接关联云联网实例，可在完成创建后，进入 VPN 网关详情基本信息页面编辑所属网络关联云联网实例。</li><li>如果您需要通过 VPN 连接实现与单 VPC 网络的互通，您可以勾选【私有网络】。</li></td>
</tr>
<tr>
<td>所属网络</td>
