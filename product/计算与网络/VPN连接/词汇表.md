...
### 路由表
<a href="https://cloud.tencent.com/document/product/215/20060#.E8.B7.AF.E7.94.B1.E7.AD.96.E7.95.A5" target="_blank">路由表</a>（Routing Table）包含一系列路由策略，用于定义私有网络内每个子网的网络流量走向。每个子网有且只有一个关联路由表，每个路由表可以关联同一个私有网络中的多个子网。
### 路由策略
