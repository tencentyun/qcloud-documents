...
VPN 连接是一种通过公网加密通道连接对端 IDC 与私有网络（Virtual Private Cloud，VPC）或云联网（Cloud Connected Network，CCN）的方式（VPN 网关连接云联网灰度中，如有需要，请提交 [工单申请](https://console.cloud.tencent.com/workorder/category)）。如下图所示，腾讯云 VPN 连接分为如下组成部分：
