...
在 [CAM 用户列表](https://console.cloud.tencent.com/cam/user) 中，选取对应子账号，单击【关联策略】，单击【从策略列表中选取策略关联】，搜索并关联 `QcloudSLSFullAccess`，策略语法如下：
...
如果希望子账号仅对 Serverless Framework 某些特定资源有操作权限，在 [CAM 用户列表](https://console.cloud.tencent.com/cam/user) 中，选取对应子账号，点击【关联策略】，单击【从策略列表中选取策略关联】并单击【新建自定义策略】，创建一条自定义策略并关联到用户，参考策略语法如下：
