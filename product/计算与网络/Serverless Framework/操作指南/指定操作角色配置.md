...
4. 选择预设策略 **QcloudSLSFullAccess**、	**QcloudCOSFullAccess**、**QcloudSLSFullAccess**，单击【下一步】。
...
## 子账号添加权限
子账号如果需要添加权限，需要将角色名称与需要添加的策略名称一起提供给主张浩，主账号在 [CAM 控制台](https://console.cloud.tencent.com/cam/role) >【角色】中完成权限添加。
