...
8. 通过 DevTools 的右侧栏，可以控制中断的程序继续执行、单步执行、步入步出的操作，也可以直接查看当前变量，或设定要跟踪查看的变量。DevTools 的进一步使用可以查看 [DevTools 说明文档](https://developers.google.com/web/tools/chrome-devtools/)。
