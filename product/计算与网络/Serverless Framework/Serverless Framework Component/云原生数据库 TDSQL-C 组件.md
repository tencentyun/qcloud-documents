...
在新目录下创建 `serverless.yml` 文件，在其中进行如下配置，[查看全量配置](https://github.com/serverless-components/tencent-cynosdb/tree/master/docs/configure.md)
...
![](https://main.qcloudimg.com/raw/66e70fa9bf9147ff55790db19767dc78.png)
