## 前提条件
- 了解 [快速入门](https://cloud.tencent.com/document/product/1154/42990)
- 了解 [Serverless 应用](https://cloud.tencent.com/document/product/1154/48261)
- 了解 [账号和权限管理](https://cloud.tencent.com/document/product/1154/48260)
...
## 权限管理
在开发项目中，需要对不同的人员进行权限分配和管理。例如对于开发人员，只允许其访问某个项目某个环境下的权限，可以参考 [子账号权限配置](https://cloud.tencent.com/document/product/1154/48270)，授予子账号 Serverless Framework 特定资源的操作权限。
...
## Serverless 命令
开发项目到上线过程中，需要用到一些相关的Serverless相关命令。更多命令请查看 [Serverless 支持命令列表](https://cloud.tencent.com/document/product/1154/43877)。
