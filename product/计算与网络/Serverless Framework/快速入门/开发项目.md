...
## 权限管理
在开发项目中，需要对不同的人员进行权限分配和管理。例如对于开发人员，只允许其访问某个项目某个环境下的权限，可以参考 [账号和权限管理](https://cloud.tencent.com/document/product/1154/48260)，授予子账号 Serverless Framework 特定资源的操作权限。
