...
### 由于 Serverless Framework 在部署时会默认检测是否为中国用户，如果开发环境在海外地域，但希望使用中国版体验的 Serverless Framework 该怎样配置？

在 .env 文件中增加配置 SERVERLESS_PLATFORM_VENDOR=tencent 即可指定默认提供中国版体验，包括[交互式的一键部署流程](https://cloud.tencent.com/document/product/1154/41775)等。

### 如果遇到报错 “ Cannot get secretId/Key, your account could be sub-account or does not have access, please check if SLS_QcsRole role exists in your account, and visit https://console.cloud.tencent.com/cam to bind this role to your account.” 该怎样处理？

该报错为账户权限不足，可以参考[账号和权限配置](https://cloud.tencent.com/document/product/1154/43006)进行配置更新。
