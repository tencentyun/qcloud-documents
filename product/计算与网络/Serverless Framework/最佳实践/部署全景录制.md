...
腾讯云自研的全景录制，主打所见即所得的录制理念，只需要用户提供一个可供访问的公网链接，采取 Chrome 进行页面渲染录制，ffmepg 转码，同时直接上传到C OS，实时生成录制文件。结合直播、点播、 TRTC 等腾讯云产品，提供教育，游戏，互娱等一站式数据解决方案。


![image](https://main.qcloudimg.com/raw/dc58f72a5bfbe224989ca54ef593f75b.png)
...
- **CLS 日志** ：处理过程。CLS 日志可能会产生一定计费，详情参考 [CLS 计费规则](https://cloud.tencent.com/document/product/614/47116)。
...
<dx-codeblock>
::: json
{    "Action": "Describe",     "Data": {        "TaskID": "0f7d9522-a1a3-4517-b5ad-7a6eca******"    }}
:::
</dx-codeblock>
:::
::: 返回参数说明
