...
**小直播**
[秀场直播/电商直播](https://cloud.tencent.com/document/product/454/38625) 通过云函数模板 LiveRoom 创建业务后台、配合移动直播 SDK、即时通信 IM 低门槛快速实现登录、注册、开播、连麦一整套在线直播业务场景。
...
>? **通过命令行**创建互动直播房间服务时，默认创建 TD SQL。因此您无需新建数据库服务和新建 Redis 服务。
