...
2. **引入layer，部署后报依赖模块查找失败？**

   参考issue：[关于将 egg 项目 node_modules 上传层部署问题](https://github.com/serverless-components/tencent-egg/issues/11#issue-618169731)
