...
## Related object
1) Log in to [Tencent Cloud Console](https://console.qcloud.com/), click "Cloud Monitor" - "My Alarms" tab, click "Alarm Strategy" menu.
