 - For Annual/Monthly Package and pay-by-traffic CVMs, if and only if both the system disk and data disk use <font color="red">cloud disks</font>, their configuration can be adjusted.
