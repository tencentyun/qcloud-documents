...
**申请提升配额操作指引：**
请 [提交工单](https://console.qcloud.com/workorder/category/create?level1_id=6&level2_id=7&source=0)，勾选 **云服务器购买配额提升申请**，选择您的服务器类型，填写目标地区、目标配额和主机配置，并在申请原因和问题描述项按实际情况填写，最后填写您可用的手机号，完成后单击 **提交工单** 即可。
>**注意：**
