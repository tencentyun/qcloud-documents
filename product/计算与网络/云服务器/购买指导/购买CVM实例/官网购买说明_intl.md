...
- If you have set the **Uniform expiration date** feature, the purchase page will display the Uniform expiration date check box. The purchase period for those CVMs with this field checked must be more than one month. For those days less than a full month, we will calculate the fees by converting monthly package into daily billing. For example, on November 12, you buy a CVM and check the Uniform expiration date feature at the prices of USD $9.0300 /month, and the fixed expiration date is the 20th day of each month. Then the CVM expires on December 20, and you need to pay USD $ 11.4380 .
