# Official website purchase instructions

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; This section describes the instructions and notes concerning CVM purchase on the official website. If you want to purchase CVMs, please refer to the CVM purchase guide:
...
>Note: Currently purchase history for pay-by-traffic services is not supported. Please look forward to feature upgrades.
...
For the guide on setting a fixed expiration date, click [here](https://www.qcloud.com/doc/product/285/1894#.E4.BA.94.E3.80.81.E8.AE.BE.E7.BD.AE.E7.BB.9F.E4.B8.80.E5.88.B0.E6.9C.9F.E6.97.A5)
- If you have set the **Uniform expiration date** feature, the purchase page will display the Uniform expiration date check box. The purchase period for those CVMs with this field checked must be more than one month. For those days less than a full month, we will calculate the fees by converting monthly package into daily billing. For example, on November 12, you buy a CVM and check the Uniform expiration date feature at the prices of 60 CNY/month, and the fixed expiration date is the 20th day of each month. Then the CVM expires on December 20, and you need to pay 76 CNY (60 +60 ÷ 30 × 8).
