...
3. 完成购买后登录云服务器：根据您购买的云服务器类型，可以选择 [登录 Linux 实例](https://cloud.tencent.com/document/product/213/5436) 或者 [登录 Windows 实例](https://cloud.tencent.com/document/product/213/5435)。
4. （可选）您可以通过购买的云服务器搭建个人网站、论坛或者存储文件。
 - [使用镜像搭建WordPress个人站点](https://cloud.tencent.com/document/product/213/9740)
 - [使用镜像搭建Discuz! 论坛](https://cloud.tencent.com/document/product/213/9753)
