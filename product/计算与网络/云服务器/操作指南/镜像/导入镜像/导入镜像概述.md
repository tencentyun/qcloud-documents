...
<tr><td>操作系统</td><td><ul><li>基于 CentOS、Ubuntu、Debian、OpenSUSE、SUSE、CoreOS、FreeBSD、Kylin、UnionTech、TencentOS、Fedora、CentOS Stream、AlmaLinux、Rocky Linux、Other Linux 发行版的镜像
</li><li>支持32位、64位和 arm_64位</li></ul></td></tr>
