...
<tr><td>镜像大小</td><td><ul><li>镜像实际大小不超过500G，使用<code>qemu-img info imageName &#124; grep 'disk size'</code>查看镜像实际大小</li><li>镜像 vsize 不超过500G，使用<code>qemu-img info imageName &#124; grep 'virtual size'</code>查看镜像 vsize</li></ul><b>注意：</b>导入镜像时审查大小以转换为 QCOW2 格式后的镜像信息为准</td></tr>
