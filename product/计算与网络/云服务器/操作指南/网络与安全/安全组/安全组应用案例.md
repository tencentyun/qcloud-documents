...
- 安全组的出站规则默认全部放通，即默认您可以访问外部网络资源，如果您需要限制您的云服务器访问某些网络资源，可以设置这些端口的出站规则为拒绝。
- 同一地域、同一安全组内的云服务器默认即可互相访问。
...
**解决方法**：[添加入站规则](https://cloud.tencent.com/document/product/215/20398#.E6.B7.BB.E5.8A.A0.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99) 时，在 “类型” 中选择 “Linux 登录”，开通22号协议端口，放通 Linux SSH 登录。
...
**解决方法**：[添加入站规则](https://cloud.tencent.com/document/product/215/20398#.E6.B7.BB.E5.8A.A0.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99) 时，在 “类型” 中选择 “Windows 登录”，开通3389号协议端口，放通 Windows 远程登录。
...
**解决方法**：使用 ping 程序进行测试。即在 [添加入站规则](https://cloud.tencent.com/document/product/215/20398#.E6.B7.BB.E5.8A.A0.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99) 时，将 “类型” 选择为 “Ping”，开通 ICMP 协议端口，允许其他云服务器通过 ICMP 协议访问该云服务器。
...
**解决方法**：如需通过 Telnet 远程登录云服务器，则需在 [添加入站规则](https://cloud.tencent.com/document/product/215/20398#.E6.B7.BB.E5.8A.A0.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99) 时，配置以下安全组规则：
<table>
<tr><th>方向</th><th>类型</th><th>来源</th><th>协议端口</th><th>策略</th></tr>
...
**解决方法**：如需通过通过 HTTP 或者 HTTPS 的方式访问网站，则需在 [添加入站规则](https://cloud.tencent.com/document/product/215/20398#.E6.B7.BB.E5.8A.A0.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99) 时，根据实际需求配置以下安全组规则：
- 允许公网上的所有 IP 访问该网站
<table>
<tr><th>方向</th><th>类型</th><th>来源</th><th>协议端口</th><th>策略</th></tr>
...
**解决方法**：[添加入站规则](https://cloud.tencent.com/document/product/215/20398#.E6.B7.BB.E5.8A.A0.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99) 时，在 “类型” 中选择 “自定义”，开通1101号协议端口，允许外部访问指定的业务端口。
...
**解决方法**：[添加入站规则](https://cloud.tencent.com/document/product/215/20398#.E6.B7.BB.E5.8A.A0.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99) 时，在 “类型” 中选择 “自定义”，配置1102号协议端口，将 “策略” 设置为 “拒绝”，拒绝外部访问指定的业务端口。
<table>
<tr><th>方向</th><th>类型</th><th>来源</th><th>协议端口</th><th>策略</th></tr>
...
## 多场景组合
在实际的场景中，可能需要根据业务需求配置多个安全组规则。例如，同时配置入站或者出站规则。一台云服务器可以绑定一个或多个安全组，当云服务器绑定多个安全组时，多个安全组将按照从上到下依次匹配执行。您可以随时调整安全组的优先级，操作详情可参考 [安全组规则](https://cloud.tencent.com/document/product/213/12452#.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99) 进行设置。
