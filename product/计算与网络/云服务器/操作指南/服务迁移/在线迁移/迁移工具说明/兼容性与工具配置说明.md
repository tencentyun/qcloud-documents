...
<table>
	...
	<tr><td>CentOS 5/6/7/8</td><td rowspan=7>Windows Server 2008,<br>Windows Server 2012,<br>Windows Server 2016,<br>Windows Server 2019,<br>Windows Server 2022 </td></tr>
...
<table>
	...
	<tr><td>go2tencentcloud_x32.exe</td><td>32位 Windows 系统的迁移工具可执行程序。</td></tr>
	<tr><td>user.json</td><td>迁移时的用户信息。</td></tr>
	<tr><td>client.json</td><td>迁移工具的配置文件。</td></tr>
