...
控制台迁移支持**公网迁移模式**和**内网迁移模式**。

#### 公网迁移模式[](id:ConsolepublicMigration)
...
#### 内网迁移模式[](id:ConsoleintranetMigration)

如果您的源端主机或目标云服务器处于某个内网或 VPC 中，源端主机不能通过互联网直接与目标云服务器建立连接，则可以使用控制台的内网迁移模式进行迁移。内网迁移模式需要通过使用如 [VPC 对等连接](https://cloud.tencent.com/document/product/553)、[VPN 连接](https://cloud.tencent.com/document/product/554)、[云联网](https://cloud.tencent.com/document/product/877) 或者 [专线接入](https://cloud.tencent.com/document/product/216) 等方式建立源端主机与目标云服务器的连接通道。

- [](id:ConsoleScenario1)**场景1**：如果您的源端主机可以访问公网，则可以先在源端主机上通过互联网访问腾讯云 API 发起迁移请求，再通过连接通道向目标云服务器传输数据进行迁移。此场景要求对源端主机具有公网访问能力，而目标云服务器则不要求。
![](https://main.qcloudimg.com/raw/6b941668b1a36b91ceb5e0c142f1f4e0.png)
- [](id:ConsoleScenario2)**场景2**：如果您的源端主机可以通过代理访问公网，则可以先在源端主机上通过网络代理访问腾讯云 API 发起迁移请求，再通过连接通道向目标云服务器传输数据进行迁移。此场景不要求对源端主机和目标云服务器具有公网访问能力。
...
<table>
	...
	<tr><td>user.json</td><td>迁移时源端主机和目标云服务器的配置文件，通过工具迁移时请根据 <a href="#userJsonState">user.json 文件参数说明</a> 修改配置。 通过控制台迁移时通常无需修改该配置文件。</td></tr>
...
<td>打印帮助信息。</td>
<td><code>./go2tencentcloud_x64 --help</code></td>
<td><code>./go2tencentcloud_x64 --help</code></td>
</tr>
<tr>
...
<td>仅使用工具模式迁移。</td>
<td>-</td>
<td><code>./go2tencentcloud_x64 --no-console</code></td>
</tr>
<tr>
<td><code>--check</code></td>
<td>对源端主机进行检查</td>
<td><code>./go2tencentcloud_x64 --check</code></td>
<td><code>./go2tencentcloud_x64 --no-console --check</code></td>
</tr>
<tr>
<td><code>--log-file</code></td>
<td>设置日志文件名称，默认为 <code>log</code>。</td>
<td><code>./go2tencentcloud_x64 --log-file log</code></td>
<td><code>./go2tencentcloud_x64 --no-console --log-file log</code></td>
</tr>
<tr>
<td><code>--log-level</code></td>
<td>日志输出级别，取值范围为<code>1</code>（ERROR 级别），<code>2</code>（INFO 级别）和<code>3</code>（DEBUG 级别），默认值为<code>2</code>。</td>
<td><code>./go2tencentcloud_x64 --log-level 2 </code></td>
<td><code>./go2tencentcloud_x64 --no-console --log-level 2</code></td>
</tr>
<tr>
<td><code>--clean</code></td>
<td>目标云服务器强制退出迁移模式，清理现场。仅在工具迁移模式时使用， 搭配<code>--no-console</code>参数使用。例如，如果控制台提示 <code>Please execute '--clean' option manually.</code>，则需要使用此选项,执行<code>./go2tencentcloud_x64 --no-console --clean</code>,使目标云服务器退出迁移模式。</td>
<td>-</td>
<td><code>./go2tencentcloud_x64 --no-console --clean</code></td>
</tr>
<tr>
<td><code>--version</code></td>
<td>打印版本号。</td>
<td><code>./go2tencentcloud_x64 --version</code></td>
<td><code>./go2tencentcloud_x64 --version</code></td>
</tr>
</tbody>
</table>
