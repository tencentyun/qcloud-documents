...
4. （可选）设置网络代理。
 - 若您的迁移场景为 [内网迁移模式：场景1](https://cloud.tencent.com/document/product/213/65714#Scenario1)， 则请跳过该步骤。
 - 若您的迁移场景为 [内网迁移模式：场景2](https://cloud.tencent.com/document/product/213/65714#Scenario2)， 则需要配置代理网络的 IP 地址和端口：
