...
<td>
  设置迁移传输数据时使用的网络类型。
    ...
    <li><b>内网传输</b>：迁移传输数据到中转实例时使用内网传输。中转实例会创建在选择的私有网络（VPC）下的子网中。可参考 <a href="https://cloud.tencent.com/document/product/213/65715">内网迁移教程</a>。
      <br>私有网络：<b>必填</b>，迁移到云服务器镜像时， 中转实例将创建在该私有网络（VPC）中。迁移至目标云服务器时，不需要选择该项。
      <br>子网：<b>必填</b>，迁移到云服务器镜像时， 中转实例将创建在该子网中。迁移至目标云服务器时，不需要选择该项。
    </li>
  </ul>
</td>
</tr>	
