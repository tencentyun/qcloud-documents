...
<dx-tabs>
::: Windows 服务器
1. 将迁移工具 go2tencentcloud.zip 下载或上传至源端主机，解压得到 go2tencentcloud 文件，提取其中的 go2tencentcloud-windows.zip 继续解压，得到如下图所示的目录：
![](https://qcloudimg.tencent-cloud.cn/raw/dd2a4d920252f28b6d530a653b09b83d.png)    
2. 通过以下方式运行 go2tencentcloud_x64 应用程序。
	- 方式一：双击运行 go2tencentcloud_x64 应用程序，在弹窗中输入SecretId、SecretKey。
	- 方式二：以管理员身份打开cmd命令行 ：cd /d "go2tencentcloud_x64.exe所在目录的绝对路径" ，运行go2tencentcloud_x64应用程序。
