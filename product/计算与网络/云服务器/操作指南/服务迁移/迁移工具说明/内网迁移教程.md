## 操作场景
本文档介绍通过使用在线迁移工具中的**内网迁移**，将源服务器上的系统、应用程序等从自建机房（IDC）或云平台等源环境迁移至腾讯云云服务器的操作步骤。
...
5. [](id:Scenario1_step05)在一台可以访问公网的主机（如网关）上运行工具。
...
6. [](id:Scenario1_step06)在待迁移的源端主机上运行工具。
