...
<table>
	<tr><th>参数名称</th><th>类型</th><th>是否必填</th><th>说明</th></tr>
  <tr><td>Client.Net.Mode</td><td>Integer</td><td>是</td><td>迁移模式参数，默认使用公网传输，值为<code>0</code>，取值范围：<code>0</code>（<a href="#DefaultMode">公网迁移模式</a>）、<code>1</code>（<a href="#Scenario1">内网迁移模式：场景1</a>）、<code>2</code>（<a href="#Scenario2">内网迁移模式：场景2</a>）、<code>3</code>（<a href="#Scenario3">内网迁移模式：场景3</a>），内网迁移详见 <a href="">内网迁移教程</a> 。</td></tr>
	...
	<tr><td>Client.Rsync.BandwidthLimit</td><td>String</td><td>否</td><td>限速配置项，单位为 KBytes/s，默认值为空，即默认传输时不限速。</td></tr>
