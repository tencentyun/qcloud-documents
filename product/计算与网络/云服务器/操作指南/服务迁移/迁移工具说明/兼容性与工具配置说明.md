...
<table>
  ...
  <tr>
	...
	<td>Integer</td>
	<td>否</td>
	<td>源端数据盘大小，单位GB，取值范围[10,16000]。</td>
  </tr>
  <tr>
...
您可参考 [修改配置文件](https://cloud.tencent.com/document/product/213/38783#modifyConfiguration) 中的示例，结合实际业务场景修改配置文件。
...
<blockquote class="doc-tip"><p class="doc-tip-tit"><i class="doc-icon-tip"></i>说明：</p><p>除上述参数，client.json 文件剩余配置项通常无需填写。</p>
</blockquote>
