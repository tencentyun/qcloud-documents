...
<table>
	<tr><th>参数名称</th><th>类型</th><th>是否必填</th><th>说明</th></tr>
	<tr><td>Client.Net.Mode</td><td>Integer</td><td>是</td><td>默认值为<code>0</code>，取值范围：<code>1</code>（<a href="#Scenario1">内网迁移模式：场景1</a>）、<code>2</code>（<a href="#Scenario2">内网迁移模式：场景2</a>）、<code>3</code>（<a href="#Scenario3">内网迁移模式：场景3</a>），请根据您实际需要进行不同模式/场景的迁移，填写相应的参数值。</td></tr>
