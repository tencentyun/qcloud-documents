...
<table>
	...
	<tr><td>Client.Rsync.Checksum</td><td>Bool</td><td>否</td><td>传输校验项，设为<code>true</code>后可加强传输一致性校验，但会提高源端主机CPU负载和减慢传输速度；默认值为<code>false</code>，即默认不校验。</td></tr>
</table>
除了以上参数，client.json文件剩余配置项一般无需填写；
