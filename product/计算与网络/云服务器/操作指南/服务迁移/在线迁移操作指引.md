...
sudo ./go2tencentcloud_x64
```
若返回`Stage 1 is finished and please run next stage at source machine.`，则说明阶段1已完成。
...
sudo ./go2tencentcloud_x64
```
若返回`Stage 2 is finished and please run next stage at gateway machine.`，则说明阶段2已完成。
