...
>? 
> - 目前新增的所有云硬盘实例和本地盘实例均支持进行不同平台重装系统。部分存量的20GB本地盘实例暂时不支持控制台上进行跨平台重装，使用这些本地盘实例的用户，需要通过 [在线支持](https://cloud.tencent.com/online-service?from=connect-us) 进行申请。
> - 竞价实例不支持重装系统。
...
![](https://main.qcloudimg.com/raw/e6f084dc9cf5a83bd9b0de5ec8aba36a.png)
:::
