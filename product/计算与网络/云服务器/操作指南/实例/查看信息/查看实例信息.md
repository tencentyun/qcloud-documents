...
![](https://main.qcloudimg.com/raw/833139e32797b7d5b53b047c03ac1f59.png)

### 查看实例详情信息

1. 在 [实例](https://console.cloud.tencent.com/cvm/index) 的管理页面上方，选择地域。如下图所示：
![](https://main.qcloudimg.com/raw/73df7c17e36ebb6d3cf3132fad152ee4.png)
2. 找到需要查看详情的实例，单击 ID/实例名，进入实例详情页面。如下图所示：
在实例详情页面，您可以查看到包括实例信息、架构图、网络信息、配置信息、镜像信息、计费信息、弹性网卡、监控、安全组、操作日志等。
![](https://main.qcloudimg.com/raw/c25176ccaabe1ab7e030f9e1908ca7f3.png)
