...
<dx-tabs>
::: 购买页操作
1. 参考 [创建实例](https://cloud.tencent.com/document/product/213/4855) 购买3台实例，并在“设置网络和主机”中以**“前缀+序号”**的命名规则填写实例名称，即将实例名称填写为 `CVM`。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/1e02c88d4c3381e7b3760515bc63e53c.png)
2. 根据页面提示逐步操作，并完成支付。
:::
::: API\s操作
...
<dx-tabs>
::: 购买页操作
1. 参考 [创建实例](https://cloud.tencent.com/document/product/213/4855) 购买实例，并在“设置网络和主机”中以**“前缀+指定模式串{R:x}”**的命名规则填写实例名称，即将实例名称填写为 `CVM{R:3}`。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/530c6d8b510f26a192a139c039ad3f35.png)
2. 根据页面提示逐步操作，并完成支付。
:::
::: API\s操作
在云 API [RunInstances](https://cloud.tencent.com/document/api/213/15730) 中，设置相关字段：
...
<dx-tabs>
::: 购买页操作
1. 参考 [创建实例](https://cloud.tencent.com/document/product/213/4855) 购买3台实例，并在“设置网络和主机”中以**“前缀+指定模式串{R:x}-前缀+指定模式串{R:x}-前缀”**的命名规则填写实例名称，即将实例名称填写为 `cvm{R:13}-Big{R:2}-test` 。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/e0dbc03fe1af2d0b707451d063b03cd8.png)
2. 根据页面提示逐步操作，并完成支付。
