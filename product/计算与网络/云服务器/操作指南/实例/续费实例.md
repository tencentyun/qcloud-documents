...
## 续费实例
包年包月类型实例有多种续费方式，此处以 [云服务器控制台](https://console.cloud.tencent.com/cvm/) 为例进行操作展示。用户亦可参考 [控制台续费管理](https://console.cloud.tencent.com/account/renewal) 文档，进行自动续费设置、续费至统一时间等操作。
