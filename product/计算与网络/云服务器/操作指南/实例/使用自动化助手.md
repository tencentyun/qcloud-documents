## 操作场景
腾讯云自动化助手（TencentCloud Automation Tools，TAT）是云服务器和轻量应用服务器的原生运维部署工具。您无需远程连接实例，自动化助手即可自动批量执行 Shell 命令，完成运行自动化运维脚本、轮询进程、安装/卸载软件、更新应用及安装补丁等任务。如需了解自动化助手的更多信息，请参见 [腾讯云自动化助手](https://cloud.tencent.com/document/product/1340/50752)。
