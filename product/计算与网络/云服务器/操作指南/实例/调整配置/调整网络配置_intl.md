...
## Procedure
1. Log in to the [CVM Console](https://console.cloud.tencent.com/cvm/index), select the instance for which you want to change the network configuration, and then click **More** -> **CVM Configuration** -> **Adjust Network**.
