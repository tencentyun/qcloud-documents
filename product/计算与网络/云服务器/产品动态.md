...
<table>
	<tr><th style="width: 25%;">动态名称</th><th style="width: 50%;">动态描述</th><th style="width: 25%;">相关文档</th></tr>
		<tr>
	<td>关于新加坡地域竞价实例价格下调的公告</td>	<td>2022年11月7日起，针对新加坡地域部分实例类型的竞价实例价格做弹性优惠，新购竞价实例价格为该实例类型按量计费刊例价的5%左右。</td>
		<td><a href="https://cloud.tencent.com/document/product/213/82558">关于新加坡地域竞价实例价格下调的公告</a>
	</td>
	</tr>
</table>
