...
3. **选择网络类型**：腾讯云提供【基础网络】或【私有网络】两种网络类型可选。
 ...
 >! 公网网关是私有网络与公网的一种接口，可转发私有网络中不同子网内无外网 IP 的云服务器请求。更多详情请参见 [公网网关](https://cloud.tencent.com/document/product/215/20078)。
4. **选择机型和配置**
...
2. **选择操作系统及版本**：腾讯云提供了 CentOS、CoreOS、Debian、FreeBSD、openSUSE、SUSE、Ubuntu 等操作系统，后续运行环境请您自行搭建。
...
1. **选择安全组**：**须确保登录端口22开放**，更多信息请参见 [安全组](https://cloud.tencent.com/document/product/213/12452)。
...
|---------|---------|---------|---------|
|MBR | 2TB |<li>4个主分区</li><li>3个主分区和1个扩展分区</li>|Linux 操作系统：<li>fdisk 工具</li><li>parted 工具</li> |
