...
5. 找到【tcp】中的 PortNumber 并双击。如下图所示：
...
8. 找到【RDP-Tcp】中的 PortNumber 并双击。如下图所示：
...
![](https://main.qcloudimg.com/raw/0a27ae0c2666b44cf7a5108e69e9137c.png)
 ...
 4. 在 “新建入站规则向导” 窗口的 “协议和端口”步骤中，选择【TCP】，并填写特定本地端口为12345，单击【下一步】。如下图所示：
...
12. 在 “服务” 窗口中，找到【Remote Desktop Services】，并右键单击【Remote Desktop Services】，选择【重新启动】，重启远程登录服务，下一次登录时，使用修改后的端口远程登录云服务器即可。如下图所示：
![](https://main.qcloudimg.com/raw/c826fa4dcfef45b7de8695fada5674d3.png)
>? 如果您使用 RDP 文件登录云服务器，请对应修改 RDP 文件中的 `full address:s` 参数。如下图所示：
...
```
6. 配置生效后，使用 SSH 工具通过新端口远程登录云服务器，测试是否成功。如下图所示：
...
5. 在安全组规则页面，选择【入站规则】。
6. 找到协议端口为 “TCP:3389” 或 “TCP:22” 的安全组规则，单击操作栏下的【编辑】。如下图所示：
 - 协议端口为 “TCP:3389”：
...
7. 在协议端口输入框输入修改的端口，单击【保存】即可。如下图所示：
例如，将协议端口修改为12345。
