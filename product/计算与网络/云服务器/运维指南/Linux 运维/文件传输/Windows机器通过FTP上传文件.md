...
**配置信息说明：**
 ...
 - 用户名：[搭建 FTP 服务](https://cloud.tencent.com/document/product/213/10414) 时设置的 FTP 用户的帐号。图中以 “ftpuser1” 为例。
 - 密码：[搭建 FTP 服务](https://cloud.tencent.com/document/product/213/10414) 时设置的 FTP 用户帐号对应的密码。
 - 端口：FTP 监听端口，默认为**21**。
连接成功后即可查看云服务器远程站点文件。
