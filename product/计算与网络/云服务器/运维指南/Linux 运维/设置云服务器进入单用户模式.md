...
根据操作系统类型，选择不同的操作步骤。
 - CentOS 6 操作系统，执行 [CentOS 6 的步骤1](#configCentOS6)。
 - CentOS 7 操作系统，执行 [CentOS 7 的步骤1](#configCentOS7)。
 - Ubuntu 操作系统，执行 [Ubuntu 的步骤1](#configUbuntu)。
...
reboot
```
7. 等待约1分钟，并通过 [VNC 登录 该 CVM 实例](https://cloud.tencent.com/document/product/213/5436#.E4.BD.BF.E7.94.A8-vnc-.E7.99.BB.E5.BD.95.E5.AE.9E.E4.BE.8B)。登录界面如下图所示：
...
reboot
```
8. 等待约1分钟，并通过 [VNC 登录 该 CVM 实例](https://cloud.tencent.com/document/product/213/5436#.E4.BD.BF.E7.94.A8-vnc-.E7.99.BB.E5.BD.95.E5.AE.9E.E4.BE.8B)。登录界面如下图所示：
...
sudo reboot
```
5. 等待约1分钟，并通过 [VNC 登录 该 CVM 实例](https://cloud.tencent.com/document/product/213/5436#.E4.BD.BF.E7.94.A8-vnc-.E7.99.BB.E5.BD.95.E5.AE.9E.E4.BE.8B)。登录界面如下图所示：
