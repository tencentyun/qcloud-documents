...
将本地的文件存储到云服务器上，是用户购买云服务器的常见用途之一。您可以通过如下视频及文档，了解如何将您本地的文件拷贝到云服务器上。
 ...
 <table>
      ...
      <tr>
        <td rowspan=2> Windows </td>
				...
				<td  rowspan=2><a href="https://cloud.tencent.com/document/product/213/2761">通过 MSTSC 方式上传文件到云服务器</a></td>
      </tr>
			<tr>
