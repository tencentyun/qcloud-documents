...
如果您想要让用户能够查看 CVM 控制台中的云硬盘信息，创建云硬盘，使用云硬盘，可将以下操作添加到您策略中，然后将该策略关联到您想要的用户。
...
如果您想要让用户能够查看 CVM 控制台中的安全组，并且使用安全组，可将以下操作添加到您策略中，然后将该策略关联到您想要的用户。
...
如果您想要让用户能够查看 CVM 控制台中的弹性 IP 地址，并且使用弹性 IP 地址，可将以下操作添加到您策略中，然后将该策略关联到您想要的用户。
