...
```
project_id：描述项目信息，仅为了兼容CAM早期逻辑，这里请不填。
...
| 资源 | 授权策略中的资源描述方法 |
|-------|-------|
|实例|  qcs:\$project:cvm:\$region:\$account:instance/\$instanceId|
|密钥|  qcs:\$project:cvm:\$region:\$account:keypair/\$keyId|
|VPC|  qcs:\$project:vpc:\$region:\$account:vpc/\$vpcId|
|子网|   qcs:\$project:vpc:\$region:\$account:vpc/\$vpcId|
|系统磁盘|  qcs:\$project::cvm:\$region:\$account:systemdisk/*|
|镜像|   qcs:\$project:cvm:\$region:\$account:image/*|
|子网|  qcs:\$project::vpc:\$region:\$account:subnet/\$subnetId|
|数据盘|  qcs:\$project::cvm:\$region:\$account:datadisk/*|
|安全组|  qcs:\$project:cvm:\$region:\$account:sg/\$sgId|
|EIP|  qcs:\$project:cvm:\$region:\$account:eip/*|
