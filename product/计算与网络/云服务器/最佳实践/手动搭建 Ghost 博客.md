...
- Ghost 博客配置需要使用已完成备案，并且已解析到所使用云服务器的域名。
...
### 步骤一：创建新用户
1. 请参考 [使用标准方式登录 Linux 实例](https://cloud.tencent.com/document/product/213/5436) 登录 Linux 云服务器。
2. 当您登录 Ubuntu 操作系统的云服务器后，请参考 [Ubuntu 系统使用 root 用户登录](https://cloud.tencent.com/document/product/213/17278#ubuntu-.E7.B3.BB.E7.BB.9F.E5.A6.82.E4.BD.95.E4.BD.BF.E7.94.A8-root-.E7.94.A8.E6.88.B7.E7.99.BB.E5.BD.95.E5.AE.9E.E4.BE.8B.EF.BC.9F) 切换为 root 用户。
3. 执行以下命令，创建新用户。本文以 `user` 为例。
