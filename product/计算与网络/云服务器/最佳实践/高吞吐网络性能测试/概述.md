腾讯云在 SA3、S6、C6 等新一代的云服务器实例上提供了超高网络性能，更多信息请参见 [实例规格](https://cloud.tencent.com/document/product/213/11518)。您可通过本文提供的 netperf 和 DPDK 两种网络性能测试方法，进行云服务器高吞吐网络性能测试。
