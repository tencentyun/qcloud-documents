...
iperf3 -s
```
![图三](https://main.qcloudimg.com/raw/3764044d04c70684465c1764288c165d.png))
#### 客户端测试流程
按以下格式输入命令：
```
iperf3 -c <服务器IP地址> -b 2G -t 300 -P <网卡队列数目>
```
![图四](https://main.qcloudimg.com/raw/0a8622fcd4c78ea9a83c341663314aea.png)
...
```
## Windows 版本 iPerf3 与 Netperf 安装帮助
### Windows下 iPerf3 安装帮助
1. iPerf3 安装包下载页面链接：[iPerf3 下载页面](https://iperf.fr/iperf-download.php)。本示例下载的是 iPerf 3.1.3 版本。
2. 下载后解压如图：
![图 9 windows iperf](//mc.qcloudimg.com/static/img/bddabeb2c4c11d2c1dbc6d3f96f32f86/image.png)
3. 通过 PowerShell 或者 CMD 工具使用 iPerf3 ，命令使用方法与 Linux 下一致。
