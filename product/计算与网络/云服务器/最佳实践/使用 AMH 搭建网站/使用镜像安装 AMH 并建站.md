...
## 操作步骤
### 创建云服务器
>!此步骤针对全新购买云服务器。如果您已购买云服务器实例，可通过 [重装系统](https://cloud.tencent.com/document/product/213/4933)，并参考 [手动安装 AMH](https://cloud.tencent.com/document/product/213/38362?!editLang=zh&!preview) 完成安装。
>
1. 在实例的管理页面，单击【新建】。
...
5. 将已注册的域名填入【主机标识域名】及【绑定域名】中，其余设置保持默认，并单击【保存】。如下图所示：
>?
...
>!请参考 [相关简介](#setting) 将该云服务器的公网 IP 解析到已配置的主标识域名。
>
