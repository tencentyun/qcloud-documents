...
11. 执行以下命令，安装 GitLab。
```
sudo EXTERNAL_URL="云服务器的公网 IP 地址" yum install -y gitlab-ce
```
您可以在 “[实例](https://console.cloud.tencent.com/cvm/instance/index?rid=1&ProjectId=0&pid=0)” 管理页面查看云服务器公网 IP 地址。如下图所示：
![](https://main.qcloudimg.com/raw/ec849b283d74a4ed34e3acaca8ecc151.png)
