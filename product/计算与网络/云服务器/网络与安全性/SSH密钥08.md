为保证实例的安全可靠，腾讯云提供两种加密登录方式： [密码登录](/doc/product/213/6093) 和 SSH 密钥对登录。本文档介绍 SSH 密钥对登录的相关配置内容。不同操作系统云服务器的用户可以分别参考 [自定义配置 Windows 云服务器](https://www.qcloud.com/document/product/213/10516#.E8.AE.BE.E7.BD.AE.E4.BF.A1.E6.81.AF) 与 [自定义配置 Linux 云服务器](https://www.qcloud.com/document/product/213/10517#.E8.AE.BE.E7.BD.AE.E4.BF.A1.E6.81.AF) 的设置信息部分，选择加密方式。
...
## 密钥绑定/解绑服务器
 1. 打开 [云服务器 CVM 控制台](https://console.qcloud.com/cvm/) 。
 2. 单击左侧导航窗格中的【SSH 密钥】。
 3. 勾选 SSH 密钥，点击【绑定/解绑云主机】按钮（或在需要修改的密钥名称上右键单击，单击【绑定/解绑云主机】按钮）。
...
## 修改 SSH 密钥名称/描述
 1. 打开 [云服务器 CVM 控制台](https://console.qcloud.com/cvm/) 。
 2. 单击左侧导航窗格中的【SSH 密钥】。
 3. 勾选密钥列表中需要修改的密钥，单击上方【修改】按钮（或在需要修改的密钥名称上右键单击，单击【修改】按钮）。
 4. 在弹框中输入新的名称及描述信息，单击【确定】。

## 删除 SSH 密钥
>**注意**：
>若 SSH 密钥关联云服务器或自定义镜像则不能删除。
