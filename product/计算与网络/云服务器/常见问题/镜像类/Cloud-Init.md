...
![](https://main.qcloudimg.com/raw/97684bd42d3b0d05eee996d0106825e3.png)
 4. 打开“注册表”搜索并找到全部的“LocalScriptsPlugin”，确保其值为2，如下图。
...
**解决方案：**
将 cloudbase-init 服务改为 LocalSystem 服务，具体操作方式详见：[Cloudbase-Init 服务运行排查方案](#checkcloudbase-init) 的步骤 2。 

#### 禁用了 cloudbase-init 服务，从而使得初始化重置密码等操作失败。
**解决方案：**
将 cloudbase-init 服务启动类型改为自动。 具体操作方式详见：[Cloudbase-Init 服务运行排查方案](#checkcloudbase-init) 的步骤 2。
