...
您需要对实例绑定安全组开放相应端口，具体操作步骤请参考 [典型场景配置](https://cloud.tencent.com/document/product/213/12448)。
...
详细操作指南请单击：[安全组常见操作](https://cloud.tencent.com/document/product/213/12450)
...
为了提升腾讯云 IP 地址发邮件的质量，将默认限制云服务器使用 TCP 25 端口连接外部地址。您可以登录 [控制台](https://console.cloud.tencent.com)，鼠标移动至顶部导航的 **账号**，即可看到 **25 端口解封** 入口。

每个用户在每个地域默认可解封 5 个实例。

详细说明可参考 [云服务器 TCP 25 端口出方向被封禁？](https://cloud.tencent.com/document/product/215/12390)
...
请参考 [安全组常见操作](https://cloud.tencent.com/document/product/213/12450) **创建安全组** 部分。

### 如何配置安全组？

请参考  [安全组常见操作](https://cloud.tencent.com/document/product/213/12450)。

### 安全组如何关联 CVM 实例？

请参考  [安全组常见操作](https://cloud.tencent.com/document/product/213/12450) **配置 CVM 实例关联安全组** 部分。
