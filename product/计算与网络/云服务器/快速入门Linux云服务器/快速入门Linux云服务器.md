...
## 步骤二：创建 Linux 云服务器
本步骤介绍 Linux 云服务器的创建，腾讯云提供 快速配置 和 自定义配置 两种方式。本部分以 快速配置 为例说明，若快速配置不能满足您的需求，您可参考自定义配置云服务器文档进行配置。
 > 注意：
...
![](//mc.qcloudimg.com/static/img/bb40e721c1e09110f980895dcad026cc/image.png)
