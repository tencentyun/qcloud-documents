...
## 步骤二：创建 Linux 云服务器
本步骤介绍 Linux 云服务器的创建，腾讯云提供快速配置和自定义配置两种方式。本部分以快速配置为例说明，若快速配置不能满足您的需求，您可参考 [自定义配置 Linux 云服务器](https://www.qcloud.com/document/product/213/10135?!preview=&lang=cn) 文档进行配置。
 > 注意：
