...
2. 使用 PUTTY 连接 Linux 云服务器。打开Putty客户端，在PuTTY Configuration 窗口中输入以下内容：
   ...
   - Port：云服务器的端口，必须填 22。（请确保云主机 22 端口已开放，详见查看 [安全组(/doc/product/213/5221) 及 网络ACL）
   - Connect type：选择“ SSH ”。
...
1. 若密码或密钥无误，将会通过系统验证，成功使用 Webshell 方式登录 Linux 云服务器。
...
2. 在接下来的画面中将会弹出新的白色窗口，在窗口下方找到【浏览器 VNC 方式登录】一栏，然后点击其中的【立即登录】。
   
3. 完成以上步骤即可以成功使用 VNC 方式登录 Linux 云服务器
