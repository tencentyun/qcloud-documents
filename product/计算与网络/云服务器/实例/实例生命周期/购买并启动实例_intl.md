...
1) Log in to the Tencent Cloud official website, select "Products" - "Compute" - "Cloud Virtual Machine", then click "Buy Now" button,  enter the [CVM purchase page](https://buy.qcloud.com/buy/cvm).
