If users do not need [instances charged by quantity](https://www.qcloud.com/doc/product/213/2180#2.-.E6.8C.89.E9.87.8F.E8.AE.A1.E8.B4.B9) any more, they may terminate the instance (Note: instances under an annual or monthly plan do not support voluntary termination, and can be terminated automatically within a period of time after expiration). When an instance is under termination or terminated, no fees related to this instance would be generated.
...
## Use console to terminate charge-by-quantity instances

1) Open [CVM console](https://console.qcloud.com/cvm/).

2) The termination of CVM only works for machines charged by quantity.

3) To release a CVM instance charged by quantity running solely, click "Terminate" on the action bar to the right side.
...
## Use API to terminate charge-by-quantity instances
Please refer to [ReturnInstance API](https://www.qcloud.com/doc/api/229/1347).