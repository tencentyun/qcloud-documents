...
| network/network/macs/<font color=red>mac</font>/mac | 实例网络接口设备地址 | 1.0 |
| network/network/macs/<font color=red>mac</font>/primary-local-ipv4 | 实例网络接口主内网 IP 地址 | 1.0 |
| network/network/macs/<font color=red>mac</font>/public-ipv4s | 实例网络接口公网 IP 地址 | 1.0 |
| network/network/macs/<font color=red>mac</font>/local-ipv4s/<font color=red>local-ipv4</font>/gateway | 实例网络接口网关地址 | 1.0 |
| network/network/macs/<font color=red>mac</font>/local-ipv4s/<font color=red>local-ipv4</font>/local-ipv4 | 实例网络接口内网 IP 地址 | 1.0 |
| network/network/macs/<font color=red>mac</font>/local-ipv4s/<font color=red>local-ipv4</font>/public-ipv4 | 实例网络接口公网 IP 地址 | 1.0 |
| network/network/macs/<font color=red>mac</font>/local-ipv4s/<font color=red>local-ipv4</font>/public-ipv4-mode | 实例网络接口公网网络模式 | 1.0 |
| network/network/macs/<font color=red>mac</font>/local-ipv4s/<font color=red>local-ipv4</font>/subnet-mask | 实例网络接口子网掩码 | 1.0 |

> 以上表格中粗体 <font color=red>mac</font> 和 <font color=red>local-ipv4</font> 字段分别表示实例指定网络接口的设备地址和内网 IP 地址。
> 
