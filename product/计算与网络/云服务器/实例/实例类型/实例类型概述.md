...
### 当前一代实例
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;系列 2 采用 Intel E5-Xeon Broadwell（v4） CPU、搭配 DDR4 内存，拥有更好的内存计算能力；其中高 IO 型/计算型搭配网络增强，包转发能力达30w。整数和浮点运算的性能翻倍，整体计算能力更强。
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;实例系列2目前只支持 华南地区(广州)－广州三区 和 华东地区(上海)－上海一区 的购买.如需购买，请点击 [这里](http://www.qcloud.com/event/cvm2.html)。
