---
title: 2017-7-10 CVM-win快速入门
tags: CVM,Windows,快速入门
...
---
	...
	* [步骤一：购买准备](#步骤一购买准备)
		* [注册腾讯云账号](#注册腾讯云账号)
		* [确定云服务器所在地域](#确定云服务器所在地域)
		* [确定云服务器配置需求](#确定云服务器配置需求)
		* [确定付费方式](#确定付费方式)
	* [步骤二：购买与创建Windows云服务器](#步骤二购买与创建windows云服务器)
		* [选择地域与机型](#选择地域与机型)
		* [选择镜像](#选择镜像)
		* [选择存储与网络](#选择存储与网络)
		* [设置信息](#设置信息)
	* [步骤三：登录Windows云服务器](#步骤三登录windows云服务器)
		* [前提条件](#前提条件)
		* [查看站内信及云服务器信息](#查看站内信及云服务器信息)
		* [控制台登录云服务器](#控制台登录云服务器)
		* [本地Windows机器登录云服务器](#本地windows机器登录云服务器)
	* [步骤四：格式化数据盘（可选）](#步骤四格式化数据盘可选)
		* [前提条件](#前提条件)
		* [格式化数据盘](#格式化数据盘)
		* [磁盘分区（可选）](#磁盘分区可选)
	* [步骤五：安装部署应用环境（可选）](#步骤五安装部署应用环境可选)
		* [安装配置IIS和ASP](#安装配置iis和asp)
		* [搭建MySQL](#搭建mysql)
		* [安装PHP](#安装php)
		* [使用FileZilla搭建FTP服务](#使用filezilla搭建ftp服务)
...
![][17]
  ...
  [1]: ./images/1499831040984.jpg
  [2]: ./images/1499831040987.jpg
  [3]: ./images/1499831040999.jpg
  [4]: ./images/1499831040995.jpg
  [5]: ./images/1499831040999_1.jpg
  [6]: ./images/1499831040988.jpg
  [7]: ./images/1499831040985.jpg
  [8]: ./images/1499831040989.jpg
  [9]: ./images/1499831040989_1.jpg
  [10]: ./images/1499831040994.jpg
  [11]: ./images/1499831040995_1.jpg
  [12]: ./images/1499831040996.jpg
  [13]: ./images/1499831040985_1.jpg
  [14]: ./images/1499831040986.jpg
  [15]: ./images/1499831040986_1.jpg
  [16]: ./images/1499831040997.jpg
  [17]: ./images/1499831040996_1.jpg
  [18]: ./images/image1_1.png
  [19]: ./images/image2.png