...
<dx-accordion>
::: rc.local 被增加恶意命令[](id:maliciousCommands)
...
:::
::: crontab 被增加恶意任务[](id:maliciousTask)
...
:::
::: ld.so.preload 增加动态库劫持[](id:dynamicLibraryHijacking)
...
:::
::: sysctl.conf 配置大页内存[](id:hugePageMemory)
