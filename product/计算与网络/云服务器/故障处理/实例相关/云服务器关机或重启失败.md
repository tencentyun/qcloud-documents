...
<tbody>
  <tr>
    <td>检查 CPU/内存的使用情况</td>
    <td ><a href="#tcpPacketLoss"> 检查 CPU/内存的使用情况</a></td>
  </tr>
  <tr>
    <td>检查是否安装 ACPI 管理程序</td>
    <td><a href="#CheckNetworkLink"> 检查是否安装 ACPI 管理程序</a></td>
  </tr>
  <tr>
    <td>检查是否进行 WindowsUpdate</td>
    <td><a href="#CheckServer">检查是否进行 WindowsUpdate</a></td>
  </tr>
  <tr>
    <td>检查云服务器是否完成初始化</td>
    <td><a href="#CheckOtherProblems">检查云服务器是否完成初始化</a></td>
  </tr>
  <tr>
    <td>检查已安装的软件是否正常</td>
    <td><a href="#CheckOtherProblems1">检查已安装的软件是否正常</a></td>
  </tr>
  <tr>
    <td>强制关机/重启功能</td>
    <td><a href="#MandatoryShutdownOrRestart">强制关机/重启功能</a></td>
  </tr>
</tbody>
</table>
- CPU 或者内存使用率过高。
...
### 检查 CPU/内存的使用情况[](id:tcpPacketLoss)
...
### 检查是否安装 ACPI 管理程序[](id:CheckNetworkLink)
...
### 检查是否进行 WindowsUpdate[](id:CheckServer)
...
### 检查云服务器是否完成初始化[](id:CheckOtherProblems)
...
###  检查已安装的软件是否正常[](id:CheckOtherProblems1)
