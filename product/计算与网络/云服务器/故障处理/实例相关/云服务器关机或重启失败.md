...
<tbody>
  ...
  <tr>
    <td>云服务器实例未强制关机或重启功能</td>
    <td><a href="#MandatoryShutdownOrRestart">检查云服务实例是否强制关机或重启功能</a></td>
  </tr>
</tbody>
</table>
...
若仍无法关机/重启，请执行 [检查云服务实例是否强制关机或重启功能](#MandatoryShutdownOrRestart)。
...
```
 -  如果存在 ACPI 进程，请执行 [检查云服务实例是否强制关机或重启功能](#MandatoryShutdownOrRestart)。
...
- 如果没有正在更新的补丁或程序，请执行 [检查云服务实例是否强制关机或重启功能](#MandatoryShutdownOrRestart)。
...
- 如果云服务器已完成初始化，请执行 [检查云服务实例是否强制关机或重启功能](#MandatoryShutdownOrRestart)。
...
- 如果未发现异常，请执行 [检查云服务实例是否强制关机或重启功能](#MandatoryShutdownOrRestart)。


### 检查云服务实例是否强制关机或重启功能[](id:MandatoryShutdownOrRestart)
