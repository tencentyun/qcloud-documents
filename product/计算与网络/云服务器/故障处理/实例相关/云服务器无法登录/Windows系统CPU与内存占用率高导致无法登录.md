...
2. 对 CPU 或内存占用率高的进程进行分析。
 ...
 - 如果是腾讯云组件进程，请通过 [在线支持](https://cloud.tencent.com/online-service?from=connect-us) 联系我们进行进一步定位处理。
...
请通过 [在线支持](https://cloud.tencent.com/online-service?from=connect-us) 联系我们进行进一步定位处理。
