...
![无公网IP](https://main.qcloudimg.com/raw/c3de8a36a5fec23c75eceb22eb239d66.png)
 - 是，检查实例是否购买公网 IP。
 - 否，请 [申请弹性公网 IP 并进行绑定](https://cloud.tencent.com/document/product/213/16586)，再测试远程连接是否成功。
 
###  检查是否购买公网带宽
检查公网带宽是否为0Mb（最少1Mbps）。
 - 是，请通过 [调整网络](https://cloud.tencent.com/document/product/213/15517) 将带宽调整到1Mbps或以上，再测试远程连接是否成功。
...
13. 对 Windows 实例完成以上设置，再次测试是否可以远程登录成功。
