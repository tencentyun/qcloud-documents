...
| 可能原因 | 处理措施 | 
|---------|---------|
| 检查实例是否正常运行状态| [排查实例处于非正常运行状态](#eax) |
| 检查服务器是否设置公网 IP| [排查服务器是否设置公网 IP](#step01) |
| 检查实例绑定的安全组未放通远程登录端口 | [排查实例绑定的安全组未放通远程登录端口（默认为3389）](#step03) |
| 检查远程桌面服务 | [排查远程桌面服务未启动](#step04) |
| 检查是否购买公网带宽 | [排查是否购买公网带宽](#step02) |
| 检查Windows 防火墙设置 | [排查Windows 防火墙设置问题](#step05) |
