...
## 可能原因
在 CentOS 6.x 操作系统中，因为 grep 版本的不同，initscripts 的版本低于 9.03.49-1 存在缺陷。此时，需要升级 initscripts 到最新的版本，并重新生成 DNS 信息。
...
```
可得知，initscripts-9.03.40-2 低于问题版本 initscripts-9.03.49-1，存在 DNS 被清空的风险。
