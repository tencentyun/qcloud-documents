...
<tbody>
  <tr>
    <td>检查本地客户端</td>
    <td ><a href="#tcpPacketLoss"> 检查本地客户端</a></td>
  </tr>
  <tr>
    <td>检查网络链路</td>
    <td><a href="#CheckNetworkLink"> 检查网络链路</a></td>
  </tr>
  <tr>
    <td>检查服务器</td>
    <td><a href="CheckServer">检查服务器</a></td>
  </tr>
  <tr>
    <td>检查其他问题</td>
    <td><a href="#CheckOtherProblems">检查其他问题</a></td>
  </tr>
</tbody>
</table>
...
您也可以直接使用公网 IP 访问对应页面，排查是否为 DNS 的问题导致网站访问卡慢。
 - 是，请检查 DNS 解析，具体操作可参见 [解析生效相关](https://cloud.tencent.com/document/product/302/30597)。
