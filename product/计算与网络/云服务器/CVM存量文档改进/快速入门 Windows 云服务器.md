本文主要介绍如何从零开始，以最简单的方式搭建一个 Windows 云服务器。<br>

如果您之前没有搭建云服务器的经验，建议您按照本文介绍的方式来购买和配置您的第一台云服务器。

云服务器按照系统的版本可以分为 Windows 云服务器和 Linux 云服务器，如果您想了解如何从零开始搭建一台 Linux 云服务器，可以参考 [零基础配置 Linux 云服务器]([https://cloud.tencent.com/document/product/213/2936)。
...
- **机型**：您需要的云服务器机型配置。这里我们选择 “入门设置（1核1GB）”。 
...
2. 根据您本地操作系统的类型，选择不同的登录方式：
	- 如果您本地是 Windows 系统，请先下载 RDP 文件到本地，再双击打开刚下载的 RDP 文件，输入云服务器的帐号和密码登录。
	- 如果您本地是 Linux 系统，推荐您首先安装 rdesktop 软件，并按照 [Linux 系统使用 RDP 登录](https://cloud.tencent.com/document/product/213/5435#linux-.E7.B3.BB.E7.BB.9F.E4.BD.BF.E7.94.A8-rdp-.E7.99.BB.E5.BD.95)。
	- 如果您本地是 MacOS 系统，推荐您首先安装 Microsoft Remote Desktop for Mac 软件，并按照  [MacOS 系统使用 RDP 登录](https://cloud.tencent.com/document/product/213/5435#macos-.E7.B3.BB.E7.BB.9F.E4.BD.BF.E7.94.A8-rdp-.E7.99.BB.E5.BD.95)。
