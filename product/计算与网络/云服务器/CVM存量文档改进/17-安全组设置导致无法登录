...
如果通过工具检查，确认为安全组端口设置问题，但您不想通过【一键放通】功能放通所有云服务器的常用端口，或者您需要自定义远程登录端口，您还可以通过自定义配置安全组的入站和出站规则，解决无法远程连接的问题。具体操作请参考 [修改安全组规则](https://cloud.tencent.com/document/product/213/18197#.E4.BF.AE.E6.94.B9.E5.AE.89.E5.85.A8.E7.BB.84.E8.A7.84.E5.88.99)。
