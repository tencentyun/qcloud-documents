...
<table>
    <tr>
      <th style="width: 40%;">镜像类型</th>
    <th style="width: 60%;">服务支持</th>
    </tr>
    <tr>
        <td>腾讯云自研镜像 <a href="https://cloud.tencent.com/document/product/1397">encentOS Server</a></td>
        <td>腾讯云自研镜像TencentOS Server是针对云的场景研发的 Linux 操作系统，由腾讯云提供技术支持与维护。</td>
    </tr>
    <tr>
        <td>第三方镜像</td>
        <td><li>第三方开源镜像相关问题请联系开源社区或操作系统原厂获得技术支持，腾讯云将对问题的调查提供技术协助。<br></li><li> 腾讯云上选用第三方商业镜像，腾讯云工程师团队会协助您解决操作系统上发生的问题，必要时腾讯云团队会与原厂商联系获取帮助和支持。</td></li>
...
- **操作系统官方维护计划**：
腾讯云提供的公共镜像维护周期将与官方公布的维护周期保持一致，您可在文档 [操作系统官方维护计划](https://cloud.tencent.com/document/product/213/82003) 查看不同操作系统平台对于各版本镜像的维护计划。
- **公共镜像更新记录**：
腾讯云将根据官方发布的更新、补丁修复等信息，定期对公有云提供的公共镜像进行定期的更新，您可在文档 [公共镜像更新记录](https://cloud.tencent.com/document/product/213/46059) 查看镜像更新动态。
...
### Linux系统镜像列表如下所示：
腾讯云公共镜像包含丰富的第三方Linux系统镜像，如OpenCloudOS、CentOS、Ubuntu以及商业镜像Red Hat Enterprise Linux 等。
...
<table>
    <tr>
        <th style="width: 20%;">镜像版本</th>
      <th style="width: 20%;">镜像名称</th>
        <th style="width: 20%;">镜像ID</th>
    </tr>
    <tr>
        <td  rowspan='3'>Ubuntu Server 22.04 LTS </td>
