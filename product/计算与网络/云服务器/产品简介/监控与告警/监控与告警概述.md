...
- **Dashboard 设置：**您可以针对监控指标设置 Dashbaord， 通过 Dashboard 动态分析指标异常原因。您也可以实时观察指标变化情况，及时进行资源扩容。详情参考 [新建 Dashboard](https://cloud.tencent.com/document/product/248/46747)。
