...
- 您可以使用弹性伸缩定时或根据条件自动地增加或减少服务器集群数量。更多信息，请参见 [弹性伸缩产品文档](https://cloud.tencent.com/document/product/377)。
...
- 您可以使用腾讯云可观测平台服务监控云服务器实例及其系统盘。更多信息，请参考 [腾讯云可观测平台产品文档](https://cloud.tencent.com/document/product/248)。
