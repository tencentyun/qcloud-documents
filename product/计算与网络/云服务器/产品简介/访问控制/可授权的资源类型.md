资源级权限指的是能够指定用户对哪些资源具有执行操作的能力。云服务器（Cloud Virtual Machine，CVM）部分支持资源级权限，即表示针对支持资源级权限的 CVM 操作，您可以在满足限定的 [生效条件](https://cloud.tencent.com/document/product/213/10313#cvm-.E7.9A.84.E6.9D.A1.E4.BB.B6.E5.AF.86.E9.92.A5) 下，控制何时允许用户执行操作或是允许用户使用的特定资源。例如，您 [授权用户拥有广州地域的 CVM 操作权限](https://cloud.tencent.com/document/product/213/10312#.E6.8E.88.E6.9D.83.E7.94.A8.E6.88.B7.E6.8B.A5.E6.9C.89.E7.89.B9.E5.AE.9A-cvm-.E7.9A.84.E6.93.8D.E4.BD.9C.E6.9D.83.E9.99.90.E7.AD.96.E7.95.A5)。
