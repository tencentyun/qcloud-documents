...
> **Note**:
> Any CVM API operation not listed here does not support resource-level permission. If a CVM API operation does not support resource-level permission, you can still authorize users to perform this operation, but you must specify * for the resource element of policy statement.
