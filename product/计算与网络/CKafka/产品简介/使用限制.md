...
| 限制项 | 说明 |
|---------|---------|
| Topic 总数量 | 根据产品规格不同固定上限，专业版可额外补充 Topic 数量。 | 
...
| 实例 | <li>不支持变更实例地域属性。</li><li>客户端实例最大连接数量为500。</li>| 
| 版本 | <li>标准版：兼容开源0.9、0.10、1.1版本，默认安装1.1版本，不支持定制版本。</li><li>专业版：兼容开源0.9、0.10、1.1、2.4版本，可以在购买时自由选择。</li> |
