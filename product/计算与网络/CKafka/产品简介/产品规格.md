...
| 项目 | 标准版 | 专享版 |
|---------|---------|---------|
|版本| 兼容开源0.9、0.10版本<br>默认安装0.10.2 版本，不支持定制版本<br> 独占型实例支持 0.10.2以及1.1.1|兼容开源0.9、0.10、1.1.1版本<br>默认安装1.1.1版本<br>|
|实例类型|共享物理节点资源|专享实例，独占虚拟主机节点|
|实例规格|分为入门型、标准型和独占型等9种实例类型|暂时支持入门型|
|实例价格|参考 [标准版计费说明](https://cloud.tencent.com/document/product/597/11745)|公测期间新实例优惠限定，价格与标准版-入门型相同，正式发布后价格可能进行调整，以官方通知为准|
|性能调优|根据不同实例规格限制Topic、partition个数|支持根据业务场景定制|
|阶段|正式商用|公测|
...
- 专享版实例暂不支持 [路由接入方式](https://cloud.tencent.com/document/product/597/36348) 默认 VPC 网络。
- 专享版实例暂不支持公网访问。
