...
2. oss 配置文件
>!启动 oss 会创建 _schemas 主题，所以实例开启了自动创建，或者创建这个主题（没试过，测试时开了自动创建）。

![](https://main.qcloudimg.com/raw/5482de42c702cf4d43a3498e4592f420.png)
![](https://main.qcloudimg.com/raw/a29cdea9a265160c7a4beadf59dc327d.png)
3. 启动 Schema Registry
`bin/schema-registry-start etc/schema-registry/schema-registry.properties`
![](https://main.qcloudimg.com/raw/241e7fb7d84dcd69edfedd9b41577772.png)
...
2. 注册 schema 到 topic（注册 topic 为 test）
```
