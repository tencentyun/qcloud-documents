...
## 操作步骤
### 1. 创建实例
新建一个新版 CKafka 实例（详情请参考 [创建实例](https://cloud.tencent.com/document/product/597/30931)）。

### 2. 创建 Topic
创建与旧版 CKafka 名字相同的 Topic（详情请参考 [创建 Topic](https://cloud.tencent.com/document/product/597/40415)）。
