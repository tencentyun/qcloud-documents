...
| 路由类型 | VPC 网络                                                     | 公网域名接入                                                 |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 接入方式 | <li>PLAINTEXT</li><br/><li>SASL_PLAINTEXT</li><br/><li>SASL_SSL（仅专业版实例支持）</li><br/><li>SASL_SCRAM（仅北京地域且2.4.1版本实例支持，其他地域和存量实例需要[提交工单]([https://console.cloud.tencent.com/workorder/category?level1_id=876&level2_id=951&source=0&data_title=%E6%B6%88%E6%81%AF%E6%9C%8D%E5%8A%A1%20CKafKa&step=1](https://console.cloud.tencent.com/workorder/category?level1_id=876&level2_id=951&source=0&data_title=消息服务 CKafKa&step=1))申请）</li> | <li>SASL_PLAINTEXT</li><br><li>SASL_SSL（仅专业版实例支持）</li> |
