...
| 路由类型 | VPC 网络                                                     | 公网域名接入                                                 |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 接入方式 | <li>PLAINTEXT</li><li>SASL_PLAINTEXT</li><li>SASL_SSL（仅专业版实例支持）</li><li>SASL_SCRAM（仅北京地域且2.4.1版本实例支持，其他地域和存量实例需要 <a href = "https://console.cloud.tencent.com/workorder/category?level1_id=876&level2_id=951&source=0&data_title=消息服务CKafKa&step=1">提交工单</a> 申请）</li> | <li>SASL_PLAINTEXT</li><li>SASL_SSL（仅专业版实例支持）</li> |
