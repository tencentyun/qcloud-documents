...
当前 CKafka 未开放自动创建 Topic 的开源接口，建议客户通过标准的 API 接口 [CreateTopic](https://cloud.tencent.com/document/product/597/40851) 创建 Topic。
>!
- 通过接口 [CreateTopic](https://cloud.tencent.com/document/product/597/40851) 自动创建的 Topic 也会占用您实例中 Topic 和 Partition 的配额，请注意配额限制。
