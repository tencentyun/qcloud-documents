...
|消息可靠性|	较高<br>可通过三副本方式提升可靠性，集群容灾性能好，故障情况极少发生|	低<br>broker只有异步刷盘机制并主备只有异步复制，可能会导致丢失部分消息	|高<br>发送消息时，指定消息为持久化就会写入到磁盘	|高<br>broker具有同步双写机制，主备都写成功才向应用返回成功	|极高<br>保证消息不丢失同步刷盘，数据持久性99.999999%|
