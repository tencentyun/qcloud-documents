...
- **异步拉取-服务类：**支持 MongoDB，日志服务 CLS和 DTS。
  ...
  - 数据传输服务 DTS：支持 DTS 数据接入 CKafka。详细操作参见 [数据传输服务 DTS]()。
...
- **异步拉取-日志类：**支持容器服务（TKE）日志和云防火墙日志。
  ...
  - 云防火墙日志：通过日志投递功能，您可以将云防火墙日志自动投递到指定的 CKafka 实例中。详细操作参见 [日志分析](https://cloud.tencent.com/document/product/1132/46644)。
