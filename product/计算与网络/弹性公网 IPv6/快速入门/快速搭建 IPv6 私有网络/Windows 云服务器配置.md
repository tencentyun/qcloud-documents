...
4. 在“Internet 协议版本 6（TCP/IPv6）属性”弹窗中，手工输入云服务器获取到的 IPv6 地址 (请参见[搭建 IPv6 私有网络：步骤三](https://tcloud-doc.isd.com/document/product/215/47557?!editLang=zh&!preview)) 并设置 DNS（推荐使用`240c::6666`），单击【确定】。
