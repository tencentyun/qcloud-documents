...
## 解决思路
1. 如果通过 `ifconfig`，没有看到“fe80”开头的 IPv6 地址，则说明云服务器没有开启 IPv6 功能。<sapn id="handlestep1" />请参见 [快速入门-步骤6](https://cloud.tencent.com/document/product/1142/38130#.E6.AD.A5.E9.AA.A46.EF.BC.9A.E7.99.BB.E5.BD.95.E4.BA.91.E6.9C.8D.E5.8A.A1.E5.99.A8.EF.BC.8C.E5.BC.80.E5.90.AF-ipv6) ，选择您所需的镜像开启 IPv6 的方式重新配置，可以通过执行 `sysctl -a | grep ipv6 | grep disable` 来确认。
