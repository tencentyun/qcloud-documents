...
![](https://main.qcloudimg.com/raw/3779eef119d349c3fab32d53f1d942e8.png)
 - 如果已获取表明该镜像已经开启了 IPv6 功能，请执行 [步骤2](#step2)。 
 - 如果未获取，请参见 [解决思路-步骤1](#handlestep1)。
...
![](https://main.qcloudimg.com/raw/8493e3bb2d5f2276527bf89e5c8907c5.png)
 - 如果已获取，请执行 [步骤3](#step2)。 
 - 如果未获取，请参见 [解决思路-步骤2](#handlestep2)。
...
![](https://main.qcloudimg.com/raw/01f56c86f25d721f2849b80061046c82.png)
 - 如果已配置默认路由且能 Ping 通公网，请执行 [步骤4](#step3)。
 - 如果看不到默认路由，或无法如果 Ping 通公网，请参见 [解决思路-步骤3](#handlestep3)。

4. 执行如下命令，确认是否22端口和80端口都已经监听了 IPv6。<span id="step4" />
```
netstat - tupln
```
...
ifconfig
```
3. 如果已经获取到 IPv6 地址，但是无法 Ping 通公网，则可以通过 `ip -6 route show` 查看是否已经配置默认路由。如果看不到默认路由，则需要：<span id="handlestep3" />
