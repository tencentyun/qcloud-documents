...
## 解决思路
1. 如果通过 `ifconfig`，没有看到“fe80”开头的 IPv6 地址，则说明云服务器没有开启 IPv6 功能。<sapn id="handlestep1" />请参见 [快速入门-步骤2：云服务器配置 IPv6](https://cloud.tencent.com/document/product/1142/40134) ，选择您所需的镜像开启 IPv6 的方式重新配置，可以通过执行 `sysctl -a | grep ipv6 | grep disable` 来确认。
