...
2. 执行如下命令，查看网卡的默认路由。<sapn id="step2" />
```
ip -6 route show
```
...
![](https://main.qcloudimg.com/raw/01f56c86f25d721f2849b80061046c82.png)
 - 如果已配置默认路由且能 Ping 通公网，请执行 [步骤3](#step3)。
 - 如果看不到默认路由，或无法如果 Ping 通公网，请参见 [解决思路-步骤3](#handlestep3)。

3. 执行如下命令，确认是否22端口和80端口都已经监听了 IPv6。<span id="step3" />
```
netstat - tupln
```
...
![](https://main.qcloudimg.com/raw/983a49105b07fd033556c5d876d2e11b.png)
  2. 通过执行 `netstat -tupln` 查看22或者80等端口是否已监听 IPv6，可参见上文 [操作步骤-步骤3](#step3)。
