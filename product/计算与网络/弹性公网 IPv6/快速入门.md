...
下载该工具到系统，下载地址：[enable-ipv6 工具下载](https://iso-1251783334.cos.ap-guangzhou.myqcloud.com/scripts/enable_ipv6.sh)。
赋予执行权限后使用管理员权限执行：
```
chmod +x ./enable_ipv6
./enable_ipv6 [网卡名称]

e.g. ./enable_ipv6 eth0
	 ./enable_ipv6 eth1
```
...
下载该工具到系统，下载地址：[config_ipv6 工具下载](https://iso-1251783334.cos.ap-guangzhou.myqcloud.com/scripts/config_ipv6.sh)。
赋予执行权限后使用管理员权限执行：
