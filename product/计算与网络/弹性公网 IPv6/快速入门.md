...
### 步骤2：为子网分配 IPv6 CIDR
1. 登录 [私有网络控制台](https://console.cloud.tencent.com/vpc)。
2. 在目标云服务器所属子网所在行的操作栏下，单击【获取 IPv6 CIDR】并确认操作，系统将从 VPC 的`/56` IPv6 CIDR 分配一个`/64`的 IPv6 CIDR。
...
4. 勾选目标云服务器的 IPv6 地址、设置目标带宽上限	，单击【提交】即可。
>?
...
```
![](https://main.qcloudimg.com/raw/4b3937053527ea3edd3efedfa0113ca9.png)
16. 测试连通性，请参见 [步骤7：测试 IPv6 的连通性](#.E6.AD.A5.E9.AA.A47.EF.BC.9A.E6.B5.8B.E8.AF.95-ipv6-.E7.9A.84.E8.BF.9E.E9.80.9A.E6.80.A7)。
...
```
![](https://main.qcloudimg.com/raw/4b3937053527ea3edd3efedfa0113ca9.png)
19. 测试连通性，请参见 [步骤7：测试 IPv6 的连通性](#.E6.AD.A5.E9.AA.A47.EF.BC.9A.E6.B5.8B.E8.AF.95-ipv6-.E7.9A.84.E8.BF.9E.E9.80.9A.E6.80.A7)。
<span id="Debian8.2"/>
...
```
8. 测试连通性，请参见 [步骤7：测试 IPv6 的连通性](#.E6.AD.A5.E9.AA.A47.EF.BC.9A.E6.B5.8B.E8.AF.95-ipv6-.E7.9A.84.E8.BF.9E.E9.80.9A.E6.80.A7)。
