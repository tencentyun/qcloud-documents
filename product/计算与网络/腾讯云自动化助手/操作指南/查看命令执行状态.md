## 操作场景
本文介绍通过**登录实例**或**轻量应用服务器控制台**两种查看腾讯云自动化助手命令执行状态的方法，您可按需选择方式查看命令的执行状态信息。命令的所有执行状态信息，请参见 [命令执行状态](https://cloud.tencent.com/document/product/1340/50752)。
...
![](https://main.qcloudimg.com/raw/47ec4b51674090d8a4c846a21e72b78c.png)
