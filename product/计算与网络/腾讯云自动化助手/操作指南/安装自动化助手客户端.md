...
<dx-alert infotype="notice" title="">
为实现切换用户身份执行脚本的功能，TAT 需在安装脚本中自动创建名为 TAT-AGENT 的用户，并以该身份启动 tat_agent 进程。该创建过程可在安装脚本中查看，详情请参见 [winutil.ps1](https://github.com/Tencent/tat-agent/blob/main/install/winutil.ps1)。
</dx-alert>
