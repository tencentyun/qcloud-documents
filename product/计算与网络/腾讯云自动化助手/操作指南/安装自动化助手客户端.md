...
```
wget https://tat-gz-1258344699.cos.ap-guangzhou.myqcloud.com/tat_agent_windows_x86_64_0.1.18.zip -OutFile .\tat_agent_windows.zip;Expand-Archive -Path .\tat_agent_windows.zip -DestinationPath .\tat_agent_windows;.\tat_agent_windows\install.bat;Remove-Item -Recurse -Force .\tat_agent_windows, .\tat_agent_windows.zip
```
...
```
https://tat-gz-1258344699.cos.ap-guangzhou.myqcloud.com/tat_agent_windows_x86_64_0.1.18.zip
```
2. 解压，并进入文件夹。
