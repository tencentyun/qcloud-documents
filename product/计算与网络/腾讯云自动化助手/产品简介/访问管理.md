...
您可通过以下示例，快速了解如何使用 CAM 进行权限控制：
 - [允许修改和删除命令 cmd-xxxxxxxx](#example1)
 - [允许查看命令 cmd-xxxxxxxx 的详情](#example2)
 - [允许查看命令 cmd-xxxxxxxx 的执行结果](#example3)
 - [禁止用户执行命令 cmd-xxxxxxxx](#example4)
 - [禁止用户执行任何命令](#example5)
 - [禁止用户在云服务器实例 ins-xxxxxxxx 上执行任何命令](#example6)
 - [禁止用户在任何云服务器实例上执行命令](#example7)
 - [禁止用户在轻量应用服务器实例 lhins-xxxxxxxx 上执行任何命令](#example8)
 - [禁止用户在任何轻量应用服务器实例上执行命令](#example9)
 - [允许用户在云服务器实例 ins-xxxxxxxx 上执行命令 cmd-xxxxxxxx 或 cmd-yyyyyyyy](#example10)
 - [允许用户在轻量应用服务器实例 lhins-xxxxxxxx 上执行命令 cmd-xxxxxxxx 或 cmd-yyyyyyyy](#example11)
 - [禁止用户查看云服务器实例 ins-xxxxxxxx 的命令执行任务结果](#example12)
 - [禁止用户查看轻量应用服务器实例 lhins-xxxxxxxx 的命令执行任务结果](#example13)
 - [禁止用户查看云服务器实例 ins-xxxxxxxx 的 Agent 运行状态](#example14)
 - [禁止用户查看轻量应用服务器实例 lhins-xxxxxxxx 的 Agent 运行状态](#example15)
