...
3. 选择左侧导航栏中的**基本信息**，即可在基本信息页面中查看**集群APIServer信息**模块中该集群的访问地址、外网/内网访问状态、Kubeconfig 访问凭证内容等信息。如下图所示：
	...
	<img src="https://qcloudimg.tencent-cloud.cn/raw/27782c40a6780c50c44d2849571aa6c5.png" width=600/>
...
3. 选择左侧导航栏中的**授权管理** > **ClusterRole**，单击主界面的**获取集群Admin角色**，即可获取集群 Admin 角色。
	<img src="https://qcloudimg.tencent-cloud.cn/raw/daf6a50f98b96d986320029e44a9fcd2.png" width=700/>
