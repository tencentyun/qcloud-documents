...
> ?
> 对于微服务API，不建议同时将X-NameSpace-Code和X-MicroService-Name定义为Path参数。如需同时定义为Path参数，请使用固定串分割，如/{X-NameSpace-Code}/{X-MicroService-Name}/service。
