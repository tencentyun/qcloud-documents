...
>!API 网关于2018年9月20日晚-21日对接CAM，为避免影响现有客户所有账户的使用，我们会默认对20日前的 API 网关用户的账户子账户均授予 QcloudAPIGWFullAccess 权限，这意味着您的子账户跨账户等均拥有对 API 网关现有服务及 API 的完全管理权限，此授权不影响其他产品的权限，若您希望更精确管理账户的权限策略，则可参考下面的示例进行更改**。
