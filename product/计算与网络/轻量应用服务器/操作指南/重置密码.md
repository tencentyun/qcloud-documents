...
## 注意事项
- **删除**：只有处于关机状态的实例才允许执行重置密码操作。
- **添加**：轻量应用服务器控制台支持在线重置与离线重置两种重置密码的方式。
...
1. 登录 [轻量应用服务器控制台](https://console.cloud.tencent.com/lighthouse/instance/index) 后，您可通过以下方式，打开实例重置密码操作窗口：
 ...
 <img style="width:900px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/1095e8b968bc80ae556539766975ca2c.png" />
 - 选择实例卡片进入实例详情页后，单击页面右上角的**重置密码**。如下图所示：
  <img style="width:900px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/6953af46a2ccac4afe1494f27be021bb.png" />
...
如果您使用在线重置密码时失败或无效，请参见实例重置密码失败或无效（文档链接） 排查原因。
</dx-alert>
