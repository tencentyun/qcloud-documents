...
>!同账号下不同地域的轻量应用服务器所在 VPC 关联云联网时，由于 VPC 的子网 CIDR 可能重叠，则可能导致路由冲突。需前往 [云联网控制台](https://console.cloud.tencent.com/vpc/ccn) 查看路由信息，确认新增的路由条目是否有效，详情请参见 [查看路由信息](https://cloud.tencent.com/document/product/877/18756)。
>
