...
![](https://qcloudimg.tencent-cloud.cn/raw/518656335e77a88cea2dc29f66202a41.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/625e7439d11a74c5f562d976b5c4ecfb.png)
4. [](id:step4)联机后磁盘1由脱机状态变为没有初始化。右键单击磁盘1区域，在菜单列表中选择**初始化磁盘**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/2513d23ae2e37fd8a4016f3d7ed2d3a0.png)
5. 在“初始化磁盘”弹窗中勾选需要初始化的磁盘，选择磁盘分区形式并单击**确定**。本文以选择“MBR（主启动记录）”为例，如下图所示：
<dx-alert infotype="notice" title="">
磁盘投入使用后再切换磁盘分区形式，磁盘上的原有数据将会清除，因此请根据实际需求合理选择分区形式。
</dx-alert>
![](https://qcloudimg.tencent-cloud.cn/raw/b5f7c9408e358c26c9d70b488ac915ed.png)
6. 右键单击磁盘1未分配的区域，选择**新建简单卷**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/f29e6fb5d83b431ecc881c3165cf1515.png)
7. 弹出“新建简单卷向导”窗口，根据界面提示，单击**下一步**。
8. 根据实际情况指定卷大小，默认为最大值，单击**下一步**。
9. 分配驱动器号，单击**下一步**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/42ab0c6dd84baaad707be171be673c0a.png)
10. 选择“按下列设置格式化这个卷”，并根据实际情况设置参数，格式化新分区，单击**下一步**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/1d9b4e182c9e3024aa3be09166b7d89b.png)
11. 单击**完成**完成分区创建。需要等待片刻让系统完成初始化操作，当卷状态为状态良好时，表示初始化磁盘成功。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/87dfae528b762f24c7449d11de4b541c.png)
初始化成功后，进入“计算机”界面可以查看到新磁盘。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/d4497505681f7a06650c945ba3cac1f7.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/35ae2aaa1df8a77ec9848a9ec64d4702.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/d78fd03c90806ed6d560845a36aa2b70.png)
...
```
返回类似如下图所示信息：
![](https://qcloudimg.tencent-cloud.cn/raw/b5fe52c367a3f8f4c0e5374878c6b0bc.png)
4. 输入 **n** 并按 **Enter**，开始新建分区。返回如下图所示信息：
![](https://qcloudimg.tencent-cloud.cn/raw/ed0a41f5d9cf219eaf4c81808e4c021d.png)
表示磁盘有两种分区类型：
 - **p** 表示主要分区。
 - **e** 表示扩展分区。
5. 以创建一个主要分区为例，输入 **p** 并按 **Enter**，开始创建一个主分区。返回如下图所示信息：
![](https://qcloudimg.tencent-cloud.cn/raw/6af118b2d8f3aeac1db599829dbd33d9.png)
**Partition number** 表示主分区编号，可以选择1 - 4。
6. 以选择分区编号1为例，输入主分区编号 **1** 并按 **Enter**。返回如下图所示信息：
![](https://qcloudimg.tencent-cloud.cn/raw/7b23eddc6926ae520ae9e6f1f475f0d6.png)
**First sector** 表示初始磁柱区域，可以选择2048 - 41943039，默认为2048。
7. 以选择默认初始磁柱编号2048为例，按 **Enter**。返回如下图所示信息：
![](https://qcloudimg.tencent-cloud.cn/raw/c3d98fb8c5382b457c18140c0f2d4012.png)
**Last sector** 表示截止磁柱区域，可以选择2048 - 41943039，默认为41943039。
8. 以选择默认截止磁柱编号41943039为例，按 **Enter**。返回如下图所示信息：
![](https://qcloudimg.tencent-cloud.cn/raw/653728e907e2f06544c20c75f434732a.png)
9. 表示分区完成，即为20GB的数据盘新建了1个分区。
10. 输入 **p** 并按 **Enter**，即可查看新建分区 `/dev/vdb1` 的详细信息。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/0d9ba50f143466d4efc62245b31f70d6.png)
<dx-alert infotype="explain" title="">
若上述分区操作有误，请输入 **q** 退出 fdisk 分区工具，之前的分区结果将不会被保留。
</dx-alert>
11. 输入 **w** 并按 **Enter**，将分区结果写入分区表中。返回结果如下图所示，表示分区创建完成。
![](https://qcloudimg.tencent-cloud.cn/raw/d9bfef761b90511fdbc1ad7ff235ea20.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/a82519b988ff27a7986e17e50c99c843.png)
