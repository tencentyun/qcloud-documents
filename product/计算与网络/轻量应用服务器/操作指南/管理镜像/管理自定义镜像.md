...
- 如您的账户处于欠费状态：
 ...
 - 账号下已有的自定义镜像（包含免费配额内的镜像）都将被隔离进入“待回收”状态，无法使用，**占用超出免费额度的镜像将会持续计费**，直到镜像被删除。若自定义镜像进入“待回收”状态后7天内（包括第7天），账号余额未充正，则自定义镜像将会自动释放。
...
<img src="https://main.qcloudimg.com/raw/b4fdd3410ebec046a05bb1351ab31b1e.png"/>
