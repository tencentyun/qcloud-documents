...
<dx-accordion>
::: 选择登录实例[](id:choose)
您可通过该步骤，在同一个 WedShell 窗口中选择登录任意一台实例。具体步骤如下：
...
3. 在弹出的“选择要展示的实例”窗口中，选择您期望登录的实例。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/ebc15cae5b84fc92dca6c8380dade5ab.png)
4. 单击**确定**，即可在新的标签中登录该实例。
5. 您可选择 <img src="https://qcloudimg.tencent-cloud.cn/raw/5bb1db36d10fd49f34ecc27eda0e306a.png" style="margin:-3px 0px"> > **添加实例**，并添加所需登录的实例。添加成功后，您选择已添加的任意实例即可进行登录。如下图所示：
<dx-alert infotype="explain" title="">
目前最多支持添加10个实例。
</dx-alert>![](https://qcloudimg.tencent-cloud.cn/raw/41089996dd2363a7516c2683794e3cbf.png)
