腾讯云轻量应用服务器于2022年1月29日起，下线中国内地地域1核2GB内存200GB系统盘存储型实例套餐。使用已下线套餐的实例仍可按原价进行续费。但建议使用已下线套餐的用户进行实例套餐升级，详情请参见 [升级实例套餐](https://cloud.tencent.com/document/product/1207/51730)。
