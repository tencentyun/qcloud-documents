...
### 在轻量应用服务器中安装 Docker
 ...
 - 对于基于 CentOS 操作系统的实例，您可以参考 [Docker 官方文档 - 在 CentOS 中安装 Docker](https://docs.docker.com/engine/install/centos/) 进行安装。
 - 对于基于 Ubuntu 操作系统的实例，您可以参考 [Docker 官方文档 - 在 Ubuntu 中安装 Docker](https://docs.docker.com/engine/install/ubuntu/) 进行安装。
 - 对于基于 Windows 操作系统的实例，您可以参考 [Docker 官方文档 - 在 Windows 中安装 Docker](https://docs.docker.com/docker-for-windows/install/) 进行安装。
