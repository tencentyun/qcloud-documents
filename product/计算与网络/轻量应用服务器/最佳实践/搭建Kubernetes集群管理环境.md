...
```
<dx-alert infotype="explain" title="">
- master 节点操作系统为 CentOS 8.2，建议您添加同地域下的其他轻量应用服务器实例作为集群 Node 节点。如需创建实例，可使用 CentOS 8.2 系统镜像参考 [快速创建 Linux 实例](https://cloud.tencent.com/document/product/1207/44548) 进行创建。
...
1. 进入实例详情页，选择**防火墙**页签，参考 [配置轻量应用服务器网络防火墙](#configFirewall) 步骤放通 `TCP:30000-32767` 端口。
