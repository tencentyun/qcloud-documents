...
>!宝塔 Linux 面板（BT-Panel）目前已下线，您可使用宝塔 Linux 面板 7.5.1 腾讯云专享版。专享版覆盖普通版所有功能，还默认集成腾讯云对象存储、文件存储、内容分发网络和 DNS 解析插件。详情请参见 [使用宝塔 Linux 面板腾讯云专享版管理服务器](https://cloud.tencent.com/document/product/1207/54078)。
>
