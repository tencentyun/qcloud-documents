## 操作场景
Cloudreve 是一款开源的网盘软件，支持服务器本机及腾讯云对象存储 COS 等多种存储方式，提供离线下载、拖拽上传、在线预览等功能，能够帮助您快速搭建个人使用或多人共享的网盘系统。该镜像基于 CentOS 8.2 64位操作系统，已集成宝塔 Linux 面板，并已预置 Nginx、Aria2、MariaDB 软件。
