## 网站搭建
使用轻量应用服务器 Lighthouse 提供的精品镜像，可快速创建满足您业务诉求的网站，如企业官网、个人展示网站、博客、论坛、电商、外贸网站等。随着业务规模的增长，您还可以随时灵活升级服务器配置。 
...
## 云端学习环境
为您提供触手可及的云端学习环境，如 Ubuntu、CentOS、Debian 等常用 Linux 系统和 Windows Server 系统。您可以随时创建、随时销毁环境。
