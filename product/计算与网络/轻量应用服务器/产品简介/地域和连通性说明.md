...
### 可用区
- **简介**
每个地域内科包含多个电力和网络相互独立的物理区域，称为可用区（Zone）。
通常情况下，推荐您在创建实例时选择“随机分配”可用区，同一地域内不同可用区间的实例可通过内网互访。同地域下不用可用区间可实现故障隔离，若您的应用对于容灾能力有极高的要求，则可将不同轻量应用服务器实例部署在同一地域下的不同可用区内。但需注意不同实例跨可用区通信的时延较同一可用区内通信会有一定增加。
- **相关特性**
同一地域不同可用区的轻量应用服务器默认内网互通。
...
<table>
<tr>
<th width="50%">地域</th><th>可用区</th>
</tr>
<tr>
<td rowspan=2> 北京<br>ap-beijing</td>
<td>北京三区<br>ap-beijing-3</td>
</tr>
<tr>
<td>北京五区<br>ap-beijing-3</td>
</tr>
<tr>
<td rowspan=2>广州<br>ap-guangzhou</td>
...
<tr>
<td rowspan=2>上海<br>ap-shanghai</td>
...
<tr>
<td rowspan=2>香港<br>ap-hongkong</td>
<td>香港二区<br>ap-hongkong-2</td>
</tr>
<tr>
<td>香港三区<br>ap-hongkong-3</td>
</tr>
<tr>
</table>
...
<tr>
<td>新加坡<br>ap-singapore</td>
<td>新加坡一区<br>ap-singapore-1</td>
</tr>
<tr>
<td>东京<br>ap-tokyo</td>
<td>东京一区<br>ap-tokyo-1</td>
</tr>
<tr>
<td>硅谷<br>na-siliconvalley</td>
<td>硅谷二区<br>na-siliconvalley-2</td>
</tr>
<tr>
<td>莫斯科<br>eu-moscow</td>
<td>莫斯科一区<br>eu-moscow-1</td>
</tr>
</table>
