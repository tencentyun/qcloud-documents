...
OpenCloudOS 是 OpenCloudOS 社区发布的正式版本，其基础库和用户态组件完全与 CentOS 8兼容，并通过内核层面的优化和增强，经1000万+节点大规模验证，稳定性提升70%，特定场景性能提升50%，能够提供给用户相比于 CentOS 8更优的解决方案。当前最新版本为 OpenCloudOS 8.6。
...
- **获取 OpenCloudOS**
请前往 [OpenCloudOS官网](https://www.opencloudos.org/iso) 获取对应官方镜像版本。
<dx-alert infotype="explain" title="">
