...
- 如果您想对 [云监控](https://cloud.tencent.com/document/product/248/13466) 支持的轻量应用服务器资源设置性能消耗类指标的阈值告警，或针对轻量应用服务器实例或平台底层基础设施的服务状态设置事件告警。使发生异常时及时通过微信、邮件、短信、电话等渠道通知您采取措施，则需创建告警策略。更多信息，请参考 [新建告警策略](https://cloud.tencent.com/document/product/248/50398)。
