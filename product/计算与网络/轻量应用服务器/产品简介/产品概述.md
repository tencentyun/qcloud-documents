...
::: 系统镜像
- **镜像描述**
系统镜像中仅包含初始的操作系统（如 Linux 或 Windows Server）。不包含应用和相关的运行环境和配置信息（如 CentOS、Ubuntu、Windows Server 等操作系统的不同版本镜像）。
- **适用场景**
...
::: 应用镜像
- **镜像描述**
应用镜像除了包含底层的操作系统外，还封装了应用软件、应用依赖的运行环境以及相关的初始化配置信息，如 LAMP、WordPress、ASP.NET、Node.js、宝塔面板等。
- **适用场景**
...
<li>ASP.NET 4.8</li>
<li>宝塔 Linux 面板 7.5.1 腾讯云专享版</li>
...
#### 带宽
中国内地各个地域的轻量应用服务器提供的公网出方向带宽，可保障稳定、低延迟的网络质量。带宽具备一定限制，详情请参见 [带宽上限说明](https://cloud.tencent.com/document/product/1207/44755#BandwidthUpperLimit)。

#### 峰值带宽
中国港澳台地区和其他国家地域的轻量应用服务器提供的公网出方向带宽最大限制。带宽具备一定限制，详情请参见 [带宽上限说明](https://cloud.tencent.com/document/product/1207/44755#BandwidthUpperLimit)。
...
## 安全
默认免费开通 [DDoS 基础防护](https://cloud.tencent.com/document/product/1020/31625) 和 [主机安全](https://cloud.tencent.com/document/product/296/2221) 防护，帮助用户构建服务器安全防护体系。
