...
- **包含镜像**
<ul class="params">
<li>宝塔 Linux 面板 7.5.2 腾讯云专享版</li>
<li>Discuz! Q </li>
<li>WordPress 5.4.2 社区版</li>
<li>Typecho 1.1.0</li>
<li>Cloudreve 3.3.1</li>
<li>LAMP 7.3.15</li>
...
- 如果您想对 [云监控](https://cloud.tencent.com/document/product/248/13466) 支持的轻量应用服务器资源设置性能消耗类指标的阈值告警，针对轻量应用服务器实例或平台底层基础设施的服务状态设置事件告警。使发生异常时可及时通过微信、邮件、短信、电话等渠道通知您采取措施，则需创建告警策略。更多信息，请参考 [新建告警策略](https://cloud.tencent.com/document/product/248/50398)。
