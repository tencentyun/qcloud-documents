...
轻量应用服务器（Lighthouse）是新一代开箱即用、面向轻量应用场景的云服务器产品，助力中小企业和开发者便捷高效的在云端构建小型网站、博客、论坛、小程序/小游戏、云盘以及各类开发测试和学习环境，相比传统云服务器更加简单易用，并通过基础云资源与热门开源软件的融合打包实现应用的一站式交付，是您使用腾讯云的最佳入门途径。 
