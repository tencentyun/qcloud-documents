...
其中仅2核8GB、4核8GB及4核16GB实例套餐可享受时长折扣（折扣后的价格可在 <a href="https://buy.cloud.tencent.com/lighthouse?buy_from=lh-console">购买页</a> 面查看）。
</dx-alert>
...
>!仅使用2核8GB、4核8GB及4核16GB实例套餐，在新购或续费实例时可享受时长折扣。
