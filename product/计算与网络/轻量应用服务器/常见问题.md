...
[](id:Q42)
### 如何查看轻量应用服务器系统盘使用情况？
您可登录 [轻量应用服务器控制台](https://console.cloud.tencent.com/lighthouse/instance)，选择实例卡片进入实例详情页，即可在“资源使用情况”中查看该实例系统盘使用情况。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/456b2eced47283921850287b3f34da9d.png)
