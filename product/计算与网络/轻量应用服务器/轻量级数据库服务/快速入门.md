...
4. 在此台轻量应用服务器上安装 MySQL Workbench，本文将为您提供 [安装 MySQL Workbench](https://dev.mysql.com/doc/mysql-installer/en/MySQLInstallerConsole.html) 的第三方教程，您可参考教程进行相关实践操作。
>?
>- 本文第三方教程来自 MySQL，仅供学习与参考。
