...
<tr>
                <td>轻量应用服务器支持救援模式</td>
                 <td>在使用轻量应用服务器操作系统的过程中，若遇到因机器 grub 引导文件丢失、系统关键文件缺失、lib 动态库文件损坏/缺失等情况导致的操作系统无法进入单用户模式问题，可使用救援模式进行系统修复。</td>
                <td>
								<a href="https://cloud.tencent.com/document/product/1207/86184" target="_blank">救援模式</a>
									  </td>
	   </tr>	 
				<tr>
                <td>轻量应用服务器支持在线重置密码</td>
                 <td>在线重置密码借助<a href="https://cloud.tencent.com/document/product/1340/50752"> 自动化助手 </a>在实例中执行重置密码的命令，无需关机即可完成密码重置，对业务无影响。</td>
                <td>
								<a href="https://cloud.tencent.com/document/product/1207/44575" target="_blank">重置密码操作说明</a>
									  </td>
	   </tr>	 
	</tbody>
</table>
...
<table>
    <tbody><tr><th style="width: 25%;">动态名称</th><th style="width: 60%;">动态描述</th><th style="width: 15%;">相关文档</th></tr>
				<tr>
                <td>轻量应用服务器支持设置 HTTPS</td>
                <td>您可以通过轻量应用服务器控制台为成功解析的主机名设置 HTTPS，以向网站访问者表明他们的数据是安全的。</td>
                <td>
								<a href="https://cloud.tencent.com/document/product/1207/84359" target="_blank">设置 HTTPS</a>
									  </td>
	   </tr>	 
	</tbody>
</table>
...
<table>
    <tbody><tr><th style="width: 25%;">动态名称</th><th style="width: 60%;">动态描述</th><th style="width: 15%;">相关文档</th></tr>
				<tr>
                <td>轻量应用服务器数据盘容量提升</td>
                <td>轻量应用服务器数据盘的最大容量由原本的1000GB，提升至4000GB。</td>
                <td>
		...
		<tr>
                <td>轻量应用服务器支持域名管理</td>
                <td>您可以通过轻量应用服务器控制台添加域名，并将添加的域名解析到任何轻量应用服务器。</td>
                <td>
								<a href="https://cloud.tencent.com/document/product/1207/81316" target="_blank">管理域名</a>
									  </td>
	   </tr>	    
	</tbody>
</table>
...
<table>
    <tbody><tr><th style="width: 25%;">动态名称</th><th style="width: 60%;">动态描述</th><th style="width: 15%;">相关文档</th></tr>
		<tr>
                ...
                <td>腾讯云轻量应用服务器新增支持首尔（首尔一区，首尔二区）地域</td>
                <td>
								<a href="https://cloud.tencent.com/document/product/1207/81122" target="_blank">关于新增首尔地域及可用区公告</a>
									  </td>
	   </tr>	    
		<tr>
                <td>轻量应用服务器支持跨地域复制自定义镜像</td>
                <td>您可通过该功能快速将自定义镜像复制至多个目标地域，并在目标地域下使用已复制的镜像，创建相同配置的实例。</td>
                <td>
								<a href="https://cloud.tencent.com/document/product/1207/80571" target="_blank">跨地域复制自定义镜像</a>
									  </td>
	   </tr>
		<tr>
                <td>轻量应用服务器支持备份点功能</td>
                <td>轻量应用服务器云硬盘备份点是腾讯云提供的一种数据备份方式。备份点为云硬盘保留某一时刻的历史数据，使云硬盘可以恢复历史版本的数据，减轻误操作、入侵等情况下的数据安全风险。</td>
                <td>
								<a href="https://cloud.tencent.com/document/product/1207/76269" target="_blank">备份点概述</a>
									  </td>
	   </tr>
	</tbody>
</table>
...
<table>
    <tbody><tr><th style="width: 25%;">动态名称</th><th style="width: 60%;">动态描述</th><th style="width: 15%;">相关文档</th></tr>
		<tr>
                <td>轻量应用服务器支持开通主机安全普惠版</td>
                <td>轻量应用服务器实例开通普惠版防护后，将在防护有效期内进行异常登录、密码破解、文件查杀、应急漏洞的监控和检测。您可通过控制台处理当前实例面临的主要网络安全风险。</td>
                <td>
								<a href="https://cloud.tencent.com/document/product/1207/76216" target="_blank">使用主机安全</a>
									  </td>
	   </tr>
	</tbody>
</table>
...
<table>
    <tbody><tr><th style="width: 25%;">动态名称</th><th style="width: 60%;">动态描述</th><th style="width: 15%;">相关文档</th></tr>
		<tr>
		<td>支持 Windows 实例使用 WebRDP 登录</td>
	  <td>轻量应用服务器 Windows 实例支持 WebRDP 登录，您可通过控制台直接登录实例。</td>
	  <td>
		<a href="https://cloud.tencent.com/document/product/1207/75048" target="_blank">使用 WebRDP 登录 Windows 实例</a>
	  </td>
	 </tr>
		<tr>
		<td>轻量应用服务器新增地域及可用区</td>
	  <td>轻量应用服务器新增支持多伦多（多伦多一区）。</td>
	  <td><ul style="margin-bottom:0px">
		<li><a href="https://cloud.tencent.com/document/product/1207/50103" target="_blank">地域与网络连通性</a></li>
		<li><a href="https://cloud.tencent.com/document/product/1207/74781" target="_blank">关于新增多伦多地域及可用区公告</a></li>
		</ul>
	  </td>
	   </tr>
	</tbody>
...
<table>
    <tbody><tr><th style="width: 25%;">动态名称</th><th style="width: 60%;">动态描述</th><th style="width: 15%;">相关文档</th></tr>
		<tr>
		<td>轻量应用服务器支持实例自助检测</td>
	  <td>实例自助检测可检测轻量应用服务器实例的性能、网络、磁盘等状态，并可帮助您了解实例的运行状态。帮助您了解实例运行状态，及时发现并解决问题。</td>
	  <td>
		<a href="https://cloud.tencent.com/document/product/1207/74704" target="_blank">使用实例自助检测</a>
	  </td>
	 </tr>
		<tr>
		<td>轻量应用服务器支持同地域下批量实例操作</td>
	  <td>您可通过轻量应用服务器控制台，进行同地域下实例的批量操作。例如实例开机、关机及重置密码等。</td>
	  <td>
		<a href="https://cloud.tencent.com/document/product/1207/73796" target="_blank">批量实例操作</a>
	  </td>
	 </tr>
		<tr>
		<td>提升中国内地地域实例套餐购买配额</td>
	  <td>轻量应用服务器云提升中国内地地域下实例套餐购买配额，提升后每地域下购买配额为：通用型（50台）、存储型（50台）及企业型（100台）。</td>
	  <td>
		<ul style="margin-bottom:0px">
		<li><a href="https://cloud.tencent.com/document/product/1207/73441" target="_blank">关于提升中国内地地域实例套餐购买配额公告</a></li>
		<li><a href="https://cloud.tencent.com/document/product/1207/44376" target="_blank">使用限制</a></li>
		</ul>
	  </td>
	   </tr>
	</tbody>
