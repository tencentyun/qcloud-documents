您可通过本文及时获取 WebShell 更新信息，如需使用 WebShell 登录实例，请参见 [使用 WebShell 方式登录 Linux 实例](https://cloud.tencent.com/document/product/1207/44642)。
...
- **支持使用 URL 上传文件**
您可在 WebShell 界面中使用 URL 上传文件至实例的指定位置。详情请参见 [使用 URL 上传文件](https://cloud.tencent.com/document/product/1207/44642#urlUpload)。
- **查看发布说明**
