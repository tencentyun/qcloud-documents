...
2. 单击左上角的【+新建】，在弹出框中依次输入或确定如下参数：
 ...
 >?当 NAT 网关绑定 EIP 时，NAT 网关出带宽上限和 EIP 带宽上限的较小值生效。如果 NAT 网关出带宽上限大于 EIP 总带宽上限（1个 NAT 网关最多绑定10个 EIP），则可能存在丢包风险，为规避此风险您可以作如下操作：
 >- 针对新创建的 NAT 网关，请根据实际业务情况，尽量规划并设置 NAT 网关出带宽上限小于或等于计划绑定的 EIP 总带宽上限。
 >- 针对已创建的 NAT 网关：您可通过调整NAT网关出带宽上限、或调整EIP总带宽上限、或为NAT网关绑定多个 EIP 的方式，使得 NAT 网关出带宽上限小于或等于 EIP 总带宽上限。
 >
