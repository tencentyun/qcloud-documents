...
<tr>
	<td rowspan="2">亚太地区（香港） </br> ap-hongkong</td><td>香港一区（香港节点可用于覆盖东南亚地区）</br> ap-hongkong-1</td>
</tr>
<tr>
	<td>香港二区（香港节点可用于覆盖东南亚地区）</br> ap-hongkong-2</td>
</tr>
<tr>
	<td>亚太地区（新加坡） </br> ap-singapore</td><td>新加坡一区（新加坡节点可用于覆盖东南亚地区）</br> ap-singapore-1</td>
</tr>
<tr>
	<td>亚太地区（曼谷） </br> ap-bangkok</td><td>曼谷一区（曼谷节点用户覆盖亚太东南地区） </br> ap-bangkok-1</td>
</tr>
<tr>
	<td>亚太地区（孟买） </br> ap-mumbai</td><td>孟买一区（孟买节点可用于覆盖亚太南部地区） </br> ap-mumbai-1</td>
</tr>
<tr>
	<td>亚太地区（首尔） </br> ap-seoul</td><td>首尔一区（首尔节点可用于覆盖东北亚地区） </br> ap-seoul-1</td>
</tr>
<tr>
	<td>亚太地区（东京） </br> ap-tokyo</td><td>东京一区（东京节点可用区覆盖东北亚地区） </br> ap-tokyo-1</td>
</tr>
<tr>
