...
![](https://main.qcloudimg.com/raw/3da610705abb35f160e0b9f0d2ed8198.png)
 ...
 - **资源数量**：并发渲染数，例如1台。
 - **超时时间、重试次数**：保持默认值。
4. 单击**下一步**，配置程序信息。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/8ea796f86e92e681befcf90f5f36c398.jpg)
 - **执行方式**：PACKAGE。
 - **程序包地址**：以对象存储举例，`cos://barrygz-125xxxxxx4.cos.ap-guangzhou.myqcloud.com/render/max.tar.gz`。
