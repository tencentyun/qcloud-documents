...
## 前提条件
开始前请按照 [开始前的准备](https://cloud.tencent.com/document/product/599/10807) 中的步骤做好准备。


## 操作步骤
### 安装和配置 TCCLI
1. 请参考 [安装 TCCLI](https://cloud.tencent.com/document/product/599/10548#.E6.AD.A5.E9.AA.A41-.E5.AE.89.E8.A3.85-tccli) 安命令行工具。 
