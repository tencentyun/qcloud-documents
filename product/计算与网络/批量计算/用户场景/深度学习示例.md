## 快速开始
本文介绍一个深度学习示例。基于scikit-learn机器学习库，编写一个多层感知器（MLP，Multilayer Perceptron）BP算法示例，通过对[历史国际足球比赛](https://www.kaggle.com/martj42/international-football-results-from-1872-to-2017)、[球队排名](https://www.kaggle.com/tadhgfitzgerald/fifa-international-soccer-mens-ranking-1993now)、[球员体能技术指标](https://www.kaggle.com/sawya34/football-world-cup-2018-dataset/data)以及[FIFA 2018小组赛结果](https://fixturedownload.com/results/fifa-world-cup-2018)建模，预测两只球队的胜负平概率。具体操作步骤如下：
### 一. 制作自定义镜像
