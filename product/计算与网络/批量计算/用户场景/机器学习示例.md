## 快速开始
本文介绍一个机器学习示例。基于scikit-learn机器学习库，编写一个简单的全连接深层神经网络，通过对[历史国际足球比赛](https://www.kaggle.com/martj42/international-football-results-from-1872-to-2017)、[球队排名](https://www.kaggle.com/tadhgfitzgerald/fifa-international-soccer-mens-ranking-1993now)、[球员体能技术指标](https://www.kaggle.com/sawya34/football-world-cup-2018-dataset/data)以及[FIFA 2018小组赛结果](https://fixturedownload.com/results/fifa-world-cup-2018)建模，预测两只球队的胜负平概率。具体操作步骤如下：
### 一. 制作自定义镜像
...
![](https://main.qcloudimg.com/raw/ef7c95752cfb266f855ea0e69436d245.jpg)
  ...
  * 命令行：`python predict.py "Japan" "Senegal"（备注：球队列表包括'Russia', 'Saudi Arabia', 'Egypt', 'Uruguay', 'Portugal', 'Spain', 'Morocco', 'Iran', 'France', 'Australia', 'Peru', 'Denmark', 'Argentina', 'Iceland', 'Croatia', 'Nigeria', 'Brazil', 'Switzerland', 'Costa Rica', 'Serbia', 'Germany', 'Mexico', 'Sweden', 'Korea Republic', 'Belgium', 'Panama', 'Tunisia', 'England', 'Poland', 'Senegal', 'Colombia', 'Japan'）`
