...
<span id="get"></span>
### 获取 COS 相关访问域名
1. 单击 Bucket 左侧的【基础配置】，可在 Bucket 基础信息中查看访问域名。图下图所示：
![](https://main.qcloudimg.com/raw/08f4cbbd440b555f9c58667a0a963348.png)
2. 获取 COS Bucket 子文件夹访问域名。
>?请结合您的实际情况，获取 COS 相关域名。
>
已获得 COS Bucket 的访问域名为：`https://batchdemo-xxxxxxxxx.cos.ap-guangzhou.myqcloud.com`，可通过 `域名+文件夹` 推算出在 [创建 Bucket 及子文件夹](#create) 中已创建的3个文件夹的访问域名。如下所示：
...
## 步骤4 下载 Batch Demo 文件
1. 请前往 [Batch Demo](http://batchdemo-1251783334.cosgz.myqcloud.com/demo/BatchDemo.zip) 下载测试文件并解压。
...
## 步骤5 修改 Demo 自定义信息
>!Batch Demo 中需替换自定义信息中的通用部分，请参考以下步骤修改文件。
>
