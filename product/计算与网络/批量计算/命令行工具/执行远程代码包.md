...
Application = {
    ...
    "PackagePath": "http://batchdemo-xxxxxxxxxx.cosgz.myqcloud.com/codepkg/codepkg.tgz"
}
...
### 查看状态
步骤同简单开始中的 [查看状态](https://cloud.tencent.com/document/product/599/10551#4.-.E6.9F.A5.E7.9C.8B.E7.8A.B6.E6.80.81)。

### 查看结果
1. 步骤同简单开始中的 [查看结果](https://cloud.tencent.com/document/product/599/10551#5.-.E6.9F.A5.E7.9C.8B.E7.BB.93.E6.9E.9C)。
