...
* topic_name：关联的 CMQ 主题的 ID，所有事件消息将投递给该主题，主题再将消息转发给所有订阅者
...
```
消息结构见上，如果订阅者中指定了消息队列，可以通过 [CMQ 控制台 - 消息接收](https://console.cloud.tencent.com/mq/receive) 快速查看由 Batch 发送到主题内的事件消息
