黑石负载均衡（LB）中七层监听器（HTTP/HTTPS）支持个性化配置功能，允许客户设置单 LB 实例的配置参数，如ssl_protocols、client_header_timeout 等，以满足客户个性化配置需求。本文档主要介绍个性化配置参数说明和如何操作个性化配置。
