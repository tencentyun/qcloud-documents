...
## 操作步骤
1. 前往 [THPC_QCSLinkedRoleInAcrossService](https://console.cloud.tencent.com/cam/role/grant?roleName=THPC_QCSLinkedRoleInAcrossService&serviceLinkedRole=1) 角色页面，并单击**同意授权**。
2.  完成身份验证后，即可成功授权。
