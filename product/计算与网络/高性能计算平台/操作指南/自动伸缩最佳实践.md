...
使用 ClusterId 查询集群状态：
```plaintext
tccli thpc DescribeClusters --ClusterIds '["hpc-043vckce"]'
```
返回结果，其中：<br>
(1) ClusterStatus 为 RUNNING 状态表示集群创建完成，可以开始使用。<br>
(2) ClusterStatus 为 INITING 状态表示集群正在初始化中，需要等待直到为 RUNNING或者 INIT_FAILED 状态之一。<br>
(3) ClusterStatus 为 INIT_FAILED 状态表示集群创建失败，需要提单排查。
...
```
提交作业前，集群没有任何节点存在：<br><img src="https://qcloudimg.tencent-cloud.cn/raw/0b660e673ad8c678095ec4ca4c3b29a5.png"  width="600"/>
提交作业：
```plaintext
sbatch submit.sh
```
...
<img src="https://qcloudimg.tencent-cloud.cn/raw/d3529f92767fd8749abc0218f1639a9d.png"  width="600"/><br>
等待2～3分钟之后，会进行自动缩容到最小节点数：<br>
<img src="https://qcloudimg.tencent-cloud.cn/raw/b47b5e7168ac0c851e91aca692ec42d2.png" width="600"/><br>
