...
- 在配置云产品地域时，若您需使用弹性扩缩容，则 `region` 请输入 `ap-guangzhou`。若您仅需创建固定集群，则可在 [地域列表](https://cloud.tencent.com/document/product/1527/64909#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8) 中选择您需要的地域。
