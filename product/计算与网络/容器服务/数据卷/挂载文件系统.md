## 前提条件
如果您还未创建文件系统 CFS，您需要先创建文件系统。有关如何创建文件系统的详细信息，参见 [创建文件系统及挂载点](/doc/product/582/9132) 。
...
2. 查看 CFS 的可用区，本文档以北京一区为例。单击 **ID/名称** 进入 CFS 详情页。
...
有关如何创建集群的详细信息，参见 [新建集群](/doc/product/457/9091) 。
>**注意：**
>创建集群时，需要注意以下设置：
...
## 创建服务
有关如何创建服务的详细信息，参见 [服务的基本操作](/doc/product/457/9096)。
>**注意：**
>创建服务时，需要注意以下设置：
