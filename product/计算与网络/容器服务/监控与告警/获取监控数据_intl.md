...
You can view the monitoring data of KTE in the following ways:

### Monitoring on KTE Console

#### Cluster Monitoring

- Log in to [KTE Console](https://console.cloud.tencent.com/ccs), and select **Cluster**.
...
- Log in to [KTE Console](https://console.cloud.tencent.com/ccs), and select **Service**.
