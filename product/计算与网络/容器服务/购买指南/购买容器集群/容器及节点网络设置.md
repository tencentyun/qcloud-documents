...
- **集群网络**：将为集群内主机分配在节点网络地址范围内的 IP 地址，您可以选择私有网络中的子网用于集群的节点网络，更多私有网络（VPC）请参见 [私有网络](/doc/product/215/4927) 。
...
对于一个 Node 上的 Pod，有3个地址不能分配分别是网络号，广播地址和网关地址。故 Node 其最大的 Pod 数目=podMax-3
