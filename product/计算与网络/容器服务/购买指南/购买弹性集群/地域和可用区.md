...
>? 针对地域为**深圳／上海／北京金融专区**的金融行业监管要求定制的合规专区，具有高安全，高隔离性的特点。目前提供云服务器、金融数据库、Redis 存储、人脸识别等服务，已认证通过的金融行业客户可 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请使用专区。详见 [金融专区介绍](https://cloud.tencent.com/document/product/304/2766)。
>
