...
腾讯云边缘容器服务（Tencent Cloud Kubernetes Service for Edge）针对用户创建的托管集群控制面收取**集群托管费**和针对用户接入到边缘集群的计算节点收取**节点托管费**。关于腾讯云边缘容器服务的具体价格，请参见 [购买腾讯云边缘容器服务](https://cloud.tencent.com/document/product/457/78129)。
