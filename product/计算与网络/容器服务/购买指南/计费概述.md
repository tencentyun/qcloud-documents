...
Serverless 容器服务（Elastic Kubernetes Service，EKS）会根据工作负载申请的 CPU、GPU、内存数值以及工作负载的运行时间来核算费用，分别适用于不同场景下的用户需求。关于 TKE Serverless 集群的具体价格，请参见 [购买 TKE Serverless 集群](https://cloud.tencent.com/document/product/457/39807)。
