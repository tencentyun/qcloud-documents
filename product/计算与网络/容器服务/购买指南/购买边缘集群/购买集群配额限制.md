...
边缘容器服务的配额限制包括资源配额，CVM 相关的配额限制以及托管集群的资源配额限制，详情如下：
...
<table>
	...
	<td>单地域下集群</td>
	<td>5</td>
	<td rowspan=5><a href="https://console.cloud.tencent.com/tke2/overview">控制台概览页右下方</a></td>
	<td rowspan=5>是</td>
	</tr>
	<tr>
	<td>单集群下节点</td>
...
## K8s 资源配额说明
>? 下列配额自2022年4月30日开始生效，该配额无法被移除。配额不足时，**您可通过升高集群规格提高各资源配额**。
