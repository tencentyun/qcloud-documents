>?容器服务旧版控制台目前已下线，文档已停止维护。新版控制台已进行了一系列模块的调整，建议参考 [新版用户指南](https://cloud.tencent.com/document/product/457/31697) 使用。可 [点此](https://cloud.tencent.com/document/product/457/32187) 进入新版用户指南集群概述。
