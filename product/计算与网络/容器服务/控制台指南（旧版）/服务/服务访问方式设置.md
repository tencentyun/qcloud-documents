...
## 更多
除以上四种方式外还可以配置7层负载均衡（HTTP / HTTPS）转发到服务，详情请参阅 [Ingress 转发设置](https://cloud.tencent.com/document/product/457/9111)。
更多关于集群访问方式原理介绍，请参阅 [Kubenerters 中多种服务访问方式以及相应的安全组设置在腾讯云的落地实践](https://cloud.tencent.com/document/product/457/9084)。
