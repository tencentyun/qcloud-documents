...
You can take precautionary or remedial measures in a timely manner when an alarm is set off by status changes. Therefore, creating a reasonable alarm can help you improve your application's robustness and reliability. For more information about alarms, please see [Creating Alarms](https://intl.cloud.tencent.com/document/product/248/6215).
