...
### What is Container?
Container is used to realize operating system virtualization. With a container, you can run applications and their dependent components under the condition where resources are isolated. TKE allows you to package the codes, configuration and dependent components of an application into an easy-to-use building block, to improve environment compatibility, implement version control, and increase operation efficiency and developer productivity. TKE can ensure that applications are deployed in a fast, stable and consistent manner without being affected by the deployment environment.
...
Tencent Cloud's TKE involves the following concepts:
...
We provide some examples on how to get started with TKE.
