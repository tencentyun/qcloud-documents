...
K8S 1.18在 HPA Spec 下新增了 `behavior` 字段，该字段提供 `scaleUp` 和 `scaleDown` 两个字段分别控制扩容和缩容行为，详情请参见官方 [K8S API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#hpascalingrules-v2beta2-autoscaling) 文档。  
