此步骤介绍如何推送单个或多个镜像至 TKE 镜像，并通过 TKE 控制台使用该镜像创建 Deployment。
...
![](https://main.qcloudimg.com/raw/e34d75ef2332981476b94c03bb903a58.png)
...
4. 参考[ Slave pod 构建配置 ](https://cloud.tencent.com/document/product/457/41397#slavepod)步骤，根据实际需求依次新建10个 test。如下图所示：
