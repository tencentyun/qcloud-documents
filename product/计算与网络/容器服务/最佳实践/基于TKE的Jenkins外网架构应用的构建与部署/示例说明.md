...
![](https://main.qcloudimg.com/raw/e1d675a34c3b081f78fc3782b53a8871.png)
...
| 角色 | 内网 IP | 操作系统 |
|---------|---------|---------|
| Jenkins Master | 10.0.0.7 | CentOS 7.6 64 bit |
| Node | 10.0.0.14 | CentOS 7.6 64 bit |


## 注意事项
- 确保已具备 Jenkins Master 节点，并已安装 Git。
- Jenkins Master 节点配置最低要求为：CPU 4核、内存2GB、公网带宽3Mbps。
...
## 操作流程
请按照以下步骤，进行 TKE 集群及 Jenkins 的配置，使用 slave pod 进行构建打包并推送镜像至 TKE 镜像仓库，并通过 TKE 控制台使用拉取的镜像进行 Pod 部署。
1.  [步骤1：TKE 集群侧及 Jenkins 侧配置](https://cloud.tencent.com/document/product/457/41396) 
2.  [步骤2：Slave pod 构建配置](https://cloud.tencent.com/document/product/457/41397)
3.  [构建测试]()
