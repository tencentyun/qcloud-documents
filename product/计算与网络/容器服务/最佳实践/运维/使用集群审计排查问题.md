...
关于 TKE 的集群审计简介与基础操作，请参见 [集群审计](https://cloud.tencent.com/document/product/457/48346)。集群审计的数据存储在日志服务，若需要在日志服务控制台去对审计结果进行检索和分析，检索语法请参见 [语法与规则](https://cloud.tencent.com/document/product/614/47044)，要进行分析就还需要写日志服务所支持的 SQL 语句，请参见 [分析简介](https://cloud.tencent.com/document/product/614/44061)。
