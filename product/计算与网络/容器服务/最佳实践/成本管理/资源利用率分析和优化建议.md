...
- 定时弹性伸缩解决方案：
 ...
 - 对于短时间内的流量突发，支持 TKE 集群秒级弹性扩容 TKE Serverless Pod（Elastic Kubernetes Service），无需重新购买节点。  
...
- 弹性伸缩解决方案：
 ...
 - 对于短时间内的流量突发，支持TKE集群秒级弹性扩容TKE Serverless Pod（Elastic Kubernetes Service），无需重新购买节点。  
