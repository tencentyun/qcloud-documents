...
- 加速服务目前仅面向容器服务 TKE、容器镜像服务 TCR 用户，如有需求请提交 [在线咨询](https://cloud.tencent.com/online-service?from=doc_457) 申请使用。
- 加速服务目前只支持腾讯云 [私有网络 VPC](https://cloud.tencent.com/document/product/215) 访问，公网访问能力暂未开放，相关域名可以访问但无法提供实际的加速功能。
- 如需使用其他主流镜像托管平台内镜像，请提交 [在线咨询](https://cloud.tencent.com/online-service?from=doc_457) 咨询。
