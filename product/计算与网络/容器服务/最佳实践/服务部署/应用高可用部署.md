...
<img style="width:50%" src="https://main.qcloudimg.com/raw/e3fdb23fc451bd9597f41e056a159482.png">
3. 在“节点列表”页面为该批节点编辑相同的 label 进行标识，这些节点是置放群组中某个同一批次添加的节点。如下图所示：
>!置放群组的策略仅对同一批次的节点生效，需要为每一批次的节点增加 label 并且指定不同的值来进行标识。
>
<img style="width:50%" src="https://main.qcloudimg.com/raw/276684c8f448e70a366a2981408ac54b.png">
