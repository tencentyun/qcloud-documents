...
腾讯云容器服务底层基于Kubernetes编排引擎。在容器服务的应用模板中原生的支持Kubernetes的编排语法。本文将对Kubernetes的常用的编排语法做介绍。
...
也可以在UI页面借助控制台操作，生成对应的初始化YAML文件，关于控制台操作的说明，可以参考[数据卷挂载说明][6]
...
更多关于Kubernetes编排描述语言的说明，可以参考[API Overview][94]
...
[6]: https://cloud.tencent.com/document/product/457/9112

[91]: https://kubernetes.io/docs/api-reference/v1.7/
[92]: https://kubernetes.io/docs/api-reference/v1.6/
[93]: https://kubernetes.io/docs/api-reference/v1.5/
[94]: https://kubernetes.io/docs/reference/api-overview/
