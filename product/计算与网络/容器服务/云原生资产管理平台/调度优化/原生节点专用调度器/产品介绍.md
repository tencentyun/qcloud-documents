...
- 需要保证 Kubernetes 版本至少为这三个及以上的版本：v1.22.5-tke.8，v1.20.6-tke.24，v1.18.4-tke.28，v1.16.3-tke.30。集群版本升级请参考 [升级集群](https://cloud.tencent.com/document/product/457/32192)。
