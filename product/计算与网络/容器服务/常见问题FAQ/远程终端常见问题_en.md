...
#### Ubuntu 16.04
For container whose system is Ubuntu 16.04, you can execute the following command to configure the apt source as a Tencent Cloud source server by simply copying the following command to the console.
```shell
...
### 6. How do I copy on-site files (such as dump or log) to local for analysis?
You can use our container file download feature which will become available soon.

### 7. Why can't I use the "upload file to container" or "download file to local machine" feature?
...
### 9. How do I copy text in the console?
...
### 12. What if I receive an error "TERM environment variable not set" when I execute commands such as "top"?
