...
## 节点池相关概念
TKE 的弹性伸缩实现是基于腾讯云弹性伸缩（AS）以及 Kubernetes 社区的 [cluster-autoscaler](https://github.com/kubernetes/autoscaler/tree/master/cluster-autoscaler) 实现的。
...
第一层是 K8s 提供的 cluster autoscaler（CA）功能，第二层是腾讯云弹性伸缩服务提供的 AS（AutoScaling）能力。
> ?
