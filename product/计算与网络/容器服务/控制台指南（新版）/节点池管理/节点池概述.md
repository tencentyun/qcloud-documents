...
>?节点池功能目前已全量发布，如果您集群中创建了伸缩组，节点池全量之后仍然可以继续使用这些伸缩组。但请注意，节点池全量后TKE不会对旧版伸缩组进行后续功能维护及迭代，请您尽快使用TKE提供的转换功能（通过[云API](https://cloud.tencent.com/document/product/457/49435)或者[控制台](https://cloud.tencent.com/document/product/457/43735#.E8.AF.B4.E6.98.8E.E4.BA.8B.E9.A1.B9)）将伸缩组转换成节点池。
>
