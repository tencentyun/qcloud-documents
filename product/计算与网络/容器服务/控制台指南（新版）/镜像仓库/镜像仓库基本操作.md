...
![](https://main.qcloudimg.com/raw/eee4b432fe91f43a1f978963466e9b9c.png)
 - **用户名**：默认是当前用户的账号，是您登录到腾讯云 Docker 镜像仓库的身份，可在 [账号信息](https://console.cloud.tencent.com/developer) 页面中的账号ID获取。
...
```
**username**：腾讯云账号 ID，开通时已注册，可在 [账号信息](https://console.cloud.tencent.com/developer) 页面中的“账号ID”获取。
