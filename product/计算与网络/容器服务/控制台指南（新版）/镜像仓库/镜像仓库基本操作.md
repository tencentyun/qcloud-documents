...
2. 根据以下信息，进行镜像仓库初始化，并单击【开通】。如下图所示：
...
$ sudo docker login --username=[username] ccr.ccs.tencentyun.com
```
2. 替换命令中的信息并执行命令，下载镜像。
```
$ sudo docker pull ccr.ccs.tencentyun.com/[namespace]/[ImageName]:[镜像版本号]
```

### 删除镜像
1. 在“我的镜像”页面，选择需删除镜像所在行右侧【删除】。
2. 在弹出的“删除镜像仓库”窗口中，单击【确定】即可**删除该镜像所有版本**。如下图所示：
