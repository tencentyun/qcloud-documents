...
![](https://main.qcloudimg.com/raw/f410f600c8219718f1638c2572fbdf2d.png)
 ...
 - **触发方式**：复选模式，支持当 push 代码到某个分支或者新的 Tag 时，自动触发容器镜像构建。也可不选择触发方式，在镜像构建页面通过 [手动构建](https://cloud.tencent.com/document/product/457/10154#.E6.89.8B.E5.8A.A8.E6.9E.84.E5.BB.BA) 的方式构建镜像。
