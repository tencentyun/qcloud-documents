## 操作场景
对等连接（Peering Connection）是一种大带宽、高质量的云上资源互通服务，可以打通腾讯云上的资源通信链路。关于如何建立对等连接，您可以参考 [创建对等连接](https://cloud.tencent.com/document/product/553/18836)。您可以通过对等链接实现**同地域和跨地域**的不同集群互通。
>! 
