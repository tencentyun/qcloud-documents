...
- 同地域集群：可通过以下步骤直接实现容器间互通。
- 跨地域集群：请先 [提交工单](https://console.cloud.tencent.com/workorder/category?level1_id=6&level2_id=350&source=0&data_title=%E5%AE%B9%E5%99%A8%E6%9C%8D%E5%8A%A1TKE&step=1 ) 申请打通容器路由，再执行以下步骤，实现容器间互通。
