...
> - 请先确保对黑石公有云对等连接成功建立，子机与黑石间能互通。若对等连接建立有问题，请排查**控制台路由表项、安全组、子网 ACL** 的设置是否有问题。关于如何建立黑石私有网络对等连接，您可以参考 [黑石 VPC 对等连接](https://cloud.tencent.com/document/product/386/13701)。
