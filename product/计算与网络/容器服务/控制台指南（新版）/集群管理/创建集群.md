...
![](https://main.qcloudimg.com/raw/139922aac72cecba2256cb7ab6fe086c.png)
 - **勾选 “使用已有云主机创建集群”**，执行 [使用已有云服务器创建集群的操作](#UseExistingCVMCreateCluster)。
 - **未勾选 “使用已有云主机创建集群”**，执行 [不使用已有云服务器创建集群的操作](#NotUseExistingCVMCreateCluster)。
...
![云服务器配置](https://main.qcloudimg.com/raw/10610b39dc40ff67fdbecc922132acae.png)
主要参数信息如下：
 - **数据盘挂载**：默认勾选。
