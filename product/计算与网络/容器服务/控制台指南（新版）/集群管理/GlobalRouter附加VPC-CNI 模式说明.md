...
```
其中：
- spec.template.annotations：tke.cloud.tencent.com/networks: "tke-route-eni"  表名Pod使用VPC-CNI模式。 
...
如需使用固定IP的StatefulSet，可[查看详情](https://cloud.tencent.com/document/product/457/34994)
