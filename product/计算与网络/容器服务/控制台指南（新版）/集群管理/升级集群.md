...
- 大版本升级如1.12升级到1.14如果您设置了自定义参数，需要您重新设置新版本的自定义参数。 原参数不保留。详情见 [自定义 kubernetes 组件启动参数](https://tcloud-doc.isd.com/document/product/457/47775?!editLang=zh&!preview)
...
>! 
 - 大版本升级如1.12升级到1.14，若您设置了自定义参数，需要您重新设置新版本的自定义参数。原参数不保留。
