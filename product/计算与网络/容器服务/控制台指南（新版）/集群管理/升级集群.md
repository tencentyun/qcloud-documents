...
## 注意事项
- 目前集群升级处于内测阶段， 如有需要请提交工单申请。
- 请在升级集群前，查看集群下状态是否均是健康状态。若集群不正常，您可以自行修复，也可以通过 [提交工单](https://console.qcloud.com/workorder/category?level1_id=6&level2_id=350&source=0&data_title=%E5%AE%B9%E5%99%A8%E6%9C%8D%E5%8A%A1TKE&step=1) 联系我们协助进行修复。 
...
- TKE 节点产品化升级功能即将上线，目前仅允许用户升级 Master 版本。Master 版本升级完成后，可通过以下步骤替换节点版本：
	1. 驱逐节点上运行的 pod。
...
>
5. <span id="step5"></span>请根据实际情况进行登录密码及安装组设置，并单击【完成】，等待节点添加成功。


#### 解除封锁
1. 节点添加成功后，处于封锁状态。选择该节点所在行右侧的【更多】>【取消封锁】。如下图所示：
