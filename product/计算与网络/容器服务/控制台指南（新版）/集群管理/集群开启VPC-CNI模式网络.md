...
2. 在【VPC-CNI 模式】中单击<img src="https://main.qcloudimg.com/raw/5d18cae0914f64405b15a710d633fba3.png" style="margin-bottom: -5px;"></img>，弹出【编辑 VPC-CNI 模式】页面。如下图所示：
 ![open][1]
  - 子网：选择可用区的子网。
...
### 关闭 VPC-CNI
 ...
 >
1. 选择需要查看的集群ID/名称，进入该集群的管理页面。并单击【基本信息】。
2. 在【VPC-CNI 模式】中单击<img src="https://main.qcloudimg.com/raw/942a8819f581e4f43871baa2190b9776.png" style="margin-bottom: -5px;;"></img>，弹出【关闭 VPC-CNI 模式】页面。如下图所示：
 ![close][2]
集群名称：输入集群名称进行确认并提交。
