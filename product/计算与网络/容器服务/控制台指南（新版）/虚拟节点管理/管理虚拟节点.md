...
4. 选择计划修改的类型为【虚拟节点】的节点池，点击【编辑】。
5. 进入节点池编辑页面，支持修改节点池名称、Labels、Taints等信息。如下图所示：
>! Labels、Taints 相关的修改会在节点池中的所有虚拟节点上生效，如果有特殊调度策略请务必谨慎操作。
>
![](https://main.qcloudimg.com/raw/07b1f18c75ccf794cf10535f40833a0e.png)
6. 选择计划修改的类型为【虚拟节点】的节点池，单击【删除】。如下图所示：
![](https://main.qcloudimg.com/raw/f7fcb029533923361b0b7b3b075994bc.png)
7. 进入节点池删除确认页面，单击【确认】删除节点池。如下图所示：
>! 虚拟节点上如果有运行中的 Pod 则不可删除。勾选强制删除，则会驱逐重建节点池上的所有 Pod，请务必保证所有 Pod 可以重新调度到其他节点池上。
>
![](https://main.qcloudimg.com/raw/cc423f26cf06206c8551ff210f632e9b.png)
...
2. 在“集群管理”列表页面，选择目标集群 ID，进入该集群 “Deployment” 页面。
3. 选择左侧菜单栏中的【节点管理】>【节点池】，进入“节点池列表”页面。如下图所示：
   ![](https://main.qcloudimg.com/raw/a85eb0fa56cd51e10ee6b7eb43cd1414.png)
4. 选择计划修改的，类型为【虚拟节点】的节点池。
5. 点击节点池 ID 进入节点池详情页，可以进行基本信息编辑、新增/删除虚拟节点以及对具体虚拟节点进行驱逐、封锁/取消封锁等操作。

![](https://main.qcloudimg.com/raw/36f19b236257004bd9f12833dcc04b10.png)

6. 点击【新建节点】，可在当前节点池新增虚拟节点，只须指定新增虚拟节点关联的 VPC 子网，请保证指定子网可用 IP 数量充足。

>! 注意，新增的虚拟节点会沿用节点池的VPC、安全组、Labels、Taints 等一系列配置。
>
>![](https://main.qcloudimg.com/raw/ee80a8ca84bb1f1eec0826087e59c65c.png)

7. 点击【移出】，将删除选定的虚拟节点。

>! 注意，虚拟节点上如果有运行中的 Pod 则不可删除。勾选强制删除，则会驱逐重建虚拟节点上的所有 Pod，请务必保证所有 Pod 可以重新调度到其他节点上。
>
>![](https://main.qcloudimg.com/raw/8cd80de69ee153e2e5efadc2423092cf.png)

8. 点击虚拟节点名称进入虚拟节点详情页，可以管理虚拟节点上的 Pod、查看虚拟节点事件、Yaml 等信息。
   ![](https://main.qcloudimg.com/raw/f7f522ba494589c9be96a8c9ec21d570.png)
