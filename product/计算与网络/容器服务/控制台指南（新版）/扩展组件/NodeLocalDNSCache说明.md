...
- VPC-CNI 模式同时支持 kube-proxy 的 iptables 和 ipvs 模式，GlobalRouter 模式仅支持 kube-proxy的 iptables 模式，ipvs 模式下需要更改 kubelet 参数，详情请参见 [官方文档](https://kubernetes.io/docs/tasks/administer-cluster/nodelocaldns/)。
