...
创建云原生监控实例后，会在用户的账户下创建2个内网 LB，每多关联一个集群，会增加一个LB。若要使用通过外网访问 Grafana 服务，则需要创建一个相应的公网 LB，该资源会收取费用，创建的公网 LB 可在 [负载均衡控制台](https://console.cloud.tencent.com/clb/instance?rid=1) 查看资源信息，如下图所示：
