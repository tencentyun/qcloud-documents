...
<span id="check1"></span>
### 查看集群指标
在需要查看监控数据的集群行中，单击图标 <img src="https://main.qcloudimg.com/raw/fef90a2f69f50758b30e4c4b5e0bc7de.png" style="margin-bottom: -2px;;"></img>，即可查看该集群监控信息页面。如下图所示：
...
1. 根据您的实际需求查看 Pod 内 Container 指标。
  - 参照查看工作负载内 Pod 指标的步骤1-步骤3。
  - 参照查看节点内 Pod 指标的第二种方式 [通过节点详情页](#node)。
