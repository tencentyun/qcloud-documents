...
![](https://qcloudimg.tencent-cloud.cn/raw/1f27747673809219c7b825221a55be71.png)
![](https://qcloudimg.tencent-cloud.cn/raw/907a44af95a73a0a5c112bdec52db0ab.png)
   ...
   - **服务端加密**：支持**不加密**和**SSE-COS 加密**（即由对象存储托管密钥的服务端加密）两种方式。
      - **SSE-COS 加密**：对象存储托管密钥的服务端加密，由对象存储托管主密钥和管理数据，用户可通过对象存储直接对数据进行管理和加密。详情请参见 [服务端加密概述 ](https://cloud.tencent.com/document/product/436/18145)。
...
2. 单击**新建**进入“新建 Workload” 页面，参考 [创建 Deployment ](https://cloud.tencent.com/document/product/457/31705#.E5.88.9B.E5.BB.BA-deployment) 进行创建，并设置数据卷挂载。如下图所示：
