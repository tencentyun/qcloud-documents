...
> 注意：
 ...
 > 
 > 当 LoadBalance 声明为 TCP 时，端口可以使用扩展协议的能力，将负载均衡的协议改成 TCP_SSL、HTTP、HTTPS。
 > 
 > 当 LoadBalance 声明为 UDP 时，端口可以使用扩展协议的能力，将负载均衡的协议改成 UDP、QUIC。
...
在创建 Service 时，如果是以“公网LB”或“内网LB”的形式暴露服务，非[直连模式](https://cloud.tencent.com/document/product/457/41897)情况下，“端口映射”中，仅支持 TCP 和 TCP SSL 一起使用。
![](https://main.qcloudimg.com/raw/0f0e88b4ae715e9408863c982c90af14.png)

当 Service 为仅在集群内访问（ClusterIP） 或 主机端口访问（NodeBalance） 模式时，支持任意协议混用。
