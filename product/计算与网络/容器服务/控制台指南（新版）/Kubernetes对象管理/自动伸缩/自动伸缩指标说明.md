...
<tr>
	...
	<td>%</td>
	<td>Pod 的 CPU 使用量占 Pod 规格总量的比例</td>
	<td>Pods</td>
	...
	<td>CPU 利用率<br>（占 Request）</td>
	<td>% </td>
	<td>Pod 的 CPU 使用量和设置的 Request 值的比例 </td>
	<td>Pods</td>
	<td>k8s_pod_rate_cpu_core_used_request</td>
	<td>%</td>
	</tr>
	...
	<td>CPU 利用率<br>（占 Limit）</td>
	<td>%</td>
	<td>Pod 的 CPU 使用量和设置的 Limit 值的比例</td>
	<td>Pods</td>
	<td>k8s_pod_rate_cpu_core_used_limit</td>
	<td>%</td>
	</tr>
...
<tr>
	...
	<td>%</td>
	<td>Pod 内存使用占 Pod 规格总量的比例</td>
	<td>Pods</td>
	<td>k8s_pod_rate_mem_usage_resource</td>
	<td>%</td>
	</tr>
	<tr>
	<td>内存利用率<br>（占 Request）</td>
