...
<table>
<tr>
	<th width="25%">指标名称（控制台）</th><th width="20%">单位（控制台）</th><th width="30%">备注</th>
	<th >type</th><th>metricName</th><th >默认单位</th>
	</tr>
	<tr>
	<td>CPU 使用量</td>
	<td>核</td>
...
<table>
<tr>
	<th width="25%">指标名称（控制台）</th><th width="18%">单位（控制台）</th><th width="30%">备注</th>
	<th >type</th><th>metricName</th><th >默认单位</th>
	</tr>
	<tr>
	<td>硬盘写流量</td>
...
<table>
<tr>
	<th width="25%">指标名称（控制台）</th><th width="20%">单位（控制台）</th><th width="35%">备注</th>
	<th >type</th><th>metricName</th><th >默认单位</th>
	</tr>
	<td>网络入带宽</td>
	<td>Mbps</td>
...
<table>
<tr>
	<th width="25%">指标名称（控制台）</th><th width="10%">单位（控制台）</th><th width="30%">备注</th>
	<th >type</th><th>metricName</th><th >默认单位</th>
	</tr>
	<tr>
	<td>GPU 使用量</td>
 ...
 <tr>
	...
	<td>Pods</td>
	<td>Pods	k8s_pod_gpu_memory_request_bytes</td>
	<td>B</td>
 </tr>
 <tr>
