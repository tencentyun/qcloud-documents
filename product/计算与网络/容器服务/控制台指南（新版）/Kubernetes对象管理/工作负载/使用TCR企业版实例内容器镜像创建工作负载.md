...
>
![](https://main.qcloudimg.com/raw/82ca7e438d233fea69c02e92b6b85302.png)
...
#### 使用 TCR 扩展组件进行快速配置
1. 在集群详情页面，选择左侧【组件管理】，进入 “组件管理” 页面，并单击【新建】。
2. 在 “新建扩展组件” 页面，选择 “TCR” 组件，并单击【查看详情】了解组件功能及配置说明，而后单击【参数配置】开始配置组件。
    >? 当前 TCR 组件暂只支持 K8S 版本为 1.14，1.16 的集群，即将支持 1.12，1.18，如集群版本暂不支持，请采用手动配置方式。
	>
   ![](https://main.qcloudimg.com/raw/ac01c58b0e50f2c2001f0abe50a361e3.png)
3. 在 “TCR组件参数设置” 页面，参考查看详情中介绍的组件配置方式，配置相关参数。其中，关联实例请选择与集群同地域的 TCR 实例，其他参数均可采用默认配置。若内网访问链路中未展示为 “链路正常”，请参考 [内网访问控制](https://cloud.tencent.com/document/product/1141/41838)，配置 TCR 实例与 TKE 集群所在私有网络 VPC 的内网链路。
![](https://main.qcloudimg.com/raw/8e67e9971c47c6f12add01dd937c7b56.png)
4. 点击【确定】后，返回组件选择界面，继续点击【完成】，开始为集群安装 TCR 扩展组件。
5. 组件安装完成后，集群将具备内网免密拉取该关联实例内镜像的能力，无需额外配置。
...
![](https://main.qcloudimg.com/raw/7a53ee5832d68b8b4bee3fb9e7278f0b.png)
 - **镜像访问凭证**：
	 1. 集群已安装 TCR 扩展组件：无需配置
	 2. 集群未安装 TCR 扩展组件：选择【添加镜像访问凭证】，并选择 [配置访问凭证](#issued) 步骤中已下发的访问凭证。如下图所示：
