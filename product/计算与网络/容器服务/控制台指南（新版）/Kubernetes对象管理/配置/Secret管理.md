...
![](https://qcloudimg.tencent-cloud.cn/raw/420329b09ec7efca2373ca1707d8bdde.png)
4. 单击**新建**，进入 “新建Workload” 页面。
5. 根据页面信息，设置工作负载名、命名空间等信息。并在 “数据卷” 中，单击**添加数据卷**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/4afb4b5efcb99d39439e809a910d68bf.png)
6. 选择**使用Secret**方式，填写名称，并单击**选择Secret**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/179cd480a77de33b68de9df7aaf3ea91.png)
 - **选择Secret**：根据实际需求进行。
