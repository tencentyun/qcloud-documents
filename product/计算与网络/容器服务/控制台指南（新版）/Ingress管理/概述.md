Service 提供了基于四层网络的集群内容器服务的暴露能力，Service 暴露类型均基于四层网络服务的访问入口（例如 ClusterIP、NodePort 或 LoadBalancer），缺少基于七层网络的负载均衡、SSL 或基于名称的虚拟主机等七层网络能力。Ingress 提供七层网络下 HTTP、 HTTPS 协议服务的暴露，同时包括七层网络下的常见能力。
...
- 当 Ingress 资源没有描述 `kubernetes.io/ingress.class` 注解时，`TKE Ingress Controller` 会管理当前 Ingress 资源。
...
- [Ingress 基本功能]()
- [Ingress 使用已有 CLB 直连 Pod](https://cloud.tencent.com/document/product/457/45686)
