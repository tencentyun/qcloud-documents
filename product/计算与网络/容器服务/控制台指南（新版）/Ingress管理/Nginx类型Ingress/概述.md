...
Nginx-ingress 是使用 Nginx 作为反向代理和负载平衡器的 Kubernetes 的 [Ingress 控制器](https://cloud.tencent.com/document/product/457/45685)。您可以部署 Nginx-ingress 组件，在集群中使用 Nginx-ingress。容器服务 TKE 提供了产品化的能力，帮助您在集群内安装和使用 Nginx-ingress。
