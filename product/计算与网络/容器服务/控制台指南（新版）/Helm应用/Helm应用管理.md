...
## 前提条件
- 已有腾讯云容器服务 TKE 集群，且至少拥有0.28核 CPU，180MiB内存的资源。
- 已在集群内开通 Helm 应用管理功能。
...
![](https://main.qcloudimg.com/raw/50910f52eff809af3eb54fc202289c6f.png)
	- **应用名**：自定义。
...
3. 在弹出的 “更新Helm应用” 窗口中，重新设置 “Chart_Url”，并根据业务需求填写自定义参数。如下图所示：
