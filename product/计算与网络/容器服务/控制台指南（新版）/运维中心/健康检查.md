...
<tr>
<td> etcd 的参数配置</td>
<td> 根据 master 节点配置检测以下参数：<ul><li>quota-backend-bytes：存储大小。</td>
<td> 是</td>
</tr>
...
2. 进入“健康检查”页面，选择需要健康检查的集群，并为其选择合适的检查方式。   
 ...
 - **批量检查**，适用于同时检查多个集群。
 - **立即检查**，适用于只检查一个集群。
 - **自动检查**，适用于需要周期性检查的集群。选择需要周期检查的集群，点击【自动检查】。如下图所示：
...
4. 检查完成后，可点击【查看结果】查看检查报告。如下图所示：
![](https://main.qcloudimg.com/raw/49258501e70fdea11dd6ec76fcbdc093.png)
在检查报告页面，选择【资源状态】和【运行情况】分别查看资源状态和异常情况，点击【检查内容】可展示具体的检查内容，点击【异常】可查看异常级别、异常描述、异常原因、异常影响和修复建议。如下图所示：
