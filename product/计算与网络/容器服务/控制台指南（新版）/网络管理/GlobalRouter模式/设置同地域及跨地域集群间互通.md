...
>?如需实现跨地域集群间互通，请在执行完以下操作步骤后 [在线咨询](https://cloud.tencent.com/online-service?from=connect-us ) 申请打通容器路由，实现容器间互通。
...
- **跨地域集群**：对等连接建立成功后，请 [在线咨询](https://cloud.tencent.com/online-service?from=connect-us ) 打通容器路由，实现容器之间的互通。
