...
>! 容器实例目前正在内测中，如需使用可 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请使用。
...
<li><b>健康检查</b>：详情请参见 [容器健康检查](https://cloud.tencent.com/document/product/457/32815)。</li>
<li><b>运行命令及参数</b>：详情请参见 [容器的运行命令和参数](https://cloud.tencent.com/document/product/457/32816)。</li>
...
单击【确认配置】，在“确认配置”页确认资源规格及配置费用，即可完成创建实例。
5. 如需进行高阶配置，单击【下一步】，进入“其他配置”页面。
<dx-tabs>
::: 重启策略
