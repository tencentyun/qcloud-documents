...
<tr>
    <td>节点安装脚本新增支持check、clear两个功能参数</td><td>节点安装脚本支持两个功能参数：<li>check参数，方便用户使用脚本手动检查节点环境哪些地方不满足安装要求；</li><li>clear参数，方便一键清理节点中的脏数据、关闭防火墙等</li></td><td>2020-11-13</td><td>-</td>
</tr>
<tr>
