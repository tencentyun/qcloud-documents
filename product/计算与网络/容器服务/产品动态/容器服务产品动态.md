...
<tr>
    <td>qGPU 功能增强</td>
		<td>
		qGPU 支持单容器多卡，可支持绑定多张整卡或一张分数卡、支持 GPU 监控，可支持 GPU 卡 Pod 容器级利用率监控、支持 TKE 黑石集群，并支持 ampere 架构 GPU 卡、支持离在线混部功能，可支持在线推理与离线训练的原生优先级调度。
		</td>
		<td>2021-11-05</td>
    ...
    <td>cfs-csi 存储插件功能更新</td>
		...
		<td>2021-11-02</td>
		<td><a href="https://cloud.tencent.com/document/product/457/492584">CFS-CSI 说明</a></td>
</tr>	
</table>
