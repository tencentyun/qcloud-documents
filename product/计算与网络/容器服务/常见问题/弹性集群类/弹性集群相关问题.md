...
在创建集群时，需要选择一个 VPC 网络作为集群网络，同时指定一个子网作为容器网络，详情请参见 [容器网络说明](https://cloud.tencent.com/document/product/457/39813#ContainerNetwork)。弹性集群 EKS 的 Pod 会直接占用容器网络子网 IP。在使用集群过程中，如需新增或修改容器网络，需要通过新增/移出超级节点的操作来实现，具体操作请参考以下步骤。
