...
超级节点是 Serverless 集群提供的一种调度能力，在创建 Serverless 集群时会对应在容器网络所在的每个子网中创建一个超级节点。

当您遇到如下场景时，可通过创建超级节点来解决相应的问题：

- 在 Serverless 集群中运行大规模工作负载时，因为服务所在可用区子网的 IP 资源耗尽而无法创建 Pod。这种情况下建议您在新的子网中创建超级节点来拓展 IP 数量。
...
本文介绍如何通过容器服务控制台在 Serverless 集群中新建超级节点。
...
2. 在“ Serverless 集群”列表页，选择目标集群 ID，进入该集群 “Deployment” 页面。
