...
## 操作场景
在 TKE Serverless 集群中，用户可以 [通过环境变量配置日志采集](https://cloud.tencent.com/document/product/457/47200)。也可以通过自定义资源（CustomResourceDefinitions，CRD）的方式配置日志采集。
...
1. 登录 [容器服务控制台](https://console.cloud.tencent.com/tke2/cluster?rid=4)，选择左侧导航栏中的 **[运维功能管理](https://console.cloud.tencent.com/tke2/ops/list?rid=1)**。
