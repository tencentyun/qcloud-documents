...
请根据实际需求，将命令行中的 “v1.18.4” 替换成业务所需的 Kubectl 版本。一般来说，客户端的 Kubctl 与服务端的 Kubernetes 的最高版本保持一致即可。您可以登录 [容器服务控制台](https://console.cloud.tencent.com/tke2/cluster?rid=1)，在集群的“基本信息”模块里查看 k8s 版本，如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/173cb96308e6264e967da7d19986b4eb.png)
</dx-alert>
<dx-tabs>
::: Mac\sOS\s系统
