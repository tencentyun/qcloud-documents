...
>! 
> - 弹性集群没有 Node，工作负载在创建时会根据参数确定为每个 Pod 实际分配的资源，详情请参考 [指定规格方法](https://cloud.tencent.com/document/product/457/xxx)。
> - 如果您需要通过 yaml 来创建、管理您的 Kubernetes 对象，EKS 支持的一些功能可以通过指定 annotation 实现，了解详情请阅读 [Annotation 说明](https://cloud.tencent.com/document/product/457/xxx)。
