...
<td>Kubernetes</td>
<td>原生支持</td>
<td>原生支持，存在由无计算节点造成的功能缺省，详情请参见 <a href="" target="_blank">缺省 Kubernetes 功能</a></td>
</tr>
<tr>
<td>私有网络</td>
<td colspan=2>支持</td>
...
- 网络：如需创建并管理您的私有网络，例如创建私有网络和子网、建立对等连接、使用 NAT 网关、配置路由表、配置安全策略等，可使用 [私有网络 VPC](https://cloud.tencent.com/product/vpc)。
