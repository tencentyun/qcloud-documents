...
为了实现快速的在不同集群或者集群的不同namespace中部署Guestbook应用，可以先将Guestbook部署相关的配置保存到应用模板中，然后使用应用模板快速部署对应的应用。

本示例将介绍如何将创建Guestbook的应用模板。
...
![应用模板guestbook示例-003.png-35kB][5]
...
```
![应用模板guestbook示例-004.png-32.6kB][6]
...
![应用模板guestbook示例-006.png-5.3kB][8]
