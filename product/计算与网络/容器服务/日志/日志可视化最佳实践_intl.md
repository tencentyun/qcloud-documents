...
You can directly use the basic template of Elasticsearch provided by KTE to build Elasticsearch cluster and Kibana. The following command can be used directly on the node in the cluster.
