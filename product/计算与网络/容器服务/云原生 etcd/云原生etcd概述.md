...
腾讯云云原生 etcd（Cloud etcd Service）是基于 [开源 etcd](https://github.com/etcd-io/etcd) 针对云原生服务场景进行优化的 etcd 托管解决方案，由腾讯云容器团队提供，完全兼容开源的 etcd 分布式存储能力，为用户提供高稳定、可观测、免运维的云原生 etcd 服务。
