...
<td><li>从 TKE 集群扩容到 EKS：支持固定 IP   (kube-scheduler)</li>
	...
	<li>写入 cpu manager 状态文件发生错误时，避免 panic   (kubelet)</li></td></tr>
...
<tr><td>2021-07-13</td><td>v1.18.4-tke.12</td><td><li>从 TKE 集群扩容到 EKS：在批量调度 Pod 时，能正确感知子网剩余 IP ，调度正确数量的 Pod 到虚拟节点上   (kube-scheduler)</li>
<li>支持收集 Containerd 运行时的磁盘用量指标   (kubelet)</li><li>缩容时支持指定 Pod   (kube-controller-manager)</li></td></tr>
    <td>2021-06-05</td>	
