...
### ClusterRole：集群维度 <span id="ClusterRole"></span>
...
4. 在 “ClusterRole” 页面中，选择右上角的【YAML创建资源】。
5. 在编辑界面输入自定义策略的 YAML 内容，单击【完成】即可创建 ClusterRole。
以 [ClusterRole：集群维度](#ClusterRole) YAML 示例为例，创建完成后，可在 “ClusterRole” 管理页面中查看自定义权限 “testClusterRole”。
...
8. 在“集群RBAC”步骤中，设置权限。例如，“权限设置”选择为命名空间 “default” 下的“只读用户”。如下图所示：
9. 进入“集群RBAC设置”界面，按照以下指引进项权限设置。如下图所示：
