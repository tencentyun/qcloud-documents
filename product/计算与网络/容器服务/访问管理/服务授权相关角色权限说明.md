...
1. 登录[容器服务控制台](https://console.cloud.tencent.com/tke2)，在**集群管理**页面的上方选择地域及集群后，进入“集群详情”页。
2. 在“集群详情”页的左侧导航栏中选择**组件管理**，单击**新建**。
3. 在“组件管理”页面中，当扩展组件首次选择为 “CFS 腾讯云文件存储” 时，单击页面下方的**服务授权**。如下图所示： 
