本文档旨在帮助大家了解如何快速创建一个容器集群内的 Hello World 的 Node.js 版的服务。更多关于如何构建 Docker 镜像的教程可参阅  [如何构建docker镜像](https://www.qcloud.com/document/product/457/9115) 。
...
### 创建 Docker 镜像
构建 Docker 镜像更多详情见：[如何构建docker镜像](https://www.qcloud.com/document/product/457/9115) 。
...
### 上传该镜像到 qcloud 镜像仓库
更多镜像操作详情见：[镜像仓库基本教程](https://www.qcloud.com/document/product/457/9117) 。
```shell
