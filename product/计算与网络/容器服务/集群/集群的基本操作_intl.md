...
5. Enter CVM configuration.
 ...
 - **Security group**: It functions as a firewall and is used to set the network access control of CVMs. For more information, please see [Configure KTE Security Group](/doc/product/457/9084).
