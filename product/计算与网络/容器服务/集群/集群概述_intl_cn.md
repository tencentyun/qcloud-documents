...
## 集群保留资源说明
集群中的每个节点都会保留部分资源以支持kubernetes运行，具体保留规则如下：

CPU

| 节点总量/单位：核 | 1    | 2    | 4    | 8    | 16   | 32   |
| --------------- | ---- | ---- | ---- | ---- | ---- | ---- |
| 节点保留量/单位：核 | 0.06 | 0.07 | 0.08 | 0.09 | 0.11 | 0.14 |

Memory

| 节点总量/单位：Gib | 1   | 2   | 4   | 8   | 12   | 16   | 24   | 32   | 48   |
| ---------------- | --- | --- | --- | --- | ---- | ---- | ---- | ---- | ---- |
| 节点保留量/单位：Mib | 160 | 320 | 420 | 830 | 1200 | 1300 | 1660 | 1830 | 2420 |

另外每个节点还会额外保留100Mi内存以防系统OOM。
