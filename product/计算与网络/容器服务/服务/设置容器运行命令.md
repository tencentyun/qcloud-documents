...
如何将docker run命令适配到腾讯云容器服务，点击查看[详情](https://www.qcloud.com/document/product/457/9883)
...
**注意:**Docker entrypoint对应容器服务控制台上的运行命令，Docker run的CMD参数对应容器服务控制台上的运行参数，当有多个运行参数时，在容器服务的运行参数中输入参数，每个参数单独一行。
