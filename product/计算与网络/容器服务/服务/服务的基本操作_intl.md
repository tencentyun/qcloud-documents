...
>If no source path is specified, a temporary path is assigned by default.
 ...
 - **Type**: Four types of volumes are supported: local disk, cloud disk, NFS disk, and configuration file. For more information, please see [How to Use KTE Volume](https://cloud.tencent.com/document/product/457/9112#.E5.AE.B9.E5.99.A8.E6.9C.8D.E5.8A.A1.E6.95.B0.E6.8D.AE.E5.8D.B7.E4.BD.BF.E7.94.A8.E8.AF.B4.E6.98.8E).
 - **Name**: Volume name.
...
5. Configure a container.
 ...
 - **Tag**: The default image tag for KTE. If you need to use a different image tag, click tag display window to select one.
...
1. Click **Services** in the left navigation bar of KTE console to enter the service list, and click **Update Number of Pods**.
...
## Updating Service
1. Click **Services** in the left navigation bar of KTE console to enter the service list, and click **Update Service**.
...
1. Click **Services** in the left navigation bar of KTE console to enter the service list, and click **More** -> **Redeploy**.
...
## Deleting Service
1. Click **Services** in the left navigation bar of KTE console to enter the service list, and click **More** -> **Delete**.
