...
5. 远程登录南京边缘地域的 Pod 访问北京地域的服务。示例如下：
```
root@nginx-nj-******45b8-8sslj:/# curl http://nginx-bj.default:80
<!DOCTYPE html>
<html>
<head>
...
```
6. 远程登录北京边缘地域的 Pod 访问南京地域的服务。示例如下：
```
root@nginx-bj-******8894-r7b5j:/# curl http://nginx-nj.default:80
<!DOCTYPE html>
<html>
<head>
<title>Welcome to nginx!</title>
