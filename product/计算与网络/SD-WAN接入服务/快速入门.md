...
5. [关联云联网](#5)：将北京和广州地域的 SD-WAN 接入服务实例、腾讯云 VPC 关联至云联网，实现网络互通。
...
1. 配置 WAN 接口。（即192.168.3.1）
   - 方式1：通过本地 Web 控制台配置（即192.168.3.1），具体操作请参见 [在本地 Web 控制台配置 Edge 设备](https://cloud.tencent.com/document/product/1277/47252)。
...
2. 在 “Edge 设备”页面，勾选目标 Edge 设备实例，并在页面上方单击【关联云联网】。
   ...
   >
![](https://main.qcloudimg.com/raw/7b4f71241fe8ee131ffc12476a313def.png)
...
4. 检查云联网路由表。
   ...
   ![](https://main.qcloudimg.com/raw/42b3667d9c3c85b33d2d6ae18cd32fd0.png)
