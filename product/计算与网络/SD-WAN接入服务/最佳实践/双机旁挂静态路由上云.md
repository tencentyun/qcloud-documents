本篇文档为您介绍腾讯云 SD-WAN 接入服务的典型使用场景之一，分布在不同地域的线下分支通过 Edge 设备实现与云上 VPC 的互联互通。
...
2. 在**新建 Edge**页面中，填写设备名称，选择硬件规格等信息，此处硬件规格勾选Edge-1000，然后单击**下一步**。
