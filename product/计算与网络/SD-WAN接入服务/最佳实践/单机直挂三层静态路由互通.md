本文将为您介绍腾讯云 SD-WAN 接入服务的典型使用场景之一，Edge 设备作为线下分支 PC 、手机等移动设备访问远端私有网络云服务器内网流量的转发设备。线下分支 PC、手机等移动设备和 Edge 设备同处于三层网络，通过三层交换机或路由器互通。
...
- 默认路由的下一跳为192.168.2.1，即 Edge 设备 LAN 侧 Default-vPort IP
