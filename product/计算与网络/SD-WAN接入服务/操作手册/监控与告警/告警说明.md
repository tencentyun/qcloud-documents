...
| 升级失败          | Upgrade_Failed   | 异常事件 | Edge 设备维度 | 有           | 系统升级失败              | 请[ 联系我们](https://cloud.tencent.com/act/event/connect-service)                           |
| 发货失败          | Delivery_Failed  | 异常事件 | Edge 设备维度 | 有           | Edge 设备因故发货失败      | 请[ 联系我们](https://cloud.tencent.com/act/event/connect-service)                                |
| 物流失败          | Logistics_Failed | 异常事件 | Edge 设备维度 | 有           | 物流原因导致              | 请[ 联系我们](https://cloud.tencent.com/act/event/connect-service)                            |
...
| 所有链路故障      | All_Link_Down    | 异常事件 | Edge 设备维度 | 有           | 主备链路和 4G 链路均不可用  | 检查链路，联系客服                 |
| WAN 侧下行链路丢包 | Down_Packet_Loss | 异常事件 | Edge 设备维度 | 有           | VPN隧道带宽下行带宽达上限导致丢包 | 提升下行带宽或 [联系我们](https://cloud.tencent.com/act/event/connect-service)  进行处理               |
| WAN 侧上行链路丢包 | Up_Packet_Loss   | 异常事件 | Edge 设备维度 | 有           | VPN隧道上行带宽达上限导致丢包 | 提升上行带宽或 [联系我们](https://cloud.tencent.com/act/event/connect-service) 进行处理                 |
