...
## 查看列表信息
1. 登录 [SD-WAN 接入网关控制台](https://console.cloud.tencent.com/vpc/edge)。
2. 在实例列表中查看目标实例信息。
...
<tr>
<td>监控</td>
<td>设备状态为“运行中”、“离线”的实例可以查看监控信息，具体操作请参见 <a href="">查看监控信息</a>。</td>
</tr>
<tr>
<td>设备状态</td>
...
<tr>
<td>带宽</td>
<td>申请 Edge 设备的带宽，运行中的实例可以提升带宽，具体操作请参见 <a href="">升级带宽</a>。 </td>
</tr>
<tr>
<td>关联云联网</td>
<td>关联的云联网实例，运行中的实例才可以关联云联网，具体操作请参见 <a href="">关联云联网</a>。</td>
</tr>
<tr>
<td>LAN 网段</td>
...
1. 在 [SD-WAN 接入服务实例列表](https://console.cloud.tencent.com/vpc/edge) 中，单击目标实例 ID。
