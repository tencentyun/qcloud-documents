...
- **扣费类问题**
 - [ 对于“未绑定，扣费中”状态的 EIP，如何停止收取 IP 资源费？](#21)
 - [对于已释放的“未绑定，扣费中”状态的 EIP，为什么仍在扣费？](#22)
- **计费模式类问题**
 - [带宽上移账户的 EIP 计费模式如何更换？](#31)
 - [为什么要为计费模式为按流量计费的 EIP 设置带宽峰值？](#32)

<span id = "10"></span>
### EIP 如何计费？
EIP 的费用根据非带宽上移和带宽上移不同类型的账户收费不同，详情请参见 [计费说明](https://cloud.tencent.com/document/product/1199/41692)。
...
详情请参见 [IP 资源费用](https://cloud.tencent.com/document/product/1199/41692#ip)。

<span id = "12"></span>
### EIP 什么时候收取 IP 资源费？
当 EIP 未绑定云资源时，如下情况会产生 IP 资源费：
- 非带宽上移账户的 EIP。
...
EIP 的公网网络计费详情，请参见 [公网网络费用](https://cloud.tencent.com/document/product/1199/41692#net)。

<span id = "14"></span>
### 绑定、解绑和释放 EIP，对费用有什么影响？
- 将 [EIP 绑定云资源](https://cloud.tencent.com/document/product/1199/41702) 后，不同类型账户下的费用说明如下：
<table>
<thead>
<tr>
<th>账户类型</th>
...
- 将 [EIP 解绑云资源](https://cloud.tencent.com/document/product/1199/41703) 后，不同类型账户下的费用说明如下：
<table>
<thead>
<tr>
<th>账户类型</th>
...
- [释放 EIP](https://cloud.tencent.com/document/product/1199/41704) 后，不同类型账户下的费用说明如下：
<table>
<thead>
<tr>
<th width="20%">账户类型</th>
...
<span id = "21"></span>
### 对于“未绑定，扣费中”状态的 EIP，如何停止收取 IP 资源费？
