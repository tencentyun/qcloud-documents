...
<span id = "11"></span>
### EIP 如何收取 IP 资源费用？
1. 控制台展示的费用为空置满一小时的费用，目前 IP 资源费用的收取可以精确到秒级，多次绑定/解绑，解绑状态的时长按秒累加后收费。
2. 闲置总时长不足一小时，按闲置时间占比收取 IP 资源费用。

EIP 的 IP 资源费用的计费详情，请参见 [IP 资源费用](https://cloud.tencent.com/document/product/1199/41692#ip)。
...
- 带宽上移账户：根据计费模式的不同，公网网络费用的收取情况有所差异。
...
- <span id="bind" />将 [EIP 绑定云资源](https://cloud.tencent.com/document/product/1199/41702) 后，不同类型账户的费用说明如下：
<table>
<thead>
<tr>
<th>账户类型</th>
...
- <span id="unbind" />将 [EIP 解绑云资源](https://cloud.tencent.com/document/product/1199/41703) 后，不同类型账户的费用说明如下：
<table>
<thead>
<tr>
<th>账户类型</th>
...
- <span id="release" />[释放 EIP](https://cloud.tencent.com/document/product/1199/41704) 后，不同类型账户的费用说明如下：
<table>
<thead>
<tr>
<th width="20%">账户类型</th>
