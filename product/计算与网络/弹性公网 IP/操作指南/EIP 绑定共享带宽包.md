...
2. 添加 EIP 到共享带宽包后，EIP 原本的计费模式将变更为共享带宽包模式，不额外收取流量费和带宽费用，但正常收取 IP 资源费。
3. EIP 的 IP 资源费与是否加入共享带宽包无关，当 EIP 绑定云资源时，IP 资源费减免。
...
5. 在弹出的“绑定资源”窗口中，选择【弹性公网IP/普通公网IP】为资源类型，并选择需添加到共享带宽包的 EIP，单击【确定】即可。
