您可将 EIP 绑定到 CVM 实例、NAT 网关等云资源上，利用 EIP 的灵活地容灾与提供公网通信服务等。
...
<td>CVM 实例</td>
<td><ul>
<li>非带宽上移账户的 EIP 与 CVM 实例绑定，该 CVM 实例需未绑定其他 EIP ，若已有普通公网 IP，则绑定 EIP 后会释放当前 CVM 实例的普通公网 IP。</li>
...
<li>非带宽上移账户的 EIP 绑定主网卡内网 IP 时，若主网卡绑定的 CVM 实例的已有普通公网 IP，则主网卡内网 IP 绑定 EIP 后 CVM 实例当前的普通公网 IP 会被释放。</li>
<li>带宽上移账户的 EIP 绑定主网卡内网 IP 时，该主网卡绑定的 CVM 实例需未分配普通公网 IP。</li>
