弹性公网 IP（EIP）可按需调整带宽或更改计费模式，实时生效。

## 限制说明
仅带宽上移账户可在 EIP 控制台调整带宽或调整计费模式。非带宽上移账户，请在对应的云服务器或 NAT 网关上调整带宽。若您无法确定账户类型，请参见 [账户类型区分](https://cloud.tencent.com/document/product/1199/41692#judge)。
