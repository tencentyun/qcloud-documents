...
- <span id="judge" />区分账户类型：登录 <a href="https://console.cloud.tencent.com/cvm/eip">EIP 控制台</a>，在“弹性公网 IP”页面查看列表字段。
...
- 包月带宽：无论是否绑定云资源，仅收取 <a href="#net">公网网络费用</a>。</li>
- 按小时带宽：无论是否绑定云资源，仅收取 <a href="#net">公网网络费用</a>。</li>
<img src="https://main.qcloudimg.com/raw/ae16d65c2fb344660ae05b9fa5b24396.png" style="width:60%;"></img>
...
共享带宽包模式适用于大规模业务，且使用公网的不同实例间可形成流量错峰的场景。
#### 计费价格
| 地域     | 价格（单位：元/Mbps/月） |
| -------- | ------------------------ |
| 全部地域 | 108                      |
