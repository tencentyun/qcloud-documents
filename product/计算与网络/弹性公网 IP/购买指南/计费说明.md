...
## 费用组成
EIP 的费用分为 **IP 资源费用**和**公网网络费用**两部分，非带宽上移和带宽上移类型的账户费用详情介绍如下：
...
<ul>
<li>绑定云资源：EIP 自身不收取任何费用，仅在 CVM、NAT 网关等实例上收取公网网络费用，其计费详情请参见 <a href="#net-price">公网网络费用</a>。</li>
...
<li>未绑定云资源：<ul><li>按流量计费模式的 EIP 收取 IP 资源费用，按小时计费，计费详情请参见 <a href="#ip-price">IP 资源费用</a>。</li><li>按包月带宽和按按小时带宽计费模式的 EIP，不收取 IP 资源费用。</li></ul></li></ul>
