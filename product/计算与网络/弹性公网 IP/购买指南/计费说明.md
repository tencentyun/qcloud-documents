弹性公网 IP（EIP）的费用，依据非带宽上移和带宽上移两种不同账户类型进行计费，本文为您介绍对应的计费详情。
...
## 费用组成
EIP 的费用分为 **IP 资源费用**和**公网网络费用**两部分，非带宽上移和带宽上移两种账户类型的费用详情如下：
...
<li>绑定云资源：EIP 自身不收取任何费用，仅在 CVM 实例上收取公网网络费用，其计费详情请参见 <a href="https://cloud.tencent.com/document/product/213/10578" target="_blank">云服务器-公网计费模式</a>。</li>
</ul>
...
<ul>
<li>未绑定云资源：<ul><li>按流量计费模式的 EIP 仅收取 IP 资源费用，按小时计费，计费详情请参见 <a href="#ip-price">IP 资源费用</a>。</li><li>包月带宽和按小时带宽计费模式的 EIP，不收取 IP 资源费用。</li></ul></li>
<li>绑定云资源：仅收取公网网络费用，分为按流量、包月带宽、按小时带宽三种模式，费用在 EIP 上收取，计费详情请参见 <a href="#net-price">公网网络费用</a>。<br>按流量和按小时带宽计费模式的 EIP 可以加入共享带宽包中，加入后，EIP 原本的计费模式将变更为共享带宽包模式，消耗的公网网络资源从共享带宽包中扣除，不再额外收取公网网络费用，共享带宽包计费详情请参见 <a href="https://cloud.tencent.com/document/product/684/15255">共享带宽包-计费概述</a>。</li>
</ul>
...
>!为节省您的 EIP 使用费用，以免产生不必要的 IP 资源费用，建议：
>- 申请 EIP 后，请及时绑定云资源，以免产生 IP 资源费用。
>- 若不再使用 EIP，解绑云资源后请及时释放 EIP。
