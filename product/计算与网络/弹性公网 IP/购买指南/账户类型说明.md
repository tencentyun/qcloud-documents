...
- 公网网络（云服务器、弹性公网 IP）：两种账户类型支持的计费模式与价格完全一致，详细价格可参见 [公网网络费用](https://cloud.tencent.com/document/product/1199/51693)。
- 弹性公网 IP 资源费：两种账户类型的结算方式与价格完全一致，详细价格可参见 [IP 资源费用](https://cloud.tencent.com/document/product/1199/51694)。
...
>?升级标准账户类型，公网 IP 地址、内网 IP 地址不会发生改变。
>
:::
::: 对带宽上线的影响
对带宽上限的影响：
...
### 对其他产品的影响
除云服务器、公网 IP（包括普通公网IP和弹性公网 IP）、负载均衡外，升级对其他产品不会产生任何影响。
