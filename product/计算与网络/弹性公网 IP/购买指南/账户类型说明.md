...
## 公网网络费用说明
标准账户与传统账户使用公网网络、弹性公网IP都需要支付费用，各产品区别如下：
- 公网网络（云服务器、弹性公网IP）：两种账户类型支持的计费模式与价格完全一致，详细价格可参见 [定价页](https://cloud.tencent.com/document/product/1199/51693)。
- 弹性公网IP资源费：两种账户类型的结算方式与价格完全一致，详细价格可参见 [定价页](https://cloud.tencent.com/document/product/1199/51694)。
...
### 升级对云服务器和 IP 的影响
- 对云服务器上的公网 IP（包括普通公网 IP 和 EIP）的网络计费模式影响如下表所示：
<table>
<tr>
...
>?升级标准账户，公网 IP 地址、内网 IP 地址不会发生改变。
>
- 对带宽上限的影响：
...
#### 对其他产品的影响
除云服务器、公网IP（包括普通公网IP和弹性公网IP）、负载均衡外，升级对其他产品不会产生任何影响。
