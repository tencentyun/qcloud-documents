...
- 公网网络（云服务器、弹性公网 IP）：两种账户类型支持的计费模式与价格完全一致，详细价格可参见 [定价页](https://cloud.tencent.com/document/product/1199/51693)。
- 弹性公网 IP 资源费：两种账户类型的结算方式与价格完全一致，详细价格可参见 [定价页](https://cloud.tencent.com/document/product/1199/51694)。
