...
>? 账户类型不同，申请 EIP 时填写的参数也有所不同。若您无法确定账户类型，请参见 [区分账户类型](https://cloud.tencent.com/document/product/1199/49090#.E5.8C.BA.E5.88.86.E8.B4.A6.E6.88.B7.E7.B1.BB.E5.9E.8B)。
...
<td>
<ul>
<li>常规 IP 支持按流量、包月带宽、按小时带宽和 共享带宽包计费模式，详情请参见 <a href="https://cloud.tencent.com/document/product/1199/51693">公网网络费用</a>。
</li>
<li>加速 IP 和静态单线 IP 只支持共享带宽包计费模式，不支持其它计费模式。加速 IP 和静态单线 IP 创建后会自动新增并添加到共享带宽包中。
</li>
</ul>
</td>
</tr>
