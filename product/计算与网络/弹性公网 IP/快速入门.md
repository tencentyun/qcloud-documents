...
4. [释放 EIP](#step4)：若不再需要使用该 EIP，可将其释放，释放后不再产生费用，但释放后可能无法找回，更多详情，请参见 [找回公网 IP 地址](https://cloud.tencent.com/document/product/1199/41708)。
...
## 相关信息
- 若需要绑定其它云资源，如 NAT 网关、弹性网卡、高可用虚拟 IP，请参见 [申请 EIP](https://cloud.tencent.com/document/product/1199/41698)。
