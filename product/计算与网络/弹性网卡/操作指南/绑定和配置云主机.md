...
3. 找到需要绑定和配置的弹性网卡所在行，单击操作栏中的【绑定云主机】。
   ![](https://main.qcloudimg.com/raw/25ef215f4139ec0d3a0a5d29c13ec02b.png)
   > !仅支持绑定和弹性网卡在相同可用区的云主机。
4. 在弹框中，选择需要绑定的云主机，单击【确定】完成绑定。
   ![](https://main.qcloudimg.com/raw/fa2dfd0e38f43ebb559b42943abd14cd.png)
