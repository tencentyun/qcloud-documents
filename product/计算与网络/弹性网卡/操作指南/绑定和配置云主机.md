...
> 
 ...
 3. 配置策略路由。
> !
> + 此处两个命令中，IP 要分别替换成主网卡上的 IP，以及辅助网卡上的 IP；10和20为步骤6.1中自定义的路由ID，请根据实际情况填写。
...
> ?此处两个命令中，172.21.48.1要分别替换成著网卡所属子网的网关，以及辅助网卡所属子网的网关。具体网关，请参考 [查看网关](#.E6.9F.A5.E7.9C.8B.E7.BD.91.E5.85.B3) 。
>     
