...
<table >
   <tr align="center" >
    <th   rowspan="2" style = "text-align:center;">机型</th>
    <th  rowspan="2" style = "text-align:center;">实例类型</th>
    <th colspan="10" style = "text-align:center;">弹性网卡数，单网卡绑定内网 IP 数</th>
   </tr>
   <tr >
   ...
   <tr >
    <th class="xl71" x:str>GPU 计算型 GN6</th>
    <td >-</td>
    <td >-</td>
    <td >-</td>
    <td >-</td>
