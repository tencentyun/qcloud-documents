...
<table >
   <tr >
    <th width="5%"  rowspan="2" style = "text-align:center;">机型</th>
    <th  width="11%"  rowspan="2" style = "text-align:center;">实例类型</th>
    <th width="84%" colspan="10" style = "text-align:center;">弹性网卡数，单网卡绑定内网 IP 数</th>
   </tr>
   <tr >
