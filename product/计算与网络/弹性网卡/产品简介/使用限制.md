...
<table >
   <tr >
    <th width="6%"  rowspan="2" style = "text-align:center;">机型1</th>
    <th  width="12%"  rowspan="2" style = "text-align:center;">实例类型</th>
    <th width="82%" colspan="10" style = "text-align:center;">弹性网卡数，单网卡绑定内网 IP 数</th>
   </tr>
   <tr >
   ...
   <tr >
    <th style = "text-align:center;">黑石物理服务器2.0</th>
