...
#### 前提条件
- 启用 CDN 加速必须使用用户已经在**腾讯云备案**的自有域名，详情请参考 [备案指引](https://cloud.tencent.com/document/product/243/18905)。
...
- 自定义域名必须是已经在**腾讯云备案**的域名，详情请参考 [备案指引](https://cloud.tencent.com/document/product/243/18905)。
