...
<li>全时流量包的可用时间是全天。</li><li>闲时流量包的可用时间是该地域时间的0:00-8:00，其余时间不生效无法使用。</li><li>闲时流量包目前处于内测中，如需使用，请提交 <a href="https://cloud.tencent.com/apply/p/9k903wazwfb">内测申请</a>。</li></ul></td></tr>
