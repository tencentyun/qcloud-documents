...
) the cloud disk from the instance, and then create a snapshot and [re-connect it to the CVM instance](https://intl.cloud.tencent.com/document/product/362/5745).
