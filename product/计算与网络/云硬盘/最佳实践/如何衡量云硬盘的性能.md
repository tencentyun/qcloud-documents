...
<table>
	 ...
	 <tr>
         <td>direct</td>
		 <td>指定 direct 模式。<li>True（也写作1）表示使用 O_DIRECT 模式，忽略 I/O 缓存，数据直写。</li><li>False（也写作0）表示不使用 O_DIRECT 模式。</li>默认为 True（也写作1）。</td>
         <td>1</td>
     </tr>
	 <tr>
         <td>rw</td>
	 ...
	 <tr>
         <td>randrepeat</td>
		 <td>随机序列是否可重复，True（也写作1）表示随机序列可重复，False（也写作0）表示随机序列不可重复。默认为 True（也写作1）。</td>
         <td>0</td>
     </tr>
