When you need to mount the ***elastic cloud disk*** to another instance, you can disconnect it from the current instance and then connect it to another instance. <font color="red">The unmounting of elastic cloud disk will not erase the data on it.</font>
...
3) In the Cloud Block Storage list page, click "More" - "Unmount" button next to the Clocd Block Storage with the status of <font color="red">"Mounted" or "Support Mounting/Unmounting"</font> to unmount the single Cloud Block Storage;
Or in the Cloud Block Storage list page, check the Cloud Block Storage with the status of <font color="red">"Mounted" or "Support Mounting/Unmounting"</font>, and click "Mount" button on the top to batch unmount.
