...
### 使用 API 创建弹性云盘
请参考 [CreateCbsStorage 接口](https://www.qcloud.com/doc/api/364/2524)。
...
### 使用 API 创建非弹性云盘
非弹性云盘是随实例而创建的跟随实例生命周期的云硬盘，创建实例并选择非弹性云盘的操作可以参考 [RunInstances 接口](https://www.qcloud.com/doc/api/229/1248) 和 [RunInstancesHour 接口](https://www.qcloud.com/doc/api/229/1350)。