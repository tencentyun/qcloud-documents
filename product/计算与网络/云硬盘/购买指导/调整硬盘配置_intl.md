...
- After disk expansion, you need to manually modify the file system configuration to make use of the newly expanded capacity. For more information, please see [Expanding Linux File System](https://cloud.tencent.com/document/product/362/6738) 
...
Please see [API ResizeInstance](https://cloud.tencent.com/doc/api/229/1306) and [API ResizeInstanceHour](https://cloud.tencent.com/doc/api/229/1344).
