...
- HDD cloud storage has low storage cost, and the same level of data persistency as SSD cloud block storage. It can be used as cold data backup and archive, with a maximum capacity of 16TB for a single disk 
...
**Deployment environment**: 5 servers (12Core 40GB RAM), each mounted with a 1TB SSD cloud disk and a 1TB HDD cloud disk, to simulate offline data analysis
**Test performance**: For 1.5TB data, 5 HDD cloud disks can provide a read speed of 500MB/s, the data is read into RAM in 50 minutes, while SSD cloud disks will finish this process in 25 minutes!
...
**Deployment environment**: Mount 800G SSD cloud disks onto 4 virtual machines (Core 8GB RAM) and deploy Mysql version 5.5.42.
