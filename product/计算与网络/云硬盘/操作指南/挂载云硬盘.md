...
5. 根据云硬盘的情况，您需要选择执行对应的后续操作使云硬盘可用。
 ...
 <tr>
  ...
  <tr>
	...
	<td>云硬盘容量 = 快照容量</td>
	<td><ul><li>挂载至 Windows 云服务器：
		<ul><li>若快照关联云硬盘完成初始化：通过【服务器管理】>【存储】>【磁盘管理】，联机后即可使用。</li>
		<li>若未完成初始化：请参考 <a href="https://cloud.tencent.com/document/product/362/33065">初始化场景介绍</a> 完成初始化操作。</li></ul>
		<li>挂载至 Linux 云服务器：登录实例后执行 <code>mount <磁盘分区> <挂载点></code> 命令，例如 <code>mount /dev/vdb /mnt</code> 后即可使用。</li>
		</ul>
	</li></td>
 </tr>
 </tr>
