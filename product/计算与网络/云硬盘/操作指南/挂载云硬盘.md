...
- 单独购买的云硬盘，通过控制台或 API 接口手动将弹性云硬盘挂载到同一可用区中的已有云服务器实例上。
 ...
 - 从快照创建的云硬盘
  若云硬盘容量等于快照容量，手动挂载后可直接读写数据盘。
	 若云硬盘容量大于快照容量，需要将超出部分的磁盘空间划分至已有分区内，或者格式化成一个独立的新分区，具体操作请参考 [扩展分区及文件系统（Windows）](https://cloud.tencent.com/document/product/362/6737)或 [扩展分区及文件系统（Linux）](https://cloud.tencent.com/document/product/362/6738)。
...
5. 根据云硬盘的情况，您需要选择执行对应的后续操作使云硬盘可用。
 ...
 <td>小于2TB</td>
 <td><a href="https://cloud.tencent.com/document/product/362/6734">初始化云硬盘（小于2TB）</td>
 </tr>
 <tr>
  <td>大于等于2TB</td>
	<td><a href="https://cloud.tencent.com/document/product/362/6735">初始化云硬盘（大于等于2TB）</td>
 </tr>
  <tr>
	<td  rowspan="2">从快照创建</td>
	<td>等于快照容量</td>
	<td>无</td>
 </tr>
 </tr>
