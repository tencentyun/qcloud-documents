...
<td nowrap="nowrap"><ul><li>若快照中使用 MBR 分区形式：</li>需要删除原有数据，再按照 GPT 格式重新分区。具体操作可参考 <a href="https://cloud.tencent.com/document/product/362/6735">初始化云硬盘（大于等于2TB）</a><li>若快照中使用 GPT 分区形式：<ul><li>挂载至 Windows 云服务器：<a href="https://cloud.tencent.com/document/product/362/6737">扩展分区及文件系统（Windows）</a></li><li>挂载至 Linux 云服务器：<a href="https://cloud.tencent.com/document/product/362/6738">扩展分区及文件系统（Linux）</a></li></ul></td>
 </tr> 
 </table>
