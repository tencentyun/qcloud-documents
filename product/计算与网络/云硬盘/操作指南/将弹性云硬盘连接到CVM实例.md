...
3) 在云硬盘列表页，单击状态为<font color="red">待挂载、支持挂载/卸载</font>的云硬盘后的【更多】-【挂载】按钮进行单盘挂载；
...
## 使用 API 将云硬盘连接到实例
请参考 [AttachDisks 接口](https://cloud.tencent.com/document/product/362/16313)。

## 部分已创建的云服务器实例无法识别云硬盘的解决方案
