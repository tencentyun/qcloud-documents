...
云服务器支持作为系统盘的云硬盘进行在线扩容，即不停服扩容。如需使用此功能，请通过 [售前在线咨询](https://cloud.tencent.com/online-service?source=PRESALE&from=doc_213) 提交申请。
</dx-alert>
 1. 在“扩容分区及文件系统”步骤中，查阅注意事项，单击**开始调整**即可。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/2ac6dfa7572ea6f5a031c23188c1eba0.png)
 2. 完成控制台扩容操作后，请参考 [在线扩展系统盘分区及文件系统](https://cloud.tencent.com/document/product/362/64035) 进行扩容分区及文件系统操作。
