...
<table>
	 ...
	 <tr>
         ...
         <td>磁盘容量小于2TB</td>
    		 <td><li>扩容的是 Linux 云服务器的云硬盘：<a href="https://cloud.tencent.com/document/product/362/6738">扩展分区及文件系统（Linux）</a></li>
				 <li>扩容的是 Windows 云服务器的云硬盘：<a href="https://cloud.tencent.com/document/product/362/6737">扩展分区及文件系统（Windows）</a></li>
				 </td>
     </tr>
	 <tr>
         <td>磁盘容量大于等于2TB</td>
         <td>
				 <li>采用 GPT 分区格式：<a href="https://cloud.tencent.com/document/product/362/6738">扩展分区及文件系统（Linux）</a>或 <a href="https://cloud.tencent.com/document/product/362/6737">扩展分区及文件系统（Windows）</a></li>
				 <li>采用 MBR 分区格式：不支持<br/>MBR 格式分区支持的磁盘最大容量为2TB。如果您的硬盘分区为 MBR 格式，且需要扩容到超过2TB时，建议您重新创建并挂载一块新的数据盘，然后使用 GPT 分区方式后将数据拷贝至新盘中。</li>
				 </td>
     </tr>
</table>
