...
>!如果云硬盘的最大容量仍无法满足您的业务需求，您可以使用 [多块弹性云硬盘构建 RAID 1](https://cloud.tencent.com/document/product/362/2932) 或 [多块弹性云盘构建 LVM 逻辑卷](https://cloud.tencent.com/document/product/362/2933) 。
