...
## 操作步骤
>?
>- 如果[扩容云硬盘](https://cloud.tencent.com/document/product/362/5747) 时，挂载该盘的 CVM 实例正处于正常运行状态，则需要 [重新扫描磁盘](#Scaning) 待识别扩容后的云硬盘空间后再 [扩展卷](#Extending)。
>- 如果 [扩容云硬盘](https://cloud.tencent.com/document/product/362/5747) 时，该盘处于未挂载状态或者挂载该盘的 CVM 实例正处于关机状态，直接 [扩展卷](#Extending) 即可。
