...
可用区具备以下特性：
- 同一腾讯云账户下相同地域不同可用区，但在同一个 [VPC（私有网络）](https://cloud.tencent.com/document/product/215) 下的云产品之间均通过内网互通，可以直接使用 [内网 IP](https://cloud.tencent.com/document/product/213/5225) 访问。
