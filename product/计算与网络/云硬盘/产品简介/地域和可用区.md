...
<table class="table-striped">
	...
	<tr>
		...
		<tr>
			<td rowspan="2">亚太东南地区（中国香港）<br>ap-hongkong</td>
...
<tr>
		...
		<tr>
			<td>亚太东南地区（新加坡）<br>ap-singapore</td>
			<td>新加坡一区（新加坡节点可用于覆盖东南亚地区）<br>ap-singapore-1</td>
		</tr>
		<tr>
		  	<td >亚太东南地区（曼谷）<br>ap-bangkok </td>
				 <td >曼谷一区  （曼谷节点用户覆盖亚太东南地区）<br>ap-bangkok-1</td>
		<tr>
       <tr>
			<td  rowspan="2">亚太南部地区（孟买）<br>ap-mumbai</td>
...
<tr>
		...
		<tr>
			<td >亚太东北地区（首尔）<br>ap-seoul</td>
			<td>首尔一区（首尔节点可用于覆盖东北亚地区）<br>ap-seoul-1</td>
		</tr>
		<tr>
			<td >亚太东北地区（东京）<br>ap-tokyo</td>
