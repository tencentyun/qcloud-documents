...
云硬盘容量上限为16TB，单台云服务器累计可挂载10个弹性云硬盘作数据盘用，高效应对 TB/PB 级数据的大数据处理场景。

## 高性能

高性能云硬盘采用 cache 机制满足用户常规业务需求。SSD 云硬盘采用 NVMe 标准 SSD，单盘提供24,000随机读写 IOPS（Input/Output Operations per Second），满足对 I/O 能力有极端要求的场景。
