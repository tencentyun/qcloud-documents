...
<div style="position:absolute;width:1px;height:213px;top:0;left:0;background-color: #d9d9d9;transform:rotate(-72deg);transform-origin:top;"></div><span style="width:96px;display:block;padding-left:80px;">服务器所在地区</span><span style="width:96px;display:block;padding-right:80px;padding-top:10px">公网出入口地区</span></th>
