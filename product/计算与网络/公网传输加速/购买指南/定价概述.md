使用 Anycast 公网加速需要购买 Anycast 公网加速 IP，其属于弹性公网 IP（EIP）的其中一种类型。本文介绍 EIP 中的 Anycast 公网加速 IP 的计费规则。

## 费用组成
Anycast 公网加速的费用由 **IP 资源费用**和**公网网络费用**组成。
<table>
<tr><th>计费项</th><th>计费模式</th><th>计费说明</th></tr>
<tr><td><a href="#ipcost">IP 资源费用</a></td><td>按小时后付费</td><td>Anycast 公网加速 IP 闲置未绑定云资源时，仅收取 IP 资源费用，不收取公网网络费用。</td></tr>
...
>?Anycast 公网加速仅加速除中国大陆以外的其他地区，不加速中国大陆与海外地区之间的跨境传输。
>
## 计费示例
