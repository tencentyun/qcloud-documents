...
![](https://main.qcloudimg.com/raw/efe4881f8a427899c8c73258e0cfbc4a.png)
 ...
 - **触发规则**：
    ...
    - **仓库名称**：触发器生效的仓库名称，支持对镜像仓库及 Helm Chart 仓库进行 [正则匹配](https://cloud.tencent.com/document/product/1141/41945#.E7.9B.B8.E5.85.B3.E6.93.8D.E4.BD.9C)。
    - **版本Tag**：触发器生效的 Tag，支持 [正则匹配](https://cloud.tencent.com/document/product/1141/41945#.E7.9B.B8.E5.85.B3.E6.93.8D.E4.BD.9C)。如需所有版本均可触发，可不填写。
