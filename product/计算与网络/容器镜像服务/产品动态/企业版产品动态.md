...
<table>
	...
	<tr><td>镜像构建功能新增多个代码源支持</td><td>新增支持私有GitLab，腾讯工蜂代码源支持，并优化了代码源授权流程</td><td><a href="https://cloud.tencent.com/document/product/1141/45762">配置镜像构建</a></td></tr>
...
<table>
	<tr><th style="width: 25%;">动态名称</th><th style="width: 50%;">动态描述</th><th style="width: 25%;">相关文档</th></tr>
	<tr><td>新增镜像版本保留功能</td><td>支持定义命名空间内镜像版本自动清理规则，可定期执行，清理历史镜像版本</td><td><a href="https://cloud.tencent.com/document/product/1141/48184">配置镜像版本保留</a></td></tr>
</table>
