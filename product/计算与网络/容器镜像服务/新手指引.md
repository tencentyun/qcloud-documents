...
- **容器镜像服务如何实现监控与告警？**
容器镜像服务暂不支持告警功能。容器镜像服务企业版支持对托管的容器镜像进行安全扫描、生成扫描报告、暴露容器镜像内潜在的安全漏洞，并提供修复建议，可有效降低生产环境漏洞风险。详情请参见 [容器镜像安全扫描](https://cloud.tencent.com/document/product/1141/48185)。
