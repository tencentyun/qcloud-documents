## 概述
容器镜像服务 TCR 同时向企业客户及个人用户提供容器镜像托管分发服务，其中个人版为用户提供简单，免费的基础服务，即当前容器服务 TKE 内的镜像仓库。为向客户提供接口定义更加规范，访问时延下降显著的 API 接口服务，原有个人版镜像仓库 (CCR）的 API 接口已由 2.0 版本升级至最新的 3.0 版本，接口名称及授权方案也发生了相应变更。本指南介绍了 API 升级后新旧接口映射关系及如何使用最新的授权方案。
