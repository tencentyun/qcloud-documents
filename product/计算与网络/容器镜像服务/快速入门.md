...
您可在“[实例列表](https://console.cloud.tencent.com/tcr/instance)”页面查看实例的创建进度，预计1分钟完成创建。
...
### 公网访问
1. 在“[公网访问](https://console.cloud.tencent.com/tcr/publicaccess)”页面上方，选择需要配置公网访问策略的实例。
...
### 内网访问
1. 在“[内网访问](https://console.cloud.tencent.com/tcr/privateaccess)”页面上方，选择需配置内网访问策略的实例。
...
## 步骤4：创建镜像仓库
1. 选择左侧导航栏中的【[命名空间](https://console.cloud.tencent.com/tcr/namespace)】，进入“命名空间”列表页面。
...
4. 单击左侧导航栏中的【[镜像仓库](https://console.cloud.tencent.com/tcr/repository)】，进入“镜像仓库”列表页面。
...
### 登录 Registry 实例
1. 选择左侧导航栏的【[实例列表](https://console.cloud.tencent.com/tcr/instance)】，单击实例名进入实例管理页面。
