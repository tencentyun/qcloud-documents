...
## 步骤2：进行线上申请[](id:Step2)
目前云托付物理服务器 CHC 处于邀测阶段，使用前请进行 [试用申请](https://cloud.tencent.com/apply/p/6boipokjrin)。您的申请预计将在3个工作日内完成审核，届时将通过短信、站内信及邮件的方式通知您审核结果，请注意查收。如通过审核，售前工程师将联系您进行商务洽谈。

## 步骤3：线下入场评估[](id:Step3)
使用 CHC 还需通过 [联系我们](https://cloud.tencent.com/document/product/1448/60712)  进行服务器线下入场评估。入场评估完成后可邮寄服务器至机房，验收后即可申请服务器上架。
...
3. 单击**确定**即可完成配置。此时 CHC 物理服务器状态为“可生产”。


## 步骤6：申请 CHC 物理服务器上电[](id:Step6)
请通过 [联系我们](https://cloud.tencent.com/act/event/connect-service) 通过线下给状态为“可生产”的 CHC 物理服务器进行上电。

## 步骤7：登录 CHC 物理服务器带外网络（可选）[](id:Step7)
CHC 物理服务器带外网络不支持外网访问，完成上电后可使用同私有网络内的云服务器、黑石服务器2.0，通过 SSH 登录至 CHC 物理服务器带外网络。详情请参见 [使用 SSH 登录 Linux 实例](https://cloud.tencent.com/document/product/213/35700)。

## 步骤8：创建 CHC 云服务器[](id:Step8)
在 “CHC物理服务器”页面中，状态度“可生产”的 CHC 物理服务器可创建 CHC 云服务器，及配置带外网络。步骤如下：
1.  单击 CHC 所在行右侧的**生产**。
