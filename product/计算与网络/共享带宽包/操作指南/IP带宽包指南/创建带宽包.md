本文将为宽带上移账户的用户介绍，如何创建 IP 带宽包。
>? 
>- 目前共享带宽包处于内测阶段，如需使用，请提交 [内测申请](https://cloud.tencent.com/apply/p/8o8lmsr5nj8)。
>- 带宽上移账户仅能创建 IP 带宽包，账户类型判断方式详情请见 [ 区分账户类型](https://cloud.tencent.com/document/product/684/39903)。
>- 非带宽上移账户可以提 [工单申请](https://console.cloud.tencent.com/workorder/category) 修改账户类型为带宽上移类型，以使用 IP 带宽包。
