...
>?目前传统帐户类型共享带宽包处于内测阶段，如需使用，请联系商务经理申请。标准账户类型支持多种 [共享带宽包计费模式](https://cloud.tencent.com/document/product/684/15255)，您可参考 [账户类型说明](https://cloud.tencent.com/document/product/1199/49090#judge) 进行升级。
>
