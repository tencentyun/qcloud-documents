...
## 新建带宽包
1. 在共享带宽包控制台，单击左上角的【+新建】。
2. 选择您需要计费模式，如需使用月95计费需要 [提交申请](https://cloud.tencent.com/act/apply/bwp)。
![](https://main.qcloudimg.com/raw/2d0966c69870a60533306981211d5a0f.png)
 
## 添加 IP
1. 单击共享带宽包 ID 进入详情页。
2. 单击【+添加资源】，在弹框中选择您需要添加的 EIP 并确认操作。
...
2. 在操作拦下，选择【更多】>【绑定】，在弹窗中选择需要绑定的设备并确认操作。

## 将设备移出带宽包
1. 单击共享带宽包 ID 进入详情页。
2. 选中需要移出共享带宽包的 EIP，单击【移出资源】。
