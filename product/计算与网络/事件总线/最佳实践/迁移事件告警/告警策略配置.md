...
### 4. 测试配置结果
配置完成后，回到事件集控制台，选择刚刚已绑定的事件集，点击「发送事件」，可以选择刚刚已绑定的事件规则模版，点击「发送」进行测试。
>! 注意：测试模版里只展示`data`字段里的内容，其它字段已固定，无法自定义修改

![](https://qcloudimg.tencent-cloud.cn/raw/00b0e2b28b8f78cc08697b0b97609cbc.png)
![](https://qcloudimg.tencent-cloud.cn/raw/d3205b0868ce7a792a5ccfde5f78c74f.png)
