...
2. 策略将以产品维度进行迁移，如下图所示，完成迁移后，用户账号下该产品**所有资源**都将默认配置告警，如果希望对指定资源进行告警，您可以手动调整告警规则，参考 [告警策略配置](https://cloud.tencent.com/document/product/1359/64706)。
...
>? 当前仅在**广州**地域支持一键迁移，子账号使用前，确保主账号已将 CAMFullAccess、EBFullAccess、SCFFullAccess、CLSFullAccess 权限赋予子账号，保证可以正常迁移使用。
>
