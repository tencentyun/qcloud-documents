...
2. 填写事件集名称与事件集描述： 
![](https://qcloudimg.tencent-cloud.cn/raw/07498ed75cfd1d79dcb59dcf38e64b5d.png)
3. 单击**确定**后完成创建。


### 步骤2. 创建事件连接器
1. 在事件集页单击自定义事件集名称，进入事件集详情页。
![](https://qcloudimg.tencent-cloud.cn/raw/9a7cb86d2a8458d5518ebf96d7875afe.png)
...
3. 根据页面提示填写相关信息：
![](https://qcloudimg.tencent-cloud.cn/raw/7e4fa31da9b71746b10c6bcf8c6eec87.png)
该事件模式的含义是，接收所有来自 Ckafka 连接器的消息。事件模式的具体编写方法，请参见 [事件模式](https://cloud.tencent.com/document/product/1359/56084)。
...
### 步骤5. 追踪历史投递事件
事件总线为用户提供了事件追踪能力，开启 [事件追踪](https://cloud.tencent.com/document/product/1359/72371) 后，在事件集的事件查询页可以查看事件投递记录。
![](https://qcloudimg.tencent-cloud.cn/raw/2f83a13944f6e06c7320a99a66a0b165.png)


事件追踪方式若选择“默认投递”，将仅能查询匹配成功但投递到下游失败的事件。若需查询全部事件，请在“事件集-事件追踪”中将投递类型设置为**全部日志**，并勾选“同时上报规则匹配失败日志”。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/33460bc5b9f379bf55966db82f090ff7.png)
