...
![](https://qcloudimg.tencent-cloud.cn/raw/34a171fb2e03a811502993aa9446f28c.png)
...
3. 根据页面提示填写相关信息：
![](https://qcloudimg.tencent-cloud.cn/raw/0431a123f1bc14b4c1d650a9a3170f0f.png)
...
### 5. 追踪历史投递事件
事件总线为用户提供了事件追踪能力，开启「事件追踪」后，在事件集的「事件查询」页可以看到事件投递记录。

![](https://qcloudimg.tencent-cloud.cn/raw/f6b371d16a547f9b3e365edfc87f6f19.png)

事件追踪方式若选择「默认投递」，将仅能查询匹配成功但投递到下游失败的事件。若需查询全部事件，请在「事件集-事件追踪」中进行如下图配置：
