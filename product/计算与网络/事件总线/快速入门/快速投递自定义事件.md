...
3. 根据页面提示填写相关信息：
![](https://qcloudimg.tencent-cloud.cn/raw/643dc16e5f9861efc1c35eee1e2d9815.png)
该事件模式的含义是，接收所有来自 TDMQ 连接器的消息。事件模式的具体编写方法，请参见 [事件模式](https://cloud.tencent.com/document/product/1359/56084)。
