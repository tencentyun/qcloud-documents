...
> ! 普通公网 IP 转换成弹性公网 IP 后，建议您立即释放，否则，未绑定实例的弹性公网 IP 将会收取一定 [IP 资源费用](https://cloud.tencent.com/document/product/213/17156#ip-.E8.B5.84.E6.BA.90.E8.B4.B9.E7.94.A8)。 

### 能否找回之前使用的公网 IP？能否申请指定的弹性公网 IP？
- 公网 IP 释放后不能找回。
- 支持找回您使用过、且当前未分配给其它用户的弹性公网 IP，详情请参见 [找回公网 IP 地址](https://cloud.tencent.com/document/product/1199/41708)。
