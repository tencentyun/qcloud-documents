...
>- 辅助 CIDR 限制请参见 [限制说明](https://cloud.tencent.com/document/product/215/36514)。
>
1. 登录 [私有网络控制台](https://console.cloud.tencent.com/vpc)。
2. 在列表上方，选择需创建辅助 CIDR 的私有网络所在地域。
3. 在列表中，找到需创建辅助 CIDR 的私有网络所在行，单击操作栏下的【编辑 CIDR】。
4. 在弹框的 IPv4 CIDR 中，单击【添加】，填写需要添加辅助 CIDR 并确认操作即可。
...
>
1. 登录 [私有网络控制台](https://console.cloud.tencent.com/vpc)。
2. 在列表上方，选择需删除辅助 CIDR 的私有网络所在地域。
