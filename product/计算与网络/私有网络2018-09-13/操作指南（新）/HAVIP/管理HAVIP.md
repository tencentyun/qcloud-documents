...
如 keepalived 方案下，在 keepalived.conf 中指定 virtual_address，具体请参见最佳实践 [VPC 内通过 keepalived 搭建高可用主备集群](https://cloud.tencent.com/document/product/215/20186)。如果是其他方案，在对应的配置文件中指定 virtual IP 为 HAVIP 即可。
