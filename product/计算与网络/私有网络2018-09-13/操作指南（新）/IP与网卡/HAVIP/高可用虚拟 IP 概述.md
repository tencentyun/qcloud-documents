...
>- 为保证主备集群云服务器的高可用性，强烈建议通过 [置放群组](https://cloud.tencent.com/document/product/213/15486) 将不同云服务器分配到不同的宿主机上，更多关于置放群组的信息，请参见 [置放群组](https://cloud.tencent.com/document/product/213/15486)。
>- 高可用软件需要支持发送 ARP 报文。
>
