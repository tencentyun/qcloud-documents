[弹性公网 IP（EIP）](https://cloud.tencent.com/document/product/1199)，简称弹性 IP 地址或弹性 IP。它是专为动态云计算设计的静态 IP 地址，是某地域下一个固定不变的公网 IP 地址。借助弹性公网 IP，您可以快速将地址重新映射到账户中的另一个 CVM 实例或 NAT 网关实例，从而屏蔽实例故障。
