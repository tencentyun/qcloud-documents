...
- 若需要实现多个支持 EFI 的实例间通信，请保证不同实例的 EFI 弹性网卡在同 vpc 同子网内。
  ...
  <img style="width:850px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/da433af559635f216c064c74c8d2d9bf.png" />
...
- 私有网络控制台创建后绑定。
  ...
  iv. 在弹窗中输入名称，选择辅助弹性网卡的所属私有网络、子网后，为网卡分配 IP，打开**弹性 RDMA 接口**开关。   
	 ...
	 <img style="width:850px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/d907dd8c2625d1c1cbebb5f3a7b90412.png" />
...
- 若需要实现多个支持 EFI 的实例间通信，请保证不同实例的 EFI 弹性网卡在同 vpc 同子网内。
  ...
  <img style="width:850px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/883f7131ae7b8c0f36969a7ca16c1c23.png" />
...
sh install.sh
 ...
 - 当出现如下信息时，表示安装成功。                
  <img style="width:850px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/dfaf630688c7f409424b982d992fdbe0.png" />
