...
### NAT 网关
[NAT网关（NAT Gateway）](https://cloud.tencent.com/document/product/215/20079) 提供网络地址转换功能（Network Address Translation），在内外网隔离时，将私有网络中内网 IP 地址和公网 IP 地址进行转换，实现私有网络访问 Internet 功能。NAT 网关支持最大满足5Gbps 突增流量和1000W并发连接数。同时作为高可用网关，NAT 网关实现了双机热备，单机出故障自动切换，业务无感知。
