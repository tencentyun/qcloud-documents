...
## 操作步骤
### 操作概述
设置 EIP 直通后，需要在操作系统内将 IP 加到网卡上，然后根据业务需求配置操作系统内的路由。针对典型场景，我们提供了脚本，详细方法如下。
...
3. 找到对应的 EIP 所在行，在右侧操作栏中，单击【更多】>【直通】即可。
...
>
2. 登录 [云服务器控制台](https://console.cloud.tencent.com/cvm/overview)。
3. 在左侧目录中，单击【弹性公网 IP】，进入管理页面。
4. 找到对应主网卡绑定的 EIP 所在行，在右侧操作栏中，单击【更多】>【直通】即可。
...
7. 在“Internet 协议版本4（TCP/IPv4）属性”弹窗中，配置弹性公网 IP 作为静态 IP 地址，示例如下：
 - IP 地址：193.112.18.146 （主网卡上已绑定公网 IP）
