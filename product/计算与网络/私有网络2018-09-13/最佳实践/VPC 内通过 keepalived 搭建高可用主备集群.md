...
## 注意事项
+ 推荐使用单播方式进行 VRRP 通信。
>?如果使用组播方式进行 VRRP 通信，需提单 [组播内测申请](https://cloud.tencent.com/apply/p/rkx852nifjh)，待内测申请通过后参考 [开启或关闭组播功能](https://cloud.tencent.com/document/product/215/53428) 打开 VPC 组播开关；同时在 keepalived 配置文件中**不配置** unicast_peer。
>
