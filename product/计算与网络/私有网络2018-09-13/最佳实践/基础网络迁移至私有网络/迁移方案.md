...
>
2. 在VPC内新建内网CLB（注意：当前新建的CLB都是应用型与传统型有所差异，详情请参见 [购买负载均衡实例](https://cloud.tencent.com/document/product/214/30692)），通过 API 的方式可以指定内网 CLB 的 VIP（可参见 [购买负载均衡实例](https://cloud.tencent.com/document/product/214/30692)）并配置好对应的监听器和规则。
3. 业务停服。
