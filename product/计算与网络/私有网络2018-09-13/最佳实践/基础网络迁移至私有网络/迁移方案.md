本文主要介绍单实例从 [基础网络](https://cloud.tencent.com/document/product/215/58039) 迁移到 [私有网络](https://cloud.tencent.com/document/product/215/20046) 的网络切换方案、以及迁移过程中混访处理方案。
>? 迁移前提是需要有私有网络，如果没有私有网络，请提前创建 [私有网络](https://cloud.tencent.com/document/product/215/36515)。
