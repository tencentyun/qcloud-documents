...
2. 参见 [更换 MySQL 的网络](https://cloud.tencent.com/document/product/236/35671) 和 [更换 Redis 的网络](https://cloud.tencent.com/document/product/239/30910?from=10680#.E6.9B.B4.E6.8D.A2-redis-.E7.BD.91.E7.BB.9C) 切换数据库网络。云数据库在网络切换时连接不中断，且切换后同时保持原基础网络和新 VPC 网络 IP，可确保迁移后不停服，在原有基础网络的访问的最长保持时间内，完成其他产品的迁移。
...
5. 为确保业务平滑切换，可直接切换 DNS IP 到 VPC 中公网 CLB 的公网地址。
