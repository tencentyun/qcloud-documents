...
- 1 个基础网络云服务器同一时间只能关联 1 个私有网络。
- 1 个私有网络最多支持关联 100 台基础网络云服务器。
...
## 操作指南
使用基础网络互通以及与其相关的产品的常用操作，请参见 [操作总览](https://cloud.tencent.com/document/product/215/20155)。
