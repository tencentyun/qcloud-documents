...
- 目的端
目的网段描述（仅支持网段格式，如果希望目的端为单个 IP，可设置掩码为 32（如：172.16.1.1/32），目的端 **不能** 为路由表所在私有网络内的 IP 段，原因是 Local 路由已表示此私有网络内默认内网互通。
- 下一跳类型
...
## 计费方式
路由表的创建和使用完全免费。更多私有网络价格信息，请参见 [计费概述](https://cloud.tencent.com/document/product/215/20096)。

## 操作指南
控制台操作详情，请参见 [操作总览](https://cloud.tencent.com/document/product/215/20132)。
