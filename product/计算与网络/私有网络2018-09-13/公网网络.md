...
### 计费示例
按带宽使用时长计费模式下，假设用户在中国香港使用公网网络，在07:00:00 - 07:59:59内，设置的带宽峰值为15Mbps，则费用分为两部分计算：小于等于5Mbps部分的费用 = 0.08元/Mbps/小时 ×  5Mbps = 0.4（元），大于5Mbps部分的费用 =  0.25元/Mbps/小时 × 10Mbps = 2.5（元）；总费用 = 0.4 + 2.5 =2.9（元）
