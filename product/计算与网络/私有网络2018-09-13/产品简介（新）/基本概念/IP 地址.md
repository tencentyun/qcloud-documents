...
## IPv6 地址
腾讯云的 IPv6 地址，可同时作为内网 IPv6 地址和公网 IPv6 地址，默认情况下是内网 IPv6 地址，当需要开通公网能力时，将该内网IPv6地址变更为公网 IPv6 地址，可参考[ 管理 IPv6 公网](https://cloud.tencent.com/document/product/1142/38141)。如果您不主动做释放、重新分配操作，该 IPv6 地址不会改变。
