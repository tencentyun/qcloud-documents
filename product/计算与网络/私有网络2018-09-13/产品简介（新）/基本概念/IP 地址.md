腾讯云有两类 IP 地址，内网 IP 地址和公网 IP 地址。如果您不主动做解绑、更换操作，内网 IP 和公网 IP 都不会改变。


## 内网 IP 地址
内网 IP 地址是腾讯云内网服务的实现形式，无法通过 Internet 访问。每个云服务器实例一经创建即被分配一个内网 IP 地址，内网 IP 地址可由系统自动分配，在私有网络环境下，内网 IP 地址也可由用户自定义。
...
### 适用场景
内网 IP 适用于如下场景：
- 同一私有网络或基础网络下，负载均衡与云服务器实例之间内网互访。
- 同一私有网络或基础网络下，云服务器实例之间内网互访。
- 同一私有网络或基础网络下，云服务器实例与其他云服务（如 TencentDB）之间内网互访。
...
## 公网 IP 地址
公网 IP 地址分为两类：普通公网 IP 和弹性公网 IP，均可以为云服务器提供访问公网和被公网访问的能力。
### 主要区别
...
### 计费说明
腾讯云对使用公网 IP 地址访问公网产生的公网网络流量，将收取公网网络费用，详情请参见 [公网网络计费](https://buy.cloud.tencent.com/price/idc)。
