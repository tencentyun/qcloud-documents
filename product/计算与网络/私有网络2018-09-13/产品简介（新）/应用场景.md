...
##  部署弹性混合云
您可以在私有网络内，部署应用程序，在本地数据中心，部署数据库。私有网络提供稳定安全的 [VPN 连接](https://cloud.tencent.com/document/product/554) / [专线接入](https://cloud.tencent.com/document/product/216) 服务，帮您打通本地数据中心与云端资源；您可使用 [弹性伸缩](https://cloud.tencent.com/doc/product/377) 服务，根据业务量扩展应用程序的资源（云服务器等），降低 IT 运维成本，防止核心数据外泄，轻松实现弹性混合云部署。
