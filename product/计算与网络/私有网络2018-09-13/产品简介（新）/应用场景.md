...
## 托管多层 Web 应用
私有网络在为应用提供 Internet 服务的同时，保障数据库的安全。您可以通过在私有网络中创建不同的子网，子网和子网间流量通过网络 ACL 控制，实现安全灵活地托管多层 Web 应用。
以下图场景为例，在创建私有网络后：
- 将整个 Web 层放在一个子网，并通过  [NAT 网关](https://cloud.tencent.com/document/product/552)  / [弹性公网 IP](https://cloud.tencent.com/document/product/213/5733) / [负载均衡](https://cloud.tencent.com/document/product/214) 与 Internet 通信。
