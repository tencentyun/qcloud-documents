...
2) Cross-region peering connection (the cross-region interconnection) is paid by the peering connection initiator. It supports two billing methods:

- Billing of daily peak
- Billing of monthly 95th percentile peak (It is under internal trial. Submit a ticket to apply for it.)

Billing of daily peak

**Calculation Method:** Daily fees = Peak bandwidth of the day x Applicable tiered price.

- Billing period & Calculation period: Daily
- Billing method: Postpaid on a daily basis

> Note: Peak bandwidth of the day is calculated as this: bandwidth is captured once every 5 minutes, and the maximum one out of both inbound and outbound bandwidth of that day is taken as the peak bandwidth.

**Price**: Please see the following table


<table>
        <tbody>
				<tr>
            <th style="width: 10%;" rowspan="2">Features</th>
            ...
            <th>Beijing<br>Chengdu<br>Shanghai<br>Shanghai Finance Zone<br>Guangzhou<br>Shenzhen Finance Zone</th>
						<th>Hong Kong</th>
						<th>Singapore<br>Silicon Valley<br>South Korea<br>Frankfurt</th>
            <th>Toronto</th>
        </tr>
				<tr>
        <td>Intra-region Peering Connection</td>
            ...
            <td rowspan="5">Cross-region Peering Connection</td>
						<td rowspan="5">Peak bandwidth of the day<br><br>Charged on a daily basis (CNY/Mbps/day)<br><br>Peak bandwidth is calculated using the average bandwidth per 5 minutes<br></td>
						<td>(0 , 20] Mbps</td>
						<td>20</td>
						<td>-</td>
						<td>-</td>
...
**An example of the billing of daily peak**
If the initiator and receiver of a peering connection locate in Shanghai and Guangzhou respectively, and the outbound and inbound peak bandwidth of the day are 20 Mbps and 30 Mbps respectively, the cost of the day is: 30*12=360 CNY, which shall be paid by the initiator.

#### Billing of monthly 95th percentile peak


**Calculation Method:**Monthly fees = Peak bandwidth of Monthly 95th Percentile x Proportion of effective days x Tiered price

- Billing period & Calculation period: Monthly
- Billing method: Postpaid on a monthly basis

**1. Peak bandwidth of Monthly 95th Percentile**

It is calculated on the basis of a calendar month. In a calendar month, sort the averages of bandwidth ( __the maximum average inbound/outbound bandwidth__ ) in every 5 minutes for all effective days (generating consumption) in descending order and eliminate the first 5% statistical points. Then take the largest bandwidth among the remaining 95% of statistical points as the peak bandwidth of Monthly 95th Percentile.

**2. Proportion of effective days**
Proportion of effective days = Number of effective days / Number of calendar days of this month

>Note: __Number of effective days is__ the number of days on which the consumption generated is greater than 1 Kbps from the settlement date of last month (the date when the service is created) to the settlement date of this month.

**Price:** For more information on the price of the interconnection within Mainland China, please see the following table:

| Specification (Mbps) | Price for Mainland China (CNY/Mbps/Month) |
|---------|---------|
| 0-10 | 550 |
| 10-20 |	410 |
| 20-50 |	290 |
...
> Note: Contact business department to inquire more about the prices.

##### An example of the billing of monthly 95th percentile peak
The billing process starts on February 1, 2017. The contract price is P CNY/Mbps/month.
Assume that the bandwidth consumption generated is more than 1 Kbps for 14 days in February, calculate all statistical points for these 14 days (14 * 288) and eliminate the first 5% statistical points. Then take the largest value among the remaining statistical points as the billing bandwidth, which is Max95. The charge billed in February is: Max95 x P x 14 / 28.




### Free Cross-region Interconnection Bandwidth Campaign
> **Price concession is available only to the billing of daily peak**, and is **unavailable** to the billing of monthly 95th percentile in view of its sharp price concession.

Benefits for VIP customers and common customers during the campaign are as follows (VIP customers are entitled to its benefits by default, but it is no longer available to common customers):
...
> Note:
- It takes effect on the day the bandwidth remission is approved upon review. The bandwidth beyond the free quota is billed based on tiered prices. This is valid until 3/31/2018. You can view the remission details in the pop-up window for the creation of peering connection or in the details page.
- If you consume more than 100,000 CNY in Tencent Cloud within a month, you can apply to become a VIP customer who is entitled to the supreme service and related benefits. [Apply Now >>](https://cloud.tencent.com/service/vip.html)
