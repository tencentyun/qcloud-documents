流日志功能需要将采集的日志数据上报到日志服务 CLS，因此需要赋予访问 CLS 的读写权限，否则将无法查询到日志数据。本文指导您如何配置流日志功能访问 CLS 的资源访问权限。
...
5. 在“配置角色策略”界面，输入“日志服务”进行检索，勾选“QcloudCLSFullAccess”，赋予流日志公共账户访问 CLS 的读写权限，单击“下一步”。
