...
<dx-tabs>
::: 云联网跨地域流量的网络流日志记录
流日志将记录特定捕获窗口中，按“五元组+流量源地域+流量目的地域”规则过滤的网络流，即只有在捕获窗口中符合规则的网络流日志才能记录为云联网跨地域流量的网络流日志记录。
...
|ccnid | 云联网唯一标识，如需确定云联网的信息请提交 [工单申请](https://console.cloud.tencent.com/workorder/category)。 |
