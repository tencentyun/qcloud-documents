...
1. 已 [注册腾讯云账号](https://cloud.tencent.com/register?s_url=https%3A%2F%2Fcloud.tencent.com%2F) 并 [完成实名认证](https://console.cloud.tencent.com/developer/auth)。
2. 网络环境打通：
...
### 创建私有网络 VPC[](id:createVPC) （自建数据库可跳过此步骤）
