...
>注意：
部分触发器传递的入参事件结构目前已有一部分已定义，可直接使用。可通过 [cloud event 定义](https://github.com/tencentyun/scf-java-libs)获取 java 的库并使用。如果使用过程中发现问题，可以通过[提交 issue ](https://github.com/tencentyun/scf-java-libs/issues/new)或提交工单说明。
