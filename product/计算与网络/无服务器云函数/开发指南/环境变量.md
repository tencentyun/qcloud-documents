...
| `HOSTNAME`  |	{host id}  |
|`OS_NAMESERVER` |自定义，使用方法请参见 [VPC 网络中的 Name server 配置](https://cloud.tencent.com/document/product/583/19703#vpc-.E7.BD.91.E7.BB.9C.E4.B8.AD.E7.9A.84-name-server-.E9.85.8D.E7.BD.AE) |
