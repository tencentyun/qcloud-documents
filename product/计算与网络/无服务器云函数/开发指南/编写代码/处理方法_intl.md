...
Create a SCF, paste the code above and set the execution method to `index.handler`. After creation, click the **Test** button and run it to see the returned message. For more information on how to create a function, please see [Step 1: Create Hello World function](https://cloud.tencent.com/document/product/583/9204).
