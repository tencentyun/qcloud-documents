...
云函数镜像基于 Centos 7.7.1908版本，目前已公开在腾讯云容器服务 [公有镜像](https://console.cloud.tencent.com/tke2/registry/qcloud)。您可以通过 `scf-repo` 命令 [查看镜像信息](https://console.cloud.tencent.com/tke2/registry/qcloud/default/detail/tag?rid=8&reponame=scf-repo%252Fscf-runtimes-image)。
