...
4. 将函数代码及依赖库一同压缩为 zip 包，在 [Serverless 控制台](https://console.cloud.tencent.com/scf) 中上传打包的 zip 包并创建一个新函数。操作步骤如下：
   ...
   3. 在“新建函数”页面，填写函数基本信息。如下图所示： 
      ![](https://qcloudimg.tencent-cloud.cn/raw/dad9cbccf8c09715e61d1aaadd0d8596.png)
...
4. 将函数代码及依赖库一同压缩为 zip 包，在 [Serverless 控制台](https://console.cloud.tencent.com/scf) 中上传打包的 zip 包并创建一个新函数。操作步骤如下：
   ...
   2. 在主界面上方选择期望创建函数的地域，并单击**新建**，进入函数创建流程。
   3. 在“新建函数”页面，填写函数基本信息。如下图所示： 
      ![](https://qcloudimg.tencent-cloud.cn/raw/6d5985392f7dd750f5f57f2a6cbd563a.png)
      - **创建方式**：选择使用**从头开始**来新建函数。
      - **运行环境**：选择**Python 3.6**。
      - **提交方法**：选择**本地上传zip包**。
   4. 单击**完成**即可创建函数。
...
5. 将函数代码及依赖库一同压缩为 zip 包，在 [Serverless 控制台](https://console.cloud.tencent.com/scf) 中上传打包的 zip 包并创建一个新函数。操作步骤如下：
   ...
   2. 在主界面上方选择期望创建函数的地域，并单击**新建**，进入函数创建流程。
   3. 在“新建函数”页面，填写函数基本信息。如下图所示： 
      ![](https://qcloudimg.tencent-cloud.cn/raw/50a9e9a6a2c2c9a28bd6cddcfd598f27.png)
    - **创建方式**：选择使用**从头开始**来新建函数。
    - **运行环境**：选择**Php7.2**。
    - **提交方法**：选择**本地上传zip包**。
   4. 单击**完成**即可创建函数。
...
6. 将函数代码及依赖库一同压缩为 zip 包，在 [Serverless 控制台](https://console.cloud.tencent.com/scf) 中上传打包的 zip 包并创建一个新函数。操作步骤如下：
     ...
     2. 在主界面上方选择期望创建函数的地域，并单击**新建**，进入函数创建流程。
     3. 在“新建函数”页面，填写函数基本信息。如下图所示： 
      ![](https://qcloudimg.tencent-cloud.cn/raw/2300768d2586a52cbc67adbb57211bc3.png)
          - **创建方式**：选择使用**从头开始**来新建函数。
          - **运行环境**：选择**Php7.2**。
          - **提交方法**：选择**本地上传zip包**。
     4. 单击**完成**即可创建函数。
...
4. 将函数代码及依赖库一同压缩为 jar 包，在 [Serverless 控制台](https://console.cloud.tencent.com/scf) 中上传打包的 jar 包并创建一个新函数。操作步骤如下：
   ...
   2. 在主界面上方选择期望创建函数的地域，并单击**新建**，进入函数创建流程。
   3. 在“新建函数”页面，填写函数基本信息。如下图所示： 
      ![](https://qcloudimg.tencent-cloud.cn/raw/edc0397bdbc317a0cc735115c497c622.png)
      - **创建方式**：选择使用**从头开始**来新建函数。
      - **运行环境**：选择**Java8**。
      - **提交方法**：选择**本地上传zip包**。
   4. 单击**完成**即可创建函数。
