...
- **初始化阶段**
关于初始化阶段详细信息，请查阅 [函数初始化](https://cloud.tencent.com/document/product/583/47274#.E5.87.BD.E6.95.B0.E5.88.9D.E5.A7.8B.E5.8C.96)。其中，由于 Custom Runtime 由开发者使用自定义语言及版本实现，需要通过标准协议与 SCF 进行通信，本实例中 SCF 通过 HTTP 协议提供运行时 API 及内置环境变量，更多关于环境变量信息请参见 [环境变量](https://cloud.tencent.com/document/product/583/30228)。
