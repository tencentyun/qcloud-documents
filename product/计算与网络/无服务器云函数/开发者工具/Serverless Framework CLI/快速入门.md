本教程为您介绍了如何使用Serverless Framework SCF组件快速创建与部署一个SCF项目，更多组件与最佳实践，您可以通过[查看Serverless Framework官方文档](https://cloud.tencent.com/document/product/1154/39270) 进行了解
