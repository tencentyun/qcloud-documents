...
Malagu 是基于 TypeScript 的 Serverless First、组件化、平台无关的渐进式应用框架，又叫 M 框架。使用同一套编程语言和 IoC 设计，用于开发前端、后端和前后端一体化应用。并且结合了 OOP（面向对象编程）、AOP（面向切面编程）等元素，借鉴了很多 Spring Boot 设计思想。
...
点击查看[Malagu 官方文档](https://www.yuque.com/cellbang/malagu)。

## 二、Malagu 架构图

![](https://cdn.nlark.com/yuque/0/2020/svg/365432/1608730016126-88060e22-4e70-46c4-aa98-ac55d802b3f2.svg)
