...
## 配置规范
当前插件使用的是 Serverless Cloud Framework 中 tencent-componet 的语法规范，具体语法规范可参见 [说明文档](https://github.com/serverless-components/tencent-scf/blob/master/docs/configure.md)。
