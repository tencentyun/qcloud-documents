...
3. 单击左侧导航栏<img src="https://main.qcloudimg.com/raw/082978e83344b2921a42958f644ceec7.png" style="margin:-3px 0;">（或 ctrl+shift+D），新建调试配置文件，并**选择`SCF Debugger For Node` 或者 `SCF Debugger For Python`调试模板**。如下图所示：
