...
## 云函数 SCF 组件
通过使用 Serverless Framework 的云函数 SCF 组件，您可快速打包部署您的云函数项目。
- 您可通过 [函数操作](https://cloud.tencent.com/document/product/583/45352)，快速上手 Serverless Framework CLI。
- 您可通过 [开发调试](https://cloud.tencent.com/document/product/583/44775)，了解 Serverless Framework 如何开发调试云函数。
- 您可通过 [项目应用](https://cloud.tencent.com/document/product/583/49855)，了解如何将多个云函数进行项目管理和资源编排。
