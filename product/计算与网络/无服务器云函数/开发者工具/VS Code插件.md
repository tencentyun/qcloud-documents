...
- SCF CLI：VS Code 插件借助于 [SCF 命令行工具](https://cloud.tencent.com/document/product/583/33445) 进行本地函数的创建，触发和调试。
...
3. 根据提示依次输入账号的 APPID，SecretId 及 SecretKey 信息，作为插件调用云API 时的认证信息。并在认证成功后，选择您希望部署函数的地域。配置信息获取途径如下：
...
>!**不同的 runtime 须选择对应的调试模板，即根据当前的调试文件类型，区分选择 Python 和 Node.js。**
>
![](https://main.qcloudimg.com/raw/1921d14f860df8c4895fff47a6c1ff7f.png)

5. 单击<img src="https://main.qcloudimg.com/raw/56499c05a2a66c9d011e40d504d57cc7.png" style="margin:-3px 0">，即可看到调试信息。如下图所示：
![](https://main.qcloudimg.com/raw/a41fbefae0657c1d793c26ac12732436.png)

### 函数部署
>?完成上述步骤后，可通过插件能力将函数一键部署到云端。
>
...
>
单击左侧列表中的远端函数名称，在右侧页面中单击【云端调用】，即可在页面中查看到函数在云端运行的相关信息。如下图所示：
