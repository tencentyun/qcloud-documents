...
- 支持查看云端函数运行状态，详情请参考 [运行状态教程](https://cloud.tencent.com/document/product/583/37852)。
- 支持配置多账号和账号间切换，详情请参考 [账号切换教程](https://cloud.tencent.com/document/product/583/37859)
