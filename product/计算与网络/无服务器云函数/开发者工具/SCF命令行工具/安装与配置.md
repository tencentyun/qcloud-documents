...
> !using-cos 是指在部署时是否通过 COS 部署，使用 COS 部署速度会快很多，建议开启该设置。在部署频次和包非常大时（如上万次部署或几 G 的包，详情可参考[COS 免费额度](https://cloud.tencent.com/document/product/436/6240)），可能会产生 COS 计费。
>
