...
| 参数       | 必填 | 描述                                                         | 示例           |
| ---------- | ---- | ------------------------------------------------------------ | -------------- |
| name       | 否   | 生成的项目名称。如果不填写，默认值为 demo。                  |--name  test           |
| runtime    | 否   | 生成的项目运行环境，可选值为 nodejs6.10、python2.7、nodejs 8.9、python3.6、php5、php7、go1。默认值为 python3.6。 | --runtime python2.7      |
| output-dir | 否   | 指定项目生成的目录，默认为当前目录。                         | --output-dir /root/scf/code |
