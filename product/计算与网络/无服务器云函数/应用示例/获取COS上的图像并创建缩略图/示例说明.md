...
- 源 Bucket 上的通知配置：将 SCF 函数和 COS Bucket绑定将在该 Bucket 的通知配置上添加新项，用来标识 COS 将触发函数的事件类型（文件创建/删除）及要调用的函数名称。有关 COS 通知功能的更多信息，请参阅 [PutBucketNotification](https://www.qcloud.com/document/product/436/8588) 接口。
