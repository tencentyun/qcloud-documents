...
1. 前往[对象存储控制台](https://console.qcloud.com/cos4/index)，选择`mybucket`，上传任意的 .jpg 或 .png 图片，一段时间后观察`mybucketresized`中是否有同名文件；
2. 您可以在[无服务器云函数控制台](https://console.qcloud.com/scf)中监控函数的活动，选择【日志】选项来查看函数被调用的日志记录。
