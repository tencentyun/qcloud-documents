...
当前在函数代码中通过简单的 echo，print 等输出的内容，将会在投递到日志服务时，记录在 `SCF_Message` 字段中。日志服务的字段说明可见 [索引说明](https://cloud.tencent.com/document/product/583/52644#.E7.B4.A2.E5.BC.95.E9.85.8D.E7.BD.AE)。
