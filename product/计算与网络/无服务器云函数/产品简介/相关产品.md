...
| [对象存储 COS](https://cloud.tencent.com/document/product/436) | 可以通过配置对象存储触发器，在对应的 Bucket 有事件产生时触发云函数。 |
...
| [访问管理 CAM](https://cloud.tencent.com/document/product/598) | 可以通过配置访问管理的角色，为云函数授予代码执行时访问授权资源的权限。 |
