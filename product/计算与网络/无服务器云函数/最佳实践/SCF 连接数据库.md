...
## 注意事项
由于云函数单实例同时处理的请求数均为1（[详情](https://cloud.tencent.com/document/product/583/9694#.E5.87.BD.E6.95.B0.E5.B9.B6.E5.8F.91.E9.87.8F)），以及为了防止连接数设置过大导致高并发下数据库连接耗尽，在使用连接池时，建议将最大连接数设置为1。
