...
2. 登录 [Serverless 控制台](https://console.cloud.tencent.com/scf)，进入**函数服务**页面。
...
6. 切换至 [Serverless 控制台](https://console.cloud.tencent.com/scf)，在**函数服务**页面，选择 `WebsocketTransmissionDemo-xxx` 函数，并切换至**运行日志**页签，查看云函数的执行结果。如下图所示： 
   ![](https://main.qcloudimg.com/raw/1bb434e358a263805cfed4d35f73dee0.png)
7. 切换至 websocketclient 页面，关闭其中一个页面。
8. 切换至 [Serverless 控制台](https://console.cloud.tencent.com/scf)，在**函数服务**页面，选择 `WebsocketDeleteDemo-xxx` 函数，并切换至**运行日志**页签，查看云函数的执行结果。如下图所示： 
