...
<span id="step2">2. 单击【服务】选项卡，并切换地域为【北京】。</span>
...
<span id="step7">7. 再次在【API管理】选项卡中单击【新建】创建 API，路径为 `/article/{articleId}`，请求方法为 GET，勾选上免鉴权，参数配置中输入名称为 `articleId` 的参数，参数位置为 Path，类型为 int，默认值为 1，单击【下一步】。</span>
