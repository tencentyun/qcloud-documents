...
1. 本地开发应用
   ...
   根据您实际业务场景，本地完成开发，详情可参考各个框架开发文档

2. 配置 yml 文件

   在项目根目录下，新建 `serverless.yml` 文件，按照以下示例进行配置编写，此处以全量配置请参考[文档](https://github.com/serverless-components/tencent-http/blob/master/docs/configure.md)
