...
1. 在本地创建待放置函数代码的文件夹，并在该目录下，执行以下命令安装文字识别 SDK：
```
...
5. 切换至 [无服务器云函数 SCF 的控制台](https://console.cloud.tencent.com/scf/list?rid=4)，将地域设置为 “上海”，并单击【新建】。
...
9. 上传已压缩的 zip 包，**将 “执行方法” 修改为：Word_Recognition.main_handler**，单击保存。如下图所示：
