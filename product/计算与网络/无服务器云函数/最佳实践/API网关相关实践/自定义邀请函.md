...
4. 单击【下一步】，函数名称默认填充，可根据需要自行修改。按照引导在“基础配置”中填入该模版需要的环境变量对应的值，其他保持默认配置，单击【完成】，完成函数和 API 网关触发器创建，如下图所示：
...
### 生成邀请函
您可通过以下两种方式，进行邀请函申请：
如下图所示，在【触发管理】页中获取 API 网关触发器访问路径，如下图所示：

![](https://main.qcloudimg.com/raw/2898bf6fab1c04133e17564d7332393a.png)
