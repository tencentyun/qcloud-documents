...
云函数的自定义镜像部署的说明及使用方法详情见 [使用镜像部署函数说明文档](https://cloud.tencent.com/document/product/583/56051)。


## 更多

除了可以使用自定义镜像构筑包含自定义字体文件的环境外，考虑到目前镜像构建仍有比较高的学习成本，云函数在后续也将扩展标准环境中的常用字体文件，同时也会进一步开放支持提交自定义文件，可关注此文档的后续更新介绍。
