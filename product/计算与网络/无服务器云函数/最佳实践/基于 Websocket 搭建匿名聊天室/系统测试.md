...
- 已保存【系统部署】>【配置 API 网关】>【[获取 Websocket 连接地址](https://cloud.tencent.com/document/product/583/32971#.E8.8E.B7.E5.8F.96-websocket-.E8.BF.9E.E6.8E.A5.E5.9C.B0.E5.9D.80)】中的 API 地址。
...
2. 登录 [无服务器云函数控制台](https://console.cloud.tencent.com/scf)，进入【函数服务】页面。
3. 选择 “ws_register” 函数，并切换至【运行日志】页签，查看云函数的执行结果。如下图所示：
...
7. 切换至 [无服务器云函数控制台](https://console.cloud.tencent.com/scf)，在【函数服务】页面，选择 “ws_transmission” 函数，并切换至【运行日志】页签，查看云函数的执行结果。如下图所示：
![](https://main.qcloudimg.com/raw/1bb434e358a263805cfed4d35f73dee0.png)
9. 切换至 websocketclient 页面，关闭其中一个页面。
10. 切换至 [无服务器云函数控制台](https://console.cloud.tencent.com/scf)，在【函数服务】页面，选择 “ws_delete” 函数，并切换至【运行日志】页签，查看云函数的执行结果。如下图所示：
![](https://main.qcloudimg.com/raw/8ada0522fb517c1c3d69716239fea704.png)
12. 切换至数据库管理，刷新数据库数据，查看数据库中记录的信息。如下所示，即可发现数据库管理已经删除一个 ConnectionID。
