...
>- 免费额度不包含 web 函数响应流量，web 函数计费方式参考[产品文档](https://cloud.tencent.com/document/product/583/66237)
...
>? 对于使用默认触发器的 Web 函数，会额外新增 Web 函数响应流量，具体计费方式参考[产品文档](https://cloud.tencent.com/document/product/583/66237)
...
Web 函数与事件型函数计费价格相同，详情请参阅 [产品定价说明](/document/product/583/12281)，对于使用默认触发器的 Web 函数，会额外新增 Web 函数响应流量，具体计费方式参考[ Web 函数计费说明](https://cloud.tencent.com/document/product/583/66237)
