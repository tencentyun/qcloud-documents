...
Click **Advanced Settings** -> **Environment Variable Configuration** -> **New Environment Variable** to add an environment variable input box.
...
Use limits on the environment variables of cloud function are as follows:
