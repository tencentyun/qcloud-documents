...
SCF 提供以下预设策略，用于授权访问 SCF 和其他关联资源，详情请参考 [用户策略更新说明](#Strategy)。SCF 会根据需要更新预设策略，以确保您有权限在 SCF 发布新功能后能够进行访问。同时，您也可以创建自定义策略来管理用户权限。
...
<table>
	...
	<tr>
	<td>QcloudSCFReadOnlyAccess</td><td>授予操作云函数和其他相关资源的只读访问权限</td>
	</tr>
</table>
