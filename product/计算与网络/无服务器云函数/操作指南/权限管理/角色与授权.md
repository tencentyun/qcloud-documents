...
cls:logset: 获取日志信息
cls:topic: 获取日志信息
monitor:DescribeSortObjectList: 获取函数监控信息
```
...
```bash
monitor:GetMonitorData: 获取函数监控信息
monitor:DescribeBasicAlarmList: 获取函数监控信息
cam:GetRole: 获取用户角色信息
cam:ListAttachedRolePolicies: 获取用户角色策略信息
vpc:DescribeVpcEx: 获取网络信息
vpc:DescribeSubnetEx: 获取网络信息
apigw:DescribeDomain: 获取网关信息 
cls:logset: 获取日志信息 
cls:topic: 获取日志信息 
```
