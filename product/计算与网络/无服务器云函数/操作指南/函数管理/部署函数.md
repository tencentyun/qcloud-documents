...
在使用 SCF 命令行前，可以通过 [命令行安装及配置](https://cloud.tencent.com/document/product/583/33449) 方法完成命令行的安装和配置。

执行 `scf deploy` 即可部署函数，部署函数详情[参考教程](<https://cloud.tencent.com/document/product/583/33451>)。