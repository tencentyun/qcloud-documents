...
>?在使用 Serverless Framework 命令行工具之前，请通过 [安装 Serverless Framework](https://cloud.tencent.com/document/product/583/44753) 完成安装。
>
您可通过 Serverless Framework 命令行，执行 `sls deploy` 命令部署函数。
