...
## 更多创建方式
您可根据实际需求，选择更多方式创建函数：
- 使用命令行工具，可以参考 [SCF 命令行工具快速开始](<https://cloud.tencent.com/document/product/583/33446>) 教程使用 SCF CLI 创建函数/调用/部署。
- 使用 VS Code ，您可以参考 [VS Code插件](<https://cloud.tencent.com/document/product/583/36208>) 教程使用 VS Code 插件创建函数/调试/部署。
