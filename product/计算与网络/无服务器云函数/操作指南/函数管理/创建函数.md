...
如果您习惯使用命令行工具，您可以参考以下教程使用 SCF CLI 创建函数/调用/部署：

- [SCF 命令行工具快速开始](<https://cloud.tencent.com/document/product/583/33446>)

如果您习惯使用 VS Code ，您可以参考以下教程使用 VS Code 插件创建函数/调试/部署：

- [VS Code 插件教程](<https://cloud.tencent.com/document/product/583/36208>)
