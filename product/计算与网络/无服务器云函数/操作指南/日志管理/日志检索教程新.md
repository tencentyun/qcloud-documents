...
> ! 
> - SCF 写入 CLS 的日志结构请参考[日志结构说明](https://cloud.tencent.com/document/product/583/60336)。
...
1. `TopicId` 为函数日志投递的 CLS 日志主题 ID，在需要查询日志的“函数配置”页面单击**日志主题**对应的链接。
...
> - SCF_Message 的值长度限制为 8KB，超出时将截取前 8KB。
