...
### 例子
1. 请将此仓库（https://github.com/tencentyun/scf_layer_demo）下载到本地，并解压。
![](https://main.qcloudimg.com/raw/348696e7e6e8351ab37fe0347fc43073.png)
2. 新建一个层。提交方法选择本地上传文件夹，并选择 layer 文件夹。运行环境选择 Node.js12.16。
![](https://main.qcloudimg.com/raw/52bb90e20d67578c85fce8b97c02eb4f.png)
3. 新建一个云函数。运行环境选择 Node.js12.16。创建方式选择空白函数。提交方法选择本地上传文件夹，并选择 function 文件夹。高级设置中层配置选择刚才创建的层和版本。
![](https://main.qcloudimg.com/raw/b33df41adc4cdfbc4a622aa7a2801fa3.png)
![](https://main.qcloudimg.com/raw/ebdc0d252e7a4e8ae4e7b2c54aa82704.png)
![](https://main.qcloudimg.com/raw/11fa6572225b691ec3d83d7976c3f5c8.png)
4. 在函数代码页面点击测试即可看到结果。
![](https://main.qcloudimg.com/raw/dfed2a8efdc22495503bb3347e8486bd.png)
