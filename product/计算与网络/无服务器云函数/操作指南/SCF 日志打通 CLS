...
2. 在页面上方选择函数所在地域及命名空间，并在单击列表中需实时采集日志的函数名。
3. 在“函数配置”页面，单击右上角的【编辑】。如下图所示：
![](https://main.qcloudimg.com/raw/28d3fa31668d9280acb7de553050d008.png)
4. 在“日志投递”中，选择已为该函数创建好的日志集和日志主题。如下图所示：
![](https://main.qcloudimg.com/raw/e1e86eac53cc09b57f8c7b5d71182f7d.png)
...
### 实时检索示例
>?在使用实时检索功能前，需确保您的函数服务日志已接入 CLS 平台，并且需检索的日志主题已开启索引。
>
