...
<dx-tabs>
::: VPC\s网络中的自定义域名访问方法（推荐）
在使用 VPC 网络的过程中，若需要通过使用域名来访问内网自建服务，可以通过使用腾讯云提供的 [私有云解析Private DNS](https://cloud.tencent.com/document/product/1338/50527) 来实现内网自定义域名配置及访问解析。
:::
::: VPC\s网络中的\sName\sserver\s配置
