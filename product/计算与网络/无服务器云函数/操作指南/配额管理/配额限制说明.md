...
>- 云函数平台在每个地域的默认状态下所有函数共享并发。用户可以自行配置 [函数并发](https://cloud.tencent.com/document/product/583/45757) 以满足需要，如果您需要提升各项配额或者增加命名空间维度的并发配额管理可直接 [购买套餐包](https://console.cloud.tencent.com/scf/buy?rid=1&ns=default)。
