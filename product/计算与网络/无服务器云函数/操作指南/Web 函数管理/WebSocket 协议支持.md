...
同时，API 网关触发器需要设定为前端协议为'WS或WSS'支持，后端为当前指定支持 WebSocket 的Web 函数。 通过 API 网关提供的 ws 路径，可供客户端连接使用。
...
![](https://main.qcloudimg.com/raw/b782c0c01decd5a43cda61dcd62a1aca.png)

通过勾选 WebSocket 支持，配置好 WebSocket 空闲超时时间，来完成 WebSocket协议支持。
