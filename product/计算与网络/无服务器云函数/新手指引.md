...
#### 3.3 创建云函数
- 云函数向您提供2种函数类型：事件函数和 Web 函数。详情见 [创建事件函数](https://cloud.tencent.com/document/product/583/19806) 及 [创建 Web 函数](https://cloud.tencent.com/document/product/583/56125)。
