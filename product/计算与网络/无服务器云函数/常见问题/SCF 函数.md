...
您可以将代码（以及任何依赖库）打包为 zip 并使用 CLI 从您的本地环境上传 zip 文件，或将 zip 文件上传 COS Bucket 后，在创建函数时指定拉取代码 zip 包的 Bucket 名和文件名。CLI详情可以参考[TCF命令行工具](https://cloud.tencent.com/document/product/583/33446)。
