...
本文旨在通过 Express、Koa 和 Egg 的 Hello World 示例来介绍 HTTP Service 服务型云函数使用方法，了解服务型云函数的基本使用流程和 SCF 控制台的基本操作，例如创建服务、上传代码、测试访问和查看运行日志和监控。HTTP Service 目前为内测发布功能，可通过 [提交工单](https://cloud.tencent.com/apply/p/tagk8e0x19f) 申请使用。
...
6. 单击访问路径，在浏览器窗口中看到 “Hello World!”，则 helloexpress 应用部署成功。
