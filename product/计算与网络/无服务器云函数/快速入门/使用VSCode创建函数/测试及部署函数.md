...
### 本地测试
1. 选择左侧导航栏中的<img src="https://main.qcloudimg.com/raw/07e4c5ac6fa4e41623f64e03c759b5df.png" style="margin:-3px 0;">，打开 Tencent Serverless 插件。
...
>- 如果您有安装多个 Python 版本，可根据当前要调试的 runtime 在 VS Code 里 [设置 Python path]()。

### 断点调试

#### 设置断点
>?
>- 本地调试目前支持 Python 和 Node.js ，调试 Python 项目需要先安装 [Python 插件](https://marketplace.visualstudio.com/items?itemName=ms-Python.Python) 。如果您有安装多个 Python 版本，可根据当前要调试的 runtime 在 VS Code 里 [设置 Python path]()。
...
2. 选择左侧导航栏的<img src="https://main.qcloudimg.com/raw/07e4c5ac6fa4e41623f64e03c759b5df.png" style="margin:-3px 0;">，打开 Tencent Serverless 插件。
...
### 云端测试
1. 选择左侧导航栏的<img src="https://main.qcloudimg.com/raw/07e4c5ac6fa4e41623f64e03c759b5df.png" style="margin:-3px 0;">，打开 Tencent Serverless 插件。
...
## 后续操作
您可前往 [更多功能及相关操作]() 了解并使用 VS Code 插件更多功能。
