...
2. 选择左侧导航栏中的【[安全组](https://console.cloud.tencent.com/ecm/safe)】，进入“安全组”管理页面，即可查看创建的所有安全组。
...
1. 登录 [边缘计算机器控制台](https://console.cloud.tencent.com/ecm/overview)。
- 选择左侧导航栏中的【[安全组](https://console.cloud.tencent.com/ecm/safe)】，进入“安全组”管理页面。
- 在安全组列表的右上方，单击搜索文本框，选择以下任一方式查询您需要查看的安全组。
