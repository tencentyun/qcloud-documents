...
请先 [配置访问日志到 CLS](https://cloud.tencent.com/document/product/214/41379) 后，关闭 [配置访问日志到 COS ](https://cloud.tencent.com/document/product/214/10329#close)，由于配置访问日志到 COS 将于2020年6月30日正式下线，届时访问日志无法再直接写入 COS。
