...
建议您通过 [云监控控制台](https://console.cloud.tencent.com/monitor/overview) 查看负载均衡的监控，单击【云产品监控】>[【负载均衡CLB】](https://console.cloud.tencent.com/monitor/clb)，单击负载均衡实例 ID，进入监控详情页，查看该负载均衡实例的监控数据，展开实例即可查看监听器、后端服务器等的监控信息。
