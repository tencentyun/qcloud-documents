...
## API 方式
您可以使用 GetMonitorData 接口获取所有产品的监控数据，具体内容请参见 [拉取指标监控数据](https://cloud.tencent.com/document/api/248/31014)，负载均衡的命名空间请参见 [公网负载均衡监控接口](https://cloud.tencent.com/document/api/248/35236)、[内网负载均衡监控接口（负载均衡维度）监控接口](https://cloud.tencent.com/document/api/248/35238) 和 [内网负载均衡（后端服务器维度）监控接口](https://cloud.tencent.com/document/api/248/35237)、[负载均衡七层数据监控接口](https://cloud.tencent.com/document/api/248/36169)。

## 云监控 Dashboard
当您负载均衡实例较多时，需要在同一图表中查看所有实例监控数据，进入 [云监控-Dashboard](https://console.cloud.tencent.com/monitor/dashboard2/default/d/0d6ygvlym66edjx6/yun-fu-wu-qi-cvm-yu-she-mian-ban?fromPage=default&channel=13) 获取监控数据，并在同一图表中展示同一指标的所有实例监控数据。更方便您管理和进行异障排查。
