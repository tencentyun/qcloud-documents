...
-  传统型负载均衡型实例：2018年4月后创建的 HTTPS 监听器默认支持 HTTP/2，2018年4月之前创建的监听器默认不支持 HTTP/2。
=======
 >?  
 - 负载均衡型实例：您可以选择开启或关闭 CLB 对 HTTP/2 的支持，详情请参考 [配置 HTTPS 监听器](https://cloud.tencent.com/document/product/214/36385#.E6.AD.A5.E9.AA.A42.EF.BC.9A.E9.85.8D.E7.BD.AE.E7.9B.91.E5.90.AC.E5.99.A8) 。
 - 传统型负载均衡型实例：2018年4月之前创建的监听器默认不支持 HTTP/2，2018年4月后创建的 HTTPS 监听器默认支持 HTTP/2。
  >
>>>>>>> fc3e731b38210bd110ec76dbe4a5d25249507cb8
