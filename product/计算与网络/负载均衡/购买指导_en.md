...
>**Note:**
> When a CVM is isolated (Go into recycle bin for prepaid CVMs, or be in arrears for more than two hours for postpaid CVMs), its binding relationship with the LB will be terminated.  
