...
- 当前配置访问日志到 CLS 支持的地域包括：广州、上海、香港、成都、多伦多、上海金融、深圳金融，可直接在控制台使用或通过 API 配置；南京、北京、重庆、硅谷、新加坡灰度中，如有需求，请提交 [工单申请](https://console.cloud.tencent.com/workorder/category)。
