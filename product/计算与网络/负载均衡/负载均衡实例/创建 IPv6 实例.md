...
- IPv6 具有更大的地址空间。当前 IPv4 最大的问题就在于网络地址资源有限，严重制约了互联网的应用和发展。 IPv6 采用 128位的地址，而 IPv4 采用的是 32位。因此 IPv6 支持 2<sup>128</sup>（约 3.4 × 10<sup>38</sup>）个地址，比 IPv4 增加了约 7.9 × 10<sup>28</sup> 个地址。使用 IPv6，可以让全世界的每一粒沙子都能分配到一个 IP 地址。
