...
- 业务平滑过渡。IPv6 负载均衡支持来自 IPv6 客户端的访问，业务仅需改造客户端，无需改造后端服务，便可快速、平滑地接入 IPv6。
- 对应用透明。IPv6 负载均衡可将 IPv6 报文转换成 IPv4 报文，后端云主机上的应用程序无需感知 IPv6，仍以原有形式部署和工作。
- 易于使用。腾讯云 IPv6 负载均衡能很好兼容原 IPv4 负载均衡，无需重新学习，操作简单，使用门槛低。
