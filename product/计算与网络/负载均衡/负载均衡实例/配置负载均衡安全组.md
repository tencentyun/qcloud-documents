...
- 安全组默认放通功能正处于灰度状态中，如有需求，请提交 [内测申请](https://cloud.tencent.com/apply/p/njj5tl4a5j)。传统型内网负载均衡和基础网络的负载均衡不支持安全组默认放通功能，[黑石物理服务器2.0](https://cloud.tencent.com/document/product/213/11518#CPM2) 暂不支持安全组默认放通能力。
