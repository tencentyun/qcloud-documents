...
>- Anycast CLB 当前仅支持四层协议（TCP/UDP），暂不支持七层协议（HTTP/HTTPS）。
...
## 操作指南
### 前提条件
本功能内测中，操作前请确保您已通过 [内测申请](https://cloud.tencent.com/act/apply/aia) 。
### 操作步骤
...
![](https://main.qcloudimg.com/raw/9d992fbaea8ae96917b1e753c390179d.png)
...
5. 内网负载均衡绑定加速 IP 后，该负载均衡即可提供 Anycast CLB 服务。更多负载均衡配置请参见 [负载均衡监听器概述](https://cloud.tencent.com/document/product/214/6151)。
