负载均衡支持创建 Anycast 负载均衡实例（下文也叫 Anycast CLB），Anycast CLB 是支持全球动态加速的负载均衡服务，CLB 的 VIP 会发布在全球多个地域，客户端接入最近的 POP 接入点，通过腾讯云数据中心高速互联网转发到云服务器上。
...
2. 实例类型选择 **应用型 CLB**，加速 IP 处勾选【启用 Anycast 加速 IP】，其他配置和 [普通实例配置](https://cloud.tencent.com/document/product/214/6149?!preview&!editLang=zh) 相同。
