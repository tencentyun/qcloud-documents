...
​
### Select your network
Select the network of CVM to be bound to the cloud load balancer instance. The network types of Tencent Cloud are classfied as basic network and private network, please refer to [Network Overview](http://www.qcloud.com/doc/product/213/%E7%BD%91%E7%BB%9C#1.-网络概述) for details.
​
### Purchase
...
### API Purchase
Please refer to [CreateLoadBalancer API](https://www.qcloud.com/doc/api/244/1254).
