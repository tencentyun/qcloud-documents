...
您可以将一个或多个安全组与后端云服务器关联，并对每个安全组添加一条或多条规则控制不同服务器的流量访问权限。您可以随时修改某个安全组的规则，新规则会自动应用于与该安全组关联的所有实例。有关更多信息，请参阅 [安全组操作指南](https://cloud.tencent.com/document/product/213/18197)。在 [私有网络](https://cloud.tencent.com/document/product/215/20046) 环境中，您还可以使用 [网络ACL](https://cloud.tencent.com/document/product/215/20088) 进行访问控制。
