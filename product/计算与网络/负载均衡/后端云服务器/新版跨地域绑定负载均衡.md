...
<tr>
<td style="word-wrap:break-word" >是否支持同时绑定多地域内服务</td>
<td style="width:70%">旧版跨地域绑定 CLB 仅能绑定一个地域的 CVM，例如北京的 CLB 可以绑定上海的 CVM，但是北京的 CLB 不能同时绑定北京和上海的 CVM。</td>
<td style="word-wrap:break-word">新版跨地域绑定支持同时绑定多个地域的 CVM。</td>
</tr>
