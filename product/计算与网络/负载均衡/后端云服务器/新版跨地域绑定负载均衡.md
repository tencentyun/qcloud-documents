...
<td width="43%">不支持：<ul><li>旧版跨地域绑定 CLB 仅能绑定一个地域的 CVM。</li><li>例如北京的 CLB 可以绑定上海的 CVM，但北京的 CLB 不能同时绑定北京和上海的 CVM。</li></ul></td>
<td width="30%">支持：<ul><li>新版跨地域绑定 CLB 支持同时绑定多个地域的 CVM。</li><li>例如北京的 CLB 可以同时绑定北京和上海的 CVM。</li></ul></td>
</tr>
