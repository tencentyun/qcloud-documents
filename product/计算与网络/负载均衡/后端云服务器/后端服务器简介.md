后端云服务器是创建负载均衡实例后绑定在其上处理相应转发请求的 [CVM 实例](https://www.qcloud.com/doc/product/213)。[负载均衡监听器](/doc/product/214/6151)通过不同的[轮询方式](/doc/product/214/6153)，将请求发送到后端云服务器上，保证应用平稳可靠的运行。您可在负载均衡实例所在的地域内的单个或多个可用区中选择绑定 CVM 实例，以增加应用程序的健壮性，屏蔽单点故障。
