## 1. 证书格式说明
### 1.1 证书格式要求
- 用户要申请的证书为：Linux 环境下 PEM 格式的证书。负载均衡不支持其他格式的证书，如是其它格式的证书请参见下文 [证书转换为 PEM 格式说明](#3.-.E8.AF.81.E4.B9.A6.E8.BD.AC.E6.8D.A2.E4.B8.BA-pem-.E6.A0.BC.E5.BC.8F.E8.AF.B4.E6.98.8E) 的内容。
