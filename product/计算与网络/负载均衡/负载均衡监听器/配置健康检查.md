...
在已选择 HTTP/1.1 版本且未配置检查域名的情况下：<ul><li>若勾选对应的<b>正常状态码</b>，则代表返回该值时是健康状态。</li><li>若未勾选任一<b>正常状态码</b>，则返回400错误。</li></ul>
</dx-alert>
...
<dx-alert infotype="explain" title="">
在未配置检查域名的情况下：<ul><li>若勾选对应的<b>正常状态码</b>，则代表返回该值时是健康状态。</li><li>若未勾选任一<b>正常状态码</b>，则返回400错误。</li></ul>
</dx-alert>
</td>
</tr>
<tr>
