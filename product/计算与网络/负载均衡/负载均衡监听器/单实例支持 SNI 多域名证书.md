...
2. [购买](https://buy.cloud.tencent.com/lb) 负载均衡。
>? 注：传统型负载均衡不支持基于域名和 URL 的转发，因此传统型负载均衡不支持 SNI。

### 配置 HTTPS 监听器并启用 SNI
1. 创建 HTTPS 监听器时，开启 SNI。
![图片描述](/tfl/captures/2019-08/tapd_10114221_base64_1566825964_82.png)
2. 在该监听器中添加转发规则时，针对不同的域名配置不同的服务器。
![图片描述](/tfl/captures/2019-08/tapd_10114221_base64_1566826146_29.png)
