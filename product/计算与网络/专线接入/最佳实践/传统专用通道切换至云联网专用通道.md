...
>- 若专用通道均是 BGP 路由，云端旧通道向 IDC 发送 VPC CIDR，当切换至云联网时，有以下两种情况：
>    - 专线网关在 2020 年 9 月15 日前创建，云联网向专线网关发送子网 CIDR，因此本地路由器通过 BGP 协议学习到子网 CIDR。根据路由掩码最长匹配原则，IDC 往 VPC 方向的流量会自动切换到云联网。
>    - 专线网关在2020年9月15日后创建，云联网向专线网关发送 VPC CIDR，因此本地路由器通过 BGP 协议学习到 VPC CIDR。需要手动启用下一跳为云联网的路由。
