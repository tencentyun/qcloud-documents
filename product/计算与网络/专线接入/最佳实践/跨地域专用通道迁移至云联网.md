## 背景信息
腾讯云计划将于2022-12-31 停止**专线接入-专用跨域通道**服务（2021年9月已停止新建）。为了保证您业务更加稳定、高质量的网络运营，您的跨地域专用通道将腾讯元由云联网（CCN）产品提供服务，详情请参见[专线跨地域通道升级迁移云联网公告](http：)。您可以参考本实践文档将您的跨地域专用通道切换至云联网。
