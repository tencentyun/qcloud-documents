...
## 前提条件
在控制台申请互联网通道公网 IP，具体操作请参见[申请公网互联网通道](https://cloud.tencent.com/document/product/216/50985)。

## 申请公网 IP[](id:creat)
若系统自动分配的公网地址不能满足业务需求时，您可以在控制台申请互联网通道公网 IP。申请的公网 IP 将自动绑定所在地域的互联网专用通道。若某地域有多个通道时，各通道将共享申请的公网 IP。
