...
2. [资源评估和方案设计](#buzhou2)：腾讯云专线经理将对您的需求进行资源评估，然后设计专线方案并与您同步，完成后专线状态为“待付款”。
3. [支付费用](#buzhou3)：在控制台完成付款后，专线状态进入“运行中”。

## 操作步骤

### <span id="buzhou1"/> 步骤一：创建物理专线
