...
## 背景信息
本场景中，将实现单个腾讯云 VPC（172.21.0.0/24）与单个本地 IDC（192.168.0.0/24）互通，通信带宽为 2Mbps。具体架构入下图所示：
![](https://main.qcloudimg.com/raw/4df97a68fddad608eb1871c9b2f56de3.png)
