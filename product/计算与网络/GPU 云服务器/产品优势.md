...
**低时延高 I/O 存储**
GPU 云服务器采用 SSD 本地盘， SSD 本地盘为实例提供块级别的数据访问能力，具有低时延、高随机 IOPS、高吞吐量的 I/O 能力。I/O 性能在普通本地盘的数 10 倍以上， 最高 300MB/s 的吞吐和 30000 随机 IOPS，详情请参考 [了解 SSD 本地盘详情 >>](https://www.qcloud.com/doc/product/213/5798#ssd-.E6.9C.AC.E5.9C.B0.E7.9B.98)。
