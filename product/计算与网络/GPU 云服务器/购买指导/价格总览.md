...
GPU 云服务器提供如下实例类型：计算型 GN6、GN6S、GN7、GN8、GN10X、GN10Xp 和渲染型 GN7vw， 用户可通过综合了解实例配置与价格来购买符合实际需要的 GPU 实例。了解如何选型可参考 [NVIDIA 系列实例](https://cloud.tencent.com/document/product/560/19700)。
