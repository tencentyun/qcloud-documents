...
<table>
    <tr>
      ...
      GPU 驱动：460.27.04<br>
      容器：yunfan-ttf1.15-gpu:cu112-cudnn81-py3-0.1.1</th>
    <tr>
    <tr>
      	<th rowspan="5" align=center>network</th>
        <td colspan="2" align=center>ResNet 50 ｜ synthetic ｜ batch=256</td>
    <tr>
    <tr>
    ...
    <tr>
    <tr>
        <td align=center>Throughput(imgs/sec)</td>
      	<td align=center>Throughput(imgs/sec)</td>
    <tr>
    <tr>
      	<th>NCCL + HRAP</th>
