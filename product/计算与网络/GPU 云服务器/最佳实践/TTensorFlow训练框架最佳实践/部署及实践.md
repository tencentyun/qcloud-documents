本文介绍如何在 GPU 云服务器实例上部署及使用 TensorFlow。推荐使用 [计算型](https://cloud.tencent.com/document/product/560/19700#GT4) 实例，可参考 [购买 NVIDIA GPU 实例](https://cloud.tencent.com/document/product/560/30211) 创建实例。
