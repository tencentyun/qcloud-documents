...
- qGPU 粒度：一个 GPU 上最多分配的 qGPU 个数，等于（Pod 个数）= GPU 显存数 / 4。
...
3. 在打开的页面中创建节点池，其中“镜像提供方”请选择**市场镜像**，“操作系统”请选择 **TencentOS Server 3.1**。如下图所示：
...
5. 单击**创建节点池**即可。其余参数配置可参见 [创建节点池](https://cloud.tencent.com/document/product/457/43735)。
6. 为应用分配 GPU 资源。
