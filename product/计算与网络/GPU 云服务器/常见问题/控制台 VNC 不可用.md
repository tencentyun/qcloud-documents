## 现象描述
通过 [使用 VNC 登录 Windows 实例](https://cloud.tencent.com/document/product/213/35704) 或 [使用 VNC 登录 Linux 实例](https://cloud.tencent.com/document/product/213/35701) 在系统登陆界面无法显示登陆提示信息，**黑屏**或**仅显示 Windows Logo**。如下图所示：
