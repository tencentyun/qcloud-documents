...
通过[使用 VNC 登陆 Windows 实例](https://cloud.tencent.com/document/product/213/35704) 或 [使用 VNC 登录 Linux 实例](https://cloud.tencent.com/document/product/213/35701)在系统登陆界面无法显示登陆提示信息，**黑屏**或**仅显示 Windows Logo**，如下图：
...
2. 由于其他原因导致操作系统启动失败，比如安装了和系统冲突的第三方软件等。
