...
<dx-alert infotype="explain" title="">
GNV4 实例支持驱动版本为 GRID 13.1，支持 NVDIA DLSS (Deep Learning Super Sampling)  Version 2.0，详情请参考 [NVIDIA vGPU 软件说明](https://docs.nvidia.com/grid/13.0/grid-vgpu-release-notes-generic-linux-kvm/index.html?from_wecom=1#dlss-support)。
</dx-alert>
