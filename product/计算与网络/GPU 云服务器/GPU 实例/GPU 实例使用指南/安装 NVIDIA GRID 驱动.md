...
2. 选择下拉框中的【Miscrosoft Windows Hyper-V】及【2016】，单击目标搜索结果所在行右侧的【Download】。即使用最新的 NVIDIA Virtual GPU SoftWare 版本，本文以 GRID 9.3 版本为例。如下图所示：
![](https://main.qcloudimg.com/raw/1856fd04b607e287ee6646f3b473986a.png)
3. <span id="step3"></span>创建一台普通云服务器，作为 License 服务器。详情请参见 [创建实例](https://cloud.tencent.com/document/product/213/4855)。 
...
2. 登录实例并安装 GRID Driver，即安装 NVIDIA vGPU for Windows 驱动程序。
