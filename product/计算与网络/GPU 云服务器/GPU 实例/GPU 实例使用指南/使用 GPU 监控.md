...
## 查看 GPU 工作参数
点击 GPU 列表中的 “<img style="margin:0;" src="https://main.qcloudimg.com/raw/99d10268805b09f693477afd664e05fb.png"/>” 监控图标， 访问 [控制台](https://cloud.tencent.com/login) GPU 实例的监控页面，查看 GPU 监控，移动鼠标到指标曲线上将显示对应 GPU 设备的 BDF 和监控数据。如下图所示：
