...
3. 在【路由表】标签页中，单击路由表 ID，查看该路由表的相关信息。
    ...
    - 在【绑定实例】页签中，查看该路由表绑定的网络实例（即，云联网中的网络实例绑定该路由表）。更多关于网络实例与路由表绑定的操作信息请参见 [绑定路由表](https://cloud.tencent.com/document/product/877/58541)。
       ![](https://main.qcloudimg.com/raw/451080d3cb0e214cb2e28ac72e976e15.png)
    - 在【路由接收策略】页签中，查看该路由表接收哪些网络实例的路由。关于如何配置路由接收策略请参见[ 配置路由接收策略](https://cloud.tencent.com/document/product/877/58540)。
