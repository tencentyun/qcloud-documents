...
|log-status | text |流日志的日志记录状态：<br>OK：表示数据正常记录到指定目标。<br/> NODATA：表示捕获窗口中没有传入或传出网络流量，此时“packets”和“bytes”字段会显示为“-1”。 |
 ...
 ### 如何查看指定地域间流日志？
以上海地域为例，通常在上海地域开启流日志后，会采集以上海为源地域的所有出流量，以及以上海为目的地域的入流量，如需采集地域间流日志，您可以通过 CLS 的 srcregion 和 dstregion 来过滤出期望的流日志，详情可参考[ 上下文检索分析](https://cloud.tencent.com/document/product/614/53248)。
