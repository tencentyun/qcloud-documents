...
## 前提条件
- 跨账号双方都具有云联网内测资格（本文以账号 A 和账号 B 为例）。
- 需要互联的私有网络 VPC 已创建好。
- 需要互联的各 VPC 子网网段、IDC 网段没有冲突。


## 步骤一：账号 A 创建云联网实例
1. 使用账号 A 登录 [腾讯云控制台](https://console.cloud.tencent.com/) ，选择【云产品】>【云计算与网络】>【私有网络】，进入私有网络控制台。
...
1. 使用账号 B 登录 [腾讯云控制台](https://console.cloud.tencent.com/) ，选择【云产品】>【云计算与网络】>【私有网络】，进入私有网络控制台。
