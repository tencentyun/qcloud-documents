...
|测试步骤|netperf：<br>该测试使用了同一个子网中的两台机器，B 机作为 server，A 机向 B 机发包。<br>首先 B 机作为服务端启动服务：<br>netserver<br><br>A 机作为客户端开始发送数据：<br>256B 文件 TCP:<br>并发进程数 160<br>netperf-H&lt;server>-l120-tTCP_STREAM---m256<br><br>1400B 文件 TCP:<br>并发进程数 160<br>netperf-H&lt;server>-l120-tTCP_STREAM---m1400<br><br>32B-32B 长连接:<br>并发进程数 300<br>netperf-H&lt;server>-l120-tTCP_RR---r32,32<br><br>32B-32B 短连接:<br>并发进程数 50<br>netperf-H&lt;server>-l120-tTCP_CRR---r32,32<br>32B 文件 UDP<br>并发进程数 6<br>netperf-H&lt;server>-l120-tUDP_STREAM---m32<br><br>1424B文件UDP:<br>并发进程数 6<br>netperf-H&lt;server>-l120-tUDP_STREAM---m1424<br><br>1500B 文件 UDP:<br>并发进程数 6<br>netperf-H&lt;server>-l120-tUDP_STREAM---m1500<br><br>UDP 小包<br>并发进程数 6<br>netperf-H&lt;server>-l120-tUDP_STREAM---m1<br><br>ping:<br>由 A 机向 B 机进行 ping 测试<br><br>有负载：<br>同样的 B 机作为服务端开启服务：netserver<br>A 机后台运行 netperf 足够多次，比如 100 次：<br>netperf-H&lt;server>-l3600-tTCP_RR---r32,1024<br>同时：ping---c3000-i0.1--&lt;server><br><br>空载：<br>ping---c3000-i0.1--&lt;server>|
|数据取样|3 次测试，选取平均值|
