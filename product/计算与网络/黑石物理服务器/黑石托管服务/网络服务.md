...
#### 登录黑石托管服务控制台
登录地址：https://console.cloud.tencent.com/cpm/colocation 。仅供腾讯云大客户使用， 如需使用请联系腾讯云客户经理。
...
### 其他网络服务
#### 绑定负载均衡
详情请单击 [绑定虚机IP到负载均衡四层监听器](https://cloud.tencent.com/document/product/386/9295) 、 [绑定虚机IP到负载均衡七层转发路径](https://cloud.tencent.com/document/product/386/9282)

#### 绑定弹性公网 IP
详情请单击 [VPC网络IP绑定EIP](https://cloud.tencent.com/document/product/386/8684) 、 [VPC网络IP解绑EIP](https://cloud.tencent.com/document/product/386/8685)
...
#### 前提
部份黑石数据中心带外网络采用 Sideband 带外，如果您的服务器不支持  Sideband 功能将无法使用带外服务。
