...
*黑石弹性公网IP只能绑定黑石服务器和黑石私有网络的NAT网关，与云服务器的弹性公网IP不共用*
##使用范围
...
###公网出口费
公网出口费有种计费模式，分别为：【按流量计费】以及【按固定带宽计费】
<li>按流量计费：单价:0.8元/GB,没有带宽峰值上限（即不限速）。按实际产生流量计费，该费用为后付费，每小时扣费。</li>
<li>按固定带宽计费：即按购买的带宽峰值计费，公网出口无法超过设置的带宽峰值。</br>
采用阶梯价计费。
<table>
<tr>
<td>阶梯</td>
...
*同一自然小时内，在相同计费模式下修改带宽峰值实时生效，但按最后一次修改的带宽峰值计算当前计费周期的固定带宽费用*
