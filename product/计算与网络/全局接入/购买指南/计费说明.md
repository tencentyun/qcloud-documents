...
## 费用组成
全局接入的费用由实例费、网络费和 <a href="https://cloud.tencent.com/document/product/1121/36888#2081"> LCU</a> 费组成。
<table>
<tbody>
<tr>
...
总费用 = 实例费 + 公网网络费 + LCU 费= 2.75元 + 1.86元 +0.098元 = 4.708元，于下一小时（10:00:00 - 10:59:59）进行结算并扣费。
