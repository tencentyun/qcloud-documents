...
- Gateway：定义网关的端口、监听规则、证书配置，网关与 Gateway 配置是一对多的关系，Gateway 通过 selector 字段指定配置下发的边缘代理网关。更多关于 Gateway 的使用方法请参见 “边缘代理网关 - Gateway 配置”部分。
...
当前 TCM 提供两种方式配置 Gateway，VirtualService 和 DestinationRule：
