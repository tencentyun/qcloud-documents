...
边缘代理网关创建后，您可以修改边缘代理网关的关联 CLB带宽（仅 Ingress Gateway）、实例数量、HPA 伸缩策略及资源定义配置。

### 修改CLB带宽

您可以修改 Ingress Gateway 关联的 CLB 实例的带宽。在对应网格详情页面的**基本信息**Tab 边缘代理网关部分可以编辑 Ingress Gateway 绑定的 CLB配置。
![](https://qcloudimg.tencent-cloud.cn/raw/ed727b05d20a0de30e81faa19f615d6d.png)
