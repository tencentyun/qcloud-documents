...
您可以在网格创建页面，添加服务发现集群后，创建边缘代理网关。
![](https://main.qcloudimg.com/raw/ca6c590c08fb4da77664812ee1ac37da.png)
或在网格详情页面边缘代理网关 Tab 点击新建按钮创建边缘代理网关。
...
| CLB 直连 Pod | Ingress Gateway 参数。如网关接入集群网络模式为 VPC-CNI，即可开启 CLB 直连 Pod，将不再进行 NodePort 转发，具有更高性能，支持保留客户端源IP、Pod层级会话保持与健康检查，更多详情请参见 [使用 LoadBalancer 直连 Pod 模式 Service](https://cloud.tencent.com/document/product/457/41897) |
...
1. 进入网格详情页，点击【组件管理**，选择【边缘代理网关**，在需要删除的网关对应行【操作**列点击【更多**，点击【删除**
![](https://main.qcloudimg.com/raw/b66106d5d1d553c615aed29a883e6eb7.png)
2. 在【删除边缘代理网关**弹窗，确认删除的网关名称，点击【确定**完成删除
![](https://main.qcloudimg.com/raw/7e1a544499f779c70caab036798fafde.png)
