...
| 配置项 | 描述 |
| ----- | ----- |
| 开启范围 | 配置开启访问日志输出的数据面（边缘代理网关 和 istio-proxy sidecar），可以开启指定边缘代理网关、指定 namespace 下所有数据面、或网格所有数据面的访问日到容器标准输出 |
...
- 创建网格时配置 Access Log：
![](https://main.qcloudimg.com/raw/d5a14049dbbdc741a9cc489f0e61592c.png)
- 网格创建完成后配置 Access Log：
![](https://main.qcloudimg.com/raw/d3d3ea966721a5af6919a22919a5645c.png)
...
如您开启了访问日志的消费端配置，将 TCM 数据面访问日志 Access Log 采集到了日志服务 CLS，则您可以在 CLS 控制台检索分析处选择对应日志主题查看 TCM 数据面访问日志。CLS 日志检索语法，请参考 [CLS 日志检索语法与规则](https://cloud.tencent.com/document/product/614/47044)。

![](https://main.qcloudimg.com/raw/e943189ff6bedb664ce683d1b6cc92dc.png)
