...
- For a cross-region peering connection, you can select a maximum bandwidth. To get a higher bandwidth, please submit a ticket.
...
> Note: Any fees charged for a cross-region peering connection are paid by the requester of the connection.
