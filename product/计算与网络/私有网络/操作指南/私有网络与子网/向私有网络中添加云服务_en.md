When you have created a VPC and divided it into subnets, you can add cloud services to the VPC.

You must have an available VPC to see the VPC in the purchase page of cloud resources when you log in to the Tencent Cloud website.
...
> Note: Please make sure to reserve sufficient private IPs in the subnet, otherwise the resources cannot be successfully allocated.
