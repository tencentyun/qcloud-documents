You can check the association between the basic network CVM and VPC in the VPC console.
...
2) Click "Classiclink" tab to view the list of basic network CVMs associated with the VPC.
