...
> 注意：您在 `/etc/init.d/keepalived start` 或 `service network restart`执行后** 可在主服务器内看到该内网IP（参见第三步）.或者，您在分配内网IP后，在云服务器内配置即可正式生效**. 点击查看[分配内网IP（云服务器系统内）](https://cloud.tencent.com/document/product/215/6513#.E5.88.86.E9.85.8D.E5.86.85.E7.BD.91ip.EF.BC.88.E4.BA.91.E6.9C.8D.E5.8A.A1.E5.99.A8.E7.B3.BB.E7.BB.9F.E5.86.85.EF.BC.8911)
