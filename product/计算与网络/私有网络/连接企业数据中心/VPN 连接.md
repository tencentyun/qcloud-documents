...
示例：
通过IPsec VPN连接打通您在**广州二区**的私有网络TomVPC中子网A`192.168.1.0/24`与您的IDC中子网`10.0.1.0/24`，而您IDC中VPN 网关的公网 IP 是`202.108.22.5`。
...
3) 在列表的上端选择私有网络myVPC所在**广州二区**和私有网络`TomVPC`，点击【新建】。
...
1)	登录[腾讯云控制台](https://console.qcloud.com/)点击导航条【私有网络】，进入[私有网络控制台](https://console.qcloud.com/vpc/vpc?rid=8)。
2)	点击左导航栏中【子网】，在列表的上端选择私有网络myVPC所在**广州二区**和私有网络`TomVPC`，点击子网A所关联的路由表 ID 进入该路由表的详情页。
