...
1) **按量后付费**，包含网关租用费（按小时计费）和访问公网产生的流量费用，[查看公网流量费用](https://www.qcloud.com/document/product/213/509#.E6.8C.89.E6.B5.81.E9.87.8F.E8.AE.A1.E8.B4.B912)

| 类型 | 国内 |硅谷、法兰克福、香港|  多伦多 |
|---------|---------|---------|---------|
| 小型 | 0.48元/h | 0.58元/h |0.75元/h |
