...
### 云服务器绑定 EIP
1. 打开云服务器 [CVM 控制台](https://console.cloud.tencent.com/cvm/overview)。
2. 在左侧导航窗格中，单击【弹性公网 IP】。
3. 在您想要绑定 CVM 的 EIP 列表项后，单击【绑定】按钮。若此时此弹性 IP 已绑定云服务器此按钮将为不可用状态，请先解绑。
4. 弹框处，根据 CVM 的实例 ID，选中要绑定 CVM 实例。
5. 单击【绑定】。
    **或者：**
 1. 打开云服务器 [CVM 控制台](https://console.cloud.tencent.com/cvm/overview)，进入 CVM 实例列表。
 2. 在您需要绑定弹性 IP 的云服务器右侧操作栏中，单击【绑定弹性 IP】。
...
4. 单击【确定】。
    **或者：**
 1. 打开云服务器 [CVM 控制台](https://console.cloud.tencent.com/cvm/overview)。
 2. 在您需要解绑弹性 IP 的云服务器右侧操作栏中，单击【解绑弹性 IP】。
