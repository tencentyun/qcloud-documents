## 私有网络
私有网络（Virtual Private Cloud）能帮助您在腾讯云构建出独立的网络空间，与您在数据中心运行的传统网络极其相似，但是托管在腾讯云私有网络内的是您在腾讯云上的服务资源，包括：[云主机](https://www.qcloud.com/doc/product/213/495)、[负载均衡](https://www.qcloud.com/doc/product/214/524)、[云数据库](https://www.qcloud.com/doc/product/236)等云服务资源。腾讯云私有网络为您提供以下功能：
- 通过控制台和 API 自定义网段划分、IP地址、路由策略等
- 通过[弹性 IP ](https://www.qcloud.com/doc/product/213/1941)、[NAT 网关](https://www.qcloud.com/doc/product/215/4975)和[公网网关](https://www.qcloud.com/doc/product/215/4972)等灵活访问 Internet
- 通过[ VPN ](https://www.qcloud.com/doc/product/215/4956)和[专线接入](https://www.qcloud.com/doc/product/215/4976)将私有网络与您的数据中心连通
- 通过[对等连接](https://www.qcloud.com/doc/product/215/5000)服务可实现全球同服和两地三中心容灾
- 通过基础网络互通，使得基础网络内主机可以和私有网络内主机通过内网通信
- 通过[安全组](https://www.qcloud.com/doc/product/213/500)和[网络 ACL](https://www.qcloud.com/doc/product/215/5132) 可以多维度、全方位的满足您的网络安全需求。
...
- **[弹性IP（EIP）](https://www.qcloud.com/doc/product/213/1941)**，是可以独立申请的公网 IP 地址，支持与 CVM/NAT 网关实例的动态绑定和解绑。
...
广播：腾讯云支持子网维度的广播。
组播：腾讯云支持私有网络维度的组播。
该功能处于内测阶段，如有需要，欢迎提[工单申请](https://console.qcloud.com/workorder/category/create?level1_id=6&level2_id=168&level1_name=%E8%AE%A1%E7%AE%97%E4%B8%8E%E7%BD%91%E7%BB%9C&level2_name=%E7%A7%81%E6%9C%89%E7%BD%91%E7%BB%9C%20VPC)。
...
点击查看腾讯云私有网络支持的[地域和可用区列表](https://www.qcloud.com/document/product/213/6091)
...
- 每个子网必须关联一个[路由表](https://www.qcloud.com/doc/product/215/4954)，通过设定路由表可以指定子网的网络路由。
...
有关更多信息可以点击查看[私有网络其它产品的使用约束](https://www.qcloud.com/document/product/215/537)。
...
** 收费产品**：
- 使用公网\专线的通信收费，[点击查看公网通信收费详情](https://www.qcloud.com/doc/product/213/509)。
- 跨地域对等连接、VPN网关、NAT网关收费，[点击查看收费详情](https://www.qcloud.com/doc/product/215/3079)。
...
3)	填写私有网络和子网的名称和[CIDR（点击查看CIDR规划的约束）](https://www.qcloud.com/doc/product/215/4927#cidr)，并选择子网的可用区。
...
1)	点击[私有网络控制台](https://console.qcloud.com/vpc/vpc?rid=8)左导航栏中的【子网】。
2)	选择需要创建子网的地域和私有网络。
...
### 关联子网和路由表
每个子网都必须关联一个[路由表](https://www.qcloud.com/doc/product/215/4954)，用来指定子网的出站路由，您可以实时更改子网关联的路由表。如果需要新建路由表则可以参考[创建路由表](https://www.qcloud.com/doc/product/215/4954#.E5.88.9B.E5.BB.BA.E8.87.AA.E5.AE.9A.E4.B9.89.E8.B7.AF.E7.94.B1.E8.A1.A8)。

1)	进入[私有网络控制台](https://console.qcloud.com/vpc/vpc?rid=8)选择左导航栏中的【子网】。
...
1)	在[CVM介绍页](https://www.qcloud.com/product/cvm.html)，点击立即选购按钮。
2)	在第三步，选择存储与网络，选择需要对应的私有网络和子网。

### 查看私有网络内的所有资源

1)	点击[私有网络控制台](https://console.qcloud.com/vpc/vpc?rid=8)左导航栏中的【私有网络】。
2)	在列表上方，选择需要查看的私有网络所在地域。
3)  点击私有网络ID，进入详情页，即可查看私有网络内的所有资源。

### 修改云主机内网IP
云主机主网卡的主内网IP支持修改，辅助网卡的主内网IP不支持修改，操作步骤如下：
1)  进入[云服务器控制台](https://console.qcloud.com/cvm/)，点击左导航栏的云主机，进入云主机列表页。
...
## API概览
您可以使用API操作来设置和管理您的私有网络和子网，点击查看[ VPC 所有 API 概览](https://www.qcloud.com/doc/api/245/909)。
