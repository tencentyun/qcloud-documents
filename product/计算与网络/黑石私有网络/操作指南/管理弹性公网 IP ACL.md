...
2. 选择【[黑石私有网络](https://console.cloud.tencent.com/vpcbm)】选项卡，选择【外网安全】，再选择【弹性公网 IP ACL】。
3. 单击左上角【新建】，在弹出框中依次输入或确定以下参数：
 - 名称
 - 状态方式
4. 选择结束后单击【确认】，即可完成 弹性公网 IP ACL 的创建。
...
1. 登录 [腾讯云控制台](https://console.cloud.tencent.com/)。
2. 选择【[黑石私有网络](https://console.cloud.tencent.com/vpcbm)】选项卡，选择【外网安全】，再选择【弹性公网 IP ACL】。
3. 在 弹性公网 IP ACL 列表页中单击需要修改的 弹性公网 IP ACL ID 进入详情页，在基本信息中完成以下属性修改：
 - 修改 弹性公网 IP ACL 名称；
...
1. 登录 [腾讯云控制台](https://console.cloud.tencent.com/)。
2. 选择【[黑石私有网络](https://console.cloud.tencent.com/vpcbm)】选项卡，选择【外网安全】，再选择【弹性公网 IP ACL】。
3. 在 弹性公网 IP ACL 列表页中，选择需要删除的 弹性公网 IP ACL 操作列【删除】。
![](https://main.qcloudimg.com/raw/139e237bf9a8e3cd4c4f6319db8faef5.png)

### ACL 规则设置
1. 登录 [腾讯云控制台](https://console.cloud.tencent.com/)。
2. 选择【[黑石私有网络](https://console.cloud.tencent.com/vpcbm)】选项卡，选择【外网安全】，再选择【弹性公网 IP ACL】。
3. 在弹性公网 IP ACL 列表页中单击需要修改的 弹性公网 IP ACL ID 进入详情页，在 ACL 规则中完成 ACL 规则设置：
...
1. 登录 [腾讯云控制台](https://console.cloud.tencent.com/)。
2. 选择【[黑石私有网络](https://console.cloud.tencent.com/vpcbm)】选项卡，选择【外网安全】，再选择【弹性公网 IP ACL】。
3. 在弹性公网 IP ACL 列表页中单击需要修改的 弹性公网 IP ACL ID 进入详情页，在关联弹性公网 IP 中完成弹性 IP 设置：
 - 关联弹性 IP；
 - 解除弹性 IP。
...
1. 登录 [腾讯云控制台](https://console.cloud.tencent.com/)。
2. 选择【[黑石私有网络](https://console.cloud.tencent.com/vpcbm)】选项卡，选择【弹性公网 IP】。
3. 在 弹性公网 IP 列表页中，选择需要修改的 弹性公网 IP 操作列【更多】选项卡，再选择【关联 ACL】。
4. 在关联 ACL 中选择 加入的弹性公网 IP ACL。
