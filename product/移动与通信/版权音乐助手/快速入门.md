...
在进行测试联调的同时，您可填写 [产品接入申请表](https://cloud.tencent.com/apply/p/ewsz9hgjdpd) ，版权方会基于音乐应用场景，开放特定曲库购买入口。申请会在5个工作日内反馈结果，届时会通过短信，邮件，[站内信](https://console.cloud.tencent.com/message) 进行通知。
...
申请审核通过后，您可按需购买版本曲库，曲库详细信息可 [点此](https://cloud.tencent.com/document/product/1155/38823) 查看。
