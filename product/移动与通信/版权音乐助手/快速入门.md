...
步骤1：调用 [获取分类内容（Station）列表](https://cloud.tencent.com/document/product/1155/40109) 接口，获取歌单分类信息。
步骤2：调用 [获取分类内容下歌曲列表](https://cloud.tencent.com/document/product/1155/40112) 接口，获取歌单中的歌曲列表信息。
步骤3：调用 [获取歌曲播放信息](https://cloud.tencent.com/document/product/1155/40110) 接口或 [获取歌词信息](https://cloud.tencent.com/document/product/1155/40111) 接口，获取指定歌曲的播放信息或歌词信息。
