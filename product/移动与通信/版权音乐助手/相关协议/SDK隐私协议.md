## 更新说明
我们对《正版曲库直通车 SDK 隐私保护指引》进行了更新，更新内容主要为：

- 增加了第三方 SDK 隐私政策链接。
- 增加了终端用户的同意作为启用本 SDK 的前提。
- 细化信息主体行使相关权利的机制。
- 删除了 cookie 规则、处理未成年人个人信息的规则及其他部分不适用的规则。
- 根据《个人信息保护法》更新了相关术语和表述。

## 引言
腾讯严格遵守法律法规，按照业界成熟的安全与隐私标准，保护第三方开发者和其终端用户的个人信息。

正版曲库直通车是一款由腾讯云计算（北京）有限责任公司（以下简称“我们”）提供服务的正版音乐使用服务产品，公司注册地为北京市海淀区知春路49号3层西部309。腾讯云曲库正版直通车产品对接方式包含 SDK 、API 能力，由于目前相关法律法规、政策及标准中主要对 SDK 产品的应用提供相关指引，以下将统一以 SDK 视角描述相关内容，如果您是集成、调用 API 能力或 H5 页面的第三方开发者，本指引中的内容同样适用于您。

《正版曲库直通车 SDK 隐私保护指引》主要向第三方开发者和其终端用户说明我们如何处理个人信息（处理包括“收集、存储、使用、加工、传输、提供、公开等”）。在注册、接入、使用正版曲库直通车 SDK （以下简称“本 SDK ”）产品和/或服务前，请第三方开发者和终端用户务必仔细阅读本声明。同时，请第三方开发者将本声明提供给第三方的终端用户，以便最终用户了解本声明相关内容并获得用户同意。

**在获得终端用户的同意前，除非法律法规另行允许，开发者不应收集终端用户的任何个人信息，不应启用本 SDK 产品及/或相关服务。**

**<u>我们对个人敏感信息采用“加黑并斜体”的书写方式进行特别提醒</u>**。如对本声明内容有任何疑问、意见或建议，可随时通过本声明 [第八条](#eight) 提供的方式与我们联系。

## 一、如何收集和使用第三方开发者和/或终端用户的个人信息[](id:one)
...
<th>申请的<br>权限</th>
<th>接入<br>方式</th>
<th>敏感个人信息处<br>理的必要性说明</th>
</tr>
</thead>
<tbody style="font-style:italic"><tr>
<td>正版曲库直通车</td>
<td>Wi-Fi 状态、设备型号、系统属性、操作系统</td>
<td>SDK 性能调优</td>
<td>加密传输和必要性处理：读取个人信息类型中涉及的设备信息，对设备进行针对性的性能调优和故障兼容</td>
<td>网络权限和读取存储权限</td>
<td>SDK</td>
<td>不涉及个人敏感信息</td>
</tr>
...
<tbody style="font-style:italic"><tr>
<td>Audiobase  SDK</td>
<td>实时根据客户演唱的音高进行打分，并返回给开发者</td>
<td>无</td>
<td>无</td>
<td><a href="https://privacy.qq.com/document/preview/44ce6abab3df49dc94467127a98e688b"> Audiobase SDK个人信息保护规则 </a></td>
</tr>
</tbody></table>
...
## 三、如何共享、转让、公开披露第三方开发者和/或终端用户的个人信息[](id:three)

#### （一）共享
**我们不会与第三方共享第三方开发者和/或终端用户的必要的个人信息。**

**如存在分享的行为，我们会单独征得第三方开发者和/或终端用户的同意，并要求关第三方提供数据安全能力和信息安全资质（如等级保护测评、信息安全管理体系等）证明。在个人敏感信息的处理上，我们会要求第三方采用数据脱敏加密技术，从而更好地保护个人信息。如果第三方开发者和/或终端用户对第三方处理个人信息有异议或发现这些第三方存在风险时，请按照本声明 [第八条](#eight) 所述方式联系我们。**

**第三方如要改变个人信息的处理目的，我们会再次征求第三方开发者和/或终端用户的同意。**
...
## 四、如何存储第三方开发者和/或终端用户的个人信息[](id:four)
...
## 五、如何保护第三方开发者和/或终端用户的个人信息安全[](id:five)
...
## 六、第三方开发者和/或终端用户如何管理其个人信息[](id:six)
...
2. 第三方开发者在使用本 SDK 的过程中，如果终端用户根据第三方开发者与我们的约定提出了个人信息相关的行权请求，并且第三方开发者已确定该等行权请求涉及到了第三方开发者向本 SDK 提供的个人信息时，请及时通过本指引 [第八条](#eight) 所述方式联系我们，并附上必要的书面证明材料。我们将及时核验相关材料，并按照相关法律法规，以及本指引等法律文本中明确的规则，为第三方开发者提供相应的支持与配合。
3. 我们已向第三方开发者提供关闭本 SDK 服务的能力，第三方开发者可以通过**停用 SDK 的方式**来停止收集和处理终端用户的个人信息。
4. 如第三方开发者希望注销本 SDK 服务，可以通过本指引 [第八条](#eight) 所述方式联系我们进行服务注销。我们将采取合理的步骤注销账户，我们将根据法律法规的要求删除个人信息。除非我们因法律原因而需要保存该等资料，我们将仅限于法律法规所规定的范围内进行处理，不会将其用于日常业务活动中。
...
终端用户有权查阅、复制、修改、删除、撤回同意其相关的个人信息，如希望行使以上权利，请通过开发者平台功能设置，也可以按照本声明 [第八条](#eight) 所述方式与我们联系。
...
1. **查阅、复制和修改个人信息**
  当终端用户所使用的第三方中某项功能由本 SDK 产品和/或服务提供，终端用户可以在使用我们服务的过程中，向开发者查阅、复制、修改其在使用开发者产品中处理的个人信息，也可按照本声明 [第八条](#eight) 所述方式与我们联系。
...
3. **撤回同意**
  - 基于终端用户的同意而进行的个人信息处理活动，终端用户有权撤回该同意。我们已向开发者提供关闭 SDK 服务的能力，第三方开发者可以通过**停用 SDK 的方式**来停止收集和处理终端用户的个人信息。由于我们与终端用户无直接的交互对话界面，终端用户可以直接向第三方开发者主张撤回同意的权利，也可通过第三方开发者提供的开发者平台 [功能设置](https://console.cloud.tencent.com/tpns) 主张撤回同意的权利。<u>如开发者需要我们协助终端用户的权利请求，可按照本指引 [第八条](#eight) 所述方式向我们提出协助请求</u>。
...
**如第三方开发者和/或终端用户的对上述权利实现存在疑问，可以根据本声明 [第八条](#eight) 所述方式与我们联系。**

## 七、如何变更与更新本声明[](id:seven)
...
2. 邮寄信件至：中国广东省深圳市南山区海天二路33号腾讯滨海大厦 数据隐私保护部（收）邮编：518054。
