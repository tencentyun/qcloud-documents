通过 [事件绑定](https://cloud.tencent.com/document/product/1301/58521) 我们可以了解到，一个组件的事件由触发条件以及 [执行动作](https://cloud.tencent.com/document/product/1301/61120) 两部分构成，本文章主要对触发条件进行说明。
