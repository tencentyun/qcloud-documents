...
- [产品介绍](https://cloud.tencent.com/document/product/1301/48874)
...
| 学习导览 | 学习目标                                                     | 预估学习时长 |
| -------- | ------------------------------------------------------------ | ------------ |
| 基础入门 | 讲解微搭的基础概念与功能，适合初学者学习掌握微搭的整体框架，掌握门户、表单等应用的基础搭建能力。 | 约30分钟     |
| 进阶指南 | 深度介绍编辑器、组件、小程序、数据源、用户权限等模块的核心功能配置、与前后端代码编写能力，适合开发者进一步了解平台的完整功能，实现企业内部运营管理、营销活动等复杂场景下的应用开发。 | 约2小时      |
| 高级教程 | 讲解微搭的各项高级与扩展能力，例如应用自定义域名、自定义组件、工作流、小程序分包、企业微信集成等，开发者可根据自己的实际需求按需学习。 | 3小时以上    |
| 视频课程 | 通过视频课程，您可以更加直观、全面的学习各个模块功能，对微搭形成系统性的理解认知，实现在微搭平台中熟练搭建各类应用。 | 约6小时      |
...
| 文档链接                                                     | 学习内容                                                 |
| ------------------------------------------------------------ | -------------------------------------------------------- |
| [创建应用](https://cloud.tencent.com/document/product/1301/48868) | 快速了解微搭中应用的类型和创建流程。                       |
| [编辑器](https://cloud.tencent.com/document/product/1301/53204) | 编辑器是应用开发的主模块，可快速熟悉应用的开发思路。       |
| [官方组件](https://cloud.tencent.com/document/product/1301/59110) | 查阅微搭官方组件清单，了解应用页面中可实现的基础功能效果。 |
| [数据模型](https://cloud.tencent.com/document/product/1301/68441) | 学习数据建模方案，为应用准备所需的服务端数据。             |
| [发布应用](https://cloud.tencent.com/document/product/1301/95853) | 了解应用的发布步骤，实现应用的上线使用。                   |
| [3分钟开发表单应用](https://cloud.tencent.com/document/product/1301/49510) | 完成第一款应用的开发上线，熟悉应用开发链路。               |
...
如您有其他任何问题，欢迎在 [微搭官方社区](https://developers.weixin.qq.com/community/minihome/mixflow/2300422336543784966) 中和我们沟通交流，祝您早日精通微搭，成为优秀的低代码应用开发者。
