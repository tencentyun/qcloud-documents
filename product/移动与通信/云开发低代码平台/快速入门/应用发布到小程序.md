...
>?电商交易模板创建的应用，您可参见 [电商交易模板使用文档-接入指引](https://cloud.tencent.com/document/product/1301/58852#.E6.8E.A5.E5.85.A5.E6.8C.87.E5.BC.95)。在发布小程序前，添加小程序交易插件，开通标准交易组件等操作。方可便发布成功。
