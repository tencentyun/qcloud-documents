...
2. 组件编辑器介绍
![](https://main.qcloudimg.com/raw/e0ccf40fdf243b2be2e0191ab0e6b4f3.jpg)
<table>
<tr>
<th>模块</th>
<th>功能</th>
...
<tr>
<td >组件大纲树</td>
<td>展示完整的组件大纲结构，与应用编辑器的大纲树功能类似，但只允许存在一个根节点，一般需要在顶层使用一个容器组件(如Container)作为根结点，然后往里面添加组件。 </td>
</tr>
<tr>
<td>组件库</td>
...
<tr>
<td>属性配置区</td>
<td>该区域包括了“元素配置”和“组件配置”两种，“元素配置”指对使用到的单个组件元素进行数据。样式或事件的修改，“组件配置”针对的是该次编辑用到的所有组件，且只能以源码的方式进行编辑。 </td>
</tr>
</table>
