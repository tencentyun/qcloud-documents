...
- 开通云开发
  使用待开发的小程序登录 [微信公众平台](https://mp.weixin.qq.com)：
	...
	2. 根据提示开通云开发。
	![](https://main.qcloudimg.com/raw/6e84d9a5f4ce9aff2605a8b2520a9e20.png)
- 创建低码应用
...
使用小程序 AppID 对应的小程序登录 [微信公众平台](https://mp.weixin.qq.com) ，在左侧菜单栏中选择【开发】>【云开发管理】>【开发设置】>【小程序代码上传】。
...
1. 单击应用卡片上的【编辑】，可以直接进入到应用的编辑器。
![](https://main.qcloudimg.com/raw/0bc8bcf4bb0947295bdace002b38c761.png)
2. 在应用编辑器即可开始应用设计。
