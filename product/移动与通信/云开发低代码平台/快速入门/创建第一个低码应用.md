...
<img src="https://main.qcloudimg.com/raw/530177803ab483385432bc99f6a3f966.jpg" width="90%"></img>
2. 单击后需 [填写应用基础应信息](#step5-1) 并 [完成前期准备](#step5-2)。前期准备是开发小程序的准备工作，您也可以选择在发布前再完成。
