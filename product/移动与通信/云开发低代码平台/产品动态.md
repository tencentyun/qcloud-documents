...
<tr>
<td >支持调用第三方微信小程序插件</td> 
</tr>
<tr>
<td >新增微信支付、文件上传、登录、图表、地图组件</td> 
</tr>
<tr>
<td >模型组件支持关系字段下钻及回显主列字段名称</td> 
</tr>
<tr>
<td >列表组件优化:支持筛选功能</td> 
</tr>
...
<tr>
<td >支持更多模型字段类型(自动编号字段、主列字段、文件字端、地理位置字段)</td> 
</tr>

<td rowspan="5">用户角色权限</td>
<tr>
<td >支持企业组织架构</td> 
</tr>
<tr>
...
<tr>
<td >身份验证支持第三方认证源sso</td> 
</tr>
<tr>
<td >数据源支持多层级行权限、列权限以及数据源方法权限</td> 
</tr>
...
<tr>
<td >企业工作台整体框架风格优化，满足不同场景主题风格</td>
</tr>


<td rowspan="2">模板中心</td>
<tr>
<td >新增七套模板
</tr>

<td rowspan="3">平台优化</td>
<tr>
<td >支持自定义域名
</tr>
<tr>
