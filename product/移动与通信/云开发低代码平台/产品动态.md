...
<li>数据容器上下文：数据容器作为核心的数据供给组件，增加上下文能力。用于存储、查询、更新和新建数据，简化数据获取操作的复杂度。<a href="https://docs.cloudbase.net/lowcode/components/wedaUI/src/docs/compsdocs/database/DataContainer">数据容器文档</a>。<br></li>
