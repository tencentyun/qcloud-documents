...
![](https://main.qcloudimg.com/raw/ce2a5a4792f6eb6db0de8bde5fd47a87.png)

##  步骤2：定义数据源[](id:step2)
传统开发流程需要先进行需求分析，分析完成后需要按照需求进行数据库的设计，在腾讯云微搭低代码平台中，只需在控制台左侧的**数据源管理**中自定义数据源即可，无需单独构建数据库。

1. 进入**数据源管理**页面，单击**新建自建数据源**。
![](https://main.qcloudimg.com/raw/b96da543dbf7ef889d688e7e3e6e947c.png)
2. 在打开的页面里，**数据源名称**输入问卷调查，**数据源标识**输入 survey，单击**开始新建**。
![](https://main.qcloudimg.com/raw/8e8fb017308894b4c67f997ca937d202.png)
...
2. 编辑器分为三个部分，可归纳为菜单区，组件页面选择区，编辑预览区。
 ![](https://main.qcloudimg.com/raw/590fa051940f10ddf279c62cb2d20f14.png)

### 使用表单容器快速生成表单
使用编辑器自带的表单容器即可通过绑定数据源进行表单的快速生成，操作方式如下:
1.在左侧组件区点击表单容器组件，使组件进入编辑器中。
![](https://main.qcloudimg.com/raw/3587e2b606911d35acb8a8eabaf0bbc3.png)
2.在编辑器右侧将表单容器与刚刚创建的数据源进行绑定，表单类型选择**新建**，数据源选择**问卷调查**，数据源方法选择**创建单条记录-内置**。
![](https://main.qcloudimg.com/raw/215bb830c9342b746d2bda65389d73d9.png)
3.配置完成后在弹出的窗口中单击**确定**。
![](https://main.qcloudimg.com/raw/fd0ac20fa74a8cb20dc6ce554099a6ac.png)
4.可以看到表单会按照数据源中配置的字段自动的生成完毕。
![](https://main.qcloudimg.com/raw/aeccd0b2b7d8a734f8976532cf716987.png)



## 步骤4：应用发布[](id:step4)
表单生成完成后单击右上角**发布**，即可开始进行应用的发布。
![](https://main.qcloudimg.com/raw/040d8dd85a575bc3ffc864043363e24e.png)
