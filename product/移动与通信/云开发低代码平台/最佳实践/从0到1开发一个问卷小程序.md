...
![](https://main.qcloudimg.com/raw/c9813a4006c51f1990dc2f43b284c277.jpg)
...
## 步骤1：新建低码应用
### 创建应用
单击左侧导航栏的【应用管理】，在中间的内容区域单击【创建空白应用】。
...
在打开的页面里，数据源名称输入问卷调查，数据源标识输入 survey。
![](https://main.qcloudimg.com/raw/1a4849947a9d2a320acb6433ead1f6a5.jpg)
单击【添加字段】按钮，添加数据源相关字段。
![](https://main.qcloudimg.com/raw/5502145189caadf4b38bb41771de8db9.jpg)
此处，先增加一个姓名的字段，字段标识为 name，字段类型为【字符串】，是否必填选择【是】，是否枚举选择【否】，设置完毕后单击【确定】就增加了一个字段。
![](https://main.qcloudimg.com/raw/df830ca2c01813a2670d857c47a0aa11.jpg)
相同地，添加手机的字段，字段标识为 phone，字段类型为【字符串】，是否必填选择【是】，是否枚举选择【否】，单击【确定】。
![](https://main.qcloudimg.com/raw/677efc8894e17fb54667c780c9b2e1d1.jpg)
添加职业的字段，字段标识为 job，字段类型为【字符串】，是否必填选择【是】，是否枚举选择【否】，点击【确定】。
![](https://main.qcloudimg.com/raw/e338b4aecf105b3fd39c93bc3fb57c24.jpg)
添加第一个所属行业的字段，字段标识为 industry，字段类型为【字符串】，是否必填选择【是】，是否枚举选择【否】，点击【确定】。
![](https://main.qcloudimg.com/raw/1b649d8af6a60aace528c7bc47e39b48.jpg)
由于参与问卷调查用户只需提交即可，因此设置【动作】时只需勾选【新增】方法，其他均保持默认。设置完毕后需要单击页面底部的【立即创建】按钮，否则刚才添加的字段都不生效。
![](https://main.qcloudimg.com/raw/bec79351d7e5c432513430a781deb5c4.jpg)

## 步骤3：设计页面
### 创建页面
数据源设置完毕后就需要创建页面，单击【应用管理】，找到刚才创建的应用，单击【编辑】按钮进入应用编辑器。
![](https://main.qcloudimg.com/raw/56f22a8bc6ce2890c5dbc0539d20e493.jpg)
编辑器分为四个部分，可归纳为导航条，组件选择区，编辑区，和属性面板。
...
### 引入数据源
本项目的目的是让用户填写问卷调查，再将内容保存到数据库中，所以需要先为问卷引入数据源。单击导航条上的【变量管理】。
![](https://main.qcloudimg.com/raw/75d263c9e0d851a3fed72d41a2e97eec.jpg)
在打开的页面找到首页 index 下边的【状态变量】，单击旁边的【+】号，依次录入变量标识和变量名为 survey，变量类别选择【数据源模型】，数据源选择【问卷调查（survey）】，变量类型选择【新纪录】，变量更新动作选择【创建单条记录】，设置好后单击【提交】按钮。
...
### 头部编写
头部信息需要先加入一个容器组件：选中 header，并单击【容器】组件。
![](https://main.qcloudimg.com/raw/aa72dee95024b311dc01b0c99969343a.jpg)
选中容器组件后，在左侧的组件面板中单击【文本】组件，并修改文本的内容，内容可参考：“尊敬的云开发低码用户，为了更好地提升云开发低码平台的体验和服务，我们特展开本次的问卷调查，希望能得到您的真实想法与宝贵意见，本问卷将花费您5分钟时间。”
![](https://main.qcloudimg.com/raw/64ec6008520e8357781e410b693b3ad9.jpg)
同时，可根据业务需求在右侧的组件编辑区调整视觉样式。例如，选中容器组件切换到样式标签，将组件的内边距左右各设置20个单位距离。
![](https://main.qcloudimg.com/raw/5fa13122e7c8a78825299e62a730cd72.jpg)

### 内容编写
选中 content 插槽，单击【容器】组件，此处先放一个【容器】组件。
...
之后就是依次加入调查项，此案例中调查项分为姓名、手机、所属行业和职业，具体的组件选择的，姓名选择【表单输入】，手机选择【表单手机号码】，其余的都选择【表单单选】。选中插槽 content Slot 组件，然后单击【表单输入】组件，表单字段名称设置为 name，【标题】设置为【姓名】，【是否必填】开关设置为【开】。
![](https://main.qcloudimg.com/raw/116bfa18ffed05b7a3756c4e140ece46.jpg)
再单击【表单手机号码】组件，设置该组件的表单字段名称为 phone，标题为手机，是否必填开关设置为开。
![](https://main.qcloudimg.com/raw/1507b8ec33456298d0f423b50c0eb1a0.jpg)
再单击【表单单选】组件，设置表单字段名称（字段名称填写为 job），组件的标题（我的职业是），将布局方式改为垂直，并依次增加单选项的内容，单选项名称分别为前端开发、后台开发、设计师、运营、产品策划、其他，单选项的值分别设置为 first、second、third、fourth、five、six。
![](https://main.qcloudimg.com/raw/d1e8bcf237f4d3b5884b2e85afa82d72.jpg)
按照同样的方法增加所属行业调查项,字段名称需要填写为 industry，标题设置为“我所属的行业是”，单选项名称分别为金融、工业、教育、医疗、政务、IT互联网、其他，单选项的值分别为 first、second、third、fourth、five、six、seven
![](https://main.qcloudimg.com/raw/040ec7785a90efcd2382d0c1550a6adc.jpg)
调查项添加完毕后，单击【按钮】组件，修改标题为确认提交。
![](https://main.qcloudimg.com/raw/8d765e8ecfffea9bf6286433f943f287.jpg)
然后选择【表单容器】，切换到【事件】页签，选择事件为 submit。
...
数据源名称选择问卷调查，方法名设置为 create，传入参数设置为 event&event.detail。
...
构建模式开启成功后就可以预览了，编译需要个过程，编译好了之后会弹出浏览地址。
