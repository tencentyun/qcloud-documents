...
2.查看区块自带的cardList变量设置数据源字段与模拟数据，如下图所示。

![](https://qcloudimg.tencent-cloud.cn/raw/73eb4d3856d29ba43573ab1bd01916e5.png)
3.进入**数据源管理-创建自建数据源**，按照cardList的结构进行数据源的字段创建。
...
1.点击事件Tab，选择动作类型-自定义方法，点击管理自定义方法按钮进入低码编辑器。
