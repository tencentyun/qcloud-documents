...
>? 模型字段的数据类型将会影响应用中表单组件的相关样式。您可以灵活尝试体验各种数据类型，例如枚举类型，当我们想要做一个选择框实现用户点击后进行单选或者多选的功能，首先在**数据源** > [**通用选项集**](https://console.cloud.tencent.com/lowcode/option-set) 中新建一个通用选项集，输入选项集名称，设置选项标识和选项值。
>![](https://qcloudimg.tencent-cloud.cn/raw/95d4db519daa1a46f66fa008822d6a42.png)
>之后在数据源中添加字段选择数据类型为枚举，可以设置单选/多选，关联选项集选择刚建立的通用选项集，单击**确定**。
>![](https://qcloudimg.tencent-cloud.cn/raw/44c924f40bd8cd37f02d1c897de67b44.png)
...
<img src="https://qcloudimg.tencent-cloud.cn/raw/4700ae49a772c6ebd4e8fc5a38c918c8.png" style="width:50%"> 
6. 之后进入数据模型 > **数据管理后台**。
...
2. 在左侧组件区中单击**数据列表**组件，将组件添加到编辑区中。
![](https://qcloudimg.tencent-cloud.cn/raw/7332ae556257b3c302ac364d193d7a89.png)
