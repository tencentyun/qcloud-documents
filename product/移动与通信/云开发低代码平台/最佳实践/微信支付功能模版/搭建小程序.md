...
>
![](https://qcloudimg.tencent-cloud.cn/raw/221c9db19a8f1ee3e1cafcc43290057e.png)
创建订单成功后，调用数据源方法，根据返回值的数据唯一标识，查询订单信息。
![](https://qcloudimg.tencent-cloud.cn/raw/7897f5e74535b6e2b5767d6571c4614d.png)
查询成功回调，返回值赋值给提前设置好的全局变量，用于接下来发起支付时传输订单号。
![](https://qcloudimg.tencent-cloud.cn/raw/a15f2118ae2a135d6499819e1e4460ec.png)
 - **第二步：发起支付。**
...
>
![](https://qcloudimg.tencent-cloud.cn/raw/674e8b58e051c1c10dcc9ea080df39e3.png)
  调用成功后，才能使用自定义方法，调用编辑器写好的发起支付命令，发起微信支付。
![](https://qcloudimg.tencent-cloud.cn/raw/d038491fd9645e102a902e1fb8c9873e.png)
应用调用如下图：
![](https://qcloudimg.tencent-cloud.cn/raw/e68aa17425fb882cb8094236eb612b88.png)
  - **第三步：根据支付结果更新订单状态。**
...
2. 单击申请退款。
首先打开弹窗，由用户确认是否发起退款。
![](https://qcloudimg.tencent-cloud.cn/raw/32eed612ceca2fd41752b2e89a2812fe.png)
确认发起退款后，调用 APIs **微信支付模板功能申请退款**方法。
![](https://qcloudimg.tencent-cloud.cn/raw/074b5de57da220b4d85f398ec7070429.png)
3. 根据退款结果更新订单状态。
申请退款接口调用成功的回调，更新支付状态为3退款中。
![](https://qcloudimg.tencent-cloud.cn/raw/8e3500b1de1e9110d3835a5cba169ddc.png)
