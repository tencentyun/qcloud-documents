...
### 邀请查询
页面顶部使用【顶部导航】组件显示页面标题。
![](https://qcloudimg.tencent-cloud.cn/raw/b96a674a6f747947743f3a782a7e8df3.png)
页面内容放在一个【普通容器】组件里面，使用了【单行输入】组件、【文本】组件和【按钮】组件。
在“邀请查询”页面下创建变量“telephone”。
...
【表单容器】组件“提交”事件绑定显示加载和自定义方法“apply”。
其中apply方法的低码如下：
...
【图标】组件绑定页面跳转事件，跳转至“我的预约详情”页面，创建页面参数“id”，传递参数为“数据标识”。
![](https://qcloudimg.tencent-cloud.cn/raw/94cd1a59957187533a9cae0ccb950542.png)
第二个【分组列表容器】嵌套三个【普通容器】组件，【普通容器】组件里面设置【文本】组件和【图标】组件。
【文本】组件的文本内容设置“访客码”。
【图标】组件在内置样式里面选择“qrcode”。
在“我的访客码”页面设置传递变量“fkm”、“endtime”，给【图标】绑定页面跳转事件，跳转至“我的访客码”页面，传递参数。
...
“审批中”和“已拒绝”两个内容插槽中都使用【数据列表】组件，绑定数据模型都是“预约访客”，只是筛选条件“审批状态”对应的过滤值不一样，分别是“审批中”、“已驳回”。
其它设置可以参考“已通过”内容插槽的数据绑定。
### 我的预约详情
页面顶部使用【顶部导航】组件显示页面标题。
![](https://qcloudimg.tencent-cloud.cn/raw/eadf6b2608affd3ca5be02121fc229d9.png)
页面内容统一放在【普通容器】组件里面，【普通容器】中使用【数据详情】组件，绑定数据模型“预约访客”。
![](https://qcloudimg.tencent-cloud.cn/raw/e94d5bdaf87931fa760e11a5dfcda937.png)
数据筛选条件设置“数据标识”等于从“我的预约申请”页面传递过来的变量参数“id”。
![](https://qcloudimg.tencent-cloud.cn/raw/3a1752304a92d3f1188c3dc4b5fed411.png)
其它内容使用【文本】组件文本内容绑定数据的方式。
### 我的访客码
页面顶部使用【顶部导航】组件显示页面标题。
![](https://qcloudimg.tencent-cloud.cn/raw/95457e87d2f934f3aea0dd22cd9f7996.png)
页面内容实用两个【普通容器】组件。
第一个【普通容器】中使用【图片】组件。
![](https://qcloudimg.tencent-cloud.cn/raw/69ef86181a0692d1e9178a8f5261fc20.png)
图片地址绑定一个可以传递参数并生成QRcode的公网地址，传递的参数是：
...
公网地址用户自行查找相关免费资源。
第二个【普通容器】中使用【文本】组件。
![](https://qcloudimg.tencent-cloud.cn/raw/5e32a1987a1225ea2ffa35b2a2a175b7.png)
文本内容绑定表达式
