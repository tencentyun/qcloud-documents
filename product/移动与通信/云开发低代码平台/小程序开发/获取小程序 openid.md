## 获取方式
关于微信 openid 的说明请参见 [小程序 open ID 说明](https://developers.weixin.qq.com/community/develop/article/doc/00082a04b94c00a9f3eb879ba5ac13)。
...
3. 选择表达式中的**变量** > **全局** > **登录用户信息** > **微信/企微 openid** 后，小程序用户的 openId 获取路径就会自动填写到表达式中，单击保存。
