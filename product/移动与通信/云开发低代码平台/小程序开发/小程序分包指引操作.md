...
## 操作步骤
### 步骤1：应用及子模块的新建
1. [](id:step1)进入 [**创建新应用**](https://console.cloud.tencent.com/lowcode/create/) 页面，单击**新建自定义应用**。**支持平台**选择**小程序**。若您计划在微搭从零开始搭建小程序，**开发模式**选择**低代码开发**，若您计划基于已有的小程序代码与低码结合开发，**开发模式**可选择**代码包上传**。单击**新建**之后即可创建应用并进入微搭编辑器。
