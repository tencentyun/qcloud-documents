...
[](id:step1)
## 步骤1：创建自定义应用
1. 登录 [微搭控制台](https://console.cloud.tencent.com/lowcode)，进入**快速开始** > **创建应用**页面，选择**新建自定义应用**。
![](https://qcloudimg.tencent-cloud.cn/raw/0340f51a9ecf1a29f1cdbf45bdab476e.png)
...
[](id:step3)
## 步骤3：创建自定义 API 并添加用于解密手机的自定义方法
1. 进入 [自定义 API](https://console.cloud.tencent.com/lowcode/datasource/custom-connector?envId=lowcode-5gb79k26c34e9bdb) 管理页面，单击**新建自定义 API **进行自定义 API 的创建。
...
5. 单击下方**添加入参**，设置入参标识为 cloudId，如下图所示：
...
export default async function ({event, data}) {
    ...
    { dataSourceName: 'getphonenum_t3i3ptl',  //自定义 API 标识
        methodName: 'method_58e0350156022',  // 自定义 API 方法标识
