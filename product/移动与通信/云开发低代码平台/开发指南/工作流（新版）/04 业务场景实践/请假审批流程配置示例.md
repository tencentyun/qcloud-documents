...
### 场景说明
外部用户通过外部应用创建访客申请
内部用户登录内部管理后台，对访客申请进行审批
<img src = "https://qcloudimg.tencent-cloud.cn/raw/bbe29ab4b12751d6db6fa814bf7c2f19.png" style="width: 80%">

### 配置步骤
#### 前置准备
- 新建好访客预约表单的数据模型，请参见 [创建数据模型](https://cloud.tencent.com/document/product/1301/68452) 相关文档。
- 创建保卫处的角色，并分配给相关用户，请参见 [用户权限](https://cloud.tencent.com/document/product/1301/82052) 相关文档。
- 创建好对应的外部访客应用、企业内部管理模型应用，请参见 [应用创建](https://cloud.tencent.com/document/product/1301/48868) 相关文档。


1. 新建名称为**访客预约**的流程。
2. 开始节点配置流程输入参数。
3. 添加审批节点，命名为**保卫处审批**，并配置相关属性。
4. 检查配置无误后，保存或发布流程。
5. 新建数据模型后事件，并触发关联流程。
6. 在外部访客应用中创建访客预约申请，登录企业工作台访问企业内部管理应用，查看触发的审批流程。



## 周报提醒通知
### 场景说明 
每周五上午九点给所有人发送通知，提醒提交周报。
<img src = "https://qcloudimg.tencent-cloud.cn/raw/bd185bf62596e302710b4b215643a287.png" style="width: 80%">

### 配置步骤
1. 新建名称为**周报提醒**的流程。
2. 添加**企业工作台站内通知**节点，命名为周报提醒，并配置相关属性。
3. 保存流程。
4. 新建定时任务并关联流程。
