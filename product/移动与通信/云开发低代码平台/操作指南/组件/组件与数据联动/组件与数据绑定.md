...
3. 将需要绑定数据的组件拖入数据容器内，单击**绑定字段**，即可选择数据容器的数据。
   ...
   如 1 分钟内快速展示一个数据列表：
   <img style="width:978px; max-width: inherit;" src="https://wdoc-76491.picgzc.qpic.cn/MTY4ODg1MDUyMzIwMDY3MA_521955_gADgM4ql2roQkOhw_1666670207?w=1280&h=686.0668380462726&type=image/gif" />
