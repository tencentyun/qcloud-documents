...
### 自定义 API 使用场景
当数据源配置时选择 [自定义 API ](https://cloud.tencent.com/document/product/1301/68457)，需用户自行在自定义 API 内按照参数结构定义数据，才可正常在统计卡片组件内渲染，详情请参见 [图表组件参数定义](https://cloud.tencent.com/document/product/1301/71197)。

>? 当使用自定义 API 时，数据筛选、字段选择、统计方式、统计空值属性均需用户在所建自定义 API 内自行定义，其他属性与数据模型使用场景配置保持一致。
