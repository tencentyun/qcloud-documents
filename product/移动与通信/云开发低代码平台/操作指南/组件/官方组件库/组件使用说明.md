...
<table>
        ...
        <tr>
            ...
            <td>添加图片</td>
            <td>
                <a href="https://docs.cloudbase.net/lowcode/components/wedaUI/src/docs/compsdocs/media/Image">查看文档</a>
            </td>
        </tr>
                    <tr>
            <td>图标</td>
...
<table>
        ...
        <tr>
            ...
            <td>适用于查看数据详情场景。</td>
            <td>
                <a href="https://docs.cloudbase.net/lowcode/components/wedaUI/src/docs/compsdocs/senior/ModelDetail">查看文档</a>
            </td> </tr>
            <tr>
                <td>表格组件</td>
