...
3. 按 **[通过变量获取和改变表单值](https://cloud.tencent.com/document/product/1301/83709#.E8.A1.A8.E5.8D.95.E7.BB.84.E4.BB.B6.E6.B8.85.E7.A9.BA.E8.BE.93.E5.85.A5.E6.88.96.E9.80.89.E6.8B.A9.E5.86.85.E5.AE.B9)** 的方案，实现该变量可获取到单选组件的选中值（双向数据绑定）。
...
:::
 ...
 ![](https://qcloudimg.tencent-cloud.cn/raw/a69f7e938f681ac5e1c9f4a8dfd7d387.png)
...
2. 找到组件的**可见**属性，将其**关闭**。
>!关闭**可见**属性的表单组件，其组件值会正常提交入库，同时不会触发必填等校验。
>
![](https://qcloudimg.tencent-cloud.cn/raw/9ff9b8ae7f291eddedfc8d3c3b4d5871.png)
