...
#### 扩充资源包系统限制
除 [上表](#table1) 中展示的指标，还需遵循 [资源包的系统限制](#table2)。在一个计费周期内，若资源包某项系统限制指标使用量超出当前配额限制，系统将限制对该资源的使用。超限后如需恢复使用，请前往控制台 [资源管理](https://console.cloud.tencent.com/lowcode/resource) 页面单击**立即上配**升配资源包。
![](https://qcloudimg.tencent-cloud.cn/raw/c6451f16481ffdd06a3bd1cf61dc023c.png)
