...
<li>扩充资源包除 <a href="#resourcepack">上表</a> 所列指标外，还包含 <a href="#system_limitations">资源包的系统限制</a>。在一个计费周期内，若资源包某项系统限制指标使用量超出当前配额限制，系统将限制对该资源的使用。超限后如需恢复使用，请前往控制台 <a href="https://console.cloud.tencent.com/lowcode/resource" target="__blank">资源管理</a> 页面升配资源包。</li>
</ul>
</dx-alert>
