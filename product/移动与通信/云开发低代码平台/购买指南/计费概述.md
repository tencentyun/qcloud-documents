...
- <strong>团队版</strong>：原价 168 元/月，7 月限时优惠价 88 元/月。快速开发小程序和零代码搭建业务数据管理应用，并可与外部系统打通。套餐内包含的应用运行的基础资源如文件、数据等，您可根据业务情况扩充购买。最多可添加 5 个 [企业内部用户](https://cloud.tencent.com/document/product/1301/67262)，超出将按[用户阶梯收费](#license)</a>。
