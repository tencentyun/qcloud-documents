## 微搭套餐概述
腾讯云微搭低代码平台按照是否收费和平台功能分为体验版、基础版、高级版。其中体验版为免费版本，所有用户均可享有15天免费试用，试用结束后，您可根据需要升级基础版或高级版。
<dx-alert infotype="explain" title="">
<li>基础版低码能力免费，只收取底层资源费用。</li>
<li>高级版享有高阶产品特性。</li>
</dx-alert>
...
#### 我可以免费体验微搭能力吗？
可以的，每个用户享有15天免费适用时长，试用结束后，您可根据需要升级基础版或高级版。

#### 当前套餐包含的DAU不足以支持线上业务，如何升级？
平台支持[环境包自由升配](#upgradeEnv)，您可按需升级环境包。
