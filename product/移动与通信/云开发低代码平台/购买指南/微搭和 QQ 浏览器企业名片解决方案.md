...
## 产品收费标准
4800元/客户/年 包含：微搭低代码平台、特定行业小程序模版（具体模版内容根据所选行业有所不同，详见模版介绍）、QQ 浏览器企业名片能力、服务窗权益。
...
您需要升级您的 QQ 浏览器版本。在 QQ 浏览器 iOS 11.2.5、安卓11.3.0以上的版本才可搜索到服务窗使用小程序相关服务。

#### 产品提供的过程中，是否会涉及到用户信息的获取和使用？
客户提交的相关信息数据，由腾讯云收集后转给 QQ 浏览器， QQ 浏览器对客户的此类企业信息只会用于企业名片的产品应用，不会用于其他用途。
微搭只提供小程序模版，本身不会对客户提供产品过程中涉及的用户信息进行收集或其他处理。客户创建的小程序内的逻辑是否获取用户信息，为客户自己实现，小程序发布主体需要为客户自己的主体，与腾讯无关。

#### 微搭和 QQ 浏览器企业名片、服务窗是什么关系？（涉及到企业名片跟服务窗的部分，请师丁丁律师评估)
微搭和 QQ 浏览器解决方案中，由微搭侧提供小程序模版，QQ 浏览器侧提供企业名片和服务窗能力。
客户需将小程序部署在自己账号内，自行发布小程序，并后续提交企业名片服务信息，由浏览器侧进行配置。
- 微搭：售卖微信小程序搭建的模板，购买后将部署在客户账号下，由客户进行运营。
- QQ 浏览器企业名片：面向企业提供的企业信息聚合及展现能力，提供关键词收录服务，会根据客户所提交服务信息，将提交信息内的微信小程序放置在搜索结果中，用户点击搜索结果直接跳转到微信小程序。
- QQ 浏览器服务窗：通过行业通用词聚合呈现企业服务能力，提供关键词收录服务，根据客户所提交服务信息，将提交信息内的微信小程序入口放置在搜索结果服务窗中，用户点击服务窗中的小程序入口直接跳转到对应微信小程序。
...
企业名片挂载的是企业客户自己的微信小程序，无需单独制作，只需要提供小程序相关信息即可挂载至 QQ 浏览器，用户点击后可以直接在 QQ 浏览器内拉起小程序，不需要跳转至微信。
