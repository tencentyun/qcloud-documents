...
- 在微搭低代码**用户权限** > [**用户管理**](https://console.cloud.tencent.com/lowcode/permission/user) 页面，系统管理员已经为该用户分配了应用的账号和密码，详情请参见  [用户管理](https://cloud.tencent.com/document/product/1301/67262#manage) 。
