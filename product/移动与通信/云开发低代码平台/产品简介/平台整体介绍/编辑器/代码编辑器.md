使用代码编辑要求开发者有一定的 JavaScript 基础，它能帮助开发者在使用微搭低代码进行拖拽式开发时，根据业务需求完善应用的逻辑丰富度和复杂度。对于开发经验较为缺乏的开发者，我们的组件库也提供了封装好的方法能够直接使用。平台提供通用的 API 接口，供您在代码编辑器中调用 [API 接口](https://cloud.tencent.com/document/product/1301/56700) 查看。
