...
## 模型方法
标准数据模型支持以下模型方法：新增 wedaCreate、新增多条 wedaBatchCreate、删除 wedaDelete、批量删除 wedaBatchDelete、更新 wedaUpdate、批量更新 wedaBatchUpdate、查询 wedaGetItem、查询列表 wedaGetRecords。
各数据模型的参数说明及示例用法，可以参见 [数据模型方法](https://cloud.tencent.com/document/product/1301/86772)。
