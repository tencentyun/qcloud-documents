...
## H5/Web端开发场景
微搭可以支持H5、PC Web端应用开发，支持展示类，表单类，企业官网等各种场景的开发。
...
可轻松实现多人/多团队协作、表单构建、用户权限管理、BI 报表、工作流管理等能力，助力企业快速打造高质量应用。
可使用[**模型应用**](https://cloud.tencent.com/document/product/1301/67252)实现企业级应用开发
