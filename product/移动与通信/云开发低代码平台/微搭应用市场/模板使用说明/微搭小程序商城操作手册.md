...
## 步骤3：小程序配置
进入运营管理端，【基础配置】>【小程序配置】页面。输入相应的小程序 Appid 和密钥完成配置。
...
微搭管理提供了系统默认风格的切换功能，可以根据对应的行业选择喜欢的风格样式进行切换。
![](https://main.qcloudimg.com/raw/7e297b58f53063f8f6a2988b88ff8359.png)
