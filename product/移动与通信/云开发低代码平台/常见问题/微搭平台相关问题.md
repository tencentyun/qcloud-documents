...
[](id:que15)
### 系统服务器只支持http方法获取数据，需要以text格式发送post内容，如何能实现从服务器获取数据？
您可以使用自定义连接器 - 自定义代码的方式实现：[自定义代码（云函数）](https://cloud.tencent.com/document/product/1301/68440)。


[](id:que16)
### 如何使用腾讯文档，多表添加数据，并导出？
目前腾讯文档连接器里提供的方法：[方法](https://docs.qq.com/open/wiki/sheetapi/v2/sheetbook/add_sheet.html)。
