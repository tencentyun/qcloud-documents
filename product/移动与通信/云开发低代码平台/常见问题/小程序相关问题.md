...
### 全托管认证的小程序如何配置业务域名？
全托管认证小程序后，可以在微信公众平台配置业务域名，具体操作可以参考https://developers.weixin.qq.com/miniprogram/dev/framework/ability/network.html

### 重置了小程序的AppSecret或者服务域名，是否会影响小程序使用？
会，请尽量避免重置AppSecret、服务域名以及代码上传密钥，若重置，请及时前往控制台重新认证小程序
