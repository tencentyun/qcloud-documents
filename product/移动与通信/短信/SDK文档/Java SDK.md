...
在开始本教程之前，您需要先获取 APPID 和 APPkey，如您尚未申请，请到 [短信控制台](https://www.qcloud.com/login?s_url=https%3A%2F%2Fconsole.qcloud.com%2Fsms%2Fsmslist) 中添加应用。应用添加成功后您将获得 APPID 以及 APPKey。
>**注意：**
> APPID 是以 14xxxxx 开头。
