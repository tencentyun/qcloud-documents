...
短信 Python SDK 在微云中的下载地址：[短信 Python SDK](https://share.weiyun.com/3e5630334a937685b66651f4058c5793)。
### 开发准备
...
```
> **注意：**
>  发送短信没有指定模板 ID 时，发送的内容需要与已审核通过的模板内容相匹配，才可能下发成功，否则返回失败。
...
```
> **注意：**
>  语音验证码发送只需提供验证码数字，例如 msg 内容为“123”时，您收到的语音通知为“您的语音验证码是 123”，如需自定义内容，可以使用语音通知。
