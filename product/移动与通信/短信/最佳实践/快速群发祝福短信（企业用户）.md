...
3. 结合实际情况和 [短信签名审核标准](https://cloud.tencent.com/document/product/382/13444#Sign) 设置以下参数：
 <table>
	 ...
	 <tr>      
       <td>证明上传</td>   
	     <td><img src="https://main.qcloudimg.com/raw/d7547d5ca6c257be994112409cf88a53.jpg" /></td>   
     </tr> 
</table>
3. 单击【确定】。
...
3. 结合实际情况和 [短信正文模板审核标准](https://cloud.tencent.com/document/product/382/13444#Template) 设置以下参数：
 <table>
	 ...
	 <tr>      
        <td>短信内容</td>   
	     <td>尊敬的{1}女生/先生，感谢您一直的支持与信任！在此新春佳节之际，衷心地祝福您及家人新年快乐、万事顺遂！</td>   
     </tr> 
</table>
4. 单击【确定】。
...
<span id="Step3"></span>
### 步骤3：等待审核
短信签名和正文模板提交后，我们将会在2个小时左右完成审核，您可以 [配置告警联系人](https://cloud.tencent.com/document/product/382/37810) 并设置接收模板和签名审核通知，便于及时接收审核通知。
...
3. 根据实际需求设置以下参数：
 <table>
	 ...
	 <tr>
	     <td>发送对象</td>   
	     <td>单击【下载标准模板】，参考 <a href="#Table2">模板表格示例</a> 填写的客户手机号和短信自定义内容，单击【选择文件】上传表格。</td>   
     </tr> 
</table>
 模板表格示例如下表所示。
 <span id="Table2"></span>
