...
![](https://qcloudimg.tencent-cloud.cn/raw/7c505dba928a2fbe183013f906df730f.png)
2. 开通后，进入短信控制台后，可跟随**概览页**>**新手配置指引**配置申请短信模板并发送短信。
![](https://qcloudimg.tencent-cloud.cn/raw/02f69a1172433d3f082bedf4a58f1cc9.png)
...
>?发送国际港澳台短信可以不携带签名，“创建签名”为可选项。本文以不带签名为例。
### 创建签名
1. 在 [快速入门](https://console.cloud.tencent.com/smsv2/guide) 页面，选择“我要发送国际港澳台短信”后，进入页面，单击**创建签名**。
![](https://qcloudimg.tencent-cloud.cn/raw/d1db09a7baeedeaa74db7a34e05df78f.png)
![](https://qcloudimg.tencent-cloud.cn/raw/d1db09a7baeedeaa74db7a34e05df78f.png)
2. 结合实际情况和 [签名审核标准](https://cloud.tencent.com/document/product/382/39022) 设置以下参数：：
 - 签名用途：选择**自用（签名为本账号实名认证的公司、网站、产品名等）**。
 - 短信类型：选择**公司**。
 - 短信内容：输入`Your verification code is 1234(valid for 5 minutes). For account safety, don't forward the code to others.`。
 - 证明类型：选择**三证合一**。
 - 证明上传：上传证书照片或扫描件。
3. 单击**确定**。
...
[](id:Template) 
### 创建正文模板
在 [概览页](https://console.cloud.tencent.com/smsv2) 页面，**新手配置指引**>**国际/港澳台短信**>单击**创建模板**。
![](https://qcloudimg.tencent-cloud.cn/raw/d1db09a7baeedeaa74db7a34e05df78f.png)
## 步骤3：等待审核
短信签名和正文模板提交后，我们将会在2个小时左右完成审核，如有需求可设置常用手机和邮箱，用于及时接收短信内容审核通知。
您可以了解最新申请签名和模板的审核状态，待签名与正文模板状态变为**已通过**时才可用。
![](https://qcloudimg.tencent-cloud.cn/raw/ba25dcb5f2ce8dad3d55b0d5997e5a54.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/04e5a96187d17ed90a75a90819769e89.png)
2. 根据实际需求设置以下参数：
