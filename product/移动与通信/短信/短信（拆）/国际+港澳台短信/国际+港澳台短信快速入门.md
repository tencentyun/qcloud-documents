本文以企业认证用户创建一个名为“TEST”的应用，并使用该应用向境外手机用户发送`[Tencent Cloud]Your verification code is 1234(valid for 5 minutes). For account safety, don't forward the code to others.`为例，帮助您了解如何快速使用国际/港澳台短信服务。
