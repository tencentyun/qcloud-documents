...
3. 结合实际情况和 [短信签名审核标准](https://cloud.tencent.com/document/product/382/13444#.E7.AD.BE.E5.90.8D.E5.AE.A1.E6.A0.B8.E6.A0.87.E5.87.86) 设置以下参数：
 - 签名类型：选择【公司】。
...
3. 结合实际情况和 [短信正文模板审核标准](https://cloud.tencent.com/document/product/382/13444#.E6.99.AE.E9.80.9A.E7.9F.AD.E4.BF.A1.E5.AE.A1.E6.A0.B8.E6.A0.87.E5.87.86) 设置以下参数：
 - 模板名称：输入`验证码`。
 - 短信类型：选择【普通短信】。
...
## 发送短信
发送短信之前，您需要检查确认短信签名和短信正文模板均已通过审核，否则您需要重新 [创建签名](#Sign) 或 [创建正文模板](#Template) 直至都审核通过。
您通过控制台、云短信 [API](https://cloud.tencent.com/document/product/382/13297) 或 [SDK](https://cloud.tencent.com/document/product/382/5804) 发送短信，本文以使用控制台为例。
