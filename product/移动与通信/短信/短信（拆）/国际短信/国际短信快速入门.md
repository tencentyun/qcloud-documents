...
- 如果您的账号未实名认证，需先在 [账号信息页面](https://console.cloud.tencent.com/developer) 完成实名认证，再勾选服务协议，单击【开始接入】开通短信服务。实名认证的具体操作请参考 [实名认证指引](https://cloud.tencent.com/document/product/378/3629)。
