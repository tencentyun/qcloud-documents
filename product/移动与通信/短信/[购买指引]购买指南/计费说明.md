## 国内短信
国内短信根据短信内容长度按条计费，采用预付费的方式，且不支持使用通用代金券。您可以通过以下文档，获取国内短信的相关计费信息：
...
## 语音短信
语音短信采用预付费的方式，由语音号码月租（自购买日起顺延30天）费用和实际通话时长费用组成，且不支持使用通用代金券。您可以通过以下文档，获取语音短信的相关计费信息：
...
## 国际短信
国际短信根据短信内容长度按条计费，采用日结后付费的方式，且不支持使用通用代金券。您可以通过以下文档，获取国际短信的相关计费信息：

| 文档 | 说明 |
|---------|---------|
| [国际短信计费概述](https://cloud.tencent.com/document/product/382/18052) | 提供国际短信的内容长度计算规则、计费方式等信息。 |
| [国际短信价格总览](https://cloud.tencent.com/document/product/382/18051) | 提供国际短信的价格详情。 |
| [国际短信欠费说明](https://cloud.tencent.com/document/product/382/18060) | 提供购买国内短信套餐包的详细操作指引。 |
