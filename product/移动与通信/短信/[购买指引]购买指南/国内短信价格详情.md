国内文本短信采用预付费的方式，按[发送条数](https://cloud.tencent.com/document/product/382/9556#1-.E7.9F.AD.E4.BF.A1.E9.95.BF.E5.BA.A6)计费，需要[购买短信套餐包](https://buy.cloud.tencent.com/sms)。具体价格请参考下表。
### 国内文本短信价格表：
<table>
   <tr>
        <th>套餐（万条）</td> 
