...
## 语音短信价格详情
**目前语音短信仅支持中国大陆地区。**
语音短信采用预付费的方式，由语音号码费用和实际通话时长费用两部分组成，您需要 [购买语音号码](https://cloud.tencent.com/document/product/382/19744#buyNumber) 和 [语音短信套餐包](https://buy.cloud.tencent.com/voice)。
...
- 语音短信固定套餐包具体价格如下表所示：
 <table>
     <tr>
         ...
         <th nowrap="nowrap">套餐内单条价格（元/分钟）</th>  
     </tr>
	 <tr>      
         <td>1</td>   
	     <td>1050</td>   
