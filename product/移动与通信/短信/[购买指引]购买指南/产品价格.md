...
## 国内短信价格详情
国内文本短信采用预付费的方式，不区分短信类型仅按发送条数计算，每月赠送100条，详细计算规则可参见 [腾讯云国内短信定价](https://cloud.tencent.com/product/csms/pricing) 页面，需要 [购买短信套餐包](https://buy.cloud.tencent.com/sms)。
