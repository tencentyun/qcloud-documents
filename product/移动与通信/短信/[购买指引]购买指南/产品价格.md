...
## 国内短信价格详情
国内文本短信采用预付费的方式，按发送条数计算，详细计算规则可参见 [腾讯云国内短信定价](https://cloud.tencent.com/product/csms/pricing) 页面，需要 [购买短信套餐包](https://buy.cloud.tencent.com/sms)。
>!短信套餐包仅可用于国内文本短信，不包括语音短信和国际短信。企业用户可用于国内验证码、通知类以及营销类短信。个人用户不支持国内营销类短信，仅可用于国内验证码、通知类短信。
