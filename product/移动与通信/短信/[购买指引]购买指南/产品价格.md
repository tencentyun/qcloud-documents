...
## 国内短信价格详情
国内文本短信采用预付费的方式，按发送条数计算，详细计算规则可参见[短信内容长度计算规则](https://cloud.tencent.com/document/product/382/9556#.E7.9F.AD.E4.BF.A1.E5.86.85.E5.AE.B9.E9.95.BF.E5.BA.A6.E8.AE.A1.E7.AE.97.E8.A7.84.E5.88.99)计费，需要 [购买短信套餐包](https://buy.cloud.tencent.com/sms)。具体价格(包括验证码，通知，会员营销类短信)请参考下表。
<table>
   <tr>
        <th>套餐（万条）</td> 
		<th>套餐售价（元）</td> 
