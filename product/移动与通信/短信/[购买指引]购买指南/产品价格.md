...
## 国内短信价格详情
国内文本短信采用预付费的方式，不区分短信类型，仅按发送条数计算，详细计算规则可参见 [腾讯云国内短信定价](https://cloud.tencent.com/product/csms/pricing) 页面。每个腾讯云账户每月可赠送100条国内文本短信，除此之外您需要 [购买短信套餐包](https://buy.cloud.tencent.com/sms)，套餐包自购买日起两年内有效。
>!短信套餐包仅可用于国内文本短信，不可用于语音短信和国际短信。
>- 企业认证用户可使用的短信类型包括国内验证码、通知类以及营销短信。
>- 个人认证用户可使用的短信类型包括国内验证码和通知类短信。个人认证用户**不支持国内营销短信**。

- **企业认证用户**国内短信具体价格如下表所示：
<table>
   <tr>
        <th>套餐（万条）</td> 
		<th>套餐售价（元）</td> 
...
## 语音短信价格详情
**目前语音短信仅支持中国大陆地区。**
语音短信采用预付费的方式，您需要 [购买语音号码](https://cloud.tencent.com/document/product/382/19744#buyNumber) 及 [购买语音短信套餐包](https://cloud.tencent.com/document/product/382/19744#buyPackage)。
...
|号码单价（元/个）	|备注|
|--------|----------|
|50	|<li>购买时可根据实际需求勾选语音号码到期后自动续费。若未勾选自动续费，月租到期（自购买日起顺延30天）不续费，则该号码释放。</li><li>单个企业最多支持购买5个语音号码。</li>	|


### 语音短信套餐包
具体价格如下表所示：

|套餐（分钟数）	|套餐售价（元）|	套餐内单条价格（元/分钟）|
|--------|----------|----------|
|自定义分钟数（1000 - 9999）	|分钟数 × 单价<br>例如：1000分钟 × 0.11元/条 = 110元|	0.11|
|10,000	|1050	|0.105|
|100,000 |10,000	|0.1|
|500,000 |	47,500	|0.095|
|1,000,000|	90,000	|0.09|
|3,000,000|255,000	|0.085|
...
## 国际短信价格详情
国际短信采用 [月结后付费](https://cloud.tencent.com/document/product/382/18052#.E4.BB.98.E6.AC.BE.E6.96.B9.E5.BC.8F) 的方式。
[现有价格](#Existing) 以美元为单位，实际结算时以当月最后一天美元对人民币的汇率折算成人民币计费。
**自2019年8月1日起，国际短信的 [最新价格](#New) 将采用人民币定价，更多详情可单击下载 [国际短信人民币价格表](https://main.qcloudimg.com/raw/a628b96141b91d0ea680c2ab8f35535a.xlsx)。**
