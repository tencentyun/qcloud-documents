...
## 国内短信价格详情
国内文本短信采用预付费的方式，按按发送条数计算，详细计算规则可参见 [腾讯云国内短信定价](https://cloud.tencent.com/product/csms/pricing) 页面，需要 [购买短信套餐包](https://buy.cloud.tencent.com/sms)。具体价格(包括验证码，通知，会员营销类短信)请参考下表。
<table>
   <tr>
        <th>套餐（万条）</td> 
		<th>套餐售价（元）</td> 
...
>注意：按实际通话分钟数计费（不足 1 分钟的按 1 分钟计费）。
