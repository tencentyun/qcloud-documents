...
<table>
	 ...
	 <tr>      
         <td rowspan="2">注册</td>   
	     <td>您申请的用户名为：{1}，密码：{2}，请登录并修改密码。</td>   
     </tr> 
	 <tr>      
	     <td>欢迎您的加入！请用注册的手机号码及初始密码（{1}）登录。</td>   
     </tr> 
	 <tr>      
	     <td>重置密码</td>   
	     <td>尊敬的用户，您的密码已经重置为{1}，请尽快登录并修改密码。</td>   
     </tr> 
	 <tr>      
	     <td rowspan="2">快递</td>      
	 ...
	 <tr>      
	     <td>尊敬的用户，您的提货码是：{1}，请不要把提货码泄露给其他人。</td>   
     </tr> 
	 <tr>      
	     <td>取票</td>   
	 ...
	 <tr>      
	     <td>排队</td>   
	     <td>您的排队号为{1}，您前面还有{2}人等待，请在现场等候叫号。</td>   
     </tr> 
	 <tr>      
	     <td>售后咨询</td>   
