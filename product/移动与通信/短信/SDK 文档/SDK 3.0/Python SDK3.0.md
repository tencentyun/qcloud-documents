...
每个接口都有一个对应的 Request 结构和一个 Response 结构。本文仅列举几个常用功能的示例代码，更多示例请参见 [Python SDK 示例](https://github.com/TencentCloud/tencentcloud-sdk-python/tree/master/examples/sms/v20190711)。
