...
| 参数   | 必选 | 类型   | 描述                                                                                                                 |
|--------|------|--------|----------------------------------------------------------------------------------------------------------------------|
| pic    | 否   | string | 签名对应的资质证明图片进行 base64 编码格式转换后的字符串<br>base64 编码格式工具: [http://base64.xpcha.com/indexie.php](http://base64.xpcha.com/indexie.php) ，注意编译后字符串前面的前缀：“data:image/jpeg;base64,”|
