...
| 参数   | 必选 | 类型   | 描述                                                                                                                 |
|--------|------|--------|----------------------------------------------------------------------------------------------------------------------|
| pic    | 否   | string | 请把签名内容相关的证件截图 base64 格式字符串添到该字段，可选择字段。base64 格式工具: [http://base64.xpcha.com/indexie.php](http://base64.xpcha.com/indexie.php) |
| remark | 否   | string | 签名备注，比如申请原因，使用场景等，可选字段                                                                         |
