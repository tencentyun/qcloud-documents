...
| remark | Yes | String | Signature notes (optional), such as reason for application and usage scenarios |
| sig | Yes | String | App credential. For more information on the calculation, please see the following. |
| text | Yes | String | Signature content without []. For example, if [Tencent Technology] is used as the signature, "Tencent Technology" should be entered. |
