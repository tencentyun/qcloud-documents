...
各个接口及其参数的详情介绍请参考 [API 文档](https://cloud.tencent.com/document/product/382/5976)、[SDK 文档](https://qcloudsms.github.io/qcloudsms_js/)、[错误码](https://cloud.tencent.com/document/product/382/3771) 、 [微信小程序·云开发](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/basis/getting-started.html) 和 [云短信体验版 Demo](https://github.com/qcloudsms/qcloudsms_weapp)。
