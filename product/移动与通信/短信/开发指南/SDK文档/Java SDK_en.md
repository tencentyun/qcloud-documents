...
Before starting with this tutorial, you first need to obtain SDK AppID and App Key. If you have not done so, log in to the [SMS Console](https://console.cloud.tencent.com/sms) and add an application. After this, you can get an SDK AppID and an App Key.
>**Note:**
...
### Configuring SDK
Tencent Cloud SMS can be configured in multiple ways. We provide you with the following three ways:
- **maven**
...
//Assume that the SMS template ID is 123, and the template content is: Test SMS, {1}, {2}, {3}, go to school.
 ...
 params.add("Send single SMS message with specified template");
 params.add("Shenzhen");
...
// Common bulk SMS
// The following 3 phone numbers are hypothetical
...
SmsMultiSenderResult multiSenderResult = multiSender.send(0, "86", phoneNumbers, 
	"[Tencent] Test SMS, common bulk SMS, Shenzhen, Xiao Ming, go to school.", "", "");
...
```
> **Note:**
> A maximum of 200 phone numbers are supported for a single request of sending bulk SMS messages. For extra demand, contact Tencent Cloud SMS technical support (QQ: 3012203387).
