...
## SDK 功能简介
目前腾讯云短信为客户提供**国内短信、语音短信**和**国内语音**服务，腾讯云短信 SDK 支持以下操作：
...
>?拉取短信回执功能默认关闭。您可以根据实际需求联系腾讯云短信技术支持（QQ：3012203387）开通该功能，实现批量拉取短信回执。
...
<a id="发送语音验证码" ></a>
- **发送语音验证码**
语音验证码发送只需提供验证码数字，如需自定义内容，可以 [发送语音通知](#发送语音通知)。
