...
企业认证用户可以登录 [短信控制台](https://console.cloud.tencent.com/smsv2/app-manage) 设置或修改相应的频率限制策略，具体操作请参见 [设置发送频率限制](https://cloud.tencent.com/document/product/382/37809#.E8.AE.BE.E7.BD.AE.E5.8F.91.E9.80.81.E9.A2.91.E7.8E.87.E9.99.90.E5.88.B6)。
...
- 增加图形验证码，例如腾讯云 [天御](https://cloud.tencent.com/product/captcha) 图形验证码等。
- 单 IP 请求次数限制。
...
### 发送国际/港澳台短信是否有数量限制？
单个腾讯云账户的国际/港澳台短信每日发送量限额100条（实际提交计费条数），如需调整，请联系 [腾讯云短信小助手](https://tccc.qcloud.com/web/im/index.html#/chat?webAppId=8fa15978f85cb41f7e2ea36920cb3ae1&title=Sms)。
