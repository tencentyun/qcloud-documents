...
### 创建签名
一个完整的短信由短信签名和短信正文内容两部分组成，短信签名规则详见 [短信模版规则]()，详细操作请参阅 [创建签名]()。


### 创建正文模版
短信正文模版规则详见 [短信正文规则]()，详细操作请参阅 [创建正文模版]()。
...
### 查看短信发送结果
短信发送成功后，可在控制台短信发送列表页查看短信发送的状态，状态会 10s 更新一次，在发送的过程中，可手动选择**暂停发送**和**继续发送**。
