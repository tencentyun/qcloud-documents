...
3. 在 SDK 下载页面，选择需要下载的版本，单击**下载**，并按照配置指引（[Android](https://cloud.tencent.com/document/product/548/36652)/[iOS](https://cloud.tencent.com/document/product/548/36663)）进行相关配置。
