...
- Android：支持图片、音频。
- iOS：支持图片、音频、视频。（需要 App 集成 [通知拓展服务插件](https://cloud.tencent.com/document/product/548/36667)）
...
| 平台 | 参数        | 备注                                                    |
| -------- | ----------------- | ------------------------------------------------------------ |
| Android    | <li>缩略图：`icon_res`、`icon_type` <li>大图：`xg_media_resources` <li>音频：`xg_media_audio_resources`   |<li> 缩略图仅 TPNS 通道和华为通道支持<li>大图仅 TPNS 通道和小米通道支持<li>音频仅 TPNS 通道支持|
| iOS   | <li>图片、音视频：`xg_media_resources`    | 通知图片不能与通知音视频同时设置，只能设置其中一个|
