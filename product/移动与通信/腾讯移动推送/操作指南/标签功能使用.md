...
### 用户促活与流失召回
App 运营中经常需要针对新用户进行消息提醒，作为新用户体验旅程设计的重要一环，提高新用户的留存率，通过在推送时选择 TPNS 提供的“最近注册”系统预设标签，即可快速对指定日期用户进行推送，方便快捷。同样，我们也提供了沉默用户标签，可以指定 N 日内未活跃的用户作为推送对象，对其进行消息推送将这些流失用户进行召回，提升 App 活跃用户数。
...
**方式二：通过终端 SDK 进行标签设置**
iOS SDK 进行标签的设置,具体参见文档：[自定义标签设置](https://cloud.tencent.com/document/product/548/36668#.E7.BB.91.E5.AE.9A.2F.E8.A7.A3.E7.BB.91.E6.A0.87.E7.AD.BE.E5.92.8C.E8.B4.A6.E5.8F.B7)
Android SDK 进行标签的设置,具体参见文档：[自定义标签设置](https://cloud.tencent.com/document/product/548/36659#.E8.AE.BE.E7.BD.AE.E8.87.AA.E5.AE.9A.E4.B9.89.E6.A0.87.E7.AD.BE)
