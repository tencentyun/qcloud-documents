...
### 用户促活与流失召回
APP运营中经常需要针对新用户进行消息提醒，作为新用户体验旅程设计的重要一环，提高新用户的留存率，通过在推送时选择TPNS提供的“最近注册”系统预设标签即可快速对指定日期用户进行推送，方便快捷！ 同样，我们也提供了沉默用户标签，可以指定N日内未活跃的用户作为推送对象，对其进行消息推送将这些流失用户进行召回，提升APP活跃用户数！
