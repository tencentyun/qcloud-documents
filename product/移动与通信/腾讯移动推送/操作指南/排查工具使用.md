...
![](https://main.qcloudimg.com/raw/62930e65b6a6cc1ccebb7611f331361f.png)
...
2. 推送状态显示已完成，设备状态正常，为什么手机没有收到推送？
   ...
   - 检查 APP 包名是否和配置管理中填写的包名一致，如果包名不一致检查是否开启 [多包名推送功能](https://cloud.tencent.com/document/product/548/42875)。
