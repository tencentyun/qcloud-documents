...
2. 运营人员通过用户账号推送消息，推送状态显示“推送失败”，在排查工具中输入用户账号及绑定的账号类型查询 Token，发现该应用下，此账号没有关联的设备 Token，可联系开发人员排查是否调用了 [账号绑定（Android）](https://cloud.tencent.com/document/product/548/36659#.E7.BB.91.E5.AE.9A.E8.B4.A6.E5.8F.B7)或 [账号绑定（iOS）](https://cloud.tencent.com/document/product/548/36668#.E8.AE.BE.E7.BD.AE.E8.B4.A6.E5.8F.B7)接口。
	![](https://qcloudimg.tencent-cloud.cn/raw/a705781c4bca5c76a3766a308cb10ca8.png)
...
> ?pushid 获取方式：
> 1. 可在左侧导航栏选择**App推送管理**>**推送任务**，获取需要查询的 PushID。
> ![](https://main.qcloudimg.com/raw/96c3c00ece0718f64d9e1463358afa9d.png)
> 2. 在推送接口的应答参数中获取。

3.在**App推送管理**>**推送任务**，更换 管理台创建>API创建 及可查看到API推送数据
