...
创建推送任务时，在推送文案带上个性化参数，终端设备将显示带有不同用户属性的推送消息，如下图中「1797」是某个用户的账号昵称，相较于千篇一律的统一推送文案，用户的点击意愿会更加强烈。
![](https://main.qcloudimg.com/raw/236947c7efa801354b41c10d30e1d5bb.png)
...
iOS SDK 进行用户属性的设置,具体参见文档：[用户属性设置](https://cloud.tencent.com/document/product/548/48835#.E7.94.A8.E6.88.B7.E5.B1.9E.E6.80.A7.E5.8A.9F.E8.83.BD)
Android SDK 进行用户属性的设置,具体参见文档：[用户属性设置]()

#### 方式二： 通过 Rest API 绑定：

API 绑定方式可参考 [个性化推送相关API]() 说明。
...
| default_title| string| Aandroid 平台必须，iOS平台非必须|当用户属性无法匹配时，向设备发送默认消息标题
| default_subtitle | string| 否 | 当用户属性无法匹配时，向设备发送默认消息副标题 |

其它消息字段说明可参考API[消息体说明](https://cloud.tencent.com/document/product/548/39064#message.EF.BC.9A.E6.B6.88.E6.81.AF.E4.BD.93)。
