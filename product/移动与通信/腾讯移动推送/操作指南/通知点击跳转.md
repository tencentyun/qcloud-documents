...
使用 [移动推送 TPNS](https://console.cloud.tencent.com/tpns) 控制台设置 Intent 进行跳转，在【高级设置】>【点击打开】中填写如下：
```plaintext
...
使用 [移动推送 TPNS](https://console.cloud.tencent.com/tpns) 控制台设置 URL 进行跳转，在【高级设置】>【点击打开】中填写如下：
```plaintext
http://tpns.qq.com
```
...
使用 [移动推送 TPNS](https://console.cloud.tencent.com/tpns) 控制台设置参数，在【高级设置】>【附加参数】中填写如下：
![](https://main.qcloudimg.com/raw/1853468eaddd1f2a94c2ec1a30671589.png)
...
```
{
	...
	"environment": "dev",
	"token_list": [
		"0250df875c93c555dd3a2ba536b54fc1c49f"
	],
	"message_type": "notify",
	"message": {
		"title": "xxx",
