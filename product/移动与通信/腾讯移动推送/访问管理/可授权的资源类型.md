...
| DescribeAccountPushStatInfo | 查询账号下总推送量 |是|
| DescribeAccountPushStatInfoAllZone | 查询所有集群下各应用的应发消息总量 |是|
...
//授权运营人员以特定应用的操作权限
{
    ...
    "statement": [
        ...
        {//对不支持资源级授权的操作进行授权
            "action": [
                "tpns:ModifyProductInfo",
                //“修改产品信息”在上述表格中显示不支持资源级操作权限，需要在此将该操作授权给所有资源
            ],
            "resource": [
