...
<tr>
<td>iOS 推送支持通道策略</td>
<td>APNs 静默消息对单设备每小时限额3条，iOS 通知栏消息与静默消息均支持移动推送通道与 APNs 通道互补下发，可自定义下发策略</td>
<td>2020-11-02</td>
...
<td>Android 通道策略-自定义策略优化，可自由选择设备在线是否优先通过移动推送通道下发</td>
<td>2020-08-11</td>
<td>-</td>
</tr>
...
<table>
    ...
    <tr>
        <td>小米通道超额提醒</td>
        <td>小米通道超额后，自动走移动推送通道推送，且控制台提示</td>
        <td>2020-04-23</td>
        <td>-</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>厂商通道超额策略</td>
        <td>厂商通道超额后自动通过移动推送通道下发，最大程度保证消息可达</td>
        <td>2020-02-24</td>
