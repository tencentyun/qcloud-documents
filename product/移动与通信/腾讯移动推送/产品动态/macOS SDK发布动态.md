...
<tr>
    ...
    <tr>
        ...
        <td><li> 优化接入，新增注册回调方法</li><li>新增 TPNS 通道，支持 TPNS 通道下发消息</li><li>优化数据统计</li><li>修复已知问题</li></td>
        <td>2020-04-28</td>
        <td><a href="https://console.cloud.tencent.com/tpns/sdkdownload">SDK下载</a></td>
    </tr>
    <tr>
        <td>SDK 1.0.3.0版本发布</td>
...
<tr>
    ...
    <tr>
        ...
        <td><li> 简化接入，优化上报接口使用(仅在启动方法中调用即可,参见 Demo)</li><li>提升稳定性，修复已知 Crash 问题</li><li>优化提升 SDK 兼容性</li></td>
        <td>2020-01-07</td>
        <td>-</td>
    </tr>
    <tr>
        <td>SDK 1.0.2.7版本发布</td>
...
<tr>
    ...
    <tr>
        <td>SDK 1.0.0.1版本发布</td>
        <td><li>新增查询信鸽服务生成的 Token 接口</li><li>修复单账号绑定失败的问题</li><li>修改上报数据中SDK版本号的问题</li></td>
        <td>2019-08-15</td>
        <td>-</td>
    </tr>
    <tr>
