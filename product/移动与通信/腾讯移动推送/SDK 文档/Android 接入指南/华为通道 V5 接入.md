...
4. 进入**我的项目** > **项目设置** > **常规**中的应用获取并复制APPID和Client Secret，填入 **[移动推送 TPNS 控制台](https://console.cloud.tencent.com/tpns)**>**配置管理**>**基础配置**>**华为官方推送通道**栏目中。
![](https://qcloudimg.tencent-cloud.cn/raw/e58ff2c2a0e3a0bbd6f8323d095254f1.png)
...
## 启动华为推送
1. 在调用 TPNS 注册接口 `XGPushManager.registerPush` 前，开启第三方推送接口：
```java
//打开第三方推送
