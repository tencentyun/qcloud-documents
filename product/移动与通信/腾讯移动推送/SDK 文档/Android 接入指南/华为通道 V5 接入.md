...
4. 进入**我的项目** > **项目设置** > **常规**中的应用获取并复制APPID和Client Secret，填入 **[移动推送控制台](https://console.cloud.tencent.com/tpns)** > **App 推送管理** > **基础配置** > **华为官方推送通道**栏目中。
...
dependencies {
		...
		implementation 'com.huawei.hms:push:6.7.0.300'       // HMS Core Push 模块依赖包
		}
```
