...
例如，当前使用的版本号为 1.3.3.3，最新版本号为 1.3.7.2，则将使用的推送 SDK 依赖版本号从 1.3.3.3 修改为 1.3.7.2：
```
dependencies {
    //移动推送主包
    implementation "com.tencent.tpns:tpns:1.3.7.2-release"

    // 小米推送依赖包
    implementation "com.tencent.tpns:xiaomi:1.3.7.2-release"

    // 魅族推送依赖包
    implementation "com.tencent.tpns:meizu:1.3.7.2-release"
    ...
    // OPPO 推送依赖包
    implementation "com.tencent.tpns:oppo:1.3.7.2-release"
    // 自 SDK 1.3.2.0 起，需一并加入以下依赖语句，否则可能导致 OPPO 推送注册失败
    implementation 'com.google.code.gson:gson:2.6.2'
    implementation 'commons-codec:commons-codec:1.15'

    // vivo 推送依赖包
    implementation "com.tencent.tpns:vivo:1.3.7.2-release"

    // 荣耀推送依赖包
    implementation "com.tencent.tpns:honor:1.3.7.2-release"
}
```
