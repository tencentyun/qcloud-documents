...
#### Provider 组件初始化时机配置
TPNS Android SDK 1.3.3.3 起新增以下接口配置是否自动初始化 SDK 的 Provider 组件功能，在用户同意隐私政策之后默认开启。
...
>! 如需开启，请一定参考 [TPNS 隐私保护指引](https://privacy.qq.com/document/preview/8565a4a2d26e480187ed86b0cc81d727) ，在应用自己的隐私政策中披露自启动行为，并确认在用户同意隐私政策后才配置开启。
...
>! 如需开启，请一定参考 [TPNS 隐私保护指引](https://privacy.qq.com/document/preview/8565a4a2d26e480187ed86b0cc81d727) ，在应用自己的隐私政策中披露关联启动行为，并确认在用户同意隐私政策后才配置开启。
