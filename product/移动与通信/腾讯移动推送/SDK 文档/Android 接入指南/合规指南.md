...
>!如您因特殊原因暂时无法更新至最新版本，请您务必按照本指南第4部分“老版本SDK合规方案”的说明完成相关合规设置


### 2. 隐私政策中添加移动推送 TPNS 相关说明
请您确保您开发或运营的应用有符合监管要求的《隐私政策》文本。同时请您务必明确告知终端用户您的应用使用了移动推送 TPNS 服务。建议您在《隐私政策》对应的章节、列表中添加关于移动推送TPNS 的说明，推荐条款如下：
```
SDK名称：移动推送 TPNS SDK
