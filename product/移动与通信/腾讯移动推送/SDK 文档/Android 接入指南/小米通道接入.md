...
### 获取密钥
1. 进入 [小米开放平台](https://dev.mi.com/console/appservice/push.html) ，开通小米开发者账号，并获取小米推送的 AppId、AppKey、AppSecret 等参数，详情请参见 [快速接入指南](https://dev.mi.com/console/doc/detail?pId=708)。
