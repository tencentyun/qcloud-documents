...
1. 进入 [小米推送运营平台](https://admin.xmpush.xiaomi.com/)获取balabala ，开通小米开发者账号，并获取 AppId、AppKey、AppSecret 三个密钥参数，详情请参见 [快速接入指南](https://dev.mi.com/console/doc/detail?pId=708)。
