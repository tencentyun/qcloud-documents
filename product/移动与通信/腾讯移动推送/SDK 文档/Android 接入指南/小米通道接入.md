...
引入小米推送的 jar 包。
```js
 implementation 'com.tencent.tpns:xiaomi:1.1.3.0-release'//小米推送
```
...
如果需要通过点击回调获取参数或者跳转自定义页面，可以通过使用 Intent 来实现，更多详情请参见 [Android 常见问题](https://cloud.tencent.com/document/product/548/36674#.E5.A6.82.E4.BD.95.E8.AE.BE.E7.BD.AE.E6.B6.88.E6.81.AF.E7.82.B9.E5.87.BB.E4.BA.8B.E4.BB.B6.EF.BC.9F)。
