...
```
>?- 若出现APP Debug 版本注册魅族 token 正常，但在 Release 版本中无法获取，请检查是否添加以上代码混淆规则。
- 如果您正在使用 Android Studio 3.4 或以上版本出现上述问题，那是因为 Android Studio 默认开启了 R8 混淆导致
的。解决方法：请在 gradle.properties 中添加 android.enableR8 = false 进行解决。
