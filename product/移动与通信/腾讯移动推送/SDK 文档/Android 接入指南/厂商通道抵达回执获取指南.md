...
完成荣耀厂商通道 SDK 集成后，如需开通荣耀通道抵达回执，当前需要开发者联系荣耀 Push 团队，向其提供如下回调地址进行配置：

### 回执参数配置

请在 [TPNS 控制台](https://console.cloud.tencent.com/tpns) 查看您的应用的服务接入点，并复制该应用的 AccessID，选择对应服务接入点的回执地址进行配置，参见 [荣耀推送回执模块](https://developer.hihonor.com/cn/doc/guides/100372)：
![](https://main.qcloudimg.com/raw/fbd7bb014dc5fa8bd1b2323471671e59.png)
<table>
 <tbody><tr>
 <th>服务接入点 </th>
