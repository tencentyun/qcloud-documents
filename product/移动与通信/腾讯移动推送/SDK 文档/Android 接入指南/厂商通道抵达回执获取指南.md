...
1. 配置消息回执地址。请在 [TPNS 控制台](https://console.cloud.tencent.com/tpns) 查看您的应用的服务接入点，并复制该应用的AccessID，选择对应服务接入点的回执地址进行配置：
...
>?AccessID 替换为您应用的 AccessID，如应用为广州服务接入点，则回执地址配置为https://stat.tpns.tencent.com/log/statistics/hw/1500016691 
