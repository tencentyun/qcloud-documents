...
## 华为通道抵达回执配置
华为通道抵达数据获取需要开发者自行配置。具体配置方法可参考 [配置指引](https://cloud.tencent.com/document/product/548/41318#.E9.85.8D.E7.BD.AE.E6.8C.87.E5.BC.95)文档配置完成后，可在推送记录中查看华为推送通道的抵达数据。
