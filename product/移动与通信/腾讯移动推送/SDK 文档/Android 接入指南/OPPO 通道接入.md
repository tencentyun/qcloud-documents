...
>?
> - OPPO 通道暂不支持应用内消息的发送，此类型的消息会通过移动推送通道进行下发。
> - OPPO 通道对应用的每日推送量有额度限制，详情请参见 [厂商通道限额说明](https://cloud.tencent.com/document/product/548/43794#oppo-.E5.B9.B3.E5.8F.B0.E9.99.90.E5.88.B6)，超过限制部分将走移动推送通道进行补推发送。
