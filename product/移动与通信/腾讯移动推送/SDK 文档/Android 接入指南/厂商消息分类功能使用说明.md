...
<tr>
<td>华为</td>
<td><ul><li>在华为管理台[申请自分类权益]（https://developer.huawei.com/consumer/cn/doc/development/HMSCore-Guides/message-classification-0000001149358835#section1653845862216），自分类权益生效后，应用的推送消息将根据hw_category字段进行归类。。</li><li>调用移动推送[服务端API](https://cloud.tencent.com/document/product/548/39064)时，指定hw_category参数。</li><li>华为的ChannelID作为自定义的渠道策略展示消息提醒方式，不作消息分类。。</li></ul></td>
</tr>
<tr>
<td>小米</td>
...
<tr>
<td>vivo</td>
<td><ul><li>仅支持配置使用vivo系统消息，不支持自定义通知渠道Channel 。</ul></td>
</tr>
</tbody></table>
