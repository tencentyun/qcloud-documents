...
>?
>-2023年4月3日起由 `vivo_ch_id ` 调整为 `vivo_category` 字段,若您在二级分类方案调整前，已经使用 vivo_ch_id 进行消息分类，请您尽快完成新方案的适配，补充 vivo_category 的传值。按以上表格申请vivo二级分类新方案 **[vivo 系统消息申请](#vivo_system)**。
