...
<table>
   ...
   <tr>
      ...
      <td rowspan='2'>开发者接口设置参数（category），开发文档请参见 <a href="https://dev.vivo.com.cn/documentCenter/doc/362">《服务端 API 接口文档》</a></td>
</tr>
   <tr>
      <td>运营消息</td>
...
您好，因我司应用XX（应用名称）部分消息属于用户主动订阅，参考《推送消息分类说明》，判断以下场景符合“用户设置的提醒”，申请归档为系统消息，请 vivo 推送团队核实。<br>
应用名称：XX<br>
AppId：XXXX<br>
应用包名：XXXX</td>
   </tr>
