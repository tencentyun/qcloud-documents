...
| 参数名称  | 类型   | 说明                                                         |
| --------- | ------ | ------------------------------------------------------------ |
| channel   | String | 推送通道名称<br>  xg：TPNS 通道<br> hw：华为通道<br> xm：小米通道<br> mz：魅族通道<br>oppo：OPPO 通道<br> vivo：vivo 通道<br> apns：APNs 通道（苹果通道）<br> fcm：FCM 通道<br> rog：ROG 通道 |
...
| pushOnlineUv | Integer  | APNs（苹果通道） 成功接收 |
