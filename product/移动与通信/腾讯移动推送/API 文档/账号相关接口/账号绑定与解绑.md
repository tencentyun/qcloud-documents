...
| account_list | Array  | 否 | 账号标识集合，当 operator_type = 5 时有效，且必填每个元素包含 account，以及 account_type 字段，加上account_type就可以设置类型。 <br> 示例如下：<br>`[{"account":"926@126.com"},{"account":"1527000000"}，{"account":"2849249569","account_type":9}]`|
