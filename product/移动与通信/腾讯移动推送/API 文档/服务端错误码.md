...
| -------- | ---------------- | ---------------- | ----------- |
| 1008001 | parameter parse error | 参数解析错误 | 通用接口 |
...
| 1008028  | request too fast|超出限频：<li>调用统计接口超频率</li><li>全量推送、标签推送和号码包推送超限额，参见 [推送接口](https://cloud.tencent.com/document/product/548/39064) 的注意事项</li>|统计接口，推送接口|
