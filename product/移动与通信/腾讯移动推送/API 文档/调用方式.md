本文主要介绍了腾讯移动推送的的鉴权认证方法。


## 获取秘钥
1. 登录 [腾讯移动推送控制台](https://console.cloud.tencent.com/tpns)，选择左侧菜单【应用管理】>【应用列表】。
2. 进入应用列表页面，获取产品`Access ID` 和 `SECRET KEY`（仅主账号可见）。
...
示例如下：
```
Authorization:base64(150000****:cf43dac624820*****c1fe5fc993)
```
