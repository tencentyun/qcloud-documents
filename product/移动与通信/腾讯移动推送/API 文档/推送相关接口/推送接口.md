...
| hw_category       | String  | android | 无     | 否   | 华为消息类型标识，确定消息提醒方式，对特定类型消息加快发送，参数详情请参考[华为的请求参数说明](https://developer.huawei.com/consumer/cn/doc/development/HMSCore-References/https-send-api-0000001050986197)                           |
