...
| environment   | String  | 是（仅 iOS 平台使用）                    | 用户指定推送环境，仅限 iOS 平台推送使用：<li>product： 推送生产环境</li><li>dev： 推送开发环境</li> | 注册打包的环境与推送环境需要保存一致，请参考[推送环境选择说明](https://cloud.tencent.com/document/product/548/39395)
