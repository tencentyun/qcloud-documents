...
｜oppo_top_notification_bar_show｜bool｜android｜false｜否｜oppo置顶功能 true:置顶 false:不置顶，仅OPPO通道有效，其需要[联系OPPO商务](https://open.oppomobile.com/new/developmentDoc/info?id=11260) 开通。          |
｜oppo_senior_push｜bool｜android｜false｜否｜oppo商业化推送（用于置顶和免折叠） true:不占个人配额和总配额 false:占用普通总额和个人配额｜
｜oppo_advertiser_id｜string｜android｜无｜否｜oppo广告主id,oppo厂商分配｜
｜vivo_marketing｜struct｜android｜无｜否｜vivo vpush商业化字段，仅vivo通道有效，包含广告模板id、消息样式等，其需要[联系vivo商务](https://dev.vivo.com.cn/connectus/customerService) 开通。          |
...
**vivo_marketing 参数说明**
｜creative_id｜int64｜vivo_marketing｜无｜否｜vivo广告模板id，开发者可前往vivo营销平台创建通知广告模板｜
｜style_type｜int64｜vivo_marketing｜无｜否｜标题+内容，id=1，类型纯文本 标题+内容+小图，id=2，类型小图 标题+内容+大图+小图(可选)，id=3，类型大图 标题+内容+组图/三图+小图(可选)，id=4，类型组图/三图｜
｜price｜string｜vivo_marketing｜无｜否｜出价，系统以此价格为准进行实时cpc计费，该价格不得低于与vivo商务商定价格｜
｜style｜struct｜vivo_marketing｜无｜否｜Vivo付费通道样式｜
**vivo_style 参数说明**
｜small_image_id｜int64｜vivo_style｜无｜否｜小图，请填写上传图片后所获得图片id（需要在vivo侧上传）｜
｜large_image_id｜int64｜vivo_style｜无｜否｜大图，请填写上传图片后所获得图片id（需要在vivo侧上传）｜
｜buttons｜vivo_butt on array｜vivo_style｜无｜否｜按钮组合｜
**vivo_button 参数说明**
｜name｜string｜vivo_button｜无｜否｜按钮名字｜
｜skip_type｜int64｜vivo_button｜无｜否｜点击跳转类型 1：打开APP首页 2：打开链接 3：自定义 4:打开app内指定页面｜
