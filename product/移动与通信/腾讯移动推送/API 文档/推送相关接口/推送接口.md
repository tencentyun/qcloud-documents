...
| custom_content | String | Android   |无    | 否    | 用户自定义的参数（需要序列化为json string） **⚠️注意：**<li>此字段后续会废弃，不建议继续使用；如需通过通知栏推送携带自定义参数，推荐使用[intent](https://cloud.tencent.com/document/product/548/36674#.E5.A6.82.E4.BD.95.E8.AE.BE.E7.BD.AE.E6.B6.88.E6.81.AF.E7.82.B9.E5.87.BB.E4.BA.8B.E4.BB.B6.EF.BC.9F)方式。<li>若需要进行消息覆盖,则不能使用此字段传递自定义参数，需要修改使用 intent 方式。|
