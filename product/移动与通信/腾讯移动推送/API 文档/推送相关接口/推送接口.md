...
| multi_pkg     | bool   |无 | 否                | false   | 多包名推送：当 App 存在多个渠道包（例如应用宝、豌豆荚等），并期望推送时所有渠道的 App 都能收到消息，可将该值设置为 true。<br>⚠️该参数默认控制自建通道的多包名推送，需要实现厂商通道多包名推送详见文档 [厂商通道多包名配置](https://cloud.tencent.com/document/product/548/42875#.E5.A4.9A.E5.8C.85.E5.90.8D.E5.8E.82.E5.95.86.E9.80.9A.E9.81.93.E9.85.8D.E7.BD.AE)|
