...
| oppo_senior_push  | Bool  | android  |  false | 否  |  OPPO 商业化推送（用于置顶和免折叠）： <li>true：不占个人配额和总配额</li> <li>false：占用普通总额和个人配额</li>|
| oppo_advertiser_id | String | android | 无 | 否 | OPPO 广告主 ID，OPPO 厂商分配 | 
| vivo_marketing | Struct | android | 无 | 否 | vivo vpush 商业化字段，仅 vivo 通道有效，包含广告模板 ID、消息样式等，其需要 [联系 vivo 商务](https://dev.vivo.com.cn/connectus/customerService) 开通。 |
