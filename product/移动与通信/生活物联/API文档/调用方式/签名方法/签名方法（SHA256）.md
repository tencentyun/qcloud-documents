...
```
Action=PublishMsg&Nonce=48059&SecretId=AKIDT8G5AsY1D3MChWooNq1rFSw1fyBVCX9D&SignatureMethod=HmacSHA256&Timestamp=1502197934&topic=iot12345678&message={"temperature"=27,"status"="online"}
```
...
```
GETiot.api.qcloud.com/v2/index.php?Action=PublishMsg&Nonce=48059&SecretId=AKIDT8G5AsY1D3MChWooNq1rFSw1fyBVCX9D&SignatureMethod=HmacSHA256&Timestamp=1502197934&topic=iot12345678&message={"temperature"=27,"status"="online"}
```

若为 POST 请求，示例的拼接结果为：

```
POSTiot.api.qcloud.com/v2/index.php?Action=PublishMsg&Nonce=48059&SecretId=AKIDT8G5AsY1D3MChWooNq1rFSw1fyBVCX9D&SignatureMethod=HmacSHA256&Timestamp=1502197934&topic=iot12345678&message={"temperature"=27,"status"="online"}
```
...
```
$secretKey = 'pxPgRWDbCy86ZYyqBTDk7WmeRZSmPco0';
$srcStr = 'GETiot.api.qcloud.com/v2/index.php?Action=PublishMsg&Nonce=48059&SecretId=AKIDT8G5AsY1D3MChWooNq1rFSw1fyBVCX9D&SignatureMethod=HmacSHA256&Timestamp=1502197934&topic=iot12345678&message={"temperature"=27,"status"="online"}';
