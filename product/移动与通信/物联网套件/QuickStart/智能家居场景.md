## 场景介绍
智能家居场景是假设用户拥有一款智能灯，需要将灯连接到物联网套件实现灯的远程管理及耗电量的获取。用户要解决设备如何接入物联网套件以及如何使用套件提供的 API 以及应用端SDK完成智能灯的手机应用开发，从而为智能灯的最终消费者提供服务。
...
```
查看控制台设备管理，Light_GZ_00001处于“上线”状态，表示智能小夜灯成功连接物联网套件。
...
点击更新后，立即进入light程序的运行环境，可以看到light程序已打印了一条红色文本，小夜灯的开关被打开。
