Setting an XGPush protocol proxy is to make it easy for developers to check API calls. Developers can select how to implement the protocol based on their own needs.
