...
<!-- [Required] [Note] Change authorities to package name.AUTH_XGPUSH, for example, demo package name: com.qq.xgdemo-->
  <provider
       android:name="com.tencent.android.tpush.XGPushProvider"
       android:authorities="Current application package name.AUTH_XGPUSH"
       android:exported="true"/>

  <!-- [Required] [Note] Change authorities to package name.TPUSH_PROVIDER, for example, demo package name: com.qq.xgdemo-->
  <provider
       android:name="com.tencent.android.tpush.SettingsContentProvider"
       android:authorities="Current application package name.TPUSH_PROVIDER"
       android:exported="false" />

  <!-- [Required] [Note] Change authorities to package name.TENCENT.MID.V3, for example, demo package name: com.qq.xgdemo-->
  <provider
...
<!-- [Required] Permissions required by XGPush SDK   -->
...
<!-- [Common] Permissions required by XGPush SDK -->
<uses-permission android:name="android.permission.RECEIVE_USER_PRESENT" />
<uses-permission android:name="android.permission.RECEIVE_BOOT_COMPLETED" />
<uses-permission android:name="android.permission.WRITE_EXTERNAL_STORAGE" />
<uses-permission android:name="android.permission.WRITE_SETTINGS" />
<!-- [Optional] Permissions required by XGPush SDK -->
