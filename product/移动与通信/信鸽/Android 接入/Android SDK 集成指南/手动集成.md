### 注册并下载 SDK
前往信鸽管理台 [xg.qq.com](xg.qq.com)，使用 QQ 号码登陆，进入应用注册页，填写“应用名称”和“应用包名”（必须要跟 App 一致），选择【操作系统】和【分类】，最后单击【创建应用】。应用创建成功后，单击【应用配置】即可看到 App 专属的 AccessId 和 AccessKey 等信息。
