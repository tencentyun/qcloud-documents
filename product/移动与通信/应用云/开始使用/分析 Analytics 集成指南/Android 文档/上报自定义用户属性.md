...
![](http://tacimg-1253960454.file.myqcloud.com/guides/analytics/config_custom_property.png)
...
![](http://tacimg-1253960454.file.myqcloud.com/guides/analytics/check_custom_property.png)

### 对比不同属性人群的用户行为

您可以在控制台【事件分析】下的【事件列表】，选择相应的事件后（通过用户属性设定不同的用户群，对比他们完成的效果，如设定参照组1和2，两组人群使用不同的下单流程），再对比最终点击下单的次数、用户数区别：

![](http://tacimg-1253960454.file.myqcloud.com/guides/analytics/custom_property_compare.png)
