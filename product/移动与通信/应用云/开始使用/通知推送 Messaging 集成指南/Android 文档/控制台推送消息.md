...
打开 [MobileLine 控制台](https://console.cloud.tencent.com/tac)，选择【创建推送】下的【应用内消息】，并填写好 **命令描述** 和 **命令内容**，然后选择单选框中的【单个设备】，并将注册成功后回调时打印的设备唯一标识 token 信息拷贝到编辑框中（获取 token 信息请参见 [这里](replaceme)），您也可以在推送时添加自定义参数，然后点击【确认推送】。
