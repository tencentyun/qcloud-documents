...
* 其次您需要一个提供访问授权的后台服务，请参考 [用户访问控制](https://cloud.tencent.com/document/product/666/17220)。
...
dependencies {
	...
	compile 'com.tencent.tac:tac-storage:1.1.2'
}
```

## SDK 配置授权服务

Storage SDK 需要一个后台授权服务来提供密钥，关于如何在 SDK 里配置服务，请参见 [配置密钥服务](https://cloud.tencent.com/document/product/666/17199)。
