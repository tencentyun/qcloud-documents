...
由于部分客户过度使用 `119.29.29.29` 的开放公共解析服务，近一年 `119.29.29.29` 免费测试服务的解析量快速增涨造成大量公共资源消耗，并且导致该公共服务的高质量解析效果得不到保障，损害了广大互联网用户的体验。为提升用户的解析质量，进⽽推出企业版（接入 IP：`119.29.29.98/99`），并且开放公共解析服务将于**2022年1⽉1⽇0时**停⽌服务，在此之前将根据监控的用量情况逐步缩减免费测试服务的容量。
因此，为避免影响客户业务，请您尽快完成企业版升级。
