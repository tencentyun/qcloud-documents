>!《（新版）HttpDNS（移动解析）服务等级协议》将在腾讯云官网公示30天，该协议于2019年8月1日正式生效。即2019年7月31日及以前 HttpDNS（移动解析）服务可用性问题按照《（旧版）HttpDNS（移动解析）服务等级协议》实施，2019年8月1日及以后 HttpDNS（移动解析）服务可用性按照《（新版）HttpDNS（移动解析）服务等级协议》执行。
>
