...
## 前提条件
- [已开通移动解析 HTTPDNS](https://cloud.tencent.com/document/product/379/54577) 并已获取授权 ID 和加密密钥及 HTTPS Token 等配置信息。详情可参见 [获取配置信息](https://cloud.tencent.com/document/product/379/61203)。
