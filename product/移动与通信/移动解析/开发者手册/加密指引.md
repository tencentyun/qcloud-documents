...
>
## 前提条件
已开通移动解析 HTTPDNS 获取授权 ID 和加密密钥及 HTTPS Token 并妥善保管、切勿泄漏。详细操作可参见 [开通 HTTPDNS](https://cloud.tencent.com/document/product/379/54577)。
...
3. 确定加密方式，目前移动解析支持 DES、AES、HTTPS 三种加密方式。
 - **使用 AES 或 DES 加密方式：**
