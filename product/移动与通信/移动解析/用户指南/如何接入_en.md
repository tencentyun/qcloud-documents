...
First, you need to activate HttpDNS service in the [Console](https://console.qcloud.com/httpdns).
Currently, this service is only available to verified enterprise users.

> Note: Individual developers can access this service via free API. For more information, please see [API Documentation](https://www.qcloud.com/document/product/379/3524).
...
For more information about the encryption method, please see [Encryption Guide](https://www.qcloud.com/document/product/379/3530).
