...
### 请求 URL 示例
```
https://console.tim.qq.com/v4/openim/im_remove_tag?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 请求参数说明
...
## 接口调试工具
通过 [REST API 在线调试](https://avc.qcloud.com/im/APITester/APITester.html#v4/openim/im_remove_tag) 工具调试本接口。
