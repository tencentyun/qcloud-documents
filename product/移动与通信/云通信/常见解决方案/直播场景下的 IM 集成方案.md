...
点击下载[ Android 版 Demo（应用宝）](http://sj.qq.com/myapp/detail.htm?apkName=com.tencent.qcloud.suixinbo)

下载二维码：
![](//mccdn.qcloud.com/static/img/55b65132442aa62465730bc0b20a1c7b/image.png)

点击下载[ iOS 版 Demo（App Store）](https://itunes.apple.com/cn/app/sui-xin-bo/id1037944078?mt=8)
...
点击体验[ H5 Demo](http://avc.qcloud.com/demo/webim/biggroup/mobile/index.html)
...
### 获取观看直播的人数
AVChatRoom 的人数统计并不是实时的，有 1 分钟左右的时延。App 管理后台通过 REST API 接口获取当前群人数参见：
...
### 客户端压力测试
如果要对客户端在 AVChatRoom 下的消息收发性能进行测试，可以参考 [压测工具](/doc/product/269/4287#3-.E7.BE.A4.E5.86.85.E5.8F.91.E9.80.81.E6.B6.88.E6.81.AF.E5.8E.8B.E5.8A.9B.E6.B5.8B.E8.AF.95.E8.84.9A.E6.9C.AC.E4.BD.BF.E7.94.A8.E8.AF.B4.E6.98.8E)。
