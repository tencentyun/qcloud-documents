...
**语音消息已读状态：**语音是否已经播放，可使用 [消息自定义字段](/doc/product/269/9150#3.8-.E6.B6.88.E6.81.AF.E8.87.AA.E5.AE.9A.E4.B9.89.E5.AD.97.E6.AE.B526) 实现，如 customInt 的值 0 表示未播放，1 表示播放，当用户点击播放后可设置 customInt 的值为 1。
...
对于群组会话消息，可以通过消息属性判断本群组设置的接收消息选项，可参阅 [群组管理](/doc/product/269/9152#5.11-.E4.BF.AE.E6.94.B9.E6.8E.A5.E6.94.B6.E7.BE.A4.E6.B6.88.E6.81.AF.E9.80.89.E9.A1.B932)。
