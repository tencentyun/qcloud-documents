...
|webim.MSG_ELEMENT_TYPE  | 消息元素类型，取值范围：<ol><li>webim.MSG_ELEMENT_TYPE.TEXT-文本消息<li>webim.MSG_ELEMENT_TYPE.FACE表情消息<li>webim.MSG_ELEMENT_TYPE.IMAGE-图片消息<li>webim.MSG_ELEMENT_TYPE.SOUND-语音消息<li>webim.MSG_ELEMENT_TYPE.FILE-文件消息<li>webim.MSG_ELEMENT_TYPE.LOCATION-位置消息<li>webim.MSG_ELEMENT_TYPE.CUSTOM-自定义消息<li>webim.MSG_ELEMENT_TYPE.GROUP_TIP-群提示消息（只有群聊天才会出现）|区分消息元素类型  |
