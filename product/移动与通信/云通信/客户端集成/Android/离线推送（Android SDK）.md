...
ImSDK从2.1.0版本开始提供了设置离线推送配置的方法，可以设置是否开启离线推送、收到离线推送时的提示声音等。
...
通过`TIMManager`中的`getOfflinePushSettings`方法可以获取到当前的离线推送配置。
...
#### 5.2.2 配置小米推送服务需要的service和receiver
...
#### 6.2.2 配置化为推送服务需要的service和receiver
