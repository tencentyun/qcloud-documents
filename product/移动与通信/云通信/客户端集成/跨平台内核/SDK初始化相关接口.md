...
| cb | TIMCommCallback | 返回设置配置之后所有配置的回调，此 cb 可为空，表示不获取所有配置信息。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMSetConfig](https://cloud.tencent.com/document/product/269/33552#timsetconfig)  |
