...
| cb | TIMCommCallback | 创建会话的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMConvCreate](https://cloud.tencent.com/document/product/269/33552#timconvcreate)  |
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| cb | TIMCommCallback | 获取会话缓存列表的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMConvGetConvList](https://cloud.tencent.com/document/product/269/33552#timconvgetconvlist)  |
| user_data | const void\* | 用户自定义数据， IM SDK 只负责传回给回调函数 cb ，不做任何处理 |
