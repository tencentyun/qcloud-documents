...
| [TIMGroupGetPendencyList](https://cloud.tencent.com/document/product/269/33550#TIMGroupGetPendencyList) | 获取群未决信息列表。群未决信息是指还没有处理的操作，比如邀请加群或者请求加群，这个操作还没有被处理，称之为群未决信息。 | 
