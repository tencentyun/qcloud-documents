...
- 修改群其他信息的权限说明：
 ...
 - 对于私有群，任何人可修改群简介。
- `kTIMGroupModifyInfoParamModifyFlag`可以按位或设置多个值。不同的 flag 设置不同的键，详情请参考 [GroupModifyMemberInfoParam](https://cloud.tencent.com/document/product/269/33553#groupmodifymemberinfoparam)。
...
- `kTIMGroupModifyMemberInfoParamModifyFlag`可以按位或设置多个值，不同的 flag 设置不同的键。请参考 [GroupModifyInfoParam](https://cloud.tencent.com/document/product/269/33553#groupmodifyinfoparam)。
