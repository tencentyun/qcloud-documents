...
| cb | TIMCommCallback | 创建群组成功与否的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMGroupCreate](https://cloud.tencent.com/document/product/269/33552#timgroupcreate)  |
...
- 创建群参数的 JSON Key 请参考  [CreateGroupParam](https://cloud.tencent.com/document/product/269/33553#creategroupparam)。
...
| cb | TIMCommCallback | 邀请加入群组成功与否的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMGroupInviteMember](https://cloud.tencent.com/document/product/269/33552#timgroupinvitemember)  |
| user_data | const void\* | 用户自定义数据， IM SDK 只负责传回给回调函数 cb ，不做任何处理 |
...
- 权限说明：
 ...
 - 公开群、聊天室邀请用户入群。
 - 需要用户同意；直播大群不能邀请用户入群。
- 此接口支持批量邀请成员加入群组。JSON Key 请参考  [GroupInviteMemberParam](https://cloud.tencent.com/document/product/269/33553#groupinvitememberparam)。
...
| cb | TIMCommCallback | 删除群组成员成功与否的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMGroupDeleteMember](https://cloud.tencent.com/document/product/269/33552#timgroupdeletemember)  |
| user_data | const void\* | 用户自定义数据， IM SDK 只负责传回给回调函数 cb ，不做任何处理 |
...
- 权限说明：
 ...
 - 对于直播大群：不能踢人。
- 此接口支持批量删除群成员。JSON Key 请参考 [GroupDeleteMemberParam](https://cloud.tencent.com/document/product/269/33553#groupdeletememberparam)。
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| cb | TIMCommCallback | 获取已加入群组列表成功与否的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMGroupGetJoinedGroupList](https://cloud.tencent.com/document/product/269/33552#timgroupgetjoinedgrouplist)  |
| user_data | const void\* | 用户自定义数据， IM SDK 只负责传回给回调函数 cb ，不做任何处理 |
...
- 权限说明：
 - 此接口可以获取自己所加入的群列表。
 - 此接口只能获得加入的部分直播大的列表。
- 此接口用于获取当前用户已加入的群组列表，返回群组的基础信息。具体返回的群组基本信息字段请参考 [GroupBaseInfo](https://cloud.tencent.com/document/product/269/33553#groupbaseinfo)。
...
| cb | TIMCommCallback | 获取群组信息列表成功与否的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMGroupGetGroupInfoList](https://cloud.tencent.com/document/product/269/33552#timgroupgetgroupinfolist)  |
| user_data | const void\* | 用户自定义数据， IM SDK 只负责传回给回调函数 cb ，不做任何处理 |
...
>?此接口用于获取指定群ID列表的群详细信息。具体返回的群组详细信息字段请参考 [GroupDetailInfo](https://cloud.tencent.com/document/product/269/33553#groupdetailinfo)。
...
- 修改群其他信息的权限说明。
 ...
 - 对于私有群，任何人可修改群简介。
- `kTIMGroupModifyInfoParamModifyFlag`可以按位或设置多个值。不同的 flag 设置不同的键。请参考 [GroupSetInfoParam](https://cloud.tencent.com/document/product/269/33553#groupsetinfoparam)。
...
| cb | TIMCommCallback | 获取群成员信息列表成功与否的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMGroupGetMemberInfoList](https://cloud.tencent.com/document/product/269/33552#timgroupgetmemberinfolist)  |
| user_data | const void\* | 用户自定义数据， IM SDK 只负责传回给回调函数 cb ，不做任何处理 |
...
| cb | TIMCommCallback | 获取群未决信息列表成功与否的回调。回调函数定义请参考  [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) ，回调参数解析请参考  [TIMGroupGetPendencyList](https://cloud.tencent.com/document/product/269/33552#timgroupgetpendencylist)  |
| user_data | const void\* | 用户自定义数据， IM SDK 只负责传回给回调函数 cb ，不做任何处理 |
