## 功能说明
获取用户标签（必须以管理员帐号调用）。每次最多只能获取 500 个用户的标签。
...
| Tags|Object|Tags 内容，Tag 形式及含义参见 [推送请求包字段说明](http://cloud.tencent.com/document/product/269/%E6%8E%A8%E9%80%81#.E8.AF.B7.E6.B1.82.E5.8C.85.E5.AD.97.E6.AE.B5.E8.AF.B4.E6.98.8E) |
...
## 参考
添加用户标签([v4/openim/im_add_tag](https://cloud.tencent.com/document/product/269/添加用户标签))。
