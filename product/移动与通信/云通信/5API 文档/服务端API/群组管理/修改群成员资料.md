...
云通信内置以上五种群组类型，详情参阅 [群组系统](https://cloud.tencent.com/document/product/269/1502)。

>!音视频聊天室因为内部实现的问题，只能修改管理员和群主的成员资料，修改普通成员资料时会返回 10007 错误。
...
| ShutUpTime |Integer | 选填 |需禁言时间，单位为秒，为0时表示取消禁言|
