...
>!互动直播聊天室和在线成员广播大群不支持导入群基础资料，对这两种类型的群组进行操作时会返回 10007 错误；如果需要达到导入群组基础资料的效果，可以通过 [创建群组](https://cloud.tencent.com/document/product/269/1615) 和 [修改群组基础资料](https://cloud.tencent.com/document/product/269/1620) 的方式实现。
...
| GroupId | String | 选填 |为了使得群组ID更加简单，便于记忆传播，腾讯云支持APP在通过REST API创建群组时自定义群组ID。详细请参阅 [群组系统](https://cloud.tencent.com/document/product/269/1502)  |
