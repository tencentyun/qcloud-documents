...
| command  | 命令字，与 servicename 组合用来标识具体的业务功能 |示例：`v4/im_open_login_svc/account_import`，其中`account_import`为`command`<br/>参见 [REST API 接口列表](https://cloud.tencent.com/document/product/269/1520) |
