...
| GroupmsgNospeakingTime | Number | 选填|群组消息禁言时间，单位为秒，非负整数，最大值为 4294967295(十六进制 0xFFFFFFFF)。等于 0 代表取消帐号禁言；最大值 4294967295(0xFFFFFFFF)代表帐号被设置永久禁言；其它代表该帐号禁言时间  |
...
公共错误码（60000 到 79999）详见 [公共错误码](https://cloud.tencent.com/document/product/269/1671) 文档。
本 API 私有错误码如下：
