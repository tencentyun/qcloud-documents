...
>!
1. 下载消息记录里的图片、语音、文件和短视频，此功能仅适用于4.X 版本 SDK，可通过聊天记录中的 URL 字段进行下载。如您使用 2.X 或 3.X 版本的 SDK，您将无法通过该方法获取到以上信息，如您需要此功能，请您升级至 4.X 版本；
...
| MsgTime | String | 必填 |需要下载的消息记录的时间段，2015120121 表示获取 2015 年 12 月 1 日 21:00~21:59 的消息的下载地址  |
