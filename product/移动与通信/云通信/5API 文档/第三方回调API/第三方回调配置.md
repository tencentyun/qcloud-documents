...
回调的配置包含两个方面，分别为：配置回调 URL、选择启用哪些回调。这两方面的配置均可以在云通信控制台自助完成。在云通信 [控制台](https://console.cloud.tencent.com/avc) 中单击对应应用最右侧的【更多】>【回调配置】：
