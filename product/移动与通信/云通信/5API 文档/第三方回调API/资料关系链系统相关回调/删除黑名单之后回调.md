...
- 要启用回调，必须配置回调 URL，并打开本条回调协议对应的开关，配置方法详见 [第三方回调配置](https://cloud.tencent.com/document/product/269/1522#6-.E5.9B.9E.E8.B0.83.E9.85.8D.E7.BD.AE)；
...
| 字段 | 类型 | 说明 |
| --- | --- | --- |
| CallbackCommand | String | 回调命令，本回调中该字段固定为：Sns.CallbackBlackListDelete |
...
| ErrorCode | Integer | 必填 | 错误码，0 表示 App 后台处理成功，1 表示App 后台处理失败 |
