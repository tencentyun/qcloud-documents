...
另外 App 管理员也可通过 REST API 对任意群的任意成员设置禁言，详细请参阅 [REST API：设置和取消禁言](https://cloud.tencent.com/document/product/269/1627) 文档。
...
3. 确认该自定义字段的设置请求是否成功；
4. 对于群资料的自定义字段，需要在登录 IMSDK 之前，通过`TIMGroupSettings`进行相应的配置。
