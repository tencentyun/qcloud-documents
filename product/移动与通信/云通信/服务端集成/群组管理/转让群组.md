...
2. 互动直播聊天室不支持转让群组，对这种类型的群组进行操作时会返回10007错误。
...
通过[REST API在线调试工具](http://avc.qcloud.com/wiki2.0/im/APITester/APITester.html#v4/group_open_http_svc/change_group_owner)调试本接口。 
