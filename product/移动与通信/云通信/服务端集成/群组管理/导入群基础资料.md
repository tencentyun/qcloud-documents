...
__说明__：互动直播聊天室和在线成员广播大群不支持导入群基础资料，对这两种类型的群组进行操作时会返回 10007 错误。如果需要达到导入群组基础资料的效果，可以通过[创建群组](/doc/product/269/创建群组)和[修改群组基础资料](/doc/product/269/修改群组基础资料)的方式实现。
