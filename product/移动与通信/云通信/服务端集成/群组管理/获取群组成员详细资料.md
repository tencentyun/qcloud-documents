...
2. 互动直播聊天室因为内部实现的差异，只能获取1000人以内的群成员资料，群人数达到1000后加入的群成员的成员资料无法被获取。
...
通过[REST API在线调试工具](http://avc.qcloud.com/wiki2.0/im/APITester/APITester.html#v4/group_open_http_svc/get_group_member_info)调试本接口。 
