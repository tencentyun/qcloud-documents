...
<table style="display:table;width:100%">
	<tbody>
		...
		<tr>
			<td>ResultCode</td>
			<td>Integer </td>
			<td>批量更新好友的单个好友的处理结果，0表示业务成功，非0表示业务失败。</td>
		</tr>
		<tr>
			<td>Fail_Account</td>
			<td>Array </td>
...
通过[REST API在线调试工具](http://avc.qcloud.com/wiki2.0/im/APITester/APITester.html#v4/sns/friend_update)调试本接口。 
