...
### 2.1 请求URL 
```
https://avc.qcloud.com/im/APITester/APITester.html#v4/sns/group_add?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 2.2 请求参数 
...
通过[REST API在线调试工具](https://avc.qcloud.com/im/APITester/APITester.html#v4/sns/group_add)调试本接口。 
