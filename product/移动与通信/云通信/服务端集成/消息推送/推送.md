...
| MsgBody | Object |必填 | 消息内容，具体格式请参考 [MsgBody消息内容说明](/doc/product/269/消息格式描述#1-.E6.B6.88.E6.81.AF.E5.86.85.E5.AE.B9msgbody.E8.AF.B4.E6.98.8E)。（一条消息可包括多种消息元素，所以MsgBody 为 Array 类型）  |
...
| 90002 |Json 格式请求包中 MsgBody 不符合消息格式描述，或者 MsgBody 不是 Array 类型，请参考 [MsgBody消息内容说明](/doc/product/269/消息格式描述#1-.E6.B6.88.E6.81.AF.E5.86.85.E5.AE.B9msgbody.E8.AF.B4.E6.98.8E)。|
...
| 90010 |Json 格式请求包不符合消息格式描述，请参考 [TIMMsgElement对象](/doc/product/269/消息格式描述#2-.E6.B6.88.E6.81.AF.E5.85.83.E7.B4.A0timmsgelement) 的定义。|
