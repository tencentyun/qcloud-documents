...
目前处于公测阶段，暂时最高1秒1次。单次推送用户量超过100万用户的，请咨询客户经理。
...
管理员给全员推送消息，并且消息离线保存1天(例子中MsgLifeTime为120秒，即2分钟)：
...
管理员给关注”股票A“或“股票B”的用户推送消息，并且消息离线保存1天(例子中MsgLifeTime为120秒，即2分钟)：
...
管理员给在深圳的超白金用户用户推送消息，并且消息离线保存1天(例子中MsgLifeTime为120秒，即2分钟)：
