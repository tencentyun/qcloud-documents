...
本接口适用于将应用自有帐号信息批量导入腾讯云。该接口的功能是在腾讯内部创建一个内部ID，使没有登录腾讯云的应用自有帐号能够使用腾讯云服务。
...
通过[REST API在线调试](http://avc.qcloud.com/wiki2.0/im/APITester/APITester.html#v4/im_open_login_svc/multiaccount_import)工具调试本接口。
