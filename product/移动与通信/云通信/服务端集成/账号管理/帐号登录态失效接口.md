...
| 70403 | 发起操作者不是[APP管理员](/doc/product/269/帐号登录集成说明#3.4-app.E7.AE.A1.E7.90.86.E5.91.98)，没有权限操作。  | 

## 3 接口调试工具 

### 3.1 Web调试工具 

通过[REST API在线调试](https://avc.qcloud.com/im/APITester/APITester.html#v4/im_open_login_svc/kick)工具调试本接口。
