...
### 2.1 请求URL 
```
https://avc.qcloud.com/im/APITester/APITester.html#v4/profile/portrait_get?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 2.2 请求参数 
...
<table style="display:table;width:100%">
	<tbody>
		...
		<tr>
			...
			<td>
				拉取的资料对象的值，详情可参见<a href="http://www.qcloud.com/doc/product/269/%E8%B5%84%E6%96%99%E7%B3%BB%E7%BB%9F#2-.E8.B5.84.E6.96.99.E5.AD.97.E6.AE.B5">资料字段</a>。
			</td>
		</tr>
		<tr>
			<td>ResultCode </td>
