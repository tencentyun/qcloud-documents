...
### 2.1 请求URL 
```
https://avc.qcloud.com/im/APITester/APITester.html#v4/profile/portrait_set?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json 
```
### 2.2 请求参数 
