...
本文主要介绍如何快速地将云通信 IM Demo（Windows）工程运行起来，您只需参考如下步骤依次执行即可。

## 1. 创建应用
登录 [云通信 IM 控制台](https://console.cloud.tencent.com/avc)，在**应用列表**页，单击【创建应用接入】，在**创建新应用**弹框中，填写新建应用的信息，单击【确认】。
...
## 4. 下载 Demo 源码
从 [Github](https://github.com/tencentyun/TIMSDK/tree/master/cross-platform/Windows) 下载 IM SDK Windows IMApp 工程代码。
