...
<table style="display:table;width:100%;">
    <tbody>
        ...
        <tr>
            ...
            <td>
                单个 App 最多可拥有 1 亿个群组。单 App 每天净增群组限制 500 个，如果超出该限制，需 <a href="https://cloud.tencent.com/product/im#price">付费</a> 使用，请提 <a href="/document/product/269/3916#.E4.BF.AE.E6.94.B9.E6.AF.8F.E6.97.A5.E5.88.9B.E5.BB.BA.E7.BE.A4.E7.BB.84.E9.85.8D.E9.A2.9D">工单</a> 开通。
            </td>
        </tr>
        <tr>
            <td>
