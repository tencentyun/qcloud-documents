...
| 字段 | 类型 | 说明 |
|---------|---------|---------|
| Text | String | 消息内容。当接收方为 iPhone 或 Android 后台在线时，作为离线推送的文本展示。 |
    
当接收方为 iPhone 或 Android，且应用处于后台时，json 请求包体中的 Text 字段作为离线推送的文本展示。
...
当接收方为 iOS 或 Android，且应用处于后台时，中文版离线推送文本为“[位置]”，英文版离线推送文本为“[Location]”。
...
|Desc|String|自定义消息描述信息；当接收方为 iPhone 或 Android 后台在线时，做离线推送文本展示。|
