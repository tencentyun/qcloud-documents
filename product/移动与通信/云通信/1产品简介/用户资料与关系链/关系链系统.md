...
## 好友表
即时通信 IM 的好友列表默认允许添加3000个好友，如对好友表的大小有特殊需求，请联系 [腾讯云客服](https://cloud.tencent.com/about/connect)。
好友表支持标配好友字段和自定义好友字段。
...
App 管理员可以通过即时通信 IM [控制台](https://console.cloud.tencent.com/avc/list) >【应用配置】>【功能配置】申请自定义好友字段，申请提交后，自定义好友字段将在30分钟内生效。
