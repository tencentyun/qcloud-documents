...
## 好友表
云通信 IM 的好友列表默认允许添加3000个好友，如对好友表的大小有特殊需求，请联系 [腾讯云客服](https://cloud.tencent.com/about/connect)。
好友表支持标配好友字段和自定义好友字段。
...
- 自定义好友字段的名称（Key）。
- 自定义好友字段的类型（Value）：详情可参见 <a href="https://cloud.tencent.com/document/product/269/1501#.E5.85.B3.E7.B3.BB.E9.93.BE.E5.AD.97.E6.AE.B5">关系链字段</a>。



### 添加好友

云通信 IM 支持的加好友模式有：批量加好友、一回合加好友和两回合加好友，详情可参见 <a href="https://cloud.tencent.com/document/product/269/1643">添加好友</a>。
...
云通信 IM 也支持批量删除好友，更多信息可参见 <a href="https://cloud.tencent.com/document/product/269/1644">删除好友</a>。

### 拉取好友
云通信 IM 支持以下三种拉好友模式：不带好友的增量拉取模式、全量分页拉取模式以及带好友拉取模式。详情可参见 <a href="https://cloud.tencent.com/document/product/269/1647">拉取好友</a>。
...
### 添加黑名单
云通信 IM 支持批量添加黑名单，详情可参见：<a href="https://cloud.tencent.com/document/product/269/3718">添加黑名单</a>。

### 删除黑名单
云通信 IM 支持批量删除黑名单，详情可参见：<a href="https://cloud.tencent.com/document/product/269/3719">删除黑名单</a>。

### 拉取黑名单
云通信 IM 支持通过分页模式拉取全量黑名单，详情可参见：<a href="https://cloud.tencent.com/document/product/269/3722">拉取黑名单</a>。
...
- [关系链（Web SDK）](https://cloud.tencent.com/document/product/269/1600)
- [好友系统消息（Web SDK）](https://cloud.tencent.com/document/product/269/5848)
