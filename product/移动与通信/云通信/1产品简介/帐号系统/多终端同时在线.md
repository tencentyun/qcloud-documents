...
### 同时在线
此功能需要 [提工单](https://console.cloud.tencent.com/workorder/category?level1_id=29&level2_id=40&source=0&data_title=%E4%BA%91%E9%80%9A%E4%BF%A1%20%20IM&step=1) 修改同时在线策略，工单填写可参考 [云通信配置变更需求工单](https://cloud.tencent.com/document/product/269/3916#.E6.94.AF.E6.8C.81.E5.A4.9A.E7.BB.88.E7.AB.AF.E5.90.8C.E6.97.B6.E5.9C.A8.E7.BA.BF) 中的支持多终端同时在线模板。通过配置可以做到 PC 端和手机端同时在线，或者 PC、iOS 和 Android 都可以同时在线，开启了同时在线登录不同终端不会互踢（但是两个相同终端，如两个 iOS 端登录仍然会互踢）。
