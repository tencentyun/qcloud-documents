...
## 升级
单击目标应用所在行的【升级】，弹出**升级提醒**对话框。默认开通专业版（对应云通信 IM 预付费专业版），同时可以对“**音视频聊天室**”、“**单人可创建及加入群数（个）**”及“**单个群群成员上限**”进行选择性配置（对应云通信 IM 预付费扩展功能包），具体价格请参见 [价格说明](https://cloud.tencent.com/document/product/269/11673) ，配置完毕后单击【确认】完成升级。
