本章节将帮助您快速接入使用的 MTA 统计功能，高级功能接入请参考 [高级功能接入](http://docs.developer.qq.com/mta/advance_access.html)或者 [接口说明](/document/product/549/12859) MTA.h 以及 MTAConfig.h 头文件。
