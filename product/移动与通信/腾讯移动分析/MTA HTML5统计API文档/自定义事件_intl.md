### Feature Description
Query pv\uv\vv\iv of custom events on a daily basis.

**API URL:** `http://mta.qq.com/h5/api/ctr_custom`
...
| custom | String | Custom event ID | Multiple custom event IDs are separated with "," and must be URL-encoded |
