### Feature Description
Query analysis data of channels on a daily basis.

**API URL:** `http://mta.qq.com/h5/api/ctr_adtag`
...
| adtags | String | Channel ID | IDs are separated with ",", for example: weixin, weixin.p1.p2, and must be URL-encoded |
...
| iv | Number of IPs used to visit a website in a day | <br\> |
