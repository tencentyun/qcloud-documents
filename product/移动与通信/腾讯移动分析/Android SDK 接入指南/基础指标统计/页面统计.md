...
```
>**注意：**
>onResume 和 onPause 或 trackBeginPage 和 trackEndPage 需要成对使用才能正常统计 activity，为了统计准确性，建议在每个 activity 中都调用以上接口，否则可能会导致 MTA 上报过多的启动次数，解决办法参考 特殊需求。
