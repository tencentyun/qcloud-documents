...
4. 实物奖励：抽中后客户需要填写邮寄地址，24H后不填写将失效。
![](https://qcloudimg.tencent-cloud.cn/raw/362fb61ba6eefd2dfc78d1a27b898429.png)
## FAQ
### 1. 积分能改成金币吗？
管理端统一称为积分，前端源码组件可通过属性进行[配置](https://github.com/TencentCloudBase-PageModule/sign-up/tree/master/miniprogram)，可以自由设置 名称与logo。