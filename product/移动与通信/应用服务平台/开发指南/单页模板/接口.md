...
## sdk
[@cloudbase/page-module](https://www.npmjs.com/package/@cloudbase/page-module)同一个SDK支持小程序以及服务端。
...
### 引入sdk
#### 小程序组件自带sdk
小程序组件导入时自带 `@cloudbase/page-module`的npm包，可直接使用，无需额外引入。
...
// 初始化模块名称，如果是在云函数里则无需 secretId和secretKey。云函数外，需要先获取访问秘钥 https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-http-api/utils/getQcloudToken.html
const pageModule = new PageModule('tcb:sign_up', {
...
![](https://qcloudimg.tencent-cloud.cn/raw/d16a475f88d54760907addd7697709f1.png)
1. 单击**下一步**，确认连接到云函数。
