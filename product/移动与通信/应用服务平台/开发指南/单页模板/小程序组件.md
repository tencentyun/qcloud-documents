...
`miniprogram/page_module/sign-in/pages`下为示例的页面。
小程序的页面路径需要添加到`miniprogram/app.json`内的[`pages`](https://developers.weixin.qq.com/miniprogram/dev/reference/configuration/app.html#pages)。
