...
- 当使用小程序云开发控制台进行导入时，需要已下载并安装 [微信小程序工具](https://developers.weixin.qq.com/miniprogram/dev/devtools/download.html)；
- 当使用腾讯云云开发控制台进行导入时，您需要前往 [云开发控制台](https://console.cloud.tencent.com/tcb)。
...
**腾讯云云开发控制台**
![](https://main.qcloudimg.com/raw/ba4820eb34b02c983883e18beb917442.png)
