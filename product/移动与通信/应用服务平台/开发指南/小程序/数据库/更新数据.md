...
在这章节我们一起看看如何使用数据库 API 完成数据更新，在本节中我们还是沿用[读取数据](./读取数据.md)章节中使用的数据。
...
更完整详细的更新指令可以参考[数据库 API 文档](../../../服务端%20SDK%20文档/Node%20SDK/数据库.md#更新文档)
...
下一章 [删除数据](./删除数据.md)，我们将一起学习如何删除数据。