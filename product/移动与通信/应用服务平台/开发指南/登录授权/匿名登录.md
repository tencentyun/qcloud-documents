...
### 控制台开启匿名登录和配置域名
#### 开启匿名登录
在 Cloudbase [控制台](https://console.cloud.tencent.com/tcb/user) ，单击需配置的环境，在【环境设置】> [ 登录方式](https://console.cloud.tencent.com/tcb/env/setting?tab=loginConfig) 下启用 **匿名登录**。
![](https://main.qcloudimg.com/raw/98b30344ab2494144f3a550375929eea.png)
