...
:::
::: Flutter
详情请见 [Flutter SDK-微信授权登录](https://docs.cloudbase.net/api-reference/flutter/authentication#微信授权登录)
:::
</dx-tabs>
...
:::
:::Flutter
详情请参见 [Flutter SDK-微信授权登录](https://docs.cloudbase.net/api-reference/flutter/authentication#微信授权登录)
:::
</dx-tabs>
参数说明如下：
<table>
