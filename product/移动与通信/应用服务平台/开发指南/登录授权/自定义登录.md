...
开发者还可以编写一个云函数来创建 Ticket，然后客户端使用HTTP 访问服务 HTTP 请求调用这个云函数获取 Ticket，详细的HTTP 访问服务方案请参阅 [使用HTTP 访问服务访问云函数](https://cloud.tencent.com/document/product/876/41776)。
