...
随后便可以通过 `https://${env}.${region}.app.tcloudbase.com/hello` 直接访问函数，其中 `${env}` 是环境 ID

```sh
curl https://${env}.${region}.app.tcloudbase.com/hello
hello world!
```

也可以直接在浏览器内打开 `https://${env}.${region}.app.tcloudbase.com/hello`
