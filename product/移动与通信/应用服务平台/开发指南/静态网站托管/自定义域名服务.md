...
2. 进入静态网站页面，选择【基础设置】，单击【添加域名】，进行域名添加，如下图所示：
![](https://main.qcloudimg.com/raw/eba82413045bed15f970a79ce55be617.png)
3. 添加后，系统会为你自动分配一个以 `.cdn.dnsv1.com` 为后缀的 CNAME 域名，CNAME 域名不能直接访问，你需要在域名服务提供商处完成 CNAME 配置，配置生效后，你的托管服务方可对自定义域名生效。
