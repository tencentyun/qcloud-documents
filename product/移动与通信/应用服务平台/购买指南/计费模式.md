腾讯云云开发提供报年报月和按量计费两种计费方式，具体说明如下：

| 计费模式 | 包年包月   |   按量计费   |                       
| :----- | :----- |:----- |
| 付费方式   | 预付费 | 结算时冻结费用，每日结算|
| 计费单位    | 元/月 |  具体见 [产品定价](https://cloud.tencent.com/document/product/876/39095)|
| 资源配置调整    | 满足条件下可随时调整配置。具体条件限制详情请参见 [套餐变更](https://cloud.tencent.com/document/product/876/30929)   | 按量使用，无需手动调整配置|
