...
子账号需要主账号授权资源访问权限后，授予子账号 [QcloudAccessForTCBRole](https://console.cloud.tencent.com/cam/policy/detail/8825032&QcloudAccessForTCBRole&2)，[QcloudAccessForTCBRoleInAccessCloudBaseRun](https://console.cloud.tencent.com/cam/policy/detail/34661685&QcloudAccessForTCBRoleInAccessCloudBaseRun&2) 策略，后续云开发新增的能力将会自动扩展该策略。

>!该权限包含底层对象存储、云函数、日志、监控、VPC等资源的全读写权限，一旦为子账号添加此策略，将意味着子账号拥有上述资源，并自动拥有后续新增资源的全读写权限，因此请慎重选择，详情可点击权限名称跳转查看权限规则。
