...
1. 打开 [云开发控制台](https://console.cloud.tencent.com/tcb/cloudaccess)。
2. 选择目标环境 `CustomEnv` 后，在更多扩展能力下单击【安装】【图像盲水印】扩展，并按提示完成扩展安装。
...
1. 在控制台[【云函数】](https://console.cloud.tencent.com/tcb/scf/index) 页面创建云函数如 image_watermark_demo，如下图所示。
