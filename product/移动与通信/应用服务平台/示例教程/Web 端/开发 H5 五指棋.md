...
![](https://main.qcloudimg.com/raw/7c797e4c03a3e83a9c83acff069ee8aa.jpg)
...
4. 运行命令提示符，定位到源码所在的目录，执行如下命令，将项目到云开发静态托管中（需要将 EnvID 替换为 [步骤1](#step1.3) 中您所创建的环境 ID）。
```plaintext
