...
>?预付费旧套餐会按照剩余时间退款，基础资源包满足退款条件（7日内未使用）会退款，短信资源包可在新计费套餐里正常使用。您可直接在微信 IDE（控制台版本为1.4.96及以上） [升级计费套餐](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/billing/instruction.html)。
