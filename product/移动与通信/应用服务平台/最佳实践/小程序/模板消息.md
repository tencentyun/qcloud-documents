...
## 体验功能
![](https://main.qcloudimg.com/raw/f36ab01f3fd9e0f899c879f71d11fdff.png)
...
```
具体的参数请参考 [小程序开发文档](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/template-message/sendTemplateMessage.html)。

这里我们介绍下使用 wx-js-utils 封装方法，如下所示：
```js
...
#### 官网接口
官方的发送统一服务消息 API 如下所示：
```js
POST https://api.weixin.qq.com/cgi-bin/message/wxopen/template/uniform_send?access_token=ACCESS_TOKEN
```
具体的参数请参考 [小程序开发文档](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/uniform-message/sendUniformMessage.html)。
...
>! weapp_template_msg 和 mp_template_msg 的关系，两者都有，发送 weapp_template_msg 所代表的小程序模板消息，weapp_template_msg 不存在而 mp_template_msg 存在时，则发送公众号模板消息。
