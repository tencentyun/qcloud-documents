...
|省心|serverless无服务器化，架构弹性可自动扩缩容，无需担心网站崩溃|
...
2. 访问流量不稳定的，没有流量时，云托管将自动缩容到0，减少成本
...
* 管理员用户名：Discuz! Q 后台管理系统的管理员用户名，默认 admin
* 管理员密码：Discuz! Q 后台管理系统的管理员密码，第一次安装时，会设置并加密存储在数据库内，之后变更请前往管理系统的用户管理面板重置密码，请参考[用户管理](https://discuz.com/manual-admin/3.html#_3-1-%E7%94%A8%E6%88%B7%E7%AE%A1%E7%90%86)
