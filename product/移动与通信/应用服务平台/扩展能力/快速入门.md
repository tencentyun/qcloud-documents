扩展应用依托于云开发，开发者不再需要进行复杂的配置和调试，即可便捷调用各种能力 API 和云上资源。以下是使用图像盲水印的过程：

## 步骤1：安装扩展

1. 登录 [云开发](https://console.cloud.tencent.com/tcb) 控制台，选择环境，选择左侧导航栏中的【扩展应用】。
2. 单击“图像盲水印”上的【安装】，按照步骤提示进行安装扩展。

![安装扩展](https://main.qcloudimg.com/raw/2b19f1d3fd08564c52cb91bd9ae4d9c0.png)

> ! 微信小程序开发者请使用【其他登录方式】-【微信公众号登录】登录，再选择关联的小程序账户登录；QQ 小程序开发者可直接通过 QQ 小程序开发者 IDE【云开发】登录，也可以通过关联的腾讯云账户登录。
...
2. 登录 [云开发](https://console.cloud.tencent.com/tcb) 控制台，选择环境（与扩展应用同一环境），选择左侧导航栏中的【云存储】。单击【上传文件】，将两张图片上传至云存储。
...
![](https://main.qcloudimg.com/raw/99e24c0e4c881c3947138fd735ffcbc9.png)
