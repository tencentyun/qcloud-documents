...
如果您的原有业务代码中使用了MySQL连接池，在云函数中可能就不需要连接池了，每个请求都会分发到不同的云函数实例中，通常情况下，一个云函数有一个MySQL连接就可以。
...
[深入理解云函数-云函数的运行机制](https://docs.cloudbase.net/cloud-function/deep-priciple.html)
