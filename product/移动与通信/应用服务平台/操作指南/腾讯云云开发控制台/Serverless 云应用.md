Serverless 云应用的实例称为服务，Serverless 云应用提供的服务管理包含**新建**服务、对服务进行**版本管理**、**服务配置**、**操作历史**。您无需维护复杂的容器环境，一键开通即可享受自动扩缩容的容器资源。


## 服务管理
### 新建服务

- 点击【新建服务】，选择服务关联的镜像仓库。推荐使用**系统默认仓库**，系统将会为每个新服务创建一个同名的腾讯云镜像仓库并绑定；若需要绑定已有镜像仓库，可切换至**绑定已有腾讯云镜像仓库**，选择镜像仓库。
  ![](https://main.qcloudimg.com/raw/d8eb2ab4e544b9ea901e2565dfa24bb2.png)

- 服务创建成功后，可根据系统指引进行版本配置。
  ![](https://main.qcloudimg.com/raw/28c505b2f406fb35d4d80d61b2b3d068.png)

### 删除服务
删除服务时：

- 如果服务未创建版本，可点击【删除】直接进行删除；
  ![](https://main.qcloudimg.com/raw/cce3e63fa513031a474c23d82bdf50a7.png)

- 如果该服务已经进行版本配置，则需要首先清空版本再删除该服务。
  ![](https://main.qcloudimg.com/raw/4035aef4830e0975551fac89449c2798.png)
...
2. **高级配置**
 ...
 - 环境变量：用户所需的环境变量，以 key value 的形式可配置多个环境变量。
    ...
    ![](https://main.qcloudimg.com/raw/5eb817921fc2bcdaccbf5172d061ba4f.png)

3. 系统根据配置创建版本后，用户可在具体的版本中查看当前版本配置。
![](https://main.qcloudimg.com/raw/07536d0a45fb3e01363b24c82d258d26.png)

### 流量灰度
1. 用户可在版本列表中查看当前拥有的版本。当用户的某个服务拥有一个以上的版本时，可对不同版本进行流量配置，从而实现灰度配置。
![](https://main.qcloudimg.com/raw/e583a5176d6c4512c32f74c1825aae2b.png)

    >?目前仅支持对开启了外网访问的服务进行流量配置。

2. 单击【流量配置】，目前支持按源 IP 的流量灰度。
   ![](https://main.qcloudimg.com/raw/1f5dcb8d6c0219ca086bd203973a0c6f.png)

3. 选择对应版本的流量比例，所有版本流量百分比相加需为100%。
   ![](https://main.qcloudimg.com/raw/bb6082c3da1576da06b79fbcb21c3455.png)
...
![](https://main.qcloudimg.com/raw/81bda0d9a35e3cf2a5b732d101f4d4d3.png)

## 操作历史
1. 在操作历史中，可查看版本创建的历史记录。
![](https://main.qcloudimg.com/raw/8fd6adbae13d607103503ae010259119.png)
...
## 监控信息
进入某个版本内，点击【监控】，在监控中，可查看到当前服务的监控数据。
![](https://main.qcloudimg.com/raw/6044e9bbf6da2dd147d575dcda9d3c16.png)
