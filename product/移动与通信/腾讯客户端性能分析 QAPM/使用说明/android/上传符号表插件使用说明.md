...
3. 将 [步骤2](#step2) 中的 UploadSymbolFile-1.0.jar 和 UploadSymbolFile-1.0.pom 文件拷贝至 repo 目录中。如下图所示：
...
```
6. 同步 gradle 文件，即可在 app 的 gradle 下，查看到2个新生成的 task。如下图所示：
![5](https://main.qcloudimg.com/raw/ff508e57db0abe049ca94b246c6776dd.png)
7. 设置 app 为混淆编译。如下图所示：
![6](https://main.qcloudimg.com/raw/2fa82c64bada29cf02e50c94884cea17.png)
8. 执行 app 工程 gradle 中 assembleRelease 任务编包，查看 task 执行情况。如下图所示：
