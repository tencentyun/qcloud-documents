...
在开通客户端性能监控服务前，您需要先注册一个腾讯云账号。请单击下方按钮开始注册。（如果您已注册，请跳过该步骤。）
...
当内测申请审核通过后，我们将以邮件方式通知您，您可再次单击内测申请链接（如下按钮），此时将直接跳转到 QAPM 控制台。


<div style="background-color:#00A4FF; width: 170px; height: 35px; line-height:35px; text-align:center;"><a href="https://cloud.tencent.com/apply/p/c0a2mlkk6e5" target="_blank"  style="color: white; font-size:16px;">前往控制台</a></div>
</br>
