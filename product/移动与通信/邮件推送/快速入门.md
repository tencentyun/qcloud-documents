...
登录 [邮件推送控制台](https://console.cloud.tencent.com/ses)。如果没有腾讯云账号，请参考 [账号注册](https://cloud.tencent.com/document/product/378/17985)。
...
### 步骤7：发送邮件[](id:Step7)
当域名注册完成和模板通过审核后，就可进行发送邮件。您可通过邮件推送控制台或调用云 API 的方式发送邮件。云 API 发送邮件请参阅 [API 文档](https://cloud.tencent.com/document/product/1288/51062)。
1. 单击【邮件发送】，进入到邮件发送页面。
![](https://main.qcloudimg.com/raw/f358f2e16383c53bc2f6eb7b92fa6354.png)
2. 结合实际情况设置以下参数：
 - 模板选择：选择 [步骤6](#Step6) 中**已审核通过**的邮件模板。
 - 邮件主题：输入相应的邮件主题。
 - 发件人选择：选择 [步骤5](#Step5) 中已配置好的发信地址。
 - 收件人：输入想要发送的邮箱地址。
 - 变量设置：
