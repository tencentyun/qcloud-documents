...
|-----|-----|-----|
| group_id | const char\* | 群 ID |
| json_group_counter_array | const char\* | 群计数器信息列表，群计数器信息请参考 [TIMGroupCounter](https://cloud.tencent.com/document/product/269/33553#timgroupcounter) |
| cb | TIMCommCallback | 设置群计数器的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
...
|-----|-----|-----|
| group_id | const char\* | 群 ID |
| json_group_counter_key_array | const char\* | 需要获取的群计数器的 key 列表，群计数器信息请参考 [TIMGroupCounter](https://cloud.tencent.com/document/product/269/33553#timgroupcounter) |
| cb | TIMCommCallback | 获取群计数器的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
...
|-----|-----|-----|
| group_id | const char\* | 群 ID |
| group_counter_key | const char\* | 群计数器的 key |
| group_counter_value | int64_t | 群计数器的递增变化量 value |
| cb | TIMCommCallback | 递增群计数器的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
...
| group_id | const char\* | 群 ID |
| group_counter_key | const char\* | 群计数器的 key |
| group_counter_value | int64_t | 群计数器的递减变化量 value |
| cb | TIMCommCallback | 递减群计数器的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
...
>?SDK 会搜索群名称包含于关键字列表 keywordList 的所有群并返回群信息列表。关键字列表最多支持 5 个。
...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| cb | TIMCommCallback | 获取社群列表的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
...
|-----|-----|-----|
| group_id | const char\* | 群 ID |
| json_topic_info | const char\* | 话题信息，具体请参考 [TIMGroupTopicInfo](https://cloud.tencent.com/document/product/269/33553#timgrouptopicinfo) |
| cb | TIMCommCallback | 创建话题的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
...
|-----|-----|-----|
| group_id | const char\* | 群 ID |
| json_topic_id_array | const char\* | 话题 ID 列表 |
| cb | TIMCommCallback | 删除话题的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
...
|-----|-----|-----|
| json_topic_info | const char\* | 话题信息，具体请参考 [TIMGroupTopicInfo](https://cloud.tencent.com/document/product/269/33553#timgrouptopicinfo) |
| cb | TIMCommCallback | 修改话题信息的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
...
topic_info[kTIMGroupTopicInfoModifyFlag] = kTIMGroupModifyInfoFlag_Name | kTIMGroupModifyInfoFlag_Notification;
...
| group_id | const char\* | 群 ID |
| json_topic_id_array | const char\* | 话题 ID 列表 |
| cb | TIMCommCallback | 获取话题列表的回调。回调函数定义和参数解析请参考 [TIMCommCallback](https://cloud.tencent.com/document/product/269/33552#timcommcallback) |
| user_data | const void\* | 用户自定义数据，IM SDK 只负责传回给回调函数 cb，不做任何处理 |
