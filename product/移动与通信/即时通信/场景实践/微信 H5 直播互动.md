...
npm i tweblive
```
2. 运行 Web 直播互动组件，示例代码如下。
<pre><code class="language-javascript"><span class="hljs-comment">// npm install TWebLive -S</span>
...
<span class="hljs-keyword">let</span> options = {
  <span class="hljs-attr">SDKAppID</span>: <span class="hljs-number">0</span>, <span class="hljs-comment">// 接入时需要将0替换为您的云通信应用的 SDKAppID</span>
...
如果在 Windows 或 Mac 平台推直播流，强烈建议使用 [TRTC Electron](https://github.com/tencentyun/TRTCSDK/tree/master/Electron)，与腾讯云即时通信 IM 可以完美结合，稳定可靠。
