...
| [TLS.EVENT.PROFILE_UPDATE](#tls.event.profile_update)        | 个人资料发生修改是触发。                                     |
...
| [TLS.EVENT.LIKE](#tls.event.like)                            | 有人给主播点赞是触发。                                       |
| [TLS.EVENT.BUY_GOODS](#tls.event.buy_goods)                  | 有人购买商品是触发。                                         |
| [TLS.EVENT.SEND_GIFT](#tls.event.send_gift)                  | 有人给主播送礼时触发。                                       |
| [TLS.EVENT.ATTENT](#tls.event.attent)                        | 有人关注主播时触发。                                         |
| [TLS.EVENT.ADD_GOODS](#tls.event.add_goods)                  | 该直播中所推荐的商品发生改变是出发。                         |
