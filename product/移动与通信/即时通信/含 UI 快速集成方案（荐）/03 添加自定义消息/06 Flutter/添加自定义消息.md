...
您可以在 [V2TimAdvancedMsgListener](https://comm.qq.com/im/doc/flutter/api/keyClass/listener/v2timadvancedmsglistener.html) 的 `onRecvNewMessage` 监听器属性接收自定义消息。收到的自定义消息最终会以 TIMUIKitChat中messageItemBuilder 的 [customMessageItemBuilder](https://comm.qq.com/im/doc/flutter/uikit-sdk-api/TIMUIKitChat/MessageItemBuilder.html) 所定义的形式展示在消息列表中
