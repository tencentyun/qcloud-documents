...
## 选定底层地图 SDK
本插件大部分业务逻辑接口基于百度地图设计，[选用百度地图可较快完成项目](https://docs.qq.com/doc/DSXRBZG1CUGhIVEZx)。但不限制具体使用哪一块地图 SDK，常用地图 Flutter SDK 如下：
...
**推荐：若选用百度地图，[可直接查看此文档](https://docs.qq.com/doc/DSXRBZG1CUGhIVEZx)，快速完成集成。**
