...
>?vivo 要求应用在上架后，才能使用正式推送服务。如果您需要在开发中调试 vivo 机器，请参考本文最后一节`VIVO调试`内容，开启测试模式。
...
3. 此时，可推送测试消息至测试设备。可参考[vivo单播推送文档](https://dev.vivo.com.cn/documentCenter/doc/363#w2-98542835)。
