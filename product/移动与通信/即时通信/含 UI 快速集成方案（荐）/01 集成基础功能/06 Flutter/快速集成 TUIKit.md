...
>? 本含 TUIKit tencent-cloud-chat-uikit 已开源，您可引入 [在线版本](https://pub.dev/packages/tencent-cloud-chat-uikit)，也可 [GitHub fork](https://github.com/TencentCloud/TIMSDK/tree/master/Flutter/IMSDK/tencent-cloud-chat-uikit) 后本地引入使用。
