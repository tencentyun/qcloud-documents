...
在使用离线推送之前，您需要开通 [IM 离线推送](https://cloud.tencent.com/document/product/269/75429) 服务。关于 APP 的配置，您也可以参考 TUIKitDemo 内的  [AppDelegate+Push](https://github.com/TencentCloud/TIMSDK/blob/master/iOS/Demo/TUIKitDemo/AppDelegate+Push.h) 和  [AppDelegate+APNS](https://github.com/TencentCloud/TIMSDK/blob/master/iOS/Demo/TUIKitDemo/AppDelegate+APNS.m) 文件快速接入 APNs 推送。
