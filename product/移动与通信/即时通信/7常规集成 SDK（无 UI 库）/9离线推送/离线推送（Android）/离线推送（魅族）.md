...
5. 根据 [步骤1](#Step1_3) 中获取的信息设置以下参数：
 ...
 ![](https://main.qcloudimg.com/raw/3c9ee9fb55c23fe8340b7623edf0c70d.png)
6. 单击【确定】保存信息，证书信息保存后10分钟内生效。
7. 待推送证书信息生成后，记录**`证书 ID`** 。
 ![](https://main.qcloudimg.com/raw/4ad0a0b1f61e77448c613feb08df0cf6.png)
...
- 如需打开网页，则需输入以`http://`或`https://`开头的网址，例如`https://cloud.tencent.com/document/product/269`。
- 如需打开应用内指定界面，则需输入需要打开的 Activity 的完整类名，例如`com.tencent.qcloud.tim.demo.chat.ChatActivity`。

![](https://main.qcloudimg.com/raw/30bab1b0c29e7334a6b33f478f3cad49.png)
