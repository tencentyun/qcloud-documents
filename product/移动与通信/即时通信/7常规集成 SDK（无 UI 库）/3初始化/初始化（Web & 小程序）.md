## SDK 初始化
IM Web SDK 一切操作都是由创建 SDK 实例开始， 第一步需要获取 SDK 实例，例子如下。
...
tim.on(TIM.EVENT.KICKED_OUT, function(event) {
  ...
  // event.data.type - 被踢下线的原因，如：TIM.TYPES.KICKED_OUT_MULT_ACCOUNT 多账号登录被踢
});
```

更详细的初始化流程和 API 使用介绍请看 [SDK 初始化](https://imsdk-1252463788.file.myqcloud.com/IM_DOC/Web/SDK.html)。