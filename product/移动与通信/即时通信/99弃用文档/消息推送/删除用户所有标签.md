## 功能说明
管理员给用户删除所有标签。注意每次最多只能给 500 个用户删除所有标签。

## 接口调用说明
### 请求 URL 示例
```
https://console.tim.qq.com/v4/openim/im_remove_all_tags?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 请求参数说明
...
| v4/openim/im_remove_all_tags  | 请求接口                  |
...
## 接口调试工具
通过 [REST API 在线调试](https://avc.qcloud.com/im/APITester/APITester.html#v4/openim/im_remove_all_tags)工具调试本接口。

## 参考

- 添加用户标签(  [v4/openim/im_remove_tag](https://cloud.tencent.com/document/product/269/删除用户标签))；
