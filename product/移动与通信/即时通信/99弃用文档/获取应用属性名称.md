...
### 请求 URL 示例
```
https://console.tim.qq.com/v4/openim/im_get_attr_name?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
...
| v4/openim/im_get_attr_name  | 请求接口                             |
...
| AttrNames| Object | 包含多个键对。每对键值对，表示第几个属性对应的名称。比如 "0":"xxx" 表示第 0 号属性的名称是 xxx |
...
## 接口调试工具
通过 [REST API 在线调试](https://avc.qcloud.com/im/APITester/APITester.html#v4/openim/im_get_attr_name) 工具调试本接口。

## 参考
设置应用属性名称([v4/openim/im_set_attr_name](https://cloud.tencent.com/document/product/269/设置应用属性名称))。
