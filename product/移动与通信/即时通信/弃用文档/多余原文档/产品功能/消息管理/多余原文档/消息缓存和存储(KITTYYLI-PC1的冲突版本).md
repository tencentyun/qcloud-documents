...
### 漫游消息保存时长
默认情况下，单聊消息和群聊消息有 7 天漫游，超过漫游时长的消息会会被删除。群聊消息漫游时长不支持修改，而延长单聊消息的漫游时长是增值服务，需要提交工单修改，可参考：[调整单聊消息漫游时长](/doc/product/269/云通信配置变更需求工单#.E8.B0.83.E6.95.B4.E5.8D.95.E8.81.8A.E6.B6.88.E6.81.AF.E6.BC.AB.E6.B8.B8.E6.97.B6.E9.95.BF)。
