...
| Reason | String | 用户上下线触发的原因。<ul style="margin:0;"><li>Login 的原因：Register，即 App TCP 连接建立</li><li>Logout 的原因：Unregister，即 App 用户注销帐号导致 TCP 断开</li><li>Disconnect 的原因：<ul style="margin:0;"><li>LinkClose，即检测到 App TCP 连接断开，例如 kill App，客户端发出 TCP 的 FIN 包或 RST 包</li><li>TimeOut，即检测到 App 心跳包超时，认为 TCP 已断开，心跳超时时间为400秒。例如客户端网络异常断开，未发出 TCP 的 FIN 包或 RST 包，也无法发送心跳包 </li></ul></li></ul>|
