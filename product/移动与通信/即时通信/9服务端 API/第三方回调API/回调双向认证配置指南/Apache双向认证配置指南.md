...
- **第三方开发者已有权威第三方签发的证书**
 ...
 - 即时通信 IM 给开发者后台提供用于验证请求方（即时通信 IM）证书的 CA 证书 [TencentQQAuthCA.crt](https://imsdk-1252463788.cos.ap-guangzhou.myqcloud.com/TencentQQAuthCA.crt)。
 - 参照下文 Apache HTTPS 双向认证配置参考进行配置。

- **第三方开发者向即时通信 IM 申请为其域名签发证书**
 - 开发者按照 [HTTPS 证书签发](https://cloud.tencent.com/document/product/269/3916#https-.E8.AF.81.E4.B9.A6.E7.AD.BE.E5.8F.91) 工单模板 [提交工单](https://console.cloud.tencent.com/workorder/category) 向即时通信 IM 提供开发者后台域名，例如`www.example.com`。
