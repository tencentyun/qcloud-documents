...
| Type | String | 群资料被变动的群的 [群组类型介绍](https://cloud.tencent.com/document/product/269/1502#GroupType)，例如 Public |
...
- REST API：[变动群组基础资料](https://cloud.tencent.com/document/product/269/1620)
