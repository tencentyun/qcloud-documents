...
| 字段       | 类型   | 属性 | 说明                                                |
| ---------- | ------ | ---- | --------------------------------------------------- |
| CheckItem | Array  | 必填 | 请求校验的帐号对象数组，单次请求最多支持100个帐号 |
| UserID     | String | 必填 | 请求校验的帐号的 UserID                             |
...
| UserID        | String  | 请求校验的帐号的 UserID                        |
| ResultCode    | Integer | 单个帐号的校验结果：0表示成功，非0表示失败    |
| ResultInfo    | String  | 单个帐号校验失败时的错误描述信息               |
