## 功能说明
 App 管理员可以通过本接口获取某一用户加入的已激活或无需激活的群组信息。若用户已加入某个新创建的私有群（Private），但群主未发送消息激活该群，将不会被获取到。关于群组激活的更多信息请参见 [群组系统 > 消息管理差异](https://cloud.tencent.com/document/product/269/1502#.E6.B6.88.E6.81.AF.E7.AE.A1.E7.90.86.E5.B7.AE.E5.BC.82)。
