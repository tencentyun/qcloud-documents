...
>?AVChatRoom(直播群)不支持导入群基础资料，对此类型的群组进行操作时会返回 10007 错误；如果需要达到导入群组基础资料的效果，可以通过 [创建群组](https://cloud.tencent.com/document/product/269/1615) 和 [修改群组基础资料](https://cloud.tencent.com/document/product/269/1620) 的方式实现。
...
| Type | String | 必填 |群组类型，包括 Public（陌生人社交群），Private（同新版本中的Work，好友工作群）， ChatRoom（同新版本中的Meeting，会议群） |
