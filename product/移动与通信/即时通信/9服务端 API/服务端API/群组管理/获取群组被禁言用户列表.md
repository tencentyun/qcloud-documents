...
#### 请求 URL 示例
```
https://console.tim.qq.com/v4/group_open_http_svc/get_group_muted_account?sdkappid=88888888&identifier=admin&usersig=xxx&random=99999999&contenttype=json
```
### 请求参数说明
...
通过 [REST API 在线调试工具]([https://29294-22989-29805-29810.cdn-go.cn/api-test.html#v4/group_open_http_svc/get_group_shutted_uin](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/group_open_http_svc/get_group_muted_account)) 调试本接口。
