## 功能说明
- 管理员撤回单聊消息。
- 该接口只能撤回由 REST API [单发](https://cloud.tencent.com/document/product/269/2282) 和 [批量发](https://cloud.tencent.com/document/product/269/1612) 发出的单聊消息。
...
| 字段 | 类型|属性| 说明 |
|---------|---------|----|---------|
| From_Account | String |必填| 消息发送方 Identifier  |
...
| 90003         | JSON 格式请求包体中缺少 To_Account 字段，或者 To_Account 字段不是 String 类型，或者 To_Account 账号不存在 |
| 90008         | JSON 格式请求包体中缺少 From_Account 字段，或者 From_Account 字段不是 String 类型，或者 From_Account 账号不存在 |
