...
- 若需要撤回由客户端发出的单聊消息，需要开通 [发单聊消息之前回调](https://cloud.tencent.com/document/product/269/1632) 或 [发单聊消息之后回调](https://cloud.tencent.com/document/product/269/2716) ，通过该回调接口记录每条单聊消息的 MsgKey ，然后填在本接口的 MsgKey 字段进行撤回。
