...
>?仅针对富媒体消息中使用 IM SDK 上传的文件有效，为了确保功能正常使用，请将终端 SDK 更新至4.9.x版本，Web SDK 更新至v2.0.0版本及以上。

### 请求URL示例

```
https://test.tim.qq.com/v4/im_cos_msg/allow_banned_object?sdkappid=88888888&identifier=admin&usersig=xxx&random=99999999&contenttype=json
```
