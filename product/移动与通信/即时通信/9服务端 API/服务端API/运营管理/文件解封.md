...
```
https://console.tim.qq.com/v4/im_cos_msg/allow_banned_object?sdkappid=88888888&identifier=admin&usersig=xxx&random=99999999&contenttype=json
```
...
| 参数                                | 说明                                                         |
| ----------------------------------- | ------------------------------------------------------------ |
| v4/im_cos_msg/allow_banned_object | 对象解封接口                                                 |
