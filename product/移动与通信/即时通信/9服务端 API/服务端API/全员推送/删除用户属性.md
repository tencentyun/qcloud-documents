## 功能说明
管理员给用户删除属性。注意每次最多只能给100个用户删除属性。使用前请先 [设置应用属性名称](https://cloud.tencent.com/document/product/269/45935)。
...
| Attrs | Object | 必填 |属性集合，注意这里只需要给出属性名即可；Attrs 形式及含义参见 [设置应用属性名称](https://cloud.tencent.com/document/product/269/45935) 。 |
