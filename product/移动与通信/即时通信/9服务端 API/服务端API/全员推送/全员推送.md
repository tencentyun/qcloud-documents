...
>?“全员推送”为 IM 旗舰版功能，需 [购买旗舰版套餐包](https://buy.cloud.tencent.com/avc?from=17182) 并在 [**控制台**](https://console.cloud.tencent.com/im/qun-setting) > **功能配置** > **登录与消息** > **全员推送设置** 打开开关后方可使用。
...
## 接口调试工具
通过 [REST API 在线调试](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/all_member_push/im_push) 工具调试本接口。
