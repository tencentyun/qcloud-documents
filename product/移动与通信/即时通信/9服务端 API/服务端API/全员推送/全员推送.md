...
| MsgBody | Object |必填 | 消息内容，具体格式请参考 [MsgBody 消息内容说明](https://cloud.tencent.com/document/product/269/消息格式描述#.E6.B6.88.E6.81.AF.E5.86.85.E5.AE.B9msgbody.E8.AF.B4.E6.98.8E)（一条消息可包括多种消息元素，所以 MsgBody 为 Array 类型）  |
