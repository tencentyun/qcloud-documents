...
1. 创建 `V2TIMGroupInfo` ([dart](https://comm.qq.com/im/doc/flutter/zh/SDKAPI/Class/Group/V2TimGroupInfo.html)) 对象，其中 `groupType` 设置为 `Community`，`isSupportTopic` 设置为 `true`/`YES`。
2. 调用 `createGroup` ([dart](https://comm.qq.com/im/doc/flutter/zh/SDKAPI/Api/V2TIMGroupManager/createGroup.html))  接口创建群组。
...
### 获取加入的社群列表
调用 `getJoinedCommunityList`([dart](https://comm.qq.com/im/doc/flutter/zh/SDKAPI/Api/V2TIMGroupManager/getJoinedCommunityList.html)) 获取已经加入的支持话题的社群列表。
