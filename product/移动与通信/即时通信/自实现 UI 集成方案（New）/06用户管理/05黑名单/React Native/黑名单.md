...
您可以调用 `addToBlackList` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMFriendshipManager/addToBlackList.html)) 接口把该用户加入黑名单，即拉黑该用户。
...
从黑名单中移除对方后可再次接收对方的消息，可调用 `deleteFromBlackList` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMFriendshipManager/deleteFromBlackList.html))。
...
您可以通过 `getBlackList` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMFriendshipManager/getBlackList.html)) 查看已拉黑多少用户，并对黑名单人员进行管理。
