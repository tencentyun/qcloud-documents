...
### 新建好友分组
您可以调用 `FriendshipCreateFriendGroup` ([c#](https://comm.qq.com/im/doc/unity/api/FriendshipApi/FriendshipCreateFriendGroup.html)) 接口新建好友分组。
...
### 删除好友分组
您可以调用 `FriendshipDeleteFriendGroup` ([c#](https://comm.qq.com/im/doc/unity/api/FriendshipApi/FriendshipDeleteFriendGroup.html)) 接口删除好友分组。
...
### 重命名好友分组
您可以调用 `FriendshipModifyFriendGroup` ([c#](https://comm.qq.com/im/doc/unity/api/FriendshipApi/FriendshipModifyFriendGroup.html)) 接口重命名好友分组。
...
### 获取好友分组
您可以调用 `FriendshipGetFriendGroupList` ([c#](https://comm.qq.com/im/doc/unity/api/FriendshipApi/FriendshipGetFriendGroupList.html)) 接口获取好友分组列表。
...
### 添加好友到一个分组
您可以调用 `FriendshipModifyFriendGroup` ([c#](https://comm.qq.com/im/doc/unity/api/FriendshipApi/FriendshipModifyFriendGroup.html)) 接口添加好友到一个分组。
...
### 从分组中删除某好友
您可以调用 `FriendshipModifyFriendGroup` ([c#](https://comm.qq.com/im/doc/unity/api/FriendshipApi/FriendshipModifyFriendGroup.html)) 从分组中删除某好友。
