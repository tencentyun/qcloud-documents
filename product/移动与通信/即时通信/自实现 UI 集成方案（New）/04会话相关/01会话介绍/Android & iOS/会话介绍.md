...
## 会话类介绍
会话类为 `V2TIMConversation` ([Android](https://im.sdk.qcloud.com/doc/zh-cn/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMConversation.html) / [iOS & Mac](https://im.sdk.qcloud.com/doc/zh-cn/interfaceV2TIMConversation.htmll))。`V2TIMConversation` 定义了以下内容：
...
| unreadCount | 会话未读消息数 | 具体使用请参考 [会话未读数]()。直播群（AVChatRoom）不支持未读计数，默认为 0。|
