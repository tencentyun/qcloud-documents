...
您可以调用 `MsgDelete` ([c#](https://comm.qq.com/im/doc/unity/api/MessageApi/MsgDelete.html)) 删除本地消息。
...
您可以调用 `MsgDelete` ([c#](https://comm.qq.com/im/doc/unity/api/MessageApi/MsgDelete.html)) 删除云端存储的消息。
