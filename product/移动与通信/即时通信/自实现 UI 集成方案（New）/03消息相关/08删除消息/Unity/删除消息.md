...
您可以调用 `MsgDelete` ([c#](https://comm.qq.com/im/sdk/unity_plus/_site/api/com.tencent.imsdk.unity.TencentIMSDK.html#com_tencent_imsdk_unity_TencentIMSDK_MsgDelete_System_String_com_tencent_imsdk_unity_enums_TIMConvType_com_tencent_imsdk_unity_types_MsgDeleteParam_com_tencent_imsdk_unity_callback_NullValueCallback_)) 删除本地消息。
