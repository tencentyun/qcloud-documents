...
您可以调用 `deleteMessageFromLocalStorage` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/deleteMessageFromLocalStorage.html)) 删除本地消息。
...
您可以调用 `deleteMessages` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/deleteMessages.html)) 删除云端存储的消息。
