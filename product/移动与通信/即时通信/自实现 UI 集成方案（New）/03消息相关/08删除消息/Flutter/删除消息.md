...
您可以调用 `deleteMessageFromLocalStorage` ([点击查看详情](https://comm.qq.com/im/doc/flutter/zh/SDKAPI/Api/V2TIMMessageManager/deleteMessageFromLocalStorage.html)) 删除本地消息。
...
您可以调用 `deleteMessages` ([点击查看详情](https://comm.qq.com/im/doc/flutter/zh/SDKAPI/Api/V2TIMMessageManager/deleteMessages.html)) 删除云端存储的消息。
