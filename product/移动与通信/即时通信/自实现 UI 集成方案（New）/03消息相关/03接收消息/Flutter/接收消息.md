...
在Flutter SDK 5.0.4版本后，多媒体消息在获取消息列表时不返回消息的url，需通过getMessageOnlineUrl ([点击查看详情](https://comm.qq.com/im/doc/flutter/zh/Api/V2TIMMessageManager/getMessageOnlineUrl.html))获取。
在Flutter SDK 5.0.4版本后，多媒体消息不默认不再返回 localurl，需通过 downloadMessage ([点击查看详情](https://comm.qq.com/im/doc/flutter/zh/Api/V2TIMMessageManager/downloadMessage.html)) 下载消息成功后才会返回。
