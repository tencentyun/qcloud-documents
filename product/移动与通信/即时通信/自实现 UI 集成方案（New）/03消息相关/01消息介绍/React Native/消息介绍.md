...
| needReadReceipt           | 消息是否需要已读回执       | 发送方设置。6.1 以上版本有效，需要购买旗舰版套餐。详情可参考 [已读回执](https://comm.qq.com/im-react-native-doc/classes/MessageManager__________.V2TIMMessageManager.html#sendMessageReadReceipts)                                                                                                                                                                 |
