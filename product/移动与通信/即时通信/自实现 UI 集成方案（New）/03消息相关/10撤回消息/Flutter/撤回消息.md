...
### 发送方撤回一条消息
调用 `revokeMessage` ([dart](https://comm.qq.com/im/doc/flutter/zh/SDKAPI/Api/V2TIMMessageManager/revokeMessage.html)) 撤回一条消息。
...
### 接收方感知消息被撤回
1. 调用 `addAdvancedMsgListener` ([dart](https://comm.qq.com/im/doc/flutter/zh/SDKAPI/Api/V2TIMMessageManager/addAdvancedMsgListener.html)) 设置高级消息监听。
2. 通过 `onRecvMessageRevoked` ([dart](https://comm.qq.com/im/doc/flutter/zh/SDKAPI/Callback/OnRecvMessageRevokedCallback.html)) 接收消息撤回通知。
