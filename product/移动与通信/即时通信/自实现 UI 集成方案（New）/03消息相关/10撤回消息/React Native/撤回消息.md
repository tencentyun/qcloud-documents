...
调用 `revokeMessage` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/revokeMessage.html)) 撤回一条消息。
...
1. 调用 `addAdvancedMsgListener` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/addAdvancedMsgListener.html)) 设置高级消息监听。
2. 通过 `onRecvMessageRevoked` ([TS](https://comm.qq.com/im/doc/RN/zh/Callback/OnRecvMessageRevoked.html)) 接收消息撤回通知。
