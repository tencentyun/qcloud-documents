...
接口 `sendMessage` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/sendMessage.html)) 是发送消息中最核心的接口。该接口支持发送所有类型的消息。
...
1. 调用 `createTextMessage` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/createTextMessage.html)) 创建文本消息。
2. 调用 `sendMessage` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/sendMessage.html)) 发送消息。
...
高级接口即上文中已介绍过的 `sendMessage` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/sendMessage.html))，比普通接口能设置更多的发送参数（例如优先级、离线推送信息等）。
...
1. 调用 `createCustomMessage` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/createCustomMessage.html)) 创建自定义消息。
2. 调用 `sendMessage` ([TS](https://comm.qq.com/im/doc/RN/zh/Api/V2TIMMessageManager/sendMessage.html)) 发送消息。
