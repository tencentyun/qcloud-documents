...
反初始化需要操作 1 步：
1. 调用反初始化接口 `unInitSDK`([Dart](https://pub.dev/documentation/tencent_im_sdk_plugin_platform_interface/latest/method_channel_im_flutter/MethodChannelIm/unInitSDK.html))
...
<img style="width:200px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/45f26e959a4c5a10f885bda0242838d3.png" />
