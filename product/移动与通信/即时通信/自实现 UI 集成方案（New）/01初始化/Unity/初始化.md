...
初始化 SDK 前，您需要初始化一个 [SdkConfig](https://comm.qq.com/im/sdk/unity_plus/_site/api/com.tencent.imsdk.unity.types.SdkConfig.html) 对象。该对象用于设置本地 SDK 缓存、日志位置。
...
### 调用初始化接口
操作完上述步骤后，您可以调用 `InitSDK`([c#](https://comm.qq.com/im/sdk/unity_plus/_site/api/com.tencent.imsdk.unity.TencentIMSDK.html#com_tencent_imsdk_unity_TencentIMSDK_Init_System_Int64_com_tencent_imsdk_unity_types_SdkConfig_)) 进行 SDK 初始化。
