...
<table>
	...
	<tr>
        ...
        <tr>
            <td>单个文件大小</td>
		<td><li>发送文件消息时，SDK 最大支持发送单个文件大小为100MB</li><li>小程序SDK不支持创建和发送文件消息</li><li>WebIM SDK不支持创建和发送语音消息</li></td>
        </tr>
	<tr>
            <td>历史消息存储时长</td>
        ...
        <tr>
            ...
            <td>好友及分组</td>
            <td><ul style="margin:0;"><li>单个用户支持3000个好友</li><li>添加好友时未决消息最多支持100条</li><li>好友分组最多支持32个</li><li>每个分组的名称最长30字节</li><li>好友备注最长支持96字节</li><li>WebIM SDK不支持好友关系链</li></ul></td>
        </tr>
        <tr>
            <td>黑名单</td>
