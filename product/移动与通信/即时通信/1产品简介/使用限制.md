...
<table>
        ...
        <tr>
            <td>发送文件</td>
            <td>单个文件大小</td>
            <td>SDK（Web &小程序 ）最大支持发送单个文件大小为20M，其他端 SDK 最大支持发送单个文件大小为28M</td>
        </tr>
        <tr>
            <td>系统消息</td>
            <td>数量及存储时间</td>
        ...
        <tr>
            <td>多端登录</td>
            <td>类型</td>
            <td>您可以登录 <a href="https://console.cloud.tencent.com/im">即时通信 IM 控制台</a> 配置以下多端登录类型：<ul style="margin:0;"><li>单端登录：仅允许 Windows、Web、Android 或 iOS 单端登录</li><li>双端登录：允许 Windows、Android 或 iOS 单端登录，同时允许与 Web 端同时在线</li><li>三端登录：允许 Android 或 iOS 单端登录，同时允许与 Windows 和 Web 端同时在线</li><li>多端同时在线：允许 Windows、Web、Android 或 iOS 多端或全端同时在线登录</li></ul></td>
        </tr>
        <tr>
            <td>UserID</td>
            <td>命名限制</td>
        ...
        <tr>
            <td>单聊/群聊消息</td>
            <td>历史消息存储时长</td>
            <td>单聊消息和群聊（私有群、公开群和聊天室）消息具备历史消息存储能力，历史消息存储时长如下：<ul style="margin:0;"><li>体验版：免费存储7天，不支持延长</li><li>专业版：免费存储7天，您可以登录 <a href="https://console.cloud.tencent.com/im">即时通信 IM 控制台</a> 延长历史消息存储时长</li><li>旗舰版：免费存储30天，您可以登录 <a href="https://console.cloud.tencent.com/im">即时通信 IM 控制台</a> 延长历史消息存储时长</li></ul>延长历史消息存储时长是增值服务，具体计费说明请参见 <a href="https://cloud.tencent.com/document/product/269/11673#.E5.A2.9E.E5.80.BC.E6.9C.8D.E5.8A.A1.E8.B5.84.E8.B4.B9">增值服务资费</a></td>
        </tr>
        <tr>
            <td>群组资料</td>
            <td>资料内容限制</td>
