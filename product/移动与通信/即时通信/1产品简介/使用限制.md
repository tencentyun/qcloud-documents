...
<table>
        ...
        <tr>
            <td>在群组中发送普通消息</td>
            <td>单个群的发送频率上限为40条/秒，建议通过合理分配消息优先级使用<br><b>如果5分钟内同一发送者的两条消息的随机值（Random 参数）相同，后面的消息将被当做重复消息而丢弃</b></td>
        </tr>
        <tr>
            <td>导入群消息</td>
