...
<table>
        ...
        <tr>
            ...
            <td>内容长度</td>
            <td>单聊、群聊消息，单条消息最大长度限制为8000字节，超过此长度将不保证该功能的可靠性</td>
        </tr>
	<tr>
            <td>发送频率</td>
	...
	<tr>
        ...
        <tr>
            ...
            <td>好友及分组</td>
            <td><ul style="margin:0;"><li>单个用户支持3000个好友</li><li>添加好友时未读消息最多支持100条</li><li>好友分组最多支持32个</li><li>每个分组的名称最长30字节</li><li>好友备注最长支持96字节</li><li>WebIM SDK 不支持好友关系链</li></ul></td>
        </tr>
        <tr>
            <td>黑名单</td>
