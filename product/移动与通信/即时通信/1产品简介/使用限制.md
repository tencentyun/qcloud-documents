...
<table>
        <tr>
         ...
         <tr>
            ...
            <td>
                单个 App 每天净增群组限制10000 个，单个 App 最多可拥有1亿个群组，但当总群组数量超过10万时，需要付费使用，详细价格说明请参见 <a href="https://cloud.tencent.com/document/product/269/11673">价格说明</a>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                一次最多支持添加100个成员，单个用户最大可加入1000个群组，具体请参见 <a href="https://cloud.tencent.com/document/product/269/11673">产品价格</a>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                单个群的默认发送频率限制为40条/秒，单条消息长度限制为8000字节。<b>如果5分钟内同一发送者的两条消息的随机值（Random 参数）相同，后面那条消息将被当做重复消息而丢弃</b>
            </td>
        </tr>
        <tr>
            <td>
...
<table>
        <tr>
            ...
            <td>
                建议同一对帐号发消息时，频率不要超过10条/秒，超过在线可收到，但离线只保存10条/秒，超过的会丢弃；单条消息长度不能超过8000字节
            </td>
        </tr>
        <tr>
            <td>
...
<table>
        ...
        <tr>
            ...
            <td>
                当前文件消息中，SDK 端的单个文件最大支持28M，WebSDK 端的单个文件最大支持20M
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                最大群成员数量：私有群200人，公开群2000人，聊天室6000人，音视频聊天室和在线成员广播大群无限制
            </td>
        </tr>
        <tr>
            <td>
