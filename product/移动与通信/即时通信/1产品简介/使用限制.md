...
<table>
        ...
        <tr>
            <td>导入群成员</td>
            <td>直播群（AvChatRoom）不支持导入群成员<br>一次请求最多可导入500个成员，但群成员数上限同时受不同群组类型的特性约束，详情请参见 <a href="https://cloud.tencent.com/document/product/269/1499#.E7.BE.A4.E7.BB.84.E5.8A.9F.E8.83.BD">群组功能</a></td>
        </tr>
</table>
