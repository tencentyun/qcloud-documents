...
![](https://qcloudimg.tencent-cloud.cn/raw/98d90acca6516dd50ef6470d63add9d0.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/7e1a3fe58b6ada2cd58cc0951d835eb7.png)
## 业务介绍
### 接入服务
...
### 数据存储中心
即时通信 IM 提供了中国、南亚（印度）、东南亚（新加坡）、东北亚（韩国首尔）、欧洲（德国法兰克福）以及北美（美国硅谷）数据存储中心供选择。您的业务数据存储在创建应用时选择的数据中心，每个数据中心均支持全球接入。如果您需要使用境外数据中心，请参见 [出海专区](https://cloud.tencent.com/document/product/269/81906)。
...
>?社群（Community）功能支持终端 SDK 5.8.1668增强版及以上版本、Web SDK 2.17.0及以上版本，需购买旗舰版套餐包并在 [**控制台**](https://console.cloud.tencent.com/im/qun-setting) > **群功能配置** > **社群** 打开开关后方可使用。
