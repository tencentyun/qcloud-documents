...
### 数据存储中心
即时通信 IM 提供了中国、南亚（印度）、东南亚（新加坡）、东北亚（韩国首尔）以及欧洲（德国法兰克福）数据存储中心供选择。您的业务数据存储在创建应用时选择的数据中心，每个数据中心均支持全球接入。如果您需要使用境外数据中心，请参见 [境外数据中心](https://cloud.tencent.com/document/product/269/81906)。
