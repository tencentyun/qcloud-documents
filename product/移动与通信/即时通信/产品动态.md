...
<table>
	 ...
	 <tr>      
         ...
         <td><ul><li>消息撤回支持漫游。</li><li>iOS/Mac 增加 OPPOChannelID 的设置，解决 Android 8.0 系统以上的 OPPO 手机接收 iOS 消息推送失败的问题。</li><li>iOS/Mac 优化 getGrouplist 返回对象的注释。</li><li>OPPO 手机（系统要求8.0以上）离线推送的 channleID 支持在控制台设置。</li><li>TUIKit/Demo 增加视频通话功能。</li><li>TUIKit/Demo 增加群组头像九宫格合成展示、优化会话列表、通讯录以及聊天界面 UI。</li></ul></td>   
	     <td>2019-11-13</td>   
	     <td>-</td>   
     </tr> 
	 <tr>      
...
<table>
	 ...
	 <tr>      
         ...
         <td><ul><li>增加 TIMFriendshipManager 类中的 querySelfProfile 和 queryUserProfile 接口（读取本地数据）。</li><li>增加获取好友信息中 addTime 字段。</li><li>新增支持 x86 及 x86_64 架构。</li><li>新增自定义字段数据上报。</li><li>新增阅后即焚消息。</li><li>新增消息撤回使用用例。</li><li>增加校验好友接口 checkFriends。</li><li>增加 queryGroupInfo 接口获取本地数据。</li><li>废弃 getGroupDetailInfo 和 getGroupPublicInfo 接口，统一用 getGroupInfo 接口。</li><li>优化服务器连接策略。</li><li>优化断网重连策略。</li><li>优化服务器过载策略。</li><li>优化心跳，减少不必要发包。</li><li>优化重连时连接请求。</li><li>优化在不同网络下首次连接和海外接入点的质量。</li><li>优化 iOS 切换 Wi-Fi 时网络重连慢的问题。</li><li>优化群消息同步问题。</li></ul></td>   
	     <td>2019-05-24</td>   
	     <td>-</td>   
     </tr> 
</table>
