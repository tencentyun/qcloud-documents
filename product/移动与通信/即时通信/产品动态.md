...
<tr>
    ...
    <td>
        <ul style="margin:0">
            <li> 优化群未读数的体验，在删除或撤回群的未读消息时，同步减掉未读数。</li>
            <li> 优化消息判重方案，规避收取重复消息的潜在问题。</li>
            <li> 补齐添加本地 C2C 消息的接口。</li>
            <li> 修复删除已发送失败的消息出现报错的问题。</li>
            <li> 修复对已退群或已解散群的会话设置已读或进行删除出现报错的问题。</li>
            <li> 修复添加黑名单崩溃的问题。</li>
            <li> 修复发送消息后消息的 msgID 为空的问题。</li>
        </ul>
    </td>
    <td> 2020-12-11 </td>
