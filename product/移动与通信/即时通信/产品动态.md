...
<table>
	 ...
	 <tr>      
         ...
         <td><ul style="margin:0;"><li>提高文件上传上限为100M。</li><li>优化 COS 上传。</li><li>优化群未决的处理逻辑。</li></ul></td>   
	     <td>2020-02-28</td>   
	     <td>-</td>   
     </tr> 
	 <tr>      
...
<table>
	 ...
	 <tr>      
         ...
         <td><ul style="margin:0;"><li>消息撤回支持漫游。</li><li>iOS/Mac 增加 OPPOChannelID 的设置，解决 Android 8.0 系统以上的 OPPO 手机接收 iOS 消息推送失败的问题。</li><li>iOS/Mac 优化 getGrouplist 返回对象的注释。</li><li>OPPO 手机（系统要求8.0以上）离线推送的 channleID 支持在控制台设置。</li><li>TUIKit/Demo 增加视频通话功能。</li><li>TUIKit/Demo 增加群组头像九宫格合成展示、优化会话列表、通讯录以及聊天界面 UI。</li></ul></td>   
	     <td>2019-11-13</td>   
	     <td>-</td>   
     </tr> 
	 <tr>      
...
<table>
	 ...
	 <tr>      
         ...
         <td><ul style="margin:0;"><li>发送文件类型消息时生成的 URL 增加格式后缀。</li><li>群自定义字段修改后增加通知回调。</li><li>未登录调用 initStorage 方法后，可以获取本地用户和群组信息。</li><li>Android 优化 getElementCount 接口的返回类型。</li><li>Windows 优化跨平台库优化各个平台的网络重连速度。</li><li>Windows 跨平台库新增 JVM 配置，方便 Android 环境传入 JVM。</li></ul></td>   
	     <td>2019-10-16</td>   
	     <td>-</td>   
     </tr> 
	 <tr>      
...
<table>
	 ...
	 <tr>      
         <td>SDK 4.5版本持续优化（Android、iOS 以及 Windows 端）</td>   
         <td><ul style="margin:0;"><li>Android 增加已读回执。</li><li>优化网络连接的质量。</li><li>优化群/群成员自定义段拉取逻辑。</li></ul></td>   
	     <td>2019-09-18</td>   
	     <td>-</td>   
     </tr> 
	 <tr>      
...
<table>
	 ...
	 <tr>      
	     ...
	     <td>2015-07</td>   
	     <td><ul style="margin:0;"><li><a href="https://cloud.tencent.com/document/product/269/33490">概述（Windows）</a></li><li><a href="https://cloud.tencent.com/document/product/269/33489">集成 SDK（Windows）</a></li></ul></td>   
     </tr> 
</table>
