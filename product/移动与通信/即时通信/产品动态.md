...
<li>变更收到对端（好友）资料更新后，对应更新 `conversation.userProfile`                                                                                    </li>
<li>修复非 UTF-8 字符导致 WebSocket 长连接异常断开问题
<li>修复 <a href="https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#deleteMessage">deleteMessage</a> 时传入复制的消息导致的运行时错误： `e.getOnlineOnlyFlag is not a function`                                                </li>
<li>修复 <a href="https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#deleteMessage">deleteMessage</a> 后会话 `lastMessage` 未正确更新                                                                                           </li>
<li>修复C2C 会话未读数计算问题                                                                                                                                                                                                </li>
<li>修复C2C 会话的实时消息未带 `nick` 和 `avatar` 导致的消息渲染异常                                                                                                                                                          </li>
<li>修复偶现的会话 `lastMessage.payload` 为 `null`                                                                                                                                                                            </li>
<li>修复预签名上传图片缩略图 URL 不生效                                                                                                                                                                                       </li>
<li>修复@ 群成员，重新登录后拉漫游消息，对应的 message.atUserList 为空数组                                                                                                                                                    </li>
<li>修复处理群提示消息（转让群主）时的错误                                                                                                                                                                                    </li>
<li>修复一些统计错误                                                                                                                                                                                                          </li>
</ul></td>
<td>2022-01-05</td>
<td><a href="https://cloud.tencent.com/document/product/269/36887#web">Web SDK下载</a></td>
...
<li>checkFriend 接口优化: checkType 由 int 变更为 FriendTypeEnum
<li>createGroup 接口优化: addOpt 由 int 变更为 GroupAddOptTypeEnum
<li>deleteFromFriendList 接口优化: deleteType 由 int 变更为 FriendTypeEnum
<li>getGroupMemberList 接口优化: filter 由 int 变更为 GroupMemberFilterTypeEnum
...
<li>修复部分场景 <a href="https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#getMessageList">getMessageList</a> 回包 `isCompleted` 始终为 `false`                                                                                  </li>
<li>修复[createFaceMessage](createFaceMessage)设置 `index` 为0接收方丢失 `index` 字段                                                                                                                                            </li>
</ul></td>
<td>2021-10-29</td>
<td><a href="https://cloud.tencent.com/document/product/269/36887#web">Web SDK下载</a></td>
</tr>
<tr>
<td>Electron 1.3.4 </td>
<td><ul style="margin:0;">
...
<li>变更WebSocket 重连后，SDK 重新登录并同步未读消息，保障消息的可靠性                                                                                                                                             </li>
<li>变更未登录时，连续调用 <a href="https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#login">login</a> 后会话的未读数错误                                                                                           </li>
<li>变更调用 <a href="https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#setGroupMemberNameCard">setGroupMemberNameCard</a>[setGroupMemberNameCard]() 接口，`nameCard` 传入空字符串后报错                            </li>
<li>变更调用 <a href="https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#getGroupMemberList">getGroupMemberList</a> 接口，回包数据 `muteUntil` 的值错误                                                              </li>
...
<li>修复 <a href="https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#logout">logout</a> 后再次 <a href="https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#login">login</a>，偶发 [joinGroup](https://web.sdk.qcloud.com/im/doc/zh-cn/SDK.html#joinGroup) 时遇到70001错误</li>
</ul></td>
<td>2020-5-27</td>
<td><a href="https://cloud.tencent.com/document/product/269/36887#web">Web SDK下载</a></td>
</tr>
