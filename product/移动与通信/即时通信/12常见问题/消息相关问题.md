...
目前即时通信 IM 已使用 [移动推送 TPNS](https://cloud.tencent.com/product/tpns) 提供的厂商 jar 包，您可参见文档 [IM 离线推送（Android）](https://cloud.tencent.com/document/product/269/75428)替换相关依赖包即可解决该问题。
