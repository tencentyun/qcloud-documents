...
1. 登录 [即时通信 IM 控制台](https://console.cloud.tencent.com/im)。
 ...
 >同一个腾讯云账号，最多可创建100个即时通信 IM 应用。若已有100个应用，您可以 [停用](https://cloud.tencent.com/document/product/269/32578#.E5.81.9C.E7.94.A8.E5.BA.94.E7.94.A8) 并删除无需使用的应用后再创建新的应用。**应用删除后，该 SDKAppID 对应的所有数据和服务不可恢复，请谨慎操作。**
 >
2. 单击【+添加新应用】。
