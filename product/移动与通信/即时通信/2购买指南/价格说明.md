...
- 社群（Community）功能支持终端 SDK 5.8.1668增强版及以上版本、Web SDK 2.17.0及以上版本，且仅针对旗舰版客户开放（如您降级为专业版将无法使用）。
...
|[创建社群（Community）](https://cloud.tencent.com/document/product/269/1502)|不支持 | 不支持 |可容纳10万人，需在控制台开通。详情请参见 [群功能配置](https://cloud.tencent.com/document/product/269/38656#.E7.BE.A4.E5.8A.9F.E8.83.BD.E9.85.8D.E7.BD.AE)|
|群消息已读回执|不支持|不支持|支持|
|群定向消息|不支持|不支持|支持|
