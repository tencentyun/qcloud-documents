...
>- 即时通信IM提供国内和境外数据站点，包括新加坡、德国、韩国、印度，服务全球可用。如何选择数据站点，请参见 [如何选择数据站点](https://cloud.tencent.com/document/product/269/81906)。
	- 如果您使用中国数据存储站点，请参见 [国内计费说明](https://cloud.tencent.com/document/product/269/81908)。
	- 如果您使用境外数据存储站点，如印度、新加坡、韩国、德国，请参见 [境外计费说明](https://cloud.tencent.com/document/product/269/81907)。
