...
TUIKitDemo 已经按照如下步骤接入了离线推送功能，文档中已有源码指引链接可供参见。
...
具体请参见 [厂商描述1](https://open.oppomobile.com/wiki/doc#id=11096) 或 [厂商描述2](https://open.oppomobile.com/wiki/doc#id=10743)。
