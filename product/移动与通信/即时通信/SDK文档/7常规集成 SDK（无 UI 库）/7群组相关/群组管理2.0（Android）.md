...
### 获取已加入的群组
调用 [getJoinedGroupList](https://im.sdk.qcloud.com/doc/zh-cn/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a05bfd8f7df6bfba718abc96fdad49791) 可以获取已加入的好友工作群（Work）、陌生人社交群（Public）、临时会议群（Meeting）列表，但直播群（AVChatRoom）不包含在此列表中。
...
### 设置群消息的接收选项
任何群成员都可以调用 [setReceiveMessageOpt](https://im.sdk.qcloud.com/doc/zh-cn/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupManager.html#a6bf8f3eafb5ffcb1d13bd69231de8bd4) 接口修改群消息接收选项。群消息接收选项包括：
