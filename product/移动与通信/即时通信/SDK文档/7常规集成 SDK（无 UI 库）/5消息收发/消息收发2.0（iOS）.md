...
1、调用 [createMergerMessage](http://doc.qcloudtrtc.com/im/categoryV2TIMManager_07Message_08.html#a2943bb31403aeb22f8582cd9966cf13e) 接口创建一条合并消息。
2、调用 [sendMessage](http://doc.qcloudtrtc.com/im/categoryV2TIMManager_07Message_08.html#a681947465d6ab718da40f7f983740a21) 接口发送合并消息。

- **接收合并转发消息：**
当我们收到一条合并消息 [V2TIMMessage](http://doc.qcloudtrtc.com/im/interfaceV2TIMMessage.html)，可以先通过合并消息元素 [V2TIMMergerElem](http://doc.qcloudtrtc.com/im/interfaceV2TIMMergerElem.html) 获取 [title](http://doc.qcloudtrtc.com/im/interfaceV2TIMMergerElem.html#ad39b2fbc36bb32f1287f61db3d3477a1) 和  [abstractList](http://doc.qcloudtrtc.com/im/interfaceV2TIMMergerElem.html#ad39b2fbc36bb32f1287f61db3d3477a1)  UI 展示，当用户点击合并消息的时候再调用 [downloadMergerMessage](http://doc.qcloudtrtc.com/im/interfaceV2TIMMergerElem.html#ad77abfe27eabf237aee7c951100e6755) 接口下载合并消息列表 UI 展示。
