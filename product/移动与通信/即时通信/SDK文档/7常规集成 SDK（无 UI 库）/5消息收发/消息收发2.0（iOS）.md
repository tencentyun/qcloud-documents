...
### 屏蔽某人的消息
如果您想屏蔽某人的消息，请调用 [addToBlackList](https://im.sdk.qcloud.com/doc/zh-cn/categoryV2TIMManager_07Friendship_08.html#ad1de7b4712309ce4164e4db6574486f0) 接口把该用户加入黑名单，即拉黑该用户。
...
### 屏蔽某个群组的消息
如果您想屏蔽某个群组的消息，请调用 [setGroupReceiveMessageOpt](https://im.sdk.qcloud.com/doc/zh-cn/categoryV2TIMManager_07Message_08.html#a40f3e2ada605b73a39b05a3d3144636b) 接口，设置群消息接收选项为 `V2TIM_GROUP_NOT_RECEIVE_MESSAGE` 状态。
