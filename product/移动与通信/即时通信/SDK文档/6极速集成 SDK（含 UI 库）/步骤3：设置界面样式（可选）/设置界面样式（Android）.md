本文介绍如何设置样式（Android） 以下视频将帮助您快速了解如何修改头像、配置聊天界面、配置更多菜单。

<iframe src="https://cloud.tencent.com/edu/learning/quick-play/3130-57629?source=gw.pro.media&withPoster=1&notip=1"></iframe>
