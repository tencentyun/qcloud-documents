...
1. 在 [控制台](https://console.cloud.tencent.com/im-detail/callback-setting) 的【[回调配置](https://console.cloud.tencent.com/im-detail/callback-setting)】页面，单击右上角回调 URL 配置区域的【HTTPS 双向认证证书下载】。
