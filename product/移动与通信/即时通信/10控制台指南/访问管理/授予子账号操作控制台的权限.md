## 简介
- 子账号使用即时通信IM 服务时，需要主账号授予 [访问控制台](https://console.cloud.tencent.com/im) 以及进行配置操作的权限，否则控制台应用列表将无法显示应用，如下图所示：
![](https://main.qcloudimg.com/raw/3142b22669686b2b3e7bff779747d399.png)
- 子账号有标签访问授权，但当前控制台应用标签和子账号标签权限不符时，可能会出现下图情况，且子账号无法查看新建应用：
![](https://main.qcloudimg.com/raw/45ef64be4d3e262465ca6bacf3031a69.png)
本文将为您介绍两种授权方式快速解决上述问题，详细操作步骤如下。如果您希望进行更多复杂权限配置策略，请参见 [访问管理 > 自定义策略](https://cloud.tencent.com/document/product/269/47107)。
...
### 步骤2：选择策略
在策略筛选框，搜索“即时通信”，勾选并确认需要授权的选项，即完成授权。
...
### 步骤1：进入授权
使用主账号，进入控制台【[访问管理](https://console.cloud.tencent.com/cam)】>【策略】，单击顶部的“新建自定义”按钮，将弹出“选择创建策略方式”弹框。
...
### 步骤3：策略生成
在“标签策略生成器”填入需要授权的子账号、标签等信息，点击“下一步”进入检查页面。
