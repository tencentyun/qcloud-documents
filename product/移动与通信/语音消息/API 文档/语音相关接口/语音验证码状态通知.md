## 接口描述
### 功能描述
若已 [配置事件回调](https://cloud.tencent.com/document/product/1128/37516#.E9.85.8D.E7.BD.AE.E4.BA.8B.E4.BB.B6.E5.9B.9E.E8.B0.83)，语音验证码下发给用户后，语音消息可以通过回调业务 URL 的方式，通知业务方语音验证码下发的状态。
