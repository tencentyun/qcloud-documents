...
| 参数      | 必选 | 类型   | 描述                                                         |
| --------- | ---- | ------ | ------------------------------------------------------------ |
| ext       | 否   | string | 用户的 session 内容，腾讯 server 回包中会原样返回<br>该字段需要联系语音消息小助手 QQ [3012203387](https://main.qcloudimg.com/raw/e674a37df984126f53ab9cbf4b9a168a.html) 或 [提交工单](https://console.cloud.tencent.com/workorder/category) 开通后才能使用            |
