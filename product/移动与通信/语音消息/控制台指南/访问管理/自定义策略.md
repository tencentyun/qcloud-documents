...
3. 选择服务和操作。
	- **效果（Effect）**配置项选择**允许**。
	<img src="https://qcloudimg.tencent-cloud.cn/raw/fb7fca381e2b470477d75f58e3b1aed1.png" width=900/>
	- **服务（Service）**配置项选择**语音消息**。
	<img src="https://qcloudimg.tencent-cloud.cn/raw/18d9cf7805adee514321c655fb05d265.png" width=900/>
	
	- **操作（Action）**配置项勾选读操作和写操作项后把操作名“DeleteAppInfo”这项取消勾选。
	<img src="https://qcloudimg.tencent-cloud.cn/raw/2e2579c747ba39f30fe96f7c2f447568.png" width=900/>
	- **资源（Resource）**配置项按照下图指引配置。
	<img src="https://qcloudimg.tencent-cloud.cn/raw/6493e5998ef39d4340b0e7add9f2263a.png" width=900/>
	- **条件（Condition）**配置项无需配置。
	<img src="https://qcloudimg.tencent-cloud.cn/raw/4cfbf86a263770636a4838e8e31893a2.png" width=900/>
