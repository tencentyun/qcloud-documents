...
## 操作步骤
### 查看连接器  
登录 [腾讯云数据连接器腾讯云数据连接器控制台](https://console.cloud.tencent.com/ipaas)，选择**集成资源 > 连接器**，连接器可根据您的喜好选择卡片或列表形式展示，默认是卡片形式展示，单击一个连接器卡片，进入到该连接器的详情界面，可查看该连接器的简介、更新日志、连接器文档等信息。
