...
2. 新建连接器配置，填写配置参数，点击”测试连接“按钮，测试连接器配置是否正确。
...
4. 查询成功后，message payload中包含了查询结果：
...
3. 构造好RecordSet数据后，添加Database组件的“批量删除”操作，数据表字段和RecordSet数据字段的关系构成了合并的过滤条件，Database组件配置如下：
