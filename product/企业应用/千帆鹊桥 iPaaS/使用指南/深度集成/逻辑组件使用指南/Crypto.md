...
| :--- | -------- | -------- | ------------ | ---------- |
| 密钥 | string   | 加密密钥 | 是           |    -        |
**注意：**密钥长度限制与**组件配置-通用**中选择的加密算法有关，AES/16，DES/8，3DES/24。
...
**ECB加密模式**
当选择 ECB加密模式时，只需填写明文和填充模式，无其他配置项。
...
### 配置回调测试-对称加解密案列
可单击如下链接下载回调测试demo。导入应用后进行调试或发布测试。
https://document-1259649581.cos.ap-guangzhou.myqcloud.com/demo/%E5%9B%9E%E8%B0%83%E5%8A%A0%E5%AF%86%E7%BB%84%E4%BB%B6%E6%B5%8B%E8%AF%95(20220104_12.0).ipaas
