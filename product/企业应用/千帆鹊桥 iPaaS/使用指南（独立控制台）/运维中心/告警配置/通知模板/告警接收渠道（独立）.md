...
1. 进入 [腾讯云数据连接器控制台 > 告警配置 > 通知模板](https://ipaas.cloud.tencent.com/alarm)。
2. 单击**新建**，进入新建通知模板。
3. 在新建通知模板页配置完基础信息后，在告警接收渠道勾选**微信**。
   ![](https://qcloudimg.tencent-cloud.cn/raw/ee4e5568bffb65f7dbe3bea9f599751a.png)
4. 进入 [告警策略列表](https://ipaas.cloud.tencent.com/alarm)，单击需要绑定微信告警的策略名称，进入管理告警策略页，并在告警策略页绑定通知模板。
   ![](https://qcloudimg.tencent-cloud.cn/raw/325bc11c0b99835796191c255c6eb03b.png)
...
3. 在新建通知模板页配置完基础信息后，在告警接收渠道勾选**短信**。
   ![](https://qcloudimg.tencent-cloud.cn/raw/73922aa2e3f80242006797100117ea8b.png)
4. 进入 [告警策略列表](https://ipaas.cloud.tencent.com/alarm)，单击需要绑定短信告警的策略名称，进入管理告警策略页，并在告警策略页绑定通知模板。
   ![](https://qcloudimg.tencent-cloud.cn/raw/325bc11c0b99835796191c255c6eb03b.png)
...
3. 在新建通知模板页配置完基础信息后，在告警接收渠道勾选**邮件**。
   ![](https://qcloudimg.tencent-cloud.cn/raw/ddb0d515ea752c95a1e2fddb1774cde4.png)
4. 进入 [告警策略列表](https://ipaas.cloud.tencent.com/alarm)，单击需要绑定短信告警的策略名称，进入管理告警策略页，并在告警策略页绑定通知模板。
   ![](https://qcloudimg.tencent-cloud.cn/raw/325bc11c0b99835796191c255c6eb03b.png)
...
3. 在新建通知模板页配置完基础信息后，在告警接收渠道勾选**企业微信**。
   ![](https://qcloudimg.tencent-cloud.cn/raw/91cff1be4a1786aa855f67ebbbf7e6ba.png)
4. 进入 [告警策略列表](https://ipaas.cloud.tencent.com/alarm)，单击需要绑定短信告警的策略名称，进入管理告警策略页，并在告警策略页绑定通知模板。
   ![](https://qcloudimg.tencent-cloud.cn/raw/325bc11c0b99835796191c255c6eb03b.png)