...
### 使用手机号验证签署方身份
手机号验证签署方身份的功能，是指**未实名认证的个人**签署方在使用腾讯电子签小程序签署合同时，在查看合同的环节无需经过人脸实名认证，仅通过手机号便可以查看合同的服务（签署环节仍需人脸识别），从而达到一次人脸识别的效果。开通流程如下：
1. 手机号验证签署方身份的功能，是指**未实名认证的个人签署方**在使用腾讯电子签小程序签署合同时，在查看合同的环节仅通过手机号便可以查看合同的服务（签署环节仍需人脸识别），从而达到一次人脸识别的效果。开通流程如下：
