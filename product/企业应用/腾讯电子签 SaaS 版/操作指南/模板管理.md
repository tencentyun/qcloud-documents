...
### 步骤3：配置模板信息
在**配置签约信息**页面中，填写模板名称. 模板说明，选择签署顺序。点击下方蓝色按钮添加签署人（如企业与个人签署，则添加一个企业签署方和一个个人签署方）。
...
模版列表中显示该新增模版，您可进行编辑、下载、删除等操作，或点击**使用**用模板发起合同。发起合同可参考相关[文档指引](https://cloud.tencent.com/document/product/1323/61360)。
