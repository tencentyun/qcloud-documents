...
### 步骤2：使用腾讯云账号登录电子签
1. 访问 [腾讯电子签登录页](https://ess.tencent.cn/)，单击 **快速认证企业**（入口如下图所示）。
<img style="width:500px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/c9f71c7f03cb3410b2eb4db2d2157e63.png" />
2. 选择 **腾讯云账号快速认证**，并单击 **确认**，进入登录腾讯云账号流程。
