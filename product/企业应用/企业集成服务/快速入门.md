...
2. 参考 [企业微信 API 官方文档](https://work.weixin.qq.com/api/doc/90000/90135/90967) 通讯录回调事件，将回调域名 `http://qiweirecall-$appid.ipaas.ap-tianjin.myqcloud.com` 配置为 URL（其中需将域名中的 AppId 替换为您的腾讯云主账号的 AppId）。
3. 单击通讯录中【添加成员】。
