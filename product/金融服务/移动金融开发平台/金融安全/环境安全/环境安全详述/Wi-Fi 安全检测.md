...
腾讯手机管家安全专家分析，虚假 Wi-Fi 钓鱼是当前免费 Wi-Fi 的主要安全风险，315晚会现场黑客盗取用户隐私的主要方法就是利用了虚假 WiFi 钓鱼的手法。所谓虚假 Wi-Fi 钓鱼，是指犯罪分子通过架设一个与某公共 Wi-Fi 热点同名的 Wi-Fi 网络，吸引用户通过移动设备接入该网络，然后就可以通过分析软件窃取这些接入虚假 Wi-Fi 热点用户的资料，包括 Wi-Fi 登录密码，从而成功破译。
