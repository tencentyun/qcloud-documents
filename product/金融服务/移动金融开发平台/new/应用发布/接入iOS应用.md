...
* [前置条件](#前置条件)
* [集成方式](#集成方式)
  * [CocoaPods 集成 SDK](#cocoapods-集成-sdk)
  * [手动集成 SDK](#手动集成-sdk)
...
- 把 `TMFDistribution` 组件的目录添加到您项目的 Xcode Project 中的合适位置，并选择合适的 target。
  ...
  > ![](../../img/caution.png)注意：手动集成 SDK 不要引入 `LICENSE` 与 `podspec` 等无关文件到项目中。

 <img src="../../img/copyItems.png" width="80%" />

 <img src="../../img/xcode.png" width="50%" />
...
| 参数              | 类型                                    | 描述                                                         | 必选 |
| ----------------- | --------------------------------------- | ------------------------------------------------------------ | ---- |
| info              | `TMFDistributionInfo *`                 | 更新数据对象，用于储存当次更新的数据信息，请参见 [数据对象](#数据对象) | N    |
...
![distribution_screen_shot](../../img/distribution_screen_shot.png)
