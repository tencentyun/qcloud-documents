...
|SecretId	| 在 [云 API 密钥](https://console.cloud.tencent.com/cam/capi) 上申请的标识身份的 SecretId，一个 SecretId 对应唯一的 SecretKey , 而 SecretKey 会用来生成请求签名 Signature<br>详情请参见 [签名方法](https://cloud.tencent.com/document/product/215/1693) 	| String	| 是|
