...
| 参数 | 说明   | 类型   | 长度（字节） | 是否必填 |
| ---- | ----- | ----- | ---- | --- |
| webankAppId | WebankAppId，腾讯分配的            | String     | 腾讯云线下对接决定 | 是           |
...
| idcardStr   | 身份证人像面或者国徽面图片的 Base64，大小不超过3M | String     | 3145728     | 是           |
...
| multiWarning | String | 正面/反面多重告警码，含义详情请参见 [通用响应码列表](https://cloud.tencent.com/document/product/655/13819)|
