...
- 数字活体的资源包分为黑色皮肤和白色皮肤（若要对 SDK 皮肤进行设定，除了接入对应的 AAR，还需要设定相关代码。皮肤的设定是无需格外设置的，默认为黑色皮肤，详情请参见[ SDK 样式选择](https://cloud.tencent.com/document/product/655/14077#sdk-.E6.A0.B7.E5.BC.8F.E9.80.89.E6.8B.A9)），接入方可自由选择组合配置。
