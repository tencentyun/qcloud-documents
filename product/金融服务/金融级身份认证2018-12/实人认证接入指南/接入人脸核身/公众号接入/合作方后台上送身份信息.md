...
<td><ul><li>比对源照片</li><li>原始图片不能超过500k，且必须为 JPG 或 PNG 格式</li><li>参数有值：使用合作伙伴提供的比对源照片进行比对，必须注照片是正脸可信照片，照片质量由合作方保证</li><li>参数为空 ：根据身份证号+姓名使用权威数据源比对</li></ul></td>
<td>BASE64String</td>
<td>1048576</td>
<td>否</td>
</tr>
...
<td><ul><li>比对源照片类型</li><li>参数值为1：水纹正脸照</li><li>参数值为2：高清正脸照</li></ul></td>
<td>String</td>
<td>1</td>
<td>是</td>
</tr>
