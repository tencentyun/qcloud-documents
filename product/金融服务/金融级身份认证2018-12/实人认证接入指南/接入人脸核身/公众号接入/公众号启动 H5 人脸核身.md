...
<tr>
<td>url</td>
<td>H5 人脸核身完成后回调的第三方 URL，需要第三方提供完整 URL 且做 URL Encode<br>完整 URL Encode 示例：<ul><li>原 URL：`https://idaop.webank.com`</li><li>Encode 后：`http%3A%2F%2Fidaop.webank.com`</li></ul></td>
<td>String</td>
<td>-</td>
<td>是</td>
</tr>
...
<tr>
<td>liveType</td>
<td>活体模式：<li>使用数字活体<li>使用动作活体，缺省则使用默认配置</td><td>String</td><td>-</td><td>否</td></tr>
  <tr><td>redirectType</td><td>跳转模式：<li>参数值为“1”时，刷脸页面使用 replace 方式跳转，不在浏览器 history 中留下记录<li>不传或其他值则正常跳转</td><td>string</td><td>-</td><td>否</td></tr>
  </tbody></table>
