...
- App 内调用 H5 人脸核身或者短信链接调用 H5 人脸核身等场景，若当前设备无法正常调用摄像头进行视频录制，前端将返回特定的错误码告知合作方，合作方拿到错误码后，可选择用备用方案核身处理，错误码如下：
...
<tr>
<td>url</td>
<td>H5 人脸核身完成后回调的第三方 URL，需要第三方提供完整 URL 且做 URL Encode。完整 URL Encode 示例：<br/>原 URL 为`https://idaop.webank.com`<br/>Encode 后为`http%3A%2F%2Fidaop.webank.com`</td>
<td>String</td>
<td>-</td>
<td>是</td>
</tr>
...
<tr>
<td>from</td>
<td>browser：表示在浏览器启动刷脸<br/>app：表示在 app 里启动刷脸，默认值为 app</td>
<td>String</td>
<td>40</td>
<td>是</td>
</tr>
