...
<tr>
<td>url</td>
<td>H5 人脸核身完成后回调的第三方 URL，需要第三方提供完整 URL 且做 URL Encode<br/>完整 URL Encode 示例：<ul><li>原 URL 为`https://idaop.webank.com`</li><li>Encode 后为`http%3A%2F%2Fidaop.webank.com`</li></ul></td>
<td>String</td>
<td>-</td>
<td>是</td>
</tr>
