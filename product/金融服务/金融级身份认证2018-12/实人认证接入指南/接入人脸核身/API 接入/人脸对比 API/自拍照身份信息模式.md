...
<tr><td >sourcePhotoType</td><td >比对源照片类型<li>参数值为 1 时：photoStr 为身份证正面照，逻辑处理会去抠身份证头像后再去比对。</li><li>参数值为 null 或其他：photoStr 为其他类型的照片，直接使用上送的图片去做比对。</li></td><td >String</td><td >1</td><td >否</td></tr>
</table>
