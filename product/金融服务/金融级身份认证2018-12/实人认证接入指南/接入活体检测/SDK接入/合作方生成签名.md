## 准备步骤
- **前置条件：**请合作方确保 NONCE ticket 已经正常获取，获取方式请参见 [获取 NONCE ticket ](https://cloud.tencent.com/document/product/655/31957)。
...
| version | 1.0.0 | - |
| ticket | 合作伙伴服务端获取的 ticket，注意是 NONCE 类型| 获取方式请参见 [获取 NONCE ticket](https://cloud.tencent.com/document/product/655/31957) （所用的 userId 参数值需要和 SDK 里面定义 userId 值保持一致）|
