...
|url|活体检测完成后回调第三方 URL，H5 活体检测完成后的回调 URL，需要第三方提供完整 URL，且做 URL Encode<br/>完整 URL Encode 示例<li>原URL：`https://idaop.webank.com`</li><li>Encode 后：`http%3A%2F%2Fidaop.webank.com`</li>|String|-|是|
