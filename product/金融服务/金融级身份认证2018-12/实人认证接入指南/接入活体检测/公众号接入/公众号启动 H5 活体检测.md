...
<tr><td >resultType</td><td >是否显示结果页面<br/>值为1：直接跳转到 URL 回调地址<br/>null 或其他值：跳转到提供的结果页面</td><td >String</td><td >-</td><td >否</td></tr>
...
<tr><td >liveType</td><td >活体模式<br/>1：使用数字活体<br/>2：使用动作活体<br/>缺省：使用默认配置</td><td >String</td><td >-</td><td >否</td></tr></table>