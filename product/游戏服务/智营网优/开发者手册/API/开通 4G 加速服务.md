...
接口请求域名： <font style="color:red">https://qos.api.qcloud.com/qos 或 https://qos.api.cloud.tencent.com/qos  </font>
...
| PhoneNO | String | 是 | 加密后的用户手机号码，参见 [获取手机用户唯一标示值](/document/product/594/11560) 页面。 
