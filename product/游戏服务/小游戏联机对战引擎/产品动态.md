...
| 动态名称 | 动态描述 | 发布时间 |相关文档 |
|---------|---------|---------|---------|
| 发布 SDK 版本 V1.2.8 | 优化 SDK 文件体积 | 2020-2-25 |-|
...
| 动态名称 | 动态描述 | 发布时间 |相关文档 |
|---------|---------|---------|---------|
| 发布 SDK 版本V1.0.3 | <li>更换域名配置策略。<li>添加 MGOBE.Player 对象。<li>Listener.init 添加初始化回调函数。<li>修改 Listener.init 初始化参数。<li>优化 playerInfo、roomInfo 属性命名、玩家 ID、自动补帧下报错问题等。 | 2019年6月21日 |- |
