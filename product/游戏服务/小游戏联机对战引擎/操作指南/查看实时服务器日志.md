...
- 自定义日志
  由开发者自定义打印内容，通过 [mgobexsCode](https://cloud.tencent.com/document/product/1038/34956) 对象的 logLevel 属性定义开发者代码内使用 [ActionArgs.SDK.logger](https://cloud.tencent.com/document/product/1038/34992#sdk.logger-.E5.B1.9E.E6.80.A7) 时的日志打印级别。只能填写以下值：
<table>
<thead>
<tr>
<th>值</th>
