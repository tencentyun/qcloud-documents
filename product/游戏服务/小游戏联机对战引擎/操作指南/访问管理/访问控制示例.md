## 操作场景
您可以使用访问管理 CAM 策略让用户拥有在游戏联机对战引擎（Mobile Game Online Battle Engine，MGOBE）控制台中查看和使用特定资源的权限。该部分的示例能够使用户使用控制台的特定部分的策略。
...
2. 在下拉选项中选择【游戏联机对战引擎】，您也可使用右上角搜索功能，查找该策略。
![](https://main.qcloudimg.com/raw/0e64bd7d6a895934690ce39809487b0b.png)
...
1. 进入 [策略管理界面](https://console.cloud.tencent.com/cam/policy)，单击列项【服务类型】。
2. 在下拉选项中选择【游戏联机对战引擎】，您也可使用右上角搜索功能，查找该策略。
![](https://main.qcloudimg.com/raw/cd6f065d9e703d5f31dd82fd4618df08.png)
