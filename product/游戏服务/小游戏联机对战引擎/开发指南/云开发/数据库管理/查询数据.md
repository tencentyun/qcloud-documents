...
使用数据库 API 提供的 `where` 方法我们可以构造复杂的查询条件完成复杂的查询任务。在本节中我们仍使用 [读取数据](https://cloud.tencent.com/document/product/1038/39867) 中使用的示例数据。以下这些构建查询条件，客户端与服务端 `SDK` 基本都保持一致。
...
具体的查询指令 API 文档可参考 [数据库文档](https://cloud.tencent.com/document/product/1038/39952)。
...
具体的逻辑指令 API 文档可参考 [数据库文档](https://cloud.tencent.com/document/product/1038/39952)。
