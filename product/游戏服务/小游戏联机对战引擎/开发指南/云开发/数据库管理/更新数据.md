...
## 操作场景
本文档主要指导您如何使用数据库 API 完成数据更新，在本节中我们仍沿用 [读取数据](https://cloud.tencent.com/document/product/1038/39867) 文档中使用的数据。
...
更完整详细的更新指令可以参考 [数据库文档](https://cloud.tencent.com/document/product/1038/39960)
