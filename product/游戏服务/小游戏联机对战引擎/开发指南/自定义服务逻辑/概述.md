...
MGOBE 为开发者提供 [自定义游戏 Server](https://cloud.tencent.com/document/product/1038/34950) 能力，当玩家加房成功后，可以使用客户端 SDK 中的 sendToGameServer 方法直接与游戏 Server 通信，实现游戏服务端拓展逻辑，如保存玩家数据、游戏状态同步等。
