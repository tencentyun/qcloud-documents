## 操作场景
以 [微信开发者工具](https://developers.weixin.qq.com/minigame/dev/guide/) 为例，本文介绍使用游戏联机对战引擎 MGOBE API 快速接入对战平台的方法，实现一个 MGOBE 的 Hello World。
...
2. 选择项目目录和开发模式，填写项目名称和 AppID。（如无 AppID，可以先使用测试号）如下图所示：
