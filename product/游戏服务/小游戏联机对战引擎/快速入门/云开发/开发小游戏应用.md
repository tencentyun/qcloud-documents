...
```
更多详情请参考数据库相关 [开发指南 > 数据库管理](https://cloud.tencent.com/document/product/1038/39860)。
...
更多详情请参考文件存储相关 [开发指南 > 云存储管理](https://cloud.tencent.com/document/product/1038/39872)。
...
```
更多详情请参考云函数相关 [开发指南 > 云函数管理](https://cloud.tencent.com/document/product/1038/39878)。
