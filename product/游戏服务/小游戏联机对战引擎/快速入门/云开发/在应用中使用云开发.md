...
### 创建环境
在腾讯云 [游戏联机对战引擎控制台](https://console.cloud.tencent.com/mgobe) 开通云开发服务，系统会自动为您当前游戏创建一个云开发环境。
...
### 添加应用
1. 登录腾讯云 [游戏联机对战引擎控制台](https://console.cloud.tencent.com/mgobe) ，单击左侧菜单云开发中的【环境】。
