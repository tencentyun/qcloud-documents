**为使用腾讯云游戏服务器伸缩 GSE（以下简称“本服务”），您应当阅读并遵守《腾讯云游戏服务器伸缩 GSE 服务等级协议》（以下简称“本协议”或“SLA”），以及《[腾讯云服务协议](https://cloud.tencent.com/document/product/301/1967)》。本协议包含本服务的术语和定义、服务可用性/服务成功率等级指标、赔偿方案、免责条款等相关内容。请您务必审慎阅读、充分理解各条款内容，限制、免责条款或者其他涉及您重大权益的条款可能会以加粗、加下划线等形式提示您重点注意。**
...
## 1.	术语和定义
#### 1.1 腾讯云提供的游戏服务器伸缩 GSE
是指腾讯云游戏服务器伸缩 GSE 为您（也称“客户”）提供服务，包含：服务器管理、游戏服务器管理和分配等内容。
...
#### 1.3 服务月度内不可用分钟数
在某一分钟内，只有在您持续使用本服务的 SDK  API 均失败的情况下，该分钟才计入服务月度内不可用分钟数；如果您在某一分钟内使用本服务的 SDK API 全部或部分成功时，则视为该分钟内的本服务均是可用的，不计入服务月度内不可用分钟数。在一个服务月度内服务不可用分钟数之和即为服务月度内不可用分钟数。
