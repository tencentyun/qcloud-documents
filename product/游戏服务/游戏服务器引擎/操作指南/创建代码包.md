...
-  **tencentcloud-sdk-python**
 ...
 -  版本支持：支持腾讯云云API SDK Python V2.7 - V3.6版本，详情可参考 [安装文档](https://cloud.tencent.com/document/sdk/Python)。
- **cos-python-sdk-v5**
 - 安装命令：`pip install -U cos-python-sdk-v5`。
 - 版本支持：支持腾讯云 COSV5 Python SDK Python V2.6、V2.7、V3.0及其以上版本，详情可参考 [安装文档](https://cloud.tencent.com/document/product/436/12269)。
