...
本文档主要指导您如何进行管理游戏服务器会话，其在后台中对应一个进程，您通过调用 [云 API](https://cloud.tencent.com/document/product/1165/42050) 为客户端分配一个游戏服务器会话，游戏服务器引擎会将游戏服务器会话分配在一个空闲的进程上。
...
2. 单击创建完成的服务器舰队【ID】，进入服务器舰队详情，单击【游戏服务器会话】页签，进入游戏服务器会话，详细信息如下说明：
	...
	- **创建时间**：游戏服务器会话创建的时间，格式为 yyyy-mm-dd hh:mm:ss，可按从高到底或从低到高进行排序。
	- **运行时长**：展示从开始到现在的运行时长，格式为 xxd xxh xxm xxs，可按从高到底或从低到高进行排序。
