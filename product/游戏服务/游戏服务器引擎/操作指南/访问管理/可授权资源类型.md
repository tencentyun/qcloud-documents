...
| StartGameServerSessionPlacement | `qcs::gse:$region:$account:game`<br>`ServerSessionQueue/*`<br>`qcs::gse:$region:$account:game`<br>`ServerSessionQueue/$GameServerSessionQueueName` | 开始将游戏服务器会话放置请求<br>发送到游戏服务器会话队列 |
