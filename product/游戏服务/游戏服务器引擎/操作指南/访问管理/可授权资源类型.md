...
| API 操作                        | 资源路径                                                     | 说明                                                 |
| :------------------------------ | :----------------------------------------------------------- | :--------------------------------------------------- |
| DeleteGameServerSessionQueue    | `qcs::gse:$region:$account:` <br>` gameServerSessionQueue/*`<br>`qcs::gse:$region:$account:gameServerSessionQueue/$Name` | 删除游戏服务器会话队列                               |
| StartGameServerSessionPlacement | `qcs::gse:$region:$account:gameServerSessionQueue/*`<br>`qcs::gse:$region:$account:` <br>`gameServerSessionQueue/$GameServerSessionQueueName` | 开始将游戏服务器会话放置请求<br>发送到游戏服务器会话队列 |
| UpdateGameServerSessionQueue    | `qcs::gse:$region:$account:` <br>`gameServerSessionQueue/*`<br>`qcs::gse:$region:$account:gameServerSessionQueue/$Name` | 更新游戏服务器会话队列的属性                         |
