...
在游戏进程启动后，如果准备就绪可以承载 GameServerSession，则需要通知该调用接口 GSE 进程已就绪，随后 GSE 即可调用 [OnStartGameServerSession ](https://cloud.tencent.com/document/product/1165/46118) 接口将 GameServerSession 分配给该进程。
