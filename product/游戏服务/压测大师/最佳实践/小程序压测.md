## 操作场景
本文以电商类为例，为您介绍如何使用压测大师对微信小程序做压测。
...
### 场景需求分析
某电商类微信小程序需要压测商品详情和加入购物车页面，根据业务逻辑，首先进入商品详情页，再进行加入购物车。
1. 进入商品详情页
通过商品 ID，可以打开不同商品详情页。
2. 加入购物车
选择不同商品详情页，将不同商品加入购物车中。
测试模型图如下所示：
![](https://main.qcloudimg.com/raw/4d67ed1c82580780dc5dd555020563a6.png)
...
### 场景配置
为了实现前面的测试需求，可以通过进行步骤：
1. 创建压测大师项目后，选择压测大师 > [用例列表](https://console.qcloud.com/wetest/master/testcase)，单击【新建 URL 测试】。
![](https://main.qcloudimg.com/raw/7ce98b5048849ad0dd795b91b7634caf.png)
...
### 启动压测
单击【立即执行】，即可发起压测（腾讯云用户需在 VUM 消费确认栏，单击确认）。
