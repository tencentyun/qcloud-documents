...
具体操作步骤如下：
1. 根据 [策略](https://cloud.tencent.com/document/product/598/37739#.E6.8C.89.E7.AD.96.E7.95.A5.E8.AF.AD.E6.B3.95.E5.88.9B.E5.BB.BA)，创建一个可以查看 GSE 服务统计数据的自定义策略，策略内容可参考以下策略语法进行设置：
```
{
  "version": "2.0",
  "statement": [
...
如果您想让用户拥有查看 GPM 服务统计数据的权限，可以将以下操作添加到您策略中，再将该策略关联到该用户。
