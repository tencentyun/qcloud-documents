...
| ModifyMatch                                                  | `qcs::gpm:$region:$account:match/*`<br>`qcs::gpm:$region:$account:match/$MatchCode` | 修改匹配         |
| DeleteMatch                                                  | `qcs::gpm:$region:$account:match/*`<br>`qcs::gpm:$region:$account:match/$MatchCode` | 删除匹配         |
| DescribeMatch                                                | `qcs::gpm:$region:$account:match/*`<br>`qcs::gpm:$region:$account:match/$MatchCode` | 查询匹配详情     |
| DescribeMatches                                              | `qcs::gpm:$region:$account:match/*`<br>`qcs::gpm:$region:$account:match/$MatchCode` | 分页查询匹配列表 |
| DescribeData                                                 | `qcs::gpm:$region:$account:match/*`<br>`qcs::gpm:$region:$account:match/$MatchCode` | 查看匹配统计数据 |
...
| API 操作      | 资源路径                                                     | 说明             |
| :------------ | :----------------------------------------------------------- | :--------------- |
| ModifyRule    | `qcs::gpm:$region:$account:rule/*`<br>`qcs::gpm:$region:$account:rule/$RuleCode` | 修改规则         |
| DeleteRule    | `qcs::gpm:$region:$account:rule/*`<br>`qcs::gpm:$region:$account:rule/$RuleCode` | 删除规则         |
| DescribeRule  | `qcs::gpm:$region:$account:rule/*`<br>`qcs::gpm:$region:$account:rule/$RuleCode` | 查询规则详情     |
| DescribeRules | `qcs::gpm:$region:$account:rule/*`<br>`qcs::gpm:$region:$account:rule/$RuleCode` | 分页查询规则列表 |
