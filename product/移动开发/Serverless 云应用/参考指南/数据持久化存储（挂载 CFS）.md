...
## 前置条件
您的云托管服务和需要使用的 CFS 处于同一 VPC 内。点击云托管服务所在私有网络的名称，可以跳转到私有网络控制台查看该私有网络内您已有哪些文件存储资源，可以与此服务配合使用。若没有满足需要的文件存储资源，您可按以下操作步骤新建 CFS 并挂载使用。
...
2. 点击服务名称进入服务详情页，单击【服务配置】进入服务配置选项卡。
