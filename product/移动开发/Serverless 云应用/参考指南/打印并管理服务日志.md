...
4. 因为进程是在后台运行，且标准日志日志不会存储在容器中，因此 [通过 webshell 登陆对应版本的容器实例](https://cloud.tencent.com/document/product/1243/48182) 中是无法看到标准输出的日志，必须通过日志采集功能将日志输出才可查看。
...
【日志采集路径】可以同时配置采集标准输出+日志文件，用半角逗号隔离。如`stdout,/logs/*`。
 ![https://main.qcloudimg.com/raw/00e2a9bca7483b5a4b10adf8ab2d2eb0.png](https://main.qcloudimg.com/raw/00e2a9bca7483b5a4b10adf8ab2d2eb0.png)
</dx-alert>
3. 部署成功后，您可以在云开发/云托管控制台 [查看日志](https://cloud.tencent.com/document/product/1243/46132)。
4. 日志文件将暂存在容器实例中。[通过webshell登陆对应版本的容器实例](https://cloud.tencent.com/document/product/1243/48182)，打开日志文件也可以查看到日志内容。
	>!
	>
