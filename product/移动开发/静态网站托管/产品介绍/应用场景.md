...
云开发支持一键部署应用，使用云开发提供的应用模板，将应用 [一键部署](https://console.cloud.tencent.com/tcb/env/index?rid=4&action=CreateEnv) 到您的环境中。如需了解更多可前往 [云开发 CloudBase](https://www.cloudbase.net/) 社区。
