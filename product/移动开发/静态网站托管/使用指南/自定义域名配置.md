...
打开控制台 - [静态网站](https://console.cloud.tencent.com/tcb/hosting) -【设置】，单击【添加域名】进行域名添加，添加后，系统会为您自动分配一个以 `.cdn.dnsv1.com` 为后缀的 CNAME 域名u下图所示。CNAME 域名不能直接访问，您需要在域名服务提供商处完成 CNAME 配置，配置生效后，您的托管服务方可对自定义域名生效。
