...
## 静态网页托管操作
1. 开通静态网站托管服务。
登录 [云开发控制台](https://console.cloud.tencent.com/tcb/env/index?rid=4)，参照云开发 [开通环境](https://cloud.tencent.com/document/product/876/41391) 文档开通环境
后，进入环境，单击左侧菜单栏【网站托管】开通静态网站托管服务。
>!仅有环境为后付费环境可开通静态托管服务。
...
3. 管理静态网站文件。
目前云开发静态托管服务既可以使用控制台进行文件管理，还能使用 CLI 工具进行文件管理。CLI 工具使用方法详见使用 CLI 工具管理 [静态网站托管](https://cloud.tencent.com/document/product/876/41543) 文件。
