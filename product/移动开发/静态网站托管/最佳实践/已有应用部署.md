...
>? 如果您托管的文件只有静态文件，可以使用 [Github Actions](https://github.com/features/actions) 或者 Gitlab 实现文件的自动上传和删除，在项目仓库更新时自动完成文件部署。请参见 [自动化部署](https://cloud.tencent.com/document/product/1210/52636)。
