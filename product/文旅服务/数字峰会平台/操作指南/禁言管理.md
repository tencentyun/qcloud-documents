...
## 业务介绍
### 取消禁言用户
在评论管理已禁言的用户，进行取消禁言，即可开启用户评论功能。登录  [腾讯数字峰会管理平台-禁言管理](https://summit.tx-exhibition.com/operation/#/muteManage) 进入禁言管理页面，选择需要取消禁言的用户，然后选择【操作】>【取消禁言】>【确定】即完成用户取消禁言操作，开启其评论功能。
