...
1.首先，我们点击设置并新建云函数的运行角色。

![](https://main.qcloudimg.com/raw/2662b92048b1ddae9b6a10260c469229/20191230001.png)

2.选择 QcloudASRFullAccess 全局读写权限。

![](https://main.qcloudimg.com/raw/ffe21327929a2419f0a6c358d856b1e2/20191230002.png)

3.在云函数中配置相关角色权限，点击保存即可。

![](https://main.qcloudimg.com/raw/27e201a5aee2a12c1e7bfa7767b6f81f/20191230003.png)

完成上述步骤，我们即可通过使用 [临时密钥](https://cloud.tencent.com/document/product/598/13895) 来发起 CreateRecTask 任务：
...
>! 云函数会自动帮您申请和管理临时密钥，您只需要从云函数的系统环境变量中读取 Credentials 即可。

然后我们在本地安装并打包 Python 环境，请参考： [Python SDK 安装及相关环境说明](https://cloud.tencent.com/document/sdk/Python)。
在本地新建 index.py ，内容如下（需修改存储桶 Bucket 的地区和回调 URL，回调 URL 需要在 [配置 API 网关触发器](#callback_url) 后获取）：
