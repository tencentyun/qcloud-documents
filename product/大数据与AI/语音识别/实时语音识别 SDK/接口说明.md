...
| engine\_model\_type | 否 | String | 引擎模型类型。<br>8k\_0：8k 中文普通话通用；<br>16k\_0：16k 中文普通话通用；<br>16k\_en：16k 英语；<br>16k_ca：16k 粤语。|
...
| needvad | 否 | Int |0：关闭 vad，1：开启 vad。<br>当音频分片超过60s时，需要开启 vad ，从而达到更高的识别准确度。 |
