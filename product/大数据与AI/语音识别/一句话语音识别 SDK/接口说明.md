...
用户通过语音 URL（https%3a%2f%2fruskin-1256085166.cos.ap-guangzhou.myqcloud.com%2ftest.wav，这是经过 urlencode 编码后的 url 地址）的方式（SourceType 为0）请求一句话识别服务，服务的引擎模型为：16k通用模型 （EngSerViceType = 16k\_0），一句话语音的采样率为16k，声道数为单声道。
