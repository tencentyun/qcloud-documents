...
| engine_type | 是 | String | 引擎模型类型。<br>8k_zh：8k 中文普通话通用；<br>16k_zh：16k 中文普通话通用；<br>16k_en：16k 英语；<br>16k_vi:16k 越南语；<br>16k_ms:16k马来语；<br>16k_zh_video：16k 音视频领域；<br>16k_zh_dialect：多方言，支持23种方言（上海话、四川话、武汉话、贵阳话、昆明话、西安话、郑州话、太原话、兰州话、银川话、西宁话、南京话、合肥话、南昌话、长沙话、苏州话、杭州话、济南话、天津话、石家庄话、黑龙江话、吉林话、辽宁话）；<br>16k_zh-PY：中英粤。 |
