...
| engine\_model\_type | 是 | String | 引擎模型类型。<br>• 8k_zh：电话中文普通话通用；<br>• 8k_zh_finance：电话 8k 金融领域模型；<br>• 16k_zh：16k 中文普通话通用；<br>• 16k_en：16k 英语；<br>• 16k_ca：16k 粤语；<br>• 16k_ko：16k 韩语；<br>• 16k_zh-TW：16k 中文普通话繁体。|
