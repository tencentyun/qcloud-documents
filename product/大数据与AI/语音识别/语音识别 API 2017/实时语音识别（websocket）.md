...
| vad_silence_time | 否 | Int | 语音断句检测阈值，静音时长超过该阈值会被认为断句（多用在智能客服场景，需配合 needvad = 1 使用），取值范围：16k引擎为390-2000、8k引擎为360-2000，单位 ms，目前仅支持 8k_zh、8k_zh_finance、16k_zh 引擎模型。 |
