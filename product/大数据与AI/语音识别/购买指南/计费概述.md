...
- 实时语音识别免费额度为**每月**15小时。
>?
- 免费资源包耗尽后，如果您已购买预付费资源包，则自动转入预付费资源包进行扣减；如果您未购买预付费资源包或者预付费资源包已耗尽，将**自动转入后付费**方式结算；如果您使用的是免费试用版，没有开通付费版，服务将会暂停，暂停后请尽快在[ 语音识别控制台 ](https://console.cloud.tencent.com/asr)升级成付费版本。
