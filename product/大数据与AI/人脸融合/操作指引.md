以下视频将为您介绍人脸融合如何快速接入产品指引：
<div class="doc-video-mod"><iframe src="https://cloud.tencent.com/edu/learning/quick-play/2327-34024?source=gw.doc.media&withPoster=1&notip=1"></iframe></div>
...
### 2. 开通服务
登录 [人脸融合控制台](https://console.cloud.tencent.com/facefusion)，单击【立即开通】，即可获得接口调用权限。

### 3. 管理素材
- 在 [人脸融合控制台](https://console.cloud.tencent.com/facefusion)，单击【添加素材】， 即可上传本地素材图片，符合规范的素材将自动审核通过。如素材被误拦截，您可在“审核不通过”右侧的❓中单击申诉，并简要填写问题。
- 若素材审核未通过，可删除原素材，重新提交符合规范的素材。涉及版权的素材需要出具证明，可单击此处的 [人脸融合版权证明模板](https://main.qcloudimg.com/raw/20b45d9576bb9f528eb05c3f77c0edfc.docx)  进行下载。
...
### 6. 购买授权（必选）
- 开发及测试完成后，在正式上线前需先购买技术授权费，价格说明详见 [人脸融合计费概述](https://cloud.tencent.com/document/product/670/14521) 。 
- 在 [人脸融合控制台](https://console.cloud.tencent.com/facefusion) 确认需要上线的活动名称及 ID，再单击右侧的 **操作—购买授权** 进行支付。
- 在线支付授权费后自动生效，单个活动购买授权后，根据授权费套餐的不同，提供的素材额度、资源包次数、基础 QPS 均有所差异。

### 7. 升级 QPS （可选）
- 在活动购买授权后，如基础 QPS 不足以支撑业务并发需要，可申请付费升级 QPS
- 在 [人脸融合控制台](https://console.cloud.tencent.com/facefusion) 确认需要升级的活动名称及 ID、算法版本，再单击右侧的 **操作—升级 QPS** 进行支付。
- 升级 QPS 为预付费，仅支持已购买技术授权费的活动购买，可选日期为【今日，近30天】，以 10QPS 为最小售卖单位，最多支持在线购买 950QPS，如有更高需求请联系我们。
