默认情况下，ClickHouse 使用自己的数据库引擎，该引擎提供可配置的 [表引擎](https://cloud.tencent.com/document/product/1299/49833) 和所有支持的 [SQL 语法](https://cloud.tencent.com/document/product/1299/49847)。除此之外，还可以选择使用 MySQL 数据库引擎。
