...
2. 在 Oceanus 控制台发布 SQL 作业，详细操作参考[ SQL作业开发](https://cloud.tencent.com/document/product/849/48287)
 - 登录 [流计算 Oceanus 控制台](https://console.cloud.tencent.com/oceanus/job)，单击左侧导航**作业管理**，进入作业管理页面；
 - 单击**新建作业**，作业类型选中 SQL 作业，输入作业名称，并选择一个运行中的集群；
