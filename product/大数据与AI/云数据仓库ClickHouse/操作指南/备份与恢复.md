...
![](https://qcloudimg.tencent-cloud.cn/raw/2cc460766a8b1f962f84c9361f87d1be.png)
4. 也可以点击数据备份策略开启对数据备份策略进行编辑，编辑数据备份除了要选择备份周期，备份开始时间，和有效期外，还需要选择要备份的数据表，注意选择数据表的同时还需要关注数据表所在节点IP。
