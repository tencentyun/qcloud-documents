...
- 目前仅支持后付费，预期在2020年初支持预付费资源包。

>? 
- 图像分析产品客户，如果需要增加并发或定制，收费标准以腾讯云商务报价为准，详情请 [联系我们](https://cloud.tencent.com/act/event/connect-service) 。
- 旧版图像标签服务已经升级为使用更先进深度学习技术、覆盖范围更广的图像分析- [图像标签服务](https://cloud.tencent.com/document/api/865/35471)，建议使用新版，开通方法详见 [腾讯云图像分析入门](https://cloud.tencent.com/product/tiia/getting-started) 。旧版图像标签在2019年内会继续提供稳定的服务，但不会进行算法升级。
- 旧版图像标签文档和定价详情请见：[旧版图像标签服务](https://cloud.tencent.com/document/api/865/17592)，[旧版图像标签价格](https://cloud.tencent.com/document/product/865/39206) 。
