...
- 登录 [腾讯云图控制台](https://console.cloud.tencent.com/yuntu)，单击左侧菜单栏【数据源管理】，进入数据源管理页面，在右侧选择需要新建的数据源类型，然后单击【新建数据源】。
![](https://main.qcloudimg.com/raw/ce132b23d5dadc5e561112638575aeec.png)
