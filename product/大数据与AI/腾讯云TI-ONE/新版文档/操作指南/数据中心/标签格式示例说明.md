...
- 文件目录要求和内容示例如下：
![](https://qcloudimg.tencent-cloud.cn/raw/36db48e770ebecff2424c798e11e2ed8.png)
- 标注文件格式详细说明：
...
- 一级多选的格式
"领域": ["政治","经济"]   
- 多级单选、多级多选的格式（最深支持5个层级）
"来源": [["中央新闻", "国际事务", "欧洲播报"],["2022全年","第一季度","3月1日","早间新闻播报"]]      
        
```

#### 2）CSV 格式
- 文件目录要求和内容示例如下：
![](https://qcloudimg.tencent-cloud.cn/raw/998d442e334e8345fe7f9151a18d3eb6.png)
