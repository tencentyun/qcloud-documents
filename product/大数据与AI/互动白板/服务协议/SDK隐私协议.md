为落实个人信息保护相关规定，更充分保障开发者与终端用户的权利，我们对《SDK 隐私协议》进行了更新，此版本的更新主要集中于： 在第1章节“我们会收集、使用终端用户的设备型号、操作系统、唯一设备标识符”部分，进一步披露了我们的SDK在使用时需使用的信息。
...
我们通常会在征得第三方开发者和/或终端用户同意后收集个人信息。我们会在本声明中载明收集的个人信息用途，如果我们要将收集个人信息用于本声明未载明的其它用途，我们会以合理的方式向第三方开发者和/或终端用户告知，并在使用前再次征得第三方开发者和/或终端用户的同意。您可以查看如下:第三方信息共享清单表格(了解我们将向第三方提供信息的主体，以及涉及个人信息类型、使用目的、处理方式等信息)。

关于 互动白板 第三方信息共享清单如下(Android端):

| 功能类型 | 第三方名称   | 使用目的        | 处理方式      | 个人信息类型 | 第三方隐私政策或官网链接    |
| -------------- | ------------ | --------------- | ---------- | -------------- | ---------------------- |
| TBS         | 腾讯科技（深圳）有限公司 | 浏览器内核      | 采用去标识、加密等方式进行传输和处理  |设备信息（设备名称、地区和语言设置、设备识别码（IMEI号码）、设备硬信息状态、使用习惯、IP地址、Mac地址、操作系统版本、以及用于访问服务的设备设置信息）| https://x5.tencent.com/ |
| GSON   | 开源框架  | json数据解析          | 无数据处理  | 无 | https://github.com/google/gson |

#### （一）第三方开发者和/或终端用户主动提供或我们直接收集的个人信息

为实现腾讯 SDK 的互动白板功能，我们可能需要向第三方开发者和/或终端用户收集相关个人信息。以下将详细列出腾讯 SDK 的各项业务功能及为实现该功能所需收集的个人信息情况。
...
第三方开发者将腾讯 SDK 产品和/或服务集成到其第三方中，为向终端用户提供腾讯 SDK 产品和/或服务，我们会以合法合规的方式收集、存储、加工来自于第三方开发者和/或终端用户的个人信息。 接入方应当在用户同意隐私政策之后才可以启动SDK。
...
当第三方开发者访问、登录、使用腾讯 SDK 时，为确保网站正常运转，我们可能会在第三方开发者的计算机或移动设备上通过Cookie 缓存功能使用相关信息，Cookie 包含当前登录帐号。
