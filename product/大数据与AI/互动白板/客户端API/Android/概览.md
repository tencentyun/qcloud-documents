...
| <del>[applyFileTranscode](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#applyFileTranscode-java.lang.String-com.tencent.teduboard.TEduBoardController.TEduBoardTranscodeConfig-)</del> | 发起文件转码请求 (自2.6.5版本废弃，请从服务端发起云API转码)  |
| [getFileTranscodeProgress](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#getFileTranscodeProgress-java.lang.String-) | 主动查询文件转码进度<br/>该接口仅用于特殊业务场景下主动查询文件转码进度，调用 applyFileTranscode 后，SDK 内部将会自动定期触发 onTEBFileTranscodeProgress 回调，正常情况下您不需要主动调用此接口(已废弃) |
...
| [getAllClassGroupIds](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#getAllClassGroupIds--)  | 获取所有分组id  |
