...
| TEDU_BOARD_ERROR_RUNTIME | number | 7	| 白板运行错误，请检查 sdkAppId、userId、userSig是否正确；请根据错误信息描述，查阅 [错误码文档](https://cloud.tencent.com/document/product/269/1671) |
...
| TEDU_BOARD_WARNING_H5PPT_ALREADY_EXISTS | number |	3	| 调用 addTranscodeFile 接口时候传入的课件已经存在 |
