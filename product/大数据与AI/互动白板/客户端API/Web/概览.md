...
| [setOwnerNickNameVisible](https://doc.qcloudtiw.com/web/TEduBoard.html#setOwnerNickNameVisible) | 是否显示自己的别名  |
| [useMathTool](https://doc.qcloudtiw.com/web/TEduBoard.html#useMathTool) | 使用数学尺规教具  |
| [enablePenAutoFit](https://doc.qcloudtiw.com/web/TEduBoard.html#enablePenAutoFit) | 开启绘制涂鸦过程中自动拟合图形(魔法笔)  |
| [getElementById](https://doc.qcloudtiw.com/web/TEduBoard.html#getElementById) | 获取元素信息  |
| [updateElementById](https://doc.qcloudtiw.com/web/TEduBoard.html#updateElementById) | 设置元素样式 |
...
| [getPPTRemarks](https://doc.qcloudtiw.com/web/TEduBoard.html#getPPTRemarks) | 获取指定课件的备注 |
...
| [setHighlighterColor](https://doc.qcloudtiw.com/web/TEduBoard.html#setHighlighterColor) | 设置荧光笔颜色  |
| [getHighlighterColor](https://doc.qcloudtiw.com/web/TEduBoard.html#getHighlighterColor) | 获取荧光笔颜色  |
