...
互动白板结构体和常量的定义，请参考[关键类型定义文档](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html)。
## TEduBoardToolType

[白板工具](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#gaf3fcb2784549d1b6137bb05b118e4f4f)
...
[白板元素类型](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#gaf6731b79977c18d9036cd1295fcc9520)
...
[橡皮擦可擦除元素类型](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#ga991805cc45b19cc6b065ba6f965799ee)
...
[白板图片填充对齐模式](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#gaf14361d162d6cfb92d758efea2b4af6c)
...
[白板图片状态](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#gaa640cf9faf133bad3a3d3ef02258f213)
...
## TEduBoardPosition
[位置类型](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#gaa43f1221eaf4d93e883d81bd769536d7)
...
## TEduBoardTextStyle
[白板文本样式](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#ga54c36aed61c686655f686f134ae4a57f)
...
[白板上传状态](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#gaa4dc63d2b79cb0feffab3acb02305ba4)
...
[H5 背景状态](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#ga14528350c37c98634900d57c621005e0)
...
[白板内容自适应模式](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#ga8899e1da194f430feaec030447e962b8)
...
## TEduBoardLineType
[直线类型](https://doc.qcloudtiw.com/win32/2.6.4.216/group__def.html#gad5fa2e2f4bde6932526d923ed77b6227)
...
| 属性 | 类型 | 字段含义 |
| --- | --- | --- |
| proxyServer | const char * | 默认为'' 为白板服务设置代理服务器，传入一个JSON格式字符串。JSON格式可参考SetProxyServer接口  |
...
| textStyle | TEduBoardTextStyle | 默认TEDU_BOARD_TEXT_STYLE_NORMAL 文本样式；  |
...
| 属性 | 类型 | 字段含义 |
| --- | --- | --- |
| disableRotate | bool | 默认 false 是否禁用旋转 （文本元素默认为true，不可更改）  |
| disableMove | bool | 默认 false 是否禁用移动  |
| disableProportionScale | bool | 默认 false 是否禁用等比例缩放  |
| disableArbitraryScale | bool | 默认 false 是否禁用任意缩放 （文本元素默认为true，不可更改）  |
...
| 属性 | 类型 | 字段含义 |
| --- | --- | --- |
| whiteBoard | bool | 设置鼠标工具在普通白板翻页行为, 默认为true  |
| h5PPT | bool | 设置鼠标工具在动态ppt转码的文件翻页行为, 默认为true  |
| imgPPT | bool | 设置鼠标工具在静态ppt转码文件翻页行为, 默认为true  |
| imgFile | bool | 设置鼠标工具在图片文件（addImagesFile接口添加的文件）翻页行为, 默认为true  |
...
| progressEnable | bool | 默认 false 是否启用SDK内置Loading图标  |
| systemCursorEnable | bool | 默认 false 是否启用原生系统光标，该参数说明具体请看setSystemCursorEnable接口  |
| enableScaleTool | bool | 默认 true 是否启用白板缩放移动工具的缩放功能，当设置为false，切换到缩放移动工具时缩放功能不可用  |
...
| imageTimeout | uint32_t | 图片加载超时时间 单位秒 默认10s  |
