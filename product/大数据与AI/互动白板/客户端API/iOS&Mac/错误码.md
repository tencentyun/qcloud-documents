...
| TEDU_BOARD_WARNING_TIM_SEND_MSG_FAILED | 腾讯IMSDK发送消息失败  |
| TEDU_BOARD_WARNING_H5PPT_ALREADY_EXISTS | 当要添加的H5PPT已存在时抛出该警告  |
| TEDU_BOARD_WARNING_ILLEGAL_OPERATION | 白板历史数据加载完成之前禁止操作  |
| TEDU_BOARD_WARNING_H5FILE_ALREADY_EXISTS | 当要添加的H5File已存在时抛出该警告  |
