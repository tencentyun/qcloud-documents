...
出现此错误表示白板已经不可用白板错误码 [TEduBoardErrorCode](https://doc.qcloudtiw.com/ios/Constants/TEduBoardErrorCode.html)
...
| TEDU_BOARD_ERROR_TIM_INVALID | NSInteger | 5 |互动白板内置 IMSDK 不可用互动白板内部会反射调用 IMSDK 接口，如果 IMSDK 升级了后则会调用失败请参考 [TIM 同步信令通道](https://cloud.tencent.com/document/product/1137/60737) 文档 |
...
警告级别，不会影响白板使用白板警告码 [TEduBoardWarningCode](https://doc.qcloudtiw.com/ios/Constants/TEduBoardWarningCode.html)
