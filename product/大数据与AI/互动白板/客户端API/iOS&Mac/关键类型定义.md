...
| TEDU_BOARD_SIGNATURE_EXPIRED  | NSInteger | 11 |userSig过期, 请生成新的usersig，并重新初始化白板 |
...
[元素样式类型](https://doc.qcloudtiw.com/ios/Classes/TEduMathToolType.html)
...
[元素样式类型](https://doc.qcloudtiw.com/ios/Classes/TEduElementOperatorType.html)
