...
| [setEnableCache](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/setEnableCache) | 启用和关闭缓存, 请在 TEduBoardController 初始化之前调用  |
...
| [getPPTRemarks](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/getPPTRemarks:pageIndex:) | 获取 PPT 的备注 |
