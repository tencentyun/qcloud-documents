...
> 注意1：配置业务域名，同[集成SDK文档的配置业务域名](../集成SDK/小程序.md)。

> 注意2：可以再调试工具中，打开开发者工具-详情-不校验合法域名。
...
打开 Demo/miniprogram/pages/tic目录下的配置文件account.js，替换新的 SDKAppID 以及新创建的 UserId 和 UserSig（UserToken）即可。
