...
6. 新转码方案中，不支持客户端 [snapshot](https://doc.qcloudtiw.com/web/TEduBoard.html#snapshot) 接口截图功能，支持使用 [addSnapshotMark](https://doc.qcloudtiw.com/web/TEduBoard.html#addSnapshotMark) 接口用[云 API 板书生成服务](https://cloud.tencent.com/document/product/1137/59004)。