...
腾讯云互动白板为您提供了点播和直播流视频播放功能。设置点播或直播流地址，即可实现Android、iOS、Mac、Windows、Web、小程序全平台互通同步的视频播放能力。
...
>?
- 移动端支持mp4/m3u8，桌面端支持mp4/m3u8/flv/rtmp。
...
2. 在TBS环境下，受限于X5内核和视频资源I帧间隔，在Android平台下无法精准同步。例如：10秒的视频，I帧间隔5秒，seek到4秒位置，在TBS上从0秒开始播放。
