...
> 3. 课中录制的需要提供一个用户加入白板与音视频房间对白板画面与音视频流进行记录，该录制用户也会产生对应的白板使用时长或者音视频通话时长等计费项，具体请参考 [白板使用时长计费说明](/购买指南/白板时长计费说明.md) 与 [实时音视频计费概述](https://cloud.tencent.com/document/product/647/17157)。
## 服务定价
