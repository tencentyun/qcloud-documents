...
### 查看系统分配域名
登录[万象优图控制台](https://console.qcloud.com/ci)，点击【 Bucket 管理】进入管理页面，选择【域名管理】页签，即可看到系统分配域名。
...
登录 [万象优图控制台](https://console.qcloud.com/ci) ，进入左侧菜单栏【 Bucket 管理】，点击需要配置域名的存储桶（如 imagetest1），单击【域名管理】可进行防盗链设置。
