...
数据万象产品定价按照两种计费方式，分为按量计费定价和资源包定价。具体价格，请分别参见 [计费项](https://cloud.tencent.com/document/product/460/58116) 和 [资源包（预付费）](https://cloud.tencent.com/document/product/460/49023)。
