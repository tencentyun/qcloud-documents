...
| API                                                              | 操作描述                   |
|------------------------------------------------------------------|------------------------|
| [查询图片处理队列](https://cloud.tencent.com/document/product/460/79395) | 用于搜索图片处理队列             |
| [更新图片处理队列](https://cloud.tencent.com/document/product/460/79396) | 用于更新图片处理队列             |
...
详情请参见 [查询图片处理队列](https://cloud.tencent.com/document/product/460/79395#.E5.93.8D.E5.BA.94) 。
...
| - - - - Event        | 回调事件	                                                                                                 | string |
| - - - - ResultFormat | 回调类型, XML 或者 JSON	                                                                                                 | string |
...
详情请参见 [更新图片处理队列](https://cloud.tencent.com/document/product/460/79396#.E5.93.8D.E5.BA.94) 。
