...
| API                                                                            | 操作描述              |
|--------------------------------------------------------------------------------|-------------------|
| [提交哈希值计算任务](https://cloud.tencent.com/document/product/460/83085)  | 创建一个文件处理哈希值计算任务   |
| [查询哈希值计算结果](https://cloud.tencent.com/document/product/460/83086) | 查询一个文件处理哈希值计算结果任务 |
| [哈希值计算同步请求](https://cloud.tencent.com/document/product/460/83084) | 同步计算文件哈希值 |
...
| AddToHeader | Request.Operation.FileHashCodeConfig | 是否将计算得到的哈希值添加至文件自定义 header, 有效值：true、false，默认值为 false。<br>自定义 header 根据 `Type` 的值变化，例如 `Type` 值为MD5时，自定义 header 为 x-cos-meta-md5。 | String | 否       |


#### 返回结果说明

详情请参见 [提交哈希值计算任务](https://cloud.tencent.com/document/product/460/83085#.E5.93.8D.E5.BA.94)。
...
详情请参见 [查询哈希值计算结果](https://cloud.tencent.com/document/product/460/83086#.E5.93.8D.E5.BA.94)。
...
详情请参见 [哈希值计算同步请求](https://cloud.tencent.com/document/product/460/83084#.E5.93.8D.E5.BA.94)。
