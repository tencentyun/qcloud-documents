...
| API                                                                            | 操作描述                           |
|--------------------------------------------------------------------------------| --------------------------------- |
| [提交文件解压任务](https://cloud.tencent.com/document/product/460/83087) |  创建一个文件处理解压任务 |
| [查询文件解压结果](https://cloud.tencent.com/document/product/460/83088) |  查询一个文件处理解压任务 |
...
详情请参见 [提交文件解压任务](https://cloud.tencent.com/document/product/460/83087#.E5.93.8D.E5.BA.94)。
...
详情请参见 [查询文件解压结果](https://cloud.tencent.com/document/product/460/83088#.E5.93.8D.E5.BA.94)。
