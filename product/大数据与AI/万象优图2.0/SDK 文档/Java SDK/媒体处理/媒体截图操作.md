...
| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [GenerateSnapshot](https://cloud.tencent.com/document/product/460/38914) | 查询媒体文件某个时间的截图  | 获取媒体文件某个时间的截图  |
...
| Height     | 截图的高。默认为0。<br/>Width 和 Height 都为0时，表示使用视频的宽高。如果单个为0，则以另外一个值按视频宽高比例自动适应。 | Int       | 否       |
