...
| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [DescribeMediaBuckets](https://cloud.tencent.com/document/product/460/38914) | 查询媒体Bucket | 查询当前账号下已经开通媒体处理功能的桶列表 |
...
| bucketNames |  bucket名字，以,分隔，支持多bucket，精确搜索 | String |否|
| regions |  地区信息，以,分隔字符串，支持All,ap-shanghai,ap-beijing | String |否|
