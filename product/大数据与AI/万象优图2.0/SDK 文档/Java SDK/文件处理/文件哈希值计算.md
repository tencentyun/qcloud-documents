...
| API                                                                            | 操作名             | 操作描述                           |
|--------------------------------------------------------------------------------| ------------------ | ---------------------------------- |
| [提交哈希值计算任务](https://cloud.tencent.com/document/product/460/83091)  | 创建哈希值计算任务 | 创建一个文件处理任务 |
| [查询哈希值计算结果](https://cloud.tencent.com/document/product/460/83092) | 查询哈希值计算任务 | 查询一个文件处理任务 |
