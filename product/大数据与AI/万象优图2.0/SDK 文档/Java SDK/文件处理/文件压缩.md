...
| API                                                                            | 操作名    | 操作描述                           |
|--------------------------------------------------------------------------------|--------| ---------------------------------- |
| [提交多文件打包压缩任务](https://cloud.tencent.com/document/product/460/83091) | 创建压缩任务 | 创建一个文件处理任务 |
| [查询多文件打包压缩结果](https://cloud.tencent.com/document/product/460/83092) | 查询压缩任务 | 查询一个文件处理任务 |
