...
本文档提供关于数据万象文件处理解压任务的相关 API 概览以及 SDK 示例代码，此处以动图任务举例。

| API                                                                             | 操作名             | 操作描述                           |
|---------------------------------------------------------------------------------| ------------------ | ---------------------------------- |
| [CreateFileUncompressJob](https://cloud.tencent.com/document/product/460/83087) | 创建任务 | 创建一个文件处理任务 |
| [DescribeFileProcessJob](https://cloud.tencent.com/document/product/460/83088)  | 查询任务 | 查询一个文件处理任务 |
