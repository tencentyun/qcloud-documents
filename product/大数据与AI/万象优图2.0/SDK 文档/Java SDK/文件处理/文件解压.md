...
| API                                                                            | 操作名             | 操作描述                           |
|--------------------------------------------------------------------------------| ------------------ | ---------------------------------- |
| [提交文件解压任务](https://cloud.tencent.com/document/product/436/83110) | 创建解压任务 | 创建一个文件处理任务 |
| [查询文件解压结果](https://cloud.tencent.com/document/product/436/83111) | 查询解压任务 | 查询一个文件处理任务 |
