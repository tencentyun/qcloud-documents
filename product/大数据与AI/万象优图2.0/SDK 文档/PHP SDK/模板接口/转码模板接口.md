...
| Preset             | Request.Video | 视频算法器预置     | String | 否       | medium，当 Codec 为 VP8 时，为 good | H.264支持该参数，取值 veryfast、fast、medium、slow、slowerVP8 支持该参数，取值 good、realtimeH.265 和 VP9 不支持该参数 |
