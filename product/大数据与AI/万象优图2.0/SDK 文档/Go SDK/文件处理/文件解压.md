...
| API                 | 操作名        | 操作描述            |
| ------------------- | -------------- | --------------------- |
| [CreateFileProcessJob](https://cloud.tencent.com/document/product/436/83110)   | 提交文件解压任务 | 以提交任务的方式进行文件解压任务        |
| [DescribeFileProcessJob](https://cloud.tencent.com/document/product/436/83111)  | 查询文件解压任务结果 | 主动查询指定的文件解压任务结果 |
...
| 参数名称  | 描述                                   | 类型      |
| --------- | -------------------------------------- | --------- |
| Tag       | 创建任务的 Tag，目前仅支持：FileUncompress | String    |
