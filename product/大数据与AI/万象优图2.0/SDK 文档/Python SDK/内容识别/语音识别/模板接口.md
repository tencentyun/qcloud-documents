...
| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [创建语音识别模板](https://cloud.tencent.com/document/product/460/78939) | 创建模板 | 用于创建一个新的模板 |
| [DeleteTemplate](https://cloud.tencent.com/document/product/460/78940) | 删除模板 | 删除一个模板|
| [DescribeTemplates](https://cloud.tencent.com/document/product/460/78941) | 查询模板 | 查询模板列表 |
| [更新语音识别模板](https://cloud.tencent.com/document/product/460/78942) | 修改模板 | 修改一个模板 |
