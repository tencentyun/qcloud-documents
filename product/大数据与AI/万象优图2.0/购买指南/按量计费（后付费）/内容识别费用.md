数据万象（Cloud Infinite，CI）集成腾讯云 AI 的多种强大功能，对腾讯云 COS 的数据提供图片标签、人脸智能裁剪、二维码识别、音频识别、人脸美颜、人脸特效等增值服务，广泛应用于电商网站、社交软件、相册应用、视频网站等多种场景，方便用户对图片进行内容管理。



## 内容识别费用

内容识别费用分为**二维码识别费用**、**图片标签费用**、**图片质量评估费用**、**人脸识别费用**、**人脸核身**、**汽车识别费用**、**图片文字识别（OCR）费用**、**语音识别费用**，具体介绍如下：
