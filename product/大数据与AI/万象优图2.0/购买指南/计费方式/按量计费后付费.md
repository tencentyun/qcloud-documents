...
<td align="center">图片文字识别（OCR）费用指对图片进行OCR识别而产生的费用，包含：通用文字识别、身份证识别，根据每月识别次数收费。</td>
</tr>
<tr>
...
<tr>
<td align="center" rowspan=11>媒体处理费用</td>
...
<tr>
<td align="center">SDR to HDR费用</td>
<td align="center">SDR to HDR费用是指使用SDR to HDR服务产生的费用，根据动态范围变换按输出视频时长收费。</td>
</tr>
<tr>
...
<tr>
<td align="center">文档转HTML费用</td>
<td align="center">文档转HTML费用指使用文档预览服务时，采用文档转HTML功能产生的费用，根据转换成功次数收费。</td>
</tr>
<tr>
