...
适用于短视频制作时，原始视频无字幕，需要智能识别视频语音内容并生成字幕的场景。可应用于 PGC/UGC 平台、视频网站、短视频应用、资讯平台等对媒体内容制作有较高智能化和时效性需求的行业。
...
// srt文件格式转 webvvt 格式，非必须，TCPlayer 播放器字幕文件暂只支持 webvvt 格式
...
- 具体代码可参见 cos-demo [视频智能添加字幕](https://github.com/tencentyun/cos-demo/tree/main/video-subtitles)
