...
2. 配置处理参数，具体参数参考 [创建音视频转码任务](https://cloud.tencent.com/document/product/436/53968#.E5.88.9B.E5.BB.BA.E9.9F.B3.E8.A7.86.E9.A2.91.E8.BD.AC.E7.A0.81.E4.BB.BB.E5.8A.A1)。
>?
>
...
1. 选择一个文件夹，创建批量数据处理任务，可参考 [批量数据处理](https://cloud.tencent.com/document/product/460/78919#.E5.88.9B.E5.BB.BA.E6.89.B9.E9.87.8F.E6.95.B0.E6.8D.AE.E5.A4.84.E7.90.86.E4.BB.BB.E5.8A.A1)。
...
- 可以在控制台上查看执行结果，可参见 [查看执行实例](https://cloud.tencent.com/document/product/436/53967#.E6.9F.A5.E7.9C.8B.E6.89.A7.E8.A1.8C.E5.AE.9E.E4.BE.8B)
