...
![域名管理](https://main.qcloudimg.com/raw/a8204e4ea6d6000be485bdf55ae5f59f.png)

**系统分配域名- 内网跨区域访问：** 系统分配域名可以用于在同区域的不同腾讯云产品之间进行访问。但是，若需要实现内网跨区域的访问， 例如，所在区域为广州的 CVM 需要使用新加坡的数据万象上的数据，则需要使用 VPC 部署专属网络通道，实现高速访问体验。详情请参见 [私有网络](https://cloud.tencent.com/product/vpc) 产品介绍页。
...
![CDN1](https://main.qcloudimg.com/raw/75b4969e8b6b785c752a264347077cf0.png)
2. 单击【域名管理】，进入域名管理页面，单击 CDN 加速的【编辑】，进入可配置状态。
![CDN2](https://main.qcloudimg.com/raw/01c5e3033fe54c58752eb9f867002b8e.png)
3. 修改当前状态，单击【保存】即可。
![CDN3](https://main.qcloudimg.com/raw/58abb3cf37643ae68ba7695c75fc6842.png)
...
2. 复制 CNAME 地址
![示例2](https://main.qcloudimg.com/raw/7c0a0d11ed6d9deffe1d6f3b12260aeb.png)
3. 进入云解析管理控制台，单击已绑定的自定义域名。
![示例3](https://main.qcloudimg.com/raw/60ba83bb64f766c82a857caef19e67f5.png)
