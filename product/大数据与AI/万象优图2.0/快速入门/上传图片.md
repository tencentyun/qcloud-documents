...
## 上传图片
1. 在[万象优图控制台](https://console.qcloud.com/ci#1)  ，单击【Bucket 管理】，进入存储桶列表。单击您想存储图片的存储桶（如test1），进入存储桶的文件列表页面。
...
1. 在 [万象优图控制台](https://console.qcloud.com/ci#1)  ，选择【Bucket 管理】，选择相应存储桶（如 test1），进入存储桶的图片列表。
![](//mc.qcloudimg.com/static/img/f309c0bf1f33e593858c360e568c3247/image.png)
