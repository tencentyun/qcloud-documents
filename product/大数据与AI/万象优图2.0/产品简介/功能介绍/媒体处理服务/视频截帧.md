...
- API 方式：您可使用 API 接口，创建视频截帧任务，详情请见 [ API 文档](https://cloud.tencent.com/document/product/460/76910)。
