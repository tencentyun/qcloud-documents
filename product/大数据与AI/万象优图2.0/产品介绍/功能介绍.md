...
<table>
   ...
   <tr>
      <td><a href="https://cloud.tencent.com/document/product/460/43680">TPG 压缩 </a></td>
      <td>将 JPG/PNG/GIF/WEBP 等格式图片转码为 TPG 格式，大幅减小图片大小</td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <tr>
      <td rowspan=2>内容审核服务</td>
      <td><a href="https://cloud.tencent.com/document/product/460/6934">图片审核</a></td>
      <td>图片内容安全审核，检测场景包括鉴黄、鉴政、鉴暴恐、广告检测</td>
   </tr>
   <tr>
      <td><a href="https://cloud.tencent.com/document/product/460/6934">视频审核</a></td>
      <td>支持对视频文件的截帧审核，检测场景包括鉴黄、鉴政、鉴暴恐、广告检测</td>
   </tr>

   <tr>
      <td rowspan=2>智能识别服务</td>
...
>!
>- 媒体处理服务当前仅支持北京、上海、重庆、南京地域，如您有其他地域需求请 [提交工单](https://console.cloud.tencent.com/workorder/category) 处理。
