...
>? 人声分离为付费功能，详情请查看 [媒体处理费用](https://cloud.tencent.com/document/product/460/58120)。
>
...
对于存储在对象存储上的存量数据，您可通过创建任务来实现文件转码。人声分离任务您可选择控制台或 API 进行创建。
...
- API 方式：您可使用 API 接口创建转码任务，使用详情请见 [API 文档](https://cloud.tencent.com/document/product/460/58322)。
