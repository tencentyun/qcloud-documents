...
>? 精彩集锦为付费功能，详情请查看 [媒体处理费用](https://cloud.tencent.com/document/product/460/58120)。
>
...
- API 方式：您可使用 API 接口创建转码任务，使用详情请见 [API 文档](https://cloud.tencent.com/document/product/460/58321)。
