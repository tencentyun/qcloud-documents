...
| 地域     | 上传域名                                         | 下载域名                               |
| :------- | :----------------------------------------------- | :------------------------------------- |
| 中国香港 | &lt;BucketName-APPID&gt;.pic.ap-hongkong.myqcloud.com  | &lt;BucketName-APPID&gt;.cos.ap-hongkong.myqcloud.com |
| 新加坡  | &lt;BucketName-APPID&gt;.pic.ap-singapore.myqcloud.com  | &lt;BucketName-APPID&gt;.cos.ap-singapore.myqcloud.com |
...
| 孟买    | &lt;BucketName-APPID&gt;.pic.ap-mumbai.myqcloud.com | &lt;BucketName-APPID&gt;.cos.ap-mumbai.myqcloud.com |
| 硅谷    | &lt;BucketName-APPID>.pic.na-siliconvalley.myqcloud.com | &lt;BucketName-APPID>.cos.na-siliconvalley.myqcloud.com  |
...
>- cos：指对象存储 COS，可确定当前域名为 COS 域名。若是 pic 或 picgz，则为数据万象域名。
