<table>
   ...
   <tr>
      ...
      <td>总限制</td>
      <td><li>支持格式：目前支持处理 jpg、bmp、gif、png、webp 格式，并且支持 HEIF 格式的解码和处理。<li>体积限制：处理图片原图大小不超过32MB、宽高不超过30000像素且总像素不超过2.5亿像素，处理结果图宽高设置不超过9999像素；针对动图，原图宽 x 高 x 帧数不超过2.5亿像素。<li>动图帧数限制：GIF 帧数限300帧。</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td>仅对质量 q > 70、像素 ＜ 400万的 JPG 图片进行处理。</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td><li>音频格式：当前支持 mp3、wav、aac、flac、amr、3gp、m4a、wma、ogg、ape。</li><li>音频码率：128Kbps - 256Kbps。</li><li>音频大小：文件 < 600M。</li><li>最大时长：3小时。</li><li>可识别普通话、英语。</li></td>
   </tr>
   <tr>
      <td><a href="https://cloud.tencent.com/document/product/460/52712">文本审核</a></td>
      <td><li>当前仅支持 TXT 格式文件，且文件大小不超过1MB。<li>可识别普通话、英语。 </td>
   </tr>
   <tr>
