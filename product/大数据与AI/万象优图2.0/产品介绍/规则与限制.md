<table>
   ...
   <tr>
      ...
      <td>总限制</td>
      <td><li>支持格式：目前支持处理 jpg、bmp、gif、png、webp 格式，并且支持 HEIF 格式的解码和处理。<li>体积限制：处理图片原图大小不超过20MB、宽高不超过30000像素且总像素不超过1亿像素，处理结果图宽高设置不超过9999像素；针对动图，原图宽 x 高 x 帧数不超过1亿像素。<li>动图帧数限制：GIF 帧数限300帧。</td>
   </tr>
   <tr>
      <td>格式转换</td>
   ...
   <tr>
      <td>盲水印</td>
      <td>水印图的宽高不得超过原图的1/8，文字盲水印当前仅支持数字[0 - 9]及英文大小写[A - Z,a - z]。</td>
   </tr>
   <tr>
      <td>图片高级压缩</td>
      <td><li>支持格式：支持将 jpg、png、gif、webp 等格式图片转换为 tpg 或 heif 格式。<li>体积限制：处理图片原图大小不超过20MB、宽高不超过30000像素且总像素不超过1亿像素，处理结果图宽高设置不超过9999像素；针对动图，原图宽 x 高 x 帧数不超过1亿像素。<li>动图帧数限制：gif 帧数限300帧。</td>
   </tr>
   <tr>
      <td>媒体处理服务</td>
      <td>工作流视频处理</td>
      <td>支持格式：3gp、asf、avi、dat、dv、flv、f4v、m2t、m3u8、m4v、mj2、mkv、mov、mp4、mpe、mpg、mpeg、mts、ogg、qt、rm、rmvb、swf、vob、wmv、webm。</td>
   </tr>
   <tr>
   ...
   <tr>
      <td>文本审核</td>
      <td>仅支持 txt 格式文件，且文件大小不超过1MB。</td>
   </tr>
   <tr>
