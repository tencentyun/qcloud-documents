...
| Width                | Request.Watermark.Image | 宽         | String    | 否   | 无   | 1. 当 Mode 为 Original，水印图宽 <br/> 2. 当 Mode 为 Proportion，单位为%，背景图：[100 300]；前景图：[1 100]，相对于视频宽，最大不超过4096px<br/> 3. 当 Mode 为 Fixed，单位为 px，取值范围：[8，4096]<br/> 4.若只设置 Width 时，按照视频原始比例计算 Height<br/> |
| Height               | Request.Watermark.Image | 高         | String    | 否   | 无   | 1. 当 Mode 为 Original，水印图高 <br/> 2. 当 Mode 为 Proportion，单位为%，背景图：[100 300]；前景图：[1 100]，相对于视频高，最大不超过4096px<br/> 3. 当 Mode 为 Fixed，单位为 px，取值范围：[8，4096]<br/> 4.若只设置 Height 时，按照视频原始比例计算 Width<br/>|
