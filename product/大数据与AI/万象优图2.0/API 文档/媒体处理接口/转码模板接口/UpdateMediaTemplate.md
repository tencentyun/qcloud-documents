...
| Channels           | Request.Audio | 声道数         | String | 否       | 无     | 1. 当 Codec 设置为 aac，支持1、2、4、5、6、8<br/>2. 当 Codec 设置为mp3，支持1、2 |
...
| IsCheckVideoBitrate   | Request.TransConfig | 是否检查视频码率 | String | 否       | false  | true、false <br/>2. 当为 false 时，按照配置参数转码          |
