...
#### 请求体1：截帧、音视频转码、转动图、音视频拼接、智能封面、人声分离、精彩集锦、SDR转HDR、视频增强、SCF函数和音视频分段等
...
| SuperResolution_*** | Request.MediaWorkflow.Topology.Nodes | 超分节点        | Container | 否           | 节点名称以SuperResolution为前缀，可能有多个超分节点          |
...
#### 请求1：截帧、音视频转码、转动图、音视频拼接、智能封面、人声分离、精彩集锦、SDR转HDR、视频增强、SCF函数和音视频分段等
