...
## MediaWorkflow_Topology_Nodes_VideoEnhance\_\*\*\*_Operation
<span id="MediaWorkflow_Topology_Nodes_VideoEnhance_Operation"></span>
...
## MediaWorkflow_Topology_FileInfo\_\*\*\*_Operation
<span id="MediaWorkflow_Topology_Nodes_FileInfo"></span>
...
## MediaWorkflow_Topology_Nodes_Condition\_\*\*\*_Operation
<span id="MediaWorkflow_Topology_Nodes_Condition_Operation"></span>

| 节点名称（关键字） | 描述 | 类型   | 是否必选 | 限制                            |
| -----------------  |--| ------ | -------- | ------------------------------- |
| Condition     | 条件配置,详情请参见 [Condition](#Condition) | Container | 是       | 无   |

## MediaWorkflow_Topology_Nodes_SegmentVideoBody\_\*\*\*_Operation
<span id="MediaWorkflow_Topology_Nodes_SegmentVideoBody_Operation"></span>
...
| 节点名称（关键字） | 描述      | 类型   | 是否必选 |
| ------------------ | ------------------------ | ------ | ---- |
| Mode             | 抠图模式，当前只支持 Mask (输出alpha通道结果) | String | 否   |

## MediaWorkflow_Topology_Nodes_NoiseReduction\_\*\*\*_Operation
<span id="MediaWorkflow_Topology_Nodes_NoiseReduction_Operation"></span>
...
| MixMode            | 混音模式                                    | String    | 否   | Repeat | <li>Repeat: 混音循环<br/><li>Once: 混音一次播放 |
...
## AudioMixArray
<span id="AudioMixArray"></span>
同 <a href="#AudioMix" target="_blank">AudioMix</a>
...
| 节点名称（关键字） | 描述    | 类型      | 是否必选 | 限制                 |
|-----------|-------| --------- |------|--------------------|
| Express   | 表达式详情 | String    | 是    | 详情请参见 [jsonLogic](https://jsonlogic.com/) |
