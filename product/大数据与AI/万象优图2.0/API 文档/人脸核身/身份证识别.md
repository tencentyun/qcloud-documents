...
>?
- 当前身份证识别的图片限制为：要求图片经 Base64编码后不超过7M，分辨率建议500 × 800以上，支持 PNG、JPG、JPEG、BMP 格式。建议卡片部分占据图片2/3以上。
- 人脸特效为付费服务，计费详情请查看 [计费与定价](https://cloud.tencent.com/document/product/460/6970#.E4.BA.BA.E8.84.B8.E7.89.B9.E6.95.88.E8.B4.B9.E7.94.A8)，每个账号每月有1000次的免费体验额度，超出后将正常计费。
- 该功能目前仅提供 API 使用方式。
...
| 节点名称（关键字） | 父节点   | 描述                                                         | 类型   |
| :----------------- | :------- | :----------------------------------------------------------- | :----- |
| IdCard             | AdvancedInfo   | 裁剪后身份证照片的 base64编码，设置 Config.CropIdCard 为 true 时返回                                            | String |
| Portrait          | AdvancedInfo   | 身份证头像照片的 base64编码，设置 Config.CropPortrait 为 true 时返回                                              | String |
