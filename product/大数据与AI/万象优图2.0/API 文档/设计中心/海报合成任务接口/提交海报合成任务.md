...
<Request>
    ...
    <Operation>
        ...
        <PosterProduction>
            ...
            <Info>
                <main>https://test-123456789.cos.ap-chongqing.myqcloud.com/demo.jpg</main>
...
| 节点名称（关键字） | 父节点            | 描述                                                         | 类型      | 是否必选 |
| ------------------ | ----------------- | ------------------------------------------------------------ | --------- | ---- |
| PosterProduction                   | Request.Operation | 指定该任务的参数 | Container | 否   |
...
| 节点名称（关键字） | 父节点            | 描述                                                         | 类型      | 是否必选 |
| ------------------ | ----------------- | ------------------------------------------------------------ | --------- | ---- |
| TemplateId                   | Request.Operation.PosterProduction | 海报合成任务模板 ID | String | 是   |
| Info                       | Request.Operation.PosterProduction | 模板可替换信息, 同 [查询海报合成模板接口](https://cloud.tencent.com/document/product/460/82386) 中的 Response.Template ，Info 中的图片 URL 需要保证可访问，如有特殊字符需要 URLencode                  | Container | 是   |
...
Container 节点 PosterProdcution 的内容：

| 节点名称（关键字） | 父节点            | 描述                                                         | 类型      | 是否必选 |
| ------------------ | ----------------- | ------------------------------------------------------------ | --------- | ---- |
| TemplateId                   | Request.Operation.PosterProduction | 海报合成任务模板 ID | String | 否   |
