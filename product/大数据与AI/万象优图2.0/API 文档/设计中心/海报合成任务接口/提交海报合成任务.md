...
| Info                       | Request.Operation.PosterProduction | 模板可替换信息, 同 [查询海报合成模版接口](https://cloud.tencent.com/document/product/460/82386) 中的 Response.Template ，Info 中的图片 URL 需要保证可访问，如有特殊字符需要 URLencode                  | Container | 是   |
