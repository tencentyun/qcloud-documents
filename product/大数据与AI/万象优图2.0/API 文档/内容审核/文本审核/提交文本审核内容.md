...
- 选择`Object`时，接口响应为异步返回，可通过 [查询文本审核任务结果](https://cloud.tencent.com/document/product/460/56284) 接口查看审核的结果。
...
| Keywords           | Response.JobsDetail.Section.\*Info | 在当前审核场景下命中的关键词。 | String |
