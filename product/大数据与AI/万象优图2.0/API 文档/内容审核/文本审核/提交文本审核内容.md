...
>?
> - 当传入的内容为纯文本信息，需要先经过base64编码，文本原文长度不能超过**15000字节或5000个汉字**（以先达到者为准）。
...
| Content            | Request.Input | 文本内容的Base64编码，文本原文长度不能超过**15000字节**或**5000个汉字**（以先达到者为准）；若超出长度限制，接口将会报错。 | String       | 否       |
