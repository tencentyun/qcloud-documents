...
本接口用于提交一个音频审核任务。音频审核功能为异步任务方式，您可以通过提交音频审核任务审核您的音频文件，然后通过 [查询音频审核任务接口](https://cloud.tencent.com/document/product/460/53396) 或 [音频审核回调](https://cloud.tencent.com/document/product/460/60767) 查询审核结果。
