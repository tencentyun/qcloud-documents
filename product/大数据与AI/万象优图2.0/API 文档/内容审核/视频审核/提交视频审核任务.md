...
本接口用于提交一个视频审核任务。视频审核功能为异步任务方式，您可以通过提交视频审核任务审核您的视频文件，然后通过 [查询视频审核任务接口](https://cloud.tencent.com/document/product/460/46926) 或 [视频审核回调](https://cloud.tencent.com/document/product/460/60766) 查询审核结果。
