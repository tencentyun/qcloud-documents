...
>?
- COS 简单上传文件接口，请参见 [COS 文档](https://cloud.tencent.com/document/product/436/7749)。
...
>!上传时处理支持 COS V5 的分块上传功能，您在使用 COS V5 的 Complete Multipart Upload 接口时只需在请求包头部中加入 Pic-Operations 项，即可实现图片处理。
...
COS 接口请参考 [COS 文档](https://cloud.tencent.com/document/product/436/7742)。
