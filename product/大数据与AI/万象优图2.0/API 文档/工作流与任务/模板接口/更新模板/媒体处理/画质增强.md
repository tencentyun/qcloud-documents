...
| :----------------- | :----- | :----------------------------------------------------------- | :-------- | -------- |
| Request            | 无     | <a href="https://cloud.tencent.com/document/product/460/xxx#Request" target="_blank">同创建画质增强模板接口的 Request</a> | Container | 是       |
...
| 节点名称（关键字） | 父节点 | 描述                                                         | 类型      |
| :----------------- | :----- | :----------------------------------------------------------- | :-------- |
| Response           | 无     | <a href="https://cloud.tencent.com/document/product/460/xxx#Response" target="_blank">同创建画质增强模板接口的 Response</a> | Container |
