...
| :----------------- | :----- | :------------- | :-------- | -------- |
| Request            | 无     | <a href="https://cloud.tencent.com/document/product/460/77096#Response" target="_blank">同创建精彩集锦模板接口的 Request</a> | Container | 是   |
...
| 节点名称（关键字） | 父节点 | 描述                                                | 类型      |
| :----------------- | :----- | :-------------------------------------------------- | :-------- |
| Response           | 无     | <a href="https://cloud.tencent.com/document/product/460/77096#Response" target="_blank">同创建精彩集锦模板接口的 Response</a> | Container |
