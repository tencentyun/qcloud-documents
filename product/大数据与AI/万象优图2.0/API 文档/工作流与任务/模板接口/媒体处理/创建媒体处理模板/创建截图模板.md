...
| CIParam              | Request.Snapshot | 截图图片处理参数     | String    | 否       | 无                | <ul  style="margin: 0;"><li>参考 [缩放](https://cloud.tencent.com/document/product/460/36540) </li><li>例如: imageMogr2/format/png</li></ul> |
