...
| 节点名称（关键字） | 父节点            | 描述                                                         | 类型      | 是否必选 |
| ------------------ | ----------------- | ------------------------------------------------------------ | --------- | -------- |
| Snapshot           | Request.Operation | 该任务的参数，同创建截图模板接口中的 <a href="https://cloud.tencent.com/document/product/460/77091#Snapshot " target="_blank">Request.Snapshot</a> | Container | 否       |
