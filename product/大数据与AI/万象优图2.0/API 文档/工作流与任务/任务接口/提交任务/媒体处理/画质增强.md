...
| 节点名称（关键字）  | 父节点            | 描述                                                         | 类型           | 是否必选 |
| ------------------- | ----------------- | ------------------------------------------------------------ | -------------- | -------- |
| VideoEnhance        | Request.Operation | 画质增强模板参数，不能与 TemplateId 同时为空。同创建画质增强模板接口中的 <a href="https://cloud.tencent.com/document/product/460/84722#VideoEnhance" target="_blank">Request.VideoEnhance </a> | Container      | 否       |
