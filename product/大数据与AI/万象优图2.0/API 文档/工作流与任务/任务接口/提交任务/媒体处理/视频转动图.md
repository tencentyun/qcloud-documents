...
| 节点名称（关键字） | 父节点                      | 描述                                                         | 类型      | 是否必选 |
| ------------------ | :-------------------------- | ------------------------------------------------------------ | --------- | -------- |
| Container          | Request.Operation.Animation | 同创建动图模板接口中的 <a href="https://cloud.tencent.com/document/product/460/77088#Container" target="_blank">Request.Container</a> | Container | 否       |
| Video              | Request.Operation.Animation | 同创建动图模板接口中的 <a href="https://cloud.tencent.com/document/product/460/77088#Video" target="_blank">Request.Video</a> | Container | 否       |
| TimeInterval       | Request.Operation.Animation | 同创建动图模板接口中的 <a href="https://cloud.tencent.com/document/product/460/77088#TimeInterval" target="_blank">Request.TimeInterval</a> | Container | 否       |
