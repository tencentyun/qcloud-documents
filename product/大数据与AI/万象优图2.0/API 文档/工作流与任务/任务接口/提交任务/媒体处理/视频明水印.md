...
| Watermark           | Request.Operation | 印模板参数，同创建水印模板接口中的 <a href="https://cloud.tencent.com/document/product/460/77099#Watermark" target="_blank">Request.Watermark</a> ，最多传3个。 | Container数组 | 否       |
