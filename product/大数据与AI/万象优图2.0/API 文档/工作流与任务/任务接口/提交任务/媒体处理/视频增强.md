...
| 节点名称（关键字）  | 父节点            | 描述                                                         | 类型           | 是否必选 |
| ------------------- | ----------------- | ------------------------------------------------------------ | -------------- | -------- |
| VideoProcess        | Request.Operation | 视频增强模板参数，不能与 TemplateId 同时为空                 | Container      | 否       |
| TemplateId          | Request.Operation | 模板 ID ，不能与 VideoProcess 同时为空                       | String         | 否       |
| Transcode           | Request.Operation | 转码模板参数，不能与 TranscodeTemplateId 同时为空            | Container      | 否       |
| TranscodeTemplateId | Request.Operation | 指转码模板 ID，优先使用模板 ID，不能与 Transcode 同时为空    | String 数组    | 否       |
| WatermarkTemplateId | Request.Operation | 水印模板 ID，可以传多个水印模板 ID，最多传3个。              | String         | 否       |
| Watermark           | Request.Operation | 水印模板参数，同创建水印模板接口的 <a href="https://cloud.tencent.com/document/product/460/84725#Watermark" target="_blank">Request.Watermark</a>, 最多传3个 | Container 数组 | 否       |
...
| 节点名称（关键字） | 父节点                         | 描述                                                         |
| ------------------ | :----------------------------- | ------------------------------------------------------------ |
| ColorEnhance       | Request.Operation.VideoProcess | 同创建视频增强模板接口中的 <a href="https://cloud.tencent.com/document/product/460/84728#ColorEnhance" target="_blank">Request.ColorEnhance</a> |
| MsSharpen          | Request.Operation.VideoProcess | 同创建视频增强模板接口中的 <a href="https://cloud.tencent.com/document/product/460/84728#MsSharpen" target="_blank">Request.MsSharpen</a> |
