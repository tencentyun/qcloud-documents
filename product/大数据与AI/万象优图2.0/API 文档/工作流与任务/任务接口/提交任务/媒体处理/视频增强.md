...
| Watermark           | Request.Operation | 水印模板参数，同创建水印模板接口的 <a href="https://cloud.tencent.com/document/product/460/77099#Watermark" target="_blank">Request.Watermark</a>, 最多传3个 | Container 数组 | 否       |
...
| 节点名称（关键字） | 父节点                         | 描述                                                         |
| ------------------ | :----------------------------- | ------------------------------------------------------------ |
| ColorEnhance       | Request.Operation.VideoProcess | 同创建视频增强模板接口中的 <a href="https://cloud.tencent.com/document/product/460/77097#ColorEnhance" target="_blank">Request.ColorEnhance</a> |
| MsSharpen          | Request.Operation.VideoProcess | 同创建视频增强模板接口中的 <a href="https://cloud.tencent.com/document/product/460/77097#MsSharpen" target="_blank">Request.MsSharpen</a> |
