...
| VideoTargetRec     | Request.Operation | 视频目标检测参数, 同创建视频目标检测模板接口中的<a href="https://cloud.tencent.com/document/product/436/84994#VideoTargetRec " target="_blank"> Request.VideoTargetRec</a> | Container | 否       |
