...
Container 类型 SplitVideoParts 的具体数据描述如下：

| 节点名称（关键字） | 父节点                             | 描述                           | 类型   | 是否必选 |
| ------------------ | ---------------------------------- |------------------------------| ------ | -------- |
| Mode               | Request.Operation.SplitVideoParts | 拆条模式，当前只支持 SHOTDETECT (分镜拆分) | String | 否       |
...
| Tag                | Response.JobsDetail | 新创建任务的 Tag：SegmentVideoBody                           | String    |
...
Container 节点 SplitVideoInfoResult 的内容：

| 节点名称（关键字） | 父节点                            | 描述    | 类型          |
| :----------------- |:-------------------------------|:------|:------------|
| TimeInfo   | Response.JobsDetail.Operation.SplitVideoInfoResult | 各片段详情 | Container数组 |

Container 节点 TimeInfo 的内容：

| 节点名称（关键字） | 父节点                                                         | 描述    | 类型     |
| :----------------- |:------------------------------------------------------------|:------|:-------|
| Index   | Response.JobsDetail.Operation.SplitVideoInfoResult.TimeInfo | 片段索引  | String |
| PartBegin   | Response.JobsDetail.Operation.SplitVideoInfoResult.TimeInfo | 各片段详情 | 片段起始时间 |
| PartEnd   | Response.JobsDetail.Operation.SplitVideoInfoResult.TimeInfo | 各片段详情 | 片段结束时间 |
