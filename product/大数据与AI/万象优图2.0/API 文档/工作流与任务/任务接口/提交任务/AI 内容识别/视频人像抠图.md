...
| 节点名称（关键字） | 父节点                             | 描述                                          | 类型   | 是否必选 |
| ------------------ | ---------------------------------- | --------------------------------------------- | ------ | -------- |
| Mode               | Request.Operation.SegmentVideoBody | 抠图模式，当前只支持 Mask (输出alpha通道结果) | String | 否       |
...
| 节点名称（关键字） | 父节点                        | 描述                                          | 类型      |
| :----------------- | :---------------------------- | :-------------------------------------------- | :-------- |
| SegmentVideoBody   | Response.JobsDetail.Operation | 同请求中的 Request.Operation.SegmentVideoBody | Container |
