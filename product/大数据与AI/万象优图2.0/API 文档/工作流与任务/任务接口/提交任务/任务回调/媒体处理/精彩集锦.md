...
<Response>
    ...
    <JobsDetail>
        ...
        <Operation>
            ...
            <Output>
                <Bucket>test-123456789</Bucket>
                <Object>output/videoMontage.${ext}</Object>
                <Region>ap-chongqing</Region>
            </Output>
...
同提交精彩集锦任务接口中的 <a href="https://cloud.tencent.com/document/product/460/84778#jobsDetail" target="_blank">Response.JobsDetail</a>
...
```plaintext
{
    ...
    "JobsDetail": [{
        ...
        "Operation": {
            ...
            "Output": {
                "Bucket": "test-123456789",
                "Object": "output/videoMontage.${ext}",
                "Region": "ap-chongqing"
            },
