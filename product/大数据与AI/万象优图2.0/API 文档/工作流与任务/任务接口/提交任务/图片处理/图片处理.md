...
| PicProcess         | Request.Operation | 该任务的参数，同创建图片处理模板接口中的 <a href="https://cloud.tencent.com/document/product/460/84735#PicProcess" target="_blank">Request.PicProcess</a> | Container | 否       |
| Output             | Request.Operation | 结果输出配置                                                 | Container | 是       |
| UserData           | Request.Operation | 透传用户信息, 可打印的 ASCII 码, 长度不超过1024              | String    | 否       |
| JobLevel           | Request.Operation | 任务优先级，级别限制：0 、1 、2 。级别越大任务优先级越高，默认为0 | String    | 否       |

>!优先使用 TemplateId，无 TemplateId 时使用 PicProcess。
