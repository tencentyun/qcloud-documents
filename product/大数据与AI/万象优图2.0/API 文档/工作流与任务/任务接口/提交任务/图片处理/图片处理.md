...
| 节点名称（关键字） | 父节点            | 描述                                                         | 类型      | 是否必选 |
| ------------------ | ----------------- | ------------------------------------------------------------ | --------- | -------- |
| PicProcess         | Request.Operation | 该任务的参数，同创建图片处理模板接口中的 <a href="https://cloud.tencent.com/document/product/460/77182#PicProcess" target="_blank">Request.PicProcess</a> | Container | 否       |
