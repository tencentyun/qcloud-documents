...
| Video              | Request.Operation.<br/>ConcatTemplate | 视频参数，同创建拼接模板 <a href="https://cloud.tencent.com/document/product/460/77089#Video" target="_blank">CreateMediaTemplate</a> 接口中的  <br/>Request.ConcatTemplate.Video | Container      | 否       | 无     | 无                             |
...
| AudioMix           | Request.Operation.<br/>ConcatTemplate | 混音参数, 详情见 <a href="https://cloud.tencent.com/document/product/460/78927#AudioMix" target="_blank">AudioMix</a>  | Container数组      | 否       |无      | 仅在 Audio.Remove 为 false 时生效 |
