...
| Type               | Request.MediaWorkflow.Topology.</br>Nodes.Start.Input.NotifyConfig | 回调类型 | String | 是       | 无     | Url:Url 回调                                                  |
...
| ResultFormat       | Request.MediaWorkflow.Topology.</br>Nodes.Start.Input.NotifyConfig | 回调格式 | String | 否       | XML    | 1. XML：xml 格式 </br> 2. JSON：json 格式                      |
...
| AllFile            | Request.MediaWorkflow.Topology.</br>Nodes.Start.Input.ExtFilter   | 所有文件              | String | 否       | false  | false/true                                                   |
