...
| CIParam              | Request.Snapshot | 截图图片处理参数  | String    | 否   | 无  | <li>参考文档(https://cloud.tencent.com/document/product/460/36540) </li><li>例如: imageMogr2/format/png |
...
| Color              | Request.Snapshot.SpriteSnapshotConfig | 背景颜色  | String    | 是   | 无  | 支持颜色详见https://www.ffmpeg.org/ffmpeg-utils.html#color-syntax |
