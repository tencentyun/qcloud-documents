...
| Pixfmt             | Request.Video | 视频颜色格式       | String | 否       | 无           | 1. H.264支持：yuv420p、yuv422p、yuv444p、yuvj420p、yuvj422p、yuvj444p<br/>2. H.265支持：yuv420p、yuv420p10le<br/>3. Codec 为 VP8/VP9时不支持此参数 |
