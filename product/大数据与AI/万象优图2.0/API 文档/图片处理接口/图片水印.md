...
| /image/      | 水印图片地址，需要经过 URL 安全的 Base64 编码。例如，水印图片为`http://examplebucket-1250000000.picsh.myqcloud.com/shuiyin_2.png`，则该处编码后的字符串为`aHR0cCUzQS8vZXhhbXBsZWJ1Y2tldC0xMjUwMDAwMDAwLnBpY3NoLm15cWNsb3VkLmNvbS9zaHVpeWluXzIucG5n`            |
