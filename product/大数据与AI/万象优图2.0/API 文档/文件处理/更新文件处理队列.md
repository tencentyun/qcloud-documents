...
```plaintext
<Response>
    <RequestId>NjJmNDczY2R******NTA4ZV85</RequestId>
    <Queue>
        <QueueId>pb926e1dce*******2164f4869</QueueId>
        <Name>My-Queue-file</Name>
        <State>Active</State>
        <NotifyConfig>
            <Url>http://callback.demo.com</Url>
...
```plaintext
PUT /file_queue/pb926e1******69 HTTP/1.1
...
Server: tencent-ci
x-ci-request-id: NjJm******ZV85

<Response>
    <RequestId>NjJmNDcz******ZV85</RequestId>
    <Queue>
        <QueueId>pb926e1dce******64f4869</QueueId>
        <Name>My-Queue-file</Name>
        <State>Active</State>
        <NotifyConfig>
            <Url>http://callback.demo.com</Url>
