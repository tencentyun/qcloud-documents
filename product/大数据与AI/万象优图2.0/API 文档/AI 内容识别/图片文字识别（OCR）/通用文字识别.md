...
- 成功调用接口会产生 [通用文字识别费用](https://cloud.tencent.com/document/product/460/58118) 和 [COS 读请求费用](https://cloud.tencent.com/document/product/436/53861#.E8.AF.B7.E6.B1.82.E6.AC.A1.E6.95.B0.E5.AE.9A.E4.BB.B7)。
