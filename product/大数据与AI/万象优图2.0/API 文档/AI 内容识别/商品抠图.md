...
-  原图来自其他链接：
  ...
  ```javascript
  GET /<ObjectKey>?ci-process=GoodsMatting&detect-url=<detect-url> HTTP/1.1
  Host: <BucketName-APPID>.cos.<Region>.myqcloud.com
  Date: <GMT Date>
  Authorization: <Auth String>
  ```
...
| ci-process | 数据万象处理能力，商品抠图固定为GoodsMatting。                                                                                                                                                                                                                       | String | 是    |
...
| rule   | String | 是    | 固定为：ci-process=GoodsMatting                                                                                                                                                                                                                                                                                          |
...
| ETag      | Object | 抠图后图片的ETag值 | String |
