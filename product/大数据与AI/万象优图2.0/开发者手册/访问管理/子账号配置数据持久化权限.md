...
授予子账号拥有数据万象的操作权限分为三个步骤：**创建子账号并配置 CI 权限**、**对子账号授予 COS 资源访问权限**、**使用子账号进行数据处理**。
...
2. 进入用户列表页面，单击【新建用户】。
3. 在“选择新建用户类型”页面，选择子用户，如下图所示： 
![](https://main.qcloudimg.com/raw/fa307753e1a6a4ad058249917e9aac80.png)
...
## 步骤二：对子账号授予 COS 资源访问权限

对子账号授予权限可通过直接关联预设策略的方式：
1. 登录 [CAM 控制台](https://console.cloud.tencent.com/cam)，选择左侧菜单栏【用户】>【用户列表】。
2. 进入用户列表页面，找到需要授权关联策略的子用户，单击账号右侧的【授权】。如下图所示：
![](https://main.qcloudimg.com/raw/55515c66c9ea9f7de58b6f2118267df6.png)
...
也可通过编写自定义策略对子账号授予权限，具体可参考 [授权管理](https://cloud.tencent.com/document/product/598/10602) 文档和策略示例。
...
![](https://main.qcloudimg.com/raw/1616b92d10e5be9d4cc3142db76fb415.png)
