...
| ----------------------- | ------------ | ------------ | -------- | ------------------- | --------------------- |
| 消息队列 CKafka         | 支持         | 不支持       | 不支持   | 支持                | 暂不支持              |
| 云数据库 MySQL          | 支持         | 支持         | 支持     | 支持                | 支持                  |
| 云数据库 PostgreSQL CDC | 支持         | 支持         | 支持     | 支持                | 支持（9.5及以上版本） |
| 云数据仓库 PostgreSQL   | 不支持       | 支持         | 支持     | 支持                | 暂不支持              |
| 云数据仓库 ClickHouse   | 不支持       | 暂不支持     | 暂不支持 | 支持                | 支持                  |
| Elasticsearch Service   | 不支持       | 不支持       | 不支持   | 支持                | 支持                  |
| Filesystem(HDFS/COS)    | 不支持       | 不支持       | 不支持   | 支持                | 不支持                |
| Hive                    | 支持         | 不支持       | 支持     | 支持                | 不支持                |
| Hbase                   | 不支持       | 支持         | 支持     | 支持                | 支持                  |
| Kudu                    | 不支持       | 支持         | 不支持   | 支持                | 支持                  |
| 云数据库 Redis          | 不支持       | 不支持       | 暂不支持 | 支持                | 支持                  |
| 消息队列 CMQ            | 支持         | 不支持       | 不支持   | 支持                | 暂不支持              |
| Oracle                  | 暂不支持     | 支持         | 支持     | 支持                | 支持                  |
| Doris                   | 暂不支持     | 暂不支持     | 暂不支持 | 支持                | 支持                  |
| 云日志集 CLS            | 支持         | 不支持       | 不支持   | 不支持              | 不支持                |
