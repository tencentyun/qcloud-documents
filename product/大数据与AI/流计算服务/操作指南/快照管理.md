...
当前默认保留 checkpoint 的数量设置为 5 个， 可以在**高级参数**中使用 "state.checkpoints.num-retained" 关键字来设定保留多少份 checkpoint。使用示例参考下图。
![](https://qcloudimg.tencent-cloud.cn/raw/ad88c1560903a880325c2b64e96cb361.png)
