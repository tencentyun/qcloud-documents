...
<td>含<strong>本地时区</strong>信息的时间戳类型。<li>取值范围是[0000-01-01 00:00:00.000000000 +14:59，9999-12-31 23:59:59.999999999 -14:59]。<li>p 表示秒的小数位精度，取值范围是0 - 9。如果未指定，默认为6。<li>时区数据<strong>不存储</strong>在每条数据中，而是遵循全局的时区设置。<li><strong>此类型不支持闰秒。类似于 Java 的 OffsetDateTime 类型。</td>
</tr>
<tr>
