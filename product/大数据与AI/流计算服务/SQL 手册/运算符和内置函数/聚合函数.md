...
**示例测试语句**：`COUNT(ALL *)  FROM TEST;`
**测试结果：**

| 测试语句                                    | 测试结果（nums） |
| ------------------------------------------- | ---------------- |
| `COUNT(ALL *)  AS nums FROM TEST; `           | 9                |
| `COUNT(DISTINCT site_id)  AS nums FROM TEST;` | 5                |
...
| 测试语句                            | 测试结果（avg） |
| ----------------------------------- | --------------- |
| `SELECT AVG(count) AS avg FROM TEST;` | 176.3           |
...
| 测试语句                            | 测试结果（sum） |
| ----------------------------------- | --------------- |
| `SELECT SUM(count) AS sum FROM TEST;` | 1569            |
...
| 测试语句                            | 测试结果（max） |
| ----------------------------------- | --------------- |
| SELECT MAX(count) AS max FROM TEST; | 545             |
...
| 测试语句                            | 测试结果（min） |
| ----------------------------------- | --------------- |
| SELECT MIN(count) AS min FROM TEST; | 13              |
