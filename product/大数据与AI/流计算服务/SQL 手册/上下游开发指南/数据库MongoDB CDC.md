...
| connection.options        | The ampersand-separated <a href="https://docs.mongodb.com/manual/reference/connection-string/#std-label-connections-connection-options">connection options</a> of MongoDB. eg. ```replicaSet=test&connectTimeoutMS=300000``` | 否       | -                         |
| errors.tolerance          | 是否忽略错误记录，接受 none 或者 all。如果设置为all， 忽略错误记录 | 否       | none                      |
