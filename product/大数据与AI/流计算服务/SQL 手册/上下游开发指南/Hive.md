...
### 在任务中使用配置 jar
Flink SQL 任务作业参数中选择内置 Connector（当前支持 flink-connector-hive-3.1.1、flink-connector-hive-2.3.5、flink-connector-hive-2.3.2 三个版本），引用程序包里面选择 Hive 连接配置 jar 包（即 hive-xxx.jar）。
