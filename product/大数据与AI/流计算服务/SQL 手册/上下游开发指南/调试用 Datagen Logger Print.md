...
Datagen 是 Flink 自带的随机数据生成器，它可以作为数据源直接引用。详细的使用方式可以参考 [Flink 官方文档](https://ci.apache.org/projects/flink/flink-docs-release-1.13/zh/docs/connectors/table/datagen/).
...
使用 Logger Sink 前，需要先 [下载 JAR 包](https://github.com/tencentyun/flink-hello-world/releases) ，如果您希望自定义输出逻辑，也可以自行修改并编译构建程序包。

随后可以将这个 JAR [上传到程序包](https://cloud.tencent.com/document/product/849/48295)，然后在 SQL 作业用 [引用该程序包](https://cloud.tencent.com/document/product/849/48287)。
