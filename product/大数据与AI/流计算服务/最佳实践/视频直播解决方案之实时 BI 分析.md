...
### 创建 EMR 集群
弹性 MapReduce 是云端托管的弹性开源泛 Hadoop 服务，支持 Spark、HBase、Presto、Flink、Druid 等大数据框架，本次示例主要需要使用Flume、Hive、YARN、HUE、Oozie 组件。页面地址[https://console.cloud.tencent.com/emr](https://console.cloud.tencent.com/emr)
...
| ip           | varchar   | 客户 IP 地址   |
| room\_id     | bigint    | 房间号       |
| arrive\_time | timestamp | 进入房间时间 |
| leave\_time  | timestamp | 离开房间时间 |
