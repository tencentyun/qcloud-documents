...
### 创建 EMR 集群
EMR 是云端托管的弹性开源泛 Hadoop 服务，支持 Spark、HBase、Presto、Flink、Druid 等大数据框架，本次示例主要需要使用Flume、Hive、YARN、HUE、Oozie 组件。页面地址[https://console.cloud.tencent.com/emr](https://console.cloud.tencent.com/emr)
