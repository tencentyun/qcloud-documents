...
| 时间 | 版本号 | 特性 | 相关链接 |
|---------|---------|---------|---------|
| 2019.6.3 | V2.0.3 | 人脸检测与分析，最多处理的人脸数目（MaxFaceNum）由30提升为120 | [人脸检测与分析](https://cloud.tencent.com/document/api/867/32800) |
