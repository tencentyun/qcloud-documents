...
- 通过编写代码调用腾讯云 SDK 来访问腾讯云产品。腾讯云 SDK 将腾讯云产品的各 API 基于常见的编程语言进行了打包，包括 C++、PHP、Python、Java、JavaScript 和 Node.js 等。详情请查看人脸识别的 [SDK 文档 ](https://cloud.tencent.com/document/sdk)。
