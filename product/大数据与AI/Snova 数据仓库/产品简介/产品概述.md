## 产品简介
Snova 为您提供简单、快速、经济高效的 PB 级云端数据仓库解决方案。借助于 Snova，您可以在数分钟内创建数百节点的企业级云端数据仓库，并高效的完成日常维护工作；也可以使用丰富的 PostgreSQL 开源生态工具，实现对 Snova 中海量数据的即席查询分析、ETL 处理及可视化探索；还可以借助其云端数据无缝集成特性，轻松分析位于 COS、CDB、ES 等数据引擎上的 PB 级数据。
