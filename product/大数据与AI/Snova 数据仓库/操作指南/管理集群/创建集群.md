## 操作场景
本文为您介绍内测阶段的 Snova 数据仓库，[申请](https://cloud.tencent.com/apply/p/9w3pf3gjrtk) 通过后，在控制台创建集群的操作。

## 操作步骤
1. 申请通过后，在控制台选择集群列表。
>?[申请](https://cloud.tencent.com/apply/p/9w3pf3gjrtk) 通过后，选择【云产品】>【云智大数据平台】>【Snova 数据仓库】，进入 Snova 控制台。
