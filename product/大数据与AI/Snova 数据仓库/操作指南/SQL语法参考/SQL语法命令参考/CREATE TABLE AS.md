...
CREATE TABLE AS 创建一个新表，并且初始计算查询一次来填充新表。该新表不会同步源表查询子序列的变化。
...
CREATE TABLE AS 可以用于从外部表数据源中快速加载数据。详情请参见 [CREATE EXTERNAL TABLE](https://cloud.tencent.com/document/product/878/33622)。
...
## 另见
[CREATE EXTERNAL TABLE](https://cloud.tencent.com/document/product/878/33622)
[SELECT](https://cloud.tencent.com/document/product/878/33673)
[SELECT INTO](https://cloud.tencent.com/document/product/878/33675)
