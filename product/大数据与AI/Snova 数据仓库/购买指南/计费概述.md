...
<thead>
<tr>
<th width="100px" style="word-wrap:break-word">计算密集型</th>
<th width="90px" style="word-wrap:break-word">CPU（核）</th>
<th width="120px" style="word-wrap:break-word">内存（GB）</th>
<th width="140px" style="word-wrap:break-word">存储量（TB）</th>
<th width="100px" style="word-wrap:break-word">存储类型</th>
<th width="140px" style="word-wrap:break-word">包月价（元）</th>
<th width="160px" style="word-wrap:break-word">按量计费（元/小时）</th>
</tr>
</thead>
<tbody><tr>
<td>nc.large</td>
...
<th width="90px">CPU（核）</th>
<th width="120px">内存（GB）</th>
<th width="140px">存储量（TB）</th>
<th width="100px">存储类型</th>
<th width="140px">包月价（元）</th>
