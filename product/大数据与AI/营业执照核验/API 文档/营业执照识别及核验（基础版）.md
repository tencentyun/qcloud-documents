...
以下请求参数列表仅列出了接口请求参数和部分公共参数，完整公共参数列表见 [公共请求参数](/document/product/1024/38178?!preview&preview_docmenu=1&lang=cn&!document=1)。

| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | 公共参数，本接口取值：VerifyBasicBizLicense。 |
| Version | 是 | String | 公共参数，本接口取值：2018-11-19。 |
| Region | 是 | String | 公共参数，详见产品支持的 [地域列表](/document/product/1024/38178?!preview&preview_docmenu=1&lang=cn&!document=1#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8)，本接口仅支持其中的: ap-guangzhou |
...
| Dom | String | 住址|
| RegNumResult | [BizLicenseVerifyResult](/document/product/1024/31298?!preview&preview_docmenu=1&lang=cn&!document=1#BizLicenseVerifyResult) | 验证结果|
...
以下仅列出了接口业务逻辑相关的错误码，其他错误码详见 [公共错误码](/document/product/1024/38181?!preview&preview_docmenu=1&lang=cn&!document=1#.E5.85.AC.E5.85.B1.E9.94.99.E8.AF.AF.E7.A0.81)。
