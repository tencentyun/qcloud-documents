...
服务开通成功后，您将获得营业执照识别及核验每个接口50次的免费调用额度，每个账户仅可获取一次。同时您也可以在[文字识别购买页](https://buy.cloud.tencent.com/iai_ocr?type=bizlic_verify&action=VerifyBasicBizLicense) 中购买对应文字识别服务的资源包，若免费额度以及资源包调用次数耗尽，接口计费将自动转为后付费方式按月进行结算，具体计费标准可以查看营业执照核验的 [购买指南](https://cloud.tencent.com/document/product/1252/46550) 。
