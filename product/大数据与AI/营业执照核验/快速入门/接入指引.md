...
## 操作步骤
只需三步，轻松完成腾讯云文字识别营业执照核验接口调用。

### 第一步：开通文字识别服务
在调用文字识别相关接口前，您需要进入 [文字识别控制台](https://console.cloud.tencent.com/ocr/verifybasicbizlicense)，申请开通对应的文字识别服务。 

![](https://main.qcloudimg.com/raw/d7ebc957049daecadcc45fe3356585b9.png)

营业执照核验目前处于内测阶段，您需要填写 [使用申请](https://cloud.tencent.com/apply/p/fmfilz78395)，申请审核通过之后，将为您开通服务。

服务开通成功后，您将获得营业执照识别及核验每个接口50次的免费调用额度，每个账户仅可获取一次。同时您也可以在[文字识别购买页](https://buy.cloud.tencent.com/iai_ocr?type=bizlic_verify&action=VerifyBasicBizLicense) 中购买对应文字识别服务的资源包，若免费额度以及资源包调用次数耗尽，接口计费将自动转为后付费方式按月进行结算，具体计费标准可以查看营业执照核验的 [计费概述](https://cloud.tencent.com/document/product/1252/47673) 。

![](https://main.qcloudimg.com/raw/528512ff655657251e8fdb3c849ce7c4.png)

### 第二步：使用 API3.0 Explorer 在线调用文字识别接口
文字识别服务开通成功后，进入文字识别 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=ocr&Version=2018-11-19&Action=VerifyBizLicense&SignVersion=) 在线接口调试页面，选择需要调用的接口，并填写**个人密钥**和**输入参数**。

![](https://main.qcloudimg.com/raw/f86565a2e8a4b74e746807e3e42f069a.png)
