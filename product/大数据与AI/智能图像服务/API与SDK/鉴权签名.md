...
>**注意：**
>- 如果您是新用户（初次使用智能图像服务），请使用 [API 密钥](https://console.cloud.tencent.com/capi) ；
>- 如果您是老用户且使用过100、101等开头的项目ID，可以继续使用 [项目密钥](https://console.cloud.tencent.com/capi/project)，但建议使用[API 密钥](https://console.cloud.tencent.com/capi)；
