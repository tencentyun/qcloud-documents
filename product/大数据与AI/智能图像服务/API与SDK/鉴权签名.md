...
>**注意：**
>- 如果您使用的是 125 开头的 APPID，请使用 [API 密钥](https://console.cloud.tencent.com/capi) ；
>- 如果您使用的是 100、101 等开头的 项目 ID，请使用 [项目密钥](https://console.cloud.tencent.com/capi/project)；
...
（2）SecretKey 为 API 密钥，orignal 为 2.2 节中拼接好的签名串。
