...
<<<<<<< HEAD
| content-length | 包体总长度                                | 图片大小建议小于1280*720px；每个请求的包体大小限制为 6MB；不支持 .gif 类型的动图。        |
...
=======
| content-length | 包体总长度                                | 图片大小建议不超过 1280*720px；每个请求的包体大小限制为 6MB；不支持 .gif 类型的动图。        |
...
>>>>>>> f053cdc2236904c291b0fd9dc9d6a3f0e89e68f2
