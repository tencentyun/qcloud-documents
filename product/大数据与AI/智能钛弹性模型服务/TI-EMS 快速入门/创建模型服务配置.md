...
**选择运行环境：** 单击【运行环境】，可选择模型运行的公共环境。智能钛弹性模型服务提供 Tensorflow、PMML、TensorRT、OpenVINO 和 Angel 五种模型服务运行环境，相关介绍请详见 [模型运行环境介绍](https://cloud.tencent.com/document/product/1120/36600)。
