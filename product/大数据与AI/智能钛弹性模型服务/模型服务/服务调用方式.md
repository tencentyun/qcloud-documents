...
### VPC 地址调用
TI-EMS 支持用户自己的 VPC 通过 privatelink 通道和 TI-EMS 的 VPC 环境打通，。在控制台对应的在线服务列表处单击【更多】>【调用】>【VPC 调用】，选择需要打通的 VPC 私有网络和子网信息，完成打通后可显示调用地址和需要的鉴权信息。VPC 相关操作请详见 [VPC 产品文档](https://cloud.tencent.com/document/product/215/3071)。
