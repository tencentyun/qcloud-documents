...
这里以< appid > = 200001 为例拼接签名原文，则拼接的签名原文为：
```
POST aai.qcloud.com/asr/v1/<appid>?expired=1473148422&nonce=12345&projectid=1000010&secretid=AKIDUfLUEUigQiXqm7CVSspKJnuaiIKtxqAv&source_type=0&template_name=example&timestamp=1473148302&url=http://test.audiourl.com
```
对原文进行加密处理：
```
