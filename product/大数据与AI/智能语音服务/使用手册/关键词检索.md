...
关键词检索服务，可以帮助您从语音文件中检索出业务关注的词语。您可以同时提交最多 200 个关键词，服务会语音文件中检索关注的关键词，并给时间偏移量和置信度。相比于，使用语音转文字服务后进行关键词的匹配，关键词检索服务具备更优地效率和更高地关键词召回率。适合应用于客服语音质检、APP 音频审核、直播鉴黄等场景。
