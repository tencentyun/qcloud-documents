...
本节将介绍腾讯云对象存储（COS）数据接入方法。更多关于腾讯云对象存储（COS）的信息请查看 [COS 产品介绍](https://cloud.tencent.com/document/product/436) 。

## 操作步骤

进入 [集群管理](https://sparkling.cloud.tencent.com) 页面，在左侧导航单击【数据】进入数据接入页面，按以下操作步骤完成 COS 数据接入：
...
##### 步骤1  数据源配置
  ...
  - 文件格式：支持CSV、TSV及其他自定义分隔符日志的文件。
  - 表头字段：点选是否将第一行作为表头字段名。
...
![](https://main.qcloudimg.com/raw/0b3d79583b30d2646200c31f051090c9.png)
 ...
 ##### 步骤3  目标配置
确认目标配置，输入标题（新建表表名）及描述，选择存储格式后点击【下一步】进入任务预览页面。
