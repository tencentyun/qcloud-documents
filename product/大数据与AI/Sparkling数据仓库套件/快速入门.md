...
在 [Sparkling 数据仓库套件](https://sparkling.cloud.tencent.com) 产品页面创建集群，填写申请单，填写完成后单击【提交申请】完成线上申请。
...
### 数据开发
单击【工作区】进入数据开发页面，可以执行笔记簿的刷新、新建、重命名、删除操作，可以在命令栏中输入执行 SQL 语句并对其可视化操作和下载。
