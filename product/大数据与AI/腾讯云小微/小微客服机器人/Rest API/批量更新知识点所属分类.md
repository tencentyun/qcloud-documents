...
|qaid_list	|需要修改分类的知识点id列表|String|是|
|l1classid	|1级分类id，未分类填"0"|String|是|
|l2classid	|2级分类id,直接属于1级分类，则2，3级分类都填"0"|String|是|
|l3classid	|3级分类id，直接属于2级分类，则3级分类填"0"|String|是|
...
|succ_qaid_list	|成功修改分类的知识点id列表|String|
