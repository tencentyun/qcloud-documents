...
在文本测试页面你可以输入文本，测试系统能否正确是别意图和槽位。同时这里也可以看到小微向Skill后台发出的请求文本的格式和内容。
![](//mc.qcloudimg.com/static/img/0c8da9a6d1f5ea0ddba3b3c7d47e2e2e/image.jpg)
