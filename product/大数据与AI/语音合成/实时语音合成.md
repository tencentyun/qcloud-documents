...
腾讯 TTS 技术可以应用到很多场景，例如，移动 App 语音播报新闻；智能设备语音提醒；依靠网上现有节目或少量录音，快速合成明星语音，降低邀约成本；支持车载导航语音合成的个性化语音播报。**本接口内测期间免费使用**。
...
```
鉴权说明请参考 [接口鉴权](https://cloud.tencent.com/document/product/1073/37991) 文档。
...
[C++](https://cloud.tencent.com/document/product/1073/37931)  
[Java](https://cloud.tencent.com/document/product/1073/37933)  
[Python](https://cloud.tencent.com/document/product/1073/37935)  
[Php](https://cloud.tencent.com/document/product/1073/37934)  
