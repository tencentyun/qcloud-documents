腾讯云腾讯增长平台目前支持通过登录腾讯云官网，可填写并提交申请单的方式申请部署腾讯增长平台服务。申请通过后，通过可视化的点击操作，您可以快速了解和使用腾讯增长平台。更多操作请参阅 [用户使用手册](https://docs.google.com/document/d/1lzJVeXWAHF8GWeOG4LrsBsUTYDTyexgSUl8OrLMIPCk/edit)。
