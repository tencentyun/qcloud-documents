...
![](https://main.qcloudimg.com/raw/52b246172a4d62af80a86730aaf1b1a1.png)

在管道配置中，分别针对“input-kafka”和“output-elasticsearch”进行配置，一些关键的配置参数说明如下：

### input-beats

* host: logstash要监听的ip地址，可设置为节点的ip，默认为0.0.0.0
* port: logstash要监听的端口号，默认为5044
* type: 标识字段

查看更多参数，可以参考[input-beats](https://www.elastic.co/guide/en/logstash/current/plugins-inputs-beats.html#plugins-inputs-beats-host)
