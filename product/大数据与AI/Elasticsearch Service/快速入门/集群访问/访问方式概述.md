...
## 访问鉴权
选择 高级特性（原官方 X-Pack 插件）是白金版时，Elasticsearch 集群将开启用户认证功能，您在通过各种客户端或 API 访问客户集群时，需要输入用户名密码，开源版和基础版则不需要，在访问集群时，请注意所选择的的 Elasticsearch 高级特性版本，具体使用方式可参考以下各种访问方式说明。
