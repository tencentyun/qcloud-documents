...
Elasticsearch 从 5.6.0 开始，发布了Java High Level REST Client。这个官方的 high-level client，可以用于执行 search, index, delete, update and bulk 操作，同 TransportClient 使用的核心 Java classes 一致，并且是为了替代 TransportClient。详情参考：[Java High Level REST Client说明](https://www.elastic.co/guide/en/elasticsearch/client/index.html)。
