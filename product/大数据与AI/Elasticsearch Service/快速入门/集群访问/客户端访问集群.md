...
建议客户端版本同服务端版本保持一致，腾讯云 ES 目前提供了不同 Elasticsearch 版本，请注意客户端版本选择。更多信息，可查看官方说明
；[ESAPI版本兼容性说明](https://www.elastic.co/guide/en/elasticsearch/client/java-rest/6.0/java-rest-high-compatibility.html)，
