## 简介
高级特性，Elasticsearch 官方商业特性（原X-Pack 商业版插件），包含了安全-权限管理（Security）、SQL、JDBC、告警（Alerting）、机器学习（Machine Learning）、监控等能力，可以为集群多用户权限管理，JDBC开发，以及日志分析等业务应用场景提供有力帮助，具体介绍，见下文。

## 高级特性说明
![](https://main.qcloudimg.com/raw/de50a8ca3ee5ae61ca140e4ce5aa497c.png)
腾讯云 ES，提供了 3 种可选的高级特性版本，其中基础版和白金版均集成了官方的商业特性（原X-Pack插件），开源版则没有；白金版包含了全部商业特性，基础版只包含了部分。为了能够使用腾讯云 Elasticsearch 的功能，我们建议您选择白金版，具体功能及区别如下。
