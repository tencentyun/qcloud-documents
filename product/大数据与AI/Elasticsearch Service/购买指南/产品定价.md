...
<table class="tg">
  <tr>
    ...
    <th class="tg-llyw" colspan="12">预付费（元/个/月）</th>
  </tr>
  <tr>
...
**折扣说明**  
目前产品有优惠活动，根据实际购买的版本和购买时长，会有不同的折扣，特别是白金版，具体可查看 [购买ES](https://buy.cloud.tencent.com/es) 。
...
<table class="tg">
  <tr>
    ...
    <th class="tg-llyw" rowspan="3">内存（GB）</th>
    <th class="tg-llyw" rowspan="3">适用场景</th>
    <th class="tg-llyw" colspan="12">预付费（元/个/小时）</th>
  </tr>
  <tr>
    <td class="tg-llyw" colspan="2">北京/上海/广州</td>
    <td class="tg-llyw" colspan="2">成都</td>
