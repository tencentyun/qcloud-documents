...
## 费用计算示例 
### 包年包月模式费用计算
用户在广州二区，购买了一个白金版的 ES 集群，集群的节点规格是2核4GB，集群总的存储量要求1.5TB SSD 云硬盘，所以选择了3个节点，单节点磁盘是500GB，购买时长是1个月，用户所需支付的费用计算如下：
- 节点2核4GB：306元/月
- SSD 云硬盘500G：1.1元/GB/月 * 500 = 550元/月
- 节点个数：3

总的费用为：（306 + 550）* 3 = 2568元/月
