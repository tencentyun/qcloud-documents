...
<table>
<tr>
<td width=100 colspan="3">节点机型</td>
<td colspan="13">标准型 S1</td>
</tr>
<tr>
<td width=100 colspan="3">节点规格</td>
        <td >ES.S1.SMALL2</td>
				<td >ES.S1.SMALL2</td>
				<td >ES.S1.SMALL2</td>
				<td >ES.S1.SMALL2</td>
		...
		<tr>
    	<td width=100 colspan="3">CPU</td>
        <td width=300>标准型 SA2</td>
    </tr>
			<tr>
    	<td width=100 colspan="3">内存（GB）</td>
        <td width=300>标准型 SA2</td>
    </tr>
			<tr>
    	<td width=100 colspan="3">适用场景</td>
        <td width=300>标准型 SA2</td>
    </tr>
    <tr>
    	<td rowspan="26">	预付费（元/个/月）</td>
        <td rowspan="2">北京/上海/广州/南京</td>
        <td>开源版/基础版</td>
        <td>0110</td>
    </tr>
    <tr>
