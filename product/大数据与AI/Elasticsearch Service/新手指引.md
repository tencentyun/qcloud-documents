...
**3.3 访问集群**
集群创建成功后，即可开始访问集群，访问集群需要您先进行登录认证，详情可参考 [ES 集群用户登录认证](https://cloud.tencent.com/document/product/845/42868)。认证完后即可访问集群，访问集群有三种方式：[通过 API 访问集群](https://cloud.tencent.com/document/product/845/19540)、[通过客户端访问集群](https://cloud.tencent.com/document/product/845/19538)、[通过 Kibana 访问集群](https://cloud.tencent.com/document/product/845/19541)。
...
| 了解集群变配的基本概念和变配场景的原理，扩容 ES 集群把集群调整到合适的规格    | [调整配置](https://cloud.tencent.com/document/product/845/32096) 和 [集群变配建议和原理介绍](https://cloud.tencent.com/document/product/845/43615)  |      
...
| 从低版本到高版本升级，及升级高级特性     |      [升级 ES 集群](https://cloud.tencent.com/document/product/845/36107) 和 [ES 版本升级检查](https://cloud.tencent.com/document/product/845/36106) |
...
### 6.2 其他问题
- [腾讯云 ES 自研熔断器的熔断机制是什么？](https://cloud.tencent.com/document/product/845/35547#.E8.85.BE.E8.AE.AF.E4.BA.91-es-.E8.87.AA.E7.A0.94.E7.86.94.E6.96.AD.E5.99.A8.E7.9A.84.E7.86.94.E6.96.AD.E6.9C.BA.E5.88.B6.E6.98.AF.E4.BB.80.E4.B9.88.EF.BC.9F)
- [常用清理内存的方法是什么？](https://cloud.tencent.com/document/product/845/35547#.E5.B8.B8.E7.94.A8.E6.B8.85.E7.90.86.E5.86.85.E5.AD.98.E7.9A.84.E6.96.B9.E6.B3.95.E6.98.AF.E4.BB.80.E4.B9.88.EF.BC.9F)
- [出现写入拒绝（Bulk Reject）问题如何解决？](https://cloud.tencent.com/document/product/845/33969)
- [磁盘 readonly 的产生原因和解决办法是什么？](https://cloud.tencent.com/document/product/845/35546)
