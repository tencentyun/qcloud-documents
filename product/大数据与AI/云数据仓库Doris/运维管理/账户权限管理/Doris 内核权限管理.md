...
## 更多帮助
关于权限管理使用的更多详细语法及最佳实践，请参阅 [GRANTS](https://doris.apache.org/zh-CN/docs/dev/sql-manual/sql-reference/Account-Management-Statements/GRANT?_highlight=grants) 命令手册，您也可以在 MySql 客户端命令行下输入 `HELP GRANTS` 获取更多帮助信息。
