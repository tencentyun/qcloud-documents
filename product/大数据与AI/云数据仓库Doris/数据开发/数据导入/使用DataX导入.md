...
3. 创建 datax 脚本`import_t_test.json`
```
{
    "job": {
        "setting": {
...
4. 执行 datax 任务：python datax.py  import_t_test.json。具体用法参考 [datax 官网](https://github.com/alibaba/DataX/blob/master/userGuid.md)。
