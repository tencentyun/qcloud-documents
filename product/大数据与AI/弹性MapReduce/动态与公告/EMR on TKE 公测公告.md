腾讯云弹性 MapReduce 正式推出 EMR on TKE 容器版集群服务，将大数据服务组件与容器融合的型部署方式，提供灵活部署、操作高效、资源复用高效、高安全性及低成本。EMR on TKE 支持 Spark、Hive、Trino 等多种大数据处理引擎服务，满足用户不同场景的需求服务选择，实现更加灵活的数据处理。
