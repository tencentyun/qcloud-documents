## 功能介绍
日志功能提供组件的运行日志采集、搜索及导出功能，支持当前集群核心服务日志和节点系统日志进行关键词搜索，可以在不登录节点的情况下快速查看服务关键日志。

## 操作步骤
1. 登录 [EMR 控制台](https://console.cloud.tencent.com/emr)，在集群列表中单击对应的集群 **ID/名称**进入集群详情页。
2. 在集群详情页中选择**集群监控 > 日志**可根据当前集群、日志文件、节点 IP 和时间范围条件过滤，查看日志内容。
![](https://qcloudimg.tencent-cloud.cn/raw/5c9cb0ae77d7e3cb0a7fbfd2f506839e.png)
或者在集群详情页中选择**集群服务>组件卡片>角色管理**，查看角色列表，选择**某一节点IP**单击跳转，进入节点监控指标展示页，单击**角色日志**，可跳转日志搜索页面。
![](https://qcloudimg.tencent-cloud.cn/raw/c79210158d2829453ff19996870491db.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/7c4c947c1e4c945376d7ab602def3093.png)
4. 支持筛选日志结果和源日志导出，导出日志可下载到本地。
![](https://qcloudimg.tencent-cloud.cn/raw/222f3526d77f357bc4b14f4501beedbc.png)
...
<tr>
<td >HS2Audit</td>
<td >	/data/emr/hive/logs/hadoop_hive_server2_audit</td>
<td >HiveServer2 的审计日志</td>			
</tr>
<tr>
<td >HMSAudit</td>
<td >	/data/emr/hive/logs/hadoop-hivemetastore</td>
<td >HiveMetaStore 的审计日志</td>			
<tr>
...
<td >Kyuubi</td>
<td >KyuubiServer</td>
<td >/data/emr/kyuubi/logs/kyuubi.log <br>/data/emr/kyuubi/logs/kyuubi-hadoop-org.apache.kyuubi.server.KyuubiServer-hostIp.out </td>
<td >KyuubiServer 的运行时日志</td>
</tr>
<tr>
<td rowspan=2>Trino</td>
<td >Coordinator</td>
<td >/data/emr/trino/logs/coordinator.log</td>
<td >Coordinator 的运行时日志</td>
</tr>
<tr><td >Worker</td>
<td >/data/emr/trino/logs/worker.log</td>
<td >Worker 的运行时日志</td>
</tr>
<tr>
<td rowspan=4>StarRocks</td>
<td >FE</td>
<td >/data/emr/starrocks/fe/log/fe.log</td>
<td >FE 的运行时日志</td>
</tr>
<tr><td >BE</td>
<td >/data/emr/starrocks/be/log/be.INFO</td>
<td >BE 的运行时日志</td>
</tr>
<tr><td >Broker</td>
<td >/data/emr/starrocks/broker/log/apache_hdfs_broker.log</td>
<td >Broker 的运行时日志</td>
</tr>
<tr><td >CN</td>
<td >/data/emr/starrocks/be/log/cn.INFO</td>
<td >CN 的运行时日志</td>
</tr>
</table>
