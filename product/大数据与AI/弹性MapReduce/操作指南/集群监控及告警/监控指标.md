...
| ----------------- | ---- | ------------------ |
| Read(vdb)         | MB/s | 磁盘读速率         |
| Write(vdb)        | MB/s | 磁盘写速率         |
| Read(vdb)         | 次/s | 读操作 QPS          |
| Write(vdb)        | 次/s | 写操作 QPS          |
| Merge-Read(vdb)   | 次/s | 合并读操作 QPS      |
| Merge-Write(vdb)  | 次/s | 合并写操作 QPS      |
| UTIL_PERCENT(vdb) | %    | 磁盘繁忙程度       |
| Free(vdb)         | GB   | 磁盘剩余空间       |
| Used(vdb)         | GB   | 磁盘已使用空间     |
| Total(vdb)        | GB   | 磁盘总空间         |
| UsedPercent(vdb)  | %    | 磁盘使用率         |
| IFree(vdb)        | 个   | 磁盘剩余 INODES 数量 |
| ITotal(vdb)       | 个   | 磁盘 INODES 总数量   |
| IUsedPercent(vdb) | %    | 磁盘 INODES 使用率   |
...
| BytesWrittenBM                          | Bytes/s         | 写入 DN 的字节速率                           |
| BytesReadBM                             | Bytes/s         | 读取 DN 的字节速率                           |
| RemoteBytesReadBM                       | Bytes/s         | 远程客户端读取字节速率                     |
| RemoteBytesWrittenBM                    | Bytes/s         | 远程客户端写入字节速率                     |
