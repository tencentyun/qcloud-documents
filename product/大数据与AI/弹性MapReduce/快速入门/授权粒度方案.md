...
![](https://qcloudimg.tencent-cloud.cn/raw/0c4e21e1d0185b1e788ca36caaa4b5e5.png)
...
### 2. 子账号赋权并验证
- 在用户列表页面找到要赋权的子用户，单击右侧的**授权**按钮；新建子用户详细操作请参见 [新建子用户](https://cloud.tencent.com/document/product/598/13674)。
