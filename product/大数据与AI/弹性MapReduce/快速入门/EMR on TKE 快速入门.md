...
## 创建集群
登录 [EMR 控制台](https://console.cloud.tencent.com/emr)，在 EMR on TKE 集群列表页单击**创建集群**，在购买页面完成相关配置；当集群状态显示为运行中时，表示集群创建成功。详细配置项及其说明请参见 [创建集群](https://cloud.tencent.com/document/product/589/93159)。
