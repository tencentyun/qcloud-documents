...
**3.2 选购 EMR 集群**
在使用腾讯云 EMR 之前，您需要注册腾讯云账号，然后在 [官网产品介绍页](https://buy.cloud.tencent.com/emr) 单击**立即选购**创建集群，创建集群可参考 [创建 EMR 集群](https://cloud.tencent.com/document/product/589/10981)。
**3.3 角色授权**
