...
EMR 代理了 Presto 原生 Web UI，可以直接在 EMR 控制台查看。登录 [EMR 控制台](https://console.cloud.tencent.com/emr)，单击**集群实例 ID**，进入实例管理页面。单击左侧菜单栏**集群服务**，即可看到 WebUI 地址页面快捷入口，单击 Presto 的入口即可。登录用户名为 root，密码为创建集群时设置的密码。如下图：
![](https://qcloudimg.tencent-cloud.cn/raw/8ab8e049f2535015a170f22a40951f66.png)
