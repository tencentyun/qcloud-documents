...
| 组件名称	| EMR-V3.4.0| EMR-V3.3.0	| EMR-V 3.2.1	|  EMR-V 3.1.0	| 
| :------------------------- | :---------- | :---------- | :---------- | :---------- | 
| 发布时间	| 2022.04|  2021.09	| 2021.07	| 2020.12	| 
| hdfs（必选）	| 3.2.2	|3.2.2	| 3.2.2	| 	3.1.2	| 
| yarn（必选）	| 3.2.2	|3.2.2	| 3.2.2	| 3.1.2	| 
| zookeeper（必选组件）	| 3.6.3	| 3.6.1	| 3.6.1	| 3.6.1	| 
...
| kerberos（仅创建时支持选择）	| 1.15.1	| 1.15.1	| 1.51.1	| 	1.15.1	| 
| ganglia	| 3.7.2|3.7.2| 	-|  -| 	
