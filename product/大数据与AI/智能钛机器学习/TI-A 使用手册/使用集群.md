...
要完成私有集群的配置，需要完成TI-A日志配置与CCS私有集群配置。

#### 私有集群配置

1. 上导航栏 容器服务--日志--新建一个日志收集规则

![](https://main.qcloudimg.com/raw/3f59ecb6b0a9cbb773553cdab334e7a9.png)

2. 填写日志收集规则表单。填写日志收集规则名称与集群地区信息以及集群id，消费类型选择日志服务CLS，并选择创建好的日志集和服务实例。 点击完成。

![](https://main.qcloudimg.com/raw/18d0d91262703b518f10dad5b546c7a9.png)

#### 私有集群日志配置

1. 打开[腾讯云控制台](https://console.cloud.tencent.com)，点击 云产品--大数据应用服务--日志服务。
...
3. 填写日志集名称、保存时间并配置日志主题名称，点击确定完成创建。

![](https://main.qcloudimg.com/raw/4ab6124269f05dce741ae440fc0cc5d0.png)

4. 查看日志基本信息：日志集管理--查看--日志主题ID。复制并保存日志主题ID、所属日志集ID。
...
![](https://main.qcloudimg.com/raw/43b09f114b5294b4a5b97a8ff23ffe70.png)
   ...
   发送邮件至zzoeyzhang @tencent.com,邮件格式如下：

   ​       邮件标题：【TIA日志配置】

   ​       邮件内容包含：1. 日志主题ID  2.  所属日志集ID  3.  账号ID   4. APPID

   ​       （右上角用户账号--点击账号信息，获取账号ID与APPID）

![](https://main.qcloudimg.com/raw/1dbe898781bf0cf4af2df154e96d35b8.png)

后台配置完成后发送邮件进行通知， 完成TI-A私有集群日志配置。