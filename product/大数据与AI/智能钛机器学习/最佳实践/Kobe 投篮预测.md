...
目标 COS 路径本为自动生成，无需修改，但支持用户自定义修改，如此处修改为`${cos}/kobe_predict/`
 注意：请务必复制修改此处“目标 COS 路径”，否则后续运行系统会报找不到文件的错误 
...
3. 填写参数：
 - 程序脚本：上传文件 `data_transformation.py`详情请见上文【案例相关材料】
...
3. 填写参数：
 - 程序脚本：上传文件 `feature_selection.py`详情请见上文【案例相关材料】
 - Python版本：选择 Python 3.5
 - 其余参数均可默认
...
3. 填写参数：
 - 程序脚本：上传文件 `classifier.py`详情请见上文【案例相关材料】
 - Python版本：选择 `Python 3.5`
 - 其余参数均可默认
