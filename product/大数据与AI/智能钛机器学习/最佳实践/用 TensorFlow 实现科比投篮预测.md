...
#### 一. 上传数据
本案例通过本地数据节点上传所需数据： 
1. 在 [智能钛机器学习平台控制台](https://console.cloud.tencent.com/tione/project/list) 的左侧导航栏，选择【输入】>【数据源】>【 本地数据】，拖入画布中 。
...
1. 在 [智能钛机器学习平台控制台](https://console.cloud.tencent.com/tione/project/list) 的左侧导航栏，选择【框架】>【深度学习】>【TensorFlow】。 
