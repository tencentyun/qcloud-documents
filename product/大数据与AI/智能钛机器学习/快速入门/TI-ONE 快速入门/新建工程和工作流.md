开通服务之后，您将进入到智能钛机器学习平控制台界面。搭建工作流之前，您需要完成工程和工作流窗口的新建。
## 操作步骤
...
![](https://main.qcloudimg.com/raw/498cfbafa2d8d34a3dee164b7e7dac68.png)
3. 单击 **COS Bucket** 输入框后的【获取】，在下拉列表处选择 Bucket 名称。
   值得注意的是，COS Bucket建议选择与平台处于**相同区域**的bucket，如图，平台地区处于**重庆**，选择同处于**重庆**地区的bucket，计算效率和通信效率会相对较高。
