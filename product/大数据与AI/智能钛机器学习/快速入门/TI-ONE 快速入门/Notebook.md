## 操作背景
- Notebook 是智能钛机器学习平台为开发者量身打造的灵活的交互式开发工具，您可以在智能钛 Notebook 中完成数据准备、数据预处理、算法调试与模型训练，无需多平台切换，更多详情请见 [Notebook 简介](新链接)。
...
2. 在 Notebook 实例列表页，单击左上角【新增实例】，跳转至创建 Notebook 实例的设置页面。填写说明如下：
   ...
   - **卷大小**：您的笔记本实例的卷大小（以 GB 为单位），最小值为 10GB 且为10的倍数，**注意：**请大于当前硬盘值，最大值为 16384GB (16TB)。
