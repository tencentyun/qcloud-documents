...
- 您可以通过**操作指南**，进一步了解如何 [设置内核](新文档链接)， [安装第三方库](https://cloud.tencent.com/document/product/851/40119)，进行[数据上传与下载](https://cloud.tencent.com/document/product/851/40143) 等。
