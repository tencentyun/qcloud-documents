...
## 操作步骤
1. 登录 [智能钛机器学习平台控制台](https://tio.cloud.tencent.com) ，单击**菜单栏**的【Notebook】，页面将跳转至Notebook的实例列表页面，此页面将展示罗列用户创建的所有的 Notebook 实例。
![](https://main.qcloudimg.com/raw/7bd4db721e004d743fa4981715556524.png)
2. 在Notebook实例列表页，单击左上角【新增】，跳转创建 Notebook 实例的设置页面。
...
3. 单击【新建实例】按钮完成创建，Notebook 列表中将新增一条实例记录，用户在可以对 Notebook 实例进行打开、停止、编辑、删除操作。
- 单击“打开”进入 Notebook 实例内部。
- 单击“停止” Notebook 将会停止运行。
- 单击“编辑”可以对部分配置信息进行修改。
- 单击“删除”，此实例记录销毁。

下一步：[使用内置案例](3. 使用内置案例.md)
