## 操作场景
该任务指导您通过 TI 控制台新建工程和工作流，以进行后续的模型数据训练。

## 操作步骤
### 新建工程
1. 登录 [TI 控制台](https://tio.cloud.tencent.com) ，进入 TI 项目列表页，单击【+新建工程】。
...
3.  单击【COS 一键授权】，页面将跳转至访问管理控制台，单击【同意授权】，即可创建服务预设角色并授予 TI 相关权限。
