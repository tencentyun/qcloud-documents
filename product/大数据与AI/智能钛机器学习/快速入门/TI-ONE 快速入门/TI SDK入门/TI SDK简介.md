...
- 目前您可以在智能钛的 Notebook 内使用 TI SDK，也可以在本地 Python3 环境中使用 TI SDK，单击下载 [TI SDK](https://ti-ap-guangzhou-1300268737.cos.ap-guangzhou.myqcloud.com/%20ti-python-sdk/ti_sdk_python-1.3.0-py3-none-any.whl) 。
