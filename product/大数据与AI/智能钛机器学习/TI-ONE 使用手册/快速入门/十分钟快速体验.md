## 操作场景
随着信息时代的发展，伴随着照相装备和图片采集设备的普及，越来越多的图片数据广泛存在于生产生活的各个角落，如何对海量图片数据进行高效的分类和检索成为了一项新的挑战，本场景中，将通过搭建CNN网络训练分类模型，识别五中花朵类型。
...
- 已完成 [新建工程](https://cloud.tencent.com/document/product/851/17078)
...
2. [新建工程](https://cloud.tencent.com/document/product/851/17078)
3. 准备数据
...
**您需要将这些组件拖入画布中，并根据整体流程图进行连线。（加大字体）**
