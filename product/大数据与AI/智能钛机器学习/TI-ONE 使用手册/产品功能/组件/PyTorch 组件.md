PyTorch 是一个基于 Python 为接口的深度学习框架，允许用户利用 GPU 资源对矩阵进行运算，类似 numpy 中 Array 的运算，更多详细介绍可参考 PyTorch 文档。
...
从左边栏中，组件>深度学习 列表下拖拽出 PyTorch 节点至画布中。
...
以下代码展示了如何在 PyTorch 框架中，调用torch.nn构建一个典型神经网络(nn)。
