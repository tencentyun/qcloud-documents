...
4. secret_id：腾讯云账号 API 密钥 ID，可在腾讯云控制台 [API 秘钥管理](https://console.cloud.tencent.com/cam/capi) 中查看。
5. secret_key：腾讯云账号 API 密钥 KEY，可在腾讯云控制台  [API 秘钥管理](https://console.cloud.tencent.com/cam/capi) 中查看。
