...
## COS 数据集
![](https://main.qcloudimg.com/raw/40521e10df550eadc2544673bde9473f.png)
为下游算法提供输入数据，选择 COS 文件或指定 COS 数据路径即可通过数据流自动传递。
...
4. 上传文件或点选文件夹。详情请参见 [上传对象](https://cloud.tencent.com/document/product/436/6233) 。
