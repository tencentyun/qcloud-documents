参数服务器是一个编程框架，用于分布式并行程序的编写，支持大规模参数的分布式存储和协同。
...
设计一个上述系统时，我们需要解决很多问题，比如频繁访问修改模型参数需要消耗巨大带宽，如何提高并行度，减少同步等待造成的延迟等，在此类场景下，类似 MapReduce 的框架无法满足需求，参数服务器应运而生。Parameter Server 适用于大规模深度学习系统，大规模 Logistic Regression 系统，大规模主题模型，大规模矩阵分解等依赖 SGD 或 L-BFGS 最优化的算法。

## 位置
【框架】>【深度学习】>【TensorFlow PS】
