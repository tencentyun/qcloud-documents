...
> 注意：不同地域的模型服务功能存在差异。 TI-ONE 平台【重庆】地域将于12月31日下线，为避免造成数据的丢失，您可以参照[迁移指南](https://cloud.tencent.com/document/product/851/40091)进行模型服务迁移。TI-ONE 未来会整合云上各种资源，后续将推出模型一键部署到 TI-EMS 等功能，尽情期待。
