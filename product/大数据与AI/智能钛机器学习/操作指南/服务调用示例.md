...
[点击下载模型文件](http://ti-ems-1255502019.cosbj.myqcloud.com/tfserving/inception/1556451336.zip)
**模型运行环境：**tfserving 环境
...
**测试图片：**
[点击下载测试文件](http://ti-ems-1255502019.cosbj.myqcloud.com/tfserving/inception/image.encode
)
