...
- TF-Serving： 业界流行的 TensorFlow Serving 模型服务。
- PMML：通用标准的 PMML 模型服务。
- TensorRT: 支持模型自动优化的Tensorflow模型服务镜像。
- OpenVINO：专门针对CPU优化的模型服务镜像
- Angel：腾讯自研的 Angel 框架 模型服务。
...
## 5. Angel
腾讯自研深度学习框架，TI-EMS支持[Angel](https://github.com/Angel-ML/serving/blob/master/docs/serving_doc.md)类型的模型文件。
