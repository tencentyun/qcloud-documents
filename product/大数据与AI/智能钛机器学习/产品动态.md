...
<table>
  ...
  <tr>      
      ...
      <td>主要优化内容包括：
	      1.算法库支持统一的日志格式
2.目标检测算法 SSD、RFCN、FasterRCNN 支持多卡训练
3.目标检测算法、Deeplab图像分割算法支持可视化预测结果</td>   
      <td>2020-05-31</td>   
	<td>-</td>  
     </tr> 
  <tr>      
       <td>支持可视化查看 Notebook 实例创建进度</td>   
      <td>支持用户在 Notebook 实例创建的等待过程中，点击列表中的“状态”栏按钮查看详细的实例进度记录弹窗</td>   
      <td>2020-05-28</td>   
...
<tr>      
      ...
      <td>1.可查看 CPU 使用核数、使用率；GPU 使用卡数、使用率；内存、内存使用率等资源信息
	  2. 点击日志一键跳转日志详情</td>   
      <td>2020-05-28</td>   
