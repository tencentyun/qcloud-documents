...
在调用文字识别相关接口前，您需要先 [申请开通对应的文字识别服务](https://console.cloud.tencent.com/ai/ocr/general)。
...
![](https://main.qcloudimg.com/raw/1b8d4db374844a476fab415b8d77cede.png)

**2. 填写个人密钥和输入参数中的必填参数。**

![](https://main.qcloudimg.com/raw/cf084592f8be9d3416bfbda4e7abfe24.png)

Region 参数说明： 域名中的地域信息决定访问的是哪个接入点：ocr.ap-shanghai.tencentcloudapi.com 就是要访问上海这个接入点。公共参数 Region 决定的是要访问业务资源所在区，例如 Region = ap - beijing 就是要操作北京区的资源，如果域名中不指定 地域信息则是就近接入 。就近接入可能会存在问题。如果解析不到 IP 会默认到广州地域里面。另外域名地域和公共参数 Region 可以不一致，但是可能会增加耗时。建议域名和公共参数 Region 选择相同的地域：华南地区(广州)，ap-guangzhou。
...
![](https://main.qcloudimg.com/raw/90376934a600dbbfd348bb5d3b4eec7e.png)
...
![](https://main.qcloudimg.com/raw/6b74dba7cb37284f6c642d3714d0252e.png)
...
- SecretId/SecretKey 生成地址：`https://console.cloud.tencent.com/cam/capi`。文字识别相关接口目前仅支持主账号调用，我们会尽快支持子账号调用。
