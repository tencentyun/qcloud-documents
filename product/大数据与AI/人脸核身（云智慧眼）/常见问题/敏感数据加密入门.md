...
- 获取E证通Token：[GetFaceIdToken](https://github.com/TencentCloud/faceid-api-crypto-java/blob/main/crypto-example/src/main/java/com/tencentcloud/faceid/example/GetDetectInfoEnhanced.java)
