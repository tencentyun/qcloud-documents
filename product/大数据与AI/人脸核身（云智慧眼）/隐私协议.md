...
|腾讯图灵盾人脸防攻击 SDK |深圳市腾讯计算机系统有限公司	|安全风控	|实人认证安全风控	|用户在使用第三方开发者应用中与人脸核验/验证相关的功能场景时	|（1）系统设置、系统属性、网络状态、设备型号、操作系统、IP 地址、相机（相机参数、接口）,（2）不同版本还共享以下信息：Android：硬件序列号 OAID、部分存储文件路径；iOS：运营商信息、iDFV|	SDK 集成	|待图灵盾更新最新链接|
...
### 附录：名词解释与定义
本规则中使用的特定词语，具有如下含义：
1. 腾讯云慧眼人脸核身基础版 SDK 产品：指慧眼人脸核身基础版 SDK Android 端和 iOS 端。
1. 2. 第三方SDK：指除腾讯云慧眼人脸核身基础版 SDK 产品外的软件工具包。
...
12. 中国或中国境内：指中华人民共和国大陆地区，仅为本规则之目的，不包含香港特别行政区、澳门特别行政区和台湾地区。
