## 操作场景
该任务指导您在购买人脸核身-云智慧眼服务后，通过 API 3.0 Explorer 在线接口调试页面调用腾讯云慧眼接口，并将该接口对应语言的 SDK 集成到项目。

## 前提条件
在调用人脸核身接口前，您需要先 [申请开通腾讯云慧眼服务](https://cloud.tencent.com/apply/p/shcgszvmppc)，并通过审核。
