...
**1.后付费**
6月22日之前开通人脸核身的用户，后付费计费标签及计费方式不变，详细参考本文中的计费标签逻辑。
6月22日之后开通人脸核身的用户，后付费计费标签参考 [计费概述](https://cloud.tencent.com/document/product/1007/56803) 中描述的计费标签。
![](https://main.qcloudimg.com/raw/b470b1fd4340b0c7348df7ee1a65f3ca.png)

**2.预付费**
所有开通人脸核身的用户的预付费计费标签，自2021年6月22日起统一遵循 [计费概述](https://cloud.tencent.com/document/product/1007/56803) 中描述的计费标签。
...
人脸核身接入渠道付费方式说明如下，若您想了解详细定价信息请查阅 [价格说明](https://cloud.tencent.com/document/product/1007/51350) 文档。
    ...
    <tr>
        ...
        <td rowspan =2>
            <li><a href="https://cloud.tencent.com/document/product/1007/42656">微信原生 H5</a></li><li><a href="https://cloud.tencent.com/document/product/1007/31071">微信小程序</a></li>
				...
				<td>跟权威库比对</td>
			 <td>活体人脸核身</td>
			 	<td>增强版人脸核身(权威库)-微信xxx资源包</td>        
    </tr>
		   <tr>
			 <td>跟上传照片比对</td>
			 <td>活体人脸比对</td>
			 <td>增强版人脸核身(自传照片)-微信xxx资源包</td> 
			  </tr>
    <tr>
        <td rowspan =2>
				...
				<td>跟权威库比对</td>
			 <td>活体人脸核身</td>
			 	<td>基础版版人脸核身(权威库)-xxx资源包</td>        
    </tr>
		   <tr>
			 <td>跟上传照片比对</td>
			 <td>活体人脸比对</td>
			 <td>基础版版人脸核身(自传照片)-xxx资源包</td> 
			  </tr>
			   <tr>
        ...
        <th>后付费计费标签</th>
			<th>预付费计费标签</th>
			 ...
			 <td rowspan =4>身份证信息核验</td>
			 	<td  rowspan =4>身份证信息核验-xxx次资源包</td> 
			  </tr>
				<tr>
	...
	<tr>
		...
		<td><a href="https://cloud.tencent.com/document/product/1007/51441">微信实名认证授权 API</a></td>
			 ...
			 <td rowspan =3>银行卡信息核验</td>
			 	<td rowspan =3>银行卡信息核验-xxx次资源包</td> 
			  </tr>
				 <tr>
			 ...
			 <td  rowspan =2>手机号信息核验-xxx次资源包</td>
			  </tr>
				<tr>
