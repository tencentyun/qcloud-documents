...
- **后付费（按量月结）**
后付费方式是腾讯云慧眼人脸核身服务默认的计费方式，根据您使用腾讯云慧眼人脸核身相关产品产生的调用量进行计费，当月1-5号为您推送上个自然月账单并进行扣费结算。 
- **预付费（资源包）**
资源包是腾讯云慧眼人脸核身服务针对不同的计费项推出的优惠套餐，您可以通过购买不同的资源包，抵扣使用腾讯云慧眼人脸核身相关产品产生的计费调用量。相较于按量计费方式，资源包具有较高的折扣优惠。
腾讯云慧眼人脸核身的预付费资源包支持多种规格，有效期均为1年，1年内若资源包次数未使用完，则过期作废；预付费资源包使用后不支持剩余次数冻结，若购买后未使用，支持7天内无理由退款。

## 接入渠道与计费标签
慧眼人脸核身提供了丰富的接入渠道，不同的接入渠道对应的计费标签如下，若您想了解人脸核身服务各个子产品的详细定价信息，请查阅 [价格说明](https://cloud.tencent.com/document/product/1007/56804) 文档。

### 增强版人脸核身
增强版人脸核身在基础版人脸核身的功能上，增加了实时认证风险检测等安全能力，防攻击能力更强。增强版人脸核身接入渠道与计费标签对应关系说明如下，若您想了解详细定价信息请查阅 [价格说明](https://cloud.tencent.com/document/product/1007/56804) 文档。
        ...
        <td rowspan =2>
		   ...
		   <tr>
			 ...
			 <td>后付费月结、预付费资源包</td> 
			   ...
			   <tr>
                   <td rowspan =2><a href="https://cloud.tencent.com/document/product/1007/35866">App SDK</a>
				</td>
				<td>跟权威库比对</td>
...
提供集成身份证 OCR、活体检测、与库源人脸比对等一系列功能的人脸核身 SaaS 服务以及客户自传视频/照片做核身的 API 能力。基础版人脸核身接入渠道与计费标签对应关系说明如下，若您想了解详细定价信息请查阅 [价格说明](#新增文档) 文档。
...
实名信息核验提供身份证、银行卡、手机号等要素信息核验服务，实名信息核验各 API 接口与计费标签对应关系说明如下，若您想了解详细定价信息请查阅 [价格说明](#新增文档) 文档。
...
E 证通是基于腾讯云人脸核身、文字识别 OCR和人脸比对技术，向用户提供权威、合规的身份信息核验及复核服务的小程序服务，E 证通服务与计费标签对应关系说明如下，若您想了解详细定价信息请查阅 [价格说明](#新增文档) 文档。
