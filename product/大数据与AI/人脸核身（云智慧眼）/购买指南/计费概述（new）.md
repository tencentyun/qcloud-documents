...
|   计费方式|  描述  | 
|-----------|-------|
|后付费（按量月结）|后付费方式是腾讯云慧眼人脸核身服务默认的计费方式，根据您使用腾讯云慧眼人脸核身相关产品产生的调用量进行计费，当月1-5号为您推送上个自然月账单并进行扣费结算。 |
|预付费（资源包）|资源包是腾讯云慧眼人脸核身服务针对不同的计费项推出的优惠套餐，您可以通过购买不同的资源包，抵扣使用腾讯云慧眼人脸核身相关产品产生的计费调用量。|
