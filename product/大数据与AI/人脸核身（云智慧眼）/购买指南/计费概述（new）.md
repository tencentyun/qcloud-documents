...
|预付费|<li>您可以通过购买资源包，抵扣使用人脸核身相关产品产生的计费调用量。<li>资源包有效期均为1年，1年内若资源包次数未使用完，则过期作废；<li>预付费资源包使用后不支持剩余次数冻结，若购买后未使用，支持7天内无理由[退款](https://cloud.tencent.com/document/product/1007/31008)。|[购资源包](https://buy.cloud.tencent.com/iai_faceid)|
