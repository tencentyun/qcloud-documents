...
<tr><td>user_id</td><td >当前使用用户的唯一标识，需合作伙伴自行定义<br/>注意：合作伙伴必须保证 user_id 的全局唯一性，不要带有特殊字符</td><td>String</td><td>32</td><td>是</td></tr>
</tbody></table>
- **请求示例：**
```
https://kyc.qcloud.com/api/oauth2/api_ticket?app_id=xxx&access_token=xxx&type=NONCE&version=1.0.0&user_id=xxx
```
