...
>! 接入前务必注意：请参见 [意愿核身 H5 接入步骤](https://cloud.tencent.com/document/product/1007/77303)  进行接入，如是 App 调用，务必按照 [App 调用 H5 兼容性配置](https://cloud.tencent.com/document/product/1007/77304) 进行兼容性适配，否则将影响正常使用。
>
## 兼容性说明
