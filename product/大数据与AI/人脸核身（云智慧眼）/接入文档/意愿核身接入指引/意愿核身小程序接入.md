...
>!由于意愿核身的开启还需要线下配置，完成业务流程申请后，请 [联系我们](https://cloud.tencent.com/document/product/1007/56130)，并将腾讯云账号的 Appid 、账号 ID 和已经审核通过的 RuleId 提供给我们。
...
### 3.1. 开发准备
- **下载 SDK**
下载 [意愿核身小程序 SDK](https://faceid-verify-temp-1254418846.cos.ap-chengdu.myqcloud.com/asr/cloud-faceid-micro-asr-sdk-release.zip)，并在小程序代码中引入，调用 init 方法进行初始化。
- **安装 SDK**
...
3. 下载并更新 SDK 为  [意愿核身小程序 SDK](https://faceid-verify-temp-1254418846.cos.ap-chengdu.myqcloud.com/asr/cloud-faceid-micro-asr-sdk-release.zip)。
