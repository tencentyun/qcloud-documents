...
## 意愿核身识别结果查询接口
### 请求
**请求 URL：**`https://miniprogram-kyc.tencentcloudapi.com/api/server/getWillFaceResult?app_id=IDAxxxxxx&nonce=xxxxx&version=1.0.0&order_no=xxxxx&sign=xxxxx`
**请求方法：POST**
**请求参数：**
...
**请求示例：**
```
https://miniprogram-kyc.tencentcloudapi.com/api/server/getWillFaceResult?app_id=IDAxxxxxx&nonce=xxxxx&version=1.0.0&order_no=xxxx&sign=xxxxx
```
