...
|willContentList	|意愿核身过程中播报文本/问题、用户朗读/回答的文本，当前支持一个播报文本+回答文本	|List	|	否|
|willContentList.id	|从下标0开始|	string|32|否|
|willContentList.question	|系统播报问题文本/问题<br>长度为60个字以内<br>示例：“ 您好，为确保您本人操作，此次签约全程录音录像。请问您本次业务是本人自愿办理吗？请回答：我确认 ”	|string|32|否|
|willContentList.answer|	用户朗读/回答的文本，用于识别用户朗读/回答的语音与文本是否一致。长度为10个字以内<br>支持多个文本作为识别内容，文本之间用 “&Iota;”符号分割。<br>示例：“我确认”	|string|32|否|
