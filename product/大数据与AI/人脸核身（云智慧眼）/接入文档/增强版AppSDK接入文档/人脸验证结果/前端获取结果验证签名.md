为了确保前端 SDK 和 H5 返回的结果真实性且未被篡改，合作伙伴服务端可以验证结果，我们提供**前端获取结果验证签名**和 **[服务端验证结果](https://cloud.tencent.com/document/product/1007/57638)** 两种结果验证方式，合作伙伴可以根据需求自行选择。
前端获取结果验证签名方式用于：
...
| api ticket | 合作伙伴服务端缓存的 tikcet，请注意是 SIGN 类型    | 获取方式请参见 [获取 SIGN ticket](https://cloud.tencent.com/document/product/1007/57613) |
