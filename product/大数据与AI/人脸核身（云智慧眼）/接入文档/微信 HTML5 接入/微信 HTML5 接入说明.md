...
微信 H5 接入模式还区分了微信原生 H5 和微信 H5 普通模式，两者区别如下：

**1. 用户体验**
- 微信原生 H5 是基于微信原生的体验，在手机端微信内实时验证，无需录制视频，用户体验好。
- 微信 H5 普通模式在验证过程中需要录制视频，在后台验证。

**2. 主体行业限制**
- 微信原生 H5 有明确的主体行业限制，在控制台申请 RuleId 时需上传对应的行业资质。所以在接入微信原生 H5 前，请确认公众号的主体和类目是否符合范围，并准备好对应的资质文件，详情可查阅 [微信 HTML5 及小程序资质文件列表](https://cloud.tencent.com/document/product/1007/42684)。
- 微信 H5 普通模式对行业类目没有限制。
