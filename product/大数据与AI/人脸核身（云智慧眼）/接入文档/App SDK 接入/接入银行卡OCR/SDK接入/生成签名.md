...
|version	|参数值：1.0.0	|-|
| ticket | 合作伙伴服务端实时获取的 ticket，注意是 NONCE 类型 | 获取方式请参见 [获取 NONCE ticket](https://cloud.tencent.com/document/product/1007/37306)（所用的 userId 参数值需要和 SDK 里面定义的 userId 保持一致） |
