...
|address	| String	| 身份证识别结果：人像面<br>如果用户没有正确上传身份证反面，则没有该字段|
|authority	| String	| 身份证识别结果：国徽面<br>如果用户没有正确上传身份证反面，则没有该字段|
|validDate	| String	| 身份证识别结果：国徽面<br>如果用户没有正确上传身份证反面，则没有该字段|
