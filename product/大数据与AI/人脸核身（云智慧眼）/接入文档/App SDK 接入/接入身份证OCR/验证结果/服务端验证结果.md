...
|参数 | 说明 | 来源|
|----- | ----- | ------|
|AppId|	请添加小助手微信 faceid001，进行线下对接获取  | 腾讯云线下对接分配|
...
|frontWarnCode | String | 人像面告警码，在身份证有遮挡、缺失、信息不全时会返回告警码；当 frontCode 为0时才会出现告警码，告警码的含义请参考 [错误码](https://cloud.tencent.com/document/product/1007/31082)|
|backWarnCode | String | 国徽面告警码，在身份证有遮挡、缺失、信息不全时会返回告警码；当 backCode 为0时才会出现告警码，告警码的含义请参考 [错误码](https://cloud.tencent.com/document/product/1007/31082)|
|operateTime | String | 做 OCR 的操作时间|
|frontMultiWarning | String | 正面多重告警码，含义请参考 [错误码](https://cloud.tencent.com/document/product/1007/31082)|
|backMultiWarning | String | 反面多重告警码，含义请参考 [错误码](https://cloud.tencent.com/document/product/1007/31082)|
...
>- 对于身份证 OCR 识别有部分遮挡、缺失、信息不全的情况，请参考 frontWarnCode 和 backWarnCode，详情请参见 [错误码](https://cloud.tencent.com/document/product/1007/31082)。
