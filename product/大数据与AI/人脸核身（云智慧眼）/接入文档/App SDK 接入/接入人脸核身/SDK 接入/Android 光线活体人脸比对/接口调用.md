...
| clientIp          | 用户 IP 信息3.0.10版本后无需上送该字段<br/>格式：“IP=xxx.xxx.xxx.xxx”<br/>示例：“IP=58.60.124.0”| String                | 30                 | 是       |
| gps               | 用户 GPS 信息3.0.10版本后无需上送该字段<br/>格式：“lgt=xxx;lat=xxx”<br/>示例：“lgt=22.5044;lat=113.9537”| String                | 30                 | 是       |
