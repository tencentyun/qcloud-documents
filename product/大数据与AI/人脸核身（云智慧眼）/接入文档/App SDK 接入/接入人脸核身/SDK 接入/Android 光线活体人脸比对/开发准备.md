...
## CPU 平台设置
目前 SDK 只支持 armeabi，armeabi-v7a，armeabi-v8a 平台，为了防止在其他 CPU 平台上 SDK crash，建议在您的 App 的 build.gradle 里加上 abiFilter，如下图中代码所示，您也可以根据您的 App CPU 平台情况进行相应的设置和过滤：
