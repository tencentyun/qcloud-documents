人脸核身 SDK（增强版）全面升级活体防攻击能力。在原光线活体、动作活体、数字活体以及静默活体检测的基础上，增加实时检测当前设备的风险等级能力，有效拦截多种类型的过脸攻击，针对通过摄像头劫持、恶意注入等攻击方式，拦截准确率可达到99.9%。欢迎升级体验。
...
## 合作方后台上送身份信息 
### 请求
- **请求 URL：**https://idasc.webank.com/api/server/getfaceid?orderNo=xxx
...
<tr><td>sourcePhotoStr	</td><td>比对源照片，注意：原始图片不能超过500k，且必须为 JPG 或 PNG 格式。
