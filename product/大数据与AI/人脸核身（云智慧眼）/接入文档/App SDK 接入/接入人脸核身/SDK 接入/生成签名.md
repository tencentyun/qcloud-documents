...
| version  | 参数值为：1.0.0                                |     -                                                         |
| ticket   | 合作伙伴服务端缓存的 ticket，注意是 NONCE 类型 | 获取方式请参见 [获取 NONCE ticket](https://cloud.tencent.com/document/product/1007/37306)（所用的 userId 参数值需要与 SDK 里面定义 userId 值保持一致） |
...
<tr><td>webankAppId</td><td>	请添加小助手微信 faceid001，进行线下对接获取</td><td>	String	</td><td>腾讯云线下对接决定</td><td>	是</td></tr>
...
```
{
    ...
    "result": {
        ...
        "orderNo": "合作方订单号",
        "faceId": "175177e03bc53dxxxxxxxxx18c731488",
        "success": false
    },
    "transactionTime": "20201019110305"
}
