...
## 生成签名
### 准备步骤
-  [下载 SDK](https://console.cloud.tencent.com/faceid/access/wbversion?sdkType=baseSdk)，请联系您的产品对接专员获取密码。
...
<br>参数有值：使用合作伙伴提供的比对源照片进行比对，必须注意是正脸可信照片，照片质量由合作方保证<br>参数为空 ：根据身份证号 + 姓名使用权威数据源比对</td><td>	BASE64String	</td><td>1048576</td><td>	否，非必填<br>请使用标准的图片转 base64方法，base64编码不可包含换行符，不需要加前缀</td></tr>
