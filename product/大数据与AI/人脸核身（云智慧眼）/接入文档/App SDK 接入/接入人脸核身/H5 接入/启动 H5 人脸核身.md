...
- 请合作方确保 NONCE ticket 已经正常获取，获取方式请参见 [NONCE ticket 获取](https://cloud.tencent.com/document/product/1007/37306) 。
...
| api ticket  | 合作伙伴服务端缓存的 tikcet，注意是 NONCE 类型 | 获取方式请参见 [NONCE ticket 获取](https://cloud.tencent.com/document/product/1007/37306)（所用的 userId 与接口里定义的 userId 参数值保持一致） |
...
<tr><td>appId001</td><td>appId001</td></tr>
