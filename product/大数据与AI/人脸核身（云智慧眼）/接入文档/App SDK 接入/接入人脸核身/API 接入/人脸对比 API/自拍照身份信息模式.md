...
<tr><td>photoStr</td><td><br/>高清自拍照片<br>注意：图片base64后不能超过20MB，且必须为 JPG 或PNG 格式</td><td>Base64 String</td><td>不超过20MB</td><td>是<br>请使用标准的图片转base64方法，base64编码不可包含换行符，不需要加前缀</td></tr>
</table>
