...
## 自拍照+身份信息模式
- **请求 URL：**https://ida.webank.com/api/paas/easyface?orderNo=xxx
...
<tr><td>photoStr</td><td >高清自拍照片<br/>注意：原始图片不能超过2MB，且必须为 JPG 或 PNG 格式</td><td>Base64 String</td><td>不超过3MB</td><td>是</td></tr>
</table>
