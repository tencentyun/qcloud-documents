...
<tr><td >webankAppId</td><td >请添加小助手微信 faceid001，进行线下对接获取</td><td >String</td><td >腾讯服务分配</td><td >是</td></tr>
...
- **请求示例：**
```
https://idasc.webank.com/api/server/sync?webankAppId=xxx&nonce=xxx&order_no=xxx&version=1.0.0&sign=xxx
```
