...
| version    | 默认值：1.0.0                     |           -                    |
| ticket | 合作伙伴服务端缓存的 ticket，注意是 SIGN 类型 | 获取方式请参见 [获取 SIGN ticket](https://cloud.tencent.com/document/product/1007/37305) |
...
## 人脸核身结果查询接口(升级)
### 请求
- **请求 URL：**`https://kyc.qcloud.com/api/v2/base/queryfacerecord?orderNo=xxx`
