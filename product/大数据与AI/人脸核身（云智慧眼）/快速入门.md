...
## 步骤2：进行企业实名认证
如果您的腾讯云账号已实名，可忽略此步骤，如果您还未进行实名，可查看 [企业认证指引](https://cloud.tencent.com/document/product/378/10496) 进行企业实名认证。
<div style="background-color:#00A4FF; width: 170px; height: 35px; line-height:35px; text-align:center;"><a href="https://console.cloud.tencent.com/developer_quick_auth?auth_type=enterprise" target="_blank"  style="color: white; font-size:16px;">点此进行企业实名认证</a></div>

## 步骤3：申请人脸核身
单击如下链接，按需求正确填写具体业务信息后提交申请，申请即刻通过，无需等待审核。
