腾讯云小钛支持微信公众号、微信小程序、PC 网站、移动网站（App、HTML5）四种方式接入。
...
进入“系统管理 > 机器人管理 > 小程序接入”，点击 “**去微信公众平台绑定授权**” 按钮，使用拥有小程序管理员权限微信扫描二维码，并点击授权即可。绑定成功后可直接在小程序内进行对话体验。
...
- 绑定后，微信公众号原先配置的自动回复可能与客服消息冲突，建议将微信后台的自动回复移至智能客服平台。
- 您的小程序需要有一个[**客服会话按钮**](https://developers.weixin.qq.com/miniprogram/dev/component/contact-button.html)，点击进入微信客服会话
