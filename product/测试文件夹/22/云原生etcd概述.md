腾讯云云原生 etcd 服务目前正在内测中 ，内测阶段 etcd 服务将以白名单形式开放。若需要部署测试生产级业务，请通过腾讯云助手或 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请开通 etcd 服务。
...
etcd 是一个分布式、高可靠的键值存储，可以容忍集群中部分节点故障，只要有一半以上节点存活即可对外提供服务。主要用于元数据存储、服务发现、分布式选举等场景。基于 etcd 提供的 Watch 机制，可以更便捷的实现发布订阅等功能。
