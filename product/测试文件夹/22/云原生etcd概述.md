腾讯云云原生 ETCD 服务目前正在内测中 ，内测阶段服务将以白名单的形式开放。若需要部署测试/生产级业务，请通过腾讯云助手或 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请。
...
ETCD 是一个分布式、高可靠的键值存储，可以容忍集群中部分节点故障，只要有一半以上节点存活即可对外提供服务。主要用于元数据存储，服务发现，分布式选举等场景。基于 ETCD 提供的 Watch 机制，可以很方便的实现发布订阅等功能。
...
ETCD 服务本身不收取费用 ，ETCD 在使用过程中将自动创建的云硬盘、对象存储等产品，相关计费详情请参见对应产品计费模式 [云硬盘价格总览](https://cloud.tencent.com/document/product/213/2255)、[对象存储计费说明](https://cloud.tencent.com/document/product/436/16871)。
