...
etcd 集群除了常见的集群监控指标外，还可通过对接 [云原生监控](https://cloud.tencent.com/document/product/457/54318) 来支持扩展的巡检指标设定，例如，数据一致性巡检、集群健康探测、业务写 QPS 巡检等指标。本文为您介绍如何在控制台为 etcd 集群配置监控和告警。
...
- 若您的 etcd 集群尚未配置监控，在集群列表页的操作栏中，可通过【配置监控】来关联云监控实例。操作如下：
