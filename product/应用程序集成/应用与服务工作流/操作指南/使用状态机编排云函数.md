...
![](https://main.qcloudimg.com/raw/a0c4327fb38812bfe4501a077e344798.png)
4. 您可以通过两种方式调用云函数组件。
（a）弹出窗格中直接调用
在右侧的弹出窗口中，您可以重新命名选择的节点，并设置需要调用的云函数。在本实例中，讲节点命名为“求和”，设置区域为云函数定义的区域（广州），选择对应的函数名称（sum）。
![](https://main.qcloudimg.com/raw/d419e64a913a1669b05ec558c09f735f.png)
（b）通过代码调用
在右侧代码窗的右上方，单击【刷新】代码框中将出现对应组件的代码块。
![](https://main.qcloudimg.com/raw/d59cbf2e33cf75565add3ce72eb201e9.png)
...
5. 单击右上角 【下一步】 ，进入保存界面，输入状态机名称，运行角色选择 【新建角色】 ，类型选择 【标准状态机】 ，单击右上角 【完成】 。
