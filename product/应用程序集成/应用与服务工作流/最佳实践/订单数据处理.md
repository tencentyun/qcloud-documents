...
```
>?Resource 字段格式为"qrn:qcs:asw:{函数所在区域}:{Appid}:sdk:json:qcloud:scf:Invoke/{函数名称}/{函数版本别名}/{函数命名空间}" ，请按照您创建的函数信息修改。更多详情参考 [Task节点](https://cloud.tencent.com/document/product/1272/55658)。
