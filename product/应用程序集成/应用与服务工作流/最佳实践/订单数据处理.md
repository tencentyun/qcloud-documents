...
```
>?Resource 字段格式为"qrn:qcs:asw:{函数所在区域}:{Appid}:sdk:json:qcloud:scf:Invoke/{函数名称}/{函数命名空间}/{函数版本别名}" ，请按照您创建的函数信息修改。更多详情参考 [Task节点](https://cloud.tencent.com/document/product/1272/51544#.3Ca-id.3D.22step8.22.3Etask.3C.2Fa.3E)。
