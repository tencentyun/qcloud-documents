域名续费的目的是延长您已注册域名的有效使用期限。在域名到期前，腾讯云会发出邮件或短信提醒。为保障您的域名能正常运行，您也可以随时进行 [续费操作](console.qcloud.com/domain)。
...
在使用中的云产品栏目内，单击【域名管理】页面，即可看到您购买的所有域名信息列表。
...
完成自动续费设置后，自动续费栏目下会对应变成【已开启】，说明该域名自动续费功能已开启成功。
