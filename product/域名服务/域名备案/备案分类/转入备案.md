...
#### 填写主体信息
1. 根据您在其他服务器商的备案信息，系统会检测出该域名的主体备案号，请您填写对应的主体备案密码。点击可查看 [如何找回备案密码](https://cloud.tencent.com/document/product/243/9584)。
...
2. 若您有多个需办理转入备案的网站，请点击 **继续添加网站** 填写下一个网站的信息。
