...
按提示填写主办单位相关信息和网站相关信息，系统将根据您所填写的证件信息和域名，自动识别您要办理的备案类型。
...
**证件类型**：请根据实际情况进行选择并填写对应的证件号码。注意：此处选填的证件在后续手续中还需使用其扫描件或彩色照片。
