...
#### 1.1 获取证书
Apache文件夹内获得SSL证书文件 1_root_bundle.crt，证书链文件 2_www.domain.com_cert.crt 和私钥文件 3_www.domain.com.key,
...
<VirtualHost www.domain.com:443>
    ...
    SSLEngine on
    SSLCertificateFile /usr/local/apache/conf/1_root_bundle.crt
    SSLCertificateKeyFile /usr/local/apache/conf/3_www.domain.com.key
    SSLCertificateChainFile /usr/local/apache/conf/2_www.domain.com_cert.crt
</VirtualHost>
```
