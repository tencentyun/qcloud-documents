...
### 关联云资源
1. 在 “添加记录” 页面，将 “主机记录” 设置为 internal（`internal.qcloud-example.com`中的 www 叫做主机记录）。
...
4. 在弹出的 “关联云资源” 窗口中，选择云服务器（内网），根据实际需求，勾选需关联的云服务器，单击【确定】。如下图所示：
![](https://main.qcloudimg.com/raw/b96db3dca9eb35f4869d4701395caf90.png)
5. 单击【保存】，记录列表中显示该新添加记录即表示添加成功。如下图所示：
![](https://main.qcloudimg.com/raw/1a71ae59eaab339c7f30009d5ff7fa02.png)


### 测试
现在登录任意一台您的云服务器，试试访问一下 internal.qcloud-example.com ，您也可以在您的任意一台云服务器上执行 dig internal.qcloud-example.com -t A，如果查询到结果中包含 10.1.1.9，10.0.0.6 这两个内网 IP，就表示该内网子域名的解析成功。
