...
1. 登录 [物联网开发平台控制台](https://console.cloud.tencent.com/iotexplorer)，单击【新建项目】。
2. 在新建项目页面，填写项目基本信息，单击【保存】。
...
![](https://main.qcloudimg.com/raw/70bfd014c108d24902d0ca1bfda790f2.png)
...
>  - 新买到的开发板可能没有烧写蓝牙协议栈或烧写的蓝牙协议栈版本不正确，强烈建议按上述步骤烧写一次。

### 抽取例程代码

1. 打开 LLSync SDK 目录 `qcloud_iot_explorer_ble\scripts\code_extract`。
2. 按下“Shift”单击右键选择在此处打开 cmd 窗口，在命令行中执行 `python3 code_extract.py nrf52832`。
3. 在该目录下会生成一个名为 `qcloud-iot-ble-nrf52832` 的文件夹，将该文件夹拷贝至 nrf sdk 的路径下 `nRF5_SDK_15.3.0_59ac345\examples\ble_peripheral`。
