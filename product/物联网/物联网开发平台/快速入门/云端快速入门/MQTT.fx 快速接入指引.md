...
5. 单击【User Credentials】，填写 User Name 和 Password。
 - **User Name**	：MQTT 协议字段，按照物联网通信约束填入：产品 ID + 设备名 + SDKAppID + connid+expiry。创建完产品即可在产品列表页和产品详情页查看 ProductID，如："TO****DS8Gdev001;12010126;E4F3Q;1591948593"，仅替换示例中的产品 ID + 设备名即可，后面的三个参数本身由物联网通信接入 SDK 自动生成，也可由腾讯云物联网平台提供的 [生成小工具](https://iotmarket-1256872341.cos.ap-guangzhou.myqcloud.com/market/772011611/014fc7752c9ef6130dfa408c507da111.zip) 自动生成。
 - **Password**	：Password 必须填写，用户可以使用物联网平台提供的 [生成小工具](https://iotmarket-1256872341.cos.ap-guangzhou.myqcloud.com/market/772011611/014fc7752c9ef6130dfa408c507da111.zip) 自动生成Password，也可以按照文档 [手动生成Password](https://cloud.tencent.com/document/product/634/32546)。
