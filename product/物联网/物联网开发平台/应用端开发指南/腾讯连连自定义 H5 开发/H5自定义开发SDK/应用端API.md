在开发H5面板的过程中，我们需要获取产品信息，设备信息，或者获取设备在线状态，控制设备，这些能力都通过应用端API来提供，完整的API列表可以参考[应用端API](https://cloud.tencent.com/document/product/1081/40772)。H5自定义开发SDK 对调用应用端API的过程进行了封装，从而方便开发者进行调用。
