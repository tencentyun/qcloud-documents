...
我们提供了设备配网 SDK，目前支持 SoftAP、SmartConfig、simpleConfig、AirKiss、BLE-Combo 这五种方式进行设备配网，详细的SDK使用及配网流程参考 [设备配网 SDK](https://cloud.tencent.com/document/product/1081/67489)。
