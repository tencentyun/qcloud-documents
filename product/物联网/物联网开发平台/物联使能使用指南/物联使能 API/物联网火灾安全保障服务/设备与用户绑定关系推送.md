...
| DeviceInfos | Array of [DeviceInfo](https://cloud.tencent.com/document/product/1081/50245#deviceinfo) | 是   | 设备信息列表，支持用户与单个或多个设备的绑定关系             |
...
| Status    | String | 请求结果，成功时返回此字段，返回值为OK                       |
...
content-type: application/json
{
	...
	"DeviceInfos":[{"ProductName":"***","DeviceId":"ProductId/DeviceName","CustomerDeviceNo":"123"}]
}
:::
</dx-codeblock>
