...
| ItemId     | String | 是   | 保单类别 ID，用来表示保单类型，由系统后台配置提供。           |
...
:::  JSON
{
    "Response": {
      "RequestId": "f92406b3-****-4fe8-bc43-45e3d794bb68"
      "URL":"https://www.example.com/path/to/h5homepage?CustomerId=abc&ServiceAppKey=xyz&ItemId=IoTFireInsurance2020&InsuranceType=1"
    }
}
:::
</dx-codeblock>
