...
####   iOS 
  <img src="https://main.qcloudimg.com/raw/86dae2b9dc3eca7a83b1dcb9698028ad.jpg" alt="Picture6_Push_iOSBundleID.png" style="zoom: 100%;" />
	
	#### 	Android
	<img src="https://main.qcloudimg.com/raw/083f16e21deb2765481950ed15997112.jpg" alt="Picture6_Push_iOSBundleID.png" style="zoom: 100%;" />
	
   4. 填写完 BundleID 后，请务必保存好 iOS 或 Android 平台的 AccessID 和 AccessKey，在 SDK 接入工程配置时将会用到，并上传 iOS 平台对应的证书。
#### iOS
  <img src="https://main.qcloudimg.com/raw/a1c1c9073fd10a7fd239862d1ad4144b.jpg" alt="Picture8_Push_Config_ios.png" style="zoom: 65%;" />   
####   Android
  <img src="https://main.qcloudimg.com/raw/3fbefdf17447e95021825915484fba1b.jpg" style="zoom:65%;" />   
   5. 如要接入使用需要购买或申请测试使用。   
