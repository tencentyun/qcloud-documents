本文档为您介绍开源 App 可接入的第三方服务，包括腾讯移动推送（信鸽）、第三方登录（微信登录）和 Firebase 上报 Crash 信息。第三方服务为可选服务，可根据项目需要进行配置使用。
## 接入腾讯移动推送
 <span id="test"></span>
### 步骤1：创建移动推送应用
...
![](https://main.qcloudimg.com/raw/e6ae3220b9ce9ff270530d20c3134817.jpg)
 ...
 ![](https://main.qcloudimg.com/raw/12b344990a5db33e83ae1348fb3de02f.jpg)
...
```
   {
     "WXAccessAppId": "微信开放平台申请并获得的 AppID",
...
```
   {
     LinkAPP_NAME = 
     LinkAPP_WEIXIN_APPID = “微信开放平台申请的appid”
     LinkAPP_BUNDLE_TEAM =
     LinkAPP_BUNDLE_SIGN = 
     LinkAPP_BUNDLE_ID = 
...
2. 按照步骤初始化添加 Firebase SDK。按照平台查看 [firebase 文档](https://firebase.google.com/docs?authuser=0)。
