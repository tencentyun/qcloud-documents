...
| ID            | 设备可控属性 ID，如“power_switch”、“color”        |
| ------------- | ------------------------------------------------ |
...
### 更多功能
账户系统、家庭相关操作、设备控制等详细操作，请参考 SDK Demo 工程 [iOS 版本 LinkSDKDemo](https://github.com/tencentyun/iot-link-ios/tree/master/Source/LinkSDKDemo)/[Android 版本 sdkdemo](https://github.com/tencentyun/iot-link-android/tree/master/sdkdemo)
...
若接入过程中有其他问题，请参考 [App SDK 开发常见问题](https://github.com/tencentyun/iot-link-ios/blob/master/doc/SDK开发/APP%20SDK开发常见问题.md) 
