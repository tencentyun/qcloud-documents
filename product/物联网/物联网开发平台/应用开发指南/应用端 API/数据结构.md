...
|名称|类型|必选|描述|
|---|---|---|---|
|AccessToken|String|是|AccessToken 为调用登陆接口之后获取的 Token|
...
|Attachments|Object of [MessageAttachment](https://cloud.tencent.com/document/product/1081/40780#MessageAttachment)|消息加信息|
...
|ActionParams|Object of [HeartBeatParam](https://cloud.tencent.com/document/product/1081/40780#HeartBeatParam)|是|设备心跳接口入参|
