...
|KGCommand|String|是|子命令，本接口取值：playlist_top|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams_playlist_top](接口请求域名替换#KugouParams_playlist_top)|是|子命令的参数|
...
|Data|Object of [Data_playlist_top](接口请求域名替换#Data_playlist_top)|返回结果|
