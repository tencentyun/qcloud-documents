## 1. 接口描述
接口请求域名： 接口请求域名替换
本接口(device_activation)用于设备激活接口。
...
|KGCommand|String|是|子命令，本接口取值：device_activation|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams](接口请求域名替换#KugouParams)|是|子命令的参数|
...
|Data|Object of [Data](接口请求域名替换#Data)|返回结果|
