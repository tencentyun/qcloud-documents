...
|KGCommand|String|是|子命令，本接口取值：top_song|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams_top_song](接口请求域名替换#KugouParams_top_song)|是|子命令的参数|
...
|Data|Object of [Data_top_song](接口请求域名替换#Data_top_song)|返回结果|
