...
|KGCommand|String|是|子命令，本接口取值：awesome_recommend|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams_awesome_recommend](接口请求域名替换#KugouParams_awesome_recommend)|是|子命令的参数|
...
|Data|Object of [Data_awesome_recommend](接口请求域名替换#Data_awesome_recommend)|返回结果|
