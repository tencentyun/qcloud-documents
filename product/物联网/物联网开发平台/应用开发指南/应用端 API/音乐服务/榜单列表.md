...
|KGCommand|String|是|子命令，本接口取值：top_list|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams_top_list](接口请求域名替换#KugouParams_top_list)|是|子命令的参数|
...
|Data|Object of [Data_top_list](接口请求域名替换#Data_top_list)|返回结果|
