## 1. 接口描述
接口请求域名： 接口请求域名替换
本接口(wechat_appinfocode)用于获取唤起微信参数。
...
|Action|String|是|公共参数，本接口取值：AppKugouDeviceCommand|
|KGCommand|String|是|子命令，本接口取值：wechat_appinfocode|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams_wechat_appinfocode](接口请求域名替换#KugouParams_wechat_appinfocode)|是|子命令的参数|
...
|Data|Object of [Data_wechat_appinfocode](接口请求域名替换#Data_wechat_appinfocode)|返回结果|
...
#### 示例1
   **输入示例**
    ...
    content-type: application/json
   {
     ...
     "Action": "AppKugouDeviceCommand",
     "AccessToken":"8b4a70dd16105f******************18edd4e78a3bb8ec",
     "DeviceId":"LAEG4YJE1A/dev01",
     "KGCommand":"wechat_appinfocode",
     "KugouParams":{...}
   }
