...
|KGCommand|String|是|子命令，本接口取值：singer_list|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams_singer_list](接口请求域名替换#KugouParams_singer_list)|是|子命令的参数|
...
|Data|Object of [Data_singer_list](接口请求域名替换#Data_singer_list)|返回结果|
