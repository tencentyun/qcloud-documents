...
|KGCommand|String|是|子命令，本接口取值：album_info|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams_album_info](接口请求域名替换#KugouParams_album_info)|是|子命令的参数|
...
|Data|Object of [Data_album_info](接口请求域名替换#Data_album_info)|返回结果|
