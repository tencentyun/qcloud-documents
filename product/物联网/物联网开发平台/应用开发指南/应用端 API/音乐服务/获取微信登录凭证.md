## 1. 接口描述
接口请求域名： 接口请求域名替换
本接口(wechat_minipauth)用于获取微信登录凭证。
...
|KGCommand|String|是|子命令，本接口取值：wechat_minipauth|
|DeviceId|String|是|设备Id 由产品ID和设备Name组成|
|KugouParams|Object of [KugouParams_wechat_minipauth](接口请求域名替换#KugouParams_wechat_minipauth)|是|子命令的参数|
...
|Data|Object of [Data_minipauth](接口请求域名替换#Data_minipauth)|返回结果|
