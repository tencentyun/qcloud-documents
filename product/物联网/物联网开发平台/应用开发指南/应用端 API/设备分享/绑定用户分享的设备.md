## 1. 接口描述
接口请求域名： 接口请求域名替换
本接口(AppBindUserShareDevice)用于绑定用户分享的设备
...
{
  "Action": "AppBindUserShareDevice",
  "AccessToken": "8b4a70dd16105f******************18edd4e78a3bb8ec",
  "RequestId": "1555507435215",
  "ProductId": "22F9Y6II7O",
  "DeviceName": "light1",
  "ShareDeviceToken": "0820728466424d8f****422ec06bd398"
}
```
**输出示例:  成功**
```json
...
```json
{
  "Response": {
    "Error": {
      "Code": "InvalidParameterValue.DeviceBinded",
      "Message": "设备已经和当前用户绑定"
    },
    "RequestId": "1555507435215"
  }
...
|InvalidParameterValue.ShareDeviceTokenUsed|设备分享Token已使用|
