...
1. 下载 H5 面板的 [JS 文件](https://github.com/tencentyun/iotexplorer-h5-panel-demo/releases/download/latest/index.js) 和 [CSS 文件](https://github.com/tencentyun/iotexplorer-h5-panel-demo/releases/download/latest/index.css)
