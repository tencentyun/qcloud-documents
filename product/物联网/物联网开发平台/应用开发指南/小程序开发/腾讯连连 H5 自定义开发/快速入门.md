...
腾讯云物联网开发平台为开发者提供一个 H5 自定义面板 Demo，开发者可以按本文档的指引流程，部署并体验 H5 自定义面板 Demo。关于 Demo 的更多信息，请参见 [H5 面板 Demo](https://github.com/tencentyun/iotexplorer-h5-panel-demo)。
...
1. 在产品详情页面，选择【设备调试】>【虚拟设备调试】，进入虚拟设备调试页面，页面展示虚拟设备调试二维码。

   ![](https://main.qcloudimg.com/raw/0610c526385ab3d1ae002251b0c05fc8.png)

2. 使用微信扫描该二维码，微信跳转到腾讯连连小程序。授权完成后，腾讯连连小程序自动绑定该设备，页面提示添加设备成功。
