...
>? 小程序 API [wx.getUserProfile](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/user-info/wx.getUserProfile.html) 每次请求均会弹出授权窗口。对于已注册用户，在调用物联网开发平台的 [微信号注册登录](https://cloud.tencent.com/document/product/1081/40781) 应用端 API 进行登录时，可不传入用户昵称和头像。
