...
2. 进入项目列表页面，单击【新建项目】
 ...
 - **项目描述**：输入项目的备注信息。  
3. 单击【新建】，则项目创建成功。
![image](https://main.qcloudimg.com/raw/a7aa26d4b7af06532d133b065b9a2f8f.png)


### 删除项目
1. 完成新项目创建后，您可以在项目列表页面查看创建的项目。
2. 当您无需该项目时，您可以在该项目的右上方，单击【删除】即可。
![image](https://main.qcloudimg.com/raw/9fe7fb1eee813c41ca1b763b1ccd7fd8.png)
...
>注意：为了防止误操作删除产品影响您的业务，若该产品下还有设备，则不允许删除该产品。

### 数据模板
单击创建的产品进入产品开发环节，产品开发第一步就是定义数据模板。
![image](https://main.qcloudimg.com/raw/6bcc0851c439d16eea03b4821f6461d5.png)
