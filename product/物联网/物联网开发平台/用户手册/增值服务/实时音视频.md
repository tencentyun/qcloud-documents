...
2. 设备端  C SDK Linux X86版本 使用 Github 托管，可访问 Github 下载最新版本设备端 [ C SDK](https://github.com/tencentyun/qcloud-iot-face-ai-c-sdk)。

### 开发指南

请参见 [Android SDK 接入指南](https://github.com/tencentyun/iot-link-android/tree/master/doc/实时音视频接入指南.md)、 [Linux SDK 接入指南](https://github.com/tencentyun/iot-link-ios/blob/master/doc/实时音视频接入指南.md)。
