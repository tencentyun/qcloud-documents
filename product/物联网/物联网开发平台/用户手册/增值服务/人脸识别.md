...
请参见 [Android SDK 开发指南](https://github.com/tencentyun/iot-device-java/blob/master/explorer/explorer-device-face/docs/IOT-Explorer人脸识别%20Android%20SDK开发指南.md
)、 [C SDK 接入指引](https://github.com/tencentyun/qcloud-iot-face-ai-c-sdk/blob/master/docs/IOT-Explorer人脸识别C-SDK开发指南.md)。
