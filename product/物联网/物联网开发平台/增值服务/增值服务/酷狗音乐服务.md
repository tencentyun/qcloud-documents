...
2. 设备端 SDK 使用 Github 托管，可访问 Github 下载最新版本 [Android SDK 接入指南](https://github.com/tencentyun/iot-device-java/blob/master/explorer/explorer-device-tme/README.md)、[设备端 C-SDK 接入指南](https://github.com/tencentyun/qcloud-iot-explorer-sdk-embedded-c/tree/master/docs)。
