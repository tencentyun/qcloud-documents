目前物联网开发平台 IoT Explorer 位置服务支持多种设备定位属性，包括 GPS 定位（GPS_Info、GPS_ExtInfo）、蜂窝定位（Cell_Info）、 Wi-Fi 定位（Wifi_Info ）以及 LoRa Edge 定位（Wifi_Info、GNSS_NAV），从而确定设备所在具体位置。
...
## LoRa Edge 定位
详细介绍请参阅 [LoRa Edge 介绍](https://cloud.tencent.com/document/product/1081/78671)、[LoRa LR1110 快速入门](https://cloud.tencent.com/document/product/1081/71441)。
