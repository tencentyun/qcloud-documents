...
开发阶段，需要设置访问白名单才可使用腾讯连连调试 H5 自定义面板。设置访问白名单的步骤，请参见 [H5 面板访问白名单](https://cloud.tencent.com/document/product/1081/49028#h5-.E9.9D.A2.E6.9D.BF.E8.AE.BF.E9.97.AE.E7.99.BD.E5.90.8D.E5.8D.95)。
