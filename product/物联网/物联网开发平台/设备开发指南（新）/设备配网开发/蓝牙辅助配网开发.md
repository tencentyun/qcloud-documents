...
目前腾讯连连小程序已支持采用腾讯蓝牙辅助配网协议进行配网 Demo 开发，并提供相应的 [小程序 SDK](https://www.npmjs.com/package/qcloud-iotexplorer-appdev-sdk)。
蓝牙辅助方式配网及设备绑定的示例流程图如下：
![](https://main.qcloudimg.com/raw/b5f24fdace1257807327b29aa21a99f4.png)
