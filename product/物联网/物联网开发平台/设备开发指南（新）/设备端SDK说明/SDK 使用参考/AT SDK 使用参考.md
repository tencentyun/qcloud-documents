...
|开发平台|参考文档|
|---|---|
|MCU+定制AT模组（蜂窝类）|[MCU+定制MQTT AT模组（蜂窝类）接入指引](https://cloud.tencent.com/document/product/1081/48395)|
|MCU+定制AT模组（wifi类）|[MCU+定制MQTT AT模组（wifi 类）接入指引](https://cloud.tencent.com/document/product/1081/48394)|
