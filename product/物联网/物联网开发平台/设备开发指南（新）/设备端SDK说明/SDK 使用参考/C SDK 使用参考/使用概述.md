...
- 对于具备网络通讯能力并使用标准 Linux/Windows 系统的设备。例如 PC/服务器/网关设备，及较高级的嵌入式设备，例如：树莓派等，可直接在该设备上编译运行 SDK。
...
编译方式以及编译配置选项的详细说明请参考 [编译配置说明](https://cloud.tencent.com/document/product/1081/48371) 和 [编译环境说明](https://cloud.tencent.com/document/product/1081/48372)。
