...
|MCU+定制AT模组（wifi类）|[qcloud-iot-sdk-tencent-at-based](https://github.com/tencentyun/qcloud-iot-sdk-tencent-at-based)|[MCU+定制MQTT AT模组（wifi 类）接入指引](https://cloud.tencent.com/document/product/1081/48394)|
