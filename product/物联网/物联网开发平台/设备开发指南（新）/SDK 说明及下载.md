...
- 自 V3.1.0 版本开始，使用独立的 [Github](https://github.com/tencentyun/iot-device-java/tree/master/explorer-device-java ) 托管 C 设备 SDK 代码。
...
ESP8266 SDK 使用独立的 [Github](https://github.com/tencentyun/iot-device-java/tree/master/explorer-device-java ) 托管代码。

## Android SDK 代码托管

自 V3.1.0 版本开始，Android SDK 使用独立的 [Github](https://github.com/tencentyun/iot-device-java/tree/master/explorer-device-java ) 托管代码。
...
- 自 V0.1.0 版本开始，C SDK 5G  使用独立的 [Github](https://github.com/tencentyun/iot-device-java/tree/master/explorer-device-java ) 托管代码。
