...
本接口（ServiceCallDeviceActionSync）用于同步调用设备行为。

## 2. 输入参数

| 名称        | 类型   | 必选 | 描述                                                         |
| ----------- | ------ | ---- | ------------------------------------------------------------ |
| Action      | String | 是   | 公共参数，本接口取值：ServiceCallDeviceActionSync            |
...
content-type: application/json
{
	...
	"AppKey": "AppKey",
	"Signature": "Signature",
	"Action": "ServiceCallDeviceActionSync",
	"ProductId":"22****II7O",
	"DeviceName":"light1",
	"ActionId": "echo",
...
{
  "Response": {
				"ClientToken": "45016a4****74abcb05e25790b916dc3",
				"OutputParams": "{\"message\":\"hello.\"}",
				"RequestId": "f92406b3-****-4fe8-bc43-45e3d794bb68",
				"Status": "succ"
			  }
}
