...
- 消费物联场景：基于数据模板协议，用户可无缝使用腾讯连连小程序或自主品牌小程序与 App，提升效率。
- 产业物联场景：基于数据模板协议，无需用户解析设备数据，可使用物联网开发平台的数据分析、告警和存储等服务。
...
<table>
   ...
   <tr>
      <td>method</td>
      <td>String</td>
      <td>unbind_device 表示是用户在小程序或App中删除或解绑某个设备</td>
   </tr>
     <tr>
      <td>timestamp</td>
      <td>Integer</td>
