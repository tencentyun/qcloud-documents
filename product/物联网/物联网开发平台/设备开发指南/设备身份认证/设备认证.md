## 设备身份信息
为保证安全，物联网平台会验证每个接入设备的合法性，为此提供了两种认证方式，满足不同的使用场景及各种资源的设备接入。两种认证方式分别为证书设备和密钥设备。证书方式安全性更高，但需要消耗较多的软硬件资源。
...
![](https://main.qcloudimg.com/raw/925478e7f8fabdd036e2bfed256ce48a.jpg)
