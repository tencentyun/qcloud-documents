...
以海康摄像机为例，本地配置页面详情如下。
![](https://qcloudimg.tencent-cloud.cn/raw/d4fd18a292652ca558fbc13b0e91ed5e.png)
- 本地 SIP 端口填写前需确认防火墙是否支持该端口，建议填写：6067。
- 传输协议选择 TCP。
...
- 本地 SIP 端口填写前需确认防火墙是否支持该端口，建议填写：5067。
- 传输协议选择 TCP。
- 协议版本选择GB/T28181-2016。
