...
```
>?
 - include 目录：SDK 供用户使用的 API 及可变参数，其中 config.h 为根据编译选项生成的编译宏。API 具体介绍请参考 [接口及可变参数说明](https://cloud.tencent.com/document/product/634/38259)。
 - platform目录：平台相关的代码，可根据设备的具体情况进行修改适配。具体的函数说明请参考[ C-SDK_Porting跨平台移植概述](https://cloud.tencent.com/document/product/634/38388)。
