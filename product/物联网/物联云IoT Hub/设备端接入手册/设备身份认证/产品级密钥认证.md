...
>?为了避免不可预知情况（如设备固件bug，产品密钥被盗取等情况）造成创建过多设备，若您勾选了自动创建设备，建议设置合理的设备上限。

![](https://main.qcloudimg.com/raw/09d32e0e2b94c42a402ad34eb0ec650a.png)
3. 在产品下创建设备（可选操作）
...
![](https://main.qcloudimg.com/raw/1fad65cc1cb007f7cedd9b2cdf821309.png)
4. 设备固件烧录，具体步骤如下：
 1. 下载 [设备端 SDK](https://cloud.tencent.com/document/product/634/11928)。
 2. 实现SDK中关于产品、设备信息读写的 HAL 层函数，包括 ProductID、ProductSecret 和 Devicename 等，并 SDK 中的开启动态注册功能，具体可参见 [设备接入](https://cloud.tencent.com/document/product/634/35270)。
