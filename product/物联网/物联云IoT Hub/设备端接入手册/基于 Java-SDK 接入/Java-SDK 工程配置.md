...
腾讯云物联网设备端 Java-SDK 依靠安全且性能强大的数据通道，为物联网领域开发人员提供设备端快速接入云端，开发人员只需完成工程的相应配置即可完成设备的接入。
...
```
- 如果您想通过代码集成方式进行项目开发，可访问 [Github](https://github.com/tencentyun/iot-device-java/tree/master/hub-device-java) 下载 Java-SDK 源码。
