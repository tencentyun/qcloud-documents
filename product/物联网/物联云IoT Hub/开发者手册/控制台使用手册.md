...
![](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_productdetail.png)

点击产品描述旁边的【修改】按钮即可进行产品描述修改并【保存】结果。
![](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_productdetailedit.png)
...
![](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_deleteproduct.png)
...
![](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_createdevice.png)
...
可以查看该设备下的权限列表。
![设备权限列表](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_devicepolicy.png)
![设备权限列表详情](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_devicepolicylist.png)

### 1.5 权限列表

区别于设备权限列表，这里是产品层级的权限列表。
![权限列表1](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_productpolicy.png)

#### 1.5.1 定义 Topic 权限

第一步：点击【定义 Topic 权限】按钮
![权限列表按钮](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_policybtn.png)
...
![](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_policydelete.png)

#### 1.5.3 权限管理

可以对【操作名称】和【设备操作权限】进行修改。
![](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/iot_policyeditbtn.png)
...
![](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/TIM截图20171127105353.png)
