...
完成以上配置后，物联网通信平台会将符合规则条件的设备上报数据，转发至用户配置的 CTSDB 实例。用户可参考 [CTSDB 开发指南](https://cloud.tencent.com/document/product/652/13611) 在自己的应用服务器上读取数据进行处理，或者在 [CTSDB 控制台](https://console.cloud.tencent.com/ctsdb) 对数据进行聚合检索查询。
...
![](https://main.qcloudimg.com/raw/7450b83a9c14e9831df4567a8539d168.png)
