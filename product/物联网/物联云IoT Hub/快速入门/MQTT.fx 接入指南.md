...
| Broker Port         | MQTT 服务器连接端口，填入：8883。 本文主要针对证书认证类型的产品，端口必须是8883；如果您想通过1883接口接入，建议使用秘钥认证型产品自行接入，请参考 [设备基于 MQTT 接入](https://cloud.tencent.com/document/product/634/32546) 进行接入。  |                 
