...
###  Android-SDK 操作步骤
####  程序实现
请参照 [C-SDK 操作步骤 - 程序实现](https://cloud.tencent.com/document/product/634/11914#c-sdk-.E6.93.8D.E4.BD.9C.E6.AD.A5.E9.AA.A4) 中功能说明。

#### 程序编译与执行
请参照 [C-SDK 操作步骤 - 程序编译与执行](https://cloud.tencent.com/document/product/634/11914#c-sdk-.E6.93.8D.E4.BD.9C.E6.AD.A5.E9.AA.A4) 中功能说明。
