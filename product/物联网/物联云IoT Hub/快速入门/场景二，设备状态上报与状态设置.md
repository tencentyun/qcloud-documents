...
通过云 API 操作设备影子的相关接口案例实现，请下载 [iothub_RestAPI_python.zip](https://mc.qcloudimg.com/static/archive/5e9c28a87376664c6e23e205ec23d911/iothub_RestAPI_python.zip)，用户需根据《 RestAPI 操作说明》配置个人信息。通过修改 RestAPI 文件夹下 airConditionerCtrl.py 参数实现自定义功能。
