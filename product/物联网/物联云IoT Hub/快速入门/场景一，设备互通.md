...
2. 进入产品列表页，单击【创建新产品】。
3. 创建产品（Door）并根据需要选择加密类型，输入产品描述，单击【确定】。
![](https://main.qcloudimg.com/raw/c0d43cb669f07d79dce21188693ca002.png)
4. 创建成功后，可以查看产品的基本信息。
...
1. 登录 [物联网通信控制台](https://console.cloud.tencent.com/iotcloud)，单击左侧菜单栏【产品列表】。
2. 进入产品列表页，单击【创建新产品】
3. 创建空调产品（AirConditioner），并根据需要选择加密类型，输入产品描述，单击【确定】。
![](https://main.qcloudimg.com/raw/9cbe53d1843e6b205261edc328fcf63a.png)
4. 创建成功后，可以查看产品的基本信息。
