...
![rule_engine_for_smart_home](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/airv1schema.png)
...
2. 创建成功后，可以查看产品的基本信息
	...
	![产品设置](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/IoTDoorProductDescription.png)

3. 在【设备列表】下创建设备（door1）
	> **注意:**创建设备会返回设备密钥，此密钥用于设备通信，并且不会在物联云后台存储，请妥善保管
	![创建设备返回](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/IoTDoorDevicePK.png)

4. 点击【管理】可查询设备详情。
	![查询设备](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/IoTDoorDeviceDescription.png)
	
	
### 2.2 创建空调产品和设备

1. 进入 [控制台](https://console.cloud.tencent.com/iot/products), 创建空调产品（AirConditioner）

	![创建空调产品](https://mc.qcloudimg.com/static/img/7a7bad485660ba86707cce3b2a05d526/1-7.png)
    	
2. 创建成功后，可以查看产品的基本信息

	![创建设备](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/IoTAirProductDescription.png)
    
3. 在【设备列表】下创建设备（airConditioner1），此步骤与2.1步骤3一致
    
4. 点击【管理】可查询设备详情

	![查询设备](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/IoTAirDeviceDescription.png)
...
![创建规则引擎](http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/iotdoorairrule.png)
