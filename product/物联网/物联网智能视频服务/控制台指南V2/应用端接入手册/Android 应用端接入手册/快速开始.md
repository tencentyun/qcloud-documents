...
- **SNAPSHOT 版**
进入 [so下载地址](https://oss.sonatype.org/#welcome)，单击 【Repositories】>【Snapshots】>【Browse Storage】 的 Path Lookup 输入框中输入`com/tencent/iot/thirdparty/android` >【xp2p-sdk】>选择对应版本（例如1.0.2-SNAPSHOT）> 选择最新的 `.aar` 右键【Downloads】。
