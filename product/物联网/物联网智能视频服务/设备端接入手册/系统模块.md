...
成员名称 | 描述 | 取值
---|---|---
IV_SYS_CERTIFICATE_TYPE_INITIAL | 初始证书 | 略
IV_SYS_CERTIFICATE_TYPE_ACTIVED | 激活证书 | 略 
IV_SYS_CERTIFICATE_TYPE_SECERT_KEY | 证书密钥，一个so文件 | 略
...
成员名称 | 描述 | 取值
---|---|---
IV_SYS_DEVICE_ABILITY_POOR | 内存较少 | 略
IV_SYS_DEVICE_ABILITY_ORDINARY | 内存一般 | 略 
IV_SYS_DEVICE_ABILITY_RICH | 内存富余 | 略
