...
### 第4步：创建产品与设备
登录 [物联网智能视频服务（消费版）（消费版）控制台](https://console.cloud.tencent.com/iot-video)，或通过物联网智能视频服务（消费版）（消费版）云 API，创建产品及设备，产品为一类真实设备的集合，创建的设备则对应真实设备。
...
完成上述步骤后，您集成了设备端 SDK 的设备，就可实现物联网智能视频服务（消费版）(消费版)相关功能。
