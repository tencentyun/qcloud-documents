...
| ------ | ---------------------------------------------------------- | -------- | 
| Android | 最低兼容 Android 5.1（SDK API Level 22），建议使用 Android 5.1 （SDK API Level 22）及以上版本。 | 填写申请表 [物联网智能视频服务控制台](https://cloud.tencent.com/apply/p/ozpml9a5po) 进行申请，完成申请后，相关工作人员将联系您进行需求沟通，并提供对应 SDK 及 Demo         |
