...
| :---- | :---- | :---- |
|  noRespondsToSelector  | 21030  | 方法选择器无响应、未实现协议方法 |
|    invalidParameter    | 21031  | 参数错误                         |
|   playbackListEmpty    | 21032  | 录像列表为空                     |
|    playbackDataErr     | 21033  | 录像列表数据异常                 |
|   recorderIsRunning    | 21034  | 正在录制                         |
| videoResolutionChanged | 21035  | 视频分辨率已改变                 |
| encoderNotAvailableNow | 21036  | 编码器暂不可用                   |
...
| :---- |:---- |:----|
|    duplicate     | 21000  | 消息重复、消息正在发送 |
|    sendFailed    | 21001  | 消息发送失败           |
|     timeout      | 21002  | 消息响应超时           |
|  getGdmDataErr   | 21003  | 获取物模型失败         |
|  rcvGdmDataErr   | 21004  | 接收物模型失败         |
|  sendPassSrvErr  | 21005  | 透传数据给服务器失败   |
|  sendPassDevErr  | 21006  | 透传数据给设备失败     |
| notFoundCallback | 21007  | 没有找到回调           |
| exceedsMaxLength | 21008  | 数据超过上限           |
...
|             ac_centerInner_find_login_user_err             | 8612   |                                                              |
|      ac_centerInner_login_user_utcinitchgd_lower_err       | 8613   |                                                              |
|       ac_centerInner_login_dev_utcinitchgd_lower_err       | 8614   |                                                              |
|           ac_centerInner_processDevLastWord_err            | 8620   |                                                              |
|        ac_MsgBody_LastWords_topic_is_not_valide_err        | 8621   |                                                              |
|        ac_MsgBody_LastWords_json_is_not_valide_err         | 8622   |                                                              |
|         ac_MsgBody_LastWords_not_with_livetime_err         | 8623   |                                                              |
|          ac_MsgBody_LastWords_not_with_topic_err           | 8624   |                                                              |
|           ac_MsgBody_LastWords_not_with_json_err           | 8625   |                                                              |
|             ac_MsgBody_LastWords_action_is_err             | 8626   |                                                              |
|             ac_MsgBody_LastWords_query_is_none             | 8627   | 中心服务器未查到遗言                                         |
|                 aSrv_centerInner_other_err                 | 8700   |                                                              |
...
|               aSrv_AllTermInitReq_other_err                | 9000   |                                                              |
...
|                      term_alloc_fail                       | 20200  |                                                              |
|                     term_param_invalid                     | 20201  |                                                              |
|                   term_term_unit_no_init                   | 20202  |                                                              |
|             term_msg_onlinemsg_handle_invalid              | 20213  | 在线消息 handle 错误，有可能是过期丢弃了                       |
