...
> **注意:**
> airConditioner1 不可直接订阅 door1 的 update 消息完成消息通信，原因参见[权限管理](http://iot.open.qq.com/wiki/index.html#!CLOUD/iothub_intro.md#%E6%9D%83%E9%99%90%E7%AE%A1%E7%90%86)。
...
查询设备详情页面，设备证书、设备私钥用于 MQTT 的 TLS 非对称加密；对称秘钥用于对称加密通信（两种通信方式差别见[设备接入](http://iot.open.qq.com/wiki/index.html#!CLOUD/iothub_intro.md#%E8%AE%BE%E5%A4%87%E6%8E%A5%E5%85%A5)。
> **注意:**
> 以上资源的创建可通过 restAPI 由后台创建，具体请参见[云API](http://iot.open.qq.com/wiki/index.html#!CLOUD/iothub_intro.md#%E4%BA%91API)。
