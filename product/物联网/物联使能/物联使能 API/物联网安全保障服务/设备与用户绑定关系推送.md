...
| DeviceInfos | Array of [ServiceDeviceInfo](https://cloud.tencent.com/document/product/1465/59061#ServiceDeviceInfo) | 是   | 设备信息列表，支持推送用户与单个或批量设备的绑定关系。<br/>当用户对应多个厂商设备编号时，必须采用批量推送方式。          |
