...
>?服务端可不返回 Token，此时 SE 安全芯片将维持上一个 Token 不变，后续所有业务数据的加解密操作均由 SE 安全芯片完成。详情请参考 [设备端 SDK 相关代码](https://cloud.tencent.com/document/product/1086/35982#.E4.B8.8B.E8.BD.BD-sdk)。
