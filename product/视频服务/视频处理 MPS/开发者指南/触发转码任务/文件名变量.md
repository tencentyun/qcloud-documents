...
则使用 [ProcessMedia](https://cloud.tencent.com/document/product/862/37578) 接口发起转码时，应将
InputInfo.CosInputInfo.OutputObjectPath 参数指定为`{inputName}_{definition}.{format}`。
