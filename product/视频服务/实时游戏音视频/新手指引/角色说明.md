欢迎使用腾讯云游戏多媒体引擎 SDK 。为方便开发者接入腾讯云游戏多媒体引擎产品，这里向您介绍适用于游戏多媒体引擎 SDK 的游戏音视频实时语音角色说明。
## 角色介绍
...
## 角色制定
### 1.登录控制台
打开网址[腾讯云控制台](https://console.qcloud.com/ilvb) 在应用列表中选择需要编辑的应用，在【SPEAR 引擎配置中】单击【变更场景】，选择【游戏实时语音】。
