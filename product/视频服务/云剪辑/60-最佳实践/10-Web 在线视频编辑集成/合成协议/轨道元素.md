>? 决定展示内容的容器，只能承载云媒资，关于云媒资请参阅 [导入素材库](https://cloud.tencent.com/document/product/1156/43243)。
...
该种类的素材我们提供了更丰富的处理形式，具体请参阅 [多媒体处理](#Media)，元素示例如下：
...
该种类的素材我们提供了更丰富的处理形式，具体请参阅 [多媒体处理](#Media)，图片除开没有自身时间线外，与视频类型素材基本一致，示例如下：
...
该种类的素材我们提供了更丰富的处理形式，具体请参阅 [多媒体处理](#Media)，示例如下：
