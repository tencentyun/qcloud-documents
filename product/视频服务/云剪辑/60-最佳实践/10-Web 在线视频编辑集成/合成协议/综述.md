...
<img src='https://vs-cdn.tencent-cloud.com/assets/imgs/track_demo.png'>
...
- 轨道(Track)：
  * 决定舞台展示层级的容器，顺序字段用数字表示，从小到大，表示从顶层到底层，顶层值为0，详情请参考[轨道](./轨道.md)。
- 轨道元素(TrackItem)：
  * 决定展示内容的容器，只能承载云媒资，关于轨道元素具体请参考[轨道元素](./轨道元素.md)。
- 云媒资：
  * 整合到制作云系统的基本媒体资源，如何导入云媒资，具体请参考[云媒资](https://cloud.tencent.com/document/product/1156/43243)。
  * 如何便捷的获取云媒资，请参考[云媒资助手](../组件化/合成协议助手.md)。
