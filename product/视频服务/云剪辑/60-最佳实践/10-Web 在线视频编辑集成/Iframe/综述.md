...
```
>? 通过`send`方法发送**命令字**，命令字相关内容请参见 [云剪辑指令](https://cloud.tencent.com/document/product/1156/51219)。 
>
#### destroy[](id:destroy)
```js
/**
...
#### on[](id:on)
>? 监听来自云剪辑的用户事件用户事件，与之相对应的有移除事件，了解更多用户事件请参见 [云剪辑事件](https://cloud.tencent.com/document/product/1156/51218)。
