...
| player:playing |        暂无                  | 播放器开始播放时的事件回调。 |
| player:pause   |        暂无                   | 播放器暂停播放时的事件回调。 |
| player:ended   |        暂无                    | 播放器播放结束时的事件回调。 |
| player:error   |        暂无                  | 播放器加载失败时的事件回调。 |
