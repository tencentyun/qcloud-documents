...
| 参数    | 描述     | 类型                                                          | 必填                                                                |
| ------- | -------- | ------------------------------------------------------------- | ------------------------------------------------------------------- |
| options | 轨道设置 | {type:'video'/'audio'/....}，具体类型请参见 [轨道描述](https://cloud.tencent.com/document/product/1156/51226)。 | 是                                                                  |
...
| styles     | 文字样式 {font_size,font_color,align,italic,background_color,background_alpha,height}，详请请参见 [示例](#addSubtitle_exam)。 | object | 否   |
