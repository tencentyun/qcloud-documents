...
```
在页面初始化完成以后填入如下代码。
<pre class="markdown-text-box" style="overflow-y: hidden;padding: 16px 20px;"><code class="language-js"><span class="hljs-comment">/*    @create  创建实例方法,没调用该方法之前,调用 send 方法通信无效。
 ...
 **/</span>
<span class="hljs-keyword">let</span> myCmeInstance = CME.Iframe.create(<span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">"Container"</span>), {
  <span class="hljs-attr">sign</span>: <span class="hljs-string">"your_signature"</span>,
});
<span class="hljs-comment">/**
 * 页面初始化异常时，会抛出Error事件。
 **/</span>
myCmeInstance.on(<span class="hljs-string">"Error"</span>, (err) =&gt; {
...
myCmeInstance.on(<span class="hljs-string">"Editor:Ready"</span>, () =&gt; {
   ...
   *
   **/</span>
  myCmeInstance.send(<span class="hljs-string">"syncFusionData"</span>, {}, (err,data) =&gt; {
