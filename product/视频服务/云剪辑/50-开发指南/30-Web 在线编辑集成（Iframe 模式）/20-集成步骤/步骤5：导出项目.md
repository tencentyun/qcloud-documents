...
2. `ExportDestination`指导出的结果输出，可以是导出为云点播的媒资文件，也可以导出成CME的素材。
...
导出项目后CME后端返回导出任务的 ID，开发者可以通过服务端 API 查询任务的导出进度及结果，具体请参见 [获取任务详情](https://cloud.tencent.com/document/product/1156/40359)。
