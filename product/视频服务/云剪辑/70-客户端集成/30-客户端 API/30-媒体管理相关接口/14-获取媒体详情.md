...
字段 | 类型 | 描述
------- | ------- | -------
MaterialInfoSet | Array of [MaterialInfo](../复杂结构.md#MaterialInfo)| 媒体信息集合。
FailedMaterialInfoSet | Array of [FailedMaterialInfo](../复杂结构.md#FailedMaterialInfo) | 获取失败的媒体集合。 
