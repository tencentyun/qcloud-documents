...
- 云点播（VOD）存储（由上传短视频产生），详见 [存储计费](https://cloud.tencent.com/document/product/266/14666#.E8.AE.A1.E8.B4.B9.E4.BB.B7.E6.A0.BC) 和 [存储资源包](https://cloud.tencent.com/document/product/266/14667#1.-.E5.AD.98.E5.82.A8.E8.B5.84.E6.BA.90.E5.8C.85)。
- VOD 流量（由播放短视频产生），详见 [流量计费](https://cloud.tencent.com/document/product/266/14666#.E8.AE.A1.E8.B4.B9.E4.BB.B7.E6.A0.BC6) 和 [流量资源包](https://cloud.tencent.com/document/product/266/14667#2.-.E6.B5.81.E9.87.8F.E8.B5.84.E6.BA.90.E5.8C.85)。
- VOD 音视频 AI（由对短视频进行内容审核产生），详见 [内容审核计费](https://cloud.tencent.com/document/product/266/14666#.E5.86.85.E5.AE.B9.E5.AE.A1.E6.A0.B8.3Cspan-id.3D.22media_ai.22.3E.3C.2Fspan.3E) 和 [内容审核资源包](https://cloud.tencent.com/document/product/266/14667#5.-.E8.A7.86.E9.A2.91.E5.AE.A1.E6.A0.B8.E5.8C.85)。
...
### 步骤1：准备腾讯云 CVM<span id="step1"></span>
...
>?
>- 购买 CVM 的方法请参考 [操作指南-创建实例](https://cloud.tencent.com/document/product/213/4855)。
>- 重装系统方法请参考 [操作指南-重装系统](https://cloud.tencent.com/document/product/213/4933)。

### 步骤2：开通 VOD<span id="step2"></span>
...
### <span id = "anchor2"></span>步骤3：获取 API 密钥<span id="step3"></span>
...
### 步骤5：配置回调地址<span id = "anchor3"></span>
