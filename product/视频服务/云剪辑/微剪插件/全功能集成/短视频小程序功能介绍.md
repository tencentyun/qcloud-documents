...
一般情况下小程序主要由 `前端` 和 `后台` 两部分组成 。本文将主要介绍前端部分逻辑，后台部分请参见 [后台设计](https://tcloud-doc.isd.com/document/product/1156/48625?!preview&!editLang=zh)。

## 功能介绍

### feeds 瀑布流<span id="feeds"></span>
...
### 视频导出与发布<span id="video_export"></span>
