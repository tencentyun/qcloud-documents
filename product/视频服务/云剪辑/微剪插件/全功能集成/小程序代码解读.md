...
1. 微剪插件 （ 用于短视频编辑 ）， 详见 [产品文档与收费标准](https://cloud.tencent.com/document/product/1156/45643)；

2. 云点播插件 （ 获取视频资质 ），详见[开发文档](https://mp.weixin.qq.com/wxopen/plugindevdoc?appid=wx116d0dd5e6a39ac7&token=&lang=zh_CN)，[购买指南](https://cloud.tencent.com/document/product/266/33149)；

3. 云点播上传SDK ( 用于视频上传 ) , [开发文档](https://cloud.tencent.com/document/product/266/18177)。
