本章节将重点介绍短视频小程序实现过程，后台部分参考 [后台设计](https://tcloud-doc.isd.com/document/product/1156/48625?!preview&!editLang=zh) 章节。

## Demo 源码<span id="demo"></span>

<td><a onclick="window.open('https://imgcache.qq.com/operation/dianshi/other/demo_video.e15e790501215e83f0439bd3f43138120dd2628a.zip ')"><div style="width:124px;height: 124px;background-image:url(https://main.qcloudimg.com/raw/10eeb0f77c40f8ac31bce004ec7b8ca0.png);background-size: cover;">
</div></a></td>
...
#### 视频播放
1. 启动小程序，进入 [feeds 流](https://tcloud-doc.isd.com/document/product/1156/48622?!preview&!editLang=zh#feeds)。
2. 单击视频封面将进入 [播放界面](https://tcloud-doc.isd.com/document/product/1156/48622?!preview&!editLang=zh#video_play)，进行视频播放（借助 `点播插件`）。

#### 视频发布
1. 单击首页悬浮的编辑图标![](https://main.qcloudimg.com/raw/7cc3cc974f3d710044699d7f434b40f8.png)。
2. 进入 [视频编辑](https://tcloud-doc.isd.com/document/product/1156/48622?!preview&!editLang=zh#video_edit) 页，可对视频进行编辑 (借助 `微剪插件`)。
...
通过原型图可以看到 feeds 主要由 [视频瀑布流](#waterflow) 和 [蓝色编辑按钮](#bbutton)![](https://main.qcloudimg.com/raw/f1ec2c5e2f39f6baf09dbef110dbe04b.png) 组成。单点击视频封面将进入视频播放页面，单击按钮将进入视频编辑页面。
...
>? `clip` 和 `export` 是微剪插件主要提供两个核心组件。`clip` 组件用于视频的编辑，`export` 组件用于视频的导出。

### 视频编辑<span id="video_edit"></span>
...
>- 更多 settings 中的属性设置，请参见 [集成组件 API 文档](https://tcloud-doc.isd.com/document/product/1156/48607?!preview&!editLang=zh#settings-.E5.8F.82.E6.95.B0.E8.AF.B4.E6.98.8E)。



### 视频发布<span id="video_export"></span>
#### 步骤1：导出视频
