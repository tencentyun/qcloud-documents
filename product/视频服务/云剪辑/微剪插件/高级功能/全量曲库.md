...
3. 单击【立即开通】，即可开通服务。
4. 进入 [正版曲库直通车控制台](https://console.cloud.tencent.com/ame/acc)，完成以下3个接入指引步骤：
	1. 进入域名管理页面，单击 [【添加域名】](https://console.cloud.tencent.com/ame/acc/add)。
	2. 当域名状态显示为【已启动】后，请在域名服务提供商处完成 CNAME 配置，详情请参见 [CNAME 配置](https://cloud.tencent.com/document/product/228/3121)。
	3. 您可以在域名管理页面，单击域名右侧操作列中的【测试】，对资源分发链路进行测试。
...
## 步骤4：导出跨域问题解决<span id="step4"></span>
