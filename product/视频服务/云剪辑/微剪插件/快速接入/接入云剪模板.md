...
![](https://main.qcloudimg.com/raw/d7e4103676020e16c247f16596f332f9.png)
...
2. 创建完成后会进入到剪辑界面中，目前微剪还只支持9：16的分辨率，因此先把剪辑分辨率调整为9:16。
   <img src="https://main.qcloudimg.com/raw/553dd7376e8082b9df0b9c1431b56af7.png" width=700></img>
...
| ---------- | ---------- | ---------------- | ---------- | ---------- | ---------- |
| 后端导出   | 导出的视频在云剪后台，返回 `https://` 格式的远程链接，需要接入方自行下载再上传自自有存储 | 是               | 目前仅支持导出云剪模板（后续会支持普通剪辑） | wj-export-backend | 后端导出，导出稳定，不受机型和微信版本影响   |
