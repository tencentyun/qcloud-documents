...
登录 [微信公众平台](https://mp.weixin.qq.com/)，注册完成 [小程序](https://mp.weixin.qq.com/cgi-bin/wx?token=&lang=zh_CN) 后，在微信开发者工具里 [新建小程序项目](https://mp.weixin.qq.com/wxopen/waregister?action=step1)。
> 若您当前已有小程序，直接打开即可。
