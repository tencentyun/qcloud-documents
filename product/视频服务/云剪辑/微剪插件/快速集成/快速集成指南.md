...
>? 只有多个素材的情况才可使用影集模式，一个素材会默认为手动模式；
> 也可以在插件 [settings](https://tcloud-doc.isd.com/document/product/1156/48607?!preview&!editLang=zh#settings-.E5.8F.82.E6.95.B0.E8.AF.B4.E6.98.8E) 中配置 `editMode: ['album', 'manual']` 并选择编辑模式
