...
> 也可以在插件 [settings](https://tcloud-doc.isd.com/document/product/1156/48607?!preview&!editLang=zh#settings-.E5.8F.82.E6.95.B0.E8.AF.B4.E6.98.8E) 中配置 `editMode: ['album', 'manual']` 选择编辑模式
