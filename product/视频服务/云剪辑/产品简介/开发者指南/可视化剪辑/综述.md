...
>? 执行成功即可进入下一步 [页面定制](#page)。

<span id="page"></span>
## 页面定制
初始化成功后，则可以看到下图这样的页面，页面可以做**基础定制**，目前需 [联系客服](https://support.qq.com/products/101813) 协助操作，后续会开放自助。
...
| 事件名 | 数据结构                                                     |
| ------ | ------------------------------------------------------------ |
| Error  | {error:1000,msg:'NotSupportBrowser'}，更多错误码详情请参见 [错误码](#error_code)。 |
