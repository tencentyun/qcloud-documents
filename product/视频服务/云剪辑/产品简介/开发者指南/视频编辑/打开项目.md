...
![](https://main.qcloudimg.com/raw/af1693c29883d0a1a917b1279007c11e.jpg)
...
云剪会将上面`id=editor`的`div`标签进行初始化，将云剪视频编辑页以 IFrame 的形式植入当中，开发者也可以根据自己的页面结构进行适当的调整，更多的细节可以参考：[前端 SDK](https://cloud.tencent.com/document/product/1156/43776?!preview&!editLang=zh)。
