...
- original 除了可以包含必选参数，还可包含任意多个选填参数，详细请参见 [签名参数](#check)。
...
```
上面为 Java 版的示例代码，其他语言的实现请参见 [签名示例](https://cloud.tencent.com/document/product/1156/43778?!preview&!editLang=zh)。
...
| action | 是 | String | 操作 API 名称，目前支持：<li>OpenProject：打开项目编辑页。<li>Upload：上传文件。 | 
| userId | 是 | String | 用户 Id，为开发者服务端用户的唯一标识。 |
| openProject.projectId | 否 | String | 项目 ID，当 action=OpenProject 时有效。 |


## 签名示例
- [Java 版签名示例](https://cloud.tencent.com/document/product/1156/43778?!preview&!editLang=zh#java)
- [Go 版签名示例](https://cloud.tencent.com/document/product/1156/43778?!preview&!editLang=zh#go)
- [Node.js 版签名示例](https://cloud.tencent.com/document/product/1156/43778?!preview&!editLang=zh#nodejs)
- [Python 版签名示例](https://cloud.tencent.com/document/product/1156/43778?!preview&!editLang=zh#paython)
- [PHP 版签名示例](https://cloud.tencent.com/document/product/1156/43778?!preview&!editLang=zh#php)
