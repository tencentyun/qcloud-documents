...
| action | 是 | String | 操作 API 名称，目前支持：<br/>OpenProject：打开项目编辑页<br/>Upload：上传文件 | 
...
- [NodeJS 版签名示例](https://cloud.tencent.com/document/product/1156/43778?!preview&!editLang=zh#nodejs)
