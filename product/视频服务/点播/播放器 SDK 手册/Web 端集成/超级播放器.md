...
建议在使用播放器 SDK 的时候自行部署资源，[单击下载播放器资源](https://web.sdk.qcloud.com/player/tcplayer/release/v4.2.1/release.zip) 。
...
- 自行生成缩略图文件与 VTT 文件，并将两个文件的 URL 传递给播放器，参见示例“缩略图预览 - 传入缩略图与 VTT 文件”
