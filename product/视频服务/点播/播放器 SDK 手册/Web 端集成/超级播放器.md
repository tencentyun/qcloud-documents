本文档是介绍腾讯云视立方 Web 云点播服务的超级播放器，它可以帮助腾讯云客户通过灵活的接口，快速与自有 Web 应用集成，实现视频播放功能，本文档适合有一定 Javascript 语言基础的开发人员阅读。
...
### 清晰度切换提示[](id:resolutionNotification)
