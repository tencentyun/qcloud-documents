...
建议在使用播放器 SDK 的时候自行部署资源，[单击下载播放器资源](https://web.sdk.qcloud.com/player/tcplayer/release/v4.3.0/release.zip) 。
...
播放器可以结合云点播的服务端能力实现高级功能，比如自动切换自适应码流、预览视频缩略图、添加视频打点信息等。这些功能在 [播放长视频方案]（TODO: 这里是链接，需要这篇文档发布后的地址） 中有详细的指引，可以参考文档实现。

此外，播放器还提供更多其他功能，功能列表和使用方法请参考 [功能展示](https://tcplayer-1306264703.cos.ap-nanjing.myqcloud.com/build/index.html) 页面。
