...
在播放器初始化过程中，可以通过超级播放器签名参数 `psign`，快速结合云点播的能力实现高级功能，比如试看、伪直播、防盗链以及私有加密等。这里以私有加密功能举例 ，云点播分别在 [视频加密综述](https://cloud.tencent.com/document/product/266/43632) 和 [视频加密接入指引](https://cloud.tencent.com/document/product/266/43633) 中详细介绍了视频加密的原理和接入方式，在初始化过程中将指引中生成的播放器签名传入即可。
...
更多其他功能的使用方法和说明，请参考 [功能展示](https://tcplayer-1306264703.cos.ap-nanjing.myqcloud.com/build/index.html) 页面。
