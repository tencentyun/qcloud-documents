...
<table>
   <tr>
      <th width="170px" style="text-align:center">播放方式</td>
...
<table>
   <tr>
      <th width="170px" style="text-align:center">功能</td>
      <th width="0px" style="text-align:center">功能描述</td>
      <th width="0px"  style="text-align:center">其他说明</td>
   </tr>
   <tr>
...
<table>
   <tr>
      <th width="85px" style="text-align:center">终端类别</td>
      <th width="85px" style="text-align:center">播放器类型</td>
