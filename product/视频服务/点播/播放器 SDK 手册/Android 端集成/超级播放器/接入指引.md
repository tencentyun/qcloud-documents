...
```
   如果之前没有使用过9.4以及更早版本的 SDK 的下载缓存功能，并且不需要在9.5及后续 SDK 版本播放9.4及之前缓存的下载文件，可以不需要该功能的 so 文件，达到减少安装包的体积，可以在 app/build.gradle 中添加：
```xml
packagingOptions {
...
#### 二、视频云工具包
<img src="https://main.qcloudimg.com/raw/6790ddaf4ffe4afd0ceb96b309a16496.png" width="200">
