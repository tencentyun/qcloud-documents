...
本播放器基于SuperPlayer的一个Flutter插件，同时支持android和iOS两个平台。完全免费开源，不对播放地址来源做限制，可放心使用。

# SDK下载

点播Flutter超级播放器项目的地址是[SuperPlayer Flutter](https://github.com/tencentyun/SuperPlayer/tree/main/Flutter)。 
