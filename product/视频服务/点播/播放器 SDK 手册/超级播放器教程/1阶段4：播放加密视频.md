...
[](id:step4)
## 步骤4：私有协议加密集成 
视频加密属于长视频场景下的一个细分场景，是视频平台自有的独播剧、网络课程等具有版权的视频，采取加密防止视频被非法下载和传播的措施。集成视立方超级播放器请参见 [集成指引](https://cloud.tencent.com/document/product/266/58772)，集成完后，可以提取上传媒资的 appid、fileId 和 pSign 进行播放。
