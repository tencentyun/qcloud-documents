...
阅读之前，请先确保已经学习播放器指引的 [阶段1：用播放器播放视频](https://cloud.tencent.com/document/product/266/46217) 篇部分，本教程使用了 [阶段1](https://cloud.tencent.com/document/product/266/46217) 篇开通的账号以及上传的视频。
