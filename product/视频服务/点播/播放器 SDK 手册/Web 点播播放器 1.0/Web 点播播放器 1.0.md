...
#### step 3：获取 ID
上传完视频之后，您就可以在视频管理页面查到该文件的 ID ，与此同时，本款播放器有质量统计功能，在使用之前需要先确认 APPID，您的 APPID 也可以在视频管理页面查看到。下图中的两个 ID，左边一个是视频文件的 ID，另一个是您的 APPID。
![](https://main.qcloudimg.com/raw/25a03de0b207c294ddd5166740844a0f.png)
