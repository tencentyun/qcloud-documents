...
<dx-tabs>[](id:zip)
::: 下载播放器组件 ZIP 包
您可以直接下面播放器组件 ZIP包，点击页面的**Code**>**Download ZIP**下载。
![](https://qcloudimg.tencent-cloud.cn/raw/a38a9995bfe13d645bcd1d2e5242a297.png)
:::
::: Git 命令下载[](id:git)
1. 首先确认您的电脑上安装了 Git，如果没有安装，可以参考 [Git 安装教程](https://git-scm.com/downloads) 进行安装。
...
```
#### 播放视频
本步骤，用于指导用户播放视频，腾讯云视立方 iOS 超级播放器支持云点播 fileId 或者 url 进行播放，推荐用户选择使用 **集成 fileid** 使用更完善的能力。
...
至此，您已经完成了腾讯云视立方 iOS 超级播放器创建、播放视频和退出播放的能力即成。
