...
[短视频 SDK](https://cloud.tencent.com/document/product/584/9366) 集成了客户端视频播放的功能，推荐使用该 SDK 实现客户端视频播放。如果您不希望使用短视频 SDK，我们也提供了独立的 [播放器 SDK](https://cloud.tencent.com/document/product/266/7836)。
