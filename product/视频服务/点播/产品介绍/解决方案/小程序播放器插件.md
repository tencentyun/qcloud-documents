小程序播放器插件是云点播提供的短视频在小程序端播放的解决方案。该插件含有《信息网络传播视频许可证》的资质证书备案，同时可以帮助客户集成视频能力，将视频简单快捷地在集成在微信小程序端上播放，便于用户制作、编辑、集成并通过互联网向公众提供音视频节目。
小程序播放器插件依托于云点播成熟的一站式服务平台，提供视频上传、视频处理、视频分发、视频 AI 及视频内容保护等功能，有效提高视频服务质量。 
...
2. 访问 [云点播控制台](https://console.cloud.tencent.com/vod)，获取 [云点播 APPID](https://console.cloud.tencent.com/developer)，用于接入小程序播放器插件。


####  注册小程序
在 [微信公众平台](https://mp.weixin.qq.com/) 注册并登录小程序，小程序类目请根据您的实际场景选择。
>?小程序播放器插件仅限非个人主体小程序使用。
...
## 功能列表
小程序播放器插件提供的详细功能清单如下，同时请关注小程序官方 [video 文档](https://developers.weixin.qq.com/miniprogram/dev/component/video.html)，及时了解功能更新。
...
## 购买流程
如需**购买**云点播的小程序播放器插件服务，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。


## 购买指南
#### 计费价格
小程序播放器插件费用由两部分产生：云点播插件使用费和视频播放次数费用，详情如下表。

|计费项|计费方式|单价
---------|----------|-----
|小程序播放器插件服务费| 预付费 - 按年数|30000元/年
...
例如，用户 A 于2018年08月01日购买了2个小程序播放器插件，则该插件的有效期为2020年08月01日。
