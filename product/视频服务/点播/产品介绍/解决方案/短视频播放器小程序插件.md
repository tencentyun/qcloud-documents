云点播短视频播放器插件，是一个短视频在小程序端播放的解决方案。该插件含有《信息网络传播视频许可证》的资质证书备案，同时可以帮助客户集成视频能力，将视频简单快捷地在集成在微信小程序端上播放，便于用户制作、编辑、集成并通过互联网向公众提供音视频节目。
云点播短视频播放器插件依托于云点播成熟的一站式服务平台，提供视频上传、视频处理、视频分发、视频 AI 及视频内容保护等功能，有效提高视频服务质量。 
...
2. 访问 [云点播控制台](https://console.cloud.tencent.com/vod)，获取 [云点播 APPID](https://console.cloud.tencent.com/developer)，用于接入云点播短视频播放器插件。


####  注册小程序
在 [微信公众平台](https://mp.weixin.qq.com/) 注册并登录小程序，小程序类目请根据您的实际场景选择。
>?云点播短视频播放器小程序插件仅限非个人主体小程序使用。
...
用户需要申请并等待插件开发者通过后，即可在小程序中使用相应插件，详细请查阅微信官方的插件 [使用文档](https://mp.weixin.qq.com/debug/wxadoc/dev/framework/plugin/using.html)，申请插件权限。
...
## 功能列表
云点播短视频播放器插件提供的详细功能清单如下，同时请关注小程序官方 [video 文档](https://developers.weixin.qq.com/miniprogram/dev/component/video.html)，及时了解功能更新。
...
## 购买流程
如需**购买**云点播短视频播放器插件服务，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。


## 购买指南
### 计费价格
短视频播放器插件费用由两部分产生：云点播插件使用费和视频播放次数费用，详情如下表。

|计费项|计费方式|单价
---------|----------|-----
|短视频播放器插件服务费| 预付费 - 按年数|30000元/年
|小程序端视频播放次数|后付费 - 按次数|0.3元/次

其余使用云点播产生的费用，详细请参见 [云点播 - 计费方式](https://cloud.tencent.com/document/product/266/14666)。 
### 计费说明
+ 如果购买多个插件，则使用期限在插件上叠加。
例如，用户 A 于2018年08月01日购买了2个短视频播放器插件，则该插件的有效期为2020年10月01日。
