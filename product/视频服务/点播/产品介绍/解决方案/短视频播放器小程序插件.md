...
云点播短视频播放器插件依托于腾讯云点播成熟的一站式服务平台，提供视频上传、视频处理、视频分发、视频 AI 及视频内容保护等功能，有效提高视频服务质量。
>? **购买流程**：如需购买云点播短视频播放器插件服务，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
...
云点播会对审核后的视频显示发布状态，用来标识该视频是否可以发布：
	...
	+ 如果发布状态为发布失败，则表示该视频可能涉嫌违规，需由用户重新审核，若用户审核无误，请 [提交工单](https://console.cloud.tencent.com/workorder/category) 反馈。
...
## 功能列表
云点播短视频播放器插件提供的详细功能清单如下，同时请关注小程序官方 video 文档，及时了解功能更新。
...
| poster | string | - | 否 | 视频封面的图片网络资源地址或云文件ID（2.3.0）。如果 controls 属性值为 false，则设置 poster 无效 |
