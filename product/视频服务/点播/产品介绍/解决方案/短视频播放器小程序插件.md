短视频播放器小程序插件是云点播提供的短视频在小程序端播放的解决方案。该插件含有《信息网络传播视频许可证》的资质证书备案，同时可以帮助客户集成视频能力，将视频简单快捷地在集成在微信小程序端上播放，便于用户制作、编辑、集成并通过互联网向公众提供音视频节目。
...
## 购买流程
如需**购买**云点播的短视频播放器小程序插件服务，请 [提交工单](https://console.cloud.tencent.com/workorder/category)。
