...
1. 云点播控制台 导航栏选择**媒资管理**>**音视频管理**，单击**上传音视频**，上传一个视频。（建议上传的视频时长大于6分钟。）
...
1. 在 **[步骤3](#step3)** 中获取到的播放 URL 中加入 QueryString，参数名为 uid，参数为任意的8位十六进制整数（例如1234abcd），得到 URL 类似 `http://xxx.vod2.myqcloud.com/xxx/xxx/xxx.m3u8?uid=1234abcd`，将链接贴到浏览器中播放。
