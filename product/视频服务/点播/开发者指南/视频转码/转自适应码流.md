...
>?
- 转自适应码流的目标规格，包含了“转哪些码率的视频流”、“转哪些码率的音频流”等参数。云点播使用转自适应码流模板表示参数集合，具体请参见 [转自适应码流模板](https://cloud.tencent.com/document/product/266/34049?!editLang=zh&!preview#.E8.BD.AC.E8.87.AA.E9.80.82.E5.BA.94.E7.A0.81.E6.B5.81.E6.A8.A1.E6.9D.BF)。
- 转自适应码流是一种离线任务，发起方式请参见 [任务发起](https://cloud.tencent.com/document/product/266/34049?!editLang=zh&!preview#.E4.BB.BB.E5.8A.A1.E5.8F.91.E8.B5.B7) 和 [结果获取](https://cloud.tencent.com/document/product/266/34049?!editLang=zh&!preview#.E7.BB.93.E6.9E.9C.E8.8E.B7.E5.8F.96)。
...
## 结果获取
发起转自适应码流任务后，可以通过异步等待 [结果通知](https://cloud.tencent.com/document/product/266/33475?!preview&!editLang=zh#.E7.BB.93.E6.9E.9C.E9.80.9A.E7.9F.A5) 和同步进行 [任务查询](https://cloud.tencent.com/document/product/266/33475?!preview&!editLang=zh#.E4.BB.BB.E5.8A.A1.E6.9F.A5.E8.AF.A2) 两种方式获取视频转自适应码流任务的执行结果。下面是发起内容审核任务后，普通回调方式的结果通知例子：
```json
{
