...
事件通知分为“普通回调”和“可靠回调”两种方式，您可以登录 [云点播控制台](https://console.cloud.tencent.com/video) 设置回调模式，选择您需要接收回调的事件，具体操作请参考 [回调设置](https://cloud.tencent.com/document/product/266/33781)。
