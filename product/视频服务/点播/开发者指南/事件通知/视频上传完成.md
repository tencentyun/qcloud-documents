...
## 事件说明
App 配置事件通知后，并且将视频通过客户端或服务端上传，App 后台即可通过“普通回调”或“可靠回调”的方式获取该事件通知。事件通知内容为 [FileUploadTask 结构](https://cloud.tencent.com/document/api/266/31773#FileUploadTask)。
