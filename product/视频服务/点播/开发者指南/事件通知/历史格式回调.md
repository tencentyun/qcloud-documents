...
- 同时可见【2.0回调 URL】和【3.0回调 URL】，说明您正在使用2.0格式普通回调，**请继续阅读后面的内容**。
...
| output.suggestion | String | 鉴黄结果建议，有 pass、review 和 block 三种。 |
...
| output.segments.suggestion | Float | 嫌疑片段鉴黄结果建议，有 pass、review 和 block 三种。 |
