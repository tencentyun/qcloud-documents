...
视频转码后，参考 [结果获取](链接到锚点结果获取) 可以获得转码后视频播放的 URL。您可以使用自有播放器或第三方播放器，播放转码后的视频。

>! 转码功能主要适用于**短视频**的场景。对于**长视频**（视频网站、在线教育等），使用 [转自使用码流](https://cloud.tencent.com/document/product/266/34071) 将为您和您的用户带来更好的体验。
