...
| uid | 否 | String | <ul style="margin:0;"><li>播放者的 ID，以十六进制表示，共8位，该参数用于溯源水印使用场景</li><li>具体含义和取值参见 [防盗链参数](https://cloud.tencent.com/document/product/266/14047#.E9.98.B2.E7.9B.97.E9.93.BE-url-.E7.94.9F.E6.88.90.E6.96.B9.E5.BC.8F) 中的 uid 参数</li> |
