...
然后，业务服务器使用 ServerEncapsuleKey 和 ServerEncapsuleIv 对 ClientEncapsuleKey 本身进行加密，生成 EncryptedEncapsuleKey；使用 ServerEncapsuleKey 和 ServerEncapsuleIv 对 ClientEncapsuleIv 本身进行加密，生成 EncryptedEncapsuleIv。
