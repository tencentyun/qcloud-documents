...
| 参数名称 | 类型 | 说明 |
| -- | -- | -- |
| SecretId | String | 云 API 密钥中的 SecretId，获取方式参考 [获取云 API 密钥](https://cloud.tencent.com/document/product/266/9219#.E8.8E.B7.E5.8F.96.E4.BA.91-api-.E7.A7.98.E9.92.A5)。 |
...
1. **获取 API 密钥**：参考 [获取云 API 密钥](https://cloud.tencent.com/document/product/266/9219#.E8.8E.B7.E5.8F.96.E4.BA.91-api-.E7.A7.98.E9.92.A5) 获取或者创建一个 SecretId，并拿到对应的 SecretKey。
...
1. **生成秘钥和 CSR**：在一台 macOS 机器上，使用 openssl 命令行生成秘钥和 CSR。
	- 执行以下命令，生成秘钥对文件`privatekey.pem`：
```
...
```
2. **获取 ASK 和 FPS 证书**：
	1. 登录 Apple 的 [开发者账号](developer.apple.com/account)，单击【+】按钮请求一个新证书，并在【Development】下选择【FairPlay Streaming Test Certificate】选项。
