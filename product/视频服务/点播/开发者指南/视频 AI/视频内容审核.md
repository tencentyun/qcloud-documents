...
* 调用服务端 API [ProcessMedia](https://cloud.tencent.com/document/product/266/33427) 发起任务：在请求中的`AiContentReviewTask`参数指定 [视频内容审核模板](《链接到“视频内容审核模板”》) 的模板 ID；
* 调用服务端 API [ProcessMediaByUrl](https://cloud.tencent.com/document/product/266/33426) 发起任务：在请求中的`AiContentReviewTask`参数指定 [视频内容审核模板](《链接到“视频内容审核模板”》) 的模板 ID；
