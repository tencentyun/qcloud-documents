...
>?
- 通过视频内容审核参数，可以控制审核任务执行以上7种操作中的哪几项操作。云点播使用视频内容审核模板来表示智能审核参数集合，具体请参见 [视频内容审核模板](https://cloud.tencent.com/document/product/266/33498?!editLang=zh&!preview#.E8.A7.86.E9.A2.91.E5.86.85.E5.AE.B9.E5.AE.A1.E6.A0.B8.E6.A8.A1.E6.9D.BF)。
- 视频内容审核是一种离线任务，发起方式请参见 [任务发起](https://cloud.tencent.com/document/product/266/33498?!editLang=zh&!preview#.E4.BB.BB.E5.8A.A1.E5.8F.91.E8.B5.B7) 和 [结果获取](https://cloud.tencent.com/document/product/266/33498?!editLang=zh&!preview#.E7.BB.93.E6.9E.9C.E8.8E.B7.E5.8F.96)。
...
* 调用服务端 API [ProcessMedia](https://cloud.tencent.com/document/product/266/33427) 发起任务：在请求中的 AiContentReviewTask.Definition 参数指定 [视频内容审核模板](https://cloud.tencent.com/document/product/266/33498?!preview&!editLang=zh#.E8.A7.86.E9.A2.91.E5.86.85.E5.AE.B9.E5.AE.A1.E6.A0.B8.E6.A8.A1.E6.9D.BF) 的模板 ID。
* 调用服务端 API [ProcessMediaByUrl](https://cloud.tencent.com/document/product/266/33426)  发起任务：在请求中的 AiContentReviewTask.Definition 参数指定 [视频内容审核模板](https://cloud.tencent.com/document/product/266/33498?!preview&!editLang=zh#.E8.A7.86.E9.A2.91.E5.86.85.E5.AE.B9.E5.AE.A1.E6.A0.B8.E6.A8.A1.E6.9D.BF) 的模板 ID。
...
* 服务端上传时指定任务：在控制台 [添加任务流](https://cloud.tencent.com/document/product/266/14058#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E4.BB.BB.E5.8A.A1.E6.B5.81)，任务流中开启视频内容审核； 在 [客户端上传签名](https://cloud.tencent.com/document/product/266/9221#.E7.AD.BE.E5.90.8D.E5.8F.82.E6.95.B0) 中的```procedure```参数指定为该任务流；
* 客户端上传时指定任务：在控制台 [添加任务流](https://cloud.tencent.com/document/product/266/14058#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E4.BB.BB.E5.8A.A1.E6.B5.81)，任务流中开启视频内容审核；在 [客户端上传签名](https://cloud.tencent.com/document/product/266/9221#.E7.AD.BE.E5.90.8D.E5.8F.82.E6.95.B0) 中的```procedure```指定该任务流；
