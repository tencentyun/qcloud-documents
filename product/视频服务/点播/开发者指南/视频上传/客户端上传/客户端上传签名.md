...
| storageRegion | 否 | String | 指定存储地域，可以在控制台上自助添加存储地域，详情可参考 [上传存储设置](/document/product/266/14059)，该字段填写为存储地域的 [英文简称](/document/product/266/9760#.E4.B8.8A.E4.BC.A0.E5.AD.98.E5.82.A8)。|
