...
[](id:editor)
>?
>- 互联网有许多基于 Web 且免费的在线调试工具，您可通过此类工具绘制满意的 SVG，完成后即可导出 XML。
>- 对于精细化设置（例如元素对齐属性、字体大小等），可手工修改 XML。确认最终效果，得到 XML 代码。

## 简单应用 SVG 水印
### 步骤1：调试 SVG 水印效果
1. 通过 [SVG 调试工具](#editor)，调试满意的图形，操作全程所见即所得。完成后，将 SVG 保存为后缀 `.html` 文件后使用浏览器打开查看效果。
...
## 复杂应用 SVG 水印[](id:example)
下文将通过具体的案例为您介绍如何添加复杂水印，把品牌 Logo + 用户 ID 水印输出最终效果，请参见下面详细说明。
...
将上面这段代码保存至后缀为 `.html` 的文件，在浏览器打开可看到水印效果为图2：白色背景。

| 图1：透明背景| 图2：白色背景 | 图3：黑色背景 |
|---------|---------|---------|
|![](https://main.qcloudimg.com/raw/5e6aaff07cf4095895a6ea3c2e2fb44d.png)|![水印效果](https://main.qcloudimg.com/raw/7b139cbc39463ef83db0a49e4800a8e6.png "水印效果")|![](https://main.qcloudimg.com/raw/1ba0bb868747950eb5716bdefd41fc57.png)|
...
|`<filter id="filter">`|定义要用到的滤镜。|`stdDeviation="2"`|
...
如有其他字体需求，请联系 [技术支持](https://tcloud-doc.isd.com/document/product/266/19905?!preview&!editLang=zh#.E6.8A.80.E6.9C.AF.E4.BA.A4.E6.B5.81)。
