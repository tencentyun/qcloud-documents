...
参考 [快速入门-步骤2](https://cloud.tencent.com/document/product/266/8757#.E6.AD.A5.E9.AA.A42.EF.BC.9A.E4.B8.8A.E4.BC.A0.E8.A7.86.E9.A2.91) 上传一个测试视频。本 Demo 使用的测试视频为 [视频链接](http://1400329073.vod2.myqcloud.com/ff439affvodcq1400329073/e968a7e55285890804162014755/LKk92603oW0A.mp4)，对应的 FileId 为5285890804162014755，如下图：

![](https://main.qcloudimg.com/raw/48fece7109210b6e69ef34fa19f50a97.png)

> ?建议使用较短的视频文件进行测试（比如时长为几十秒），避免转码过程耗时太长。

### 步骤3：发起转码<span id="p13"></span>

- 在控制台 [媒资管理](https://console.cloud.tencent.com/vod/media) 页面勾选刚才上传的测试视频，然后点击【视频处理】按钮：

![](https://main.qcloudimg.com/raw/e9987e58e8cc81803f9b737010b2705c.png)

- 在弹出的对话框中，处理类型适用默认的【转码】，然后点击【转码模版】：

  ![](https://main.qcloudimg.com/raw/cdb75f1248cc3f83d49b3c0833fbb2d8.png)

- 选择所需的转码模版，然后点击【确定】按钮。本 Demo 以系统预置模版 MP4-FLU（模版 ID 100010）和 MP4-SD（模版 ID 100020）为例，如果开发者需要使用自定义的转码模版，请参考 [模版配置](https://cloud.tencent.com/document/product/266/33818#.E8.A7.86.E9.A2.91.E8.BD.AC.E7.A0.81.E6.A8.A1.E6.9D.BF) 的说明。

  ![](https://main.qcloudimg.com/raw/e19dc4df67c67e577f7c574c0e7c7237.png)

- 点击【确定】，发起转码：

  ![](https://main.qcloudimg.com/raw/38c350b064bb08c73a01f8fa071c5c18.png)

- 在媒资管理页面看到测试视频的状态为【处理中】，则表示视频正在转码：

  ![](https://main.qcloudimg.com/raw/2ae3cf1470cd53bc96b9402ebb231342.png)

### 步骤4：查看转码结果<span id="p14"></span>

- 在控制台 [媒资管理](https://console.cloud.tencent.com/vod/media) 页面等待测试视频的状态变回【正常】，此时表示转码已完成。点击测试视频右侧的【管理】按钮，进入视频管理页面

  ![](https://main.qcloudimg.com/raw/40c20aae319e0f4c3b30a333578cdf7f.png)

- 在【基本信息】标签页下的【标准转码列表】中，可以看到转出了 MP4-FLU 和 MP4-SD 两个规格。开发者可以点击右侧的【预览】按钮直接观看视频，也可以点击【复制地址】按钮复制转码视频的 URL，然后通过其它渠道发布给观众。

  ![](https://main.qcloudimg.com/raw/363e9ccf90b23b9af3534227d2960e94.png)
...
- 执行`process_media.py`脚本发起转码：
  ...
  该命令将对5285890804162014755这个视频发起 [`ProcessMedia`](https://cloud.tencent.com/document/product/266/33427) 请求，按 VOD [预置转码模版](https://cloud.tencent.com/document/product/266/33476#.E9.A2.84.E7.BD.AE.E8.BD.AC.E7.A0.81.E6.A8.A1.E6.9D.BF) 100010和100020两个规格进行转码，并打印请求的应答内容：
...
- 等待测试视频的状态变回【正常】，此时表示转码已完成。点击测试视频右侧的【管理】按钮，进入视频管理页面
...
VOD 有多种上传视频的方式，包括控制台上传、服务端上传、客户端上传和 URL 拉取上传等（详见 [媒体上传综述](https://cloud.tencent.com/document/product/266/9760)）。各种上传方式均支持指定一个 [任务流](https://cloud.tencent.com/document/product/266/33475#.E4.BB.BB.E5.8A.A1.E6.B5.81)，在上传完成后自动触发转码。任务流的使用方法将在单独的最佳实践文档中进行介绍（即将上线）。

## 上传视频后自动转码（事件通知）

VOD 后台在视频上传完成和转码任务完成后均会发起 [事件通知](https://cloud.tencent.com/document/product/266/33779) 给开发者预先配置好的事件通知接收服务。开发者可以利用事件通知机制来对新上传的视频发起转码，也可以通过事件通知来自动获取转码结果（上文展示的方法是人工在控制台查看转码结果）。事件通知的使用方法在单独的最佳实践文档 [如何接收事件通知](https://cloud.tencent.com/document/product/266/45366) 中有详细介绍。
