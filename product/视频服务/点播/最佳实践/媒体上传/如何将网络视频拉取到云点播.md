...
- 消耗 VOD 存储用于存储拉取上传的视频，详见 [存储计费](https://cloud.tencent.com/document/product/266/14666#.E8.A7.86.E9.A2.91.E5.AD.98.E5.82.A8) 和 [存储资源包](https://cloud.tencent.com/document/product/266/14667#1.-.E5.AD.98.E5.82.A8.E8.B5.84.E6.BA.90.E5.8C.85)。
...
访问云点播控制台 [上传页面](https://console.cloud.tencent.com/vod/media/upload)，上传方式选择【视频拉取】，然后点击【添加一行】，填写待拉取视频的 URL（本文以 [测试视频 URL](http://1400329073.vod2.myqcloud.com/ff439affvodcq1400329073/e968a7e55285890804162014755/LKk92603oW0A.mp4) 为例；其余项为选填，开发者可以根据需要进行填写），然后点击左下角的【拉取视频】：

![](https://main.qcloudimg.com/raw/7f3d1e304b5422d45cd4f1daa7611429.png)

> ?拉取视频所花费的时间和视频文件的大小成正比。建议开发者选择较小的视频（比如几十MB以内）进行测试，避免长时间等待。

### 步骤3：查看拉取结果<span id="p13"></span>

等待一两分钟后（根据视频文件的大小有所差别），在 [媒资管理页面](https://console.cloud.tencent.com/vod/media) 可以看到已经拉取完成的视频：

![](https://main.qcloudimg.com/raw/5427d60c501ca5d13076c69b134f3225.png)
...
![](https://main.qcloudimg.com/raw/f80594c3c77c10d7fa6c364eb71de78d.png)
