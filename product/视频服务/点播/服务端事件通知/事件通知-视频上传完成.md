...
| data.author | String | 录制特有参数，标明作者是谁  |
| data.sourceType | String | 文件上传的来源 |
| data.sourceContext | String | 对录制来说是推流信息，转拉即源站地址，上传用作透传字段 |
| data.streamId | String | 录制特有参数，推流id |
| data.procedureTaskId | String | 如果该视频上传之后配置了指定流程，则该参数为流程任务id |
