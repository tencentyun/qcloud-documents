...
| data.drm | Object | 文件加密信息，用户在发起任务流时若指定了加密，该字段才存在  |
| data.processTaskList | Array | 任务流包含的任务列表，参见[processTaskList说明]  |
...
#### processTaskList（任务列表）说明**
任务列表，目前有转码任务，采样截图任务，雪碧图截图任务。
