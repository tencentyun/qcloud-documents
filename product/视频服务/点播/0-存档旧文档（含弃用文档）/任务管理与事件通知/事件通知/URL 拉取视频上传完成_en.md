...
## Event Description
If an APP is configured with event notification, after a URL pulling task is completed, VOD backend will notify the APP backend of the event.

For more information about the way in which the APP backend receives the event notification, see [Introduction to Server Event Notification](/document/product/266/7829).
