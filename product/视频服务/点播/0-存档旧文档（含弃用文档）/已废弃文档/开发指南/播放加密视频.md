...
| 参数名称 | 类型 | 说明 |
| -- | -- | -- |
| SecretId | String | 云 API 密钥中的 SecretId，获取方式参考 [获取云 API 密钥](https://cloud.tencent.com/document/product/266/9219#p3)。 |
...
1. **获取 API 密钥**：参考 [获取云 API 密钥](https://cloud.tencent.com/document/product/266/9219#p3) 获取或者创建一个 SecretId，并拿到对应的 SecretKey。
...
2. **获取 ASK 和 FPS 证书**：
	...
	<img src="https://main.qcloudimg.com/raw/25795a838ca2d098cdcb8487755416f5.png" width="660">
	2. 上传 CSR 文件（即`cert.pem`），并单击【Generate】。
	<img src="https://main.qcloudimg.com/raw/b2fec9b771b42304f274b746c963a879.png" width="660">
	3. 将生成的 ASK 记录下来，并在下图的文本框中将 ASK 输入，再单击【Continue】。
	<img src="https://main.qcloudimg.com/raw/03f662daa576f671a22e2e67cf436877.png" width="660">
	4. 生成 FPS 证书后，单击【Download】下载证书。
	<img src="https://main.qcloudimg.com/raw/db978fbdeb1ffc544cb51759cd281b95.png" width="660">
3. **提交 ASK 和 FPS 证书**
