...
<img src="https://main.qcloudimg.com/raw/dc2bacdaea59777daeff97ab0a985b97.png" width="800" />
...
| expireTimeStamp | 否 | Integer | 派发签名到期 Unix 时间戳，不填表示签名派发后1天内过期 |
...
UrlTimeExpire = hex(CurrentTime + 3600)[2:]
...
class Main {
    public static void main(String[] args) {
        ...
        Integer CurrentTime = System.currentTimeMillis()/1000L;
        Integer PsignExpire = CurrentTime + 3600;
        String UrlTimeExpire = Integer.toHexString(CurrentTime + 3600);
