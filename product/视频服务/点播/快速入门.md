...
2. 在页签栏选择【水印模板】。
3. 单击【创建水印模板】，在该页面进行如下设置，最后单击【创建】。
![](https://main.qcloudimg.com/raw/0bd26c5d4d7691e796d5fffd6b90adcc.png)
...
2. 在【基本设置】配置项，【播放器名称】设置为 player001，【默认画质】选择为【标清】，其他选项为默认设置。
3. 在【外观】配置项，【logo 图片】从本地选择一张图片（以腾讯视频 LOGO 为例）。
4. 在【贴片】配置项，开启【暂停贴片】，单击【选择文件】，从本地选择一张图片（以腾讯视频 LOGO 为例），其他选项为默认设置。
6. 设置完毕后，单击【确定】。  
