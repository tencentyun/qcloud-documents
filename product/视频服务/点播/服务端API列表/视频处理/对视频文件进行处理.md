...
任务执行完毕之后，每项异步任务的执行结果（例如转码输出文件URL）可以通过[获取视频信息V2](/document/product/266/8586)接口获得。
...
| coverBySnapshot | 否 | Object | 参见[使用截图设置封面](#coverbysnapshot.EF.BC.88.E4.BD.BF.E7.94.A8.E6.88.AA.E5.9B.BE.E8.AE.BE.E7.BD.AE.E8.A7.86.E9.A2.91.E5.B0.81.E9.9D.A2.EF.BC.89) |
...
| watermark | 否 | Integer | 参见[水印参数模板](/document/product/266/9647)。 |
