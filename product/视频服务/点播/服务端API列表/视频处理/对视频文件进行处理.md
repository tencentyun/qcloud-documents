...
| snapshotByTimeOffset | 否 | Object | 参见[指定时间点截图控制参数](#coverbysnapshot.EF.BC.88.E4.BD.BF.E7.94.A8.E6.88.AA.E5.9B.BE.E8.AE.BE.E7.BD.AE.E8.A7.86.E9.A2.91.E5.B0.81.E9.9D.A2.E6.8E.A7.E5.88.B6.E5.8F.82.E6.95.B0.EF.BC.89) |
...
| **参数名称** | **必填** | **类型** | **描述** |
|---------|---------|---------|---------|
| definition | 是 | Array | 转码输出模板号，参见[转码参数模板](/document/product/266/8098)。 |
...
| timeOffset | 是 | Array | 整数数组，截图的时间戳，单位为毫秒。 |

任务流执行完毕之后，时间点截图信息可以从[snapshotByTimeOffsetInfo](snapshotbytimeoffsetinfo.EF.BC.88.E8.A7.86.E9.A2.91.E6.8C.87.E5.AE.9A.E6.97.B6.E9.97.B4.E7.82.B9.E6.88.AA.E5.9B.BE.E4.BF.A1.E6.81.AF.EF.BC.89)对象中获取到。。
