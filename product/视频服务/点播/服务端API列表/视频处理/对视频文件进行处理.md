...
| snapshotByTimeOffset | 否 | Object | 参见[指定时间点截图控制参数](#) |
...
任务流执行完毕之后，截图URL可以从[GetVideoInfo](/document/product/266/8586)接口应答包体中的[snapshotByTimeOffsetInfo](snapshotbytimeoffsetinfo.EF.BC.88.E8.A7.86.E9.A2.91.E6.8C.87.E5.AE.9A.E6.97.B6.E9.97.B4.E7.82.B9.E6.88.AA.E5.9B.BE.E4.BF.A1.E6.81.AF.EF.BC.89)对象中获取到。
