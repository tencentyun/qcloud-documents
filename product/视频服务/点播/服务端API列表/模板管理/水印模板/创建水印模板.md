...
> 注意：
> - 用户创建的水印模板数最最多16个。
> - 水印文件需要事先上传到点播系统。可以使用[ApplyWatermarkUpload](/document/product/266/11607)获取上传地址然后上传水印文件。
...
| url | 是 | String | 水印的url地址，该url必须为点播系统中的图片url，即申请上传水印文件ApplyWatermarkUpload返回的url |
