...
| video.width | 是 | Integer | 视频流宽度的最大值，若不填或者填0，而video.height填写了非0值，则按比例缩放，如果video.height也没填或者填0，则表示同源。 单位：px |
| video.height | 是 | Integer | 视频流高度的最大值，若不填或者填0，而video.width填写了非0值，则按比例缩放，如果video.width，则表示同源。单位：px |
