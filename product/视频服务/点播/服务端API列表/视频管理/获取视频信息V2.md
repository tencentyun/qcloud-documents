...
1. 该接口可以获取单个视频的多种信息，包括：
    ...
    5. 采样截图信息（sampleSnapshotInfo）：对视频采样节诶图后，相关截图信息；
...
| infoFilter.n | 否 | String | 指定需要返回的信息，可同时指定多个信息，n 从0开始递增。如果未填写该字段，默认返回所有信息。备选项：basicInfo（基础信息）、元信息（metaData）、加密信息（drm）、transcodeInfo（转码结果信息）、imageSpriteInfo（雪碧图信息）、snapshotByTimeOffsetInfo（指定时间点截图信息）。 |
...
#### snapshotInfo（转码采样截图信息）

| **参数名称** | **类型** | **描述** |
|---------|---------|---------|
| snapshotInfo.id | Integer | 截图序号 |
| snapshotInfo.url | String | 截图地址 |
| snapshotInfo.height | Integer | 截图高度 |
| snapshotInfo.width | Integer | 截图宽度 |
...
```javascript
{
 ...
    "snapshotInfo": [
        {
            "id": 1,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_0.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 2,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_1.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 3,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_2.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 4,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_3.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 5,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_4.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 6,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_5.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 7,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_6.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 8,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_7.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 9,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_8.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 10,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_9.jpg",
            "height": 640,
            "width": 360
        },
        {
            "id": 11,
            "url": "http://xxx.vod2.myqcloud.com/xxx/xxx/shotup/f0.100_10.jpg",
            "height": 640,
            "width": 360
        }
    ]
