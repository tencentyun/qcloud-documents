...
上文提到点播的视频处理主要基于 [视频处理任务流](https://cloud.tencent.com/document/product/266/33475#.E4.BB.BB.E5.8A.A1.E6.B5.81)。如果开发者需要在视频上传完成后自动发起任务流，可以在生成上传签名时通过 `procedure` 参数来实现。
