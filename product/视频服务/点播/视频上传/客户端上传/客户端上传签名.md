...
按照 URL QueryString 的格式要求生成签名明文串 Original<sup>注 1</sup>，格式如下：
...
生成签名明文串 Original 后，用已获取的 secretKey 对明文串进行 [HMAC-SHA1](https://www.ietf.org/rfc/rfc2104.txt) 加密，得到 SignatureTmp<sup>注 2</sup>：
