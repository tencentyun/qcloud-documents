...
- 上传小文件（小于5MB）使用的 API，详细参见 [简单上传文件](https://cloud.tencent.com/document/product/436/7749) 文档。
- 上传大文件（大于5MB）使用的 API，详细参见 [初始化分片上传](https://cloud.tencent.com/document/product/436/7746)、[逐个上传分片](https://cloud.tencent.com/document/product/436/7750) 和 [结束上传分片](https://cloud.tencent.com/document/product/436/7742) 文档。
