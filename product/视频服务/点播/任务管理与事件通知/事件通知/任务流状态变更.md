...
| output.segment | Array | 有涉黄嫌疑的视频片段 |
| output.segment.startTimeOffset | Float | 嫌疑片段起始的偏移时间 |
| output.segment.endTimeOffset | Float | 嫌疑片段结束的偏移时间 |
| output.segment.confidence | Float | 嫌疑片段涉黄分数 |
| output.segment.suggestion | Float | 嫌疑片段鉴黄结果建议，有 pass，review，block 三种 |
| output.segment.url | String | 涉黄嫌疑图片 URL（图片不会永久存储，在一段时间后失效） |
| output.segment.picUrlExpireTimeStamp | Integer | 涉黄嫌疑图片 URL 失效时间 |
...
| output.segment | Array | 有暴恐嫌疑的视频片段 |
| output.segment.startTimeOffset | Float | 嫌疑片段起始的偏移时间 |
| output.segment.endTimeOffset | Float | 嫌疑片段结束的偏移时间 |
| output.segment.confidence | Float | 嫌疑片段暴恐分数 |
| output.segment.suggestion | Float | 嫌疑片段暴恐结果建议，有 pass，review，block 三种 |
| output.segment.url | String | 暴恐嫌疑图片 URL （图片不会永久存储，在一段时间后失效）|
| output.segment.picUrlExpireTimeStamp | Integer | 暴恐嫌疑图片 URL 失效时间 |
