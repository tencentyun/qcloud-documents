...
| **参数名称** | **类型** | **描述** |
|---------|---------|---------|
| definition | Integer | AI鉴黄模板ID |
| riskType | Array | 字符串数组，标识AI审核到的该视频所有的风险类型，目前只有 Porn(涉黄)一种 |
| imgInfo.url | String | 检测的风险的截图url |
| imgInfo.riskType | String | 图片的风险类型，目前只有Porn(涉黄)一种 |
