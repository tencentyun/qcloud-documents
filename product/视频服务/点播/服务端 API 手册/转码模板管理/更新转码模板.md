...
| isFiltrateVideo | 否 | Integer | 去除视频数据，1：去除；0：保留。 |
| isFiltrateAudio | 否 | Integer | 去除音频数据，1：去除；0：保留。 |
| video | 是 | Object | 请参见 [视频流配置参数](#video.EF.BC.88.E8.A7.86.E9.A2.91.E6.B5.81.E9.85.8D.E7.BD.AE.E5.8F.82.E6.95.B0.EF.BC.89)（当 isFiltrateVideo 为1时，则该字段的值将被忽略）。 |
| audio | 是 | Object | 请参见 [音频流配置参数](#audio.EF.BC.88.E9.9F.B3.E9.A2.91.E6.B5.81.E9.85.8D.E7.BD.AE.E5.8F.82.E6.95.B0.EF.BC.89)（当 isFiltrateAudio 为1时，则该字段的值将被忽略）。 |
