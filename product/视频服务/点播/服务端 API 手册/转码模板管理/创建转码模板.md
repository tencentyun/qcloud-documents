...
| bitrate | 是 | Integer | 视频流的码率，大于等于128，小于等于10000，单位：kbps。 |
...
| 参数名称 | 必填 | 类型 | 说明 |
|---------|---------|---------|---------|
| codec | 是 | String | 音频流的编码格式，目前有 libfdk_aac（更适合 mp4 和 hls），libmp3lame（更适合 flv）。 |
| bitrate | 是 | Integer | 音频流的码率，大于等于26，小于等于256，单位：kbps。 |
| soundSystem | 否 | Integer | 音频通道方式，可填 1：双通道，2：双通道。默认为双通道。 |
| sampleRate | 是 | Integer | 音频流的采样率，可填 44100，48000 两个值，单位：Hz。|
