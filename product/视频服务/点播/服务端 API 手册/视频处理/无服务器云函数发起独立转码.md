...
## 创建部署程序包
下载点播提供的无服务器云[代码模版](https://main.qcloudimg.com/raw/63c82dcc941a538dee90ec8b6535b9cc.zip)，解压文件夹，修改配置文件参数 config.json，将 SecretId和 SecretKey修改为您的实际参数，并将代码打包成 `RequestVideoTranscodeDemo.zip`。
