...
**注意**：输入文件 Bucket 和输出文件 Bucket 需要先完成[配置操作](/document/product/266/16923)。
...
**注意**：公测阶段，VTS 配置事件通知需要在[点播控制台](/document/product/266/7829#.E9.85.8D.E7.BD.AE.E6.96.B9.E6.B3.95)上进行。
...
| mediaCheck | 否 | Object| 参见[视频鉴黄参数](#mediacheck.EF.BC.88.E8.A7.86.E9.A2.91.E9.89.B4.E9.BB.84.E5.8F.82.E6.95.B0.EF.BC.89) |
...
| 参数名称 | 必填 | 类型 | 说明 |
|---------|---------|---------|---------|
| bucket | 是 | String | 输出文件 Bucket（需要先完成[配置操作](/document/product/266/16923)） |
| dir | 是 | String | 输出文件目录 |
