...
| 参数名称 | 必填 | 类型 | 说明 |
|---------|---------|---------|---------|
| bucket | 是 | String | 输入文件 Bucket（需要先完成[配置操作](/document/product/266/16923)）（注2）|
...
> 注2
> 新版 COS 控制台，显示的 Bucket 名会在末尾拼上开发商的 AppId （例如，开发者的 AppId 是 1250001，创建的 Bucket 名为 myinputbucket，则显示的 Bucket 名为 myinputbucket-1250001）。
> 这里填入的 Bucket 参数应为**不带后缀**的 Bucket 名（即 myinputbucket）。
...
| terrorism | 否 | Object | 参见[暴恐审核控制参数](#terrorism.EF.BC.88.E6.9A.B4.E6.81.90.E5.AE.A1.E6.A0.B8.E6.8E.A7.E5.88.B6.E5.8F.82.E6.95.B0.EF.BC.89) |
...
| 参数名称 | 必填 | 类型 | 说明 |
|---------|---------|---------|---------|
| definition | 是 | Integer | 鉴黄模板号，参见[暴恐参数模板](/document/product/266/17914#.E9.A2.84.E7.BD.AE.E6.9A.B4.E6.81.90.E6.A8.A1.E6.9D.BF) |
