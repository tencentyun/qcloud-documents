...
| watermark | 否 | Integer | 参见[水印参数模板](https://cloud.tencent.com/document/product/266/33479#.E6.B0.B4.E5.8D.B0.E6.A8.A1.E6.9D.BF)。填1表示使用控制台默认水印，指定水印则填写水印ID（整数）， 不填则不带水印 |
