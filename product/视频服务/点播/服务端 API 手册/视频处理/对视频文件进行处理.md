...
| **参数名称** | **必填** | **类型** | **描述** |
|---------|---------|---------|---------|
| definition | 是 | Array | 转码输出模板号，请参见 [转码参数模板](https://cloud.tencent.com/document/product/266/33478#.3Cspan-id-.3D-.22zm.22-.3E.3C.2Fspan.3E.E8.BD.AC.E7.A0.81.E6.A8.A1.E6.9D.BF)。|
| watermark | 否 | Integer | 请参见 [水印参数模板](https://cloud.tencent.com/document/product/266/33479#.3Cspan-id-.3D-.22sy.22.3E.3C.2Fspan.3E.E6.B0.B4.E5.8D.B0.E6.A8.A1.E6.9D.BF)。填1表示使用控制台默认水印，指定水印则填写水印 ID（整数）， 不填则不带水印。 |
...
| **参数名称** | **必填** | **类型** | **描述** |
|---------|---------|---------|---------|
| definition | 是 | Array | 转动图模板号，请参见 [转动图参数模板](https://cloud.tencent.com/document/product/266/33481#.3Cspan-id-.3D-.22zdt.22.3E.3C.2Fspan.3E.E8.BD.AC.E5.8A.A8.E5.9B.BE.E6.A8.A1.E6.9D.BF)。 |
...
| watermarkDefinition | 否 | Array | 水印模板号，请参见 [水印参数模板](https://cloud.tencent.com/document/product/266/33479#.3Cspan-id-.3D-.22sy.22.3E.3C.2Fspan.3E.E6.B0.B4.E5.8D.B0.E6.A8.A1.E6.9D.BF)。|
...
| **参数名称** | **必填** | **类型** | **描述** |
|---------|---------|---------|---------|
| definition | 是 | Integer | 鉴黄模板号，请参见 [鉴黄参数模板](https://cloud.tencent.com/document/product/266/33498#.3Cspan-id-.3D-.22sh.22.3E.3C.2Fspan.3E.E8.A7.86.E9.A2.91.E5.86.85.E5.AE.B9.E5.AE.A1.E6.A0.B8.E6.A8.A1.E6.9D.BF)。 |
