...
任务执行完毕之后，每项异步任务的执行结果（例如转码输出文件 URL）可以通过 [GetVideoInfo](/document/product/266/8586) 接口获得。

## 事件通知

任务流状态变更（或者处理完成）会触发 [事件通知 - 任务流状态变更通知](/document/product/266/9636)。App 后台可据此监听任务流的执行状态。

更多参见 [服务端事件通知简介](https://cloud.tencent.com/document/product/266/33779)。
...
| classificationAIAnalysis | 否 | Object | 参见 [智能分类控制参数](#classificationaianalysis.EF.BC.88.E6.99.BA.E8.83.BD.E5.88.86.E7.B1.BB.E6.8E.A7.E5.88.B6.E5.8F.82.E6.95.B0.EF.BC.89)。 |
| tagAIAnalysis | 否 | Object | 参见 [智能标签控制参数](#tagaianalysis.EF.BC.88.E6.99.BA.E8.83.BD.E6.A0.87.E7.AD.BE.E6.8E.A7.E5.88.B6.E5.8F.82.E6.95.B0.EF.BC.89)。 |
...
>? 对视频进行**智能分类**和**智能标签**，需要满足原始视频小于**100MB**，视频封装格式必须为 **MP4、FLV 和 AVI** 三种封装格式。

#### transcode（转码控制参数）

| **参数名称** | **必填** | **类型** | **描述** |
|---------|---------|---------|---------|
| definition | 是 | Array | 转码输出模板号，参见 [转码参数模板](https://cloud.tencent.com/document/product/266/33478#.E8.BD.AC.E7.A0.81.E6.A8.A1.E6.9D.BF)。|
| watermark | 否 | Integer | 参见 [水印参数模板](https://cloud.tencent.com/document/product/266/33479#.E6.B0.B4.E5.8D.B0.E6.A8.A1.E6.9D.BF)。填1表示使用控制台默认水印，指定水印则填写水印 ID（整数）， 不填则不带水印。 |
