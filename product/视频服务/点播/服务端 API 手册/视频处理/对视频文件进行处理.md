...
| animatedGraphics | 否 | Object | 参见[转动图控制参数]() |
...
| **参数名称** | **必填** | **类型** | **描述** |
|---------|---------|---------|---------|
| definition | 是 | Array | 转动图模板号，参见[转动图参数模板](/document/product/266/11702)。 |
| startTime | 否 | Integer | 动图在视频中的开始时间
| endTime | 否 | Integer | 动图在视频中的结束时间

任务流执行完毕之后，转动图结果可以从[GetVideoInfo](https://cloud.tencent.com/document/product/266/8586)接口应答包体中的[animatedGraphicsInfo](/document/product/266/8586对象获取到。
