...
| animatedGraphicsList.height | 动图的高度。单位：px |
| animatedGraphicsList.width | 动图的宽度。单位：px |
| animatedGraphicsList.bitrate | 动图码率。 单位：bps |
| animatedGraphicsList.size | 动图大小。单位：字节 |
| animatedGraphicsList.md5 | 动图的md5值 |
| animatedGraphicsList.startTime | 动图在视频中的起始时间。单位：秒 |
| animatedGraphicsList.endTime | 动图在视频中的结束时间。单位：秒 |
