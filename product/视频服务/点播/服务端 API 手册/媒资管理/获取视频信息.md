...
| segments.startTimeOffset | Float | 嫌疑片段起始的偏移时间 |
| segments.endTimeOffset | Float | 嫌疑片段结束的偏移时间 |
...
| segments.picUrlExpireTimeStamp | Integer | 涉黄嫌疑图片 URL 失效时间 |
...
| segments.picUrlExpireTimeStamp | Integer | 暴恐嫌疑图片 URL 失效时间 |
