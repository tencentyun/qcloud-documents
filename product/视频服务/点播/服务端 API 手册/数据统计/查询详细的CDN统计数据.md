...
| interval      | 否   | Integer | 统计数据的时间间隔，单位为分钟。如果 startDate 不等于 endDate 将忽略该参数，按天返回每天汇总的统计数据。如果 startDate 等于 endDate ，interval 可以取的值有<ul><li>5：每5分钟汇总一个统计数据</li><li>30：每30分钟汇总一个统计数据</li><li>60：每小时汇总一个统计数据</li><li>120：每2小时汇总一个统计数据</li></ul> |
