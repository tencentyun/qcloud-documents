...
1. 可以查询最近90天的数据。
2. 统计数据的时间间隔可能是每5分钟汇总的统计数据，也可能是每天汇总的统计数据，根据请求的起始日期和结束日期的时间跨度以及请求的时间间隔来决定。
...
| interval      | 否   | Integer | 统计数据的时间粒度间隔，单位为分钟，根据startDate和endDate的时间跨度，可以取不同的间隔<ul><li>跨度为一天，支持的间隔：5、15、30、60、120、240、1440（一天）</li><li> 跨度为2到3天，支持的间隔：15、30、60、120、240、1440（一天）</li><li>跨度为4到7天，支持的间隔：30、60、120、240、1440（一天）</li><li>跨度为8到30天，支持的间隔：120、240、1440（一天）</li><li>跨度大于30天，支持的间隔:240、1440（一天）</li></ul> 默认为最小间隔 |
