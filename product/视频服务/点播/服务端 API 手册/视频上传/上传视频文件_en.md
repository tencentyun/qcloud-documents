...
1. [Simple File Upload](/document/api/436/6066)

### API Used to Upload Large Files (> 20 MB)
1. [Initiate Multipart Upload](/document/api/436/6067)
2. [Upload Parts One by One](/document/api/436/6068)
3. [Finish Multipart Upload](/document/api/436/6074)
...
## SDK
It is recommended to use [JSON-based API encapsulation SDK](/document/product/436/6474) to call the API.
...
The variable values in the syntax are the [results of VOD-initiated uploads](/document/product/266/9756#.E6.8E.A5.E5.8F.A3.E5.BA.94.E7.AD.94):
