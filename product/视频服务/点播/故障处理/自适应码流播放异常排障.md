...
1. 首先需要检查对应视频资源是否被删除，确认资源是否被删除可以通过调用云点播 api（DescribeMediaInfos），查看数据应答中是否包含 adp.xxx.m3u8 格式的数据。
...
![](https://main.qcloudimg.com/raw/5d4944e435d1d79c3e7e43ce70a06ea1.png)
<dx-codeblock>
:::  plaintext
