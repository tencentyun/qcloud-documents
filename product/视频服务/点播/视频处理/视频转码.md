...
<iframe src="https://playvideo.qcloud.com/vod/9031868223412081416/iplayer.html?appid=1253131631&fileid=9031868223412081416&autoplay=0&sw=1280&sh=720" frameborder="0" width="70%" height="360" scrolling="no"></iframe>	<!-- 页面内多处使用iframe代码，后面的JS代码只需要使用一次(作用是调整iframe的高度) -->	
