...
<table>
    ...
    <tr>
        ...
        <td>
            AVI格式：文件后缀为AVI；
            QuickTime格式：文件后缀为MOV；
            MPEG格式：文件后缀为MPG, MPEG, MPE, DAT, VOB, ASF, 3GP, MP4等；
            WMV格式：文件后缀为WMV, ASF；
            Real格式：文件后缀为RM, RMVB；
            Flash格式：文件后缀为FLV, F4V；
            Matroska格式：文件后缀为MKV。
        </td>
    </tr>
    <tr>
