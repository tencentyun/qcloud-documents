...
|[版权保护](https://cloud.tencent.com/document/product/266/14666#.E7.89.88.E6.9D.83.E4.BF.9D.E6.8A.A4)|对于存储在云点播的媒体源文件进行版权保护（溯源水印、商业级 DRM 加密）操作，具体费用计算请参见 [版权保护](#copyright)。|
...
>?
>- 提取不成功将不收取费用。
>- 对视频打溯源水印时，需要转码或转自适应码流，因此会产生转码费用，详情请参见 [媒体处理](https://cloud.tencent.com/document/product/266/14666#.E5.AA.92.E8.B5.84.E5.A4.84.E7.90.86.3Ca-id.3D.22media_edit.22.3E.3C.2Fa.3E)。
