...
云点播播放器 SDK 支持用户通过配置指定播放的内容（自适应码流、转码或原始视频）、指定雪碧图为缩略图和指定清晰度名称，同时还支持控制台上的预览功能，详情请参见 [播放器预览](https://cloud.tencent.com/document/product/266/36452#.E8.B6.85.E7.BA.A7.E6.92.AD.E6.94.BE.E5.99.A8.E9.A2.84.E8.A7.88)。
...
进入控制台的[**播放器配置**](https://console.cloud.tencent.com/vod/distribute-play/super-player)，单击**创建**：
...
创建成功后，在播放器配置列表中，您将看到新创建的播放器配置，同时您可以参考 [播放器预览文档](https://cloud.tencent.com/document/product/266/36452#.E8.B6.85.E7.BA.A7.E6.92.AD.E6.94.BE.E5.99.A8.E9.A2.84.E8.A7.88) 进行对应配置的预览。
