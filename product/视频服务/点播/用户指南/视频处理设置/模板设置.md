进入 [云点播控制台]( https://console.cloud.tencent.com/vod/overview)，选择左侧导航栏的【视频处理设置】>【模板设置】。模板设置内置的模板分别为**视频转码模板**、**音频转码模板**、**水印模板**、**截图模板**、**转动图模板**及**审核模板**，每种模板都可以添加至任务流设置中，用于视频处理设置。
![](https://main.qcloudimg.com/raw/adfa84a8e68954787541a5f8dc147690.png)
