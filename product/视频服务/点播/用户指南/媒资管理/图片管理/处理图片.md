...
您可通过 [云点播 API](https://cloud.tencent.com/document/product/266/48901) 创建图片即时处理模板，更多 API 详细配置，请参见 [创建图片即时处理模板](https://cloud.tencent.com/document/product/266/48901)。
