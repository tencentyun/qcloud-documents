小程序播放器插件推荐配合 [腾讯云点播]() 服务使用，点播用户购买小程序播放器插件正式版 License 可以体验更多功能。
## 购买正式版
1. 当您的小程序播放器插件试用版14天到期后，请前往 [购买页](https://buy.cloud.tencent.com/vod) 选购正式版 License，选择小程序视频插件进行购买即可。
