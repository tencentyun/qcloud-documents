小程序播放器插件推荐配合 [腾讯云点播]() 服务使用，任意点播用户可以体验小程序播放器插件（证书）- 试用版 License 14天。申请步骤如下：
### 步骤1：申请试用 License
请前往 [小程序播放器插件 License](https://console.cloud.tencent.com/vod/license/mp-plugin)，点击【激活】即可获取小程序播放器插件试用版，全程有效期为14天。
![](https://main.qcloudimg.com/raw/e0d1d8174c39a94af86657e5b0162493.png)
​
### 步骤2：完成激活 License
...
## 小程序播放器插件（正式版）
### 步骤1：购买正式版 License
当您的小程序播放器插件试用版14天到期后，请前往 [购买页](https://buy.cloud.tencent.com/vod) 选购正式版 License，在导航栏顶部单击【小程序插件】，选择小程序视频插件进行购买即可。
![](https://main.qcloudimg.com/raw/4379f92215dc6294413b06b407754cdf.png)
​
### 步骤2：查询正式版 License
