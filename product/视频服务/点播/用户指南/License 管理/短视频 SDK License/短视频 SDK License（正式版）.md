...
[](id:renew_formal)
### 更新正式版 License
您可以登录【[云点播控制台](https://console.cloud.tencent.com/vod/license)】 > 【[SDK License](https://console.cloud.tencent.com/vod/license) 】页面查看短视频正式版 License 的有效期，正式版本的 License 有效期为一年。若您对指定 License 进行续期，请保证已购买流量资源包的情况下，可进行如下操作进行续期：
