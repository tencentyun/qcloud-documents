更新说明
我们对《超级播放器  Adapter SDK 隐私保护指引》进行了更新，更新内容主要为：
1. 增加了个人信息存储规则；
2. 增加了 IP 地址这一个人信息处理的内容；
3. 删除了关于 GDPR 的内容。


腾讯严格遵守法律法规，按照业界成熟的安全与隐私标准，保护第三方开发者和其终端用户的个人信息。
超级播放器 Adapter 是一款由腾讯云计算（北京）有限责任公司以下简称“我们”）提供服务的腾讯云视立方超级播放器 Adapter 产品，公司注册地为北京市海淀区知春路49号3层西部309。超级播放器 Adapter 产品对接方式包含 SDK、H5 页面、API 能力，由于目前相关法律法规、政策及标准中主要对 SDK 产品的应用提供相关指引，以下将统一以 SDK 视角描述相关内容，如果您是集成、调用 API 能力或 H5 页面的第三方开发者，本指引中的内容同样适用于您。
...
| ---------- | --------------------------------------- | ------- | -------------------------------------- | ----- | ---- | --------------------- |
| 云点播自定义播放方案 | <i>设备信息：获取设备型号、操作系统版本号、网络类型、Wi-Fi状态、系统属性、IP地址 | <i>SDK 性能调优 |<i> 读取个人信息类型中涉及的设备信息，对设备和网络进行针对性的性能调优和故障兼容 | <i>网络权限  | <i>SDK  | <i>对设备和网络进行针对性的性能调优和故障兼容 |
