...
超级播放器 Adapter 是一款由腾讯云计算（北京）有限责任公司以下简称“我们”）提供服务的腾讯云视立方 Android 超级播放器 Adapter 产品，公司注册地为北京市海淀区知春路49号3层西部309。超级播放器 Adapter 产品对接方式包含 SDK、H5 页面、API 能力，由于目前相关法律法规、政策及标准中主要对 SDK 产品的应用提供相关指引，以下将统一以 SDK 视角描述相关内容，如果您是集成、调用 API 能力或 H5 页面的第三方开发者，本指引中的内容同样适用于您。
...
| ---------- | --------------------------------------- | ------- | -------------------------------------- | ----- | ---- | --------------------- |
| 云点播自定义播放方案 | <i>设备信息：获取设备型号、操作系统版本号、网络类型、Wi-Fi状态、系统属性 | <i>SDK 性能调优 |<i> 读取个人信息类型中涉及的设备信息，对设备和网络进行针对性的性能调优和故障兼容 | <i>网络权限  | <i>SDK  | <i>对设备和网络进行针对性的性能调优和故障兼容 |
...
| 所属权限组 | 子权限名称                                     | 申请目的                            |
| ----- | ----------------------------------------- | ------------------------------- |
| <b><i>网络权限  | <b><i>android.permission.INTERNET               | <b><i>请求加密视频数据需要网络传输                  |
|<b> <i>网络权限  | <b><i>android.permission.ACCESS\_NETWORK\_STATE | <b><i>获取当前网络用于优化网络连接策略，以便获得更稳定的网络数据传输 |
|<b> <i>网络权限  | <b><i>android.permission.ACCESS\_Wi-Fi\_STATE    | <b><i>获取网络状态用于优化网络连接策略，以便获得更稳定的网络数据传输 |
