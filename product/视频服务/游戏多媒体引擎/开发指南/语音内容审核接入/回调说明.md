...
[实时语音审核](https://cloud.tencent.com/document/product/607/64859) 和 [第三方语音流或音频文件审核](https://cloud.tencent.com/document/product/607/64860) 的回调均为服务端回调，且回调参数一致，详情如下文所述。
...
- **body**：回调给业务的 JSON 内容，下方回调示例中的全部内容即为 body。
