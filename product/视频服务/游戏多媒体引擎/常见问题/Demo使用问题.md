...
请参见 [下载指引](https://cloud.tencent.com/document/product/607/18521) ，下载相关 Demo 及 SDK。目前官网有 Unity 引擎 Demo，Cocos2D 引擎 Demo，Android 及 iOS 原生开发 Demo。
...
如果需要体验效果，请在另一个终端设备使用 demo 进入同一房间即可。
