...
2. 进入服务管理页面，单击【新建应用】，填写应用的相关信息，按照需要选择所需的服务。
![](https://main.qcloudimg.com/raw/0666f03679ca5f6d2e90f852555a7975.jpg)
 - 应用信息
 ...
 -  语音消息及转文本服务：您可根据需求进行开启并选择对应转文本支持语言的模式，不同模式单价不同，详情可参见 [计费规则](https://cloud.tencent.com/document/product/607/17808)。
 -  语音分析服务：您可根据需求进行开启，同时后续可根据需求进行修改。
3. 单击【确定】 即可成功创建应用。
...
1. 新建应用后，应用将在“应用列表”中展示，单击【设置】进入应用详情页。
![](https://main.qcloudimg.com/raw/0715f8d18cfda55cadabef8c89cd8fec.jpg)

2. 在“鉴权信息”中可获取到使用 SDK 语音服务时所需要的参数 AppID 以及权限密钥。
...
### 设置应用
单击【设置】，进入应用信息模块，单击“应用信息”中的【修改】后可对相应信息进行修改。

![](https://main.qcloudimg.com/raw/679eddc97b79b0dc564f450cd5f62bfc.jpg)

### 开启关闭业务
单击【设置】，进入应用信息模块，单击实时语言服务的【修改】后可对业务及服务进行开启或者关闭。
...
### 接入准备
接入 SDK 需要使用腾讯云提供的 AppID 及相关权限密钥。即 [应用管理](https://console.cloud.tencent.com/gamegme) 列表中的 AppID 及应用设置中的鉴权信息模块。

更多平台相关配置请参考各平台 [工程配置](https://cloud.tencent.com/document/product/607/10780) 文档。

### 官方 Demo 使用需知
使用 Demo 需要在 Demo 中在相应界面将腾讯云测试账号 AppID 更换为您在控制台获取的 AppID，并需要在 AVChatViewController-GetAuthBuffer 函数中修改实时语音的权限密钥。
