...
| 参数     |  类型  | 含义                                                         |
| -------- | :----: | ------------------------------------------------------------ |
| sdkAppId | String | 来自[腾讯云控制台](https://console.cloud.tencent.com/)的GME服务提供的 AppId。                              |
...
**如果有使用伴奏的情况，建议参考[实时语音伴奏流程图](https://cloud.tencent.com/document/product/607/34377)进行调用。**
