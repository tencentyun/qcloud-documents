...
## 使用场景
实时语音转文本可以将GME SDK采集的音频流实时识别成文字。该功能可应用于线上桌游场景，如 **“你说我猜”** 、**“你画我猜”** 等游戏场景，玩家开始猜词后，调用 **GME SDK** 的 **实时ASR** 接口，即可将玩家的实时语音流送入 **GME** 进行实时识别。业务客户端或业务服务端使用 **GME** 返回的语音转文本识别结果，可进行相关游戏玩法的逻辑实现。
...
<ul STYLE="MARGIN:0"><li>已开通实时语音服务及实时语音转文本服务：参见<a href="https://cloud.tencent.com/document/product/607/10782">语音服务开通指引</a></li><li>已接入GME SDK：参见<a href="https://cloud.tencent.com/document/product/607/10783">集成SDK</a>和<a href="https://cloud.tencent.com/document/product/607/15228">接口文档</a></li></ul>
</dx-alert>
...
### 实时语音接入
使用实时ASR功能，需要先接入实时语音功能，根据所使用的平台，请参考以下文档接入实时语音功能：
...
在成功进房之后，开启麦克风采集及上行的情况下，调用此接口可以启动实时语音 ASR 功能。
