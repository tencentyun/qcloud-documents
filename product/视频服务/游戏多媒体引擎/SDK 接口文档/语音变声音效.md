为方便开发者调试和接入腾讯云游戏多媒体引擎产品 API，这里向您介绍游戏多媒体引擎变声特效的的接入技术文档。
...
使用GME实时语音功能成功进入语音房间，并且打开了麦克风（EnableMic）。
...
### 语音消息变声流程
![](https://qcloudimg.tencent-cloud.cn/raw/b01532cb08d9d1186e7812cbc06334fe.png)
