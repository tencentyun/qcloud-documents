...
- **已接入 GME SDK 库文件libgmesoundtouch**：需要保证工程库文件中带有 libgmesoundtouch，具体参考[库文件对应功能](https://cloud.tencent.com/document/product/607/32535#.E5.BA.93.E6.96.87.E4.BB.B6.E5.AF.B9.E5.BA.94.E5.8A.9F.E8.83.BD)。
