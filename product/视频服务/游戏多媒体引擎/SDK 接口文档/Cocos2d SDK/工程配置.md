...
### 4. 编译准备
参考 GME Cocos Demo 中的 Android.mk 对自己工程进行编译选项配置。
路径为：GMECocos/GMECocosDemo/proj.android-studio/app/jni/Android.mk
preBuild.mk 文件的路径为：/Users/v_caisxcai/Downloads/GMECocos/GMESDK/android/bin/preBuild.mk
