...
![](https://main.qcloudimg.com/raw/027f42bab1776b8fc5d45824968ec0ab.png)
...
|BizID|云直播服务控制台生成的标识码 |此参数获取方式见下文步骤1。|
|StreamKey|云直播服务控制台生成的密钥|此参数获取方式见下文步骤1。|
|StreamID|rtmp 流的一个唯一标识|此参数获取方式见下文步骤2。|
|Timestamp|时间戳，单位为秒 |此参数由开发者生成并填入。|
