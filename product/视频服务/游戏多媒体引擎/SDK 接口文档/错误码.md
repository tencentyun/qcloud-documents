...
| QAVPTTERROR_ERR_VOICE_STREAMING_ASR_ERROR          | 50012    | 流式语音转文本错误 | 请求 ASR 错误                                                | 重新上传录制文件（UploadRecordedFile），然后调用转文本接口（SpeechToText）。出现此情况请联系腾讯云工作人员，并参照 [下载及使用问题](https://cloud.tencent.com/document/product/607/30410#.E5.A6.82.E4.BD.95.E5.8F.96.E5.BE.97.E6.97.A5.E5.BF.97.EF.BC.9F) 提供日志文件。 |
