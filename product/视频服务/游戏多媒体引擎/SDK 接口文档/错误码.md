...
<td>10001</td>
<td>一般错误</td>
<td>具体原因需要通过分析日志确认后台<br>返回给客户端的真正错误码才能知道。</td>
...
<td>10002</td>
<td>错误参数</td>
<td>调用 SDK 接口时，或 SDK 内部<br>发送信令给后台时，传了错误的参数。</td>
...
<td>10003</td>
<td>没有权限</td>
<td>没有权限使用某个功能。如进入房间时<br>所带的签名错误或过期，就会产生这个错误。</td>
...
<td>10004</td>
<td>超时</td>
<td>进行某个操作，在规定的时间内，还未<br>返回操作结果，则会产生这个错误。</td>
...
<td>10006</td>
<td>不在房间内</td>
<td>在不在房间内时，去执行<br>某些操作，则会产生这个错误。</td>
...
<td>10007</td>
<td>未实现</td>
<td>调用 SDK 接口时，如果相应<br>的功能还未支持，则会产生这个错误。</td>
<td>暂不支持该功能，找其他替代方案。</td>
</tr>
<tr>
<td>AV_ERR_SERVER_REPEATED<br>_OPERATION</td>
<td>10008</td>
<td>重复操作</td>
<td>已经在进行某种操作，再次去做同<br>类型的其他操作，则会产生这个错误。</td>
...
<td>10009</td>
<td>房间不存在</td>
<td>房间不存在时，去执行某些操作，<br>则会产生这个错误。</td>
<td>确保在正确的时机使用 SDK 相关功能</td>
</tr>
<tr>
...
<td>10010</td>
<td>成员不存在</td>
<td>某个成员不存在时，去执行该成<br>员相关的操作，则会产生这个错误。</td>
<td>分析日志，获取后台返回给客户端的真正错误码，并联系后台同事协助解决。</td>
</tr>
<tr>
...
<td>10011</td>
<td>错误能力</td>
<td>具体原因需要通过分析日志确认<br>后台返回给客户端的真正错误码才能知道。</td>
<td>分析日志，获取后台返回给客户端的真正错误码，并联系后台同事协助解决。</td>
</tr>
</tbody></table>
