...
| speechLanguage    |char*                     |识别出指定文字的语言参数，语音转文字的参数请参见 [语言参数参考列表](https://cloud.tencent.com/document/product/607/30282)|
| translatelanguage    |char*                  |翻译成指定文字的语言参数，语音转文字的参数请参见 [语言参数参考列表](https://cloud.tencent.com/document/product/607/30282)（此参数暂时无效，填入参数应与 speechLanguage 一致）|
