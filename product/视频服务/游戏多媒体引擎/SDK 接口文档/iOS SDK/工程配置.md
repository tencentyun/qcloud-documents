为方便 iOS 开发者调试和接入腾讯云游戏多媒体引擎产品 API，本文档主要为您介绍适用于 iOS 开发的工程配置。
...
1. 根据实际情况在 Xcode 的 Link Binary With Libraries 里，加入以下依赖库，并设置 Framework Search Paths 指向 SDK 所在目录，如图所示：  
