## 소개
Tencent Cloud GME SDK의 사용을 환영합니다. Cocos2d 개발자가 Tencent Cloud GME 제품 API를 디버깅하고 연결하는 데 도움이 되도록 여기에 Cocos2d 개발에 적합한 액세스 기술 문서를 소개합니다.
...
### 시스템 복원
시스템 이벤트가 Resume되면 엔진에도 동시Resume 진행을 알려야 합니다.
#### 함수 프로토타입
