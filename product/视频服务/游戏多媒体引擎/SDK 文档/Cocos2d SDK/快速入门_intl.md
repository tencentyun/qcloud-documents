...
Thank you for using Tencent Cloud Game Multimedia Engine SDK. This document provides an overview that makes it easy for Cocos2D developers to debug and integrate the APIs for Game Multimedia Engine.
...
This document only provides the most important APIs to help you get started with GME. For more APIs, see [API Documentation](/document/product/607/15218).
