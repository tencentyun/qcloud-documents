## Overview
Thank you for using Tencent Cloud Game Multimedia Engine SDK. This document provides a detailed description that makes it easy for Cocos2d developers to debug and integrate the APIs for Game Multimedia Engine.
