...
Tencent Cloud GME SDK의 사용을 환영합니다. Cocos2D 개발자가 Tencent Cloud GME 제품 API를 디버깅하고 연결하는 데 도움이 되도록 여기에 Cocos2D 개발에 적합한 빠른 액세스 문서를 소개합니다.
...
GME 시작 가이드 문서는 가장 중요한 연결 인터페이스에 대한 정보만 제공하고 더 많은 세부 인터페이스는 [관련 인터페이스 문서](https://cloud.tencent.com/document/product/607/15218)를 참조하십시오.
