...
Thank you for using Tencent Cloud Game Multimedia Engine (GME) SDK. This document provides an overview that makes it easy for Windows developers to debug and integrate the APIs for GME.
