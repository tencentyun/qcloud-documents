...
5. 开启或关闭**语音消息及转文本服务**。
您可根据需求进行开启并选择对应转文本支持语言的模式，不同模式单价不同，详情可参见 [计费规则](https://cloud.tencent.com/document/product/607/17808)。
...
2. 关闭**语音消息及调整转文本支持语音服务模式**。
   您可根据需求关闭语音消息及调整转文本支持语音的服务模式，转文本支持语音服务收费标准详情请参见 [计费规则](https://cloud.tencent.com/document/product/607/17808#.E8.AF.AD.E9.9F.B3.E6.B6.88.E6.81.AF.E5.8F.8A.E8.BD.AC.E6.96.87.E6.9C.AC.E6.9C.8D.E5.8A.A1)。
