...
2. 在语音聊天界面，单击【JoinRoom】进入房间：
 ...
 - 3D Voice Effect：3D 音效，勾选表示打开，可通过设置以下参数进行配置：
    ...
    - YR：绕 y 坐标轴旋转的方向。
    - ZR：绕 z 坐标轴旋转的方向。
 - Voice Change：实时语音音效，可通过选择不同的参数类型，改变播放音色，详情可参考 [实时语音音效](https://cloud.tencent.com/document/product/607/34378#k-.E6.AD.8C.E9.9F.B3.E6.95.88.E7.89.B9.E6.95.88)。
