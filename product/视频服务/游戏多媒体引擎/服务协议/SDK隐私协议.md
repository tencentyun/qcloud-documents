...
为实现腾讯 SDK 的音频通信功能，我们可能需要向第三方开发者和/或终端用户收集相关个人信息。以下将详细列出腾讯 SDK 的各项业务功能及为实现该功能所需收集的个人信息情况。
...
| 收集的个人信息 | 用途                                 |
| -------------- | ------------------------------------ |
| 设备生产商     | 用于针对性的对相应设备进行性能调优   |
| 设备型号       | 用于针对性的对相应设备进行性能调优   |
...
如存在分享的行为，我们会要求关联公司、合作伙伴及第三方提供数据安全能力和信息安全资质（如等级保护测评、信息安全管理体系等）证明。在**个人敏感信息**的处理上，我们会要求第三方采用数据脱敏加密技术，从而更好地保护个人信息。如果第三方开发者和/或终端用户对第三方处理个人信息有异议或发现这些第三方存在风险时，请按照本声明 [第十条](#connectservice) 所述方式联系我们。
...
1. 当终端用户所使用的第三方中某项功能由腾讯 SDK 产品和/或服务提供，终端用户可以在使用我们服务的过程中，访问、修改和删除第三方开发者提供的注册信息和其他个人信息，也可按照本声明 [第十条](#connectservice) 所述方式与我们联系。
...
<td>允许获取网络信息状态</td>
<td>获取当前网络用于优化数据包发送包策略，以便获得更好的音频流畅体验</td>
</tr><tr>
<td>android.permission.ACCESS_WIFI_STATE</td>
<td>允许获取当前 Wi-Fi 接入的状态以及 WLAN 热点的信息</td>
<td>获取当前 Wi-Fi 状态用于优化数据包发送包策略，以便获得更好的音频流畅体验</td>
</tr><tr>
...
<td>收集设备主板型号，用以匹配更适合的编解码策略，以获得更优质的音频体验</td>
</tr><tr>
<td>主版厂商</td>
<td>收集 Windows 设备的主板硬件厂商</td>
<td>收集设备主板厂商，用以匹配更适合的编解码策略，以获得更优质的音频体验</td>
</tr></table>
- **macOS 系统权限申请表**
<table>
<tr><th>权限名称</th><th>用途字符串</th><th>权限含义</th><th>申请原因</th></tr>
...
<td>Microphone<br>（麦克风）</td>
<td>NSMicrophoneUsageDescription<br>（麦克风）</td>
<td>允许应用访问设备麦克风。为了保护用户隐私，macOS 10.14上或之后链接的 mac 应用程序访问设备的任何麦克风，必须静态声明这样做的意图</td>
<td>用于采集用户声音，与其他使用者进行交互</td>
</tr></table>
...
如果第三方开发者和/或终端用户对我们收集和使用个人信息的法律依据有疑问或需要进一步信息的，请根据本声明 [第十条](#connecservice) 所述方式与我们联系。
