...
## 版本下载
可以到 [SDK 下载](https://cloud.tencent.com/document/product/584/9366) 页面下方下载商业版 SDK 压缩包，压缩包有加密（解压密码&licence 在接入流程步骤获取），成功解压后得到一个`Demo`和`SDK`文件，特效资源存放在 SDK/Resource 下。
