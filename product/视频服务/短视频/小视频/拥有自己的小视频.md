...
- **3.1： [新建 CVM 主机](https://console.cloud.tencent.com/cvm)** 
...
- **3.4： 付款后生成云主机**。
单击登录可以通过腾讯云的网页 shell 进行访问，也可以用 **putty** 或 **SecretCRT** 采用 ssh 登录到主机。
...
> 注意：如果服务器没有配置证书，这里的云主机服务器地址需要用 http，而不能用 https。
