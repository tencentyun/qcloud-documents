...
源码中默认配置了腾讯云提供的测试服务器地址，目的是让您快速体验小视频APP的各项能力，只需要编译通过就可以在您的手机上正常运行取来。

```
http://demo.vod2.myqcloud.com/lite/
```

如果你希望替换成自己的后台服务，请阅读文档下半部分：

## 后台部分

如果您希望使用自己的后台服务，我们也提供了相应的后台源码，您可以按照如下步骤在腾讯云CVM云主机上进行部署。
