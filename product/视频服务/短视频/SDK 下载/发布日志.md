此页面仅更新短视频 SDK 的版本历史，如您想了解全功能版 SDK 的版本历史，请参见 [全功能版 SDK 版本历史](https://cloud.tencent.com/document/product/1449/76109)。
> ? 全功能版 SDK 是多个基础 SDK 的集合，它包含了直播、短视频、音视频通话（TRTC）和播放器等子产品 SDK 的功能模块。


### Version 10.9 @ 2022.12.30
#### 功能优化
- Android&iOS：优化短视频保存时因为分辨率16对齐引起的黑边的问题。
- Android：优化短视频添加BGM录制保存后音视频不同步的问题。
- Android：增加编码profile定义，增加录制的event值。

#### 缺陷修复:
- iOS：修复设置录制预览分辨率无效的问题。
- Android：修复TXVideoEditer生成视频时偶尔崩溃的问题。
- Android：修复特定视频有几率添加贴纸导致画面出现花屏的问题。
