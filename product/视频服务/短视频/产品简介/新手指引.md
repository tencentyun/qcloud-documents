...
1.1 登陆腾讯云官网，进入 [短视频控制台](https://console.cloud.tencent.com/video/license)，填写相应的信息，其中Package Name是填Android的包名，Bundle Id是填iOS的bundleId。
...
您也可以参考文档 [**快速搭建一个短视频APP？**](https://cloud.tencent.com/document/product/584/15540) 了解如何从零开始快速搭建一个类似 “微视” 这样的短视频APP。
