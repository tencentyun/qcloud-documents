...
<table style="text-align:left;vertical-align:middle;">
   <tr>
			<th width="80px">功能模块</th>
      <th width="80px">功能项</th>
      <th width="500px">功能简介</th>
      <th width="80px">基础版</th>
      <th width="80px">商业版</th>
   </tr>
   <tr>
...
- **基础版 LICENSE**
您可以登录腾讯云[点播控制台](https://console.cloud.tencent.com/video/license)获取基础版 LICENSE。
...
- **商用版 LICENSE**
您可以联系腾讯云商务获取商用版 LICENSE 并洽谈折扣事宜。
