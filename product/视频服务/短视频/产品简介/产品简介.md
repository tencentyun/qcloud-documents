...
- **基础版 LICENSE**
购买云点播流量资源包旗舰版2、旗舰版3，可以获取短视频基础版 SDK 为期一年的 LICENSE 使用权限。云点播资源包请参见 [资源包（预付费）](https://cloud.tencent.com/document/product/266/14667)，购买成功后，登录 [云点播控制台](https://console.cloud.tencent.com/vod/license) 获取基础版 LICENSE。
- **商业版和商业版 Pro LICENSE**
