...
| 系统属性     | 针对 Android/iOS 的兼容性问题进行适配 | 在短视频制作场景中       | 去标识化、加密传输的安全处理方式 | Android、iOS |
| 设备型号     | 针对 Android/iOS 的兼容性问题进行适配 | 在短视频制作场景中       | 去标识化、加密传输的安全处理方式 | Android、iOS |
| 操作系统     | 针对 Android/iOS 的兼容性问题进行适配 | 在短视频制作场景中       | 去标识化、加密传输的安全处理方式 | Android、iOS |
