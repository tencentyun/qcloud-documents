...
1.Go to Tencent Cloud product overview page (http://cloud.tencent.com/product/vod.html), and click "Buy Now" button, as shown below:
...
By clicking "Change", you can upgrade the current VOD service package as required, as shown below:
