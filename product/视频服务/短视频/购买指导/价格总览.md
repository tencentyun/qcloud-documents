...
SDK 有两种版本和两种授权 LICENSE:
 ...
 - LICENSE 分为基础版和商用版，获取方式见下方的**授权license**。需要注意的是在 4.9 版本中我们优化了 license 的集成，基础版或者商用版都只需要一个license 即可，并且支持服务器自动续签，使用方式参考 [工程配置](https://cloud.tencent.com/document/product/584/11638) 中的**短视频 licence 集成**。
...
<table>
   ...
   <tr>
      <td>设置速度</td>
      <td>设置短视频生成后的速度，比如是正常速度的 n 倍</td>
      <td>✔</td>
      <td>✔</td>
   </tr>
   <tr>
   ...
   <tr>
      <td>AI抠图</td>
      <td>拍摄时，识别出人的轮廓，把背景抠除，替换成其他的元素，比如动态背景/PPT 等</td>
      <td>✖</td>
      <td>✔</td>
   </tr>
   <tr>
      <td>绿幕抠像</td>
      <td>拍摄时，将画面中的绿色元素(比如纯绿背景)抠除，替换成其他的元素，比如动态背景/PPT 等</td>
      <td>✖</td>
      <td>✔</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td>选择声音文件</td>
      <td>编辑视频选择自带声音文件或用户手机本地的 mp3 作为背景音</td>
      <td>✔</td>
      <td>✔</td>
   </tr>
   <tr>
   ...
   <tr>
      <td>选择字幕容器</td>
      <td>编辑视频，添加字幕时可以选择字幕边框背景的样式，比如气泡等</td>
      <td>✔</td>
      <td>✔</td>
   </tr>
   <tr>
...
购买腾讯云点播流量资源包旗舰版 2、旗舰版 3，可以获取短视频基础版 SDK 为期一年的 LICENSE 使用权限。点播资源包请参考 [点播资源包](https://cloud.tencent.com/document/product/266/14667)。购买成功后，您就可以登录腾讯云 [点播控制台](https://console.cloud.tencent.com/video/license) 获取基础版正式 LICENSE。
