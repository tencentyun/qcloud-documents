...
## SDK 授权
SDK 分为3种版本：基础版 SDK、专业版 SDK 和企业版 SDK，您可以购买对应的授权 License 来获取对应 SDK 的功能。

#### SDK 版本说明
- 短视频基础版 SDK 功能请参见 [SDK 功能及对应的 License 版本](#lic)，其根据不同的 License 授权提供了不同功能。基础版 SDK 下载请参见 [基础版 SDK 下载](https://cloud.tencent.com/document/product/584/9366#sdk)。
- 专业版 SDK 是多个音视频产品 SDK 的合集，如您需要同时集成多个音视频产品（如短视频、移动直播、TRTC 等），可使用专业版 SDK 并分别用对应产品的**基础版授权 License** 来获取对应产品功能。专业版 SDK 下载请参见 [专业版 SDK 下载](https://cloud.tencent.com/document/product/454/7873#Professional)。
...
#### License 版本说明
>- License 根据功能不同对应分4种版本：精简版、基础版、企业版、企业版 Pro，License 授权的功能区别请参见 [SDK 功能及对应的 License 版本](#lic)。
