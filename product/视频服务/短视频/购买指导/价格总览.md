...
- 短视频基础版 SDK 功能见下表，根据不同的 License 授权提供了不同功能解锁。
- 专业版 SDK 是多个音视频产品 SDK 的合集，如您需要同时集成多个音视频产品（如短视频、移动直播、TRTC 等），可使用专业版 SDK 并分别用对应产品的基础版授权来解锁对应产品功能。
- 企业版 SDK 是在专业版的基础上增加了 AI 特效能力，支持动效贴纸、智能扣背景、美颜美妆等高级美颜功能。
 - License 根据功能解锁不同对应分四种版本，授权解锁的功能区别见下方的表格。
 - 需要注意的是在4.9版本中我们优化了 License 的集成，每种版本只需要一个对应的 License 即可，使用方式请参见 [License 申请](https://cloud.tencent.com/document/product/584/20333)。
...
<table>
   ...
   <tr>
      <td>界面</td>
      <td>自定义UI</td>
	    <td>开发者自定义 UI，小视频 App 提供了一套完整的UI交互源码，可复用或自定义</td>
