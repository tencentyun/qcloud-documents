...
## SDK 授权
SDK 有3种版本（基础版、专业版和企业版），对应了4种类型的授权 License，您可通过购买授权来解锁对应 SDK 的功能。

- 短视频基础版 SDK 功能见下表，根据不同的 License 授权提供了不同功能解锁。基础版 SDK 下载请参见 [基础版 SDK 下载](https://cloud.tencent.com/document/product/584/9366#sdk)。
- 专业版 SDK 是多个音视频产品 SDK 的合集，如您需要同时集成多个音视频产品（如短视频、移动直播、TRTC 等），可使用专业版 SDK 并分别用对应产品的基础版授权 License 来解锁对应产品功能。专业版 SDK 下载请参见 [专业版 SDK 下载](https://cloud.tencent.com/document/product/454/7873#Professional)。
...
>?
>- License 根据功能解锁不同对应分四种版本，授权解锁的功能区别见下方的表格。
>- 在4.9版本中我们优化了 License 的集成，每种版本只需要一个对应的 License 即可，使用方式请参见 [License 申请](https://cloud.tencent.com/document/product/584/20333)。
>- 基础版和专业版的功能基本没有差别，但是若您需要集成多个音视频产品的 SDK，为了避免符号冲突（symbol duplicate），建议您使用专业版 SDK 进行集成，专业版 SDK 体积增量也要小于同时集成两个独立的 SDK。
...
<table>
   ...
   <tr>
      ...
      <td><a href="https://cloud.tencent.com/document/product/584/20333#.E8.B4.AD.E4.B9.B0.E6.AD.A3.E5.BC.8F.E7.89.88-license">精简版</a></td>
      <td><a href="https://cloud.tencent.com/document/product/584/20333#.E8.B4.AD.E4.B9.B0.E6.AD.A3.E5.BC.8F.E7.89.88-license">基础版</a></td>
      <td><a href="https://cloud.tencent.com/document/product/584/20333#.E5.85.B3.E4.BA.8E.E4.BC.81.E4.B8.9A.E7.89.88.E6.9C.AC-license">企业版</a></td>
      <td><a href="https://cloud.tencent.com/document/product/584/20333#.E5.85.B3.E4.BA.8E.E4.BC.81.E4.B8.9A.E7.89.88.E6.9C.AC-license">企业版 Pro</a></td>
   </tr>
   <tr>
      <td>套餐价格</td>
