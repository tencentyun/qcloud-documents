## 购买说明
使用短视频 SDK 之前，您需要开通云点播服务，并通过购买点播加速资源包获取**短视频基础版 SDK License**（一年使用授权） ：
- 点播流量资源包-10TB
- 点播流量资源包-50TB
- 点播流量资源包-200TB

> ?  短视频 SDK License 需要通过 [云点播控制台](https://console.cloud.tencent.com/vod/license) 与流量资源包进行绑定后，该资源包视为已使用。
