...
**基础版 SDK**
- 单独使用腾讯云短视频基础版 SDK ：License费用 10000 元/年

- 结合腾讯云点播服务使用：您需预先向腾讯云账户充值 5000 元，我们将返还您等价值的点播服务代金券，即可按照日结的计费方式使用腾讯云点播服务，并将免费获得腾讯云短视频基础版 SDK License 一年的使用权限。
