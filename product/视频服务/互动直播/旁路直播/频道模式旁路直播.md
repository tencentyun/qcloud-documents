...
TcPlayer是由腾讯视频云自主开发的一款播放器，同时支持RTMP、FLV、HLS。演示地址为http://imgcache.qq.com/open/qcloud/video/vcplayer/demo/tcplayer.html 更多详情请参阅官方文档 https://cloud.tencent.com/document/product/267/7479。
