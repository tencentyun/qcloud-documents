...
```
room_type: Room type. It should always be 2, which means a multi-person room.
...
Request the video images from multiple room members.
...
Cancel the video images of all the members
...
Set the index for the microphone to use.
...
3153: Request the video images of multiple members. The notification of execution result of RequestViewList.
3154: Cancel the video images of all members. The notification of execution result of CancelAllView.
