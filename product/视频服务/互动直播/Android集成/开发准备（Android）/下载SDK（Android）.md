## 一、下载SDK
你可以在[腾讯云官网](http://www.qcloud.com/product/ilvb.html)下载互动直播ILVB的SDK。
...
**特别注意：**两个sample工程各自包含了一份libs的copy，这样做的是为了让sample工程能够被独立地编译运行，jar和so文件的存放路径会有所不同，但文件的内容并无差别。
## 三、SDK文件简介
