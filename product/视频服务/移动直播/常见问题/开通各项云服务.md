...
![](https://main.qcloudimg.com/raw/71768dad3feebbbc11914b1d42e288ee.png)
...
IM 提供了一套 [REST](https://cloud.tencent.com/document/product/269/1520) API 用于让您的后台服务器可以直接调用 IM 服务，例如建群、发送系统消息、把某个用于剔除群组等等，但 IM REST API 仅允许管理员进行调用，也就是需要一个管理员用户名（Administrator）和对应的密码 (UserSig)，具体使用过程请参见 [DOC](https://cloud.tencent.com/document/product/269/1519)。
