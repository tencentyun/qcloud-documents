## 1. <span id="LVB"> 云直播 </span>
### 1.1 <span id="LVB_OPEN"> 如何开通云直播服务？</span>
进入 [云直播管理控制台](https://console.cloud.tencent.com/live)，进入腾讯云直播服务开通页，勾选同意《腾讯云服务协议》，并单击【申请开通】即可开通云直播服务。
![](https://main.qcloudimg.com/raw/efecb4fbf43c32a5094ae8af3cba8ec3.png)。

### 1.2 <span id="LVB_PUSH_SECRECT"> 如何开启流防盗链 KEY？</span>
...
### 1.3<span id="LVB_API_SECRECT"> 如何通过 API 访问鉴权 KEY？</span>
...
### 1.4 <span id="LVB_EVENT_URL"> 如何回调事件通知 URL？</span>
...
## 3. <span id="IM">即时通信（IM）</span>
### 3.1 <span id="IM_OPEN"> 如何开通 IM 服务？</span>
...
### 3.2 <span id="IM_SDKAPPID"> 什么是 SDK APPID？</span>
...
![](https://main.qcloudimg.com/raw/5482f16a715513e2bb71bd920e3772de.png)
 ...
 ### 3.4 <span id="IM_ADMIN">什么是 Administrator？</span>
...
### 3.5<span id="IM_PRIKEY">  什么是 PrivateKey 与 PublicKey？</span>
...
![](https://main.qcloudimg.com/raw/a4dd5ae56c31527faaf924e013d846c1.png)
...
![](https://main.qcloudimg.com/raw/c374250f119ea918ce06c5b105075917.png)
