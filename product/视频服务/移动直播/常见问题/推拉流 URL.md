...
- **txSecret（防盗链签名）：**防止攻击者伪造您的后台生成推流 URL，计算方法参考 [最佳实践 - 防盗链计算](https://cloud.tencent.com/document/product/267/32735)。
...
- **播放域名**
 ...
 - 关于域名 CNAME，详细请参考 [CNAME 配置](https://cloud.tencent.com/document/product/267/19908)。
