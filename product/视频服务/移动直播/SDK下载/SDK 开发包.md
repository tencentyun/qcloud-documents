...
<table width="850px">
  ...
  <tr align="center">
    ...
    <td><a href="http://download-1252463788.file.myqcloud.com/xiaozhibo/XiaoZhiBoiOSSrc_4.4.3780.zip">DOWNLOAD</a></td>
  </tr>
  <tr align="center">
    <td>Android 源码包</td>
    <td>4.4.3780</td>
    <td>由 RTMP SDK 、IM SDK、COS SDK、业务逻辑层代码和界面层代码构成，源码阅读推荐参考 <a href="https://cloud.tencent.com/document/product/454/7892">[DOC]</a></td>
    <td><a href="http://download-1252463788.file.myqcloud.com/xiaozhibo/XiaoZhiBoAndroidSrc_4.4.3780.zip">DOWNLOAD</a></td>
  </tr>
  <tr align="center">
    <td>PHP源码包</td>
    <td>4.4</td>
