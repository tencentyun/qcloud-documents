...
## 测试版 License
### 申请测试版 License
您可以免费申请测试版 License（基础版，免费测试有效期为14天，可续期1次，共28天，到期当日的00:00:00止）体验测试，具体步骤如下：
...
>! 测试版 License 有效期共28天，只能续期一次（到期当日的00:00:00止）。若您需继续使用，请购买正式版 License。

[](id:buy)
## 正式版 License
### 购买正式版 License
1. 购买指定规格的 [直播流量包](https://buy.cloud.tencent.com/mobilelive?urlctr=yes&basepack=10tb)，获得赠送1年有效期的正式直播基础版 License 使用权限（到期当日的00:00:00止），具体价格请参见 [价格总览](https://cloud.tencent.com/document/product/454/8008)。
...
则 A 和 B 可共用60TB的流量，其中10TB流量包和 License A 都在2021年01月01日00:00:00到期，50TB流量包和 License B 都在2021年02月01日00:00:00到期。
...
>! **选择流量包仅用于直播基础版 License 绑定流量包的有效期，流量包的流量可用于当前账号所有 License 直播流量消耗。（有效期至到期当日的00:00:00止。）**
