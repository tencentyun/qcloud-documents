...
> 1. 方案二使用腾讯云 RoomSerivce （`https://room.qcloud.com/weapp/rtc_room` ）作为 LiveRoom 的房间后台，但跟方案一的直接使用不同，方案二需要先使用  [RoomTool.zip](http://dldir1.qq.com/hudongzhibo/mlvb/RoomTool.zip)  配置自己的直播和 IM 等服务信息。
> 
