...
- 采用 flv 播放地址
- 设置 mode 为 live 模式
- 将 min-cache 和 max-cache 都设置为 2
- 推流端 gop 为 2
...
#### I帧间隔（GOP）
一般演播台的接入方式有两种：OBS Studio 推流或者编码盒推流，这两种推流工具均有比较成熟的设置接口。建议将 GOP（也叫关键帧间隔）设置为 1s 或 2s，这样可以让观众端的延迟差异非常小。
...
![](https://mc.qcloudimg.com/static/img/93d115a41d62acc6a4cb62b88d34aff5/image.jpg)
