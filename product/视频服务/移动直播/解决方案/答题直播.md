...
![](https://mc.qcloudimg.com/static/img/c341ebc62a9690fefb27afecba68feb1/image.gif)
...
<table>
  ...
  <tr align="center" >
	  <td rowspan="2">iOS</td>
		<td><a href="http://dldir1.qq.com/hudongzhibo/xiaozhibo/TXLiteAVSDK_Smart_iOS_4.1.3062.zip">DOWNLOAD</a></td>
		<td>YES</td>
		<td>YES</td>
		<td>YES</td>
	...
	<tr align="center">
		<td><a href="http://dldir1.qq.com/hudongzhibo/xiaozhibo/LiteAVSDK_iOS_OnlyPlayer_4.1.3081.zip">DOWNLOAD</a></td>
		<td>NO</td>
		<td>YES</td>
		<td>YES</td>
	...
	<tr align="center">
	  <td rowspan="2">Android</td>
		<td><a href="https://mc.qcloudimg.com/static/archive/3282f42a9c9c5c95de63d42a00cfca9d/LiteAVSDK_Smart_Android_4.1.3092.zip">DOWNLOAD</a></td>
		<td>YES</td>
		<td>YES</td>
		<td>YES</td>
		<td>SDK 和 Demo 源码均在压缩包中</td>
	...
	<tr align="center">
		<td><a href="http://dldir1.qq.com/hudongzhibo/xiaozhibo/LiteAVSDK_Android_OnlyPlayer_4.1.3116.zip">DOWNLOAD</a></td>
		<td>NO</td>
		<td>YES</td>
		<td>YES</td>
...
## 接入攻略（方案一）
### 步骤一：开通腾讯云直播服务
连续我们开通腾讯云 [直播服务](https://cloud.tencent.com/document/product/267/13551)，如果您时间比较急，可以 400 客服电话我们加急审核。
...
### 步骤六：开发答题界面
在此方案中，通过步骤五获取的 message 应该是一个的buffer，在我们的Demo以及定制版本的 Obs Studio 中，我们以 json 格式将题目组织成一段buffer，并将其夹在音视频流中送出去。
...
> **如下几点需要注意**
> - 题目的发送应该使用自定义消息格式 [TIMCustomElem](https://cloud.tencent.com/document/product/269/2720#2.4-.E8.87.AA.E5.AE.9A.E4.B9.89.E6.B6.88.E6.81.AF.E5.85.83.E7.B4.A0)。
>
> - 题目需要指定消息优先级(MsgPriority) 为 <font color='red'>**High**</font>，因为题目不能丢，但是文本消息可以被频率限制掉。
>
...
### 步骤七：结果显示
一般题目出来一段时间以后，就会进入闭题状态。这时，答题系统会将结果进行统计汇总，并将汇总结果下发给观众，结果下发可以继续使用 **步骤四** 中的题目扩散通道。
