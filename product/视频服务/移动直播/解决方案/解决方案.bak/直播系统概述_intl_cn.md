...
小直播 App 是腾讯云视频终端研发团队自主打造的一款演示用原型，目的是为提供全套源码参考，内部包含主播推流、观看、录制回看、互动消息、点赞、弹幕，等基本功能。只要您是腾讯云认证用户，并开通视频直播服务，就可以[免费获取](https://console.qcloud.com/live/mlvbsdkdownload)。
