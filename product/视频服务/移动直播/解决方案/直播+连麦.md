...
| 云通讯（IM）administrator | 调用 IM REST API 时需要使用[管路员名称](https://cloud.tencent.com/document/product/269/1519#3-.E8.B0.83.E7.94.A8.E6.96.B9.E6.B3.95)，由于 RoomService 使用了 IM REST API 发送房间里的系统消息，所以需要您配置管理员名称。 |  [DOC](https://cloud.tencent.com/document/product/454/7953#IM_ADMIN)  |
