...
| :-------:| :-------:| :-------: | :-------:|
| serverDomain | 腾讯云 RoomService<br> `https://room.qcloud.com/weapp`<br>`/live_room` | 腾讯云 RoomService<br>`https://room.qcloud.com/weapp`<br>`/live_room` 需要提前 [配置](#TencentRoom) | [自行部署](#SelfRoom) RoomService<br> `https://[yourcompany]/weapp/live_room` |
