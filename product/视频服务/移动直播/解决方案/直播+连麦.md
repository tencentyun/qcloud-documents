...
<h3 id="CLIENT_LOGIN"> step2: 登录（login） </h3>
...
| :-------:| :-------:| :-------: | :-------:|
| serverDomain | 腾讯云RoomService https://room.qcloud.com/weapp/live_room | 腾讯云RoomService https://room.qcloud.com/weapp/live_room 需要提前 [配置](#TencentRoom) | [自建](SelfRoom) RoomService https://[yourcompany]/weapp/live_room |
...
**方案二的注意点** 
> 1. 方案二使用腾讯云 RoomSerivce （https://room.qcloud.com/weapp/live_room ）作为 LiveRoom 的房间后台，当跟方案一的直接使用不同，方案二需要先使用  [RoomTool.zip](http://dldir1.qq.com/hudongzhibo/xiaozhibo/RoomTool.zip)  配置自己的直播和 IM 等服务信息。
> 
