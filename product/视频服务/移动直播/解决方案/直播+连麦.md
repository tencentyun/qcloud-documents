...
| 平台 | 编程语言 | API 文档 | 
|:-------:|:-------:| :-------:|
| iOS                       | Objective-C |  [API 文档](https://cloud.tencent.com/document/product/454/14730) | 
| Android                 | java            |  [API 文档](https://cloud.tencent.com/document/product/454/14642) | 
| IE浏览器                | javascript    |  [API 文档](https://cloud.tencent.com/document/product/454/14766) | 
| PC（C++）           | C++            |  [API 文档](https://cloud.tencent.com/document/product/454/14745) | 
| PC（C#）             | C#              |  敬请期待 | 
