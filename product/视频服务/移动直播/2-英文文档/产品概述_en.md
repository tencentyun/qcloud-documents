Thank you for your interest in Tencent Cloud's Mobile Live Video Broadcasting (MLVB) service!
...
- **If you want to enjoy a perfect LVB service**
If you want to integrate the complete set of LVB capabilities into your App, such as text interaction, on-screen comment, giving a like with floating heart animation, beauty filter, skin effect, joint broadcasting, authentication, etc., [Integrated Solution](#.E4.B8.80.E4.BD.93.E5.8C.96.E9.9B.86.E6.88.90.E6.96.B9.E6.A1.88) is recommended.

## Quick Integration Solution
![](//mc.qcloudimg.com/static/img/92a464fc26bbe52fea8816f8e6061ef3/image.jpg)

If you want to integrate LVB push and playback features into your own App, just follow the three steps below:
<table class="t" style="margin-left:75px; width:auto;">
<tbody><tr>
<th width="120" style="text-align: center;"> Step
</th><th width="200" style="text-align: center;"> Description
</th><th width="300" style="text-align: center;"> Reference Documentation
</th><th width="150" style="text-align: center;"> Relevant Developer
</th></tr>
<tr>
...
## Integrated Solution
If you want to integrate the complete set of LVB capabilities into your App, such as text interaction, on-screen comment, giving a like with floating heart animation, beauty filter, skin effect, joint broadcasting, authentication, etc., please refer to **Mini LVB**:
