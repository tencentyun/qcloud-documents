...
### 1. 设置依赖
按照 [SDK 集成指引](https://cloud.tencent.com/document/product/454/56588) 将 live_flutter_plugin 嵌入您的 App 工程中。
...
[](id:step4)
### 步骤4：渲染 View
接下来我们要给播放器的视频画面找个地方来显示，flutter 需要依赖`v2_tx_live_video_widget`创建视频渲染View。
