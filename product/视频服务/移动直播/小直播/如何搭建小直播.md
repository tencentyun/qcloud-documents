...
要支持ATS需要做两件事：
- 业务后台支持**HTTPS**请求，可以参考腾讯云的[SSL证书安装指引-nginx证书部署](https://www.qcloud.com/document/product/400/4143#2.-nginx-.E8.AF.81.E4.B9.A6.E9.83.A8.E7.BD.B2)。由于证书和域名绑定的，因此需要提前申请好域名。
