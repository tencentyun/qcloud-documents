...
如果你需要更强的安全性，比如需要将消息发送者的身份跟您的账号系统强绑定，也就是消息发送者的身份一定是您账号系统里的一个确定的 ID， 那么就需要通过对接 IM 云通讯服务的 [**独立模式**](https://www.qcloud.com/document/product/454/7980#3.3-.E7.8B.AC.E7.AB.8B.EF.BC.88.E9.89.B4.E6.9D.83.EF.BC.89.E6.A8.A1.E5.BC.8F) 来实现了。
