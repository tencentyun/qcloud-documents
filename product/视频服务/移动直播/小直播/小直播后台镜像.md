...
e、按下"**I**"键进入vim的Insert模式，加上如下加粗的部分。
   ** define('CLOUD_API_SECRETID','xxxxxxxxxxxxxxxxxxxxxxxxx');**  //云API个人SecretId，用于UGC上传并落地到点播系统[云API密钥](https://console.qcloud.com/capi)
   ** define('CLOUD_API_SECRETKEY','xxxxxxxxxxxxxxxxxxxxxxxxx');**  //云API个人SecrectKey，用于UGC上传并落地到点播系统[云API密钥](https://console.qcloud.com/capi) 
