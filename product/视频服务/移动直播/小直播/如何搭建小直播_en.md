...
- **Business Server:** Also known as customer backend server and used to meet customers' own business needs. It serves as the "glue" between mobile devices and Tencent Cloud.
...
- **Mode 2: Tencent Cloud CVM - Quick deployment**
...
## 4. Integration on mobile device and callback setting
