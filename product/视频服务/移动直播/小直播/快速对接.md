...
尊敬的客户您好，感谢您关注腾讯云移动直播业务！

移动直播（MLVB）腾讯云直播服务(LVB) 在移动终端方向的延伸，即帮助您基于腾讯云直播业务快速搭建起 **智能手机上的直播解决方案**。

如果您已经有非常成熟的移动端解决方案，推荐您直接转 [直播云服务](https://www.qcloud.com/product/LVB) 了解云端对接解决方案即可。

如果您还没有移动端解决方案，或者对现有的方案不是很满意，那么推荐您根据自己的情况，选择 [快速集成方案](#.E5.BF.AB.E9.80.9F.E9.9B.86.E6.88.90.E6.96.B9.E6.A1.88) 或 [一体化集成方案](#.E4.B8.80.E4.BD.93.E5.8C.96.E9.9B.86.E6.88.90.E6.96.B9.E6.A1.88)。

## 快速集成方案
如果您只需要在现有的 APP 里集成推流或直播功能，那么使用腾讯云直播服务可以快速达成目标：
