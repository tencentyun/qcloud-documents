### 1. 为何 &lt;live-pusher&gt; 和 &lt;live-player&gt; 不能工作？
...
### 3. 各种场景如何选用SD、HD、FHD、RTC模式，最小最大码率如何设置？
...
```
### 10. Android小程序 &lt;live-player&gt; 标签在RTC模式下部分手机设置muted属性不能静音
这是一个已知的 BUG，我们会尽快在 SDK 中修复，并赶上微信下一个版本的发布。

### 11. &lt;live-pusher&gt; 标签动态修改enable-camera属性不生效
...
### 12. 建议在页面onUnload里面对&lt;live-pusher&gt; 与&lt;live-player&gt; 标签做清理
具体请参考如下：
``` javascript
  onUnload: function () {
...
###  13. &lt;live-pusher&gt;或&lt;live-player&gt; 标签上面叠加cover-view时不推荐修改标签的大小
...
###  14. Demo 源码里面的 &lt;cameraview&gt; 有什么作用
