...
### 1.5 查询推流防盗链KEY
推流防盗链KEY是为了确保只有您的APP用户才可以推流的[安全保护手段](https://www.qcloud.com/doc/api/258/5693)，推流防盗链KEY可以在开启直播码时指定，亦可随时按您的需要在[直播管理控制台](https://console.qcloud.com/live/livecodemanage)中修改：
