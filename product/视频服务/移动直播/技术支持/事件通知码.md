...
| -1308 | PUSH_ERR_CAMERA_OCCUPY<br><br>PUSH_ERR_AUDIO_SYSTEM_NOT_WORK<br><br>PUSH_ERR_SCREEN_CAPTURE_START_FAILED | 摄像头正在被占用中，可尝试打开其他摄像头（Windows）<br><br>系统异常，录音失败（iOS）<br><br>开始录屏失败，可能是被用户拒绝了（Android） |
...
| 2010 | PLAY_EVT_GET_PLAYINFO_SUCC<br><br>PLAY_EVT_SNAPSHOT_RESULT | 	获取点播文件信息成功（Android iOS）<br><br>系截图快照返回码（Windows） |
| 2011 | PLAY_EVT_CHANGE_ROATION | MP4 视频旋转角度（Android iOS） |
