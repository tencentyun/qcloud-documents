...
<span id="step_1.3"></span>
#### step 1.3  获取 SDK 的测试 License<span id="get_lvb_license"></span>
...
<span id="step_1.4"></span>
#### step 1.4  在应用管理中添加一个新的应用<span id="get_im_config"></span>
...
- **iOS 版替换方案**：<span id="step_1.5_ios"></span>
...
- **Android 版替换方案**：<span id="step_1.5_android"></span>
...
<span id="step_1.7"></span>
#### step 1.7 替换“小直播” 中的 TIM 相关配置<span id="replace_TIM"></span>

我们在 [step 1.4](#get_im_config) 中拿到的 SDKAppID 和 SecretKey 在这一步可以发挥作用了，参照如下说明替换源代码中的两行字符串（SDKAppID 和 SecretKey）即可：

- **iOS 版替换方案**：<span id="step_1.7_ios"></span>
...
- **Android 版替换方案**：<span id="step_1.7_android"></span>
