...
- **1. 检查 URL 设置是否正确**
  ...
  检查【控制台】>【云直播】>【直播码接入】>[【接入配置】](https://console.cloud.tencent.com/live/livecodemanage)中回调 URL 是否正确填写。如果错误的话，直播结束后，业务后台收不到腾讯云服务器的通知回调，也就没有生成回看纪录。
...
若您还需要更多的协助，将服务端 `/data/live_demo_service/log` 目录下的日志打包，并 [提交工单](https://console.cloud.tencent.com/workorder/category) 反馈给我们。
