...
## Overall Connection
### Step 1: Push by VJ A
VJ A gets the push hotlink protection URL streamA from your business backend, and then pushes streams with [TXLivePusher](https://cloud.tencent.com/document/product/454/7879).
...
### Step 2: Push by VJ B
VJ B gets the push hotlink protection URL streamB from your business backend, and then pushes streams with [TXLivePusher](https://cloud.tencent.com/document/product/454/7879).
...
At this point, VJ A needs to use [TXLivePlayer](https://cloud.tencent.com/document/product/454/7880) to play the **low-delay** URL of streamB. Note: The playback of ordinary CDN URL is not allowed . The delay of the low-delay URL is within 500 ms, while the delay of CDN is generally over 2s. This means the CDN URL can only be used for watching ordinary videos, and cannot be used for joint broadcasting between VJs.
...
- **4.2 Use PLAY_TYPE_LIVE_RTMP_ACC playback mode of [TXLivePlayer](https://cloud.tencent.com/document/product/454/7880)**
...
- Use [TXLivePlayer](https://cloud.tencent.com/document/product/454/7880) for the playback and set the playback mode to PLAY_TYPE_LIVE_RTMP_ACC.
...
For more information, please see [API for Stream Mixing on the Cloud](https://cloud.tencent.com/document/product/454/9850).
