移动直播提供4个 SDK 版本，分别是**基础直播版 SDK**、**互动直播版 SDK**、**全功能版 SDK** 和**企业版 SDK**，可通过移动直播 License 使用相应的直播功能。

### SDK 版本对应关系

![](https://main.qcloudimg.com/raw/cf67659db0343dbcf9c6fddd7381d80a.svg)

- [**基础直播版 SDK**](https://cloud.tencent.com/document/product/454/7873#Smart) ：通过直播推流 License（原移动直播的基础版 License），可使用直播推流、直播播放和基础美颜（美白、磨皮等）功能。
- 互动直播版 SDK ：在基础直播（Smart）的功能之上增加了连麦相关的功能支持，满足互动连麦直播场景需求。
- [**全功能版 SDK**](https://cloud.tencent.com/document/product/454/7873#Professional)：多个音视频产品的合集，除了增加了对快直播的支持，其他功能上和互动直播（Live）的没有区别。主要是为了解决同时集成多个音视频产品时的符号冲突问题，通过直播推流 License（原移动直播的基础版 License）可使用直播推流相关功能，其他产品功能需要开通对应服务。
- [**企业版 SDK**](https://cloud.tencent.com/document/product/454/7873#Enterprise)：在全功能版 SDK 上增加了高级美颜特效能力，需要购买移动直播企业版 License 来使用高级美颜特效等功能。
...
>- 若在基础直播版 SDK 上使用企业版 License，则无法使用高级美颜特效等功能。
...
<table>
  <tr>
    ...
    <th width="10%" style="text-align:center">基础直播版 SDK</th>
    <th width="10%" style="text-align:center">互动直播版 SDK</th>
