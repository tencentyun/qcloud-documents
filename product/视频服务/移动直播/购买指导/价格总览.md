...
### 实时通话服务
如果您的业务包含直播连麦（LiveRoom）、视频通话（RTCRoom）场景，涉及Android、iOS、Web、Windows、微信小程序各终端的实时音视频互通场景。那么需要按照实时通话服务计费。
...
<table border="1" align="left">
   ...
   <tbody>
	  ...
	  <tr height="30">
         <td colspan="7">
         <P>1、[详见移动直播实时通话服务开通指南](https://main.qcloudimg.com/raw/f25dc357567351a3c9c092577c2dc4e5.pdf)；现阶段需通过实时音视频预付费套餐购买页完成购买 [立即购买](https://buy.cloud.tencent.com/rav_th5)；</P> 
		 <P>2、实时通话服务目前暂未全面开放，需要您成功购买套餐后提交白名单申请，[立即申请开通](https://cloud.tencent.com/act/apply/wx_rtc)；</p>
         <p>3、套餐包使用完当月若未及时续费，超出部分按照标准后付费价收费；</p>
		 <p>4、通话分钟数按与会者叠加计算，如 3 人一起通话 50 分钟，则扣减套餐剩余时间 150 分钟；</p>
		 <p>5、以上套餐价格涵盖范围为视频分辨率小于等于720P的场景，高于720P的需求需单独联系客服评估报价。</p>
		 </td>
      </tr>
   </tbody>
 </table>
