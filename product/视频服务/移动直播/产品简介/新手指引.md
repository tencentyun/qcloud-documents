本文将为刚入门直播 SDK 的用户提供一条学习路径，您可通过以下视频快速了解直播 SDK 的概念及功能特性：
...
<td><a href="https://cloud.tencent.com/document/product/454/8008#sdklicense">直播 License</a></td>
</tr><tr>
...
<tr>
<td>购买腾讯特效套餐</td>
<td><a href="https://cloud.tencent.com/document/product/454/8008#effect">腾讯特效（美颜特效）</a></td>
</tr>
</tbody></table>
...
> ? 
> - 使用直播 SDK 之前，您需要开通 [云直播服务]( https://cloud.tencent.com/document/product/267 )。
...
### 体验 Demo
直播 SDK 提供了多个不同版本的体验 Demo，分别是 [小直播 App](https://cloud.tencent.com/document/product/454/6555#.E5.B0.8F.E7.9B.B4.E6.92.AD-app)、[腾讯云工具包 App](https://cloud.tencent.com/document/product/454/6555#rtmpdemo)、[小程序 Demo](https://cloud.tencent.com/document/product/454/6555#.E5.B0.8F.E7.A8.8B.E5.BA.8F-demo)。
...
### 下载 SDK
直播提供3个 SDK 版本，分别是**直播 SDK**、**直播 SDK（基础版）和全功能版 SDK**，可通过直播 License 使用相应的直播功能。

<table>
<tr><th width=24%>版本类型</th><th>说明</th></tr>
<tr>
<tr>
<td><a href="https://cloud.tencent.com/document/product/454/7873#Live">直播 SDK</a></td>
<td>在直播 SDK（基础版）的功能之上增加了连麦相关的功能支持，满足互动连麦直播场景需求。</td>
</tr>
<td><a href="https://cloud.tencent.com/document/product/454/7873#Smart">直播 SDK（基础版）</a></td>
<td>通过直播 License ，可使用直播推流、直播播放和基础美颜（美白、磨皮等）功能。</td>
</tr>
<tr>
<td><a href="https://cloud.tencent.com/document/product/454/7873#ALL">全功能版 SDK</a></td>
<td>多个音视频产品的合集，除了增加了对快直播的支持，其他功能上和直播 SDK的没有区别，主要是为了解决同时集成多个音视频产品时的符号冲突问题，通过直播 License 可使用直播推流相关功能，其他产品功能需要开通对应服务。</td>
</tr></table>
...
| 若您需要   | 请您阅读      |
| ----------------- | ----------------- |
| 将直播 SDK 集成到您的项目中 | [SDK 集成](https://cloud.tencent.com/document/product/454/7873) |
| 将采集到的摄像头画面及麦克风声音，进行编码后推送到云直播平台中 | [摄像头推流](https://cloud.tencent.com/document/product/454/56591) |
| 将主播的手机画面作为直播源，并叠加摄像头预览进行直播 | [录屏推流](https://cloud.tencent.com/document/product/454/56594) |
| 将实时推送的直播画面通过播放端进行播放 | [直播拉流](https://cloud.tencent.com/document/product/454/56597) |
| 通过使用 Web 超级播放器 TCPlayerLite 解决手机浏览器和 PC 浏览器上音视频流播放问题 | [Web（H5）播放器](https://cloud.tencent.com/document/product/454/7503) |
| 创建直播间并实现连麦互动功能 | [连麦互动](https://cloud.tencent.com/document/product/454/52751) |
| 实现大眼、瘦脸、瘦鼻、动效贴纸、AI 抠背以及绿幕等特效功能    | [AI 变脸和挂件](https://cloud.tencent.com/document/product/454/9018) |
| 设定推流画面质量 | [设定画面质量](https://cloud.tencent.com/document/product/454/56600) |
| 监控直播推流和播放的状态数据变化 | [SDK 指标监控](https://cloud.tencent.com/document/product/454/56602) |
...
> ?
> - 若您需了解各功能接口具体说明，请参见 [iOS API 概览](https://cloud.tencent.com/document/product/454/56606)、[Android API 概览](https://cloud.tencent.com/document/product/454/56610)、[微信小程序标签说明](https://cloud.tencent.com/document/product/454/12518)。
> - 若您使用过程中发现报错信息，可根据 [错误码](https://cloud.tencent.com/document/product/454/56612) 进行问题排查。



## 快速集成小直播 App

直播 SDK 提供的小直播 App 是一套开源且完整的在线直播解决方案，它基于云直播服务、即时通信（IM）和对象存储服务（COS）构建，并使用云服务器（CVM）提供简单的后台服务，可以实现登录、注册、开播、房间列表、连麦互动、文字互动和弹幕消息等功能。具体集成方案请参见 [本地快速跑通“小直播”](https://cloud.tencent.com/document/product/454/38625)。
...
-   [直播 License 是必须购买的吗？](https://cloud.tencent.com/document/product/454/43500#.E7.A7.BB.E5.8A.A8.E7.9B.B4.E6.92.AD-license-.E6.98.AF.E5.BF.85.E9.A1.BB.E8.B4.AD.E4.B9.B0.E7.9A.84.E5.90.97.EF.BC.9F) 
-   [购买直播 License 可以用于小程序直播吗？](https://cloud.tencent.com/document/product/454/43500#.E8.B4.AD.E4.B9.B0.E7.A7.BB.E5.8A.A8.E7.9B.B4.E6.92.AD-license-.E5.8F.AF.E4.BB.A5.E7.94.A8.E4.BA.8E.E5.B0.8F.E7.A8.8B.E5.BA.8F.E7.9B.B4.E6.92.AD.E5.90.97.EF.BC.9F) 
...
使用腾讯云视立方·直播 SDK 产品和服务中有任何问题或建议，您可以通过以下渠道反馈：
