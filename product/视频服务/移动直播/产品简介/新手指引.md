本文将为刚入门移动直播 SDK 的用户提供一条学习路径，您可通过以下视频快速了解实时音视频的概念及功能特性：
...
- [产品方案及架构说明](https://cloud.tencent.com/document/product/454/19074)
...
移动直播 SDK 的费用主要由一下四个部分组成： 

<table>
<tr><th>费用类型</th><th>计费说明</th></tr>
<tr>
<td>移动直播 SDK 的使用<b>授权费用</b></td>
<td><a href="https://cloud.tencent.com/document/product/454/8008#.E7.A7.BB.E5.8A.A8.E7.9B.B4.E6.92.AD-license.3Cspan-id.3D.22sdklicense.22.3E.3C.2Fspan.3E">移动直播 License</a></td>
</tr><tr>
<td rowspan=3>对接<b>使用其他腾讯云服务</b>时产生的费用</td>
<td><a href="https://cloud.tencent.com/document/product/454/8008#.E4.BA.91.E7.9B.B4.E6.92.AD.E6.9C.8D.E5.8A.A1.3Cspan-id.3D.22lvb.22.3E.3C.2Fspan.3E">云直播服务</a></td>
</tr><tr>
<td><a href="https://cloud.tencent.com/document/product/454/8008#.E5.8D.B3.E6.97.B6.E9.80.9A.E4.BF.A1.E6.9C.8D.E5.8A.A1.EF.BC.88im.EF.BC.89.3Cspan-id.3D.22im.22.3E.3C.2Fspan.3E">即时通信服务（IM）</a></td>
</tr><tr>
<td><a href="https://cloud.tencent.com/document/product/454/8008#.E4.BA.91.E7.82.B9.E6.92.AD.E6.9C.8D.E5.8A.A1.EF.BC.88vod.EF.BC.89">云点播服务（VOD）</a></td>
</tr>
<tr>
<td>使用<b>移动直播连麦服务</b>时产生的费用</td>
<td><a href="https://cloud.tencent.com/document/product/454/8008#.E7.A7.BB.E5.8A.A8.E7.9B.B4.E6.92.AD.E8.BF.9E.E9.BA.A6.E6.9C.8D.E5.8A.A1.EF.BC.88acc.EF.BC.89">移动直播连麦服务（ACC）</a></td>
</tr>
<tr>
<td><b>额外购买美颜动效素材</b>（仅限已购买移动直播企业版 License）</td>
<td><a href="https://cloud.tencent.com/document/product/454/8008#.E7.BE.8E.E9.A2.9C.E5.8A.A8.E6.95.88.E7.B4.A0.E6.9D.90">美颜动效素材</a></td>
</tr>
</tbody></table>
...
移动直播 SDK 提供了三个不同版本的体验 Demo，分别是 [小直播 App](https://cloud.tencent.com/document/product/454/6555#.E5.B0.8F.E7.9B.B4.E6.92.AD-app)、[精简版 Demo](https://cloud.tencent.com/document/product/454/6555#.E7.B2.BE.E7.AE.80.E7.89.88-demo)、[小程序 Demo](https://cloud.tencent.com/document/product/454/6555#.E5.B0.8F.E7.A8.8B.E5.BA.8F-demo)。
...
| [专业版（Professional）](https://cloud.tencent.com/document/product/454/7873#Professional) | 多个音视频产品的合集，功能上和直播基础版的没有区别，主要是为了解决同时集成多个音视频产品时的符号冲突问题，通过移动直播的基础版 License 可使用直播推流相关功能，其他产品功能需要开通对应服务。 |
...
| 将整个直播过程录制并存储下来                                 | [录制和回看](https://cloud.tencent.com/document/product/454/8681) |
...
移动直播 SDK 提供的小直播 App 是一套开源且完整的在线直播解决方案，它基于云直播服务（LVB）、即时通信（IM）和对象存储服务（COS）构建，并使用云服务器（CVM）提供简单的后台服务，可以实现登录、注册、开播、房间列表、连麦互动、文字互动和弹幕消息等功能。 具体集成方案请参见：
...
> ? 更多问题，建议您前往 [常见问题](https://cloud.tencent.com/document/product/454/7937) 文档查看。
