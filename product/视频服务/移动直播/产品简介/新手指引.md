...
| 若您需要   | 请您阅读      |
| ----------------- | ----------------- |
| 将移动直播 SDK 集成到您的项目中 | [SDK 集成](https://cloud.tencent.com/document/product/454/7873) |
...
移动直播 SDK 提供的小直播 App 是一套开源且完整的在线直播解决方案，它基于云直播服务、即时通信（IM）和对象存储服务（COS）构建，并使用云服务器（CVM）提供简单的后台服务，可以实现登录、注册、开播、房间列表、连麦互动、文字互动和弹幕消息等功能。具体集成方案请参见 [本地快速跑通“小直播”](https://cloud.tencent.com/document/product/454/38625)。
