## 方案简介
互动直播是一站式“多路音视频实时连麦”解决方案，通过移动直播 SDK 、云直播、云点播（VOD）及即时通信（IM）等产品打造一站式的跨平台一对多、多对多的超清酷炫连麦直播方案。
...
<li>在移动直播 SDK 借助 RTC（Real-Time Communication） 建立主播和主播、主播和观众之间的实时音视频通话，从而实现超低延时的直播连麦互动。 </li>
