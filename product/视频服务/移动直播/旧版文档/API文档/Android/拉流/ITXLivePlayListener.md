...
| 参数 | 类型 | 含义 |
|-----|-----|-----|
| event | final int | 事件 ID，ID 类型请查看代码中的 com.tencent.rtmp.TXLiveConstants.[PUSH_EVT_CONNECT_SUCC](https://cloud.tencent.com/document/product/454/56592#.E4.BA.8B.E4.BB.B6.E5.A4.84.E7.90.86) 播放事件列表。 |
