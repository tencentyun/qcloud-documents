本文主要介绍如何快速地将腾讯云视立方·移动直播（Mobile Live Video Broadcasting，MLVB）的 LiteAVSDK（iOS）集成到您的项目中，按照如下步骤进行配置，就可以完成 SDK 的集成工作。下面以全功能的 [移动直播专业版 SDK](https://cloud.tencent.com/document/product/454/7873#Professional) 为例：
