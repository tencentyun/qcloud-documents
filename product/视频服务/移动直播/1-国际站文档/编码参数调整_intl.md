...
You can customize video/audio encoding parameters by setting the Config object. The following setting APIs are supported:
...
## Setting Method
You are recommended to set these parameters before enabling push, since most of them only take effect when the push is restarted. The reference code is as follows:

```java
//Declare mLivePushConfig and mLivePusher in member variables
....
//Initialize mLivePushConfig
