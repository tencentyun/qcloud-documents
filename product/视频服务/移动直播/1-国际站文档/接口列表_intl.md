...
API details: bool startPreview(TXEVideoCaptureSrcType srcType, HWND rendHwnd, const RECT &rect, TXEVideoUserDataSrcType userType)
...
```
	...
	TXE_VidoeSrc_User_Data = 1001,           Reserved parameter
```
