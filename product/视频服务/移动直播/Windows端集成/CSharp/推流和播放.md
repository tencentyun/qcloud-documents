...
- **获取开发包**
  [下载](https://cloud.tencent.com/document/product/454/7873#Windows) SDK 开发包，并按照[工程配置](https://cloud.tencent.com/document/product/454/13625?!preview&lang=cn)指引将 SDK 嵌入您的 APP 开发工程。
...
本地摄像头的画面镜像、静音、清晰度设置等功能，可以参考[接口列表](https://cloud.tencent.com/document/product/454/13626?!preview&lang=cn)，获取更多详细信息。
...
可以参考 [接口列表](https://cloud.tencent.com/document/product/454/13626?!preview&lang=cn)，获取更多详细信息。
