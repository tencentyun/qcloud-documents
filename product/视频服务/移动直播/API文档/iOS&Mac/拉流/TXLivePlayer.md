...
变更历史：1.5.2版本将参数 frame 废弃，设置此参数无效，控件大小与参数 view 的大小保持一致，如需修改控件的大小及位置，请调整父 view 的大小及位置。 参考文档：[绑定渲染界面](https://cloud.tencent.com/document/product/454/7880#step-2.3A-.E6.B8.B2.E6.9F.93-view)。
