...
<table>
	...
	<tr>
		<th >资质要求（3选1）</th>
		<td><a href="https://developers.weixin.qq.com/miniprogram/product/material/shejiao/zhibo.html"><ul><li>《信息网络传播视听节目许可证》</li>
            <li>《网络文化经营许可证》（经营范围含网络表演）</li>
            <li>《统一社会信用代码》及《情况说明函件》（适用于政府主体）</li>
            </ul></a>
		</td>
	</tr>
</table>
