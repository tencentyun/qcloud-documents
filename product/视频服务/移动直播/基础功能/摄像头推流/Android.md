...
| `setExposureCompensation` | 设置曝光比例，取值范围从-1到1 | 负数表示调低曝光，-1是最小值，对应 getMinExposureCompensation。 正数表示调高曝光，1是最大值，对应 getMaxExposureCompensation。 0表示不调整曝光，默认值为0。|
