...
- **debug**
 为了很好地调试音视频的相关功能，小程序为 live-pusher 标签提供了 debug 模式，开始 debug 模式之后，原本用于渲染视频画面的窗口上，会显示一个半透明的 log 窗口，用于展示各项音视频指标和事件，降低您调试相关功能的难度，具体使用方法我们在 [FAQ](https://cloud.tencent.com/document/product/454/7946#.E5.A6.82.E4.BD.95.E6.9F.A5.E7.9C.8Bsdk.E7.8A.B6.E6.80.81.E6.8F.90.E7.A4.BA.E4.BF.A1.E6.81.AF.EF.BC.9F) 中有详细说明。
