...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [V2TXLivePremier setLicenceURL:licenceURL key:licenceKey]; 
}
@end
...
- iOS 12 及以上的系统可以通过 RPSystemBroadcastPickerView 来弹出录屏选择界面 用法可参考[此处](https://github.com/LiteAVSDK/Live_iOS/blob/main/MLVB-API-Example-OC/Basic/LivePushScreen/TRTCBroadcastExtensionLauncher.m)。
```objectivec
// 推流代码
