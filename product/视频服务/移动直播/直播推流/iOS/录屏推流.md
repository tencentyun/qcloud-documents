...
>!本文主要介绍 iOS 11 的 ReplayKit2 录屏使用 SDK 推流的方法，涉及 SDK 的使用介绍同样适用于其它方式的自定义推流。更详细的使用说明可以参考 [Demo](https://github.com/LiteAVSDK/Live_iOS/tree/main/MLVB-API-Example-OC/Basic/LivePushScreen) 里 TXReplayKit_Screen 文件夹示例代码。

## 功能体验

体验 iOS 录屏可以扫码进行安装视频云工具包。
<img src="https://qcloudimg.tencent-cloud.cn/raw/40d0cc38505e10a2aaadb3bf6e2239ef.png" width="250">
