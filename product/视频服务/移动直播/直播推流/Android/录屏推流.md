...
>? 如果在 [第4步](#step4) 中选择 `RTMP` 协议推流，推流地址的生成请参见 [RTMP 地址](https://cloud.tencent.com/document/product/454/7915#manual)。
> 如果在 [第4步](#step4) 中选择 `RTC` 协议推流，推流地址的生成请参见 [RTC 地址](https://cloud.tencent.com/document/product/454/7915#rtc)。
...
### 事件监听
SDK 通过 [V2TXLivePusherObserver](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__V2TXLivePlayerObserver__android.html) 代理来监听推流相关的事件通知和错误通知，详细的事件表和错误码表请参见 [错误码表](https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__V2TXLiveCode__android.html)。
