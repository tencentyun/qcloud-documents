...
#### 1.3 申请测试 License
1. 进入 [直播推流 License](https://console.cloud.tencent.com/live/license)。
...
#### 1.4 在应用管理中添加一个新的应用
开通直播服务并获取 License 后，进入 [**云直播控制台**](https://console.cloud.tencent.com/live/livestat) > **直播SDK** > **应用管理** ，单击 **创建应用**。
...
## 四、连麦
如果您需要使用连麦功能，需要购买连麦套餐包，具体请参见 [价格总览](https://cloud.tencent.com/document/product/454/8008) 。
[](id:STEP4)
## 五、修改云服务器配置信息
