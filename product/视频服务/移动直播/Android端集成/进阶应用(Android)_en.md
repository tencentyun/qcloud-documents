...
| setVideoBitrate |   Video bit rate: Number of data bits produced by the video encoder per second (in Kbps) |  800 |
| setAutoAdjustBitrate |   Bit rate adaptation: Adjust the video bit rate automatically based on the network condition |   Off |
| setAutoAdjustStrategy | If bit rate adaptation is enabled, you can use this API to set the strategy to dynamically adjust the bit rate | STRATEGY_1 |
| setMaxVideoBitrate | Maximum output bit rate: This option takes effect only when bit rate adaption is enabled. |   1,200 |
| setMinVideoBitrate | Minimum output bit rate: This option takes effect only when bit rate adaption is enabled. |   800 |
...
// Modify the audio sampling rate to 44,100 and fixed video bit rate to 800
...
mLivePushConfig.setAutoAdjustBitrate(false);   //Push at a fixed bit rate
...
mLivePushConfig.setMinVideoBitrate(500);//Minimum bit rate for dynamic adjustment
mLivePushConfig.setMaxVideoBitrate(1000);//Maximum bit rate for dynamic adjustment
mLivePushConfig.setVideoBitrate(800);//Initial default bit rate
mLivePushConfig.setAutoAdjustBitrate(true);//Whether to enable dynamic adjustment of bit rate
...
```java
TXLivePushConfig* _config;
mLivePushConfig.setMinVideoBitrate(800);//Minimum bit rate for dynamic adjustment
mLivePushConfig.setMaxVideoBitrate(3000);//Maximum bit rate for dynamic adjustment
mLivePushConfig.setVideoBitrate(1800);//Initial default bit rate
mLivePushConfig.setAutoAdjustBitrate(true);//Whether to enable dynamic adjustment of bit rate
