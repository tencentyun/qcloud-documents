...
| 接口定义                                 | 功能说明                |
| ------------------------------------ | ------------------- |
| onPushEvent(int event, Bundle param) | TXLivePusher的推流事件通知 |
| onNetStatus(Bundle param)            | TXLivePusher的推流状态通知 |
