...
<td>直播推流服务</td>
<td>（1）摄像头/麦克风捕获的音视频<br>（2）设备信息：设备生产商、设备型号、系统版本、网络类型、屏幕分辨率、CPU 信息、IP 地址</td>
<td>直播推流</td>
...
<td>网络权限、存储权限、麦克风权限、音频权限、蓝牙权限、相机权限、电话权限</td>
<td>SDK</td>
<td>音视频通话 TRTC SDK、全功能版视立方 SDK</td>
</tr>
<tr>
<td>美颜特效服务</td>
<td>（1）摄像头捕获的视频<br>（2）设备信息：设备型号、设备生产商、系统版本、屏幕分辨率、CPU 信息、网络类型</td>
<td>美颜特效</td>
<td>加密传输和必要性处理：读取个人信息类型中涉及的设备信息，在设备本地进行针对性的性能优化，不存储不上报</td>
