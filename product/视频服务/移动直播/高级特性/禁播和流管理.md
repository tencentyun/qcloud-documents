...
- **sign（安全签名）**：sign = MD5(key + t)，即把加密 key 和 t 进行字符串拼接后，计算一下 md5 值。这里的 key 即 CGI 调用 key，您在腾讯云直播管理控制台 [域名管理](https://console.cloud.tencent.com/live/domainmanage) 中可以进行设置，步骤如下：

	1. 进入 [域名管理](https://console.cloud.tencent.com/live/domainmanage) 单击您的“推流域名”或者“拉流域名”后面的【管理】。
	2. 对于“播放域名”选择“访问控制”，对于“推流域名”选择“推流配置”。
	3. 单击“鉴权配置”页面中的【编辑】，进行配置。
	![](https://main.qcloudimg.com/raw/0a531d0e79ffe9d24c12427ee18da997.png)
	![](https://main.qcloudimg.com/raw/f1c5a6c555baddcddc3fff3f66bdc60e.png)
