...
1. 打开 [云创平台官网](https://v.tencent.com/)。
...
1. 进入**团队管理**界面（路径为 `{个人域名}.vs.tencent.com/manage/team）` ，单击**创建团队**，输入团队名后单击**确定**。
...
创建团队后会默认将操作者加入团队中，单击**添加成员**将其他协作者加入团队。
...
单击**导出模板**，在导出目录中选择上文创建的团队**微剪测试**。单击自定义封面，选择视频截图或自行上传均可。
...
## 素材制作
单击顶部 Tab 的**工具箱** > **素材制作**，可以制作贴片、花字、特效等素材。详情操作请参见 [素材制作工具使用手册](https://cloud.tencent.com/developer/article/1855518)。
