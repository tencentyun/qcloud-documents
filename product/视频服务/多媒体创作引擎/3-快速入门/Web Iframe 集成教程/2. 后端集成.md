...
| Definition | String | 视频剪辑预设配置 Id，用于指定导出视频的参数，详情请参见 [导出视频编辑项目](https://cloud.tencent.com/document/product/1156/40353) 接口说明。 |
...
## 步骤2：开发创建项目接口（CreateProject）[](id:CreateProject)
主要流程如下：
