...
>! 后续步骤以视频编辑模板 ID： <code>5fc07c745d6cbe00018f1830@Public@CME</code> 为例，此模板为智能创作提供的公共模板，可直接使用。

## 步骤3：导入素材[](id:p14)

使用视频编辑模板导出视频，需要替换模板中的部分媒体，这里需要先将媒体导入到智能创作媒资库。导入媒体的接口为 [导入媒体](https://cloud.tencent.com/document/product/1156/43243) 。为了简化操作，建议您使用 [API Export](https://console.cloud.tencent.com/api/explorer?Product=cme&Version=2019-10-29&Action=ImportMaterial) 导入媒体。这里通过一个接口调用示例说明关键参数设置：
