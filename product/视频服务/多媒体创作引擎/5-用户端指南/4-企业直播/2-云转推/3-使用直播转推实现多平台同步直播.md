...
- **准备输出地址**：云转推支持转推第三方平台，如视频号、微视、快手、斗鱼、虎牙等厂商，也支持自定义的 RTMP 协议的转推地址，您需要设置至少开通一个 [第三方平台的直播功能](https://tcloud-doc.isd.com/document/product/1156/64153?!preview&!editLang=zh)，或拥有一个自定义的转推地址来确保跑通直播流程。
...
[](id:step2)
## 步骤2：添加输入源
云创提供了一个直播测试地址（`https://liveplay.video-studio.myqcloud.com/live/demo1.flv`）用于跑通云转推测试，下述内容将以该直播测试地址为例说明，更多输入源添加相关说明，请参见 [跑通云转推-添加输入源](https://tcloud-doc.isd.com/document/product/1156/64164?!preview&!editLang=zh#step1)。
...
- 无人直播场景，请参见 [使用点播转直播实现无人直播](https://tcloud-doc.isd.com/document/product/1156/64166?!preview&!editLang=zh)。
