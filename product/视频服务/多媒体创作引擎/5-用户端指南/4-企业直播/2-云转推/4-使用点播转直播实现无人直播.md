...
## 前提条件
- 了解 [云转推功能](https://tcloud-doc.isd.com/document/product/1156/64163?!preview&!editLang=zh)。
- **准备直播素材**：准备几段视频，您可以上传到平台的**我的网盘**中，用来跑通云转推测试使用。
- **准备输出地址**：云导播支持转推第三方平台，如视频号、微视、快手、斗鱼、虎牙等厂商，也支持自定义的 RTMP 协议的转推地址，您需要设置至少开通一个 [第三方平台的直播功能](https://tcloud-doc.isd.com/document/product/1156/64153?!preview&!editLang=zh)，或拥有一个自定义的转推地址来确保跑通直播流程。

## 点播转直播

[](id:step1)
### 步骤1：创建云转推项目
1. [访问平台](https://tcloud-doc.isd.com/document/product/1156/64110?!preview&!editLang=zh) 打开多媒体创作引擎用户端，并进入**云直播** > **云转推**。
2. 在云导播台列表页中单击**创建转推项目**，进入新建转推项目操作台。

[](id:step2)
### 步骤2：添加输入源
下述内容以添加输入源类型为**轮播文件**>**云媒资导入**为例说明，更多输入源类型添加相关说明，请参见 [跑通云转推-添加输入源](https://tcloud-doc.isd.com/document/product/1156/64164?!preview&!editLang=zh#step1)。

1. 进入云转推项目，单击左侧的**添加主输入源**，在出现的添加输入源弹窗中，选择输入源类型为**轮播文件**。
2. 单击添加文件，选择**我的网盘**中您要添加的视频，最多支持100个视频，可以在列表中预览和调整视频的顺序。
3. 选择播放次数：
...
- 专业的直播导播功能，请参见 [使用云导播开启一场直播](https://tcloud-doc.isd.com/document/product/1156/64150?!preview&!editLang=zh)。
- 直播录制及回放，请参见 [使用直播回放录制并重播](https://tcloud-doc.isd.com/document/product/1156/64155?!preview&!editLang=zh)。
- 更加轻量的直播转推功能，请参见 [使用直播转推实现多平台同步直播](https://tcloud-doc.isd.com/document/product/1156/64165?!preview&!editLang=zh)。
