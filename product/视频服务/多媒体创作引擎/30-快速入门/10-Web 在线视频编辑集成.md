...
1. 登录 [腾讯智能创作控制台](https://console.cloud.tencent.com/cme)。
2. 单击 **前往一键授权**，进入授权页面，单击 **同意授权** 授权成功，并返回腾讯智能创作控制台。
...
### 环境准备
智能创作提供的 Demo 是基于 Node.js 开发的，在运行 Demo 之前需要检查本地是否安装了 Node.js，若没有安装 Node.js 的可以登录官网进行包进行快速安装，详情请参见：[Node.js 安装包下载](https://nodejs.org)。
