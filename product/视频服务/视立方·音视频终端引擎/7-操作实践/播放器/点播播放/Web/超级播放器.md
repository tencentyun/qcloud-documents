本文档将介绍适用于点播播放的 Web 超级播放器（TCPlayer），它可以帮助腾讯云点播客户通过灵活的接口，快速与自有 Web 应用集成，实现视频播放功能，本文档适合有一定 Javascript 语言基础的开发人员阅读。
...
具体流程请参见 [使用超级播放器播放 - 接入指引](https://cloud.tencent.com/document/product/266/43629) 文档。
...
建议在使用播放器 SDK 的时候自行部署资源，单击 [下载播放器资源](https://web.sdk.qcloud.com/player/tcplayer/release/v4.2.1/release.zip) 。
...
```
开启成功后将会看到的效果如下图：
![](https://main.qcloudimg.com/raw/c71dd3729383f97e90e9a46133bbc151.png)

[](id:continuation_demo)
#### 示例
...
> - 如需关闭该功能请参见 [开发文档](https://cloud.tencent.com/document/product/1449/57089)。

[](id:thumbnail)
### 缩略图预览
Web 超级播放器支持缩略图预览，开启该功能有两种方式：
