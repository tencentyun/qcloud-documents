...
2. 您也可以通过腾讯云的查询录制文件接口定时地查看是否有新的录制文件生成。接口描述请[点击这里](https://www.qcloud.com/document/product/267/5823)
3. 产生的录制文件会展示在点播控制台上，上面会有详细的录制文件信息，其中视频id列即file_id。进入点播控制中心请点击[这里](https://console.qcloud.com/video/videolist)
