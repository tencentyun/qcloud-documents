...
- **软解码**
	- av1d（腾讯优化版本的 AV1 解码器，性能优于 dav1d，可以对外提供闭源的库，集成方法请参见 [av1d 集成说明](https://doc.weixin.qq.com/doc/w3_AAsAWwanACkw3fba1yyRUyPFTFJ7n?scode=AJEAIQdfAAouAaOKAaAAsAWwanACk)）， T-FFmpeg 提供 FFmpeg 部分的集成 Patch 和 av1d 库
