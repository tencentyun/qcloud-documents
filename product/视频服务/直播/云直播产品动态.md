...
<table><tr>
<th width="20%">动态名称</th><th width="50%">动态描述</th><th width="10%">发布时间</th><th width="20%">相关文档</th></tr><tr>
<td>新增域名租赁功能</td>
...
<td>发布V5.3.2版本</td>
<td><li>新增旧版控制台自助切换到新版控制台功能。<li>新增纯音频转码设置功能。</td>
<td>2019-04-10</td>
...
<th width="20%">动态名称</th><th width="50%">动态描述</th><th width="10%">发布时间</th><th width="20%">相关文档</th></tr><tr>
<td>发布 V5.3.1 版本</td>
<td><li>统计分析接口升级到 API 3.0 版本。<li>新增带宽封顶阈值设置功能。</td>
<td>2019-03-22</td>
<td><a href="https://cloud.tencent.com/document/product/267/35971">直播计费带宽和流量数据查询</a></td>
</tr><tr>
<td>发布 V5.3.0 版本</td>
<td><li>云直播 CAM 子账号上线，支持接口级别权限管理。<li>新增只读策略和全读写策略功能。</td>
<td>2019-03-08</td>
...
<th width="20%">动态名称</th><th width="50%">动态描述</th><th width="10%">发布时间</th><th width="20%">相关文档</th></tr><tr>
<td>发布 V5.2.3 版本</td>
<td><li>新增地址生成器工具。<li>新增支持二维码扫描推流地址和播放地址功能。<li>国际站控制台全量开放。</td>
<td>2019-02-27</td>
...
<td>发布 V5.2.1 版本</td>
<td><li>新增功能模板管理（转码、录制、截图、鉴黄及水印）。<li>新增域名粒度模板配置功能。</td>
<td>2019-01-07</td>
...
<th width="20%">动态名称</th><th width="50%">动态描述</th><th width="10%">发布时间</th><th width="20%">相关文档</th></tr><tr>
<td>发布 V2.0.0 版本</td>
<td><li>新增直播流处理功能。<li>优化更新CDN 加速。</td>
<td>2016-09-30</td>
