...
<td>发布V5.3.2版本</td>
<td><li>支持用户从旧版控制台自助切换到新版控制台。<li>支持纯音频转码设置。</td>
...
<th width="25%">动态名称</th><th width="55%">动态描述</th><th width="20%">相关文档</th></tr><tr>
<td>发布V5.3.1版本</td>
<td><li>统计分析接口升级到 API 3.0 版本。<li>支持设置带宽封顶阈值。</td>
...
<th width="25%">动态名称</th><th width="55%">动态描述</th><th width="20%">相关文档</th></tr><tr>
<td>发布V5.2.3版本</td>
<td><li>新增地址生成器工具。<li>支持二维码扫描推流地址和播放地址。<li>国际站控制台全量开放。</td>
...
<th width="25%">动态名称</th><th width="55%">动态描述</th><th width="20%">相关文档</th></tr><tr>
<td>发布V5.2.2版本</td>
<td><li>API 接口升级到3.0版本。<li>优化云直播控制台。<li>新增断流诊断工具。</td>
