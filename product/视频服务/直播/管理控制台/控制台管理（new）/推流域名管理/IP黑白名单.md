通过 IP 黑白名单配置自定义 IP 黑/白名单及规则和内容，通过请求 IP 对请求进行过滤，实现访问限制。

## 配置原理

- 配置 IP **白名单**：只有配置的 IP 地址能够推流。
- 配置 IP **黑名单**：只有配置的 IP 地址无法推流。
...
![](https://qcloudimg.tencent-cloud.cn/raw/2ac82d5557d05bbebfa61017709ca114.png)
...
<li>若配置了 IP 白名单，则允许白名单内的 IP 地址推流；拒绝白名单外的 IP 地址推流。</li>
<li>若配置了 IP 黑名单，则拒绝黑名单内的 IP 地址推流；允许黑名单外的 IP 地址推流。</li></ul></td>
</tr><tr>
<td>IP 名单</td>
...
![](https://qcloudimg.tencent-cloud.cn/raw/fc062ef2f2754f0e80ded7ec37068c0b.png)
