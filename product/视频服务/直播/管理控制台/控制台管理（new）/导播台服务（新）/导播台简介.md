...
<td>点播</td>
<td><b>点播 URL</b>：<li>既支持腾讯云 COS  储存的媒体文件，也支持存储在其他厂家的媒体文件。<li>格式支持 MP4、HLS 和 FLV（<b>建议优先使用 FLV 格式</b>。）<li>控制台将自动以列表方式循环播放列表内的文件。<li>视频编码格式仅支持 H.264 编码，音频编码类型支持 AAC。</td>
</tr><tr>
<td rowspan=2>图片</td>
