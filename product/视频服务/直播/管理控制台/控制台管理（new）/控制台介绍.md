...
<td><ul style = "margin-bottom: 0px;"><li>可通过对直播访问日志进行实时采集，再清洗、分析和检索，快速定位访问故障。</li><li>可对前一天、近一周、近一个月或自定义时间段的离线日志数据包进行下载。</li></ul></td>
</tr>
</table>
...
<td>为直播流提供全程监控服务，系统会对网络异常、推流中断等影响直播的情况进行告警，便于客户快速干预处理。</td>
</table>
