...
## 注意事项
- 实时监播最多支持创建**20个**场次记录。
- 实时监播功能于2022年11月23日零时起结束内测正式开始计费，由原来的转码费用改为出账 [增值功能费用](https://cloud.tencent.com/document/product/267/83218)，**不再收取转码费用。** 开启实时监播会使用播放业务，就会产生 [流量带宽费用](https://cloud.tencent.com/document/product/267/52662)。
