...
- 截图与鉴黄为收费功能，启用后，截图功能按每千张￥0.1元收费；鉴黄功能按每千张￥1.3元收费。详情请查看 [计费说明](https://cloud.tencent.com/document/product/267/34175#.E7.9B.B4.E6.92.AD.E6.88.AA.E5.9B.BE)。  
...
1. 登录云直播控制台，进入【功能配置】>【直播截图&鉴黄】。
2. 通过以下方式进入域名绑定窗口：
	- **直接关联域名：**单击左上方的【绑定域名】。
	![](https://main.qcloudimg.com/raw/d97d8c7e01d394e9783618516c285d20.png)
	- **新截图&鉴黄模板创建成功后关联域名：**[模板创建](#Screenshot) 成功后，单击提醒框中的【去绑定域名】。
