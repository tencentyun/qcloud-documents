...
2. 单击【+】，选择转码类型为『**普通转码**』，进行如下配置，并单击【保存】即可。
...
1. 登录云直播控制台，【功能模板】>[【转码配置】](https://console.cloud.tencent.com/live/config/transcode)。
2. 单击【+】，选择转码类型为『**极速高清**』，进行如下配置，并单击【保存】即可。
...
<table>
   ...
   <td>码率压缩比</td>
   <td>表示相比视频码率节省的码率，取值范围：10 - 50。<br>说明：请输入10 - 50之间的整数。</b></td>
   </tr>
   </tbody></table>
...
## 删除模板
若模板已被关联，需要先解绑模板，才可以进行删除操作，具体解绑操作请参见 [解绑转码配置](https://cloud.tencent.com/document/product/267/32834#.E8.A7.A3.E7.BB.91.E8.BD.AC.E7.A0.81.E9.85.8D.E7.BD.AE)。 
1. 进入【功能模板】>【转码配置】。
