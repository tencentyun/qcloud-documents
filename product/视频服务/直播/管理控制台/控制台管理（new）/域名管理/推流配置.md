...
## 推流地址示例代码
腾讯云为您提供的 PHP 和 Java 语言的推流地址示例代码，您可直接参考示例代码完成推流地址的接入。
您可通过进入【[域名管理](https://console.cloud.tencent.com/live/domainmanage)】，选择推流域名或单击右侧的【管理】，进入域名详情页。选择【推流配置】，下拉到底查看【推流地址示例代码】标签。单击标签按钮，即可切换查看对应的示例代码。
![](https://main.qcloudimg.com/raw/c618bd1188cc4e6ce5704b4c5937a842.png)
