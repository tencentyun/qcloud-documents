为了保护直播推流的信息安全，云直播推流域名默认开启推流鉴权。您可通过控制台支持修改推流域名鉴权信息，也可以通过推流地址详情页中的推流地址生成器，在线生成对应的推流地址。通过使用推流地址在线推流，实现直播流传输到云直播服务，即实现直播视频上传。
...
2.  单击【推流配置】，查看【鉴权配置】标签。
3.  单击右侧的【编辑】，即可进入修改推流鉴权信息，单击【保存】即可成功生效。
