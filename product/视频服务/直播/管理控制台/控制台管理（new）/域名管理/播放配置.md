...
- 若采用 H.265 推流，同时播放 H.265 的直播流，可直接使用 [控制台](https://cloud.tencent.com/document/product/267/35257) 或者 [按照规则拼接](https://cloud.tencent.com/document/product/267/32720#play) 而成的播放地址。
- 若采用 H.264 推流，同时播放 H.265 的直播流，可在 [控制台通过转码模板](https://cloud.tencent.com/document/product/267/32736#T_control) 或者通过 [直播转码 API](https://cloud.tencent.com/document/product/267/32736#T_api) 实现。
