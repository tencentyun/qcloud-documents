## 操作场景
您的播放域名如果需要进行海外分发、加速和播放，则需要您将域名切换为海外地区，您可以在区域配置中选择域名的播放区域。

## 前提条件
已登录 [云直播控制台](https://console.cloud.tencent.com/live)。
## 操作步骤
1. 在新增域名，选择播放域名时，选择需要直播播放分发的加速区域，单击【提交】。
...
3. 在【高级配置】菜单栏下，可以设置修改该播放域名的区域配置。单击【区域配置】的【编辑】，可以切换为中国大陆、全球加速或是海外及港澳台。
