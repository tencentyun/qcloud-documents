...
2. 调用 [CreateLiveRecordRule](https://cloud.tencent.com/document/product/267/32615)，设置参数推流域名 DomainName 和 TemplateId（第1步返回）。在 DomainName 及 StreamName 填写空字符串，表示通配此域名下所有推流。
