...
<td><ul style="margin:0">
    ...
    <li>检查 interface name 是否为<code>mix_streamv2.start_mix_stream_advanced</code>。</li>
...
<td><ul style="margin:0">
    <li>是否推流成功5s后发起混流。 检查能否播放。</li>
    <li> 检查混流参数中 appid 是否填写正确。</li>
    </ul></td>
</tr><tr>
<td>-507</td>
<td>流长宽参数查询失败</td>
