...
>!
>- 为了保障您的直播安全，系统会自动开启推流鉴权，或您也可以在[【域名管理】](https://console.cloud.tencent.com/live/domainmanage)>对应推流域名>【推流配置】中，自定义设置鉴权信息。推流地址格式为  `rtmp://domain/live/StreamName?txSecret=xxx&txTime=xxx`。
