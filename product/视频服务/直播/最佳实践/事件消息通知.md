...
![img](https://main.qcloudimg.com/raw/5fd8ce375c744ecc7c057122bb6c02dc.png)
...
- [云直播控制台](https://cloud.tencent.com/document/product/267/32744)
...
- 鉴黄事件通知URL（PornCensorshipNotifyUrl ）
...
| 字段名称   | 类型   | 说明                                                         |
| :--------- | :----- | :----------------------------------------------------------- |
| event_type | int    | 事件通知信息类型：推流事件为1；断流事件为0；录制事件为100；截图事件为200；鉴黄事件为317。 |
| sign       | string | 事件通知签名                                                 |
...
![img](https://main.qcloudimg.com/raw/bbda212679898a8b8e4f26351650f868.png)
