...
<li/><strong>新用户请选购新版连麦音视频通用套餐包（RTC），连麦老用户请续费购买旧版移动直播连麦资源包，两种套餐资源包不可互通使用</strong></td>
...
<li/>旧版移动直播连麦资源包已下线，仅支持连麦老用户续费购买，<strong>新用户请选购新版连麦音视频通用套餐包（RTC）</strong></td>
<td style="text-align:center">仅限老用户前往<strong>云直播控制台</strong> &gt; <strong>资源包/插件管理</strong> &gt; <strong><a href="https://console.cloud.tencent.com/live/resources/liveroom">连麦包</a></strong>，单击<strong>购买连麦包</strong></td>
</tr><tr>
...
| 1TB                    | 248       | 无                                    |
| 5TB                    | 1200     | 无                                    |
| 10TB                   | 2350     | 赠送直播推流 License（原移动直播基础版 SDK License） <br>一年使用授权 |
| 50TB                   | 9889    | 赠送直播推流 License（原移动直播基础版 SDK License） <br>一年使用授权 |
| 200TB                  | 35500   | 赠送直播推流 License（原移动直播基础版 SDK License） <br>一年使用授权 |
| 1PB                    | 165000 | 赠送直播推流 License（原移动直播基础版 SDK License）<br> 一年使用授权 |
...
腾讯云新增了基于 RTC 协议的连麦方案，同时提供了更加简单灵活的 V2 接口，更好的满足开发者针对连麦功能的需求，接入操作请参见 [RTC 观众连麦](https://cloud.tencent.com/document/product/454/52751)。RTC 连麦互动直播服务费用按所有参与连麦的用户产生的 [视频时长](https://cloud.tencent.com/document/product/454/8008#v_duration) 和 [语音时长](https://cloud.tencent.com/document/product/454/8008#s_duration) 来统计连麦服务产生的用量。

>! 
>- **新用户请选购新版连麦音视频 通用套餐包（RTC），连麦老用户请续费购买 [旧版移动直播连麦资源包](#mobilelive_pag)，两种套餐资源包不可互通使用。**
...
> ! 
> - 旧版移动直播连麦资源包已下线，新用户推荐选购 [新版直播连麦套餐包（RTC）](#new_mobilelive_pag)，原移动直播连麦（RTMP_ACC）老用户可续费购买旧版移动直播连麦资源包，两种套餐资源包不可互通使用。推荐老用户尽快迁移至新版直播连麦（RTC），请选购 [新版直播连麦套餐包（RTC）](#new_mobilelive_pag)，迁移指引请参见 [RTC 功能实现](https://cloud.tencent.com/document/product/454/52751#rtc-.E8.BF.9E.E9.BA.A6.E5.8A.9F.E8.83.BD.E5.AE.9E.E7.8E.B0)。
...
<b>其它分辨率可抵扣时长 = 套餐包时长 × H.264_480P 的后付费价格 / [对应码率的后付费价格](https://cloud.tencent.com/document/product/267/39889#s_trans)</b>
