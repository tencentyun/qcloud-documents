...
<li/><strong>推荐您选购新版直播连麦套餐包（RTC）。原移动直播连麦（RTMP_ACC）老用户，推荐您尽快迁移至新版直播连麦（RTC）。若您继续使用旧版移动直播连麦，续费请购买 <a href="#mobilelive_pag">旧版移动直播连麦资源包</a>。新旧两种套餐资源包不可互通使用</strong></td>
...
<li/>旧版移动直播连麦资源包已下线，仅支持连麦老用户续费购买，<strong>推荐新老用户选购新版直播连麦套餐包（RTC）</strong></td>
