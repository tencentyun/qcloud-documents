...
![](https://main.qcloudimg.com/raw/2b084f4e696fb3792b50d05bb5c71232.jpg)

- 基础计费项为**流量/带宽**费用，即通过标准直播观看直播内容时产生的下行流量/带宽费用，您可以选择适合您的计费模式（流量或带宽）进行计费。
- 增值计费项为**域名租赁**、**直播转码**、**直播录制**、**直播截图**、**直播鉴黄**和**移动直播连麦**费用，上述五项为标准直播的增值功能，您可以按需使用，根据您的实际使用情况进行付费。
...
| 计费项 | 计费模式 | 付费方式 |
|-------------| -------------|-------------|
| [域名租赁](https://cloud.tencent.com/document/product/267/34174?!editLang=zh&!preview#.E5.9F.9F.E5.90.8D.E7.A7.9F.E8.B5.81.E8.B5.84.E6.BA.90.E5.8C.85) | 按租赁时长 | 预付费资源包 |
