...
>- 移动直播 SDK 的直播推流 License 用于腾讯云视立方·音视频终端引擎管理功能模块的授权解锁，需在 [消息订阅](https://console.cloud.tencent.com/message/subscription) 中订阅**音视频终端引擎**，即可接收 License 到期提醒，以及更多各渠道消息通知。
