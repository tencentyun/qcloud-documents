...
您可通过使用[【自有域名】](https://cloud.tencent.com/document/product/267/20381)添加已完成备案的自有域名；也可以在通过身份核验后使用[【域名租赁】](https://cloud.tencent.com/document/product/267/40367)，租赁腾讯云提供的播放域名，快速体验和使用直播服务。
...
![](https://main.qcloudimg.com/raw/7efd18aefbd2b24dff9247e2a03b47ef.png)
...
![](https://main.qcloudimg.com/raw/159ab193de075cd0a1feeb668af60d67.png)
4. 身份核验通过后，单击【继续完成域名租赁】，进入租赁域名添加页。
5. 自定义输入4 - 9位的数字或字母的域名前缀，单击【确定】。 
![](https://main.qcloudimg.com/raw/5064c4a9df86343035387289f609bf58.png)
6. 弹窗提示“还未购买套餐包，请您先购买套餐包后再租赁域名，请前往购买”，单击【前往购买】进入域名租赁资源包购买页。
7. 选择您所需购买的套餐配额，单击【立即购买】。
8. 付款成功后，返回域名租赁添加页，单击【已完成购买】即可成功添加租赁域名。

>?  
>- 云直播默认提供测试域名`数字.livepush.myqcloud.com`，您可通过该域名进行推流测试，但不建议您在正式业务中使用这个域名作为推流域名。
>- 域名添加成功后，您可通过[【域名管理】](https://console.cloud.tencent.com/live/domainmanage)的域名列表查看域名信息。若您需要对已添加成功的域名进行管理，请参见 [域名管理](https://cloud.tencent.com/document/product/267/40935)。
