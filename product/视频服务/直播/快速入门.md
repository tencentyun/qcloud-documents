...
>- 新备案成功的域名需要1天左右的时间同步到腾讯云服器，添加该类域名时可能会显示域名未备案。
...
本文以 DNS 服务商为腾讯云为例，讲述添加 CNAM 记录的操作步骤。若您使用其他 DNS 服务商，更多详细操作请参见 [CNAME 配置](https://cloud.tencent.com/document/product/267/19908)。
...
2. 选择指定推流域名或单击操作的【管理】，进入【推流配置】，在该页面进行如下设置：
