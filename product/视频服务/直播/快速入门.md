...
2. 选择【辅助工具】>[【地址生成器】](https://console.cloud.tencent.com/live/addrgenerator/addrgenerator) ，在该页面进行如下配置：
	1. 选择生成类型，例如：播放域名
	2. 选择您在域名管理中已添加的播放域名
	3. 填写与推流地址相同的 StreamName，播放地址 StreamName 要与推流地址 StreamName 一致才能播放对应的流
	4. 选择地址过期时间
	5. 单击 【生成地址】即可生成播放地址 
	![](https://main.qcloudimg.com/raw/0999b5e57bf62cb3fa9b0c3c205db18b.png)
