...
### 频道费用
腾讯云直播服务向每个帐号提供5个免费的频道用于调试。若您的产品需要使用更多的频道，我们将收取 60元/频道/月 的费用（按照月实际推流并发频道数峰值计算，不累加）。另，每50M并发带宽将减免抵扣1个频道的费用。直播码模式和频道模式均按照此标准收费，直播码模式一个视频ID即为一个频道。
需增加频道或了解细节，请联系：QQ：3358225043。
### 录制费用
