...
快直播拉流 URL 格式为 **`webrtc://domain/path/stream_id`**，如果需要 [防盗链鉴权](https://cloud.tencent.com/document/product/267/32735)，则拉流 URL 格式为 **`webrtc://domain/path/stream_id?txSecret=xxx&txTime=xxx`**。腾讯云直播拉流 URL 生成请参见 [标准直播快速入门](https://cloud.tencent.com/document/product/267/13551#step4)。
