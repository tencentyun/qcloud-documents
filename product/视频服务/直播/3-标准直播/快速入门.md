...
3. 您可以根据业务场景使用以下方式测试直播流是否能正常播放：
   ...
   2. Web 端播放测试，建议您选用播放器 SDK 里的  [TCPlayer 播放器](https://cloud.tencent.com/document/product/881/30818) 进行播放，具体请参见 [直播播放](https://cloud.tencent.com/document/product/267/32733#.E5.9C.BA.E6.99.AF.E5.9B.9B.EF.BC.9Aweb-.E7.AB.AF.E6.92.AD.E6.94.BE)。
