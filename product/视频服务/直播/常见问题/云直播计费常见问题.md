...
直播流量资源包适用于中国内地（大陆）标准直播下行流量抵扣。2021年03月01日0点起，现有的标准直播流量资源包升级为直播流量资源包，支持按比例抵扣**国际/港澳台标准直播日结流量**和**中国内地（大陆）快直播日结流量**。
- [国际/港澳台标准直播日结流量](https://cloud.tencent.com/document/product/267/34175#overseas_flow) 按照**1：1.8**比例折算为直播流量资源包抵扣。
- [中国内地（大陆）快直播日结流量](https://cloud.tencent.com/document/product/267/39136#.E6.B5.81.E9.87.8F.E8.AE.A1.E8.B4.B9) 按照**1：2**比例折算为直播流量资源包抵扣（境外快直播暂不支持）。
- 支持按照**中国内地（大陆）快直播** > **中国内地（大陆）标准直播** > **国际/港澳台标准直播**抵扣顺序对应的日结流量。资源包资源用尽后，未抵扣部分会按照后付费价格产生对应的流量账单。


[](id:pack_que2)
### 已经购买了直播流量资源包，为什么还会扣费？
直播流量包仅可抵扣计费方式为日结流量后付费时产生的下行播放流量。

- 若要使用流量包抵扣，可以在 [云直播控制台](https://console.cloud.tencent.com/live/livestat) 切换计费方式为日结流量计费，月结用户请联系商务经理进行切换。
- 若您当计费方式为**日结流量计费**，产生了其他扣费，可能是您直播过程中使用了其它 [增值服务](https://cloud.tencent.com/document/product/267/52662#appreciation)。您可通过腾讯云控制台[【账单详情】](https://console.cloud.tencent.com/expense/bill/summary)>【明细账单】查看产生费用的服务，相关操作文档可参见 [账单查询](https://cloud.tencent.com/document/product/267/44772)。
...
>?小程序播放域名、标准直播月结流量计费消耗和日结/月结带宽计费消耗均不支持使用抵扣直播流量资源包。
