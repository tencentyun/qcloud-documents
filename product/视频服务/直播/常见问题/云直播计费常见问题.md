...
标准直播计费项包含基础服务费用和增值服务费用。标准直播流量包仅可抵扣基础服务产生的费用，产生其他扣费时，可能是由于使用了其他增值服务项。可通过腾讯云控制台[【账单详情】](https://console.cloud.tencent.com/expense/bill/summary)>【明细账单】中查看产生费用的服务，相关操作文档可参见 [账单查询](https://cloud.tencent.com/document/product/267/44772)。
>? 标准直播费用组成详情可参见 [标准直播价格总览](https://cloud.tencent.com/document/product/267/2818)。 

<span id="que11"></span>
### 直播混流是不是必须产生转码费用？
不是必须的。只有当播放域名关联了转码模板进行直播播放，产生相应的费用后，云直播将收取相应的转码费用，具体费用详情请参见 [直播转码计费说明](https://cloud.tencent.com/document/product/267/34175#.E7.9B.B4.E6.92.AD.E8.BD.AC.E7.A0.81)。
