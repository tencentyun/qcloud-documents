...
<span id="que9"></span>
### 直播录制路数峰值如何计算？
一路直播流（一个流 ID）录制一种格式文件，即为一路直播录制任务，一个月内产生的最高的录制路数即为直播录制路数峰值。
**示例：**
<style>#ye{background:#ffe699;}#gr{background:#c6e0b4;}#br{background:#bdd7ee}</style>
<table id="rroad">
<tr><th rowspan=2 width="10%">流 ID</th>
...
- 若您当计费方式为**日结流量计费**，产生了其他扣费，可能是您直播过程中使用了其它 [增值服务](https://cloud.tencent.com/document/product/267/2818#.E5.A2.9E.E5.80.BC.E8.AE.A1.E8.B4.B9.E9.A1.B9)。您可通过腾讯云控制台[【账单详情】](https://console.cloud.tencent.com/expense/bill/summary)>【明细账单】查看产生费用的服务，相关操作文档可参见 [账单查询](https://cloud.tencent.com/document/product/267/44772)。



<span id="que11"></span>
### 直播混流是不是必须产生转码费用？
不是必须的。只有当混流域名关联了转码模板进行直播播放，产生相应的费用后，云直播才会收取相应的转码费用，具体费用详情请参见 [直播转码计费](https://cloud.tencent.com/document/product/267/34175#.E7.9B.B4.E6.92.AD.E8.BD.AC.E7.A0.81)。
...
<span id="que13"></span>
###  只录制一种类型的文件，为什么扣了60元？ 
录制计费是按照录制路数峰值来收费，一个月一路为30元，具体计费详情请参见 [直播录制计费](https://cloud.tencent.com/document/product/267/34175#.E7.9B.B4.E6.92.AD.E5.BD.95.E5.88.B6)。
建议前往费用中心的【账单详情】>[【资源ID账单】](https://console.cloud.tencent.com/expense/bill/summary)查看直播录制项账单情况，单击操作栏的【账单详情】进入查看上月录制实际录制峰值路数，如下图所示：

![](https://main.qcloudimg.com/raw/4aae463e52ebdd612d2a1b3d7b740097.png)
