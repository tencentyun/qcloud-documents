...
### 如何查看推流示例代码？
您可通过登录云直播控制台，选择[【域名管理】](https://console.cloud.tencent.com/live/domainmanage)。在域名列表中选择您所需的推流域名并单击右侧的【管理】，进入域名详情页选择【推流配置】，下拉即可看到**【推流地址示例代码】**，您可通过切换 Tab 按钮查看 PHP/Java 示例代码。
