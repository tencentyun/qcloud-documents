...
### 步骤二：获取推流URL
想要简单获取一个推流URL，可以参考文档：获取推流地址（[新版控制台](https://cloud.tencent.com/document/product/267/32833) &  [旧版控制台](https://cloud.tencent.com/document/product/267/31156#.E5.9C.B0.E5.9D.80.E7.94.9F.E6.88.90.E5.99.A8)）。
想要了解推流地址和直播间ID的关系，可以参考文档：[如何自主拼装推流 URL](https://cloud.tencent.com/document/product/267/32720)。
想要了解如果保护自己的推流地址不被盗用，可以参考文档：[防盗链签名](https://cloud.tencent.com/document/product/454/14551)。
