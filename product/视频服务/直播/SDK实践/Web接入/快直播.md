...
[TXLivePusher 推流 SDK](https://cloud.tencent.com/document/product/267/56505) 主要用于视频云的快直播（超低延时直播）推流，负责将浏览器采集的音视频画面通过 WebRTC 推送到直播服务器。目前支持摄像头推流、屏幕录制推流和本地媒体文件推流。
