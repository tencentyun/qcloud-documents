...
This API (StopLVBChannel) is used to enter the ID of an LVB channel to stop the channel (channels can be stopped in batch).
...
Input 1
<pre>
https://domain/v2/index.php?Action=StopLVBChannel&channelIds.1=96171715553394810&<a href="https://cloud.tencent.com/doc/api/229/6976">Common request parameters</a>
</pre>
