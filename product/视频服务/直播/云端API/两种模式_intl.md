...
The LVB Code mode is mainly designed to facilitate the direct management of LVB streams by customers in the backend. It was only open to several well-known LVB platforms in China before May 2016, and now it has become a mainstream access solution of Tencent Cloud LVB service owing to its low access cost and high reliability.

This solution is designed in such a way that the URL generation and LVB streams are basically controlled by customers, which delivers higher flexibility and customizability. It is the preferred access solution for platform LVB scenarios such as Game LVB and Live Show.
