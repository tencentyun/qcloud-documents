...
| 费用类型               | 说明                                                         |
| ---------------------- | ------------------------------------------------------------ |
| [SDK 授权费用](#sdk)       | 播放器 SDK 移动端（ iOS & Android & Flutter）的使用授权费用（Web免费公测中，暂时无需 License）。 |
| [其他相关云服务费用](#other) | 配合 [腾讯云直播](https://cloud.tencent.com/product/css)、[腾讯云点播](https://cloud.tencent.com/product/vod) 等云端服务使用播放器 SDK 时，产生对应的费用。 |
