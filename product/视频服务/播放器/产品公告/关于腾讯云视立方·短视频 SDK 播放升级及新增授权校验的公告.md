...
同时从该版本开始将增加对视频播放功能模块的授权校验，**若您需要使用上述全面升级后的卓越视频播放器，需升级 SDK （10.1版本后）并获得指定 License 授权**，**无 License 授权将无法正常使用 SDK 10.1及其之后版本中的视频播放相关功能**。授权解锁及计费说明详情请参见 [授权说明]()。
...
> - 10.1 版本将在2022年05月底正式发布，届时将同步上线相关 License 的申请、购买页面及相关文档，本次升级涉及的移动端（iOS & Android & Flutter）SDK 包含：[直播 SDK]()、[播放器 SDK]()、[短视频 SDK]()、[音视频通话 SDK（TRTC SDK）]()、[全功能版 SDK]()，您可持续关注对应 SDK 官网通知以了解最新动态。
