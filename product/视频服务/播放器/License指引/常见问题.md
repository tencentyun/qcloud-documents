...
- **视频播放 License**：用于解锁播放器 SDK 的视频播放功能。
...
若您需解锁腾讯云视立方·播放器 SDK 视频播放功能模块，使用视频点播直播播放能力，则需购买获得视频播放 License 使用授权。

[](id:que4)
### 视频播放  License 有单独购买入口吗？
视频播放 License 支持单独购买。您可参见[腾讯云视立方·播放器 SDK 价格总览](https://cloud.tencent.com/document/product/881/20193)，了解**购买独立视频播放 License** 详情。也可购买 100GB、500GB、1TB、5TB 直播/点播流量资源包赠送视频播放 License 一年使用授权。

[](id:que5)
### 视频播放 License 可以用什么授权解锁视频播放功能模块？
