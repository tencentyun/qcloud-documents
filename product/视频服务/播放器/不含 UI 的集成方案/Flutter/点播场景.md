...
本文档部分内容为腾讯云专属能力，使用前请开通 [云点播](https://cloud.tencent.com/product/vod) 相关服务，未注册用户可注册账号 [免费试用](https://cloud.tencent.com/login)。
...
int? downloadState = downloadInfo.downloadState; // 获取下载状态，具体参见 STATE_xxx 常量
```
