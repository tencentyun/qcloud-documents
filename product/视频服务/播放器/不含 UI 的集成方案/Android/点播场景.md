...
下载和集成 SDK 开发包，请参考同目录下的 [SDK 集成指引](https://cloud.tencent.com/document/product/881/81205)。
...
int downloadState = downloadInfo.getDownloadState(); // 获取下载状态，具体参考 STATE_xxx 常量
