...
下载和集成 SDK 开发包，请参见同目录下的 [SDK 集成指引](https://cloud.tencent.com/document/product/881/81205)。
...
TXPlayInfoParams playInfoParam = new TXPlayInfoParams(1252463788, // 腾讯云账户的 appId
...
![](https://qcloudimg.tencent-cloud.cn/raw/ed4c8681616c4fbce1cfe8898252ebc5.png)
...
mVodPlayer.setVodListener(new ITXVodPlayListener() {
    ...
    public void onPlayEvent(TXVodPlayer player, int event, Bundle param) {
        if (event == TXLiveConstants.PLAY_EVT_PLAY_PROGRESS) {
            ...
            mLoadBar.setProgress(playable_duration_ms); // 设置 loading 进度条
...
if (sdcardDir != null) {
    ...
    TXPlayerGlobalSetting.setMaxCacheSize(200); //单位 MB
}
...
// QUALITYSD  // 标清
// QUALITYHD  // 高清
TXVodDownloadDataSource source = new TXVodDownloadDataSource(1252463788, "4564972819220421305", QUALITYHD, "pSignxxxx", "");   //pSign 加密视频签名， 通过 fileId下载必填
...
int downloadState = downloadInfo.getDownloadState(); // 获取下载状态，具体参见 STATE_xxx 常量
boolean isDownloadFinished = downloadInfo.isDownloadFinished(); // 返回 true 表示下载完成
```
