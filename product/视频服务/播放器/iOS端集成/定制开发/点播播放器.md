...
<td><b>VIDEO_WIDTH</b></td><td>视频分辨率 - 宽</td>
</tr><tr>
<td><b>VIDEO_HEIGHT</b></td><td>视频分辨率 - 高</td>
</tr><tr>
...
通过监听上面的事件，您可以实现视频播放卡顿时显示当前网速：监听PLAY_EVT_PLAY_LOADING（视频播放 loading）事件，然后显示当前网速，收到PLAY_EVT_VOD_LOADING_END（视频播放 loading 结束）事件后，对显示速率的 view 进行者隐藏。
