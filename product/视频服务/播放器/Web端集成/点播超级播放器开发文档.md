...
本文档是介绍腾讯云 Web 云点播服务的**超级播放器相关参数以及 API**，需结合 [使用文档](https://cloud.tencent.com/document/product/266/14424) 使用。本文档适合有一定 Javascript 语言基础的开发人员阅读。
...
| Danmu | Boolean | false | 控制是否开启弹幕功能 |
