...
播放器 SDK 是腾讯云自主研发，支持 Web 端、iOS 端、Android 端三大终端，集多功能于一体的高性能的一套解决方案。能够根据您的使用所需，在短时间内打造完成流畅的观看体验。
本部分包含 Web 端、iOS 端、Android 端下超级播放器的基本入门指引，请根据您的所需灵活选择相应部分阅读。
