...
### 集成 SDK 运行以后，运行后出现“**dyld[34620]: Library not loaded: **@rpath/**TXFFmpeg.framework**/
...
```objc
打开 Xcode -> 选择对应的 Target -> 选择"General" Tab -> 选择"Frameworks,Libraries,and Embedded Content" -> 选择TXFFmpeg.framework，并也在右侧选择"Embed & Sign"
```
