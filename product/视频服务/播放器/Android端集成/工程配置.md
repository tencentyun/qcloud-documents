...
您可以前往 [SDK下载](https://cloud.tencent.com/document/product/881/20205) 文档下载对应的 SDK 文件。
...
>! `launchMode="singleTask"` 必须指定为 `singleTask` 否则悬浮窗模式切回 Activity 界面会出现多个Activity导致异常。
