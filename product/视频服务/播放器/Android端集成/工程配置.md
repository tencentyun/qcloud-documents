...
您可以前往 [SDK下载](https://cloud.tencent.com/document/product/881/20205)文档下载对应的SDK文件
...
- 若提示`Could not find :LiteAVSDK_xxx`，请检查lib_tcsuperplayer的依赖，LiteAVSDK的名字应该和app gradle中一致
...
- "com.hans.superplayertest.MainActivity" 应修改为您工程对应的id
