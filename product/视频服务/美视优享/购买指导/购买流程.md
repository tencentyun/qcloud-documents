...
## 2. 提交申请
美颜特效功能已集成到商业版(Enterprise) SDK 中，您可根据您的需求场景选择在直播或短视频场景下使用。然后提交 [申请使用](https://cloud.tencent.com/apply/p/h1qsz5vhvko) ，填写申请信息。
>! 商业版 SDK 的 License 需要绑定一个APP的包名信息，需要提前准备 iOS 的 bundle id 和 Andorid 的 Package name，提交签发 License 后不允许修改，请核实后再提交申请。
...
## 4. 测试体验
确认产品符合功能需求和业务场景后即可通过申请审批，由商务同学交付 1个月测试的商业版 License，您可以下载商业版 SDK 试用产品功能。
