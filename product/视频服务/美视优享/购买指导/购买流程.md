...
1. 正式授权购买成功后，您可以进入 [腾讯云视立方控制台](https://console.cloud.tencent.com/vcube) 创建应用并绑定 License。绑定 License 的具体流程请参见 [正式版 License](https://cloud.tencent.com/document/product/616/65879) 指引。
