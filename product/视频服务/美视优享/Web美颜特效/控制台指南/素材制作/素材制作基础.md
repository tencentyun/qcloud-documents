...
2. 单击**美妆效果** > **眉妆**或**眼妆**，在**参数配置区**单击**模板下载**，即可可下载标准的模板。
...
2. 每添加一个素材，**参数配置区**都会出现该素材的**参数信息**，您可以去对素材进行一些调整，例如**混合模式**（参考制作素材时 PS 的混合模式）、强度（即透明度）等，贴纸类素材还可以调整其位置大小及播放速率（FPS）等信息。
