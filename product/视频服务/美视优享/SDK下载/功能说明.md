...
腾讯特效 SDK 能力以套餐和原子能力的形式提供。

共有 14 个套餐，分为 3 个系列：[A 系列基础套餐](#setA)、[S 系列高级套餐](#setS) 和 [V 系列虚拟人套餐](#setV)。不同系列的不同套餐对应不同功能；原子能力提供单算法能力，集成更加灵活，业务拓展性高。
...
X系列提供单独的算法能力，集成更加灵活，业务拓展性更高，适用于对算法能力有需求的客户。
