...
腾讯特效 SDK 共有 11 个套餐，11 个套餐分为 2 个系列：[A 系列基础套餐](#setA) 和 [S 系列高级套餐](#setS)。不同系列的不同套餐对应不同功能，各套餐支持的功能详情如下表。更多下载说明请参见 [SDK 下载](https://cloud.tencent.com/document/product/616/65876)。
