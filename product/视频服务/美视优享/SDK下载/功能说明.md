...
腾讯特效 SDK 分为 3 个系列：[A 系列基础套餐](#setA)、[S 系列高级套餐](#setS) 和 [V 系列虚拟人套餐](#setV)。不同系列的不同套餐对应不同功能，各套餐支持的功能详情如下表。更多下载说明请参见 [SDK 下载](https://cloud.tencent.com/document/product/616/65876)。
