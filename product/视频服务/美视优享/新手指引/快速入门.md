...
- **Android 平台：**有 jar 包和 aar 两种集成方式选择使用，详细内容请参见 [Android 工程配置](https://cloud.tencent.com/document/product/616/11228#.3Cspan-id.3D.22jump.22.3E.E5.B7.A5.E7.A8.8B.E8.AE.BE.E7.BD.AE.3C.2Fspan.3E)。
>! 最后一定不要忘记验证一下配置是否正确。
