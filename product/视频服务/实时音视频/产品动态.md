...
<table>
	 ...
	 <tr>      
         <td>计费变更</td>   
         <td>语音时长变更为所有用户在房间内的总停留时长，再减去所有用户订阅视频流时的停留时。<br>补充说明：<ul style="margin:0;"><li>同时订阅了多路音频流的同一个用户的语音时长不会被叠加。</li>
...
<table>
...
</ul>iOS&Android：新增 API：snapshotVideo() 支持本地及远端视频画面截图。
...
</ul>Windows：<ul style="margin:0;"><li></li>
		 <li>C# 版 SDK 支持真窗口渲染和自定义渲染。</li>
	 ...
	 <tr>      
		 ...
		 <li>提供接收端/发送端多视角的数据详情，提供详细事件标记。</li>
...
<table>
	 ...
	 <tr>      
         <td>取消月功能使用费</td>   
         <td>自2019年3月起不再收取1500元/月的月功能使用费，计费变化体现在4月1日推送的账单中。</td>   
	     <td>2020-04-01</td>   
	     <td>-</td>   
     </tr> 
</table>
...
<table>
	 ...
	 <tr>      
		 ...
		 <li>支持大小流双路编码功能（推荐仅在Windows 和 Mac 设备上开启）。</li>
