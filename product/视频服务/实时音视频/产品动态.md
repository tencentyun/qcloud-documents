...
全平台：<ul style="margin:0">
	<li/>全平台 onStatistics 回调中增加远端视频卡顿相关信息。
	<li/>全平台支持通过音量调节接口实现声音的增益效果（使用前请联系技术支持）。
	<li/>全平台优化戴耳机时的声音流畅度，提高声音音质。
</ul>
<br>Android：<ul style="margin:0">
<li/>新增 setLocalVideoProcessListener 接口，能更好地支持第三方美颜集成。
<li/>优化双讲剪切效果。
</ul>
<br>iOS：<ul style="margin:0">
新增 setLocalVideoProcessListener 接口，能更好地支持第三方美颜集成。
</ul>
