...
>- 微信小程序端画面质量，可通过 pusherAttributes 进行设置，maxBitrate（最大码率）/minBitrate（最小码率）/videoWidth（上推的视频流的分辨率宽度）/videoHeight（上推的视频流的分辨率高度），请参见 [trtx-wx接口文档](https://cloud.tencent.com/document/product/647/17018#pusherAttributes)。
