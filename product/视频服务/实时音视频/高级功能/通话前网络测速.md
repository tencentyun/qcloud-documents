...
<td>上行带宽</td>
<td>预测的上行带宽，单位为 kbps， -1表示无效值</td>
</tr><tr>
<td>availableDownBandwidth</td>
<td>下行带宽</td>
<td>预测的下行带宽，单位为 kbps， -1表示无效值</td>
</tr></table>
...
| 指标         | 含义                                                                                                               |
|--------------|--------------------------------------------------------------------------------------------------------------------|
| WiFi Quality | 表示 Wi-Fi 信号质量                                                                                                  |
| DNS RTT      | 对腾讯云的测速域名解析耗时，单位 ms                                                                                  |
| MTR          | 当客户端访问目标服务器或负载均衡，使用 ping 命令测试出现丢包或不通时，可以通过 MTR 等工具进行链路测试来判断问题来源 |
| UDP Loss     | 客户端到 TRTC 节点的 UDP 丢包率                                                                                        |
| UDP RTT      | 客户端到 TRTC 节点的 UDP 延时                                                                                          |
| Local RTT    | 客户端到本地网关的 ping 延时                                                                                         |
| Upload       | 上行预估带宽                                                                                                       |
| Download     | 下行预估带宽                                                                                                       |
...
### 工具截图
- 登录：
![](https://qcloudimg.tencent-cloud.cn/raw/4318bb0b93c306275ed862893c8b035a.png)
- 快速测试：
![](https://qcloudimg.tencent-cloud.cn/raw/d8efbdb1e4e90a4d1a3e5d9f5e37af1c.png)
- 持续测试：
![](https://qcloudimg.tencent-cloud.cn/raw/eb896e495b0fbc832d789347fec4e420.png)
