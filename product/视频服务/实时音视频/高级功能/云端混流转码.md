...
![](https://main.qcloudimg.com/raw/3069963f25529168ce3685611b55580f.png)
...
- **Objective-C**
 详细的云端混流转码配置，请参见 [TRTCTranscodingConfig](https://cloud.tencent.com/document/product/647/32261#trtctranscodingconfig) 的定义。
``` Objective-C
//云端混流转码的示例代码
...
- **Java**
 详细的云端混流转码配置，请参见 [TRTCTranscodingConfig](https://cloud.tencent.com/document/product/647/32266#trtctranscodingconfig) 的定义。
``` java
//开启云端混流转码
...
- **C++**
 详细的云端混流转码配置，请参见 [TRTCTranscodingConfig](https://cloud.tencent.com/document/product/647/32271#trtctranscodingconfig) 的定义。
``` C++
// 开启云端混流转码
void enableTranscoding()
{
...
- **C#**
 详细的云端混流转码配置，请参见 [TRTCTranscodingConfig](https://cloud.tencent.com/document/product/647/36780#trtctranscodingconfig) 的定义
```c#
// 开启云端混流转码
