...
1. 确认 [云点播服务](https://console.cloud.tencent.com/video) 已经开启。
...
3. 退出直播间，在点播控制台的 [视频管理](https://console.cloud.tencent.com/video/videomanage) 界面中直接找到该文件，或用直播流 ID 进行前缀搜索找到该文件，如下图：
