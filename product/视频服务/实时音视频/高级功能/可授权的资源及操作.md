...
除了部分 [不支持资源级授权的 API ](#n_Support)，本小节列出的所有 API 操作均支持资源级授权。 [授权策略语法]() 中对这些 API 操作的**资源语法描述**均相同，具体为：
...
<tbody><tr><td>DismissRoom</td><td>房间管理</td><td>解散房间</td>
</tr><tr>
<td>RemoveUser</td>
<td>房间管理</td>
<td>移出用户</td>
...
### 控制台 API 操作
<table>
<thead><tr><th >接口名称</th><th>使用模块</th><th>功能描述</th></tr></thead>
<tbody><tr>
...
### 控制台 API 操作
<table>
<thead><tr><th>接口名称</th><th>使用模块</th><th>功能描述</th><th>特殊限制说明</th></tr></thead>
<tbody><tr>
