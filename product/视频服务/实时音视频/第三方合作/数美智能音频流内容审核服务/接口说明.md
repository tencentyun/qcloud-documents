...
| type         | string      | 是 | 识别类型，可选值：<li/>PORN：色情识别<li/>ABUSE：辱骂识别  <li/>AD：广告识别<li/>POLITICAL：涉政识别<li/>MOAN：娇喘识别<li/>ANTHEN：国歌识别<li/>SING：唱歌识别<br>如需做组合识别，通过下划线连接即可，例如：`AD_PORN_POLITICAL_MOAN` 用于广告、色情、涉政和娇喘识别 |
| btId         | string      | 是 | 音频流唯一标识，用于映射关联指定音频流，限长128位字符长度            |
| appId        | string      | 否 | 应用标识，此字段强校验，需要提前与数美约定好取值。不传取默认值default |
...
| demoSences   | int      | 是 | 录制类型可选值：<li/>分流录制：2<li/>合流录制：4<br><b>当前仅支持合流录制</b>|
...
| riskType          | int         | 是 | 标识风险类型，可能取值：<li/>0：正常<li/>100：涉政<li/>120：国歌<li/>200：色情<li/>210：辱骂<li/>250：娇喘<li/>300：广告<li/>700：黑名单<li/>900：自定义 |
