...
[TRTCMeeting](https://cloud.tencent.com/document/product/647/45667) 事件回调，您可以通过 TXMediaCoreCallback 获得 [TRTCMeeting](https://cloud.tencent.com/document/product/647/45667) 的各种状态通知。
```C++
