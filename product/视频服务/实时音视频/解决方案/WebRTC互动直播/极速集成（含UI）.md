...
![启用旁路推流](https://main.qcloudimg.com/raw/b9846f4a7f5ce1e39b3450963e872c90.png)
...
- 参考 `TUIPusher/pusher.vue` 及 `TUIPlayer/player.vue` 页面，将用户信息、直播间信息、SDKAppId 及 UserSig 等账号信息提交到 vuex 的 store 进行全局存储，您就可以跑通推拉流两个客户端的所有功能。详细业务流程参见下图：
