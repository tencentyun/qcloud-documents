...
详情请参考：[URL域名及协议限制说明](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-05-info-browser.html#h2-2)
...
当用户被踢时会触发该事件，例如：使用同名用户同时登陆、调用后台 RESTAPI [移除用户](https://cloud.tencent.com/document/product/647/40496?from=10680) 将用户踢出房间。

需要注意的是：同名用户同时登陆是不允许的行为，可能会导致双方通话异常，业务层应避免出现同名用户同时登陆。

具体请参见：[CLIENT_BANNED 事件](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/module-ClientEvent.html#.CLIENT_BANNED)
