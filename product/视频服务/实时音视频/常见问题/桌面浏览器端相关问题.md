...
1. 若您使用了浏览器原生 [getUserMedia](https://developer.mozilla.org/zh-CN/docs/Web/API/MediaDevices/getUserMedia) API 进行自定义采集，则需要手动设置 3A 参数:
...
2. 若您使用 TRTC.createStream 接口进行采集，则无需手动设置 3A 参数，SDK 默认开启 3A。
