...
不能，TRTC 发送自定义消息适用于简单低频的信令传输场景，具体限制参见 [使用限制](https://cloud.tencent.com/document/product/647/32241#.E4.BD.BF.E7.94.A8.E9.99.90.E5.88.B6)。
...
- 客户端 AI 美颜属于增值服务，由 [腾讯特效 SDK](https://cloud.tencent.com/document/product/616) 收取相关费用，详情请参见 [腾讯特效 SDK](https://cloud.tencent.com/document/product/616/36807) 价格总览。
...
[](id:que75)
### 是否支持实时不良画面检测？
关于涉黄、涉政、敏感信息等，会自动进行拦截关闭，不会允许出现在直播间中，请参见 [实时音视频鉴黄功能](https://cloud.tencent.com/developer/article/1648512)。
...
不支持，目前新增支持 RTMP 推流，详情请参见 [RTMP 协议推流接入 TRTC](https://cloud.tencent.com/document/product/647/66671)文档。
