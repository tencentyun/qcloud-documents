...
- T2：用户 Userid1 收到 `onEnterRoom` 回调，Userid2 感知 Userid2 存在延迟，大约300ms后，Userid2 收到 onRemoteUserEnterRoom 回调。
...
- T7：Userid2 会在收到 Userid1掉线通知90s后，SDK 判断远端用户 Userid1 掉线，Userid2 收到 onRemoteUserLeaveRoom 回调。
