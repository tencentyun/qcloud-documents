...
[](id:que18)
### 小程序怎么接收 SEI 消息
可以参照云+社区回答 https://cloud.tencent.com/developer/article/1852462
...
[](id:que20)
### 怎么播放背景音乐
pusherInstance 中提供了 playBGM 的方法，可参照 https://cloud.tencent.com/document/product/647/17018#pusherinstance，如果使用微信的原生标签进行播放可能会在某些机型上不兼容，导致音量模式异常或听筒扬声器播放的异常。
