...
方式一：使用腾讯云 LiteAV SDK 的podspec文件路径
```
platform :ios, '8.0'
...
**2. 在 Link Binary with Libraries 中添加所下载的SDK Framework, 并添加以下依赖库**
- libc++

**3. 在 Build Settings 中将 "Enable Bitcode" 设置为NO**


### 授权摄像头和麦克风
在App的Info.plist中添加以下两项，分别对应麦克风和摄像头在系统弹出授权对话框时的提示信息。
