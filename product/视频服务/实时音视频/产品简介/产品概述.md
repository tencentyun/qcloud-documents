...
## 产品架构
实时音视频 TRTC 主打全平台互通的多人音视频通话和低延时互动直播解决方案，提供小程序、Web、Android、iOS、Electron、Windows、macOS、Linux 等平台的 SDK 便于开发者快速集成并与实时音视频 TRTC 云服务后台连通。通过腾讯云不同产品间的相互联动，还能简单快速地将实时音视频 TRTC 与即时通信 IM、云直播 CSS、云点播 VOD 等云产品协同使用，扩展更多的业务场景。产品架构如下图所示：
...
| Linux | 推荐 CentOS 7.6 及以上系统，支持 Ubuntu 系统，不支持嵌入式及桌面版 Liunx 系统，Linux SDK 仅支持服务器平台部署，客户端部署请选用其他平台 SDK。 | 支持 | 支持 |
