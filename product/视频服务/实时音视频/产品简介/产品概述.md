...
![](https://main.qcloudimg.com/raw/9184369804679fd2c7e2fb83b50afb4d.svg)
...
<td><ul style="margin:0">
	<li>Unity 建议版本： 2020.2.1f1c1。</li>
	<li>目前支持 Android、iOS、Windows、Mac(Mac 还在内测中)平台。</li>
	<li>需要包含 <code>Android Build Support</code>、<code>iOS Build Support</code>、<code>Winodows Build Support</code> 和 <code>MacOs Build Support</code> 模块。</li>
	<li>其中 iOS 端开发还需要：<ul style="margin:0">
		<li>Xcode 11.0及以上版本。</li>
