高级开发人员可以通过以下高级功能接口和高级事件通知的开发。详细接口描述如下：
...
[代码示例](https://gitee.com/vqcloud/webrtc-samples/tree/master/getstats)
...
[代码示例](https://gitee.com/vqcloud/webrtc-samples/tree/master/audio)
