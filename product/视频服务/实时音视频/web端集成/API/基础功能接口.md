...
| recordId         | integer |  否      | 自动录制时业务自定义id，int32，将在录制完成后通过[直播录制回调](https://console.qcloud.com/live/livecodemanage) 接口通知业务方; ** `注意：如果小程序与小程序或者小程序与Web端互通，且传了recordId，必须保证web端和小程序传递的值一致`       | 
...
> role 可以在enterRoom的时候带，也可以在startRTC的时候带，建议在进房的时候带，会更快哦
