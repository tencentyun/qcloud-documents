...
<div style="position: relative; box-sizing: border-box;  padding-bottom: 10px; margin-bottom: 10px; overflow:hidden">
    ...
    <a href="https://github.com/LiteAVSDK/TRTC_Windows/tree/main/QTDemo" target="view_window">
        <div class="card-container">
            <div class="card">
    ...
    <a href="https://github.com/LiteAVSDK/TRTC_Flutter/tree/feature/init/TRTC-API-Example" target="view_window">
        <div class="card-container">
            <div class="card">
