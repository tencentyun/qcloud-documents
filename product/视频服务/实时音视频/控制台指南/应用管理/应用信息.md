...
3. 进入“编辑标签”弹框，进行如下配置：
	- 单击**标签键**下拉框，选择您已在 [标签管理](https://console.cloud.tencent.com/tag/taglist) 中创建的标签键。
	- 单击**标签值**下拉框，选择您已在 [标签管理](https://console.cloud.tencent.com/tag/taglist) 中创建的标签值。
...
![](https://main.qcloudimg.com/raw/0e361211caf9f1faceccd64aace0304a.png)

### 删除应用标签
1. 在【[应用管理](https://console.cloud.tencent.com/trtc/app)】中选择需要修改标签信息的应用，单击其右侧操作栏的【应用查看】进入应用详情页。
3. 在【应用信息】页签中，查看“标签”模块，单击右侧的【编辑】。
	![](https://main.qcloudimg.com/raw/6940f4a0f0a08634321fdd2453e1fb6d.png)
4. 进入标签编辑弹框，选择需要删除的标签信息行，单击右侧的删除按钮。
![](https://main.qcloudimg.com/raw/f2b1c6b4aab719038025acbfb4b48e24.png)
5. 单击【确定】保存，控制台会刷新弹框显示是否修改成功。
![](https://main.qcloudimg.com/raw/6c993ac805a4a9c17835e9d873593136.png)
