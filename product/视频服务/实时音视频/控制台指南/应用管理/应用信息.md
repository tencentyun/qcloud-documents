...
- **正常：**
	1. 若您已购买套餐包，即可正常使用实时音视频服务。
	2. 已开启后付费，且腾讯云账户金额充足。
	3. 自助 [启用应用](#enable) 生效后，应用状态为 “正常”。
	![](https://main.qcloudimg.com/raw/94d3dcd2bbca94d3bcb23e1ef498883a.png)
- **已停用：**
	1. 若您的免费试用套餐包用完或过期自动停服，您需要 [购买套餐包](https://buy.cloud.tencent.com/trtc)  重新激活服务，详细计费请参见 [计费说明](https://cloud.tencent.com/document/product/647/17157)。
	2. 已开启后付费，请检查 [腾讯云账户](https://console.cloud.tencent.com/expense) 是否欠费，欠费充值后将自动恢复服务。
	3. 自助 [停用应用](#deactivate) 生效后，应用状态为“已停用”，单击【启用应用】即可正常使用实时音视频服务。
...
4. 停用操作发起后成功后，全量生效需要3-5分钟，请耐心等待。
...
4. 启用操作发起后成功后，全量生效需要3分钟 - 5分钟，请稍后再刷新页面查看。
...
4. 删除操作发起后成功后，全量生效需要3分钟 - 5分钟，请耐心等待。
