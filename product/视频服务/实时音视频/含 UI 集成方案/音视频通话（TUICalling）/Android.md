...
点击进入 [Github](https://github.com/tencentyun/TUICalling) ，选择克隆/下载代码，然后拷贝 Android 目录下的tuicalling、tuicore 和 debug 目录到您的工程的 app 同一级目录，并完成如下导入动作：
...
#### 4.1. 实现1对1视频通话/音频通话 [TUICalling#call](https://cloud.tencent.com/document/product/647/47712#call)
```java
...
A: 支持，调用 [setCallingBell](https://cloud.tencent.com/document/product/647/47712#setcallingbell) 即可；
