...
## 示例
您可以登录 [GitHub](https://github.com/tencentyun/TRTCSDK/tree/master/Web/base-react-next/src/pages/basic-live) 获取本文档相关的示例代码。也可以单击 [Demo](https://web.sdk.qcloud.com/trtc/webrtc/demo/api-sample/basic-live.html) 前往体验音视频功能。
