...
- **录制回调密钥：**
  回调密钥用于在接收回调事件时生成签名鉴权，相关使用请参见 [录制事件参数说明](https://cloud.tencent.com/document/product/267/47026#.E5.BD.95.E5.88.B6.E4.BA.8B.E4.BB.B6.E5.8F.82.E6.95.B0.E8.AF.B4.E6.98.8E)。
