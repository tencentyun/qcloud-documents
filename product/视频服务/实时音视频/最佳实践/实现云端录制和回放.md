...
![](https://main.qcloudimg.com/raw/3df4ef2679c210a324f39fc88a9c3458.png)
...
| --------------- | --------------- | --------------- | --------------- | ------------------------------------------------------------ |
| 调用次数        | 只需调用一次接口        | 只需调用一次接口           | 只需调用一次接口              | 以下场景需调用混流接口：<li/>有连麦者加入时<li/>有连麦者离开时<li/>连麦者开关摄像头时<li/>连麦者开关麦克风时 |
