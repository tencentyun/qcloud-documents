...
支持大小流，具体请参见 [开启大小流传输](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-27-advanced-small-stream.html)。
...
增加手机 QQ 浏览器检测，手机 QQ 浏览器暂时无法支持 TRTC Web SDK。
...
TRTC Web SDK 重构版本，提供 Client/Stream 模式的接口，各对象职责更明确，语义更简洁明了。
