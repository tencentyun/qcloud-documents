...
- 优化进房接口 roomId 参数校验逻辑，详见[接口文档](https://trtc-1252463788.file.myqcloud.com/web/docs/Client.html#join)及[升级指引](https://trtc-1252463788.file.myqcloud.com/web/docs/tutorial-14-update-guideline.html)
