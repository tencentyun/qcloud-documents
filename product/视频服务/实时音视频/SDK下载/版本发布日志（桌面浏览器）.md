...
- 修复 iOS 15.1 开启桌面版网页通话时，出现页面 crash 的问题。详情请参见 [iOS Safari 已知问题 case 7](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-02-info-webrtc-issues.html#h2-4)。
...
- 支持美颜插件，请参见 [开启美颜](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-28-advanced-beauty.html)。
- 优化数据统计准确性。
...
支持大小流，教程请参见 [开启大小流传输](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/tutorial-27-advanced-small-stream.html)。
...
- 支持云端混流转码。
- 全平台支持字符串房间号，请参见 [TRTC.createClient 的 useStringRoomId 参数](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/TRTC.html#.createClient)。
- 支持关闭自动订阅，请参见 [TRTC.createClient 的 autoSubscribe 参数](https://web.sdk.qcloud.com/trtc/webrtc/doc/zh-cn/TRTC.html#.createClient)。
