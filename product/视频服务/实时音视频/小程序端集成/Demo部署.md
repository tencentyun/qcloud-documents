...
## 再次确认您已经完成相关接口的开通
打开 [微信公众平台](https://mp.weixin.qq.com) 注册并登录小程序，在小程序管理后台的 <font color='red'> “设置 - 接口设置” </font> 中自助开通该组件权限，如下图所示：
...
- step2：打开安装的微信开发者工具，单击【小程序项目】按钮。
- step3： 输入小程序 AppID，项目目录选择上一步下载下来的代码目录（ **注意：** 目录请选择**根目录**，根目录包含有 `project.config.json`文件），填写自己的小程序的 AppID，单击【确定】创建小程序项目。
...
将以下域名在 [微信公众平台](https://mp.weixin.qq.com) ->开发->开发设置->服务器域名配置进行配置：
