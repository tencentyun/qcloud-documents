...
### Electron开发无法进行视频通话
如果您使用的是 Electron，在提交 Mac App Store 后无法正常进行视频通话，请在 entitlements.plist 文件中加上 `com.apple.securite.network.server` 。（感谢 ABCMouse 的开发同学发现并解决了这个问题，特别感谢 Bing 对这个信息的同步）。
