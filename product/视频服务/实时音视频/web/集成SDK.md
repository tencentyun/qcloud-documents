...
| ------------------------- | -------- | ---------------------- |------- |
| iOS          | Safari ( Only ) | 11.1.2 | 由于 Safari 的实现仍然bug，产品化方案建议先规避，待苹果解决后再使用 |
| Android      | TBS | 43600                |   [TBS 介绍](http://x5.tencent.com/)   |
| Android      | Chrome | 60+               | 需要支持 H264  |
| Mac          | Chrome | 47+                |      |
| Windows(PC)  | Chrome | 52+                |  | |

> 基于 TBS 内核的 webview，需满足版本 >= 43600，我们的[ 示例代码](./示例代码.md#检测是否支持WebRTC)中有获取TBS版本的方法
...
| 名词      | 含义                                       |
| ------- | ---------------------------------------- |
| OpenID  | 也叫 identifier，在app中标示用户的身份,一般大家都把他叫做用户名   |
