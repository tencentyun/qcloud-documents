...
UserSig是使用腾讯云通讯服务（[IM](https://cloud.tencent.com/product/im)）所需的一种安全票据，而iLiveSDK则是依赖 IM 的帐号体系，所以就需要您的后台工程师生成 UserSig 给返回给终端 APP。
...
进入实时音视频 [管理控制台](https://console.cloud.tencent.com/rav)，点击**应用**，打开**功能配置**
找到 **下载公私钥** 点击下载
...
### step2：测试private_key
可以在 **开发辅助工具** 中测试一下下载的 private_key 是否能正常进行签名。

![](https://main.qcloudimg.com/raw/05f590c75c7695dccdf7b093d17dff32.png)
