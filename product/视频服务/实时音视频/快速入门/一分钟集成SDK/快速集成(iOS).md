...
```
  ...
  target 'App' do
  pod 'TXLiteAVSDK_TRTC', :podspec => 'https://pod-1252463788.cosgz.myqcloud.com/liteavsdkspec/TXLiteAVSDK_TRTC.podspec'
  end
```
...
```
  ...
  target 'App' do
  pod 'TXLiteAVSDK_Professional', :podspec => 'https://pod-1252463788.cosgz.myqcloud.com/liteavsdkspec/TXLiteAVSDK_Professional.podspec'
  end
```
