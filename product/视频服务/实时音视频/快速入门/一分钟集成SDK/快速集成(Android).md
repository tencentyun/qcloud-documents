...
```
注意：在上述 gradle 依赖里，如果您的 Android Studio 中 com.android.tools.build:gradle 工具也升级到了3.x后，请使用 implementation , 如果您的 Android Studio 中 com.android.tools.build:gradle 工具还是2.x，请使用 compile 
