...
通用套餐包可按照**1:2:4:15**分别抵扣语音、标清 SD、高清 HD 和超清 HD+ 时长，例如1分钟高清视频时长扣除4分钟套餐包时长。
通用套餐包定价如下表所示：
<table>
     <tr>
...
截止自然月的最后一天，当月视频通话服务用量无套餐包可抵扣、或超出套餐包余量时，将采用月结后付费方式，按 [服务定价](#Fixed_price) 计费。每月1日 - 5日从您的账户余额中扣除前一月的视频通话服务费用，详细以 [计费账单](https://cloud.tencent.com/document/product/555/14192#.E4.BA.8C.E3.80.81.E6.96.B0.E7.89.88.E8.B4.A6.E5.8D.95.E5.8A.9F.E8.83.BD.E7.AE.80.E4.BB.8B) 为准。
...
### 1. 视频互动直播为什么会产生语音时长？
通常情况下，用户订阅一路音视频流时，既包含音频数据，也包含视频数据，但发送端关闭摄像头、接收端关闭视频画面、只有1个人在房间等原因将会导致用户实际接收不到视频画面。为节省您的费用，当用户没有接收到视频画面时，TRTC 将按照语音时长来统计用量。
