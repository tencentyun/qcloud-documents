...
实时音视频 TRTC 按 [房间](https://cloud.tencent.com/document/product/647/46351#.E6.88.BF.E9.97.B4) 内所有用户产生的**语音时长**来统计视频互动直播服务的用量。
...
## 计费方式
即支付方式，TRTC 支持**预付费套餐包**和**后付费**，默认采用预付费套餐包，月结后付费只能通过购买的套餐包消耗完或过期后自动开通，无法直接开通。
