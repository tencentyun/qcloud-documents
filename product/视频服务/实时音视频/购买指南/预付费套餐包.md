...
TRTC 为您提供音视频通用套餐包，根据具体应用场景可细分为**语音互动直播**、**视频互动直播**、**语音通话**和**视频通话**四种，四种基础服务都可以单独使用或叠加使用。音视频通用套餐包按照 **1 : 2 : 4 : 15** 分别抵扣语音、标清 SD、高清 HD 和全高清 FHD 时长，例如1分钟高清视频时长扣除4分钟通用套餐包时长。
