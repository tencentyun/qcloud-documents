...
- 通话时长计费规则：
 ...
 - 优先使用套餐包所赠送的通话时长，**超出部分通话时长精确到分钟，不足1分钟按1分钟计算 [套餐外超量费用](#excess)**。
...
## 计费示例
假设用户于2019年9月首次开通实时音视频服务并购买了1个入门包，当月仅使用通话功能，总通话时长为52000.5分钟。
- 首次开通实时音视频服务获赠1个试用包，含赠送通话时长1000分钟可抵扣。
- 购买的入门包含赠送通话时长5万分钟可抵扣。
- 套餐外超量为`52000.5分钟 - 50000分钟 - 1000分钟 = 1000.5分钟`，不足1分钟按1分钟计算，那么超出套餐包以外的通话时长计费量为1001分钟。

因此，套餐外超量费用为`(1001 ÷ 1000)千分钟 × 25元/千分钟 = 25.025元`。
