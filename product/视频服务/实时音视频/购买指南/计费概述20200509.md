...
| [云端混流转码](https://cloud.tencent.com/document/product/647/16827) | 使用 MCU 集群将 TRTC 房间内各路上行音视频流按需进行混流转码，转码后输出的音视频流可旁路推流至云直播进行**云端录制**或**实现 CDN 直播观看**。 | [云端混流转码计费说明](https://tcloud-doc.isd.com/document/product/647/49446?!editLang=zh&!preview) |
