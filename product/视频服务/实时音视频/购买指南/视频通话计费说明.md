...
[](id:Billing_method)
## 计费方式
即支付方式，TRTC 支持**预付费套餐包**和**后付费**，默认采用预付费套餐包。如需自助开启后付费支付方式，请参见 [后付费说明](https://cloud.tencent.com/document/product/647/59756)。
...
>!
>- 为了避免在您不知情的情况下，产生超量的费用，您可在 [控制台](https://console.cloud.tencent.com/trtc/quickstart) 首次创建应用时，选择赠送套餐用完或过期后的处理方案为“**不停服，默认采用后付费的方式，按刊例价计费**”；或前往  [应用管理](https://console.cloud.tencent.com/trtc/app) 选择 【应用信息】 自助开启后付费。详细操作请参见 [后付费说明](https://cloud.tencent.com/document/product/647/59756)。
...
假设用户 A、B 、C 一起在 TRTC 房间中持续停留了45分钟。A、B、C  都始终接收对方的视频流。A 、B 、C 实际接收到的视频分辨率如下表所示：

|   时间   |   A 接收的分辨率   |   B 接收的分辨率    | C 接收的分辨率      |
| :------: | :----------------: | :-----------------: | ------------------- |
| 前30分钟 | 1280 × 720（高清） | 1920 × 1080（超清） | 1280 × 720（高清）  |
| 后15分钟 | 640 × 360（标清）  |  640 × 360（标清）  | 1920 × 1080（超清） |

**分析：**

- A 产生的用量及费用：
  - A 接收的分辨率前30分钟位于高清档，后15分钟位于标清档。
  - A 产生的费用为 `高清视频时长单价 × 高清视频时长 + 标清视频时长单价 × 标清视频时长 = 28元/千分钟 × (30分钟 / 1000) + 14元/千分钟 × (15分钟 / 1000）= 1.05元`。
- B 产生的用量及费用：
  - B 接收的分辨率前30分钟位于超清档，后15分钟位于标清档。
  - B 产生的费用为 `超清视频时长单价 × 超清视频时长 + 标清视频时长单价 × 标清视频时长 = 105元/千分钟 × (30分钟 / 1000) + 14元/千分钟 × (15分钟 / 1000）= 3.36元`。
- C 产生的用量及费用：
  - C 接收的分辨率前30分钟位于高清档，后15分钟位于超清档。
  - C 产生的费用为 `高清视频时长单价 × 高清视频时长 + 超清视频时长单价 × 超清视频时长 = 28元/千分钟 × (30分钟 / 1000) + 105元/千分钟 × (15分钟 / 1000）= 2.415元`。

则该 TRTC 房间产生的**总费用**为 `用户 A 产生的费用 + 用户 B 产生的费用 + 用户 C 产生的费用 = 6.825元`。

### 语音时长和视频时长混合示例

假设用户 A、B、C 一起在 TRTC 房间中持续停留了45分钟。A 始终接收视频流；B 前30分钟能接收到视频流，后15分钟没有接收到视频流；C 前30分钟没有接收到视频流，后15分钟能接收到视频流；A 、B 、C 实际接收到的视频分辨率如下表所示：

|   时间   |   A 接收的分辨率   |   B 接收的分辨率    | C 接收的分辨率    |
| :------: | :----------------: | :-----------------: | ----------------- |
| 前30分钟 | 1280 × 720（高清） | 1920 × 1080（超清） | 无视频，仅接收音频   |
| 后15分钟 | 640 × 360（标清）  |   无视频，也不接收音频    | 640 × 360（标清） |

**分析：**

- A 产生的用量及费用：
  - A 接收的分辨率前30分钟位于高清档，后15分钟接收的分辨率位于标清档。
  - A 产生的费用为 `高清视频时长单价 × 高清视频时长 + 标清视频时长单价 × 标清视频时长 = 28元/千分钟 × (30分钟 / 1000） + 14元/千分钟 × (15分钟 / 1000)= 1.05元`。
- B 产生的用量及费用：
  - B 接收的分辨率前30分钟位于超清档；后15分钟没有接收到视频流，按语音计费。
  - B 产生的费用为 `超清视频时长单价 × 超清视频时长 + 语音时长单价 × 语音时长 = 105元/千分钟 × (30分钟 / 1000) + 7元/千分钟 × (15分钟 / 1000）= 3.255元`。
- C 产生的用来及费用：
  - C 前30分钟没有接收到视频流，按语音计费；后15分钟接收的分辨率位于标清档。
  - C 产生的费用为 `语音时长单价 × 语音时长 + 标清视频时长 x 标清时长 = 7元/千分钟 × (30分钟 / 1000) + 14元/千分钟 × (15分钟 / 1000）= 0.42元`。

则该 TRTC 房间产生的**总费用**为 `用户 A 产生的费用 + 用户 B 产生的费用 + 用户 C 产生的费用 = 4.725元`。
