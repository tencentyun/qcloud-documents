...
分析：
- A 接收 B 的分辨率始终位于标清档，持续45分钟。
- A 接收 C 的分辨率始终位于标清档，持续45分钟。
- A 接收 D 的分辨率前30分钟位于标清档，后15分钟位于高清档。

则用户 A 产生的视频时长费用为`标清视频时长单价 × 标清视频时长 + 高清视频时长单价 × 高清视频时长 = 14元/千分钟 × (45分钟 + 45分钟 + 30分钟) / 1000 + 28元/千分钟 × (15分钟 / 1000）= 2.10元`。

### 语音时长示例

假设用户 A 和另外2人一起在 TRTC 房间内持续停留了30分钟，A 始终没有接收任何视频画面。
