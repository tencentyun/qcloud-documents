...
|   时间   |   A 接收 B、C 的分辨率   |   B 接收 A、C 的分辨率    | C 接收 A、B 的分辨率      |
| :------: | :----------------: | :-----------------: | ------------------- |
...
- A 产生的用量及费用：
  - A 接收 B、C 的分辨率前30分钟位于高清档，后15分钟接收的分辨率位于标清档。
  - A 产生的费用为 `高清视频时长单价 × 高清视频时长 + 标清视频时长单价 × 标清视频时长 = 28元/千分钟 × (30分钟 / 1000） + 14元/千分钟 × (15分钟 / 1000)= 1.05元`。
- B 产生的用量及费用：
  - B 接收 A、C 的分辨率前30分钟位于超清档；后15分钟没有接收到视频流，按语音计费。
  - B 产生的费用为 `超清视频时长单价 × 超清视频时长 + 语音时长单价 × 语音时长 = 105元/千分钟 × (30分钟 / 1000) + 7元/千分钟 × (15分钟 / 1000）= 3.255元`。
- C 产生的用来及费用：
  - C 前30分钟没有接收到视频流，按语音计费；后15分钟 C 接收 A、B 的分辨率位于标清档。
