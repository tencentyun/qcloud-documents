...
[](id:case1)
### 方案一：首次创建应用选择开启后付费
首次 [创建应用](https://console.cloud.tencent.com/trtc/quickstart) 时，您可通过赠送套餐包弹框选择“**不停服，默认采用后付费的方式，按刊例价计费**”。
![](https://main.qcloudimg.com/raw/ed2dcaa67a201ff096bb683db700ba68.png)
