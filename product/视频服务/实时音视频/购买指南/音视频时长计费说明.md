...
<table style="width:715px;">
<style>.markdown-text-box table td, .markdown-text-box table th {text-align: center;}
.tablestyle{position:absolute;width:1px;height:125.5px;top:0;left:0;background-color: #d9d9d9;transform:rotate(-51.5deg);transform-origin:top;}
.th1{position:absolute;right:10px;top:15px;}
.th2{position:absolute;right:50px;top:40px)
</style>
<tr>
