...
|参考文档 | 说明 | 
|---------|---------|
|  [用量统计方式](#Billing_items)     |   在使用 TRTC 前，您需要了解不同功能场景中分别根据什么维度进行计费。 |
|  [服务定价](#Fixed_price)    |   刊例价是指当前服务中各个计费项的原价。您可以根据刊例价对比套餐包内单价选择更合适的计费模式，并进行预算评估。   |
|  [计费方式](#Billing_method)   |  TRTC 支持**预付费套餐包**和**月结后付费**，默认采用预付费套餐包，且预付费套餐包相对更优惠。    |
|  [免费试用包](#Free_trial_package)   |   2019年10月11日起，TRTC 新用户可免费获赠一个试用包。    |
|  [计费示例](#Billing_examples)  |   您可以通过计费示例快速了解 TRTC 的计费逻辑。    |
|  [常见问题](#FAQ)   |  介绍计费相关的常见疑问及其答案。     |
