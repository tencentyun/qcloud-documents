...
| [destroySharedInstance](https://cloud.tencent.com/document/product/647/32264#destroysharedinstance) | 销毁 TRTCCloud单例 |
| [setListener](https://cloud.tencent.com/document/product/647/32264#setlistener) | 设置回调接口 TRTCCloudListener，用户获得来自 TRTCCloud的各种状态通知 |
| [setListenerHandler](https://cloud.tencent.com/document/product/647/32264#setlistenerhandler) | 设置驱动 TRTCCloudListener回调的队列 |
...
| [onUserVoiceVolume](https://cloud.tencent.com/document/product/647/32265#onuservoicevolume) | userid 对应的成员语音音量 |
...
| API | 描述 |
|-----|-----|
| [onStartPublishCDNStream](https://cloud.tencent.com/document/product/647/32265#onstartpublishcdnstream) | 启动旁路推流到 CDN 完成的回调，对应于 TRTCCloud中的 startPublishCDNStream() 接口 |
| [onStopPublishCDNStream](https://cloud.tencent.com/document/product/647/32265#onstoppublishcdnstream) | 停止旁路推流到 CDN 完成的回调，对应于 TRTCCloud中的 stopPublishCDNStream() 接口 |
