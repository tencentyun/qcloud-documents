...
| [enableCustomAudioCapture](https://cloud.tencent.com/document/product/647/32264#enablecustomaudiocapture) | 启用音频自定义采集模式，即放弃SDK原来的音频采集流程，改用 sendCustomAudioData 向 SDK 塞入自己采集的音频          |
| [sendCustomAudioData](https://cloud.tencent.com/document/product/647/32264#sendcustomaudiodata) | 发送自定义的音频数据          |
...
| API | 描述 |
|-----|-----|
| [onCapturedAudioFrame](https://cloud.tencent.com/document/product/647/32265#oncapturedaudioframe) | 本机采集到的声音回调          |
| [onPlayAudioFrame](https://cloud.tencent.com/document/product/647/32265#onplayaudioframe) | 混音前的每一路声音（比如您要对某一路的语音进行文字转换，必须要使用这里的数据，混音后的数据不适合用于语音识别）          |
| [onMixedPlayAudioFrame](https://cloud.tencent.com/document/product/647/32265#onmixedplayaudioframe) | 经过混合后的声音          |
...
| 属性 | 类型 | 描述 |
|-----|-----|-----|
| [textureId](https://cloud.tencent.com/document/product/647/32266#textureid) | int | 视频纹理Id          |
| [eglContext10](https://cloud.tencent.com/document/product/647/32266#eglcontext10) | javax.microedition.khronos.egl.EGLContext | 使用 (javax.microedition.khronos.egl.*) 定义的 OpenGL 接口          |
| [eglContext14](https://cloud.tencent.com/document/product/647/32266#eglcontext14) | android.opengl.EGLContext | 使用 (android.opengl.*) 定义的 OpenGL 接口          |
...
| [texture](https://cloud.tencent.com/document/product/647/32266#texture) | TRTCTexture | 视频纹理          |
