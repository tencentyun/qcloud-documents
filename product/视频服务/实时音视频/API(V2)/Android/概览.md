...
| API | 描述 |
|-----|-----|
| [sharedInstance](https://cloud.tencent.com/document/product/647/32264#sharedinstance) | - |
| [destroySharedInstance](https://cloud.tencent.com/document/product/647/32264#destroysharedinstance) | 销毁 TRTCCloud 单例。 |
...
| [setListenerHandler](https://cloud.tencent.com/document/product/647/32264#setlistenerhandler) | 设置驱动 TRTCCloudListener 回调的队列。 |
...
| [setLocalViewMirror](https://cloud.tencent.com/document/product/647/32264#setlocalviewmirror) | 设置本地预览画面镜像方式。 |
...
| [setBGMPosition](https://cloud.tencent.com/document/product/647/32264#setbgmposition) | - |
...
| [onWarning](https://cloud.tencent.com/document/product/647/32265#onwarning) | 警告回调：用于告知您一些非严重性问题，比如出现了卡顿或者可恢复的解码失败。 |
...
| API | 描述 |
|-----|-----|
| [onEnterRoom](https://cloud.tencent.com/document/product/647/32265#onenterroom) | 加入房间的事件回调。 |
| [onExitRoom](https://cloud.tencent.com/document/product/647/32265#onexitroom) | 离开房间的事件回调。 |
| [onConnectOtherRoom](https://cloud.tencent.com/document/product/647/32265#onconnectotherroom) | 请求跨房通话的结果回调。 |
| [onDisConnectOtherRoom](https://cloud.tencent.com/document/product/647/32265#ondisconnectotherroom) | 断开跨房通话的结果回调。 |
...
| API | 描述 |
|-----|-----|
| [onUserEnter](https://cloud.tencent.com/document/product/647/32265#onuserenter) | 有新的音视频用户加入房间。 |
| [onUserExit](https://cloud.tencent.com/document/product/647/32265#onuserexit) | 有用户从当前房间中离开。 |
...
| API | 描述 |
|-----|-----|
| [onStartPublishCDNStream](https://cloud.tencent.com/document/product/647/32265#onstartpublishcdnstream) | 启动旁路推流到 CDN 完成的回调，对应于 TRTCCloud 中的 startPublishCDNStream() 接口。 |
| [onStopPublishCDNStream](https://cloud.tencent.com/document/product/647/32265#onstoppublishcdnstream) | 停止旁路推流到 CDN 完成的回调，对应于 TRTCCloud 中的 stopPublishCDNStream() 接口。 |
| [onSetMixTranscodingConfig](https://cloud.tencent.com/document/product/647/32265#onsetmixtranscodingconfig) | 设置云端的混流转码参数的回调，对应于 TRTCCloud 中的 setMixTranscodingConfig() 接口。 |
...
| [onPlayAudioFrame](https://cloud.tencent.com/document/product/647/32265#onplayaudioframe) | 混音前的每一路远程用户的音频数据（比如您要对某一路的语音进行文字转换，必须要使用这里的原始数据，而不是混音之后的数据）。 |
