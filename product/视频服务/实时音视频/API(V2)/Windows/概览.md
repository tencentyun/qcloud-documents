...
| [selectScreenCaptureTarget](https://cloud.tencent.com/document/product/647/32269#selectscreencapturetarget) | 【屏幕共享】选择要分享的目标窗口或目标区域，支持如下四种情况：          |
...
| API | 描述 |
|-----|-----|
| [onUserEnter](https://cloud.tencent.com/document/product/647/32270#onuserenter) | userid对应的成员的进房通知，您可以在这个回调中调用 startRemoteView 显示该 userid 的视频画面          |
| [onUserExit](https://cloud.tencent.com/document/product/647/32270#onuserexit) | userid对应的成员的退房通知，您可以在这个回调中调用 stopRemoteView 关闭该 userid 的视频画面          |
| [onUserVideoAvailable](https://cloud.tencent.com/document/product/647/32270#onuservideoavailable) | userid对应的远端主路（即摄像头）画面的状态通知          |
| [onUserSubStreamAvailable](https://cloud.tencent.com/document/product/647/32270#onusersubstreamavailable) | userid对应的远端辅路（屏幕分享等）画面的状态通知          |
| [onUserAudioAvailable](https://cloud.tencent.com/document/product/647/32270#onuseraudioavailable) | userid对应的远端声音的状态通知          |
| [onUserVoiceVolume](https://cloud.tencent.com/document/product/647/32270#onuservoicevolume) | userid对应的成员语音音量，通过调用 TRTCCloud enableAudioVolumeEvaluation 来触发这个回调          |
...
| API | 描述 |
|-----|-----|
| [onStartPublishCDNStream](https://cloud.tencent.com/document/product/647/32270#onstartpublishcdnstream) | 旁路推流到CDN的回调，对应于 TRTCCloud 的 startPublishCDNStream() 接口          |
...
| API | 描述 |
|-----|-----|
| [onScreenCaptureCovered](https://cloud.tencent.com/document/product/647/32270#onscreencapturecovered) | 当屏幕分享窗口被遮挡无法正常捕获时，SDK会通过此回调通知，可在此回调里通知用户移开遮挡窗口          |
| [onScreenCaptureStarted](https://cloud.tencent.com/document/product/647/32270#onscreencapturestarted) | 当屏幕分享开始时，SDK会通过此回调通知          |
| [onScreenCapturePaused](https://cloud.tencent.com/document/product/647/32270#onscreencapturepaused) | 当屏幕分享暂停时，SDK会通过此回调通知          |
| [onScreenCaptureResumed](https://cloud.tencent.com/document/product/647/32270#onscreencaptureresumed) | 当屏幕分享恢复时，SDK会通过此回调通知          |
| [onScreenCaptureStoped](https://cloud.tencent.com/document/product/647/32270#onscreencapturestoped) | 当屏幕分享停止时，SDK会通过此回调通知          |
...
| [videoFps](https://cloud.tencent.com/document/product/647/32271#videofps) | uint32_t | 视频采集帧率 摄像头采集时推荐设置为 15fps 或 20fps，10fps以下会有明显的卡顿感，20fps以上则没有必要 屏幕采集时推荐设置为10fps 或 15fps |
...
| [bizId](https://cloud.tencent.com/document/product/647/32271#bizid) | uint32_t | 腾讯云直播bizid，在直播控制台-直播码接入可查询到          |
...
| [appId](https://cloud.tencent.com/document/product/647/32271#appid2) | uint32_t | 腾讯云 AppID，在直播控制台-直播码接入可查询到          |
| [bizId](https://cloud.tencent.com/document/product/647/32271#bizid2) | uint32_t | 腾讯云直播bizid，在直播控制台-直播码接入可查询到          |
...
| [sourceId](https://cloud.tencent.com/document/product/647/32271#sourceid) | HWND | 采集源ID；对于窗口，该字段指示窗口句柄；对于屏幕，该字段指示屏幕ID          |
| [sourceName](https://cloud.tencent.com/document/product/647/32271#sourcename) | TXString | 采集源名称          |
| [thumbWidth](https://cloud.tencent.com/document/product/647/32271#thumbwidth) | uint32_t | 缩略图宽          |
| [thumbHeight](https://cloud.tencent.com/document/product/647/32271#thumbheight) | uint32_t | 缩略图高          |
| [thumbBGRA](https://cloud.tencent.com/document/product/647/32271#thumbbgra) | TXString | 缩略图内容          |
| [iconWidth](https://cloud.tencent.com/document/product/647/32271#iconwidth) | uint32_t | 图标宽          |
| [iconHeight](https://cloud.tencent.com/document/product/647/32271#iconheight) | uint32_t | 图标高          |
| [iconBGRA](https://cloud.tencent.com/document/product/647/32271#iconbgra) | TXString | 图标内容          |
...
| 属性 | 类型 | 描述 |
|-----|-----|-----|
| [width](https://cloud.tencent.com/document/product/647/32271#width) | uint32_t | 视频宽度          |
| [height](https://cloud.tencent.com/document/product/647/32271#height) | uint32_t | 视频高度          |
