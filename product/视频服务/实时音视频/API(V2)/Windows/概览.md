...
| [userId](https://cloud.tencent.com/document/product/647/32271#userid) | TXString | 用户标识 - [必填] - 当前用户的 userid，相当于用户名，UTF-8 编码          |
...
| 属性 | 类型 | 描述 |
|-----|-----|-----|
| [userId](https://cloud.tencent.com/document/product/647/32271#userid2) | TXString | 说话者的 userId          |
...
网络测速结果。
您可以在用户进入房间前通过 TRTCCloud 的 startSpeedTest 接口进行测速 （注意：请不要在通话中调用），测速结果会每2秒 - 3秒返回一次，每次返回一个 ip 地址的测试结果。


| 属性 | 类型 | 描述 |
|-----|-----|-----|
| [ip](https://cloud.tencent.com/document/product/647/32271#ip) | TXString | 服务器 ip 地址          |
...
| [url](https://cloud.tencent.com/document/product/647/32271#url) | TXString | 旁路转推的 URL          |
...
| 属性 | 类型 | 描述 |
|-----|-----|-----|
| [userId](https://cloud.tencent.com/document/product/647/32271#userid2) | TXString | 参与混流的 userId          |
...
| 属性 | 类型 | 描述 |
|-----|-----|-----|
| [userId](https://cloud.tencent.com/document/product/647/32271#userid2) | TXString | 用户 ID，指定是哪个用户的视频流          |
| [finalLoss](https://cloud.tencent.com/document/product/647/32271#finalloss) | uint32_t | 该线路的总丢包率（%）       |
