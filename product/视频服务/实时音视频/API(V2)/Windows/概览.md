...
| API | 描述 |
|-----|-----|
| [addCallback](https://cloud.tencent.com/document/product/647/32269#addcallback) | 设置回调接口 ITRTCCloudCallback您可以通过ITRTCCloudCallback获得来自 SDK 的各种状态通知，详见 ITRTCCloudCallback.h 中的定义 |
