...
| [sendCustomVideo](31517#sendcustomvideo) | 发送自定义的视频SampleBuffer SDK内部不做帧率控制, 请务必保证调用该函数的频率和TXLivePushConfig中设置的帧率一致, 否则编码器输出的码率会不受控制。          |
...
| [sendCustomAudio](31517#sendcustomaudio) | 发送客户自定义的音频PCM数据          |
...
| [setNetEnv](31517#setnetenv) | 设置是否连接测试环境          |
