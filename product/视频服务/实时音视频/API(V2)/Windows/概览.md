...
| API | 描述 |
|-----|-----|
| [addCallback](https://cloud.tencent.com/document/product/647/32269#addcallback) | 设置回调接口 [ITRTCCloudCallback](https://cloud.tencent.com/document/product/647/32270#itrtccloudcallback) 您可以通过 [ITRTCCloudCallback](https://cloud.tencent.com/document/product/647/32270#itrtccloudcallback) 获得来自 SDK 的各种状态通知，详见 ITRTCCloudCallback.h 中的定义。 |
...
| [connectOtherRoom](https://cloud.tencent.com/document/product/647/32269#connectotherroom) | 请求跨房通话。 |
...
| [setLocalViewMirror](https://cloud.tencent.com/document/product/647/32269#setlocalviewmirror) | 设置摄像头本地预览是否开镜像。 |
| [setVideoEncoderMirror](https://cloud.tencent.com/document/product/647/32269#setvideoencodermirror) | 设置远端看到的画面是否镜像。 |
| [enableSmallVideoStream](https://cloud.tencent.com/document/product/647/32269#enablesmallvideostream) | 开启大小画面双路编码模式。 |
| [setRemoteVideoStreamType](https://cloud.tencent.com/document/product/647/32269#setremotevideostreamtype) | 选定观看指定 uid 的大画面还是小画面。 |
...
| API | 描述 |
|-----|-----|
| [getMicDevicesList](https://cloud.tencent.com/document/product/647/32269#getmicdeviceslist) | 获取麦克风设备列表 示例代码：。 |
...
| API | 描述 |
|-----|-----|
| [onEnterRoom](https://cloud.tencent.com/document/product/647/32270#onenterroom) | 加入房间的事件回调。 |
| [onExitRoom](https://cloud.tencent.com/document/product/647/32270#onexitroom) | 离开房间的事件回调。 |
| [onSwitchRole](https://cloud.tencent.com/document/product/647/32270#onswitchrole) | 切换角色结果回调。 |
| [onConnectOtherRoom](https://cloud.tencent.com/document/product/647/32270#onconnectotherroom) | 请求跨房通话的结果回调。 |
| [onDisconnectOtherRoom](https://cloud.tencent.com/document/product/647/32270#ondisconnectotherroom) | 断开跨房通话的结果回调。 |
...
| API | 描述 |
|-----|-----|
| [onUserEnter](https://cloud.tencent.com/document/product/647/32270#onuserenter) | 有新的音视频用户加入房间。 |
| [onUserExit](https://cloud.tencent.com/document/product/647/32270#onuserexit) | 有用户从当前房间中离开。 |
...
| [onUserVoiceVolume](https://cloud.tencent.com/document/product/647/32270#onuservoicevolume) | userId 对应的成员语音音量。 |
...
| API | 描述 |
|-----|-----|
| [onStartPublishCDNStream](https://cloud.tencent.com/document/product/647/32270#onstartpublishcdnstream) | 旁路推流到 CDN 的回调。 |
| [onStopPublishCDNStream](https://cloud.tencent.com/document/product/647/32270#onstoppublishcdnstream) | 停止旁路推流到 CDN 的回调。 |
| [onSetMixTranscodingConfig](https://cloud.tencent.com/document/product/647/32270#onsetmixtranscodingconfig) | 混流接口的状态回调。 |
