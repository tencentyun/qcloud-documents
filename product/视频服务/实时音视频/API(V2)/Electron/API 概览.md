...
| [setVideoEncoderRotation](https://trtc-1252463788.file.myqcloud.com/electron_sdk/docs/TRTCEngine.html#setVideoEncoderRotation)| 设置视频编码输出的（即远端用户观看到的以及服务器录制下来的）画面方向。 |
...
| [setRemoteVideoStreamType](https://trtc-1252463788.file.myqcloud.com/electron_sdk/docs/TRTCEngine.html#setRemoteVideoStreamType) | 选定观看指定 userId 的大画面或小画面。 |
...
| [muteRemoteAudio](https://trtc-1252463788.file.myqcloud.com/electron_sdk/docs/TRTCEngine.html#muteRemoteAudio) | 静音某一个用户的声音。 |
| [muteAllRemoteAudio](https://trtc-1252463788.file.myqcloud.com/electron_sdk/docs/TRTCEngine.html#muteAllRemoteAudio) | 静音所有用户的声音。 |
...
| [setCurrentCameraDevice](https://trtc-1252463788.file.myqcloud.com/electron_sdk/docs/TRTCEngine.html#setCurrentCameraDevice)| 设置需要使用的摄像头。 |
...
| [setCurrentSpeakerDevice](https://trtc-1252463788.file.myqcloud.com/electron_sdk/docs/TRTCEngine.html#setCurrentSpeakerDevice) | 设置需要使用的扬声器。 |
...
| API | 描述 |
|-----|-----|
| [setBeautyStyle](https://trtc-1252463788.file.myqcloud.com/electron_sdk/docs/TRTCEngine.html#setBeautyStyle) | 设置美颜、美白以及红润效果级别。 |
...
| API | 描述 |
|-----|-----|
| [onError](TRTCCallback.html#event:onError) | 错误回调：SDK 不可恢复的错误，必须监听，并分情况给用户适当的界面提示。 |
| [onWarning](TRTCCallback.html#event:onWarning) | 警告回调：用于告知您一些非严重性问题，例如出现了卡顿或可恢复的解码失败。 |
...
| API | 描述 |
|-----|-----|
| [onConnectionLost](TRTCCallback.html#event:onConnectionLost) | SDK 与服务器的连接断开。 |
| [onTryToReconnect](TRTCCallback.html#event:onTryToReconnect) | SDK 尝试重新连接到服务器。 |
| [onConnectionRecovery](TRTCCallback.html#event:onConnectionRecovery)| SDK 与服务器的连接恢复。 |
| [onSpeedTest](TRTCCallback.html#event:onSpeedTest) | 服务器测速的回调，SDK 对多个服务器 IP 进行测速，每个 IP 的测速结果通过这个回调通知。 |
