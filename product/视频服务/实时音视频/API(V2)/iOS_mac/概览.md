...
| [enableCustomAudioCapture](https://cloud.tencent.com/document/product/647/32259#enablecustomaudiocapture) | 启用音频自定义采集模式（iOS），即放弃 SDK 原来的音频采集流程，改用 sendCustomAudioData 向 SDK 塞入自己采集的音频 |
| [sendCustomAudioData](https://cloud.tencent.com/document/product/647/32259#sendcustomaudiodata) | 发送自定义的音频数据 （iOS） |
