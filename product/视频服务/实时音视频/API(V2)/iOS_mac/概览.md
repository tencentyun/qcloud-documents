...
| [setRemoteSubStreamViewFillMode](https://cloud.tencent.com/document/product/647/32259#setremotesubstreamviewfillmode) | 设置辅流画面的渲染模式 对应于setRemoteViewFillMode() 于设置远端的主路画面，该接口用于设置远端的辅路（屏幕分享、远程播片）画面 |
...
| [setSubStreamMixVolume](https://cloud.tencent.com/document/product/647/32259#setsubstreammixvolume) | 设置辅流的混音音量大小，这个数值越高，辅流音量占比就约高，麦克风音量占比就越小 |
...
| API | 描述 |
|-----|-----|
| [enableCustomVideoCapture](https://cloud.tencent.com/document/product/647/32259#enablecustomvideocapture) | 启用视频自定义采集模式，即放弃SDK原来的视频采集流程，改用sendCustomVideoData向SDK塞入自己采集的视频画面          |
| [sendCustomVideoData](https://cloud.tencent.com/document/product/647/32259#sendcustomvideodata) | 发送自定义的SampleBuffer          |
...
| API | 描述 |
|-----|-----|
| [onUserEnter](https://cloud.tencent.com/document/product/647/32263#onuserenter) | userid对应的成员的进房通知，您可以在这个回调中调用 startRemoteView 显示该 userid 的视频画面          |
| [onUserExit](https://cloud.tencent.com/document/product/647/32263#onuserexit) | userid对应的成员的退房通知，您可以在这个回调中调用 stopRemoteView 关闭该 userid 的视频画面          |
| [onUserVideoAvailable](https://cloud.tencent.com/document/product/647/32263#onuservideoavailable) | userid对应的远端主路（即摄像头）画面的状态通知          |
| [onUserSubStreamAvailable](https://cloud.tencent.com/document/product/647/32263#onusersubstreamavailable) | userid对应的远端辅路（屏幕分享等）画面的状态通知          |
| [onUserAudioAvailable](https://cloud.tencent.com/document/product/647/32263#onuseraudioavailable) | userid对应的远端声音的状态通知          |
| [onUserVoiceVolume](https://cloud.tencent.com/document/product/647/32263#onuservoicevolume) | userid对应的成员语音音量 通过调用 TRTCCloud enableAudioVolumeEvaluation:smooth: 来开关这个回调          |
...
| [onScreenCaptureStarted](https://cloud.tencent.com/document/product/647/32263#onscreencapturestarted) | 当屏幕分享开始时，SDK会通过此回调通知          |
| [onScreenCapturePaused](https://cloud.tencent.com/document/product/647/32263#onscreencapturepaused) | 当屏幕分享暂停时，SDK会通过此回调通知          |
| [onScreenCaptureResumed](https://cloud.tencent.com/document/product/647/32263#onscreencaptureresumed) | 当屏幕分享开始时，SDK会通过此回调通知          |
| [onScreenCaptureStoped](https://cloud.tencent.com/document/product/647/32263#onscreencapturestoped) | 当屏幕分享开始时，SDK会通过此回调通知          |
...
| API | 描述 |
|-----|-----|
| [onStartPublishCDNStream](https://cloud.tencent.com/document/product/647/32263#onstartpublishcdnstream) | 旁路推流到CDN的回调，对应于 TRTCCloud 的 startPublishCDNStream() 接口 |
...
| [sourceId](https://cloud.tencent.com/document/product/647/32261#sourceid) | NSString * | 采集源ID          |
...
| [thumbnail](https://cloud.tencent.com/document/product/647/32261#thumbnail) | NSImage * | 缩略图          |
| [icon](https://cloud.tencent.com/document/product/647/32261#icon) | NSImage * | 图标          |
...
| [streamType](https://cloud.tencent.com/document/product/647/32261#streamtype) | TRTCVideoStreamType | 参与混合的是主路还是辅路画面[TRTCVideoStreamTypeBig, TRTCVideoStreamTypeSub]          |
