...
<td><ul style="margin:0">
<li>修复进房频繁开关 AGC 的时候，处理声音变成全零的问题。  </li>
<li>C++ STL基础库全静态编译。  </li>
...
<li>修复自定义渲染回调（setRemoteVideoRenderDelegate），远端画面在分辨率是 540P 以上（包括540P）时只回调10次的 Bug。 </li>
...
<li>增加自定义音频数据回调接口：TRTCCloud &gt;&gt; setAudioFrameDelegate，支持：
