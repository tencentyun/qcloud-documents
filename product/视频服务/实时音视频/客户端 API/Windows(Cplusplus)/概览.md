...
| [setVideoEncoderRotation](http://doc.qcloudtrtc.com/group__ITRTCCloud__cplusplus.html#a932ff32ec07b20a0e0d83bb434cfb691) | 设置视频编码输出的（也就是远端用户观看到的，以及服务器录制下来的）画面方向。 |
...
| [startSystemAudioLoopback](http://doc.qcloudtrtc.com/group__ITRTCCloud__cplusplus.html#ad6a651a786871927917b087ae7094c8a) | 打开系统声音采集（64位 SDK 尚不支持系统混音能力）。 |
...
| API | 描述 |
|-----|-----|
| [__declspec](https://cloud.tencent.com/document/product/647/32269#__declspec) | - |
...
| API | 描述 |
|-----|-----|
| [onError](http://doc.qcloudtrtc.com/group__ITRTCCloudCallback__cplusplus.html#a9724da0b3da9b2eca5736fa8e54aa410) | 错误回调：SDK 不可恢复的错误，一定要监听，并分情况给用户适当的界面提示。 |
...
### 自定义视频渲染回调
跳转到 [ITRTCVideoRenderCallback](http://doc.qcloudtrtc.com/group__ITRTCCloudCallback__cplusplus.html#classTRTC_1_1ITRTCVideoRenderCallback)
...
### 音频数据回调
跳转到 [ITRTCAudioFrameCallback](http://doc.qcloudtrtc.com/group__ITRTCCloudCallback__cplusplus.html#classTRTC_1_1ITRTCAudioFrameCallback)
...
| [onPlayAudioFrame](http://doc.qcloudtrtc.com/group__ITRTCCloudCallback__cplusplus.html#ab841da62beb88a9fa9bce58d25df6f23) | 混音前的每一路远程用户的音频数据（例如您要对某一路的语音进行文字转换，必须要使用这里的原始数据，而不是混音之后的数据）。 |
...
### 日志相关回调
跳转到 [ITRTCLogCallback](http://doc.qcloudtrtc.com/group__ITRTCCloudCallback__cplusplus.html#classTRTC_1_1ITRTCLogCallback)
