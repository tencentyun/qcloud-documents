...
- 由于 H.264 版权限制，华为 Chrome 88 以下版本，无法使用 H264 编码（即无法推流）。如果您希望在华为系统的 Chrome 浏览器和以 Chrome WebView 为内核的浏览器正常运行 TRTC Web 端，请加微信 **shipinyun0925**（备注“TRTC 交流群”）进群，联系群内技术支持开通 VP8 编解码。
- Mac OS 下的 Firefox 屏幕分享效果比较差且暂无解决方案，建议使用 Chrome 或者 Safari 进行屏幕分享。[](id:attention3)
- 如果您希望 Web 端在推流时支持双声道编码，请加微信 **shipinyun0925**（备注 TRTC 交流群”）进群，联系群内技术支持开通 WebRTC 双声道编码能力。
