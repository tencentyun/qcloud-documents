...
- 由于 H.264 版权限制，Chrome 88 以下版本，无法使用 H264 编码（即无法推流）。如果您希望在华为系统的 Chrome 浏览器和以 Chrome WebView 为内核的浏览器正常运行 TRTC Web 端，请加微信 **shipinyun0925**（备注“TRTC 交流群”）进群，联系群内技术支持开通 VP8 编解码。
