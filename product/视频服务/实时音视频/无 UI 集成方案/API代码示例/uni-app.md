...
## 常见问题
### 1. [【官方】腾讯云实时音视频SDK](https://ext.dcloud.net.cn/plugin?id=7774) 和 [【官方】腾讯云原生音视频插件](https://ext.dcloud.net.cn/plugin?id=7097) 区别？
...
### 2. [【官方】腾讯云实时音视频SDK](https://ext.dcloud.net.cn/plugin?id=7774) 支持小程序吗？
> 暂不支持
...
### 5. [`startRemoteView`](https://web.sdk.qcloud.com/trtc/uniapp/doc/zh-cn/TrtcCloud.html#stopLocalPreview) 在什么时候调用？
> 建议在 [onUserVideoAvailable](https://web.sdk.qcloud.com/trtc/uniapp/doc/zh-cn/TRTCCallback.html#event:onUserVideoAvailable) 事件回调中调用 

### 6. 本地预览如何自定义样式？
> 1. 建议通过 view 包裹 `trtc-local-view、trtc-remote-view`。然后设置 view 的样式即可

### 7. [startLocalPreview](https://web.sdk.qcloud.com/trtc/uniapp/doc/zh-cn/TrtcCloud.html#startLocalPreview) 不传 viewId 可以吗？
> 1. 可以。但是页面需要有 trtc-local-view 组件，并且它的 viewId 绑定的是本地用户 id

### 8. [startLocalPreview](https://web.sdk.qcloud.com/trtc/uniapp/doc/zh-cn/TrtcCloud.html#startLocalPreview) 报 -2 错误
> 错误原因：没有实例化本地预览的 view
> 1. 首先必须是 .nvue 文件，[详见](https://nativesupport.dcloud.net.cn/NativePlugin/course/ios)
> 2. 页面必须使用 `trtc-local-view` 并且绑定了 viewId
