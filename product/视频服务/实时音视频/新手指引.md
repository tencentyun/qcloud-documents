...
| 在线生成签名 UserSig，或检验已有 UserSig 是否有效          | [签名（UserSig）生成工具](https://cloud.tencent.com/document/product/647/50686)                |
...
| 搜索已创建的应用                                           | [搜索应用](https://cloud.tencent.com/document/product/647/50771) |
