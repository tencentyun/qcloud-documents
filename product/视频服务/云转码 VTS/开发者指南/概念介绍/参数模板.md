由于音视频编码参数众多，为了方便使用，在转码服务中我们将常用的一组关键转码参数组合起来，称之为“参数模板”。每个参数模板有对应名称和ID来标识，如常用的“流畅”、“标清”、“高清”和“全高清”等转码模板在系统中的ID分别为10，20，30和40。

参数模板分类：
- 预置参数模板
为了方便使用，系统已预置了部分常用音视频转码模板，该类模板为所有客户可见。
- 自定义参数模板
同时，也支持根据需要创建自定义参数模板。
...
## 自定义参数模板
除了以上的系统预置模板，客户可根据自己业务需要对模板参数进行定制，称为“自定义参数模板”。客户可通过控制台或[调用API]()来创建。该类模板仅自己可见。
