...
针对上述模板类型，VTS提供了对应的常用参数模板，称为“预置参数模板”。同时，您也可以创建新的各类型参数模板，并为其指定不同的参数值，称为“自定义参数模板”。参数模板中各参数详细信息请参考文档[转码参数说明](../触发转码任务/转码参数说明.md)。

### 预置参数模板

该部分给出VTS中预置的各类型参数模板信息，包括模板ID和关键参数设置等。
...
控制台创建自定义参数模板请参考文档[模板设置](/document/product/862/36407)。

#### 通过API创建自定义参数模板
可以通过如下API创建对应类型的自定义参数模板：
- [创建转码模板](/document/product/1090/33553)
- [创建水印模板](/document/product/1090/33557)
- [创建采样截图模板](/document/product/1090/33691)
- [创建指定时间点截图模板](/document/product/1090/33690)
- [创建转动图模板](/document/product/1090/33692)
- [创建雪碧图模板](/document/product/1090/33605)