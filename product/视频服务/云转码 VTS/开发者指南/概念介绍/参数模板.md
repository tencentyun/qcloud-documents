...
参数模板分类：
- 预置参数模板
针对常见的使用场景，系统提供了各类型的预置参数模板，该类模板为所有客户可见。
- 自定义参数模板
同时，您也可以创建自定义参数模板，对各类型参数模板指定不同的参数值。
...
## 自定义参数模板
除了以上的系统预置模板，您可根据自己业务需要对模板参数进行定制，称为“自定义参数模板”。您可通过控制台或[调用API]()来创建。该类模板仅自己可见。
...
### 通过API创建自定义参数模板
自定义参数模板可以通过调用[创建转码模板API](/document/product/1090/33553)，[创建水印模板API](/document/product/1090/33557)，[创建截图模板API](/document/product/1090/33691)，[创建转动图模板API](/document/product/1090/33692)等接口来创建不同类型的模板。