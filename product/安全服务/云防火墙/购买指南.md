...
>? 云防火墙支持企业认证用户 [进行试用](https://console.cloud.tencent.com/cfw?adtag=cfw.from.web.top.cfw)，个人认证用户可以 [升级至企业认证用户](https://cloud.tencent.com/document/product/378/34075) 进行试用。
