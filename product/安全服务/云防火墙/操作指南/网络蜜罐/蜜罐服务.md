...
3. 在新建蜜罐服务窗口中，选择地域、实例名称和蜜罐服务类型，根据需求设置自定义诱饵和关联暴露探针后，	单击**确定**，即可完成新建。
![](https://qcloudimg.tencent-cloud.cn/raw/b2ccebca7dbbec7f979835ce0ebf7fce.png)
>?
>- 腾讯云防火墙中的蜜罐服务支持创建的蜜罐类型包括：SSH 蜜罐、Saltstack 蜜罐、Weblogic 蜜罐、Elasticsearch 蜜罐、Strusts 蜜罐、Nginx 蜜罐、MySQL 蜜罐和 Web 蜜罐。
>- 其中，除 Web 蜜罐外，其余所有类型的蜜罐均内置诱饵与脆弱性。而 Web 蜜罐需要将现有的 SSH/MYSQL 蜜罐作为诱饵才能发挥作用，因此，创建 Web 蜜罐前，请先创建 SSH/MYSQL 蜜罐并关联探针。
