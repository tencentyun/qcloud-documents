数据库白名单是基于 NAT 防火墙的针对数据库的访问控制表，可以根据 IP、地理位置等对流量进行过滤。
...
### 查看最近操作记录
在 [数据库白名单页面](https://console.cloud.tencent.com/cfw/ac/whitelist) 的最近操作记录中， 展示了用户最近对规则列表进行的操作。
>?
>- 单击【详情】可查看该条操作记录详情。
>- 单击【查看操作日志】，可查看详细操作记录。
>
...
### 添加白名单规则
1. 在 [数据库白名单页面](https://console.cloud.tencent.com/cfw/ac/whitelist)，单击【添加规则】，弹出添加白名单弹窗。
![](https://main.qcloudimg.com/raw/0800377faaf60fb00371f37276ef1d24.png)
2. 在添加白名单弹窗，配置相关规则，单击【确定】，即可创建新规则。
>?
...
### 编辑白名单规则
在 [数据库白名单页面](https://console.cloud.tencent.com/cfw/ac/whitelist)，单击对应规则的【编辑】，可修改相关参数，单击【完成】，保存修改。
![](https://main.qcloudimg.com/raw/8cc04669dcbe3027c40e9f620fc0adff.png)

### 删除白名单规则
1. 在 [数据库白名单页面](https://console.cloud.tencent.com/cfw/ac/whitelist)，单击对应规则的【删除】，弹出“确认删除”弹窗。
![](https://main.qcloudimg.com/raw/cf595aa4968c653e893fc8ed28284b9c.png)
2. 在“确认删除”弹窗，单击【确定】，即可删除该规则。
>!删除操作不可恢复，请谨慎操作。
>
