本文档将为您介绍告警中心操作指引。以下内容默认您已经登录 [云防火墙控制](https://console.cloud.tencent.com/cfw/warncenter)，在左侧导航栏中，单击【[告警中心](https://console.cloud.tencent.com/cfw/warncenter)】，进入告警中心页面。当您配置好防火墙所需的全部安全策略后，只需要持续地关注来自防火墙的告警，便可以进行网络边界防护的安全运维工作。
## 告警分析与处置
