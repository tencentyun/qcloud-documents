...
2. 在NAT 边界开关页面左侧操作栏中，单击【实例配置】>【出口绑定】>【新建规则】，选择相应的子网或私有网络使用的外部 IP后单击【确定】 即可。
...
可能资产规模在后台轮询间隔内发生变化，但尚未被同步导致，您可登录登录 [云防火墙控制台](https://console.cloud.tencent.com/cfw/switch)，单击【防火墙开关】>【互联网边界开关】>【同步资产】，主动调用后台接口重新读取并同步子网的资产信息后，再尝试开启。
