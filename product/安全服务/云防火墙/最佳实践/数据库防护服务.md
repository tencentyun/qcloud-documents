...
1. 在 [资产中心页面](https://console.cloud.tencent.com/cfw/asset)，选择**资产列表** > **数据库资产**，单击**资产更新**，完成后在数据库资产页面中可以查看当前的数据库资产。
![](https://qcloudimg.tencent-cloud.cn/raw/4101213d300053cd2778ddad3f958251.png)
