...
3. 在告警设置页面可以对告警开关、系统资源告警配置、syslog 告警配置及邮件告警配置功能进行操作。
	- **告警开关**
在告警设置页面，单击【告警开关】，打开需要开启告警的选项，单击【提交】，即可对 [syslog 告警配置](#syslog) 中所设置的服务器进行监控，且当满足告警条件时，将触发告警，并发送邮件至您所 [配置的告警邮箱](#yjgj) 中。
