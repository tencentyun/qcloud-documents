...
![](https://qcloudimg.tencent-cloud.cn/raw/e538c1bbbb3942291bff3644040905b6.png)
2. 进入数据安全审计服务之后，单击侧边栏的**数据资产**，管理数据资产。
...
2. Agent 部署完成后，在 Agent 列表页面，验证 Agent 状态是否正常。
