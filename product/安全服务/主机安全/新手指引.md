...
>?
>- 轻量应用服务器（Lighthouse）默认自动安装主机安全客户端；
>- 云服务器（CVM）、边缘计算机器（ECM）、黑石物理服务器1.0（CPM）购买时勾选“安全加固”即可自动安装主机安全客户端。



#### 3.2 购买主机安全防护授权
主机安全提供以下四个版本的防护授权以供选择，各版本特性请参见 [功能介绍与版本比较](https://cloud.tencent.com/document/product/296/2222)。

| 版本 | 描述 |
|---------|---------|
| 基础版 | 免费，无需购买。服务器安装了主机安全客户端则为基础版防护。 |
| 普惠版（仅限轻量应用服务器） | <li>包年包月：10元/个/月<br>可 [轻量应用服务器](https://console.cloud.tencent.com/lighthouse/instance) 实例详情中的“主机安全”下单击**开通普惠版**即可为该实例购买并绑定普惠版授权。 |
| 专业版 | <li>包年包月：80元/个/月<li>按量计费：3元/个/天<br>可在 [主机安全购买页](https://buy.cloud.tencent.com/yunjing) 中购买。 |
| 旗舰版 | <li>包年包月：180元/个/月<br>可在 [主机安全购买页](https://buy.cloud.tencent.com/yunjing) 中购买。 |
