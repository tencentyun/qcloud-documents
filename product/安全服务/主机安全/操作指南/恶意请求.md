...
2. 在“恶意请求”页面，可查看恶意请求事件列表，并进行相关操作。
	在恶意请求事件列表可查看内容包括：发生恶意请求事件的服务器、对外访问域名、访问次数、进程（进程数据暂仅支持 Windows 系统）、描述、状态（全部、待处理、已信任机已取消信任）、首次访问时间、最近访问时间、操作等12个字段，展示列表详情信息可进行自定义。
![](https://main.qcloudimg.com/raw/bafb2aa5f0d88ab49718b10fc87148cc.png)
	- **筛选事件**：在恶意请求事件列表支持选择日期展示相应的事件，支持按关键字及标签查询（多个关键字用竖线 “|” 分隔，多个过滤标签用回车键分隔）事件，同时支持按状态筛选事情。
	 ![](https://main.qcloudimg.com/raw/255cfad0683d5b90b4d835ce114e136d.png)
	- **自定义设置列表字段**：在恶意事件列表上方，单击<img src="https://main.qcloudimg.com/raw/9ebb9fa1652d9154137fa1d934329043.png" style="margin:0;">，可设置列表展示字段。
	![](https://main.qcloudimg.com/raw/d9c1c0973f335ad2820a6065f913a111.png)
	- **事件导出**：在恶意事件列表上方，单击<img src="https://main.qcloudimg.com/raw/ac6451a8dab74a5cf57770ff8af30954.png" style="margin:0;">，可将恶意事件列表导出。
	- **删除**：在恶意请求事件列表支持对恶意请求事件进行删除。
		- 方式1：在目标恶意请求事件的右侧操作栏，单击【删除】，即可删除该事情。
