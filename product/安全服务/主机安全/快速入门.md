...
>
![](https://main.qcloudimg.com/raw/beb53b134bc3addd89db6cd30fc5afe4.png)
...
## 步骤2：操作主机安全
主机安全支持对主机的安全信息进行实时处理和展示、支持对木马文件及漏洞进行检测及隔离、支持对可疑的登录行为进行检测识别及加白名单处理、支持对密码破解行为进行阻断设置、同时支持告警设置等操作，详情请参见 [操作指南](https://cloud.tencent.com/document/product/296/41219)。
...
- **进入系统卸载**
	...
	- **Linux 系统**：输入命令：`/usr/local/qcloud/YunJing/uninst.sh` 即可卸载。
