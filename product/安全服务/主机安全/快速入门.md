...
登录 [主机安全（云镜）控制台](https://console.cloud.tencent.com/yunjing)，在左侧导航栏中，选择【资产管理】>【主机列表】，查看云服务器是否已安装主机安全（云镜），如下图所示：
...
安装主机安全（云镜）后，可以享有主机安全（云镜）带来的木马文件查杀、登录行为审计、密码破解检测等功能，这些功能随主机安全（云镜）安装后自动启用，现有两种方式查看服务器入侵检测详情：
- 登录 [主机安全（云镜）控制台](https://console.cloud.tencent.com/yunjing) ，在左侧导航栏中，选择【资产管理】>【主机列表】，服务器列表中找到需要查看的服务器，单击服务器 IP 地址，然后单击【入侵检测】即可查看该服务器入侵检测详情。
- 登录 [主机安全（云镜）控制台](https://console.cloud.tencent.com/yunjing) ，在左侧导航栏中，单击【入侵检测】，然后单击所需查看的功能，即可查阅所有开通主机安全（云镜）的服务器入侵检测详情。
- 更多功能操作请参见：
...
安装主机安全（云镜）并开通专业防护后，可以享有主机安全（云镜）带来的系统组件漏洞检测、Web 组件漏洞检测、安全基线检测功能。
登录 [主机安全（云镜）控制台](https://console.cloud.tencent.com/yunjing) ，在左侧导航栏中，单击【漏洞管理】，然后单击所需查看的功能，即可查阅所有开通主机安全（云镜）专业防护的服务器漏洞检测详情，并可以按照提示进行修复。
...
- **控制台中卸载**
	1. 登录 [主机安全（云镜）](https://console.cloud.tencent.com/yunjing) 控制台，查看自己的云服务器是否已安装主机安全（云镜）。
	2. 在服务器列表中，选择需要卸载主机安全（云镜）的服务器进行卸载。
...
- 登录 [腾讯云控制台](https://console.cloud.tencent.com/) 后，依次单击【云产品】>【主机安全】>【主机安全】，即可进入主机安全（云镜）配置页面，在左侧导航栏中，单击【安全概览】，进入安全概览页面，在上方公告栏中，单击【升级专业版】，即可为需要的云服务器开通专业防护。
