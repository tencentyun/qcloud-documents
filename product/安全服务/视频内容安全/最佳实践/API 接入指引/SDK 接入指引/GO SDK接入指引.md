...
import ("fmt"
	...
	vm "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/vm/v20201229") func main() {
	credential: = common.NewCredential("SecretId", "SecretKey", ) cpf: = profile.NewClientProfile() cpf.HttpProfile.Endpoint = "vm.tencentcloudapi.com"
	client,
	_: = vm.NewClient(credential, "ap-guangzhou", cpf) request: = vm.NewTextModerationRequest() response,
