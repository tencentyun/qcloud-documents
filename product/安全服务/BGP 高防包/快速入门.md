...
3. 在【绑定设备】页面，根据实际防护需求选择【关联设备类型】与【选择关联机器】。
 ...
 >?BGP 高防包支持托管 IP，目前在白名单中。如用户使用腾讯云的托管 IP，需要接入 BGP 高防包，请 [联系我们](https://cloud.tencent.com/about/connect) 进行咨询或 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请加入白名单。
4. 单击【确定】。
