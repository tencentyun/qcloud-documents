BGP 高防包提供面向 DDoS 攻击的高级防护策略功能，用户可针对自身业务防护需求对 DDoS 防护策略进行调整和优化。通过黑白名单、禁用协议、禁用端口、报文特征过滤策略、空连接防护以及是否开启水印防护，为业务提供针对性防护。
...
![拒绝海外流量](https://main.qcloudimg.com/raw/86fedce2e4cc3747d3dd5bb14831ecf7.png)
-  **连接耗尽防护**
...
- **异常连接检测**
 -  **源 IP 最大异常连接数**：可填范围 0-∞（单位：个）。表示当一个源 IP 符合异常连接行为识别的连接数，超过所指定阈值时，会被认为是异常攻击源，在一定时间内被限制访问。
...
![解绑资源](https://main.qcloudimg.com/raw/c96febf5dfb09fe791b5982bfc0503bc.png)
- **客户端接入水印**
登录 DDoS 防护（大禹）管理控制台，选择【BGP 高防 IP】>【防护配置】。在【DDoS 攻击防护】页签，单击目标策略所在行的【水印客户端文件下载】，线下完成客户端的接入。

- **添加、删除或停用/启用水印密钥**
登录 DDoS 防护（大禹）管理控制台，选择【BGP 高防 IP】>【防护配置】。在【DDoS 攻击防护】页签，单击目标策略所在行的【水印密钥配置】。
...
![密钥](https://main.qcloudimg.com/raw/08cac901182e22711b6776915675b0f3.png)
