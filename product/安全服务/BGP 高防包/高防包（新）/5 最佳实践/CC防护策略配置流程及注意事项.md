...
>?防护等级为 DDoS 高防开启 CC 防护且遭受攻击触发清洗动作时，对流量检测的严格程度，分为五种等级：宽松、攻击紧急、适中、严格、自定义，可根据攻击情况进行选择，详细说明请参见 [CC 防护开关及清洗阈值](https://cloud.tencent.com/document/product/1021/43921)。
