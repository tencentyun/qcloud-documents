...
### 步骤2：资产授权
进入 [管理与授权](https://console.cloud.tencent.com/dsgc/auth) 页面，数据安全中心已拉取您腾讯云账号内的 TencentDB 列表，您只需要输入账号、密码或单击【授权】即可。数据库安全中心已拉取您腾讯云账号内的的 CVM 列表，您可自主添加自建数据库，并完成授权。
