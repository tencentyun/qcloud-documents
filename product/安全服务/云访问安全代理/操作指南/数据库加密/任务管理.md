...
2. 在全量加解密页面，选择所需的地域、CASB 实例和元数据。<br><img src="https://qcloudimg.tencent-cloud.cn/raw/9cda96b58dbfc41556c937effa31751f.png" width=700px>
...
| 增量依据    |   目前支持**自增主键ID**与**更新时间UPDATETIME**两种 |    
| 增量依据字段名 |    字段类型需要符合对应的增量依据字段类型         |   

>?
>- 增量任务说明，请查阅[增量任务最佳实践](https://cloud.tencent.com/document/product/1303/84668#increment)
>  - MYSQL 数据源增量依据支持类型：
