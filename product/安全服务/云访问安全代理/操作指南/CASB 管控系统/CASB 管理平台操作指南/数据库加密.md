...
![](https://main.qcloudimg.com/raw/542ee61c0d51b52ce29548597e3ddd3e.png)
### 系统组成

CASB 管理系统由 CASB Proxy、CASB Client、CASB 管理平台组成。

- CASB Proxy：为数据安全代理，提供数据加密使用的密码算法，用于实时数据加解密。
...
5. 在管理 Proxy 账号页面。
	 ...
	 - 单击【新增数据库账号】，添加需要使用的数据库账号，单击【确定】。
![](https://main.qcloudimg.com/raw/9cf2aa5866224754f2e554ac5725b3d9.png)
	 - 单击【新增 Proxy 账号】，输入 Proxy 账号、Proxy 密码，选择对应的数据库账号和应用后，单击【确定】。
