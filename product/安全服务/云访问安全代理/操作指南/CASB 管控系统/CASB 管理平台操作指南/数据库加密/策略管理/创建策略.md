...
2. 在策略管理页面中，选择所需的地域、 CASB 实例和 元数据。
>?
...
> - **工作模式：** 模式共有三种，分别是：读解密，写加密、读解密，写不解密、读不解密，写不加密。
...
### 数据库支持加密的字段类型
- MySQL支持的字段类型详情，请查阅 [MySQL](https://cloud.tencent.com/document/product/1303/48144)。
- PostgreSQL支持的字段类型详情，请查阅 [PostgreSQL](https://cloud.tencent.com/document/product/1303/59210)。
