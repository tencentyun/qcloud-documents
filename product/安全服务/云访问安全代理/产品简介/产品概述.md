...
### <img src="https://main.qcloudimg.com/raw/9bfe26ae0c6bfc0ba9f7e5929116d026.png" style="margin:0;"> 细致管控
管理员可通过界面设置加解密策略，控制颗粒度可达到数据库的字段级（如手机号）。云访问安全代理数据库版的访问控制与数据库本身的访问控制独立，实现系统管理员、安全管理员和审计管理员的权限分立。
### <img src="https://main.qcloudimg.com/raw/52dd74387d5ff6c125ceef5d4b3b4743.png" style="margin:0;"> 灵活部署
面对企业信息系统多且数据库多的情况，云访问安全代理服务支持统一部署。用户只需在应用中进行插件配置，重启服务即可完成安装，且支持在新系统中快速部署，支持大规模统一部署。
### <img src="https://main.qcloudimg.com/raw/8b1293b34b38de3fa014a33323ad7672.png" style="margin:0;">高性能国密支持
云访问安全代理提供高性能国密中间件，可以为企业应用提供高性能的 SM4 算法实现高速加解密，保障业务效率不受影响。
### <img src="https://main.qcloudimg.com/raw/e408059ddbfab2ba39cf5486cfad1bf5.png" style="margin:0;"> 安全合规
云访问安全代理支持国密算法（SM4）以及国际算法（AES），密钥由腾讯云密钥管理系统（KMS）进行统一管理。服务已通过国家密码管理局的安全认证，满足商用密码应用安全性评估的相关合规要求。

### <img src="https://main.qcloudimg.com/raw/558b1673d9188991282f19ae352c4423.png" style="margin:0;"> 高可靠密钥管理
数据加密密钥由腾讯云密钥管理系统统一管理，密钥管理系统底层使用国家密码局或 FIPS-140-2 认证的硬件安全模块（HSM），并支持权限管控和内置审计，全方位保护您的密钥安全。
### <img src="https://main.qcloudimg.com/raw/2b441c00fbd8c8516d7df5c8399c2d3d.png" style="margin:0;"> 可用性保障
