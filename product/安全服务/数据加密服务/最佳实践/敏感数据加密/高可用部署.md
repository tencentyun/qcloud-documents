...
9. 当 DMK 同步到多台 EVSM 时，可以比对多台 EVSM 的 DMK 校验值来确定同步后的 DMK 是否一致。单击**密钥管理** > **获取 DMK 校验值**，获取DMK校验值。
![](https://qcloudimg.tencent-cloud.cn/raw/1c16704827feae700c78dc9d772ac877.png)
10. 单击**密钥管理** > **导出DMK成份**，即可将 DMK 成份导出。
...
### 步骤3：接口配置
#### 方式1：文件形式
为实现高可用，在cacipher.ini配置文件下更改配置信息，字段详情请参见 [属性字段说明](https://cloud.tencent.com/document/product/639/67723#attribute)。
```
[LOGGER]
logsw=error
logPath=./
