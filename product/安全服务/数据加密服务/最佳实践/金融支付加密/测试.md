...
| **名称**      | **类型** | **描述**                                                     |
| ------------- | -------- | ------------------------------------------------------------ |
| keyType       | String   | 密钥类型,支持密钥类型代码和密钥类型名称两种格式，如“MDK”密钥可以传入“109”或“MDK”两种格式。<li>    000 - ZMK/KEK</li> <li> 001 - ZPK</li> <li>  002 - PVK/TPK/TMK</li><li>003 - TAK</li><li> 008 - ZAK</li><li>009 - BDK</li> <li>00A - ZEK/DEK</li><li>00B - TEK </li><li>011 - KMC</li><li>109 - MK-AC/MDK</li><li> 10C - HMAC</li><li>209 - MK-SMI</li><li> 309 - MK-SMC</li><li>402 - CVK</li><li> 409 - MK-DAK</li><li> 509 - MK-DN</li> |
| keyFlag       | char     | 密钥 LMK 下加密的密钥标识。<li>Z - 单倍长 DES 密钥</li><li>X - 双倍长 3DES 密钥</li><li> Y - 三倍长 3DES 密钥</li><li>U - 双倍长的 3DES 算法密钥</li><li> T - 三倍长的 3DES 算法密钥</li><li>R - 16字节 SM4 密钥</li><li> P - 16字节 SM1 密钥</li><li>L - 16字节 AES 密钥</li><li> M - AES-192 算法密钥</li><li> N - AES-256 算法密钥</li> |
| ZMKKey        | Object   | ZMK 密钥索引或密文（管理工具合成ZMK返回的LMK加密的密文）。   |
