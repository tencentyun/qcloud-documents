本文档为您介绍如何购买云加密机实例。
>?目前托管物理密码机功能仅对部分用户开放，如需访问控制台，请 [联系我们](https://cloud.tencent.com/online-service) 开通权限。
...
2. 在云加密机购买页面中，选择并确认实例的基本配置。
 - **虚拟密码机母机**
![](https://qcloudimg.tencent-cloud.cn/raw/9f26bf3fb0e65a149c84df8ff6df2800.png)购买页实例基本配置说明如下：
<table>
<thead>
<tr>
<th align="left">配置</th>
...
<td>根据业务情况选择地域可用区，目前支持广州三区、广州四区、广州六区、北京二区、上海金融三区及上海四区。</td>
</tr>
<tr>
<td align="left">设备厂商</td>
<td>云加密机服务可托管设备对应的厂商，当前仅支持<strong>江南天安</strong>。</td>
</tr>
<tr>
<td align="left">型号</td>
...
<td>勾选“自动续费”后，当服务期满时，系统会自动按照购买周期进行续费。</td>
 ...
 - **托管物理密码机**
![](https://qcloudimg.tencent-cloud.cn/raw/d595c7a9bf82488630091c073d44a907.png)购买页实例基本配置说明如下：
<table>
<thead>
<tr>
<th align="left">配置</th>
...
<tbody><tr>
<td align="left">地域</td>
<td>云加密机实例支持的区域，云加密机只能在专有网络 VPC 中使用，且云加密机实例的区域必须与您的 VPC 区域相同，当前支持购买实例的区域有：新加坡、法兰克福。</td>
</tr>
<tr>
<td align="left">可用区</td>
<td>根据业务情况选择地域可用区，目前仅支持新加坡一区、法兰克福一区。</td>
</tr>
<tr>
<td align="left">设备厂商</td>
<td>云加密机服务托管设备对应的厂商，当前仅支持 <strong>TASS</strong>。</td>
</tr>
<tr>
<td align="left">型号</td>
<td>云加密机服务支持的设备型号，当前仅支持 <strong>TASS Crypto Engine</strong>。</td>
</tr>
<tr>
<td align="left">私有网络</td>
<td>选择为云加密机实例绑定所属的 VPC 网络、VPC 交换机以及私网 IP 地址。<strong>业务应用和云加密机实例需配置同一 VPC 下。</strong></td>
