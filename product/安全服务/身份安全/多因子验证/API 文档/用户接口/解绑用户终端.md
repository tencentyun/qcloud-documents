...
### API 详情
- 请求路径：https://api.tencentmfa.com/am/rest/p/1/identity/user/unbindUserTerminals
- 请求方法：POST
- 请求 Content-Type：pplication/x-www-form-urlencoded
...
| loginName | 是 | 用户登录名 |
| deleteFingerprint | 否 | 是否删除指纹库中的 MAC 地址<br>删除：TRUE<br>不删除：FALSE（默认） |
