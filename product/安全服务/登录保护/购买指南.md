...
### 免费体验
- 登录保护对已进行 [企业认证](https://cloud.tencent.com/document/product/378/10496) 的用户提供7天免费体验服务（包含10000次调用），可登录 [天御控制台](https://console.cloud.tencent.com/tianyu/overview ) 进行申请。
...
>?
- 包年价格 = 包月价格 * 10，过期将停服处理，如需继续使用，需重新购买。
- 每日防护上限为当天可使用次数上限。
