...
### 第4步：API 接入
免费测试权限开通后，您可以根据实际情况按照 API 说明编写代码，接入登录保护服务，详情见 [登录保护 API 文档](https://cloud.tencent.com/document/product/1191/43979)。
### 第5步：查询调用数据
进入 [登录保护服务监控界面](https://console.cloud.tencent.com/lp/oldpackage)，查询登录保护的调用详情与请求详情，以此进行判断产品的健康情况。
