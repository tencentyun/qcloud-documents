...
>!API 支持就近地域接入，本产品就近地域接入的域名为 ams.tencentcloudapi.com，也支持指定地域域名访问，例如：广州地域的域名为 mas.ap-guangzhou.tencentcloudapi.com。详细请参考 [音频内容安全-请求结构](https://cloud.tencent.com/document/product/1219/53261)。
>
...
import TencentCloudSDKException from tencentcloud.ams.v20201229
import ams_client, models
try: cred = credential.Credential("SecretId", "SecretKey") httpProfile = HttpProfile() httpProfile.endpoint = "ams.tencentcloudapi.com"
clientProfile = ClientProfile() clientProfile.httpProfile = httpProfile client = ams_client.AmsClient(cred, "ap-guangzhou", clientProfile) req = models.TextModerationRequest() params = {}
