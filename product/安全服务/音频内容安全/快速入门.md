...
#### 操作步骤
1. 登录 [内容安全控制台](https://console.cloud.tencent.com/cms/text/overview)，在左侧导航栏中选择**音频内容安全**下的任一菜单。
2. 在页面右侧区域单击**立即开通**，即可开通音频内容安全。
>?首次开通服务后，可可免费获得**600分钟**的测试套餐包，有效期为**一个月**；如免费套餐包到期或用尽后未 [购买正式套餐包](https://buy.cloud.tencent.com/cms?type=ams)，服务将被停用。
>
...
## 步骤7：体验服务[](id:step7)
完成以上步骤后，您可以选择创建的审核策略，通过立即审核音频，体验音频内容安全服务。
...
2. 在服务体验页面，选择所需的应用策略，通过如下任意一种方式指定审核音频。
- 从本地上传：单击**点击上传**，选择需要上传的文件，其中音频文件需满足以下要求：
 - 音频文件大小： 50 MB以内。
 - 音频文件时长： 3 分钟以内。
...
3. 单击**立即审核**， 待系统审核完成后在页面下方会显示该音频的审核结果。
![](https://qcloudimg.tencent-cloud.cn/raw/2f0b38ca30d88dcb3f603311c9060e35.png)

## 步骤8：接入服务[](id:step8)
如果您需要接入音频内容安全服务，需通过调用 API 接口完成接入，详情请参考 [API 接入指引](https://cloud.tencent.com/document/product/1124/64508)。
