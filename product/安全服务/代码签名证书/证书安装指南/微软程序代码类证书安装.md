...
证书转换推荐使用在线证书格式转换工具（如：亚洲诚信在线格式转换工具https://www.trustasia.com/tools-cert-converter a11） 或者使用openssl工具进行本地证书转换。详见[什么是OpenSSL](https://www.qcloud.com/document/product/400/5707)
