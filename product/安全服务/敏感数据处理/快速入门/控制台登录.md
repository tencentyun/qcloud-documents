购买 CDS-Mask 后，您可进入 CDS-Mask 管理界面进行配置，下面将为您详细介绍如何进入管理页面。
## 进入控制台
在 [腾讯云控制台](https://console.cloud.tencent.com/) 中选择 【云产品】>【安全】>【敏感数据处理】，进入数盾控制台，单击左侧导航栏中【敏感数据处理系统】即可进入 CDS-Mask 管理页面。
