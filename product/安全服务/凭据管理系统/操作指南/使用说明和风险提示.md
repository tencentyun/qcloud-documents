...
### 应对方案
为了防止访问数据库失败的情况发生，**请不要在客户端自动保存密码信息和使用带有连接池功能的数据库SDK**。具体请参考 [最佳实践]() ，并使用**最佳实践**中推荐的腾讯云官方提供的 **SSM SDK**（ [Go](https://github.com/TencentCloud/ssm-rotation-sdk-golang) 和 [Python](https://github.com/TencentCloud/ssm-rotation-sdk-python) ） 来连接数据库。 
