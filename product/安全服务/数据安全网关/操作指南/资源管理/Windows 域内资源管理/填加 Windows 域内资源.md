## 操作场景
堡垒机支持主流的大部分资源类型，如 Linux、Windows 等其他资源类型。下面将为您详细介绍如何添加 Windows 域内资源。

## 前提条件
堡垒机系统需已添加 Windows 域控资源。具体请您查看 [添加 Windows 域控资源](https://cloud.tencent.com/document/product/1025/32500) 文档。
