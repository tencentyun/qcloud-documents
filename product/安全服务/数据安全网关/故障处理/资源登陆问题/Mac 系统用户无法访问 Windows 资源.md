...
## 处理步骤
1.工具下载安装：推荐版本[ 10.5.1(1852)](https://install.appcenter.ms/orgs/rdmacios-k2vy/apps/microsoft-remote-desktop-for-mac/distribution_groups/all-users-of-microsoft-remote-desktop-for-mac)，使用默认安装即可。
