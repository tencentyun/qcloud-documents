...
4.	将 SSH2，SSH1 和 Telnet 选项，设置为 “设置SecureCRT为您的默认xxx工具”。
...
堡垒机支持在 MAC 和 Linux 终端下通过 Web 方式（建议使用 Chrome 浏览器），进行资源单点登录与文件传输。登录堡垒机后，在工具栏选择 Web，即可登录资源。

![](https://main.qcloudimg.com/raw/2c9f03fa2ed836de90471d7b83946b02.jpeg)
 
### 当系统提示运维用户的账户密码已过期要如何处理？
