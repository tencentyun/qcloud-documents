### 生成签名 
1.前置条件：必须按照说明[获取SIGN ticket](https://www.qcloud.com/document/product/295/10120).
...
| version | 1.0.0 | 
| api ticket | 合作伙伴服务端缓存的tikcet,注意是SIGN 类型，具体见[获取SIGN ticket](https://www.qcloud.com/document/product/295/10120). | 
