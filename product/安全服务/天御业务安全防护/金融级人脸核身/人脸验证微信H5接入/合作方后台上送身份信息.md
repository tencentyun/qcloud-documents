...
| version | 1.0.0 | 
| api ticket | 合作伙伴服务端缓存的 tikcet,注意是 SIGN 类型，具体参考 [SIGN ticket获取](https://cloud.tencent.com/document/product/295/10120?!preview&lang=cn)| 
...
|sourcePhotoType | 比对源照片类型 | String |1 |1:水纹正脸照
2：高清正脸照 |
