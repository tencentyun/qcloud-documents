...
|userLanguage|	String	|指定验证码提示文案的语言，优先级高于后台配置，暂时仅支持滑块拼图验证码。支持传入值同 navigator.language 用户首选语言，大小写不敏感。更多详情请参见 [userLanguage 配置参数支持语言](#userLanguage)。 |

userLanguage 配置参数支持语言[](id:userLanguage)
