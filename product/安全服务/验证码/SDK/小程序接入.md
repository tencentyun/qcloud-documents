...
## 前提条件
验证码接入前，需要先在 [验证码控制台](https://console.cloud.tencent.com/captcha) 中注册 AppID 和 AppSecret，注册完成后，您可以在验证码控制台的验证详情的基础配置中，查看 AppID 以及 AppSecret。
## 接入步骤
...
## 后续步骤
至此，验证码客户端接入已完成，验证码后台需二次核查验证码票据结果，您需要进行 [后台 API 接入 ](https://cloud.tencent.com/document/product/1110/36926) 操作，确保验证安全性。
