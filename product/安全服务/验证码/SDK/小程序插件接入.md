...
使用小程序插件接入验证码前，需要先在 [验证码控制台](https://console.cloud.tencent.com/captcha?buffet-config=ed553bbbce&ticketId=111125) 中注册小程序插件 AppID 和 AppSecret，注册完成后，您可以在验证码控制台验证详情的基础配置中，查看 AppID 以及 AppSecret。
