...
使用小程序插件接入验证码前，需要先在 [验证码控制台](https://console.cloud.tencent.com/captcha) 中注册小程序插件 AppID 和 AppSecretKey，注册完成后，您可以在验证码控制台的验证详情的基础配置中，查看 AppID 以及 AppSecretKey。
...
```其中小程序插件验证码 AppID 请在 [验证码控制台](https://console.cloud.tencent.com/captcha) 中，选择【查看详情】>【基础配置】进行查看 。如果未新建验证，请根据业务需求选择适合的验证渠道、验证场景进行新建。 
![](https://main.qcloudimg.com/raw/1a766fa7fdbf7b98ba65a1a00a48f232.png)
