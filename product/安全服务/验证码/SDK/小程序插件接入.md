...
使用小程序插件接入验证码前，需要先在 [验证码控制台](https://console.cloud.tencent.com/captcha?buffet-config=ed553bbbce&ticketId=111125) 中注册小程序插件 AppID 和 AppSecret，注册完成后，您可以在验证码控制台的验证详情的基础配置中，查看 AppID 以及 AppSecret。
...
<img src="https://main.qcloudimg.com/raw/21af6d26f5395cdfea1d0dfd2b1c84e8.png" style="zoom:75%;" />
...
{
  "usingComponents": {
    "hello-component": "plugin://captcha/t-captcha"
  }
}
```
...
## 后续步骤
至此，验证码微信小程序接入已完成，您需要进行 [后台小程序插件 API 接入](https://cloud.tencent.com/document/product/1110/48499) 操作。
