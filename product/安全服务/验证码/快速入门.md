...
>?如果您已经具有腾讯云密钥可以跳过这一步。
### **步骤3：客户端接入**
验证码客户端接入方式，请参见 [Web 前端接入](https://cloud.tencent.com/document/product/1110/36841)（iOS 和 Android）、[小程序接入](https://cloud.tencent.com/document/product/1110/36844) 、[小程序插件接入](https://cloud.tencent.com/document/product/1110/49319) 文档。
