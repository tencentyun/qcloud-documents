...
- 请核实业务前端页面接入使用的 captcha_appid 是否为控制台创建的验证，创建合法 captcah_appid 请按照如下操作新建验证：
...
|16|appid no match|验证码强校验 appid 错误，前端代码 data-appid 和后端 CaptchaAppId 所填写的值，必须和 [验证码控制台](https://console.cloud.tencent.com/captcha) 中**验证详情** > **基础配置**内的 AppID 一致。|
