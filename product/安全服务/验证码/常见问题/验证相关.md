...
1. 登录 [验证码控制台](https://console.cloud.tencent.com/captcha) 进入验证码详情页，在上方导航栏中，单击【安全配置】。
...
|16|appid no match|前端代码 data-appid 和后端 CaptchaAppId 所填写的值，必须和 [验证码控制台](https://console.cloud.tencent.com/captcha) 中【验证详情】>【基础配置】内的 AppID 一致。
|100|	SecretKeyCheck Error	|CaptchaAppId 与对应 AppSecretKey 不一致，需检查 AppSecretKey 参数是否有误。其中 CaptchaAppId、 AppSecretKey 在 [验证码控制台](https://console.cloud.tencent.com/captcha) 的【验证详情】>【基础配置】中获取。|
