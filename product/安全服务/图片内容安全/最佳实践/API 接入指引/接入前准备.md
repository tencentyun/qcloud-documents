...
## 账号信息获取
### 获取腾讯云账号
登录腾讯云控制台后，请参考 [账号注册教程](https://cloud.tencent.com/document/product/378/17985) 进行账号注册和实名认证，如果您已经具备腾讯云账号，可以跳过本步骤。
### 获取腾讯云 API 访问密钥
...
## 控制台配置
### 服务开通
首次登录 [内容安全控制台](https://console.cloud.tencent.com/cms) 可以领取1 万/月的免费测试包。若免费测试包耗尽或过期可通过购买套餐包开通服务权限，您可以在 [图片内容安全购买页](https://buy.cloud.tencent.com/ims) 进行套餐包购买。
...
3. 在关联策略弹窗，选择 QcloudCMSFullAccess 策略，单击**确定**，即可保存设置。
![](https://main.qcloudimg.com/raw/29b40afbc4ac1efcafe740ed49be9344.png)
