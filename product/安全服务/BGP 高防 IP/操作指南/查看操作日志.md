## 操作场景
DDoS 高防 IP 支持查看近90天内重要操作的日志，如有需要，您可以登录 [DDoS 防护（大禹）管理控制台](https://console.cloud.tencent.com/dayu/overview) 查看。可查看的日志包含以下类别：
- 转发规则变更操作日志
- DDoS 高级防护策略变更操作日志
- 清洗阈值调整日志
- 防护等级变更日志
...
3. 设置时间范围，通过【产品类型】筛选【高防IP】，查看对应的操作记录。
