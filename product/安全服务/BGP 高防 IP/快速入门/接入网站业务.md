...
用户可以通过登录[ DDoS 防护（大禹）管理控制台](https://console.cloud.tencent.com/dayu/overview)，在左侧导航栏选择【BGP 高防 IP】>【资产列表】，找到目标 BGP 高防 IP 实例所在行，单击“ID/名称”，在弹出的“基础信息”页面中查看详细的高防 IP 回源地址段。
<span id="step3"></span>
### 本地验证配置
