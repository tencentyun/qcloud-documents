...
- 在添加转发规则前，您需要成功 [购买 BGP 高防 IP 实例](https://cloud.tencent.com/document/product/1005/30848)。
...
3. 根据实际需求配置如下参数，单击【确认】。
		...
		<table>
			...
			<tr>
				...
				<td><ul><li>勾选【HTTPS】。</li>
				        <li> 选择证书来源。</li>
				        <li>根据证书来源上传证书：<ul><li>若是【自有证书】则填写【证书】和【秘钥】。</li><li>若是【腾讯云托管证书】则选择【证书】。</li></li>
				        </ul></td>
			</tr> 
			<tr>
 ...
 根据【回源方式】填写源站 IP 或源站域名：
    -   若勾选【IP 回源】，则填写源站服务器的IP地址。若一个域名对应多个源站 IP，可全部填入并用回车分隔多个 IP，最多支持20个 IP。
    -   若勾选【域名回源】，则填写回源域名。
...
2. 在域名记录管理页签，单击【添加记录】，添加 BGP 高防 IP 的 CNAME 记录，单击【保存】。
