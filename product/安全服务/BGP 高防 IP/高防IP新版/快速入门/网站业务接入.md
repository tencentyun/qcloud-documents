...
### 配置转发规则
1. 登录 [DDoS 高防 IP（新版）管理控制台](https://console.cloud.tencent.com/ddos/dashboard/overview)，在左侧目录中，单击**业务接入** > **域名接入**。
2. 在域名接入页面，单击**开始接入**。
![](https://qcloudimg.tencent-cloud.cn/raw/3499752be87831f673ff70786aab7d32.png)
...
<img src="https://qcloudimg.tencent-cloud.cn/raw/41a9b95b9d1fda56ee79094fe85f79c2.png" width=700px>
4. 选择回源方式，填写源站 IP+端口或源站域名。如有备用源站可选中备用源站，添加备用源站及权重，单击**下一步：修改 DNS 解析**。
<img src="https://qcloudimg.tencent-cloud.cn/raw/ec7eed2ef12346cc6b20a27bba652a8d.png" width=700px>
>?
...
1. 用户可以通过 [DDoS 高防 IP（新版）管理控制台](https://console.cloud.tencent.com/ddos/dashboard/overview)，在左侧导航栏，单击**云上防护实例**，找到对应实例 ID。
