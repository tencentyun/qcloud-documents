...
### 配置转发规则
1. 登录 [DDoS 高防 IP（新版）管理控制台](https://console.cloud.tencent.com/ddos/dashboard/overview) ，在左侧目录中，单击**业务接入** > **端口接入**。
2. 在端口接入页面，单击**开始接入**。
![](https://qcloudimg.tencent-cloud.cn/raw/7fa76ea9748a6ebce023bb9cc2c26065.jpg)
...
![](https://qcloudimg.tencent-cloud.cn/raw/9e89902fb13292d2c321cbf433f1f5cd.jpg)
>?
...
1. 用户可以通过登录 [DDoS 高防 IP（新版）管理控制台](https://console.cloud.tencent.com/ddos/dashboard/overview)，在左侧导航栏中，单击**云上防护实例**，找到对应实例 ID。
