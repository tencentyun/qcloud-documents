...
### 步骤2：CC 防护等级设置
1. 在 [防护配置](https://console.cloud.tencent.com/ddos/antiddos-advanced/config/port) 页面，在左侧的列表选中高防 IP 的 ID 下面的域名，如"212.64.xx.xx bgpip-000002je" > "http:80" > "www.xxx.com"。
2. 在右侧的“CC防护等级”卡片中，设置防护等级，用户可以根据自己的业务选择"严格"、"适中"、"宽松"三种等级。
...
3. 单击【新建】，创建频率控制规则，填写相关字段，单击【确定】即可。详细配置说明，请参见 [CC 频率控制](https://cloud.tencent.com/document/product/1014/44103)。
>!
