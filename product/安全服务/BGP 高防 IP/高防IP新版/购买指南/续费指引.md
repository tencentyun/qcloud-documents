...
## 续费提醒
DDoS 高防 IP 服务到期前7天，系统会向您推送资源即将到期提醒，消息通过站内信、短信、邮件、微信等方式（实际接收方式以您在[消息中心订阅](https://console.cloud.tencent.com/message/subscription)配置为准）通知到腾讯云账号创建者以及所有协作者。具体详情请参考文档[欠费说明]()
...
## 续费方式
### 控制台续费
1. 登录 [DDoS 高防 IP（新版）管理控制台](https://console.cloud.tencent.com/dayu/overview)。
2. 打开“实例列表”界面，单击目标实例操作列中的【续费】。
