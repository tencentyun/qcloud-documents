...
3. 依据获取到的回传 JS 地址加载和校验验证码。
 - [iOS 客户端 API](https://cloud.tencent.com/document/product/295/2898)
 - [Android 客户端 API](https://cloud.tencent.com/document/product/295/2897)
4. 用户验证完成后，将获取的用户验证票据到后台。
详情请参见 [后台验证票据 API](https://cloud.tencent.com/document/product/295/6706)。
