...
3. 单击【免费加固】。
 ![](https://main.qcloudimg.com/raw/674a34e92271226ba7986679dc15a51b.png)
4. 单击【上传应用】，上传已签名的 APK，且不能是已经加固的包。若已上传过应用，可直接选择对应版本进行加固。
 ![](https://main.qcloudimg.com/raw/d8324d7bf5dc4e727bc7f2a309a4d1af.png)
...
2.选择 [应用加固](https://console.cloud.tencent.com/ms/reinforce/tool) 页面下加固工具列表，下载对应版本应用加固助手，下载完成后，PC 端工具可直接实现应用加固、签名、多渠道打包。多渠道打包后，需要重新签名。使用 adb 安装应用时可看到具体的错误信息。
![](https://main.qcloudimg.com/raw/595457d14da15903ce5589b0defe1f5d.png)
PC 端应用加固助手：
