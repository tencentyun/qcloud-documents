...
| 12003     | 使用自带对比源，传入参数错误，非base64 | 传入的 srcPhotoString 不是 base64   |
| 12004     | 使用自带对比源，传入参数错误，超过 3M   | 传入的 srcPhotoString 超过 3M       |
...
| Code（错误码） | Description（描述） | Reason（详细实际原因）                     |
| --------- | --------------- | ---------------------------------- |
| 42000     | 用户取消            | 回到后台/点击 home/左上角/上传时左上角取消          |
