...
- 银行卡识别时，在 WBBankCardInfoModel 类的头文件中，增加了三个字段：
 1. 清晰度 clarity 字段。
 2. 多重警告码 multiWarningCode 字段。
 3. 多重警告码描述 multiWarningMsg 字段。
- 身份证人相面识别时，在 WBIDCardInfoModel 类的头文件中，增加了两个字段：
 1. 清晰度 frontClarity 字段。
 2. 多重警告码 frontMultiWarning 字段。
- 身份证国国徽面识别时时，在 WBIDCardInfoModel 类的头文件中，增加了两个字段：
 1. 清晰度 backClarity 字段。
 2. 多重警告码 backMultiWarning 字段。
