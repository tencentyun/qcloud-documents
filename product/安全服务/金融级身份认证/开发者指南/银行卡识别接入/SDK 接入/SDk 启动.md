...
-  合作方根据本次银行卡识别验证的如下参数生成签名，需要签名的参数信息如下：
...
下一步：[Android SDK 接入](https://cloud.tencent.com/document/product/655/13857)

​              [iOS SDK 接入](https://cloud.tencent.com/document/product/655/13859)