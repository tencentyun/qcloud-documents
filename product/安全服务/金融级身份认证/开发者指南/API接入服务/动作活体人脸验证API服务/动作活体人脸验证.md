...
|sourcePhotoStr|	合作伙伴自己提供的可信比对源照片，注意：原始图片不能超过 2MB，且必须为 JPG 或 PNG 格式  |Base64 String|	不超过 3MB|	否|
|sourcePhotoType|	比对源照片类型<li>1：网纹照</li><li>2：高清照</li> |String|	1|	否|
|videoStr|	需要识别的录制视频	|Base64 String|	不超过 3MB|	是|
