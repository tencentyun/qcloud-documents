...
|sourcePhotoStr	|比对源照片|	Base64 String|	不超过 1M	|是|
|sourcePhotoType	|用户比对源照片类型(1-网纹照，2-高清照)|	String|	32	|是|
...
|faceNum|int	|图片中人脸数|
|faceResultList|list|比对照片人脸识别明细数组<br/>ingleFaceCode：每个人脸结果（1：通过<br/>2：不通过）<br/>singleFaceMsg：每个人脸的结果描述<br/>similarity：每个人脸的比对分数