...
| photoStr        | 照片文件</br>原始图片不能超过2M，且必须为 JPG 或 PNG 格式    | Base64 String | 不超过3M   | 是  |
| sourcePhotoStr  | 合作伙伴自己提供的可信比对源照片</br>原始图片不能超过2M，且必须为 JPG 或 PNG 格式 | Base64 String | 不超过3M      | 是 |
