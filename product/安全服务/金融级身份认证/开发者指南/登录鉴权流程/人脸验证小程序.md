...
### 第三步：小程序刷脸
- NONCE ticket 有效期 120 秒，且一次性有效。在用户登录流程中，获取 API ticket 请求的 userId 为必填参数，type 为 NONCE。获取方式见 [NONCE ticket 获取](https://cloud.tencent.com/document/product/655/13816)。
