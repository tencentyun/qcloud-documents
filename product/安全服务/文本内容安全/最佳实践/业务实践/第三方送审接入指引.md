...
4. 在策略配置页面，单击界面右下方的**编辑**，修改识别策略，并根据实际需求选择自定义词库，单击**确认**。
>?如未创建自定义词库，请参见 [自定义词库文档](https://cloud.tencent.com/document/product/1124/37119#.E8.87.AA.E5.AE.9A.E4.B9.89.E8.AF.8D.E5.BA.93) 进行创建。
>
