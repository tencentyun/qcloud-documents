本文档介绍了网站类业务用户如何将业务接入高防 IP 专业版实例并验证转发配置。
...
用户可以通过登录[ DDoS 防护（大禹）管理控制台](https://console.cloud.tencent.com/dayu/overview)，在左侧导航栏选择【高防 IP 专业版】>【防护配置】，进入防护配置页面，单击【防护策略】，在服务包信息区域查看所使用高防 IP 专业版实例的详细高防IP回源地址段。
<span id="step3"></span>
### 本地验证配置
转发配置完成后，高防 IP 专业版实例包含的5个高防 IP 将按照转发规则，将相关端口的报文转发到源站的对应端口。
为了最大程度保证业务的稳定，建议在全面切换业务之前先对5个高防 IP 进行本地测试。具体的验证方法如下：
