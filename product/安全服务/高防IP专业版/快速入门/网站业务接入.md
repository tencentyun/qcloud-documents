本文档介绍了网站类业务用户将业务接入高防 IP 专业版实例并验证转发配置的详细操作步骤。
...
1. 登录 [DDoS 防护（大禹）管理控制台](https://console.cloud.tencent.com/dayu/overview)，在左侧导航栏选择【高防 IP 专业版】>【接入配置】。
2. 在接入配置页面，单击【网站业务】，查找并选择目标高防 IP 专业版实例，添加转发规则。
	- 单个添加转发规则：
		1. 	单击【新建】。
![](https://main.qcloudimg.com/raw/f3b9227f5aa68220923d5b94cb0aeeab.png)
		1. 在添加转发规则页面中，根据实际需求配置如下参数，单击【确定】。
![](https://main.qcloudimg.com/raw/a364d3b967929951463aa188dea1f3ab.png)
参数说明：
 - 域名：填写需要配置防护的网站域名。
 - 协议：支持 HTTP 和 HTTPS，请根据实际业务需求勾选：
  ...
  - 根据【回源方式】填写源站 IP 或源站域名：
	...
	- 批量添加转发规则：
		1. 	选择【批量导入】>【导入转发规则】。
		![](https://main.qcloudimg.com/raw/5da700723dabb65b711bec69f41fee48.png)
...
用户可以通过登录[ DDoS 防护（大禹）管理控制台](https://console.cloud.tencent.com/dayu/overview)，在左侧导航栏选择【高防 IP 专业版】>【防护配置】，进入防护配置页面，单击【防护策略】，在服务包信息区域查看所使用高防 IP 专业版实例的详细高防 IP 回源地址段。
<span id="step3"></span>
### 本地验证配置
转发配置完成后，高防 IP 专业版实例包含的5个高防 IP 将按照转发规则，将相关端口的报文转发到源站的对应端口。
...
>?若使用正确的方法显示验证失败，请登录  [DDoS 防护（大禹）管理控制台](https://console.cloud.tencent.com/dayu/overview) 检查配置是否正确。排除配置错误和验证方法不正确后，若问题依然存在，请联系  [腾讯云技术支持](https://cloud.tencent.com/about/connect) 。
...
1. 登录 [腾讯云控制台](https://console.cloud.tencent.com)，选择【云产品】>【域名与网站】>【云解析】，在【域名解析列表】中，单击目标域名所在行的操作【解析】。
   ![](https://main.qcloudimg.com/raw/c3f533833140fba7d808a87d39b4c9ae.png)
2. 在域名记录管理页签，单击【添加记录】，记录类型选择 CNAME，记录值内输入高防 IP 专业版自动生成的 CNAME 地址，单击【保存】。
![](https://main.qcloudimg.com/raw/e3b3e48992f82bee07a5ca17a4fc8c47.png)
