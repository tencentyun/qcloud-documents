...
1. 处理完违规信息后，您可 [提交工单](https://console.cloud.tencent.com/workorder/category) 联系客服申请解除该设备的访问限制。   
>!如您的设备已经被隔离，请参见 [登录及远程连接](https://cloud.tencent.com/document/product/213/17278) 登录您的云服务器系统，并处理违规信息。
