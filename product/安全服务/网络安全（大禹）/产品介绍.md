...
|---------|---------|---------|---------|---------|
| **适用用户** |仅腾讯云内用户 | 仅腾讯云内用户 |支持任意源站位置 | 游戏类用户或对四层</br>业务有防护需求且源</br>站不在腾讯云的用户 |
| **防护对象** | 腾讯云内 CVM | 网站、非网站业务 |网站、非网站业务 | 四层 TCP 业务 |
| **特点** | 免费且普通用户均享受 2 Gbps 防护 ( VIP 客户最高可申请 10 Gbps 防护) | 无需配置</br>直接使用</br>平滑升级 |隐藏业务真实 IP | 使用 IP 池轮询技术</br>实现灵活的用户和</br>流量调度策略，保证在遭受大流量</br>攻击时，业务不受影响 |
