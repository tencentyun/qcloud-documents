...
- **启用配置检查策略**
在 [配置检查策略](https://console.cloud.tencent.com/ssav2/config/strategy) 策略列表中，单击![](https://qcloudimg.tencent-cloud.cn/raw/b3c12b2ba7f0234f58427ae12146f25c.png)即可开启策略，已启用的策略进行配置检查。
