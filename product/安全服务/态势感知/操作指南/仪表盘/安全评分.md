安全评分可查看云上的整体安全风险情况，可查看内容包括：待处理漏洞、待处理云安全配置、待处理安全事件、待处理合规风险及待处理泄露事件等信息。单击所需要查看的待处理事件及数量，页面将跳转至对应待处理事件界面。
...
- 在分数右侧单击【查看评分看板】，查看安全事件、漏洞、云安全配置等模块的待处理风险项，并根据处理建议完成处置。
	在评分看板页找到目标模块，在右侧单击【取消纳入评分】，可将该模块取消纳入安全评分，如有需求支持将其再次纳入评分。
![](https://main.qcloudimg.com/raw/8b418bb4ddad8c82fa9d91db15ac10d9.png)
>?取消纳入评分表示该模块存在未处理风险时不再进行扣分。
- 在分数右侧单击【重新检测】，可对互联网攻击面测绘、漏洞、安全事件、流量威胁感知、云配置管理模块进行重新检测。
...
<tr><td>暴露服务及端口或暴露组件</td><td>5分</td><td>有一个 IP 暴露服务及端口或暴露组件，扣1分，扣完即止。</td><td>前往【<a href = "https://console.cloud.tencent.com/ssav2/assetmap"> 互联网攻击面测绘</a>】模块，对存在暴露风险的资产进行查看和处置。</td></tr>
<tr><td>存在未处理漏洞</td><td>15分</td><td>根据风险等级扣分，扣完即止。<ul><li>1个高危扣3分。</li>
<li>1个中危扣2分。</li>
<li>1个低危扣1分。</li></ul>
</td><td>前往【漏洞管理】>【<a href = "https://console.cloud.tencent.com/ssav2/vulner"> 待处理漏洞看板</a>】模块，对未处理漏洞进行查看和处置。</td></tr>
...
<tr><td>云资产未授权</td><td>无法使用安全评分功能，总分为0分。</td><td>前往【资产中心】>【<a href = "https://console.cloud.tencent.com/ssav2/assets">云资产</a>】模块，单击【前往访问管理】进行授权。</td></tr>
<tr><td>云资产已授权，未开启监测规则</td><td>此项未开启总分扣10分。</td><td>前往【泄露监测】>【<a href = "https://console.cloud.tencent.com/ssav2/monitor/rule">自定义监测规则</a>】中，设置并开启监测规则。</td></tr>
...
<ul><li>1个严重扣4分。</li><li>1个高危扣3分。</li>
<li>1个中危扣2分。</li>
<li>1个低危扣1分。</li></ul></td><td>前往【漏洞管理】>【<a href = "https://console.cloud.tencent.com/ssav2/vulner/vul"> 漏洞列表</a>】模块，对未处理漏洞进行查看和处置。</td></tr>
<tr><td>存在未处理安全事件</td><td>40分</td><td>根据风险等级扣分，扣完即止。
<ul><li>1个严重扣4分。</li><li>1个高危扣3分。</li>
<li>1个中危扣2分。</li>
