...
单击下载相关 [Demo 及 SDK](https://main.qcloudimg.com/raw/5ef28eba111891591f576dbbbaed601c.zip)。
...
2. 将 SDK 文件添加到 Xcode。首先右键工程名，单击 “Add Files to”：
![](https://i.imgur.com/ZOeSU5b.png)
在对话框中勾选 “Create folder references”，选中 SDK 的两个文件，单击 Add。
![](https://i.imgur.com/T7ls8Cu.png)
3. 左键工程名，选择 General，将 a 文件添加到 “Linked Framews and Libraries”：
![](https://i.imgur.com/B1M5boV.png)
4. 如果是 Swift 项目，需要创建桥文件，Object-C 项目可以跳过此步骤。创建一个 Header File，命名为 bridge.h。并在文件中添加以下代码：
			# import "gamesec.h";
