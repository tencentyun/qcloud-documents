...
业务请求经过高防IP的4层转发后，业务服务器端接收到报文后，其看到的源IP地址是高防IP的出口IP地址。为了让服务器端能够获取到用户端实际的IP地址，您可以使用如下TOA的方案。在您的Linux服务器上，安装对应的TOA内核包，并重启服务器后。业务侧就可以获取到用户端实际的IP地址。
...
请根据业务服务器Linux操作系统的类型和版本下载对应的内核包，按如下步骤操作。如果没有和您操作系统一致的内核包，您还可以参考下面TOA源代码安装指引操作。
...
6.x 下载地址：
[http://toakernel-1253438722.cossh.myqcloud.com/kernel-2.6.32-220.23.1.el6.toa.x86_64.rpm](http://toakernel-1253438722.cossh.myqcloud.com/kernel-2.6.32-220.23.1.el6.toa.x86_64.rpm)

7.x 下载地址：
[http://toakernel-1253438722.cossh.myqcloud.com/kernel-3.10.0-693.el7.centos.toa.x86_64.rpm](http://toakernel-1253438722.cossh.myqcloud.com/kernel-3.10.0-693.el7.centos.toa.x86_64.rpm)
...
内核包：
[http://toakernel-1253438722.cossh.myqcloud.com/linux-image-4.4.87.toa_1.0_amd64.deb ](http://toakernel-1253438722.cossh.myqcloud.com/linux-image-4.4.87.toa_1.0_amd64.deb )

内核 header 包：
[http://toakernel-1253438722.cossh.myqcloud.com/linux-headers-4.4.87.toa_1.0_amd64.deb
](http://toakernel-1253438722.cossh.myqcloud.com/linux-headers-4.4.87.toa_1.0_amd64.deb)
...
内核包：
[http://toakernel-1253438722.cossh.myqcloud.com/linux-image-3.16.43.toa_1.0_amd64.deb](http://toakernel-1253438722.cossh.myqcloud.com/linux-image-3.16.43.toa_1.0_amd64.deb) 

内核 header 包：
[http://toakernel-1253438722.cossh.myqcloud.com/linux-headers-3.16.43.toa_1.0_amd64.deb](http://toakernel-1253438722.cossh.myqcloud.com/linux-headers-3.16.43.toa_1.0_amd64.deb)

安装方法与 ubuntu 相同


###【TOA 源代码内核安装指引（以Centos6为例）】

###1.源码安装

1.在[http://kb.linuxvirtualserver.org/images/3/34/Linux-2.6.32-220.23.1.el6.x86_64.rs.src.tar.gz](http://kb.linuxvirtualserver.org/images/3/34/Linux-2.6.32-220.23.1.el6.x86_64.rs.src.tar.gz) 下载打好 toa 补丁的源码包
