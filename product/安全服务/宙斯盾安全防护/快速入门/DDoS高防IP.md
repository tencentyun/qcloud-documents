...
### 配置上线
1. **购买 DDoS 高防 IP**
a. 用户进入 [宙斯盾高防控制台](https://console.cloud.tencent.com/gamesec)，在左侧目录中，选择 “DDoS 高防 IP”，在右边页面中单击 【购买】。
![](https://i.imgur.com/tJ4TUFW.png)
b. 根据业务需求选取需要的配置，确认配置并单击【立即支付】后，在宙斯盾高防控制台的 DDoS 高防 IP 管理列表下，会看到购买的高防 IP 资源。
![](https://i.imgur.com/11lF1ZC.png)
2. **添加高防 IP 转发规则组**
在 DDoS 高防 IP 列表下，选择 “转发规则组” 页签，单击【添加转发规则组】。输入 “新规则组名称”，选择 “转发模式” 和 “所属项目” 后，单击【确定】。每个转发规则组下默认免费提供 60 个转发规则。
...
6. **CNAME 防护域名**
用户还可以创建免费的防护域名，通过在业务域名解析服务商添加 CNAME 解析到防护域名接入。配置详情请参见 [**防护域名绑定高防IP**](http://文档_用户指南_防护域名绑定高防IP.md "文档_用户指南_防护域名绑定高防IP")。
