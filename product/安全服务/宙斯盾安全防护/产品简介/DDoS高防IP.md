## 什么是 DDoS 高防 IP？
DDoS 高防 IP 是腾讯云面向所有互联网云服务器（含非腾讯云服务器）推出的防 DDoS 攻击的付费产品，能够有效地应对大流量的 DDoS 攻击。目前支持电信、联通、移动、BGP 线路防护，您可直接购买单线路 IP 或套餐（多线路 IP）防护。
