...
#### 输入示例
```
https://<auth_domain>/auth/oauth2/token?client_id=ODQyNGJlYmFjYWF****ZiYWE4YjkwNjU4MzMxOThkMGU&grant_type=token&code=test0dc233****224993e0aca6180&client_secret=test2Uk6E****WlwJfvWUdJht1j%2bq&binding_code=123456
```
#### 返回示例
```
{
