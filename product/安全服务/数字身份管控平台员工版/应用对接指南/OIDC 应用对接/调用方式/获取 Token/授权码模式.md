...
| client_secret | Query    | String | 否       | 客户端 Secret，**[应用管理页面](https://console.cloud.tencent.com/eiam)**>**选定指定应用**> 单击**应用配置**>对应“Client Secret”。含有特殊字符，需要做 URLEncode。如 code_verifier 为空，则 client_secret 必须上送 |
...
```
{
	...
	"id_token": "*****Gc*****UzI1*****nR5*****pXVCJ9.eyJpc3*****hc2*****iLCJpYX*****yMDIx*****TExIDAwOjAwOjA*****iZXhwIjoiM*****0wOS0yOSAwMDow*****CIsImF1ZCI6ImFz*****CIsInN1YiI6ImFzZGFzZCJ9.aWErSpZtZ*****jbu_zPqt-wD_6-fP_nWnb68E"
}
```
