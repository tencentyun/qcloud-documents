...
| client_secret | Query    | String | 否       | 客户端 Secret， **[应用管理页面](https://console.cloud.tencent.com/eiam)** > **选定指定应用** > 单击**应用配置** > 对应的“Client Secret”。含有特殊字符，需要做 URLEncode。如 code_verifier 为空，则 client_secret 必须上送。 |
