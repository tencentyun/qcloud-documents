...
## 配置说明
1. 默认已购买 Web 应用防火墙服务，登录 [Web 应用防火墙控制台](https://console.cloud.tencent.com/guanjia)，在左侧导航栏，选择【Web 应用防火墙】>【防护设置】，进入防护设置页面，单击需要防护的域名。
...
5. 此时您选择封禁的地区，将无法访问您的网站。本文将国外全部地被列入封禁地域后，以海外 IP 地址访问防护网站，Web 应用防火墙会提示您已被腾讯云Web 应用防火墙（网站管家）拦截。
