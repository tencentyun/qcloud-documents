BOT 详情 展示了各个类型的 BOT 的详细数据、各个特征项的统计分布，以及相关日志。
...
## 操作步骤
1. 登录 [Web 应用防火墙（WAF）控制台](https://console.cloud.tencent.com/guanjia/waf/overview)，在左侧导航栏中，选择【BOT 行为管理】>【BOT 详情】>【BOT详情】，进入 BOT详情页面。
...
4. 单击【添加】，可添加多个，每个类型一个。
>?筛选器可以针对多个不同的条件进行数据过滤用来生成报表，条件不限于域名，还包含IP/URL/地理位置等信息。
5. 流量趋势对比图：单击切换流量趋势对比图中的标签项，可快速查看不同类型统计，在选定的时间范围内的流量趋势。
...
![](https://main.qcloudimg.com/raw/d5a9bb47f9d6236e59945901789ba5d8.png)
 - 如果数据量级大于 TOP5 ，单击【更多】，右侧弹出抽屉展示 BOT 请求量 TOP 统计（URL）列表，最多默认展示10条。单击右侧【行为分析】，会根据该路径的相关筛选项，跳转至动态行为分析页签。
![](https://main.qcloudimg.com/raw/a42cfd2600a6db880857bd9e6b733454.png)
