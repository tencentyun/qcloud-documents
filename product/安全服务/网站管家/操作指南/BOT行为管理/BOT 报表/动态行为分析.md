...
3. 在动态行为分析页面，单击“全部 BOT 类型”或“全部动作类型”下拉框，以及访问源 IP“搜索框”，可对访问源 IP 进行筛选。
![](https://main.qcloudimg.com/raw/b9de58d0d4a050bde96061cc4ece1dd8.png)
4. 在动态行为分析页面，选择所需访问源 IP，单击【展开】，可查看异常特征详情。
![](https://main.qcloudimg.com/raw/0d86c518725555237d67d8f60fd72804.png)
5. 在动态行为分析页面，选择所需访问源 IP，单击【详情】，右侧弹出该源 IP 的基本信息和访问信息。
  - 基本信息：展示了该源 IP 的 IP 基础信息、UA 信息和其他 HTTP 头部信息。
  - 访问信息：展示了该源 IP 的请求参数、COOKIE 和 Referer 等信息。
...
6. 在动态行为分析页面，选择所需访问源 IP，单击【添加黑名单】，弹出“确认添加”弹窗。
>?选择多个访问源 IP 后，单击①处【添加黑名单】，可进行批量添加操作。
>
