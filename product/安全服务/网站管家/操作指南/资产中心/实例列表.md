## 功能简介
本文档将为您介绍 Web 应用防火墙（WAF）资产中心的实例列表模块，可以查看实例详情和购买新实例，并对实例的套餐和拓展包进行续费和购买新实例管理。


资产中心是可视化的统一化管理模块，可以对已购买的实例和已配置的域名，进行概况和详细的查看，并且指导下一步的购买决策。本模块支持实例的新增、检索、续费等功能，以及实例下的域名的添加、检索、删除及防护配置。
