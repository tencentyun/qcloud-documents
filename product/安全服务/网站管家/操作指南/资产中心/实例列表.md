## 操作场景
本文档为您介绍 Web 应用防火墙（WAF）资产中心的实例管理模块，支持查看实例详情和购买新实例，并对实例的套餐和扩展包进行续费和购买管理。
...
3. 在实例管理页面，单击“实例 ID”，右侧弹出实例详情面板。
![](https://main.qcloudimg.com/raw/e8daf0cb89482b321eef8e69e72d2a6d.png)
4. 在实例详情面板，可以查看该实例的基本信息和套餐信息，单击![](https://main.qcloudimg.com/raw/f8730ea596ac7d86131e5726ce67ce77.png)，可以关闭套餐续费。
![](https://qcloudimg.tencent-cloud.cn/raw/0394022b868f94b481e1a388bdc9eb75.png)


### 搜索已有实例
如果购买了多个实例，需要检索或搜索，则可使用本功能，已有实例支持按地域、类型检索、按关键字搜索。
1. 登录 [Web 应用防火墙控制台](https://console.cloud.tencent.com/guanjia/tea-overview)，在左侧导航栏中，选择**资产中心** > **实例管理**，进入实例管理页面。
2. 在实例管理页面，可按类型、地域对已有实例进行筛选，或搜索框通过“实例 ID、实例名称和计费方式”关键字查找已有实例。
 - 单击左上角的类型下拉框，按 Web 应用防火墙类型对已有实例进行筛选。
![](https://main.qcloudimg.com/raw/003829f0c445d2d8f7d785055fba1a10.png)
 ...
 - 单击搜索框，可通过“实例 ID、实例名称和计费方式”关键字查找已有实例。
...
>
 ...
 - BOT与业务安全：根据实际需求勾选防护内容，单击**立即购买**，即可购买 BOT 与业务安全扩展包。
![](https://qcloudimg.tencent-cloud.cn/raw/8fa4ab30947e095de02bb8fc7f9316ce.png)
