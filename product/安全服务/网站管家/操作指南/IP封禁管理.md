...
## 操作步骤
### 攻击 IP 惩罚设置
登录 [Web 应用防火墙控制台](https://console.cloud.tencent.com/guanjia)，在左侧导航栏中，选择【IP 管理】>【IP 封禁管理】，进入封禁管理页。
