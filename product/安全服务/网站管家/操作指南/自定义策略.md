...
1. 登录 [网站管家 WAF 控制台](https://console.cloud.tencent.com/guanjia)，单击 【网站应用防火墙】 > 【防护设置】，选择需要防护的站点域名，单击 【自定义策略】 进入自定义策略配置界面。
...
同时，网站管家 WAF 的自定义策略支持使用掩码来控制某一网段的源 IP 的访问请求。我们可以在匹配内容中输入特定网段（如` 10.10.10.10/24` ）。
