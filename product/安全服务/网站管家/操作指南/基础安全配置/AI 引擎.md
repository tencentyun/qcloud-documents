...
![](https://qcloudimg.tencent-cloud.cn/raw/20b94ed87a2c9119a06688ed981b6227.png)
...
#### 步骤3：AI 误报处理
1. 在 AI 引擎页面的 AI 误报处理模块，单击**前往添加**。
![](https://qcloudimg.tencent-cloud.cn/raw/3ca478752da3d8da77470f7b28680e81.png)
2. 在 AI 误报处理页面，查看添加的误报记录，或单击**手动添加**，填写相关参数，单击**添加**将误报添加到误报列表中。
...
![](https://qcloudimg.tencent-cloud.cn/raw/2a3954b02a1a17b0947da9d196e98e74.png)

#### 步骤4：添加漏报
当攻击的载荷被 AI 引擎漏报时，单击 **AI 漏报处理**，将该漏报信息添加到漏报列表。
下面以参数名称为“a”，参数值为“admin^*$”为例进行说明。
![](https://qcloudimg.tencent-cloud.cn/raw/d3d79c1c34c0a016432fe02247560d93.png)
 
#### 步骤5：AI 漏报处理
1. 在 AI 引擎页面的 AI 漏报处理模块，单击**前往添加**。
![](https://qcloudimg.tencent-cloud.cn/raw/dbea792473daaf799403898d4d064049.png)
2. 在 AI 漏报处理页面，可查看添加的漏报记录，或单击**手动添加**，填写相关参数，单击**添加**将漏报添加到漏报列表中。
...
![](https://qcloudimg.tencent-cloud.cn/raw/cd8101b5455b65ab1119f9e95fc72e19.png)
...
- 当确认提交的误报或漏报有误时，可在 **AI 误报处理**或 **AI 漏报处理**页面勾选有误的记录，单击**删除**，经过二次确认后，即可删除。
