...
>!
>- 支持云上业务带宽扩展增加腾讯云内（弹性 QPS 值/40）Mbps，腾讯云外（弹性 QPS 值/120）Mbps。（上限值是指开启弹性计费的 QPS 值。）
...
<li>云上业务带宽扩展增加对应开启的带宽为：腾讯云内（弹性 QPS 值/40）Mbps，腾讯云外（弹性 QPS 值/120）Mbps。说明：上限值是指开启弹性计费的 QPS 值。</li>
</td>
<td>0.2元/QPS/天</td>
</tr>
</tbody></table>
...
>- BOT 流量管理默认仅支持 2500QPS。如有更大的 QPS 检出需求，请购买 [BOT 业务扩展包](#botq) 。
>
