...
当前 Web 应用防火墙提供两种产品形态，**SaaS 型 WAF**和**负载均衡型 WAF**，两种 WAF 计费项目、计费模式和价格相同，您可以根据不同接入方式选择购买不同类型的 Web 应用防火墙。
...
<td >9880</td>
<td >28800</td>
<td >预付费，默认套餐付费方式<br>海外属于后付费</td>
 </tr>
 <tr >
<td>适用场景</td>
<td >适用于中小型非业务网站的标准防护</td>
...
<td >3</td>
<td >4</td>
<td rowspan="2">不同的一级域名分配的 VIP 不一样，回源的 IP 也不同</td>
 </tr>
 <tr >
<td >支持二级域名个数</td>
<td>20</td>
...
<td>3</td>
<td>4</td>
<td rowspan="2" >不同的一级域名分配的 VIP 不同，回源的 IP 也不同</td>
 </tr>
 <tr>
<td>支持二级域名个数</td>
<td>20</td>
