...
WAF 的 VIP 默认具备 DDoS 基础防护能力（防护能力为2G），如果在 DDoS 基础防护中发生封堵，急需恢复业务请购买 [DDoS 高防包](https://console.cloud.tencent.com/ddos/ddos-pro/protection-config) 实并绑定 WAF 的 VIP 地址。
