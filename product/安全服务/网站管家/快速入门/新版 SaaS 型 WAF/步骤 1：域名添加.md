...
**字段说明**
 ...
 5. 完成配置后，可在域名列表看到刚刚添加的域名。当前界面显示未配置 CNAME 记录，需要 [本地验证测试](https://cloud.tencent.com/document/product/627/65712) 后，再 [修改 DNS 解析](https://cloud.tencent.com/document/product/627/65721)。
...
## 后续步骤
当您添加完域名后，可执行如下步骤：
- [步骤 2：本地测试](https://cloud.tencent.com/document/product/627/65712)
