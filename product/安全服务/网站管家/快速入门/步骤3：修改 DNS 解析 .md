为了使公网用户访问网站的流量经过网站管家 WAF 的防护，需要修改 DNS 的解析记录。下面以在腾讯云【云解析】上修改测试站点 waf.qcloudwaf.com 的 DNS 解析为例，说明配置步骤。
1. 登录 [腾讯云控制台](https://console.cloud.tencent.com/)，选择【云产品】>【域名与网站】>【云解析】，在 “我的域名” 列表中，选择需要接入网站管家 WAF 的域名 qcloudwaf.com ，单击【解析】进入解析配置界面。
...
2. 单击【添加记录】。
 ...
 在当前配置页面中：
 1. 主机记录填写对应网站的主机记录，本例中需要防护的是 waf.qcloudwaf.com，即填写 waf 。
 ...
 3. 记录值填写网站管家 WAF 分配的 CNAME 域名 ```***************bd4e69fd3c8a187.qcloudcjgj.com ```。
...
3. 修改完成之后，待 DNS 记录生效，网站管家 WAF 即可对访问网站的流量进行防护了。同时，网站管家 WAF 检测到被防护域名解析正常之后，控制台上将提示 “正常防护”。
