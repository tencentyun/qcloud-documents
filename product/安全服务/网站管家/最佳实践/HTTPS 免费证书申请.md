...
## HTTPS 证书关联操作步骤
1. 登录 [Web 应用防火墙控制台](https://console.cloud.tencent.com/guanjia/tea-instance-new)，在左侧导航中，选择**资产中心** > **实例管理**。
2. 在实例管理页面，单击所属实例右侧的**管理域名**。
![](https://qcloudimg.tencent-cloud.cn/raw/f2868a20262f8ad9b89c0815461eca79.png)
