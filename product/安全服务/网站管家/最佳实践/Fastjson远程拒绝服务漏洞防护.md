...
## 漏洞详情
近日，[腾讯云安全中心](https://console.cloud.tencent.com/ssa) 监测到开源 JSON 解析库 Fastjson 1.2.60 以下版本存在字符串解析异常，攻击者可利用该漏洞，将精心构造的恶意请求包，发送至使用到 Fastjson 的服务器，耗尽服务器内存及 CPU 等资源，导致服务不可用。目前该漏洞相关利用代码已被公开，建议尽快升级处理。
