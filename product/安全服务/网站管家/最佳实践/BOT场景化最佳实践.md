...
3. 在 BOT 管理的的 BOT 防护页面，单击**新建场景**。
4. 在新建场景弹窗中，配置相关参数，单击**立即创建**。
>!选中秒杀、登录和爬文案/爬内容中的任意一个场景与自定义场景互斥。
>
![](https://qcloudimg.tencent-cloud.cn/raw/adb58b52f00cd2648b22c5bd26a8a1d7.png)
**参数说明：**
...
>?本功能**不支持 CLB-WAF，泛域名，App/小程序**，只适用于 Web 或 H5页面，如果有非动态认证，自动化接口脚本需要优先加入白名单。
...
![](https://qcloudimg.tencent-cloud.cn/raw/5a9a6b718ed9969459e5d0cbfe3523d5.png)
### 案例一：大量机器自动化脚本请求服务
