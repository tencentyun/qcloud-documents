...
- 1.1.15  -1.1.31升级至 1.1.31.sec07 版本，1.1.31.sec06 发布后，发现1.1.31版本特有的一个问题，又发布了 1.1.31.sec07 版本。
- 1.1.32 - 1.1.33升级至 1.1.33.sec06 版本。
- 1.1.34升级至 1.1.34.sec06 版本。
- 1.1.35 - 1.1.46升级至 1.1.46.sec06 版本。
- 1.2.3 - 1.2.7升级至 1.2.7.sec06 版本，因为1.2.7使用最多特别提供，也可以直接使用 1.2.8.sec04 版本。
- 1.2.8升级至 1.2.8.sec06 版本。
- 1.2.9 - 1.2.29升级至 1.2.29.sec06 版本。
