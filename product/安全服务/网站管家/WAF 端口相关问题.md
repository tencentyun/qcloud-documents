...
1. 登录 [Web 应用防火墙控制台](https://console.cloud.tencent.com/guanjia/waf/config) ，在左侧导航中选择【Web 应用防火墙】>【防护设置】，进入防护设置页面。
2. 在防护设置页面，单击【添加域名】，进入添加域名页面。
3. 在添加域名页面的“服务器配置”中，选择对应的协议查看端口支持情况，一个域名最多可配置5个端口。
