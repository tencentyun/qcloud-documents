...
| 描述                  | 对应的 API 接口          |
| --------------------- | ------------------------ |
| name/cdcs:GetService   | [GET Service](https://cloud.tencent.com/document/product/1232/44718)              |
| name/cdcs:GetCoffer    | [GET Coffer ](https://cloud.tencent.com/document/product/1232/44719)（List Object） |
| name/cdcs:PutCoffer    | [PUT Coffer ](https://cloud.tencent.com/document/product/1232/44720)              |
| name/cdcs:DeleteCoffer | [DELETE Coffer ](https://cloud.tencent.com/document/product/1232/44721)           |

#### 对象操作

| 描述                  | 对应的 API 接口 |
| --------------------- | --------------- |
| name/cdcs:GetObject    | [GET Object](https://cloud.tencent.com/document/product/1232/44722)      |
| name/cdcs:PutObject    | [PUT Object ](https://cloud.tencent.com/document/product/1232/44723)     |
| name/cdcs:CheckObject   | [HEAD Object](https://cloud.tencent.com/document/product/1232/44724)     |

#### 生命周期管理

| 描述                  | 对应的 API 接口 |
| --------------------- | --------------- |
| name/cdcs:PutCofferLifecycle    | [PUT Coffer Lifecycle](https://cloud.tencent.com/document/product/1232/44732)    |
| name/cdcs:GetCofferLifecycle    | [Get Coffer Lifecycle](https://cloud.tencent.com/document/product/1232/44790)   |

#### 访问策略

| 描述                  | 对应的 API 接口 |
| --------------------- | --------------- |
| name/cdcs:GetCofferPolicy    | [GET Coffer Policy](https://cloud.tencent.com/document/product/1232/44735)  |
| name/cdcs:PutCofferPolicy    | [PUT Coffer Policy ](https://cloud.tencent.com/document/product/1232/44736)|
|name/cdcs:DeleteCofferPolicy|[DELETE Coffer Policy](https://cloud.tencent.com/document/product/1232/44734)|

#### 分片上传

| 描述                  | 对应的 API 接口 |
| --------------------- | --------------- |
| name/cdcs:InitiateMultipartUpload    | [Initiate Multipart Upload](https://cloud.tencent.com/document/product/1232/44677)  |
| name/cdcs:UploadPart   | [Upload Part](https://cloud.tencent.com/document/product/1232/44742) |
|name/cdcs:ListParts|[List Parts](https://cloud.tencent.com/document/product/1232/44741)|
|name/cdcs:CompleteMultipartUpload|[Complete Multipart Upload](https://cloud.tencent.com/document/product/1232/44739) |
|name/cdcs:AbortMultipartUpload|[Abort Multipart Upload](https://cloud.tencent.com/document/product/1232/44738)|
|name/cdcs:ListMultipartUploads|[List Multipart Uploads](https://cloud.tencent.com/document/product/1232/44740) |
...
service_type |描述产品简称，如 cdcs。|是
 account |描述资源拥有者的主账号信息。目前支持两种方式描述的资源拥有者。<br>一种方式是 uin 方式，即主账号的 qq 号，表示为 `uin/${OwnerUin}`，如 uin/100000000001。<br>另外一种方式是 uid 方式，即主账号的 APPID，表示为 `uid/${appid}`，如 uid/1250000000。目前 数据保险箱 的资源拥有者统一使用 uid 的方式表述，即主账号的开发商 AppID。|是
resource |描述具体资源详情，在 数据保险箱 服务中使用 XML API 访问路径来描述。|是
