...
| 描述                  | 对应的 API 接口 |
| --------------------- | --------------- |
| name/数据保险箱:GetObject    | [GET Object](https://cloud.tencent.com/document/product/1232/44722)      |
| name/数据保险箱:PutObject    | [PUT Object ](https://cloud.tencent.com/document/product/1232/44723)     |
| name/数据保险箱:CheckObject   | [HEAD Object](https://cloud.tencent.com/document/product/1232/44724)     |
...
region |描述地域信息，可参阅腾讯云数据保险箱支持的 [可用地域](https://cloud.tencent.com/document/product/1232/44641)。|是
...
```json
"resource": ["qcs::cdcs:ap-tianjin:uid/1250000000:examplecoffer-1250000000/*"]
```
下面是指定保险箱 examplecoffer-1250000000 中的 exampleobject 对象的示例。

```json
"resource": ["qcs::cdcs:ap-tianjin:uid/1250000000:examplecoffer-1250000000/exampleobject"]
```
