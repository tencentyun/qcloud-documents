...
| ------------------------------ | ---------------------- | --------------------------------- | --------- | -------- |
| LifecycleConfiguration         | 无                                                           |是       |Container |  生命周期配置。                                                 | 
| Rule                           | LifecycleConfiguration       | 是       |Container | 规则描述。 | 
| Expiration                     | LifecycleConfiguration.Rule             |  否       |Container |规则过期属性。     | 
| Days                           | Expiration      | 否       | Integer   | 指明对象在上传后多少天删除：该字段有效值为正整数，最大支持3650天。 |
