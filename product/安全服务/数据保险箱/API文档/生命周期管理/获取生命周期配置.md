## 功能描述
GET Coffer lifecycle 用于查询 Coffer 的生命周期配置。如果该 Coffer 没有配置生命周期规则会返回`NoSuchLifecycleConfiguration`。
...
#### 响应体
响应体中各个元素的内容及含义与 [PUT Coffer lifecycle](https://cloud.tencent.com/document/product/1232/44732) 时的请求体一致。详情请参见 [创建生命周期](https://cloud.tencent.com/document/product/1232/44732) 文档中的请求体节点描述内容。
