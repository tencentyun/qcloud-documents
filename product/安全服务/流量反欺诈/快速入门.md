...
### 第4步：API 接入
您可以根据实际情况按照 API 说明编写代码，接入流量反欺诈服务，**详情见 [流量反欺诈 API 文档]()。** 

### 第5步：查询调用数据
成功接入流量反欺诈服务后，可进入 [流量反欺诈控制台 404](http://console.cloud.tencent.com/taf)，选择服务监控，即可查询到对应服务的调用数据，以此进行判断企业产品的健康情况。