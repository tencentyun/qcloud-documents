...
>?
>- 出于安全因素，OAuth 协议不推荐使用此模式，请优先选择使用[ PKCE 授权码模式](https://cloud.tencent.com/document/product/1441/64348)。
...
```
>?应用回调地址拿到 `code` 参数后，需要调用  [ 普通授权码模式获取 Token ](https://cloud.tencent.com/document/product/1441/64398) 接口获取 Access Token 和 ID Token，完成登录。
>
