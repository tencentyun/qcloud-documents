...
5. 在基本信息页面，会自动生成 Client ID、Client Secret、Token、User URL 和 Group URL 等信息，请根据 [调用方式](https://cloud.tencent.com/document/product/1441/62152) 的说明将以上参数配置到您的客户端程序中进行调用。
