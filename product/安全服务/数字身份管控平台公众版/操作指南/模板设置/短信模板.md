## 操作场景
数字身份管控平台（公众版）默认为每个租户提供50条免费短信，超出免费额度后，平台将暂停为租户发送短信，控制台测试短信、门户短信 OTP 认证源登录、MFA 二次认证都会受影响。为了确保业务的正常使用，管理员需要通过配置短信模板，为平台业务发送短信提供服务。

## 配置短信模板
1. 登录 [数字身份管控平台（公众版）控制台](https://console.cloud.tencent.com/ciam)，在左侧导航栏，单击**个性化设置** > **模板设置** > **短信模板**。
2. 在短信模板页面，如果当前租户未配置短信模板时，系统默认显示如下空白模板信息，立即测试短信服务功能不可用。
![](https://qcloudimg.tencent-cloud.cn/raw/b0542c112345dde296b53c611cd7f665.png)
...
#### 获取短信模板 ID
1. 登录[ 短信服务控制台](https://console.cloud.tencent.com/smsv2)，在左侧导航栏，选择**国内短信** > **正文模板管理**，进入正文模板管理页面。
...
用户可对短信服务的有效性和正确性进行测试，测试过程如下所示。
 1. 在短信模版配置编辑页面，单击**点击立即测试短信服务**，则会弹出测试窗口。
![](https://qcloudimg.tencent-cloud.cn/raw/4ccd8d538e92dcb359e0e84436ece630.png)
 ...
 3. 也可以在短信模版配置保存之后，在短信模版查看页面，单击**点击立即测试短信服务**，可以验证配置的正确性。
![](https://qcloudimg.tencent-cloud.cn/raw/7834b31ef0e24db9da14d8241489d73a.png)
