...
![](https://qcloudimg.tencent-cloud.cn/raw/66996134b549537090c3d2d45c8aaa0c.jpg)
...
## 其他
 CIAM 还支持微信登录、支付宝登录、用户数据同步、忘记用户名、忘记密码等丰富的功能，可以 基于本文的内容并结合 [操作指南](https://cloud.tencent.com/document/product/1441/62405)做进一步探索实践。
