异常进程是基于自适应学习技术，通过系统规则和用户自定义检测规则，实时监控进程异常启动行为，并实时告警通知或拦截。异常进程包含事件列表和规则配置两大模块。事件列表展示了进程检测结果。规则配置展示模块中提供配置规则列表。
...
![](https://main.qcloudimg.com/raw/b0698c599411ff3217f4f2b7500742de.png)
