...
<tr>
<td>Cache-Tag</td>
<td>匹配 HTTP 应答包中 <code>Cache-Tag</code> 响应头内的标签（tags）清除缓存，例如 <code>Cache-Tag: tag1,tag2,tag3</code>。<br>- 仅支持企业版套餐<br>- EdgeOne 支持识别的源站响应头为 <code>Cache-Tag</code>，请添加 tag(s) 至此头部：<br> - 头部大小最大为 6KB；<br> - 不同 tag 用“,”分隔，单个 tag 不超过128字符，一共可包含1,000个不同的tag；<br> - tag忽略大小写，即 Tag1 和 tag1 是相同的 tag <br> - 若您已使用其他厂商的此功能且头部名称为 <code>Edge-Cache-Tag</code>，EdgeOne 会自动兼容识别 <code>Edge-Cache-Tag</code> 头部，无需您改造源站修改头部。但若源站同时响应 <code>Cache-Tag</code> 头部，则以 <code>Cache-Tag</code> 为准。</td>
</tr>
<tr>
<td>全部缓存</td>
