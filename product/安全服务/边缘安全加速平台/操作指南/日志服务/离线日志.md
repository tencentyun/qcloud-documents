...
> - 离线日志从各 EdgeOne 节点收集而来，因此延迟上各有差异，一般情况下延迟30分钟左右后日志包可查询、下载日志包，日志包会不断追加，一般24小时左右趋于稳定。
...
<td>ClientRegion</td>
<td>Sting</td>
<td>客户端 IP 解析出来的国家/地域。格式标准：ISO-3166-2</td>
</tr>
<tr>
<td>RequestTime</td>
<td>int</td>
<td>客户端请求时间，时区：UTC +00:00，格式标准：ISO-8601</td>
</tr>
<tr>
<td>RequestStatus</td>
<td>int</td>
...
<td>RequestBytes</td>
<td>int</td>
<td>客户端请求的大小（包含文件本身大小及请求 header 头部大小，单位：byte）</td>
</tr>
<tr>
<td>RequestMethod</td>
<td>String</td>
...
<td>String</td>
<td>客户端请求的应用层协议：HTTP, HTTPS, HTTP/3, WebSocket</td>
</tr>
<tr>
<td>RemotePort</td>
<td>int</td>
...
<td>String</td>
<td>客户端请求是否命中节点缓存：HIT（资源由节点缓存提供），MISS（资源可缓存，但由源站提供），Dynamic（资源无法被缓存）</td>
</tr>
<tr>
...
<td>EdgeServerIP</td>
<td>String</td>
<td>DNS 解析 Host 的 EdgeOne 服务器 IP 地址</td>
</tr>
<tr>
<td>EdgeServerID</td>
<td>String</td>
<td>提供服务的 EdgeOne 服务器唯一标识</td>
</tr>
<tr>
...
<td>String</td>
<td>建连时间；使用 ISO-8601 规范，默认UTC +0 时区</td>
</tr>
<tr>
<td>DisconnetTimeStamp</td>
<td>String</td>
<td>断连时间；使用 ISO-8601 规范，默认UTC +0 时区</td>
</tr>
<tr>
...
<td>ClientRegion</td>
<td>String</td>
<td>客户端所在国家/地域2位字母编码，符合 iso-3166-2 规范</td>
</tr>
<tr>
<td>EdgeIP</td>
<td>String</td>
<td>到达的 EO 边缘节点 IP</td>
</tr>
<tr>
...
<td>SentBytes</td>
<td>Int</td>
<td>本条日志持续期间产生的入流量字节数</td>
</tr>
<tr>
<td>ReceivedBytes</td>
<td>Int</td>
<td>本条日志持续期间产生的出流量字节数</td>
</tr>
<tr>
<td>LogTimeStamp</td>
<td>Int or String</td>
<td>日志生成时间；使用ISO-8601 规范，默认UTC +0 时区</td>
</tr>
</tbody></table>
