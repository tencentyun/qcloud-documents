...
**参数说明**    
  ...
  - 目标域名：本示例选择的是`target.qcdntest.cn`。
...
![](https://qcloudimg.tencent-cloud.cn/raw/abca2722e2959fe673a3d398ecba9ad1.png)
3. 单击**保存**添加成功后，EdgeOne 会自动完成检测并将别称域名的状态调整为**已生效**。
...
1. 在 [别称域名列表页](https://console.cloud.tencent.com/edgeone/alias-domain) ，单击**编辑**，选择**申请免费证**，单击**确定**即可为别称域名申请和部署免费证书。 
<img src="https://qcloudimg.tencent-cloud.cn/raw/7e244d54623ddf2ea97bd1e4d980609d.png" width=978px>
2. 申请免费证书成功后，选择目标别称域名，单击**别称域名 HTTPS**，查看已部署证书的相关信息：
...
2. 验证别称域名。      
   获取目标域名请起结果后，对别称域名发起浏览器访问和的 Curl 请求验证两者是否一致：
