#### 设定场景
假设您的同一个业务需要用到大量不同一级域名做推广，或者有大量不同的业务域名作为备用，当某个域名不能提供服务时（如境内域名未备案），您期望不影响到业务的正常运行，别称域名功能可快速满足您的业务诉求。
...
![image](https://user-images.githubusercontent.com/114125357/209667508-573a7a96-94ba-4667-8660-3178ad9ca770.png)
