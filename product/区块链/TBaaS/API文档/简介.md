...
- 最终接口采用腾讯云通用的云 API 模式，详情参照：[**云 API 介绍页**](https://cloud.tencent.com/product/api#wiki)；
- 请求结构可参考文档：[**请求结构简介**](https://cloud.tencent.com/document/api/213/6975)；
- 推荐使用 SDK 快速接入的方式；
- 目前提供 PHP、Python、Java、.Net、Node.js 等语言，并提供更多语言的的签名工具，详情请参照 [**Github**](https://github.com/QcloudApi)。
