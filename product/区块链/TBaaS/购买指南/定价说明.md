腾讯云 TBaaS 提供了在云中的一键式部署的区块链网络资源，允许您挑选多种节点配置来部署您的 TBaaS 实例。您还可以随着业务量的变化动态添加组织、节点、扩容存储空间以及升级节点配置等调整您的 TBaaS 规格。
...
>?在 TBaaS 中，公有云和金融云分别提供三种配置的云服务器，每种配置云服务器价格请参考购买页面。
  - 公有云
    - 4核8GB，系统盘50GB
    - 8核16GB，系统盘50GB
    - 16核32GB，系统盘50GB
