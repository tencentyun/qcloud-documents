...
目前，用户侧应用系统可以通过如下两种方式与 TBaaS 上的区块链进行对接。
...
调用方式：在页面上输入 API 密钥以及 [Tbass API（链接为TbaaS API的最新链接）](https://cloud.tencent.com/document/product/663/19457) 的必要参数。
...
#### 腾讯云命令行工具
通过 [腾讯云命令行工具（Tencent Cloud CLI 3.0）](https://cloud.tencent.com/document/product/440/6176)，您可以快速轻松的调用腾讯云 API 来管理您的腾讯云资源。还可以基于腾讯云的命令行工具来做自动化和脚本处理，能够获得更多种的方式来进行组合和重用。
最新的 CLI 3.0 已集成最新版本的 [Tbaas API 3.0（链接为TbaaS API的最新链接）](https://cloud.tencent.com/document/product/663/19457)。
