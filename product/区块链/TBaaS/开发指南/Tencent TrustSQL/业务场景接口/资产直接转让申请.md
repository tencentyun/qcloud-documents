...
<table>
	...
	<tr>
	<td>fee_uid</td>	<td>String</td>	<td>否</td>	<td>1 ≤ length ≤ 64</td>
	<td>资产收费账户 UID。</td>
	</tr>
	<tr>
	...
	<tr>
	<td>fee_account_pubkey</td>	<td>String</td>	<td>否</td>	<td>0 ≤ length ≤ 64</td>
	<td>手续费转入账户公钥。</td>
	</tr>
	<tr>
	...
	<tr>
	<td>src_asset_list</td>	<td>String</td>	<td>是</td>	<td>0 ≤ length ≤ 1024</td>
	<td>待转让的资源持有方拥有的资产 ID 列表。</td>
	</tr>
	<tr>
	...
	<tr>
	<td>fee_amount</td>	<td>int64</td>	<td>否</td>	<td>value ≥ 0</td>
	<td>手续费份额。</td>
	</tr>
	<tr>
...
```
{
	"mch_sign": "MEQCIAGPeCzmK3zabQAXl6YsbH0g55nCaXlj2IEhCktCUtzVAiB6Y4LVhAVwA5UgZYmtLhE5gWqIS5txmt5WkUH2pL/4zg==",
	...
	"amount": "4308",
	"sign_type": "ECDSA",
	"src_asset_list": "26aBk2Zv5qCiRNX297fSBQbRBZb3fYdPN2KmpPqStqdY4Jf",
...
```
{
	...
	"sign_type": "ECDSA",
	"mch_id": "trust_mch",
	"mch_sign": "MEYCIQCirPZWE31l1yfPdZ/VqDwnNzkXwZzWtfQ8Pg5yFwrI+wIhAOjUmEY62WopLEt8bgp8DnDqmew/h5w1PskjFVLArQ+j",
	"chain_id": "chain_id",
	"retcode": 0,
	"retmsg": "SUCCESS",
	"transaction_id": "201812290005782265",
	"sign_str_list": [
		{
			"id": 1,
			"account": "1LpqkE1FrCrumjV4aLLn4kL5P5NbyZ1PYD",
			"sign_str": "797f1cee8eb5b86a6214aad8f3c90f6b55a67161201c7047ae9178e838b314c7"
		}
	],
	"left_asset_id": "29CXPq4LQBEvsqbHsYSgVD73GPwDpZQ6WcMkD5cFk8jdAeo",
	"dst_asset_id": "26aRqfJCXJ6SiJ9FecaNeKKzFiuGy5vfxTx88h7a7VmDUdZ",
