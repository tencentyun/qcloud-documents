...
<table>
	...
	<td>交易状态。当前支持：<br>2：本地已申请。4：已提交。<br>转让签收场景下：<br>6：已签收。7：已拒签。8：已撤销。</td>
	</tr>
	<tr>
	<td>page_limit</td>	<td>int32</td>	<td>是</td>	<td>0 ≤ length ≤ 20</td>
	<td>查询条数。</td>
	</tr>
	<tr>
...
<table>
	...
	<tr>
	<td>trans_list.dst_account</td>	<td>String</td>	<td>否</td>	<td></td>
	<td>资产转入账户。</td>
	</tr>
	<tr>
