...
<div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=mrs&Version=2020-09-10&Action=ImageToClass" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn" target="_blank"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
以下请求参数列表仅列出了接口请求参数和部分公共参数，完整公共参数列表见 [公共请求参数](https://tcloud-dev.oa.com/document/product/1428/15692?!preview&preview_docmenu=1&lang=cn&!document=1)。

| 参数名称        | 必选 | 类型                                                         | 描述                                                         |
| :-------------- | :--- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| Action          | 是   | String                                                       | 公共参数，本接口取值：ImageToClass。                         |
| Version         | 是   | String                                                       | 公共参数，本接口取值：2020-09-10。                           |
| Region          | 是   | String                                                       | 公共参数，详见产品支持的 [地域列表](https://tcloud-dev.oa.com/document/product/1428/15692?!preview&preview_docmenu=1&lang=cn&!document=1#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8)，本接口仅支持其中的: ap-shanghai |
| ImageInfoList.N | 是   | Array of [ImageInfo](https://tcloud-dev.oa.com/document/product/1428/46912?!preview&preview_docmenu=1&lang=cn&!document=1#ImageInfo) | 图片列表                                                     |
| HandleParam     | 是   | [HandleParam](https://tcloud-dev.oa.com/document/product/1428/46912?!preview&preview_docmenu=1&lang=cn&!document=1#HandleParam) | 图片处理参数                                                 |
| Type            | 是   | Integer                                                      | 图片类型                                                     |
...
| 参数名称     | 类型                                                         | 描述                                                         |
| :----------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| TextTypeList | Array of [TextType](https://tcloud-dev.oa.com/document/product/1428/46912?!preview&preview_docmenu=1&lang=cn&!document=1#TextType) | 分类结果 注意：此字段可能返回 null，表示取不到有效值。       |
...
{
    "Response": {
        "RequestId": "c81f47bc-d54b-4eed-8bb0-2f0fd0503063",
        "TextTypeList": [
            {
                "Id": 12,
                "Level": 1,
...
以下仅列出了接口业务逻辑相关的错误码，其他错误码详见 [公共错误码](https://tcloud-dev.oa.com/document/product/1428/15694?!preview&preview_docmenu=1&lang=cn&!document=1#.E5.85.AC.E5.85.B1.E9.94.99.E8.AF.AF.E7.A0.81)。
