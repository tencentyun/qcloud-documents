...
| 参数名称  | 类型                                                         | 描述                                                         |
| :-------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| Template  | [Template](https://tcloud-dev.oa.com/document/product/1428/46912?!preview&preview_docmenu=1&lang=cn&!document=1#Template) | 报告结构化结果                                               |
...
&Text=检查所见：前列腺大小正常,两侧叶对称,包膜光整,实质内回声均匀,在实质内见一个囊性暗区,大小约0.8*0.7cm,后方增强,彩色多普勒血流检查未见异常血流。检查结论：前列腺囊肿&Type=0&BusinessId=10005&IsUsedClassify=true
&<公共请求参数>
:::
</dx-codeblock>
...
{
    "Response": {
        "RequestId": "8b581ce1-1705-4d7a-ad5e-481f3f53c84d",
        "Template": {
            "PatientInfo": {
                "Name": "",
                "Sex": "",
            ...
            "Check": {
                "Desc": {
                    "Text": "前列腺大小正常,两侧叶对称,包膜光整,实质内回声均匀,在实质内见一个囊性暗区,大小约0.8*0.7CM,后方增强,彩色多普勒血流检查未见异常血流。",
                    "TuberInfos": [
                        {
                            "Part": {
                                "Desc": "部位",
