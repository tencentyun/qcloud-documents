...
| Type            | 是   | Integer                                                      | 图片类别，目前支持11（检验报告），12（检查报告），15（病理报告），212（手术记录），218（诊断证明）。如果不清楚图片类型，可以使用分类引擎，该字段传 0 （同时 IsUsedClassify字段必须为 True，否则无法输出结果）                                                     |
...
{
    "Response": {
        "RequestId": "62b0783c-c0ba-47c7-9273-7b0589384612",
        "Template": {
            "PatientInfo": {
                "Name": "",
                "Sex": "女",
