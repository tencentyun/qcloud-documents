...
<table>
 <tr>
      <th width="12%" rowspan='2'>场景</td>
      <th width="12%" colspan="4">匹配条件</td>
       <th width="12%" rowspan='2'>典型会议案例</td>
       <th width="12%" rowspan='2'>匹配主要目的</td>
       <th width="12%" rowspan='2'>解决方案</td>
 </tr>
  <tr>
      <th width="12%" >参会人员类型（企业内外）</td>
      <th width="12%" >已有参会人员名单</td>
      <th width="12%" >可获得企业外参会者手机号</td>
       <th width="12%" >有 PSTN 参会需求</td>
 </tr>
 <tr>
      <td>场景1</td>
      <td>内部</td>
