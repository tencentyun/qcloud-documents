...
<td>signature</td>
<td>String</td>
<td>加密签名，signature 的计算结合了企业填的 token、timstamp、nonce、checkStr，签名计算方法请参考 [签名校验](https://tcloud-doc.isd.com/document/product/1095/51612)。</td>
</tr>
</tbody></table>
...
<td>signature</td>
<td>String</td>
<td>加密签名，signature 的计算结合了企业填的 token、timstamp、nonce、消息体，签名计算方法请参考签名校验。</td>
</tr>
</tbody></table>
