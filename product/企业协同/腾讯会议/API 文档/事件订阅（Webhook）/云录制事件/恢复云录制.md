...
**事件说明：**会议主持人或者联席主持人可在会议中开启云录制，企业管理员也可以设置自动会议录制，当云录制开启后被主持人或者联席主持人恢复之前暂停的云录制时，会触发该事件通知。

## 示例

```json
{
   "event":"recording.resumed", //事件名
   ...
   "payload":[      
       {
            ...
            "meeting_info":{//会议信息
                ...
                "meeting_type":0,// 会议类型(0-一次性会议，1-周期性会议，2-微信专属会议，4-rooms投屏会议)
