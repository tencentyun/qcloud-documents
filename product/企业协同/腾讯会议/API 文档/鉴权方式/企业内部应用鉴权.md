创建应用后即可获取应用凭证信息，具体可参见 [企业自建应用接入指引](https://cloud.tencent.com/document/product/1095/83662)。
...
|AppId | String|是 |腾讯会议分配给企业的企业ID。企业管理员可以登录 [腾讯会议官网](https://meeting.tencent.com/)，单击右上角**用户中心**，在左侧菜单栏中的**企业管理** > **高级** > **restApi** 中进行查看。 |
