## 腾讯会议网关接入场景
腾讯会议网关接入场景如下图所示：
![](https://main.qcloudimg.com/raw/9e36da9be063c8c8da2e2d8a85633a80.png)
...
### 第三方应用开发（OAuth2.0 授权）
1. OAuth2.0 允许应用程序访问腾讯会议 API 接口，在请求用户网页授权之前，开发者需要在 [第三方应用接入申请](https://cloud.tencent.com/apply/p/xf1vhv5lq79) 填写资料完成申请，审核通过后会通过邮件方式发送接入密钥。
