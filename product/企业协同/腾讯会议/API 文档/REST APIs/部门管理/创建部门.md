...
| parent_department_id | 否       | String       | 上级部 ID。                                               |
...
```plaintext
{
	"department_id": "a45edxxxxxxxxxxxxxxxxxx54c9eb537",
	"department_name": "test-子部门-03",
	"department_full_name": "test-高级部门-01/test-子部门-03",
	"is_main_department": false,
	"user_count": 0,
	"parent_department_id": "1519xxxxxxxxxxxxxxxxxxda464bf856"
}
