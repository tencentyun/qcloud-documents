...
```plaintext
GET
https://api.meeting.qq.com/v1/departments/e3ce085xxxxxxxxxxxxxxxxxx1fc2c2d?userid=meeting4548079
```
...
```plaintext
{
	"department_id": "a45edxxxxxxxxxxxxxxxxxxxc9eb537",
	"department_name": "test-子部门-03",
	"department_full_name": "test-主部门-01/test-子部门-03",
	"is_main_department": false,
	"user_count": 0,
	"parent_department_id": "1519a9xxxxxxxxxxxxxxxxxxx4bf856"
}
