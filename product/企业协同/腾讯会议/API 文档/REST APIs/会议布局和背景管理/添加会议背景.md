...
| 参数名称               | 必选 | 参数类型     | 参数描述           |
| ---------------------- | ---- | ------------ | ------------------ |
| background_number      | 是   | Integer      | 背景数量。         |
| selected_background_id | 是   | String       | 会议应用的背景 ID。 |
| background_list        | 是   | 背景对象数组 | 背景对象列表。     |
...
{
    "background_number":2,
    "selected_background_id":"f1fe9f3ae6e3e32752c7242848ca2d59",
    "background_list":[
        {
            "background_id":"ca4ea9f41fa2977261897f99e79f6e93",
            "image_md5":"c8c73a47a474da22d272c8605bc38a2e"
        },
        {
            "background_id":"f1fe9f3ae6e3e32752c7242848ca2d59",
            "image_md5":"c3da45b8df16d3ccd09225bfc70562a4"
        }
    ]
}
