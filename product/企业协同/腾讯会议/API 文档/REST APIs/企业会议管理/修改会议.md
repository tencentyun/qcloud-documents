...
|invitees|否 |UserObj 数组 |会议邀请的参会者，可为空。（企业内部请使用企业唯一用户标识；OAuth2.0 鉴权用户请使用 openId）。<br>注意：仅腾讯会议商业版和企业版可邀请参会者，邀请者列表仅支持300人；需要邀请超过300人的场景请调用 [设置会议邀请成员](https://cloud.tencent.com/document/product/1095/63659) 接口。|
