...
|hosts|否 |Array |会议主持人的用户 ID，如果没有指定，主持人将被设定为上文的 userid；如果有指定，主持人列表需包含 userId（企业用户为企业自定义账号；个人用户为用户名、手机号等；oauth2.0 鉴权用户为 openId）。 |
|invitees|否 |UserObj 数组 |邀请的参会者，可为空（企业用户为企业自定义账号；个人用户为用户名、手机号等；oauth2.0 鉴权用户为 openId）。|
