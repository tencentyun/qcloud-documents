...
|hosts| 否 |UserObj 数组 |会议主持人的用户 ID，如果没有指定，主持人被设定为参数 userid 的用户，即 API 调用者。|
...
| is_anonymous| 否 |String |用户是否匿名入会<br>true: 匿名<br> false: 不匿名。<br>缺省为 false，不匿名|
...
|participant_video | 否 |boolean |入会是参会者视频是否开启。|
