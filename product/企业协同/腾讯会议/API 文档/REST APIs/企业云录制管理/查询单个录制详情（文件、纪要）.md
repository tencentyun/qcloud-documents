...
| download_address | 否   | String   | 录制文件下载地址，默认6小时过期。OAuth 鉴权方式下，账号类型为个人免费版、企微创建企业时，该值返回为空。   |
...
| 参数名称         | 必选 | 参数类型 | 参数描述                        |
| ---------------- | ---- | -------- | ------------------------------- |
| download_address | 否   | String   | 会议纪要文件下载文件地址。OAuth 鉴权方式下，账号类型为个人免费版、企微创建企业时，该值返回为空。                    |
