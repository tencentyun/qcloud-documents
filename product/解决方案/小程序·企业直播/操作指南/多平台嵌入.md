...
- 跳转至特定直播间，点击下图红框的“获取更多页面路径”按钮；
![](https://main.qcloudimg.com/raw/1551bc7193f5860ebbea26c58a63c660.png)

- 点击下方输入某用户的微信号，点击“开启”按钮后，用户可进入某个直播间复制该直播间的页面路径；填入到【小程序路径】里即可。
 ![](https://main.qcloudimg.com/raw/ab12ce7cc8440277477fa9966a0f70c7.png)

-  完成以上步骤即可实现点击推送文章内的小程序直播间卡片，跳转至对应直播间。

- 公众号菜单直接添加小程序页面路径和参数，页面路径可选择首页或某个直播间等，若打开特定直播间，则参数需加入对应房间号 roomID（可通过欢句直播房间的分享按钮中查看）。
