...
>! 
>- 由于微信支付“支付后跳转指定页面”功能升级，开通“点金计划”的微信支付服务商配置广告图片、广告URL后无法生效，用户使用微信支付完成后将跳转至“点金计划”信息页面，支付宝支付该项配置不受影响。
...
>! 
>- 由于微信支付“支付后跳转指定页面”功能升级，开通“点金计划”的微信支付服务商配置支付完成页URL后无法生效，用户使用微信支付完成后将跳转至“点金计划”信息页面，支付宝支付该项配置不受影响。
