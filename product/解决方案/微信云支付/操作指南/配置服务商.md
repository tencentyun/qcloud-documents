...
| 支付完成页 URL | 一码支付完成后，顾客手机会跳转到该 URL 标识的页面 | 配置该 URL 会导致 [2.3](https://cloud.tencent.com/document/product/569/9796?!editLang=zh&!preview#2.3-.E9.85.8D.E7.BD.AE.E6.9C.8D.E5.8A.A1.E5.95.86.E5.9F.BA.E6.9C.AC.E4.BF.A1.E6.81.AF) 中配置的广告图片和广告 URL 无效 |
...
>?支付宝配置相关可以参见 [配置支付宝文档](https://cloud.tencent.com/document/product/569/12471)。
