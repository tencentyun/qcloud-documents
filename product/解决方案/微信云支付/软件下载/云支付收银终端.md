...
## 二、云支付收银台功能简介
    腾讯云官方提供了云支付收银台，可对接windows下的各类收银软件，且无需对收银软件做任何改造，可帮助商户快速接入微信支付等第三方支付，具体功能如下介绍，具体操作见云支付收银台操作手册。
...
### 4、插件模式支持和收银软件无缝对接
    收银完成后收银台支持发送键盘等消息模拟收银员点击收银软件上的完成收款动作。
