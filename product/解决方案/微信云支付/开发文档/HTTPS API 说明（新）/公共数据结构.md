...
<table class="tg">
  ...
  <tr>
      <td class="tg-s268">notify_url</td>
    <td class="tg-s268"></td>
    <td class="tg-s268">否</td>
    <td class="tg-s268">String(1024)</td>
		<td class="tg-s268">第三方支付平台回调 url（刷卡支付不需要该字段）</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<tr>
      <td class="tg-s268" rowspan="10">wxpay_order_content_ext*</td>
	...
	<tr>
      <td class="tg-s268">coupon_fee</td>
    <td class="tg-s268">否</td>
    <td class="tg-s268">	Number(32)		</td>
		<td class="tg-s268">代金券金额，等于支付总金额减现金支付金额</td>
  </tr>
	<tr>
      <td class="tg-s268">coupon_count</td>
    <td class="tg-s268">否</td>
    <td class="tg-s268">Number(32)	</td>
		<td class="tg-s268">代金券数量</td>
  </tr>
	<tr>
...
<table class="tg">
  ...
  <tr> 　   
	...
	<tr> 　  
      <td class="tg-s268">totcoupon_infosal_fee</td>
    <td class="tg-s268"></td>
    <td class="tg-s268">否</td>
    <td class="tg-s268">CouponInfo</td>
...
<table class="tg">
  ...
  <tr> 　    　  
	...
	<tr> 
      <td class="tg-s268" rowspan="7">wxpay_freeze_order_content_ext*</td>
    <td class="tg-s268">current_trade_state</td>
    <td class="tg-s268">是</td>
    <td class="tg-s268">Number(32)	</td>
...
machine_no|	否|	String(32)	|刷卡支付特有，每个收银终端的唯一码（刷卡支付必填）
