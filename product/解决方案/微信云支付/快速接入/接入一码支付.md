...
- 关注公众号收到消息通知后，添加通过云打印机打印小票，使用云打印机请咨询腾讯云官方客服；
...
## 交接班
- 订单汇总计算规则：依据店员上班打卡时间为开始，直至下班打卡结束，为一个店员的订单汇总；
- 若员工忘记上班打卡：则依据上一个店员下班打卡时间开始，直至店员下班打卡时间结束，依据这个时间段进行订单汇总；
- 若店员忘记下班打卡：则依据店员上班打卡开始，直至下一个店员上班打卡结束，依据这个时间段进行订单汇总；
- 汇总的订单可以通过云打印机打印出来。

 ![](https://mc.qcloudimg.com/static/img/06ecdedd6b281954a1406323377b3e67/image.png)
## 物料支持
