...
注册 并 登录 腾讯云账号，进入云直播控制台。
注册非个人主体类型的微信小程序，且主体为中国大陆地区主体
...
- 注册非个人主体类型的微信小程序，且主体为中国大陆地区主体。小程序符合小程序·云直播插件的接入的类目要求：
...
## 申请插件
>! 即日起至2020年8月31日，申请插件通过后立享免授权费试用1个月，[活动页](https://cloud.tencent.com/act/pro/xiaochengxu?from=12734)  下单可享额外优惠（试用期间流量费正常结算，最终上线以微信审核为准，建议发布成功后再下单购买）。
