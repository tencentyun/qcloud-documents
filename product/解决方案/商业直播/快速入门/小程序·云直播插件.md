...
## 第4步：小程序开发
下载 [微信开发者工具](https://mp.weixin.qq.com/debug/wxadoc/dev/devtools/download.html) ，在小程序项目中引用插件，插件使用及相关操作和开发，请参考 [小程序云直播插件集成](https://cloud.tencent.com/document/product/1078/34646)。

>! 可配合 IM 服务，实现聊天弹幕、商品推送、公告等功能。
...
**微信小程序所选类目需符合小程序的实际应用场景，否则在小程序提交审核时会有被驳回的风险。**
