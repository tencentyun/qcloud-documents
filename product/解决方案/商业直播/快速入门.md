>?内测名额已满，产品正在内部技术优化开发中，预计2020年第一季度完成升级对外接入，申请插件的小程序需满足电商平台类目要求不变。
...
在小程序后台的【设置】>【基本设置】>【服务类目】中，选择符合小程序功能的类目。**微信小程序所选>?内测名额已满，产品正在内部技术优化开发中，预计2020年第一季度完成升级对外接入，同时，申请插件的小程序需满足电商平台类目的要求不变。
...
- 方案二：若您的小程序已具备**电商平台**类目，可使用商业直播，类目认证需要提前准备《增值电信业务许可证》（简称 ICP）。
...
## 申请商务对接
针对上文方案二，若您的微信小程序已具备电商平台类目，可通过提交 [商业直播 PaaS 方案申请](https://cloud.tencent.com/apply/p/n6h3nx5f73)，申请商务对接。申请提交后，会有专人与您沟通方案和报价，请您留意来电。

**腾讯云账号和`bizname`不可修改和切换**。`bizname`用于生成商业直播指定域名，一般为品牌英文名，仅支持英文小写。例如，`bizname`为 tencent ，则推流域名为：`tencent.bizlivepush.myqcloud.com` 。

## 提交插件申请
商务对接完成，且申请审批通过后，在小程序后台选择【设置】>【第三方设置】>【插件管理】，添加商业直播插件并等待小程序后台审批。
...
类目需符合小程序的实际应用场景，否则在小程序审核时会有被驳回的风险。**
