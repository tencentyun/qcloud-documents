...
- 方案二：若您的小程序已具备**电商平台**类目，可使用商业直播方案，类目认证需要提前准备《增值电信业务许可证》（简称 ICP）。
...
> - 同时满足以上两种方案时，推荐您使用方案一接入商业直播。
> - 若您的小程序均不具备以上类目，请咨询我们的商务同事，或 [提交工单](https://console.cloud.tencent.com/workorder/category)。

## 申请商务对接
针对上文方案二，若您的微信小程序已具备电商平台类目，但不符合上述表格中的类目，可通过提交 [商业直播 PaaS 方案申请](https://cloud.tencent.com/apply/p/n6h3nx5f73)，申请商务对接。申请提交后，会有专人与您沟通方案和报价，请您留意来电。

**腾讯云账号和`bizname`不可修改和切换**。`bizname`用于生成商业直播服务指定域名，一般为品牌英文名，仅支持英文小写。例如，`bizname`为 tencent ，则推流域名为：`tencent.bizlivepush.myqcloud.com` 。

## 提交插件申请
商务对接完成，且申请审批通过后，在小程序后台选择【设置】>【第三方设置】>【插件管理】，添加对应方案的插件并等待小程序后台审批。
