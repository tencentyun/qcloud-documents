...
| [ModifyLiveDomainCertBindings](https://cloud.tencent.com/document/api/267/78655) | 批量绑定证书对应的播放域名 |
| [DescribeLiveDomainCertBindings](https://cloud.tencent.com/document/api/267/78656) | 查询绑定证书的域名列表     |
