...
>! 当通过云直播 API [创建录制任务](https://cloud.tencent.com/document/product/267/45983) 时，录制回调不会返回用户推流 URL 所带 [stream_param](https://yehe.woa.com/document/doc-cn/product-article/267/32739#message) 参数，其它录制方式会返回。
