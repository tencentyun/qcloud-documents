...
通过 [云直播控制台](https://cloud.tencent.com/document/product/267/20384) 或者 [API 调用](https://cloud.tencent.com/document/api/267/32614) 设置录制回调地址，录制文件生成后会以消息方式通知到该回调地址。在收到消息后可根据录制 [回调事件消息通知](https://cloud.tencent.com/document/product/267/32744) 进行业务处理。
