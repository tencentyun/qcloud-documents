...
<img src="https://main.qcloudimg.com/raw/6fbaebd6f0195609cff86c57f7e5de4f.png" width="750px"/>


| 费用组成  | 计费说明  | 付费方式  |
| ----------------- | ----------------- | ----------------- |
| [直播转录费用](https://cloud.tencent.com/document/product/1358/50262?!preview&!editLang=zh) | <li/>使用直播云端录制服务产生的费用，按照录制路数的月并发峰值计费。<li/>账单展示在云直播计费项中。 | 按月峰值路数 × 有效天系数 × 单价 |
