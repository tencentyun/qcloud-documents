...
- **编辑：已结束的课堂不支持编辑课堂信息。**
  - 方式一：选择【操作】>【编辑】，进入【课堂信息】页面，重新编辑课堂信息（操作同创建课堂）。
  - 方式二：单击【课堂名称】进入【课堂信息】页面。
- **查看详情：已结束的课堂不支持【查看详情】。**
 - 选择【操作】>【查看详情】，即可获取【课堂地址】。
 - 【课堂地址】主要包含机构码和课程 ID。管理员可以将地址分享给老师/学生，老师/学生在互动课堂桌面端/移动端/web 端输入地址，直接进入课堂。
