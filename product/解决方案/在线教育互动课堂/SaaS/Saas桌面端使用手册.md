...
### 桌面版配置
- Intel i7-6700 级别，鲁大师 CPU 跑分70000以上，6路视频时分辨率推荐1280\*720。
- Intel i5-7500 级别，鲁大师 CPU 跑分52000以上，6路视频时分辨率推荐960\*540。
- Intel i5-3330 级别，鲁大师 CPU 跑分42000以上，6路视频时分辨率推荐320\*240。

>?影响性能的原因较多，以上提供的配置仅供参考。如果遇到绘制白板卡顿的情况，可以在约课时设置较低点的分辨率。
