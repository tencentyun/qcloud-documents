...
腾讯云在线教育互动课堂（Tencent Interact Class，TIC）提供了集实时音视频、交互式白板涂鸦、IM 聊天室、PPT 课件共享、屏幕分享、录制回放等功能于一体的一站式在线教育互动课堂解决方案。
...
我们准备了完备的接入文档，保证您能快速集成并使用我们的服务，接入 TIC 总体只需要 2 步：
...
- **音视频互动**
  互动课堂解决方案支持老师和学生进行音视频互动操作，目前支持做多 10 路音视频同时在线。
...
- **课件共享**
  互动课堂解决方案提供文档转码服务，支持在白板中播放 PPT、PDF、word、Excel 文件（最大可支持 100 M）。
...
腾讯云 TIC 是针对教育行业的解决方案 主要包含实时音视频、云通信、白板、点播和 COS 等各产品，其中白板服务目前处于免费试用阶段（详情见[开通及配置腾讯云服务](/document/product/680/14782)），其他产品根据实际消耗结算，您可以通过 [腾讯云定价中心](https://buy.cloud.tencent.com/price) 查询各产品的具体计费详情。
