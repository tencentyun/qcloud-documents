...
1. 客户端基本功能介绍。具体请参考 [SaaS 功能介绍](https://cloud.tencent.com/document/product/680/37451)。
...
5. 直接使用腾讯云互动课堂 App 的客户，具体请参考 [SaaS 客户端应用方式接入](https://cloud.tencent.com/document/product/680/37458)。
6. 需要自行开发 App 的客户，具体请参考  [SaaS 客户端组件方式接入](https://cloud.tencent.com/document/product/680/37504)。
7. 可以使用云 API 完成控制台所有功能，具体请参考 [云 API](https://cloud.tencent.com/document/product/680/37540)。

正式接入前，请阅读 [开通指南](https://cloud.tencent.com/document/product/680/34356) 后，发送邮件申请开通服务。
...
4. 通过集成云 API，托管课堂数据到腾讯云，实现课堂管理功能。
 ...
 - [云 API](https://cloud.tencent.com/document/product/680/37540)
