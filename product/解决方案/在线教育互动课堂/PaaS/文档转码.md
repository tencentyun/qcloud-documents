...
```
请求URL：https://iclass.api.qcloud.com/transcode/v1/create?random=526919&sdkappid=1400127115&sign=d33bfea49d7f2795a4829c0d80047a7d
请求Header："Content-Type:application/json"
请求包体：
{
...
```
请求URL：https://iclass.api.qcloud.com/transcode/v1/query?random=526919&sdkappid=1400127115&sign=d33bfea49d7f2795a4829c0d80047a7d
请求Header："Content-Type:application/json"
请求包体：
{
    "expire_time":1557202745,
...
```
请求URL：https://iclass.api.qcloud.com/transcode/v1/callback?random=526919&sdkappid=1400127115&sign=d33bfea49d7f2795a4829c0d80047a7d
请求Header："Content-Type:application/json"
请求包体：
{
    "expire_time":1557202745,
