...
若您能还没开通课后录制服务，请按照[服务开通指南](../开通服务/服务开通指南.md)发送邮件申请开通，并在申请功能里保留`云端课后录制`，按照文档流程开启实时音视频云端录制以及提供App管理员UserId与UserSig
...
> 如果开启混流录制，录制结果就只有一个混流后的视频，混流的布局请参考[云端课后录制混流布局](../附录/云端课后录制混流布局.md)
