...
**增加白板页回调函数**
```
void onTEBAddBoard(String boardId, String fileId);
```
|  参数值  | 类型       | 说明 |
| -- | --------- | ------------------ |
...
**删除白板页回调函数**
```
void onTEBDeleteBoard(String boardId, String fileId);
```
|  参数值  | 类型       | 说明 |
| -- | --------- | ------------------ |
|   boardId| String  | 增加的白板页ID |
...
```
 | 参数	| 类型	|默认值 |说明 | 
 | --------- | --------- | --------- | --------- |
| ratio                   |  String   | 16:9 | 白板尺寸/比例<br> 传字符串宽高比，例如设置4:3，白板SDK会以参数id所在节点的宽高以4:3的方式来计算出白板的宽高 | 
