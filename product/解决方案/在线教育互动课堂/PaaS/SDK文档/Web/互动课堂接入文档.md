...
<!-- WebRTC SDK -->
<script src="https://sqimg.qq.com/expert_qq/webrtc/3.4.0/WebRTCAPI.min.js"></script>
<!-- WebIM SDK -->
...
<!-- TIC SDK -->
<script src="https://sqimg.qq.com/expert_qq/tedu/tic/2.2.0/TIC.min.js"></script>
```
...
webrtcOption | Integer | 是 | webrtcOption参数
