...
| ntpServer | NSString | time1.cloud.tencent | ntp服务器 |
| boardInitParam | TEduBoardInitParam | - | 白板初始化参数，具体定义请参考[白板文档](https://cloud.tencent.com/document/product/1137/39980#teduboardinitparam) |
| boardDelegate | id<TEduBoardDelegate> | - | 白板回调 |
| classScene | TICClassScene | TIC_CLASS_SCENE_VIDEO_CALL | |
| roleType | TICRoleType | - | 课堂角色 |
| compatSaas | BOOL | false | 是否兼容SaaS |
