...
| BoardSDK.CONSTANT.EVENT.COS.GET_SIGN_ERROR |  上传图片/PPT获取sig错误  |
| BoardSDK.CONSTANT.EVENT.COS.GET_SIGN_SUCCESS |  上传图片/PPT获取sig成功  |
| BoardSDK.CONSTANT.EVENT.COS.HASH_PROGRESS |  上传图片/PPT计算文件 MD5 值的进度回调函数  |
| BoardSDK.CONSTANT.EVENT.COS.PROGRESS |  上传图片/PPT的进度回调函数  |
