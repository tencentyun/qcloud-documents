...
- [对象存储](https://cloud.tencent.com/product/cos/gettingstarted)

## 二. 配置腾讯云服务
###  配置互动直播服务
请登录 [互动直播控制台](https://console.cloud.tencent.com/ilvb) 后，完成下面的配置。
#### 配置互动直播 App 基础信息
在互动直播控制台的 **APP基础设置** 页面，帐号体系集成选择集成自有帐号体系。
![](https://main.qcloudimg.com/raw/4fd5152b04c86fad42c926dbfb1baa6f.png)

####  配置互动直播 Spear 参数
在互动直播控制台的 **SPEAR引擎配置** 页面，配置Spear 参数。客户端在使用互动直播 SDK 时根据 Spear 配置设置分辨率、码率、权限位等信息。
![](https://main.qcloudimg.com/raw/f0dba39e36a19b27dfbcbd876db8205b.png)    

####  开通互动直播自动录制
在互动直播控制台的 **旁路直播配置** 页面，启用旁路直播的自动录制功能。
...
> 请 [提交互动直播服务的工单](https://console.cloud.tencent.com/workorder/category/create?level1_id=29&level2_id=37&source=0)，申请配置自动录制开通 media_start_time 回调字段。
