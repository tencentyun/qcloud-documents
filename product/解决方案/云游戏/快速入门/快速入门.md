...
![云游戏接入裁剪](https://main.qcloudimg.com/raw/87453f9d709d14c6ee77b47b57852f71.png)
**云游戏接入步骤如下：**

1. **业务集成（客户端接入）**：
   您的业务 APP（或客户端）需要集成云游戏 SDK，集成操作详情请参考 [SDK 文档](https://cloud.tencent.com/document/product/1162/46134)。
