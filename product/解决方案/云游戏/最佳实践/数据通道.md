...
![](https://qcloudimg.tencent-cloud.cn/raw/a996cf256cea5210f1e58853a0f975d8.png)
...
int main() {
    ...
    bind_addr.sin_port = htons(6626);// 绑定端口号
    ...
    while (true) {
        ...
        sendto(udp_socket_fd, response, strlen(response), 0, (struct sockaddr *) & upstream_addr, sizeof(dest_addr));
    }
    return 0;
}
```
