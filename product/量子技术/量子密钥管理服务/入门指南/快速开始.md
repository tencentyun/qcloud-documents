...
*  CiphertextBlob 即上一步通过控制台工具产生的证书密文，您也可以通过链接 [Demo 证书（密文）>>](http://jkmsdemo-1252462967.cosgz.myqcloud.com/demo_ciphertextblob.txt) 下载后再复制对应文本到代码中，Demo 压缩包中的 kms_start_demo.py 文件中已经为您替换好
...
2. 尝试更多的使用 KMS 提供能力去加密、解密文件，为您在实际业务中使用KMS 做准备。
