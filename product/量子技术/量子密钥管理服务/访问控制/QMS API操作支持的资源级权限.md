...
| kms::SetKeyAttributes | qcs::kms:$region:$account:key/creatorUin/$creatorUin/$keyid (授权单个资源）<br>qcs::kms:$region:$account:key/creatorUin/$creatorUin/* (授权某个创建者的所有资源）<br>qcs::kms:$region:$account:key/* (授权某个根帐号的所有资源) |    |    |
