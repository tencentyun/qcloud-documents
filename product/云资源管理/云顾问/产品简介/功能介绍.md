...
<table>
   ...
   <tr>
      <td>云服务器（CVM）</td>
      <td>云服务器（CVM）实例高负载</td>
      <td>检查 CVM 实例 CPU、内存使用率情况，若负载过高，则告警</td>
   </tr>
   <tr>
   ...
   <tr>
      <td>云数据库（MongoDB）WT引擎的QueueRead</td>
      <td>检查数据库（MongoDB）Read请求等待队列中的个数，如果个数大于50，则告警</td>
   </tr>
   <tr>
   ...
   <tr>
      <td>云数据库（MySQL）慢查询</td>
      <td>检查数据库（MySQL）实例慢查询情况</td>
   </tr>
   <tr>
      <td>云数据库（MySQL）运行线程数</td>
      <td>检查数据库（MySQL）实例运行线程数</td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td>云数据库（Redis）Proxy节点CPU使用率</td>
      <td>检查数据库（Redis）实例Proxy节点CPU使用率情况</td>
   </tr>
   <tr>
   ...
   <tr>
      <td>云数据库（Redis）节点执行错误数</td>
      <td>检查云数据库（Redis）节点执行错误数</td>
   </tr>
   <tr>
      <td>云数据库（TDSQL）</td>
