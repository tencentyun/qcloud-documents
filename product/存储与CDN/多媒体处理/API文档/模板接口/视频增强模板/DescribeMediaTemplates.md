...
| Tag                | Response.TemplateList | 模版类型，VideoProcess                                          | String    |
| UpdateTime         | Response.TemplateList | 更新时间                                                     | String    |
| CreateTime         | Response.TemplateList | 创建时间                                                     | String    |
| VideoProcess       | Response.TemplateList | 详细的模版参数                                                | Container |

Container节点VideoProcess的内容：

| 节点名称（关键字） | 父节点                         | 描述     | 类型      |
| :----------------- | :----------------------------- | :------- | :-------- |
| ColorEnhance       | Response.TemplateList.VideoProcess | 同精彩集锦模板 CreateMediaTemplate接口中的 Request.ColorEnhance | Container |
