...
| Contrast                  | Request.ColorEnhance | 对比度            | String | 否   | 无     | [0,100]，空字符串（表示自动分析）  |
| Correction                | Request.ColorEnhance | 色彩校正          | String | 否   | 无     | [0,1000]，空字符串（表示自动分析）|
| Saturation                | Request.ColorEnhance | 饱和度            | String | 否   | 无     | [0,300]，空字符串（表示自动分析） |
...
| SharpenLevel      | Request.MsSharpen | 增强等级    | String | 否   | 无    | [0,10]，空字符串（表示自动分析）             |
...
| 节点名称（关键字） | 父节点                | 描述                                                         | 类型      |
| :----------------- | :-------------------- | :----------------------------------------------------------- | :-------- |
| TemplateId         | Response.Template     | 模版ID                                                      | String    |
| Name               | Response.Template     | 模版名字                                                     | String    |
| BucketId           | Response.Template     | 模版所属存储桶                                                | String    |
| Category           | Response.Template     | 模版属性，Custom 或者 Official                                | String    |
| Tag                | Response.Template     | 模版类型，VideoProcess                                        | String    |
| UpdateTime         | Response.Template     | 更新时间                                                     | String    |
| CreateTime         | Response.Template     | 创建时间                                                     | String    |
| VideoProcess       | Response.Template     | 详细的模版参数                                                | Container |


Container节点VideoProcess的内容：
