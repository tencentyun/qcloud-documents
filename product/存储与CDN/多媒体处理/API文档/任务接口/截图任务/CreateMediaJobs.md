...
| Object             | Request.Operation.Output | 结果文件的名字 <br/>**当任务类型为 Snapshot时，必须包含 ${Number} 参数**<br/>如 Object 为 snapshot-${Number}.jpg <br/> | String | 否   |
| SpriteObject       | Request.Operation.Output | 雪碧图的名字 <br/>**当任务类型为 Snapshot使用，必须包含 ${Number} 参数**<br/>如 Object 为 snapshot-${Number}.jpg<br/>仅支持 jpg 格式 | String | 否   |
