...
CreateMediaJobs 接口用来提交一个视频增强任务。
...
| 节点名称（关键字） | 父节点  | 描述                                                     | 类型      | 必选 |
| ------------------ | ------- | -------------------------------------------------------- | --------- | ---- |
| Tag                | Request | 创建任务的Tag：VideoProcess                                | String    | 是   |
...
| WatermarkTemplateId | Request.Operation | 指定的水印模版 ID，可以传多个水印模板 ID，最多传3个，优先使用模板 ID           | String    |否|
