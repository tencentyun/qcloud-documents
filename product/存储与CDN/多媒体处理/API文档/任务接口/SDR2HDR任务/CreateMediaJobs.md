...
CreateMediaJobs 用于提交一个SDRtoHDR任务。
...
| WatermarkTemplateId | Request.Operation | 指定的水印模版ID，可以传多个水印模板ID, 最多传3个,优先使用模板id          | String    | 否 |无|
...
|节点名称（关键字）|父节点|描述|类型|
|:---|:-- |:--|:--|
| SDRtoHDR | Response.JobsDetail.Operation | 同 请求中的 Request.Operation.SDRtoHDR |  Container |
