...
#### 选择存储与网络
为存储网关配置存储及网络。
注意，由于 CSG 正常运行至少需要 2 块 10GB 以上的数据盘，请在当前购买流程完毕后继续为该台云主机添加更多的数据盘。 
![](https://mc.qcloudimg.com/static/img/4e1de73e91cb3b4eab390e142d09af59/image.png)

#### 设置服务器相关信息
为该存储网关设置主机名称及安全组。 端口开放需求请参考[存储网关安全组要求](https://www.qcloud.com/document/product/581/9775#.E7.BD.91.E7.BB.9C.E5.8F.8A.E7.BD.91.E5.85.B3.E5.AE.89.E5.85.A8.E7.BB.84)
![](https://mc.qcloudimg.com/static/img/4cf0544a1d410861d032f05ba61b464e/image.png)

说明，处于安全原因考虑，运行存储网关的云主机暂不提供 root 权限。请使用下面用户名/密码进行登录到存储网关主机并维护。
