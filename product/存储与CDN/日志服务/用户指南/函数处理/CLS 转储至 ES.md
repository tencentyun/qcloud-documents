...
本文为您介绍如何将 CLS 日志转储至 ES，我们用到了日志服务（CLS），云函数（SCF），Elasticsearch Service（ES）。其中，CLS 主要用于日志采集，SCF 主要提供数据加工的节点计算能力。数据处理流程图请参见 [函数处理概述](https://cloud.tencent.com/document/product/614/49851)。
