...
![](https://main.qcloudimg.com/raw/492cb04bd073b6c7078989944073487b.png)
...
![](https://main.qcloudimg.com/raw/47b1f98b323ca8fe6a78ca0f40a5f8e6.png)
...
| UnreachedThreshold      | 满足告警触发条件，但未达到告警收敛阈值，不发送告警通知；<br>HappenThreshold Unreached：未满足周期收敛条件，比如持续5个监控周期才触发告警<br>AlertThreshold Unreached：未满足告警时间间隔条件，比如每隔15分钟告警一次 |
| TemplateUnmatched       | 不符合通知模版的告警配置信息，具体原因包含：<br>TypeUnmatched：不符合通知模版的告警通知类型（告警通知、告警恢复），不发送告警通知<br>TimeUnmatched：不符合通知模版的告警通知时间段，不发送告警通知<br>SendFail：通知发送失败 |
