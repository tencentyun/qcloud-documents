...
<tr>
<td>支持多选</td>
<td>开启后可以选择多个变量值作为过滤条件。</td>
</tr>
</tbody></table>
6. 返回仪表盘详情页面，单击**过滤器**，选择过滤项，仪表盘数据将刷新为过滤后内容。
![](https://qcloudimg.tencent-cloud.cn/raw/eb0a14b6072c51fe9783f05aa9a580fe.png)
...
<tbody><tr>
<td align="left">类型</td>
<td align="left">不同的类别对应不同的配置项与应用场景，此处选择下拉选项过滤。</td>
</tr>
<tr>
...
<td align="left">用于配置查看仪表盘时的默认过滤项，非必填项目。返回仪表盘详情页面，单击**过滤器**，选择过滤项，仪表盘数据将刷新为过滤后内容。</td>
</tr>
</tbody></table>
6. 返回仪表盘详情页面，单击**过滤器**，选择过滤项，仪表盘数据将刷新为过滤后内容。
...
3. 单击需要操作的仪表盘 ID/名称，进入该仪表盘详情页面。
4. 单击顶部的**新增过滤与变量**打开设置页面。
![](https://qcloudimg.tencent-cloud.cn/raw/37e4f09317b344d5c426b268eb832afc.png)
