...
(\S+)\s\S+\s(\S+)\s\[([^\]]+)\]\s\"([^\"]+)\s(\S+)\s([^\"]+)\"\s(\d+)\s(\d+)\s([\d,.]+)\s\"([^\"]+)\"\s\"([^\"]+)\"\s\"([^\"]+)\"$
  ```
	...
	![1569579711295](assets/1569579711295.png)
	
	![1569576940882](assets/1569576940882.png)
...
![1569579807531](assets/1569579807531.png)
...
如下图所示，点击【status】字段后，可以看到 Nginx 的 TOP 10 的状态码分布，以及各状态的日志数占比。

![1569575061762](assets/1569575061762.png)

点击具体字段值，会自动生成对应的检索语句，并返回关键字检索结果，达到快速分析的目的。

如下图所示，点击 status 字段的 404 字段值，前端自动生成 status:404 的检索语句，并返回命中的日志详情。

![1569575315340](assets/1569575315340.png)
...
![1569747594824](assets/1569747594824.png)
...
![1569747685161](assets/1569747685161.png)
...
![1569746108594](assets/1569746108594.png)
...
![1569747161199](assets/1569747161199.png)
...
![1569746979626](assets/1569746979626.png)

![1569747329971](assets/1569747329971.png)
...
![1569748333783](assets/1569748333783.png)
...
![1569827430826](assets/1569827430826.png)
