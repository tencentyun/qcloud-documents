...
```
* | SELECT stddev(request_length) as "样本标准差", stddev_pop(request_length) as "总体标准差", time_series(__TIMESTAMP__, '1m', '%H:%i:%s', '0') AS dt GROUP BY dt
```
![image-20210809225126060](https://main.qcloudimg.com/raw/a96164009d17d6aea6bf1e438e622e50.png)
