...
2. 主账号授权
   ...
   主账号 CompanyExample 登录 [CAM 控制台](https://console.cloud.tencent.com/cam)，单击【用户】>【用户列表】>【授权】。在页面【关联策略】中搜索 QcloudCLSFullAccess 和步骤1中建立的策略，如 CLSListCosCKafka ，并选中关联这两个策略，单击【完成】即可。
