...
- 若在腾讯云 Ckafka 开启了 ACL 鉴权，会导致日志数据无法投递。如需投递到 Ckafka，请关闭该 Topic 的 ACL。
- 创建 Topic 时，若 max_message_bytes 参数设置不到8MB，会因 CLS 侧的单条 message 过大，无法写入 Ckafka Topic，导致投递失败。关于 max_message_bytes 参数设置，请参见 [配置 Topic 高级参数](https://cloud.tencent.com/document/product/597/73566#.E6.AD.A5.E9.AA.A42.EF.BC.9A.E9.85.8D.E7.BD.AE-topic-.E9.AB.98.E7.BA.A7.E5.8F.82.E6.95.B0)。
