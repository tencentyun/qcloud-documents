...
腾讯云日志服务 CLS 通过控制台可以快速创建机器组，具体操作步骤如下：
...
3.填写机器组名称及其服务器对应的 IP 地址，确认信息无误后，点击 **确认** 按钮，完成机器组创建。

![](https://main.qcloudimg.com/raw/837bc87b05c02e2cfe4efa462e4814c1.png)

> **注**：目前日志服务仅支持 Linux 服务器；IP 地址填写内网 IP，暂不支持填写网段。


## 查看机器状态

机器组与日志服务系统之间采用心跳机制保持连接，成功安装过 LogListener 的机器组会定时向日志服务发送心跳。
1.您可以通过点击【查看】按钮，查看机器组的状态来识别当前该机器是否工作正常。
