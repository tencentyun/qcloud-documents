...
```shell
./loglistener.sh init -s AKIDPEtPXXXXXXXXXXXXXZeabPiJXZ -k whHwQfjdLnzzXXXXXXXXXXMtDH4eEa -r ap-shanghai
```

默认使用内网域名：
![](https://main.qcloudimg.com/raw/b5d7d953c667495d18b7f7a0c4af7e6f.png)
...
```shell
./loglistener.sh init -s AKIDPEtXXXXXXXXXXXXoGZeabPiJXZ -k whHwQfjdLnXXXXXXXXXXXXMtDH4eEa -r ap-shanghai -n internet
```
...
| n   | 网络类型，intra 内网（默认）， internet 外网 |
