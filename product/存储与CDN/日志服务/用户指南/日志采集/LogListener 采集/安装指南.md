...
```shell
wget https://https://loglistener-1254077820.cos.ap-shanghai.myqcloud.com/loglistener.2.2.3.tar.gz && tar -zxvf loglistener.2.2.3.tar.gz -C /usr/local/ && cd /usr/local/loglistener/tools
```
#### 2. 安装 LogListener
