...
```shell
wget https://loglistener-1254077820.cos.ap-shanghai.myqcloud.com/loglistener-linux-x64-2.2.5.tar.gz && tar -zxvf loglistener-linux-x64-2.2.5.tar.gz -Cusr/local&& cd /usr/local/loglistener-2.2.5/tools && ./loglistener.sh install
```
