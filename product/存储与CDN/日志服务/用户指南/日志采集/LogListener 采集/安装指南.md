...
[下载 LogListener 2.1.1](https://mc.qcloudimg.com/static/archive/520370e2a9e96c9bd36b5ced36ecdb83/loglistener.2.1.1.tar.gz)
...
> - region 为您所使用的 日志服务区域而非您的业务机器所处的区域
...
### 4.卸载 LogListener
您可以通过以下命令卸载LogListener：
```
cd loglistener/tools;
./uninstall
```

>注意：卸载操作将删除 `rc.local` 里自动重启的工具。
