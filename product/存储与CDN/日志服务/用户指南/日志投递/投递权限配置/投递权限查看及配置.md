...
若您在通过 API 调用时，未配置权限，则会导致投递数据失败。
</dx-alert>
...
<img src="https://qcloudimg.tencent-cloud.cn/raw/aade131a6c18c7e93f0f712d6129ceae.png" width="70%"/><br>权限创建成功后，若您使用主账号，则可直接进行投递操作。若您需使用子账号或协作者账号，则请使用主账号参考 [权限说明](https://cloud.tencent.com/document/product/614/47110) 授予相关授权策略后再进行投递。
:::
::: 使用访问管理手动创建
1. 登录访问管理控制台，选择左侧导航栏中的 **[角色](https://console.cloud.tencent.com/cam/role)**。
2. 在“角色”页面中，单击**新建角色**。
...
权限创建成功后，参考 [投递至 COS](https://cloud.tencent.com/document/product/614/16890) 或投递至 Kafka 的接口文档配置投递参数即可。
:::
</dx-tabs>
