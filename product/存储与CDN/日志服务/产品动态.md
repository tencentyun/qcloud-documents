...
<table>
	...
	<tbody>
		...
		<tr><td>支持用户通过 SDK 上报移动端数据</td><td>支持用户通过 Android/IOS SDK 上报移动端中包括网路探测等的日志信息。</td><td>2022-07-01</td><td><a href="https://cloud.tencent.com/document/product/614/67157">API/SDK采集</a></td></tr>
	</tbody>
</table>
