...
| 动态名称        | 动态描述                                                                    | 发布时间   | 相关文档   |
|-------------|-------------------------------------------------------------------------|--------|--------|
| 数据加工新增函数    | 数据加工新增 ext_grok 函数，基于 grok 语法提取匹配结果值，降低了用户在使用加工函数时，正则提取 KV 的难度。         | 2022-11-15| [键值提取函数](https://cloud.tencent.com/document/product/614/70496#ext_grok-.E5.87.BD.E6.95.B0) |
| 仪表盘过滤器升级    | 仪表盘过滤器下拉框现已支持静态选项输入与别名配置，同时新增检索语句过滤，可支持范围过滤、NOT 过滤、全文检索、模糊匹配，满足用户多种过滤需求。 | 2022-11-20 | [模板变量](https://cloud.tencent.com/document/product/614/63400)   |
| 告警策略支持多日志主题 | 支持单个告警策略同时设置多个日志主题，最多可选择20个日志主题，每个日志主题可单独判断是否满足触发条件；暂不支持跨地域选择。          | 2022-11-23| [配置告警策略](https://cloud.tencent.com/document/product/614/51742#.E9.85.8D.E7.BD.AE.E7.9B.91.E6.8E.A7.E5.AF.B9.E8.B1.A1.E5.92.8C.E7.9B.91.E6.8E.A7.E4.BB.BB.E5.8A.A1) |
| 仪表盘图表支持字段配置 | 图表已支持对单个字段生效的个性化样式配置，满足用户仪表盘个性化样式需求。                                   | 2022-11-25 | -      |
