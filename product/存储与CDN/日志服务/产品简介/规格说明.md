...
<table>
	...
	<tr></tr>
	<tr><td>非聚类分析（不含 group by 子句）结果条数</td><td>每次分析返回结果条数最大10000条</td><td>limit 默认100条，最大10000条</td></tr>
	<tr><td>聚类分析（含 group by 子句）结果条数</td><td>	每次分析返回结果条数最大10000条</td><td>limit 默认100条，最大10000条</td></tr>
</table>
