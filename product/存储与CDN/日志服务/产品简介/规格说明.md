...
<tr>
 ...
 <tr>
  ...
  <tr>
    ...
    <td >单个主题分区 读请求限制：200 qps。超限返回状态码 429，提示错误 SpeedQuotaExceed </td>
  </tr> 
    <tr>
    <td >单个主题分区 写请求限制：500 qps。超限返回状态码 429，提示错误 SpeedQuotaExceed </td>
  </tr> 
  <tr>
    <td>读写流控</td>
    <td >单个主题分区 写流量限制：5MB/s。超限返回状态码 429，提示错误 SpeedQuotaExceed </td>
  </tr>
</table>
