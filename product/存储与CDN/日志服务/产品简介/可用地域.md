...
为提高数据传输效率，日志服务在不同模块使用的域名有所区别，具体如下：
...
:::
::: 日志采集 SDK 及日志服务 API 2017 [](id:API2017)

[日志采集 SDK](https://cloud.tencent.com/document/product/614/67157) 是 CLS 针对日志采集进行专门优化的 SDK，相比 [日志服务 API 3.0](https://cloud.tencent.com/document/product/614/56479) 自带的标准 SDK，其支持日志 ProtoBuffer 格式封装、数据压缩、异步发送和资源控制等，能够极大的降低使用难度。

>? [日志服务 API 2017](https://cloud.tencent.com/document/product/614/16907) 是日志服务旧版本 API，不建议继续使用。
>
