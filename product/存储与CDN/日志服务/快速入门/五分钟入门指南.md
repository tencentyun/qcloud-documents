...
下载 [Loglistener 安装包](https://loglistener-1254077820.cos.ap-shanghai.myqcloud.com/loglistener.2.2.3.tar.gz) ，解压安装包后进入目录`/loglistener/tools`，以管理员身份执行以下安装命令，详细安装步骤请参阅 [LogListener 安装指南](https://cloud.tencent.com/document/product/614/17414)。
```sh
