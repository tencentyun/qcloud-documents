...
| partition_id | int    | query | 是       | 需合并的主题分区编号，日志服务会自动合并范围右相邻的分区。例如，若2、3是两个相邻的 readwrite 分区，paritition_id=2时，会将2、3分区合并，同时2、3分区类型变成 readonly，合并的后的分区类型为 readwrite，partition_id=4 |
