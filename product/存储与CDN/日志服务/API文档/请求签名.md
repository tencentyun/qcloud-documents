...
## 准备工作
代码泄漏可能会导致SecretId和SecretKey泄漏,并威胁账号下所有资源的安全性,以下代码仅供参考,建议采用更安全的方式来使用密钥,请参见  [云API密钥安全方案推荐](https://cloud.tencent.com/document/product/1278/85305)。

1. 获取 SecretId 和 SecretKey。
   请在控制台 [云 API 密钥](https://console.cloud.tencent.com/capi) 页面获取。
2. 确定开发语言：
...
Authorization: q-sign-algorithm=sha1&q-ak=AKID********************************&q-sign-time=1510109254;1510109314&q-key-time=1510109254;1510109314&q-header-list=content-type;host&q-url-param-list=logset_name&q-signature=e8b23b818caf4e33f196f895218bdabdbd1f1423
```
