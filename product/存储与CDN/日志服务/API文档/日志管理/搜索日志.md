...
```plaintext
GET /searchlog?logset_id=xxxx-xx-xx-xx-xxxxxxxx&topic_ids&start_time=2017-08-22+10%3A10%3A10&end_time=2017-08-23+10%3A10%3A10&query_string=&limit=10&context= HTTP/1.1
...
| topic_ids     | string | query| 是      |要查询的 topic ID 组合                         |
