...
| cursor       | string | query | 是       | 游标值，base64编码，表示从当前位置开始读取数据 |
...
| x-cls-count  | 当前请求返回的 LogGroup 个数（一个 LogGroup 会包含多条日志，LogGroup 定义参考 [结构化日志上传](https://cloud.tencent.com/document/product/614/16873) 文档说明） |

### 响应参数

返回 LogGroupList 对象的打包内容，pb 文件描述详见 [结构化日志上传](https://cloud.tencent.com/document/product/614/16873) 接口。
