...
对象存储服务的 iOS SDK 的下载地址：[iOS SDK](https://mccdn.qcloud.com/static/archive/55534d7793b5d05e225e67ce1206b5c7/qcloud-image-ios-v1.1.3.3.zip) 。

更多示例请参考：[iOS SDK Demo](https://mccdn.qcloud.com/static/archive/25b90b570c8afcf9770021b5c6ea2af7/archive.zip)
...
![上传 SDK](//mccdn.qcloud.com/static/img/05f5a1d6768985aa11b23c3808914989/image.png)

![下载 SDK](//mccdn.qcloud.com/static/img/190e5c8c4920ba4d7334f7ba64fd3839/image.png)

将解压后的 QCloudUploadSDK 和 QCloudDownloadSDK 拖入工程目录，Xcode 会自动将其加入链接库列表中。

![导入 SDK 包](//mccdn.qcloud.com/static/img/96dda4e5f2e4f8fab3fbda3de1cd8e25/image.png)
...
![参数配置](//mccdn.qcloud.com/static/img/58327ba5d83809c77da158ff95627ef7/image.png)
...
| msgContext | NSString * | 否    | 通知用户业务后台的信息  |
...
| sign       | NSString *    | 是    | 签名                            |
| objectType | TXYObjectType | 是    | 业务类型，文件属性更新时设置为：TXYObjectFile |
| attrs      | NSString *    | 否    | 用户自定义属性                       |
