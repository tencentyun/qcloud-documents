...
进入腾讯云控制台产品页面,新建加速服务后，在列表页面可以得到游戏ID（GameId）、密钥ID（SecretId）和密钥KEY（SecretKey），每开通一项加速服务，会产生一个“游戏ID”，和“游戏KEY”，游戏KEY默认只有创建者、管理员（全局协作者）才有查看游戏KEY的权限，如果您看不到相关的信息，请联系管理员查看。
