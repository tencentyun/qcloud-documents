...
>?
>- 不支持对归档存储类型的对象进行复制粘贴。
>- 标准存储（多 AZ）类型的对象当前仅支持复制为标准存储（多 AZ） 类型，低频存储（多 AZ）类型的对象当前仅支持复制为低频存储（多 AZ）类型，暂不支持复制为其他存储类型。
...
- [Android SDK](https://cloud.tencent.com/document/product/436/34536#.E5.A4.8D.E5.88.B6.E5.AF.B9.E8.B1.A1.EF.BC.88.E4.BF.AE.E6.94.B9.E5.B1.9E.E6.80.A7.EF.BC.89)
...
- [.NET SDK](https://cloud.tencent.com/document/product/436/32869#.E8.AE.BE.E7.BD.AE.E5.AF.B9.E8.B1.A1.E5.A4.8D.E5.88.B6)
