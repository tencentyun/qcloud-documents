...
当需要复制一个超过5GB的对象时，您需要选择分块复制的方法来实现。使用分块上传的 API 来创建一个新的对象，并使用 Part Copy 的功能，携带 `x-cos-copy-source` 头部来指定源对象，流程包括：
...
- [Initiate Multipart Upload](https://cloud.tencent.com/document/product/436/35161#.E5.88.9D.E5.A7.8B.E5.8C.96.E5.88.86.E5.9D.97.E4.B8.8A.E4.BC.A0)
- [Complete Multipart Upload](https://cloud.tencent.com/document/product/436/35161#.E5.AE.8C.E6.88.90.E5.88.86.E5.9D.97.E4.B8.8A.E4.BC.A0)
...
对象存储 COS 的 Java SDK 中提供了此方法，可参考 Java SDK [ 对象操作 ](https://cloud.tencent.com/document/product/436/35215) 文档。
...
对于5G以上的文件，需要通过分块上传中的 copypart 来实现，步骤较多，因此在 TransferManager 中封装了一个 copy 接口，不仅能根据文件大小自动的选择接口，同时能支持5G以上的文件拷贝。推荐使用该接口进行文件的 copy。示例代码如下：
...
对象存储 COS 的 Python SDK 中提供了此方法，可参考 Python SDK 文档中的以下部分：

- [创建分块上传](https://cloud.tencent.com/document/product/436/35151#.E5.88.9D.E5.A7.8B.E5.8C.96.E5.88.86.E7.89.87.E4.B8.8A.E4.BC.A0)
- [完成分块上传](https://cloud.tencent.com/document/product/436/35151#.E5.AE.8C.E6.88.90.E5.88.86.E5.9D.97.E4.B8.8A.E4.BC.A0)
