...
您可以直接使用 REST API 发起删除多个对象请求，请查阅 [DELETE Multiple Objects](https://cloud.tencent.com/document/product/436/8289) API 文档。

### 使用 SDK

您可以直接调用 SDK 的删除多个对象方法，请参阅下列各语言 SDK 文档：

- [Android SDK](https://cloud.tencent.com/document/product/436/34536#.E5.88.A0.E9.99.A4.E5.A4.9A.E4.B8.AA.E5.AF.B9.E8.B1.A1)
- [C SDK](https://cloud.tencent.com/document/product/436/12297#delete-multiple-object)
...
- [JavaScript SDK](https://cloud.tencent.com/document/product/436/12260#delete-multiple-object)
- [Node.js SDK](https://cloud.tencent.com/document/product/436/12264#delete-multiple-object)
