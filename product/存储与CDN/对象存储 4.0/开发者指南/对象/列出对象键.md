[对象键（ObjectKey）](https://cloud.tencent.com/document/product/436/13324#.E5.AF.B9.E8.B1.A1.E9.94.AE)是对象在存储桶中的唯一标识，可以通俗的理解为文件路径。例如对象键为 doc/picture.jpg 则表示为图片文件 picture.jpg 存放在 COS 的 doc 路径（或文件夹）下。
