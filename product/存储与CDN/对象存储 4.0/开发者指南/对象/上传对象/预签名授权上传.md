...
您可以直接使用 REST API 发起一个上传对象请求，详情请参阅 [PUT Object ](https://cloud.tencent.com/document/product/436/7749) 文档。

### 使用 Java SDK

对象存储 COS 的 Java SDK 中提供了此方法，详情请参阅 [Java SDK 接口文档](https://cloud.tencent.com/document/product/436/12263#.E7.94.9F.E6.88.90.E9.A2.84.E7.AD.BE.E5.90.8D.E9.93.BE.E6.8E.A5) 生成预签名链接部分。
...
request({
    method: 'PUT',
    url: url,
    body: fs.readFileSync('./picture.jpg'),
