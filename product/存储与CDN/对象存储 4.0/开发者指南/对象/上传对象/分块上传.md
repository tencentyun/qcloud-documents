...
对象存储 COS 的 C++ SDK 中提供了此方法，可参考 C++ SDK [对象操作](https://cloud.tencent.com/document/product/436/35161) 文档。 
...
对象存储 COS 的 Python SDK 中提供了此方法，可参考 Python SDK [对象操作](https://cloud.tencent.com/document/product/436/35151) 文档。
