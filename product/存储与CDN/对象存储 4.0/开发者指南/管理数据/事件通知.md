...
1. 创建 SCF 函数
   ...
   - 您也可以使用 SCF 预置的模板简化创建流程，详情请参见 [创建函数](https://cloud.tencent.com/document/product/583/19806)。不同编程语言的函数写法有所区别，详情请参见 [云函数](https://cloud.tencent.com/document/product/583/31317) 文档。
2. 测试函数
