...
<table>
   ...
   <tr>
      ...
      <td>在未开启版本管理的 Bucket 下使用 Delete Object 接口删除 Object，或者使用 versionid 删除指定版本的 Object 时触发云函数</td>
   </tr>
   <tr>
      <td nowrap="nowrap">cos: ObjectRemove:DeleteMarkerCreated</td>
      <td>在开启或者暂停版本管理的 Bucket 下使用 Delete Object 接口删除 Object 时触发云函数</td>
   </tr>
</table>
...
4. 实际验证
   完成以上步骤后，您可以操作 COS 中的存储桶，并验证整体流程是否正常。例如，您可以通过控制台、COS Browser 等工具上传、删除文件，在**SCF 控制台** > **函数详情** >  **运行日志**验证是否正常工作。
