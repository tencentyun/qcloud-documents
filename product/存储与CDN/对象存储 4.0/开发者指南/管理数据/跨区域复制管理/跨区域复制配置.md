...
### 使用 C++ SDK
对象存储 COS 的 C++ SDK 中提供了该方法，请参见 C++ [快速入门](https://cloud.tencent.com/document/product/436/12301) 文档进行设置。
...
```
### 使用 C SDK
对象存储 COS 的 C SDK 中提供了该方法，请参见 C SDK [接口文档](https://cloud.tencent.com/document/product/436/12297) 进行设置。
