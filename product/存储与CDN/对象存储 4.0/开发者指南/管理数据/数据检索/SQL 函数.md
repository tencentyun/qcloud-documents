...
> - `data_type`参数是转换后的数据类型，如`INT`类型。目前 COS Select 支持的数据类型，请参见 [数据类型](#)。
...
| ...              | ...                                                          | ...                               |
| `SSSSSSSSS`      | 秒钟的小数部分(精度0.000000001，范围 0.000000000-0.999999999) | `60000000`                        |
| `n`              | 纳秒                                                         | `60000000`                        |
| `X`              | 时钟级的偏移，如果偏移为0则为"Z"                             | `+01`或者`Z`                      |
| `XX`或者`XXXX`   | 时钟或者分钟级的偏移，如果偏移为0则为"Z"                     | `+0100`或者`Z`                    |
| `XXX`或者`XXXXX` | 时钟或者分钟级的偏移，如果偏移为0则为"Z"                     | `+01:00`或者`Z`                   |
| `x`              | 时钟级的偏移                                                 | `1`                               |
