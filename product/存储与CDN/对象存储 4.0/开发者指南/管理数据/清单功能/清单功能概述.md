...
#### 1. 创建 COS 角色
创建 COS 角色，具体接口信息参见请 [CreateRole](https://cloud.tencent.com/document/product/598/36225)。
...
其中，policyName 为：QcloudCOSAccessForCLSRole，roleName 为第1步中的 COS_QcsRole，也可以使用创建 roleName 时返回的 roleID。

#### 3. 开启清单功能
调用接口，开启清单功能，具体接口信息请参见 [PUT Bucket logging](https://cloud.tencent.com/document/product/436/33707)，其中，要求存放清单文件的目标存储桶和源存储桶在同一地域。
