...
当主账号允许匿名用户，在访问来源 IP 为 101.226.100.185 或 101.226.100.186 时，对华南地区存储桶 examplebucket-1250000000 中的对象，执行 GET（下载）和 HEAD 操作，而无需鉴权。更多案例请参阅 [权限设置相关案例](https://cloud.tencent.com/document/product/436/12514)。
