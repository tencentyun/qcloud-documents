...
| 08   | userSecretKeyId | 用户访问 KeyId | 18   | resTotalTime    | 请求总耗时     |
| 09   | reqQcsSource    | 请求 qcs 源信息  | 19   | logSourceType    | 标识，内容为 cgi 或 platform    |
| 10   | reqBytesSent    | 请求字节数     | 20  |deltaDataSize|用于表示该请求导致用户存储变化量|
...
## 启用日志管理
### 使用控制台
用户可以通过控制台快速开启日志管理功能。操作指引请参阅 [日志管理](https://cloud.tencent.com/document/product/436/17040) 控制台指南。
