...
| 序号 | 名 称         | 含 义                  | 示例                                                                    |
| ---- | --------------- | ------------------------ | ------------------------------------------------------------------------- |
| 1    | bucketName      | 存储桶名称          | examplebucket-1250000000                                                      |
| 2    | deltaDataSize   | 请求对存储量的改变 | 12345678                                                                  |
| 3    | eventVersion    | 记录版本             | 1                                                                         |
...
| 7    | logSourceType   | 日志源类型          | CGI 或platform                                                           |
| 8    | qcsRegion       | 请求地域             | ap-beijing                                                                |
| 9    | remoteIp        | 来源IP                 | 192.168.0.1                                                               |
| 10   | reqQcsSource    | 请求qcs源信息       | qcs::cos:ap-beijing:uin/100000000001:examplebucket-1250000000//product/aaa.ts |
| 11   | reqBytesSent    | 请求字节数          | 83886080                                                                  |
| 12   | reqPath         | 请求路径             | /product/aaa.ts                                                           |
...
| 19   | resTotalTime    | 请求总耗时（秒） | 4295                                                                      |
| 20   | storageClass    | 存储类型             | STANDARD，STANDARD_IA，ARCHIVE                                          |
| 21   | userSecretKeyId | 用户访问KeyId        | AKIDNYVCdoJQyGJ5brTf                                     |

>!
> - 目前日志管理功能仅支持北京、上海、广州和成都这四个地域。
