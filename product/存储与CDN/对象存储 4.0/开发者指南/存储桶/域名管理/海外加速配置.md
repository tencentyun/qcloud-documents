...
1）登录腾讯云 [COS 控制台](https://console.cloud.tencent.com/cos5) ，进入存储桶管理页面。单击存储桶详情界面上方的【权限管理】，对其内容添加公开的访问策略。
![](https://main.qcloudimg.com/raw/b1c0862f797da9d1447bc6a13929a927.png)

2）单击【添加策略】，请按照以下配置**用户**、**资源**和**操作**。
- 效力：允许。
- 用户：所有用户。
- 资源：整个存储桶。
- 操作：文件读操作权限。
...
## 常见问题
关于未备案的域名是否可以接入海外加速 GCD 等问题，可参阅 COS  [常见问题](https://cloud.tencent.com/document/product/436/30737#gcd) 文档。
