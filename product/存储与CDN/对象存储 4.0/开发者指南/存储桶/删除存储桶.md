...
- 目前仅支持删除数据已被清空的存储桶，如果存储桶中仍有对象或文件碎片，将会删除失败。请在执行删除存储桶前确保存储桶内已清空对象。前往了解如何 [清空存储桶](https://cloud.tencent.com/document/product/436/35247)。
...
您可以使用工具删除存储桶，例如 COSBrowser 工具、COSCMD 工具等，详情请参见 [工具概览](https://cloud.tencent.com/document/product/436/6242)。
...
- [.NET SDK](https://cloud.tencent.com/document/product/436/63392)
- [Go SDK](https://cloud.tencent.com/document/product/436/65640)
...
- [PHP SDK](https://cloud.tencent.com/document/product/436/64277)
- [Python SDK](https://cloud.tencent.com/document/product/436/35150#.E5.88.A0.E9.99.A4.E5.AD.98.E5.82.A8.E6.A1.B6)
- [小程序 SDK](https://cloud.tencent.com/document/product/436/36159#.E5.88.A0.E9.99.A4.E5.AD.98.E5.82.A8.E6.A1.B6)
