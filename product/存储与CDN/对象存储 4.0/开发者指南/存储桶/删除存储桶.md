...
### 使用 REST API
您可以直接使用 REST API 发起一个删除存储桶请求，可参考 [Delete Bucket](https://cloud.tencent.com/document/product/436/7732) 文档。

### 使用 C++ SDK

对象存储 COS 的 C++ SDK 中提供了此方法，可参考 C++ SDK [存储桶操作](https://cloud.tencent.com/document/product/436/35160) 文档。
...
对象存储 COS 的 Java SDK 中提供了此方法，可参考 Java SDK [存储桶操作](https://cloud.tencent.com/document/product/436/35214) 文档。
...
对象存储 COS 的 Python SDK 中提供了此方法，可参考 Python SDK [存储桶操作](https://cloud.tencent.com/document/product/436/35150) 文档。
