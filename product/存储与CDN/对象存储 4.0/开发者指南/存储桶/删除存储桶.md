...
您可以使用对象存储控制台删除存储桶，请参阅 [删除存储桶](https://cloud.tencent.com/document/product/436/32433) 控制台指南文档。

### 使用 REST API

您可以直接使用 REST API 发起删除存储桶请求，请参阅 [DELETE Bucket](https://cloud.tencent.com/document/product/436/7732) API 文档。

### 使用 SDK

您可以直接调用 SDK 的删除存储桶方法，请参阅下列各语言 SDK 文档：

- [Android SDK](https://cloud.tencent.com/document/product/436/34535#.E5.88.A0.E9.99.A4.E5.AD.98.E5.82.A8.E6.A1.B6)
- [C SDK](https://cloud.tencent.com/document/product/436/12297#delete-bucket)
...
- [JavaScript SDK](https://cloud.tencent.com/document/product/436/12260#delete-bucket)
- [Node.js SDK](https://cloud.tencent.com/document/product/436/12264#delete-bucket)
