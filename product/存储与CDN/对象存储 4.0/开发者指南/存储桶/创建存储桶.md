...
对象存储 COS 的 C++ SDK 中提供了此方法，请参阅 C++ SDK [存储桶操作](https://cloud.tencent.com/document/product/436/35160)  Put Bucket 部分。
...
对象存储 COS 的 Java SDK 中提供了此方法，可参考 Java SDK [存储桶操作](https://cloud.tencent.com/document/product/436/35214) Put Bucket 部分。
...
对象存储 COS 的 Python SDK 中提供了此方法，可参考 Python SDK [存储桶操作](https://cloud.tencent.com/document/product/436/35150) Put Bucket 部分。
