...
| AVIF 压缩 | 支持jpg、png、bmp、gif、heif、webp、tpg格式图片转换为 avif 格式。 | 支持 Firefox、Chrome、Android 等少数浏览器及系统               | 弱     | 极强     | 慢       |
...
将 jpeg 格式的原图片转换为 webp、avif、heif、tpg 格式。原图 URL 为`https://ci-h5-demo-1258125638.cos.ap-chengdu.myqcloud.com/defaults/default01.jpg`，效果如下：

![img](https://ci-h5-demo-1258125638.cos.ap-chengdu.myqcloud.com/defaults/default01.jpg)

### 示例1：转换为 webp 图片
请求的最终 URL：

```
https://ci-h5-demo-1258125638.cos.ap-chengdu.myqcloud.com/defaults/default01.jpg?imageMogr2/format/webp
```
...
```
https://ci-h5-demo-1258125638.cos.ap-chengdu.myqcloud.com/defaults/default01.jpg?imageMogr2/format/heif
```
...
```
https://ci-h5-demo-1258125638.cos.ap-chengdu.myqcloud.com/defaults/default01.jpg?imageMogr2/format/tpg
```
...
```
https://ci-h5-demo-1258125638.cos.ap-chengdu.myqcloud.com/defaults/default01.jpg?imageMogr2/format/avif
```
