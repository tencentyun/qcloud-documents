...
腾讯云对象存储 COS 集成了 [数据万象](https://cloud.tencent.com/document/product/460)（Cloud Infinite，CI）专业的一体化媒体解决方案，涵盖图片上传、下载、存储、处理、识别等功能，详见如下表。您可以通过 COS 的上传和处理接口来进行媒体数据的处理操作。
