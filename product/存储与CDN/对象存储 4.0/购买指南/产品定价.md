...
> - 下文价格表中归档存储的请求费用、外网下行流量费用，是需先恢复至标准存储，才产生相应的费用。关于归档存储的相关介绍，您可参见 [存储类型](https://cloud.tencent.com/document/product/436/33417)。
...
<table>
   ...
   <tr>
      ...
      <th rowspan=2 nowrap="nowrap">请求费用<br>（元/万次）</th>
...
<table>
   ...
   <tr>
      ...
      <td>0.019<br>（暂不支持南京）</td>
      <td>0.012<br>目前北京、广州<br>支持标准存储（多 AZ）</td>
      <td>1.5</td>
      <td>0.06</td>
      <td>0.067</td>
   </tr>
