...
### 资源包定价
对象存储 COS 现针对中国大陆推出两种资源包：存储容量包和外网下行流量包。其中，存储容量包有标准存储容量包、归档存储容量包两种可选，[点击前往购买 >>](https://buy.cloud.tencent.com/cos) 具体定价详情请见 [存储容量包定价](#CCKJB)。外网下行流量包定价详情请见 [外网下行流量包定价](#WWXXLLB)。 如需了解资源包的费用说明，请参阅 [计费说明](https://cloud.tencent.com/document/product/436/16871#.E8.B5.84.E6.BA.90.E5.8C.85.E8.B4.B9.E7.94.A8) 文档。
