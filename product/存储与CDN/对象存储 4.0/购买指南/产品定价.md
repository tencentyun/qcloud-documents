<p align="right">**[COS 价格计算器](https://buy.cloud.tencent.com/price/cos/calculator)**</p>

## 概述
对象存储 COS 支持预付费、后付费两种计费模式，详情请参阅 [计费模式](https://cloud.tencent.com/document/product/436/16871)。在中国大陆地区，我们为用户提供有免费额度的标准存储空间，欢迎试用体验。标准存储的免费额度详情参阅 [免费额度](https://cloud.tencent.com/document/product/436/6240)。不同可用地域的定价可能存在差异，查看 [可用地域](https://cloud.tencent.com/document/product/436/6224)。
- 预付费：预付费仅支持购买 **存储空间资源包**。用户通过预先付费购买 **存储空间资源包** 用于抵扣存储容量的费用。需注意，此类资源包不适用于抵扣流量费用。存储空间资源包有标准存储、归档存储这两种存储空间资源包，用户可按实际需要选择购买。[点击前往购买 >>](https://buy.cloud.tencent.com/cos)
