本文介绍对象存储 COS 的按量计费和资源包定价。关于对象存储的计费方式、计费项说明以及计费周期等信息，请参见 [计费概述](https://cloud.tencent.com/document/product/436/16871)。
...
<table>
   ...
   <tr>
      <th rowspan=2><center>清单功能（元/每列出百万对象/月）</td>
      <th>检索功能（元/GB/日）</td>
   </tr>
   <tr>
      <th>标准存储</td>
