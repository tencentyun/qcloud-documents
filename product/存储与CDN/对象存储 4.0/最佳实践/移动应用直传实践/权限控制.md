策略（Policy）是用于定义和描述一条或多条权限的语法规范，您可以在请求临时密钥时设置策略来实现访问控制，下面基于 [快速搭建移动应用直传服务](https://cloud.tencent.com/document/product/436/19134) 一文中提到的通过设置 STS SDK 的 Policy 参数，来实现不同的权限控制。
