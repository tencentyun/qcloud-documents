...
![](https://main.qcloudimg.com/raw/a8fc8099c8e974478154116bf94562f3.png)
 3. 访问失败，再进入 Header 界面检查原因，可见浏览器发送了带 Origin 的 Request，因此是一个跨域请求。
![](https://main.qcloudimg.com/raw/66b8d01d091e501e4e05acbd75112258.png)
...
1. 登录 COS 控制台，进入配置页面。
登录 [COS 控制台](https://console.cloud.tencent.com/cos5) ，单击【存储桶列表】，进入相关的存储桶（例如 examplebucket-1200000000），单击【基础配置】页签，下拉页面即可找到“跨域访问 CORS 设置项”。
2. 开启并设置 CORS 规则。 
