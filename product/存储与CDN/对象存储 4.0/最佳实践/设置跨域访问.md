...
![](https://main.qcloudimg.com/raw/5aecb05b25d6dfd3eafb6e8852c4172f.png)
...
![](https://main.qcloudimg.com/raw/34d87b5ebe80a183a16a22e125c27388.png)
...
### 超时 Max-Age
浏览器对特定资源的预取请求（OPTIONS请求）返回结果的缓存时间，单位为秒。没有特殊情况时可以设置稍大一点，如60秒，该项是可选配置项。
