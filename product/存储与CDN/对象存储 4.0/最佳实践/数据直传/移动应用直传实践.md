...
出于安全考虑，后端获取临时秘钥后生成直传 url 并直接对其进行签名，可参考 [iOS Server 示例](https://github.com/tencentyun/qcloud-sdk-ios-samples/blob/master/COSDirectTransferDemo/server/app.js) 和 [Android Server 示例](https://github.com/tencentyun/qcloud-sdk-android-samples/blob/master/COSDirectTransferPractice/server/app.js)。
...
```
http://127.0.0.1:3000/sts-direct-sign?ext=需要上传的文件后缀
```
...
- [Android SDK](hhttps://cloud.tencent.com/document/product/436/12159)
