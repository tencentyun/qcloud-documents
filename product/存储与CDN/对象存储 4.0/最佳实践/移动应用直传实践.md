...
## 前提条件
1. 创建存储桶。
在 [COS 控制台](https://console.cloud.tencent.com/cos/bucket) 上创建存储桶。按照您的需求，请将存储桶权限设置为私有读写或者公有读私有写。详细操作步骤请参见 [创建存储桶](https://cloud.tencent.com/document/product/436/13309) 和 [设置访问权限](https://cloud.tencent.com/document/product/436/13315) 文档。
2. 获取永久密钥。
