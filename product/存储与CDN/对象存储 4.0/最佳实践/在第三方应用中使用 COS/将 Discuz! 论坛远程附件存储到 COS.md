...
>? 您可使用 [工具概览](https://cloud.tencent.com/document/product/436/6242) 中介绍的上传工具上传附件；或者通过对象存储控制台直接 [上传文件](https://cloud.tencent.com/document/product/436/13321)。附件存放在存储桶中的路径和附件在本地的 `/upload/data/attachment/` 目录下的相对路径需保持一致。
