...
- 您也可以在 [腾讯云市场](https://market.cloud.tencent.com/) 中搜索使用已经预装 Discuz! 论坛程序的 CVM 镜像。
...
4. 在**基础配置**页面，查看**访问域名**并记录。
   ![](https://main.qcloudimg.com/raw/f98749d1f060c408530c87e4e2d2e8b4.png)
5. 在运行 Discuz! 论坛的 CVM 上部署 COS FTP Server 工具。可参见 [FTP Server 工具](https://cloud.tencent.com/document/product/436/7214)。
...
1. 使用管理员账号登录 Discuz! 论坛并进入**管理中心**。
2. 依次进入**全局** > **上传设置** > **远程附件**。
   ![](https://main.qcloudimg.com/raw/0097f1f1fffeebcca3176ae60fb9ef73.png)
3. 设置远程附件选项，配置说明见下表。
...
![](https://main.qcloudimg.com/raw/0e0dbcdcc8cb0f44b3c0e91c34e45e7e.png)
![](https://main.qcloudimg.com/raw/a325b498ec5c0b164080cbab4efcfea9.png)

4. 单击**测试远程附件**，如果提示“远程附件设置一切正常”，说明设置成功。
   ![](https://main.qcloudimg.com/raw/2d1afb1be17b8be4c15b4d59fdbb3811.png)
5. 保存配置。
6. 发帖测试。
   ![](https://main.qcloudimg.com/raw/5d984846af7d99780b21d4f1b6ca4045.png)
7. 单击附件图片，单击右上角的**在新窗口打开**图标。
   ![](https://main.qcloudimg.com/raw/25175e71eac8738097f5c66c26489d7e.png)
8. 查看附件图片的 URL，确认附件图片的 URL 指向腾讯云 COS。
   ![](https://main.qcloudimg.com/raw/28803b68fd3cc513c5a26d8a160579fe.png)
