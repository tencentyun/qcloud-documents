...
这篇文章我们来介绍一下如何使用插件实现远程附件功能，将 WordPress 的媒体库附件存储在 [腾讯云 COS](https://cloud.tencent.com/product/cos) 上。
...
- 可配合 [腾讯云 CDN](https://cloud.tencent.com/product/cdn) 进一步提升用户查看图片附件的速度，优化网站访问速度。
...
3. 在【存储桶列表】中找到刚才创建的存储桶，并单击其存储桶名称。
