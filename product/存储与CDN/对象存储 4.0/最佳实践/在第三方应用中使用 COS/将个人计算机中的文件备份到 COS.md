...
4. 登录 [ API 密钥管理控制台](https://console.cloud.tencent.com/cam/capi) ，获取 SecretId 和 SecretKey。
...
11. 至此您已经完成备份的基本配置，软件默认将在下一个整点小时开始执行备份作业，您也可以单击菜单【Backups】>【Back Up Now】，立即开始首次备份。
