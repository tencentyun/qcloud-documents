...
1. 分片上传时，若想支持分片块在 1M 以下，需要提工单开启白名单.
2. COS 目前支持最小分片大小为 100K.
3. 分片越小，意味着请求数也增多，目前根据测试统计得到100K分片大小是1M分片大小耗时的2倍左右.
4. 一般正常请求时，建议设置分片大小 1M 及以上.
5. 在失败且因网路因素引起的，可以考虑将分片大小设置为100K，再次重新上传.
6. 上传的分片设置越小，将来下载该文件时也比较慢.
