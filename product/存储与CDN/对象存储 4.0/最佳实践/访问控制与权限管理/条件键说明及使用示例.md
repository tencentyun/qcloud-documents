...
假设主账号（uin:100000000001）拥有存储桶 examplebucket-1250000000，可以通过`cos:content-length`条件键限制子用户（uin:100000000002）上传请求的 Content-Type 头的具体内容m，在设置时，Content-Type 也需要经过 urlencode 填写，例如 “image%2Fsvg%2Bxml”。
