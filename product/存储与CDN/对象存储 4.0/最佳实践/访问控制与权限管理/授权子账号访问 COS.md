...
首先，我们需要先了解几个关键概念：主账号、子账号（用户）和用户。CAM 的相关术语、配置详细描述请查阅 [CAM 概述](/doc/product/598/10583)。
...
## 策略示例
以下提供几种典型场景的策略示例，在配置自定义策略时，您可将以下参考策略复制粘贴至输入框【编辑策略内容】，根据实际配置修改即可。更多 COS 常见场景的策略语法请参阅 [CAM 产品文档](/doc/product/598) 的**商用案例**部分。
