...
4. 根据系统提供的策略选择，可配置简单的策略，如 COS 的存储桶列表的访问权限，只读权限等。如需配置更复杂的策略，可进行 [对子账号授予权限](#.E6.AD.A5.E9.AA.A42.EF.BC.9A.E5.AF.B9.E5.AD.90.E8.B4.A6.E5.8F.B7.E6.8E.88.E4.BA.88.E6.9D.83.E9.99.90) 步骤。
