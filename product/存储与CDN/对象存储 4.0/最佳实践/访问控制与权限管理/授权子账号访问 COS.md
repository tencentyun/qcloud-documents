...
首先，我们需要先了解几个关键概念：主账号、子账号（用户）和用户。CAM 的相关术语、配置详细描述请查阅访问管理的 [词汇表](https://cloud.tencent.com/document/product/598/18564)(https://cloud.tencent.com/document/product/598/18564)。
