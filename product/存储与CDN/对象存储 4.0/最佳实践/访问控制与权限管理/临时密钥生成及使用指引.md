...
| Signature | 请求签名。用来验证此次请求的合法性，需要用户根据实际的输入参数计算得出。<br>计算方法可参考 [签名方法](https://cloud.tencent.com/document/api/213/6984#2.-.E7.94.9F.E6.88.90.E7.AD.BE.E5.90.8D.E4.B8.B2 "签名方法") 章节。|是 | String |
