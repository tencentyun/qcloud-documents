...
其他字段是云 API 的 [公共请求参数](https://cloud.tencent.com/document/api/213/6976)。
...
| Region | 云 API 地域参数，可填写空字符串，默认就近地域，可以填写的地域看 [公共请求参数](https://cloud.tencent.com/document/api/213/6976) | 是 | String |
