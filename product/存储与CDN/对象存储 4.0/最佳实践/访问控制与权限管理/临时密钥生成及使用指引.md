...
| 语言类型     | 代码安装地址   | 代码示例地址 |
| ------------------------- | ------ | ------|
| Java              | [https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/java](https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/java) | [https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/java/src/test/java/com/tencent/cloud/CosStsClientTest.java](https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/java/src/test/java/com/tencent/cloud/CosStsClientTest.java) |
| .NET             | [https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/dotnet](https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/dotnet) | [https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/dotnet/demo/Program.cs](https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/dotnet/demo/Program.cs)|
| Go            | [https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/go](https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/go) |  [https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/go/example/sts_demo.go](https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/go/example/sts_demo.go)|
| NodeJS       | [https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/nodejs](https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/nodejs) | [https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/nodejs/demo/sts-server.js](https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/nodejs/demo/sts-server.js) |
| PHP       | [https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/php](https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/php) | [https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/php/demo/sts_test.php](https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/php/demo/sts_test.php) |
| Python      | [https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/python](https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/python)    | [https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/python/demo/sts_demo.py](https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/python/demo/sts_demo.py) |
...
mvn dependency:tree
```
查看项目依赖路径，注意是否有多个 json 相关的依赖。
在 pom.xml 中使用下列方法排除多余版本。
```
<exclusions>
	<exclusion>
		<groupId>xxxx.json.xxx</groupId>
