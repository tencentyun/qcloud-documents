...
COS 针对 STS 提供了 SDK 和样例，目前已有 Java、Nodejs、PHP、Python、Go 等多种语言的样例。具体内容请参见 [COS STS SDK](https://github.com/tencentyun/qcloud-cos-sts-sdk)。各个 SDK 的使用说明请参见 Github 上的 README 和样例。各语言GitHub地址如下表格所示：

| 语言类型     | 代码安装地址   | 代码demo示例地址 |

| ------------------------- | ------ | ------|

| Java              | https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/java | https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/java/src/test/java/com/tencent/cloud/CosStsClientTest.java |

| .NET             | https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/dotnet | https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/dotnet/demo/Program.cs|

| Go            | https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/go |  https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/go/example/sts_demo.go|

| NodeJS       | https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/nodejs | https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/nodejs/demo/sts-server.js |

| PHP       | https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/php | https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/php/demo/sts_test.php |

| Python      | https://github.com/tencentyun/qcloud-cos-sts-sdk/tree/master/python    | https://github.com/tencentyun/qcloud-cos-sts-sdk/blob/master/python/demo/sts_demo.py |
