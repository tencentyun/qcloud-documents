...
## 相关说明
若您需要授予子账号在控制台上拉取标签列表的权限，通过授予子账号 GetResourceTags 和 GetResourcesByTags 操作权限即可实现，该操作需要在 [访问管理](https://console.cloud.tencent.com/cam/policy) 控制台，通过创建自定义策略进行授权。
...
3. 您可以根据业务需要勾选相应的操作，授予子账号 GetResourceTags 和 GetResourcesByTags 的操作权限，并将该策略关联至相应的子账号下，如下图所示。
![](https://main.qcloudimg.com/raw/f28af49f0655b98d119c2287f6323de5.jpg)
