...
其中服务器端获取临时密钥的SDK可以从[qcloud-cos-sts-sdk](https://github.com/tencentyun/qcloud-cos-sts-sdk)下载，目前支持JAVA、Node、Python版本
...
## 示例
### 搭建一个应用服务器
本示例采用 Python 编写，您可以 [单击下载](https://mc.qcloudimg.com/static/archive/29805ea3bb0f5b170527539f33d447fa/signer-release.zip)。
1. **配置参数**
