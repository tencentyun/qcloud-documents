...
腾讯云对象存储支持性能扩展，以支持更高的请求速率。如果您的请求是高 GET 请求负载，建议您搭配腾讯云 CDN 产品进行使用，详情请参见 [域名管理](https://cloud.tencent.com/document/product/436/18424)。如果预计存储桶的综合请求速率会超过每秒30000个 PUT/LIST/DELETE 请求，建议您 [联系我们](https://cloud.tencent.com/document/product/282/1558)，以便于为工作负载做好准备，避免遇到请求的限制。
