...
putBucketCorsReq.bucket = "example-1250000000";
putBucketCorsReq.finishBlock = {(result,error) in
   if error != nil{
        print(error!);
    }else{
        //可以从 result 中获取服务器返回的header信息
        print(result!);
    }
}
...
getBucketCorsRes.bucket = "example-1250000000";
getBucketCorsRes.setFinish { (corsConfig, error) in
    if error != nil{
         print(error!);
    }else{
        //CORS设置封装在corsConfig中
         print(corsConfig!);
    }
 }
...
deleteBucketCorsRequest.bucket = "example-1250000000";
...
putBucketLifecycleReq.bucket = "example-1250000000";
...
getBucketLifeCycle.bucket = "example-1250000000";
...
deleteBucketLifeCycle.bucket = "example-1250000000";
...
putBucketVersioning.bucket = "example-1250000000";
...
getBucketVersioning.bucket = "example-1250000000";
...
putBucketReplication.bucket = "example-1250000000";
...
getBucketReplication.bucket = "example-1250000000";
