...
3. 如果上传的源文件调用了该方法，那么在使用QCloudCOSXMLDownloadObjectRequest(下载)、QCloudHeadObjectRequest（查询）、QCloudCOSXMLUploadObjectReques（上传）t、QCloudCOSXMLUploadObjectRequest（copy）对源对象操作的时候也要调用该方法。
