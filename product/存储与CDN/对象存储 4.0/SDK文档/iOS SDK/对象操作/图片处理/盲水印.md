<!--
 * @Author: your name
 * @Date: 2021-04-29 19:17:50
 * @LastEditTime: 2021-04-29 20:21:49
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /qcloud-documents/product/存储与CDN/对象存储 4.0/SDK文档/iOS SDK/对象操作/图片处理/盲水印.md
-->
...
关于盲水印的功能说明请参考 [盲水印](https://cloud.tencent.com/document/product/460/19017)。
盲水印支持在上传时添加以及下载时添加。
...
// 盲水印图片在cos上的地址：如http://ci-1253653367.cos.ap-guangzhou.myqcloud.com/protection_blind_watermark_icon.png
