<!--
 * @Author: your name
 * @Date: 2021-04-27 20:10:20
 * @LastEditTime: 2021-04-29 17:06:23
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /qcloud-documents/product/存储与CDN/对象存储 4.0/SDK文档/iOS SDK/图片二维码/二维码识别.md
-->

## 简介

本文档提供关于数据万象二维码识别功能相关的 API 概览以及 SDK 示例代码。

| API                                                          | 操作名         | 操作描述                                  |
| ------------------------------------------------------------ | -------------- | ----------------------------------------- |
| [二维码识别](https://cloud.tencent.com/document/product/460/37513) | 二维码识别 | 二维码识别               |
...
据万象二维码识别功能可识别图片中有效二维码的位置及内容，输出图像中二维码包含的文本信息（每个二维码对应的 URL 或文本），并可对识别出的二维码添加马赛克。               |
