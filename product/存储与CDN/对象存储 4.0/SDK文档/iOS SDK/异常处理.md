...
返回错误码（封装在返回的 error 里）主要包括两类：客户端错误和服务端错误
...
## 服务端错误：
对于 COS 返回的错误码，是基于 HTTP 的状态码而来的，也就是404，503这类。对于这类错误码，可以参考 [错误码](https://cloud.tencent.com/document/product/436/7730) 文档寻求解决方案。也可以使用自助诊断工具，调试报错代码，快速定位问题。
...
#### 使用步骤
1. 复制异常处理返回的 [RequestId](https://cloud.tencent.com/document/product/436/57575)。
