...
## 相关文档 
更多例子请参阅 [XML Node.js SDK Demo](https://github.com/tencentyun/cos-nodejs-sdk-v5/blob/master/demo/demo.js) 。
完整接口文档请参阅 [XML Node.js SDK 接口文档](https://cloud.tencent.com/document/product/436/12264)。
