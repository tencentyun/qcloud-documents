...
### 实例化 QCloudCredentialProvider

`QCloudCredentialProvider` 是 COS 服务的授权类，可以给请求添加签名来认证您的身份，如果您是 [通过临时密钥来授权请求](replaceme)（我们强烈推荐这种方式），那么可以使用如下代码来初始化授权类：
...
| qCloudCredentialProvider   |服务请求的签名获取类 | QCloudCredentialProvider   | 是  | 
