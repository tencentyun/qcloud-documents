...
| cosXmlResultListener      | putBucketCORSAsync                                                 | CosXmlResultListener        | 否   |
...
查询指定存储桶的跨域访问配置信息（CORS）（GET Bucket cors）。
...
| headerKeys          | setSign  | 签名是否校验 header                | `Set<String>` |
| queryParameterKeys  | setSign  | 签名是否校验请求 url 中查询参数    | `Set<String>` |
| cosXmlResultListener      | getBucketCORSAsync                                                 | CosXmlResultListener        | 否   |
...
| headerKeys          | setSign  | 签名是否校验 header                | `Set<String>` |
| queryParameterKeys  | setSign  | 签名是否校验请求 url 中查询参数    | `Set<String>` |
| cosXmlResultListener      | deleteBucketCORSAsync                                                 | CosXmlResultListener        | 否   |
...
| headerKeys          | setSign  | 签名是否校验 header                | `Set<String>` |
| queryParameterKeys  | setSign  | 签名是否校验请求 url 中查询参数    | `Set<String>` |
| cosXmlResultListener      | putBucketLifecycleAsync                                                 | CosXmlResultListener        | 否   |
...
| headerKeys          | setSign  | 签名是否校验 header                | `Set<String>` |
| queryParameterKeys  | setSign  | 签名是否校验请求 url 中查询参数    | `Set<String>` |
| cosXmlResultListener      | getBucketLifecycleAsync                                                 | CosXmlResultListener        | 否   |
...
| headerKeys          | setSign  | 签名是否校验 header                | `Set<String>` |
| queryParameterKeys  | setSign  | 签名是否校验请求 url 中查询参数    | `Set<String>` |
| cosXmlResultListener      | deleteBucketLifecycleAsync                                                 | CosXmlResultListener        | 否   |
