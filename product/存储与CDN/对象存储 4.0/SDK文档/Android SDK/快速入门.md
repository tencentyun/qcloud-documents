...
4. 从 [COS v5 控制台](https://console.cloud.tencent.com/cos4/secret) 获取 APPID、SecretId、SecretKey。
...
或者使用gradle方式集成SDK到您的项目中，在您的项目（如app module）的build.gradle中添加如下语句(**推荐**)：

- compile 'com.tencent.qcloud:cosxml:5.4.8'

**注意，为了保证能够gradle成功，可以在您的工程的build.gradle 中添加如下语句：**
```html
allprojects {
    repositories {
		......
