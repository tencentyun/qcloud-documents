...
>?如果您在使用 XML 版本 SDK 时遇到函数或方法不存在等错误，请先将 XML 版本 SDK 升级到最新版再重试。如果您仍在使用 JSON 版本 SDK，请参见 [指引](https://cloud.tencent.com/document/product/436/6474#upgrade) 升级到 XML 版本 SDK。
