...
String region = ...; // region 字段请根据您的 bucket 所在地域以及 https://cloud.tencent.com/document/api/213/6976 文档来自行设置
String userAgent = ...; // 您可以随意填写，如 cos-test


/**
 * 初始化 {@link QCloudCredentialProvider} 对象，来给 SDK 提供临时密钥。
 */
QCloudCredentialProvider qCloudCredentialProvider = new SessionCredentialProvider(secretId, secretKey,
	appid, region, userAgent);
```
