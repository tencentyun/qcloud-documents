...
| API                                                          | 操作名         | 操作描述                         |
| ------------------------------------------------------------ | -------------- | -------------------------------- |
| [PostAudioAudit](https://cloud.tencent.com/document/product/436/54063) | 提交音频审核任务 | 用于提交音频审核任务         |
| [GetAudioAudit](https://cloud.tencent.com/document/product/436/54064) | 查询音频审核任务结果 | 用于查询音频审核任务结果         |
