...
| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [GET Service](https://cloud.tencent.com/document/product/436/8291) | 查询存储桶列表     | 获取指定账号下所有的存储桶列表     |
...
| [GET Bucket location](https://cloud.tencent.com/document/product/436/8275) | 查询存储桶地域信息 | 获取 Bucket 所在的地域信息         |
