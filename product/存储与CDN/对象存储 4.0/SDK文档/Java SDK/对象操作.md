...
|  成员名 | 设置方法            | 描述                                                         | 类型           |
| ------------ | ------------------- | ------------------------------------------------------------ | -------------- |
| minimumUploadPartSize   | set 方法 | 分块上传的块大小，默认为 5MB | long         |
| multipartUploadThreshold   | set 方法 | 大于等于该值则并发的分块上传文件，默认为 5MB | long         |
| multipartCopyThreshold         | set 方法 | 大于等于该值则并发的分块复制文件，默认为 5GB | long           |
| multipartCopyPartSize        | set 方法 | 分块复制的块大小，默认为 100MB           | long    |
