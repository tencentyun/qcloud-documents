...
本文档提供关于视频审核的相关 API 概览以及 SDK 示例代码，此处以动图任务举例。

| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [CreateVideoAuditingJob](https://cloud.tencent.com/document/product/436/47316) | 提交视频审核任务 | 用于提交一个视频审核任务 |
| [DescribeAuditingJob](https://cloud.tencent.com/document/product/436/47317) | 查询视频审核任务 | 用于查询视频审核任务执行情况以及结果 |
