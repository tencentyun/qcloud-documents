...
getObj.putCustomQueryParameter("ci-process", "sensitive-content-recognition");
// 这里是审核类型，具体请参考 API，这里仅是示例
getObj.putCustomQueryParameter("detect-type", "porn,politics");
