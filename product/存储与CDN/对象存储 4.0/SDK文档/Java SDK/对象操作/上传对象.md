...
分块操作是大文件上传时，使用一系列分块，改善大文件上传耗时太久可能导致的各种中断问题。关于分块上传的更多说明请参见 [分块上传](https://cloud.tencent.com/document/product/436/14112)。分块上传对象的操作流程如下。
