...
>? 
>
>- 为了避免不必要的繁琐代码排查与程序定位问题，如果您初次使用对象存储 COS，或者数据量不大，推荐使用更加友好、图形化界面的[控制台](https://cloud.tencent.com/document/product/436/11365)、[COSBrowser](https://cloud.tencent.com/document/product/436/11366),或者可批量操作的命令行工具 [COSCLI](https://cloud.tencent.com/document/product/436/63143)。
