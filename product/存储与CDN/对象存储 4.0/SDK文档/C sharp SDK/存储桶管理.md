...
try
{
	string bucket = "examplebucket-125000000"; //格式：BucketName-APPID
...
try
{
	...
	string subUin = "指定子账号的 uin";
	string ownerUin = "指定根账号的 uin";
...
|ownerUin|SetReplicationConfiguration|根账号的 uin|string|
|subUin|SetReplicationConfiguration|子账号的 uin|string|
|signStartTimeSecond|SetSign|签名有效期起始时间|long|
|durationSecond|SetSign|签名有效期时长|long|
|headerKeys|SetSign|签名是否校验 header|`List<string>`|
|queryParameterKeys|SetSign|签名是否校验请求 url 中查询参数|`List<string>`|
