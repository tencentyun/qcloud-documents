...
>! 目前已支持根据当前PHP版本下载guzzle6.x或guzzle7.x。guzzle7.x版本支持laravel8框架。当本地php版本>=7.2.5时自动下载guzzle7.x版本，反之下载guzzle6.x版本。若有问题，也可通过Composer方式`composer require --dev qcloud/cos-sdk-v5:dev-guzzle7` 安装guzzle7对应分支应用。
>
