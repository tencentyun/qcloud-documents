...
>! 以下安装方式均基于 guzzle6版本的 SDK，如需使用 guzzle7 版本(当前仅guzzle7支持laravel8)，请下载 [guzzle7](https://github.com/tencentyun/cos-php-sdk-v5/tree/guzzle7) 分支代码，通过源码方式或`composer require --dev qcloud/cos-sdk-v5:dev-guzzle7` 进行安装。
>
