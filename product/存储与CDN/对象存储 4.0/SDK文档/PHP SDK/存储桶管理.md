...
| API | 操作名 | 操作描述 |
| ------------------- | ------------ | ------------------ |
| [PUT Bucket referer](https://cloud.tencent.com/document/product/436/32492) | 设置 Referer 白名单或者黑名单   | 设置存储桶的版本控制功能 |
| [GET Bucket referer](https://cloud.tencent.com/document/product/436/32493) | 查询 Referer 白名单或者黑名单 | 查询存储桶的版本控制信息 |
