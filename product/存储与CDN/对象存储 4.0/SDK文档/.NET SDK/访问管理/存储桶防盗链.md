...
本文档提供关于设置存储桶防盗链操作的相关 API 概览以及 SDK 示例代码。


| API                                                          | 操作名             | 操作描述                           |
| ------------------------------------------------------------ | ------------------ | ---------------------------------- |
| [PUT Bucket referer](https://cloud.tencent.com/document/product/436/32492) | 设置存储桶防盗链   | 为存储桶设置 Referer 白名单或者黑名单     |
| [GET Bucket referer](https://cloud.tencent.com/document/product/436/32493) | 读取存储桶防盗链   | 读取存储桶 Referer 白名单或者黑名单     |
...
>?
> - 存储桶防盗链配置从 5.4.24 版本开始支持，下载新版SDK前往 [Releases](https://github.com/tencentyun/qcloud-sdk-dotnet/releases) 或参见 [快速入门](https://cloud.tencent.com/document/product/436/32819)
