...
CosXmlConfig config = new CosXmlConfig.Builder()
  /*
    设置访问COS使用的域名后缀, 格式为 cos/cos-internal.${region}.tencentcos.cn
    使用 cos-internal.${region}.tencentcos.cn 内网域名访问 COS, 不会产生外网流量, 但在外网环境无法被解析
    使用 cos.${region}.tencentcos.cn 外网域名访问 COS, 无论客户端处于内网或外网, 均会产生外网流量
    注意: 上述 ${region} 需要替换为存储桶所在地域名称, 地域与域名信息详见 https://cloud.tencent.com/document/product/436/6224
  */
  .SetEndpointSuffix("cos-internal.${region}.tencentcos.cn")
