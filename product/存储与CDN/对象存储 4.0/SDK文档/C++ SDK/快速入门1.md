...
1.在[OpenSSL官网](https://www.openssl.org/)下载OpenSSL源码进行编译，或者在[该网站](https://slproweb.com/products/Win32OpenSSL.html) 下选择window版本的.exe文件进行安装。
...
1.打开Windows的命令行，cd 到 Boost的源码目录下。
...
2.打开Windows的命令行，cd 到 jsoncpp的源码目录下，执行 mkdir {文件夹名} 命令，创建文件夹。
