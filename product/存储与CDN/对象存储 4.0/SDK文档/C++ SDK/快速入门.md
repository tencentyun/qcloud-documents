...
配置文件各字段介绍：
```
"SecretId":"COS_SECRETID", // V5.4.3 版本之前的 SDK 配置文件请使用"AccessKey"
"SecretKey":"COS_SECRETKEY",
"Region":"Region", // COS 地域，地域及简称请参阅 https://cloud.tencent.com/document/product/436/6224     
"SignExpiredTime":360,// 签名超时时间, 单位：s              
"ConnectTimeoutInms":6000, // connect 超时时间, 单位：ms         
"HttpTimeoutInms":60000, // http 超时时间, 单位：ms           
"UploadPartSize":1048576,// 上传文件分块大小，范围：1 MB~5 GB, 默认为 1 MB           
...
"LogoutType":1,// 日志输出类型，0：不输出，1：输出到屏幕，2：输出到 syslog                     
