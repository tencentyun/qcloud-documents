...
- 对象存储 COS 的 XML C++ SDK 源码下载地址：
 - Linux 版本：[ XML Linux C++ SDK ](https://github.com/tencentyun/cos-cpp-sdk-v5 "cos-cpp-sdk-v5下载地址")
 - Windows 版本：[ XML Windows C++ SDK ](https://github.com/tencentyun/cos-cpp-sdk-v5/tree/windows_dev "cos-cpp-sdk-v5下载地址")
