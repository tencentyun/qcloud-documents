...
| - error       | 请求报错信息                                                 | Object/String |
| - - Code      | 请求失败时 body 返回的 Error Code，更多详情请参阅 [错误码](https://cloud.tencent.com/document/product/436/7730) 文档 | String        |
| - - Message   | 请求失败时 body 返回的 Error Message，更多详情请参阅 [错误码](https://cloud.tencent.com/document/product/436/7730) 文档 | String        |
