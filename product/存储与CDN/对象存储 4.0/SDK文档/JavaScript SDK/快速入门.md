...
#### Promise
sdk同样支持Promise方式调用，比如上述代码等同于以下代码
...
#### 同步方式
同步方式基于JavaScript的async和await(使用时请注意浏览器兼容性)，上述代码等同于以下代码
...
>? 注意: 如果要使用cos.getObjectUrl方法的Promise和同步方式，需要将sdk升级至1.4.9及以上
>
...
强烈推荐使用高级上传接口uploadFile，自动针对小文件使用简单上传，大文件使用分块上传，性能更好。详情请参见 [高级上传](https://cloud.tencent.com/document/product/436/64960#.E9.AB.98.E7.BA.A7.E4.B8.8A.E4.BC.A0) 文档。
