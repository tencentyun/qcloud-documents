...
#### script 引入
>? 建议将sdk下载到本地后引入，选择[地址一](https://github.com/tencentyun/cos-js-sdk-v5/blob/master/dist/cos-js-sdk-v5.min.js)或
[地址二](https://cdn.jsdelivr.net/npm/cos-js-sdk-v5/dist/cos-js-sdk-v5.min.js) 下载最新 cos-js-sdk-v5.min.js。
```html
<!--src为本地路径 根据自己项目目录结果来调整-->
