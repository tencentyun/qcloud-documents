...
| 功能 | V5 | V4 |
| -------- | :------------: | :------------------:    |
| 文件上传 | 支持本地文件<br>默认覆盖上传<br/>有分片断点续传优化<br/>分片上传做了更多优化<br>智能判断上传模式：简单上传最大支持5GB<br>分块上传最大支持48.82TB（50,000GB）| 只支持本地文件上传<br>可选择是否覆盖<br/>有分片断点续传优化<br>小于等于20MB 使用简单上传<br/>大于20MB 自动分片上传。<br>简单上传最大支持20MB<br>分片上传最大支持64GB |
