...
| API                                                          | 操作名       | 操作描述                         |
| ------------------------------------------------------------ | ------------ | -------------------------------- |
| PUT Bucket versioning | 设置多版本状态 | 设置 Bucket 多版本状态 |
| GET Bucket versioning | 查询多版本状态 | 查询 Bucket 多版本状态   |
| DELETE Bucket versioning | 删除多版本状态 | 删除 Bucket 多版本状态   |

**跨园区复制规则**

| API                                                          | 操作名       | 操作描述                         |
| ------------------------------------------------------------ | ------------ | -------------------------------- |
| PUT Bucket Replication | 设置跨园区复制规则 | 设置 Bucket 跨园区复制规则 |
| GET Bucket Replication | 查询跨园区复制规则 | 查询 Bucket 跨园区复制规则   |
| DELETE Bucket Replication | 删除跨园区复制规则 | 删除 Bucket 跨园区复制规则   |
