...
| API                                                          | 操作名       | 操作描述                         |
| ------------------------------------------------------------ | ------------ | -------------------------------- |
| PUT Bucket replication | 设置跨地域复制规则 | 设置 Bucket 跨地域复制规则 |
| GET Bucket replication | 查询跨地域复制规则 | 查询 Bucket 跨地域复制规则   |
| DELETE Bucket replication | 删除跨地域复制规则 | 删除 Bucket 跨地域复制规则   |
