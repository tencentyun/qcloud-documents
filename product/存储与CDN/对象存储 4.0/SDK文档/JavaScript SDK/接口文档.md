...
Get Bucket Tagging 接口实现获取存储桶的 Tagging 标签信息。了解更多请参阅 [Get Bucket Tagging 接口说明](https://cloud.tencent.com/document/product/436/8276)。
...
Get Bucket Lifecycle 接口可以获取存储桶的生命周期规则。了解更多请参阅 [Get Bucket Lifecycle 接口说明](https://cloud.tencent.com/document/product/436/8278)。
