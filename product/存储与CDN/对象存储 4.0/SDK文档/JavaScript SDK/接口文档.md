...
Delete Bucket 接口请求可以在指定账号下删除 Bucket，删除之前要求 Bucket 内的内容为空，只有删除了 Bucket 内的信息，才能删除 Bucket 本身。注意，如果删除成功，则返回的 HTTP 状态码为200或204。
...
Put Bucket CORS 接口用来请求设置 Bucket 的跨域资源共享权限，您可以通过传入 XML 格式的配置文件来实现配置，文件大小限制为64KB。默认情况下，Bucket 的持有者直接有权限使用该 API 接口，Bucket 持有者也可以将权限授予其他用户。了解更多可阅读 [Put Bucket CORS 接口说明](https://cloud.tencent.com/document/product/436/8279)。
...
[Get Bucket Tagging 接口说明](https://cloud.tencent.com/document/product/436/8276) 

Get Bucket Tagging 接口实现获取存储桶的 Tagging 标签信息。
...
[Put Bucket Tagging 接口说明](https://cloud.tencent.com/document/product/436/8276) 
...
[Delete Bucket Tagging 接口说明](https://cloud.tencent.com/document/product/436/8276) 
...
[Get Bucket Policy 接口说明](https://cloud.tencent.com/document/product/436/8276) 

Get Bucket Policy 接口实现获取 Bucket 权限策略规则。
...
[Put Bucket Policy 接口说明](https://cloud.tencent.com/document/product/436/8282) 

Put Bucket Policy 接口实现设置 Bucket 权限策略规则。
...
[Delete Bucket Policy 接口说明](https://cloud.tencent.com/document/product/436/8285) 

Delete Bucket Policy 接口可以删除存储桶的权限策略。
