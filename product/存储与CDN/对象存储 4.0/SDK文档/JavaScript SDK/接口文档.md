...
方法一：
批量上传可以直接多次调用 putObject 和 sliceUploadFile，达到批量上传效果。通过实例化参数 FileParallelLimit 控制文件并发数，默认 3 个并发。
...
完整的队列使用例子如下：
[demo/queue](https://github.com/tencentyun/cos-js-sdk-v5/tree/master/demo/queue)
