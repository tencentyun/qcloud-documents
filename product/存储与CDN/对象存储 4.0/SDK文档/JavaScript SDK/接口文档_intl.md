> This document provides a detailed description of the APIs for the JavaScript SDK.
...
#### Feature description
This API (Get Object ACL) is used to obtain access permission of an Object under a Bucket. Only the Bucket owner is allowed to perform the action.
