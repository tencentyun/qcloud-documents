...
| GrantRead           | 赋予被授权者读取存储桶的权限，格式：id="[OwnerUin]"。<br>可使用半角逗号（,）分隔多组被授权者，如 'id="qcs::cam::uin/1001:uin/1001",id="qcs::cam::uin/1002:uin/1002"' | String      | 否   |
| GrantWrite          | 赋予被授权者写入存储桶的权限，格式：id="[OwnerUin]"。<br>可使用半角逗号（,）分隔多组被授权者，如 'id="qcs::cam::uin/1001:uin/1001",id="qcs::cam::uin/1002:uin/1002"' | String      | 否   |
