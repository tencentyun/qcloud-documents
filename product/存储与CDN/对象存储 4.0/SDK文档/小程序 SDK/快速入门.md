...
若是想开启该功能，请先确保sdk版本升级到1.4.0及以上，然后在初始化中指定 EnableTracker 为 true。
并在小程序域名白名单中request合法域名里添加：`https://h.trace.qq.com;https://oth.str.beacon.qq.com;https://otheve.beacon.qq.com`;
