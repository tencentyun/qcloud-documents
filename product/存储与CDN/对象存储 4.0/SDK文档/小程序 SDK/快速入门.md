...
> - XCosSecurityToken字段说明：v1.2.0之前版本的sdk只支持XCosSecurityToken，v1.2.0以及之后的版本请使用SecurityToken代替。
...
| SecurityToken | 获取回来的临时密钥的 sessionToken，对应 header 的 x-cos-security-token 字段。v1.2.0之前版本的sdk使用XCosSecurityToken而不是SecurityToken | String | 是   |
...
| SecurityToken | 获取回来的临时密钥的 sessionToken，对应 header 的 x-cos-security-token 字段。v1.2.0之前版本的sdk使用XCosSecurityToken而不是SecurityToken | String | 否   |
