...
| onProgress             | 进度回调函数，被调用时第一个参数是 processData 对象。依赖小程序 [UploadTask.onProgressUpdate](https://developers.weixin.qq.com/miniprogram/dev/api/network/upload/UploadTask.onProgressUpdate.html) ，在部分安卓机型上会有进度不准的问题          | Function | 否   |
