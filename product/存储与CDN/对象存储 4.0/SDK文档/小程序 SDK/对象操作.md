...
| 参数名 | 参数描述                                                     | 类型   | 是否必填 |
| ------ | ------------------------------------------------------------ | ------ | ---- |
| taskId | 文件上传任务的编号，在调用 putObject 方法时，其 TaskReady 回调将返回该上传任务的 taskId | String | 是   |xxxxxxxxxx # 假设申请的consul地址为：10.0.1.32:8500-Dspring.cloud.consul.host=10.0.1.32 -Dspring.cloud.consul.port=8500 -Dspring.cloud.consul.discovery.preferIpAddress=truebash | 
