...
| XCosStorageClass     | 文件的存储类型，例如 STANDARD、STANDARD_IA、ARCHIVE，默认值：STANDARD。更多存储类型，请参见 [存储类型概述](https://cloud.tencent.com/document/product/436/33417) | string      | 否       |
...
| StorageClass       | 用来表示分块的存储类型，例如 STANDARD、STANDARD_IA、ARCHIVE，默认值：STANDARD。更多存储类型，请参见 [存储类型概述](https://cloud.tencent.com/document/product/436/33417) | string    |
...
| StorageClass         | 文件的存储类型，例如 STANDARD、STANDARD_IA、ARCHIVE，默认值：STANDARD。更多存储类型，请参见 [存储类型概述](https://cloud.tencent.com/document/product/436/33417) | string |
