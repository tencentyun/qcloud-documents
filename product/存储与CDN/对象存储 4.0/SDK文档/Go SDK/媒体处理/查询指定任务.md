...
本文档提供关于 查询指定任务 接口的 API 概览和 SDK 示例代码。

| API                        |             操作名                     | 操作描述                                               |
| ------------------------------------------------------------ | --------------------------|---------------------------- |
| [DescribeMultiMediaJob](https://cloud.tencent.com/document/product/436/54010) | 查询指定任务接口 | 查询指定JobId任务详情 |
...
jobids = append(jobids, "j4dbe277e692411ecbf660f1bc2f629f2")
...
| NonExistJobIds      | 不存在任务Id列表                     | String数组    |
