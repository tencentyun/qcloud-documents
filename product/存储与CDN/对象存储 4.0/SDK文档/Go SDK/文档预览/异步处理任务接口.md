...
| Code         | 错误码，只有 State 为 Failed 时有意义                        | Container |
| Message      | 错误描述，只有 State 为 Failed 时有意义                      | Container |
| JobId        | 新创建任务的 ID                                              | Container |
| Tag          | 新创建任务的 Tag：DocProcess                                 | Container |
| State        | 任务的状态，为 Submitted、Running、Success、Failed、Pause、Cancel 其中一个 | Container |
| CreationTime | 任务的创建时间                                               | Container |
| QueueId      | 任务所属的队列 ID                                            | Container |
