...
- [NPM 地址](https://pub.flutter-io.cn/packages/tencentcloud_cos_sdk_plugin)

## 准备工作

1. 您需要一个纯 React Native 项目或 React Native 原生混合项目，这个应用可以是您现有的工程，也可以是您新建的一个空的工程。
2. React Native 版本要求：0.63.4 及以上

## 第一步：SDK 介绍
tencentcloud-cos-sdk-react-native 目前兼容支持 iOS、Android，是通过 React Native 桥接原生 [Android](https://cloud.tencent.com/document/product/436/12159) 和 [iOS](https://cloud.tencent.com/document/product/436/11280) 的 COS SDK 实现。
...
使用npm:
```
npm install --save tencentcloud-cos-sdk-react-native
```
或者使用yarn:
```
yarn add tencentcloud-cos-sdk-react-native
```
