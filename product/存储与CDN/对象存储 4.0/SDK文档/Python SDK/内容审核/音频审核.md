...
调用 ci_auditing_audio_submit 函数，会把 api 里面的 xml 返回转换成 dict，具体返回参数可查看如下文档：

[提交音频审核任务](https://cloud.tencent.com/document/product/460/53395) 文档。
...
调用 ci_auditing_audio_query 函数，会把 api 里面的 xml 返回转换成 dict，具体返回参数可查看如下文档：

[查询音频审核任务结果](https://cloud.tencent.com/document/product/460/53396) 文档。
