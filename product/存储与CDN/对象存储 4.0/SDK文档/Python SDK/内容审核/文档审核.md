...
调用 ci_auditing_document_submit 函数，会把 api 里面的 xml 返回转换成 dict，具体返回参数可查看如下文档：

[提交文档审核任务](https://cloud.tencent.com/document/product/460/59380) 文档。
...
调用 ci_auditing_document_query 函数，会把 api 里面的 xml 返回转换成 dict，具体返回参数可查看如下文档：

[查询文档审核任务结果](https://cloud.tencent.com/document/product/460/59383) 文档。
