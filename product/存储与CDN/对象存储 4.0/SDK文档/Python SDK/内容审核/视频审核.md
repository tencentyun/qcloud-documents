...
调用 ci_auditing_video_submit 函数，会把 api 里面的 xml 返回转换成 dict，具体返回参数可查看 [提交视频审核任务](https://cloud.tencent.com/document/product/460/46427) 文档。
...
调用 ci_auditing_video_query 函数，会把 api 里面的 xml 返回转换成 dict，具体返回参数可查看 [查询视频审核任务结果](https://cloud.tencent.com/document/product/460/46926) 文档。
