...
| Protocol                    | 全站重定向协议，可选值为http、https                          | String | 否       |
...
| Protocol                    | 重定向的协议，可选值为http,https                             | String | 否       |
| ReplaceKeyPrefixWith        | 重定向时替换前缀为指定的key                                  | String | 否       |
| ReplaceKeyWith              | 重定向时替换整个路径为指定的key                              | String | 否       |
...
| Protocol                    | 全站重定向协议，可选值为http、https      | String |
...
| Protocol                    | 重定向的协议，可选值为http、https        | String |
