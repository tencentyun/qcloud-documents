...
| [GET Service](https://cloud.tencent.com/document/product/460/37513) | 下载时识别二维码 | 下载图片对象时识别图片二维码并返回二维码信息         |
...
```python
   put_ci_object_from_local_file_and_get_qrcode(Bucket, LocalFilePath, Key, EnableMD5=False, **kwargs) 
```
...
| PicOperations |在本接口中，可变参数固定为'PicOperations'，具体参考下面说明 |String|是|
