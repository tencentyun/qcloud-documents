...
| URI |Type 为 Group 时，填入预设用户组的 URI，比如 http://cam.qcloud.com/groups/global/AllUsers， 详情请参见 [ACL 概述](https://cloud.tencent.com/document/product/436/30752#.E8.BA.AB.E4.BB.BD-grantee)|String|当 Grantee 的 Type 指定为 Group 时必选|
...
| Type |权限被授予者的类型，类型为 CanonicalUser 或者 Group|String|是|
| ID |Type 为 CanonicalUser 时，对应权限授予者的 ID，格式为 qcs::cam::uin/[OwnerUin]:uin/[OwnerUin]，如 qcs::cam::uin/100000000001:uin/100000000001|String|当 Grantee 的 Type 指定为 CanonicalUser 时必选|
| URI |Type 为 Group 时，填入预设用户组的 URI，比如http://cam.qcloud.com/groups/global/AllUsers， 详情请参见 [ACL 概述](https://cloud.tencent.com/document/product/436/30752#.E8.BA.AB.E4.BB.BD-grantee)|String|当 Grantee 的 Type 指定为 Group 时必选|
