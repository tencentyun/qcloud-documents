...
| err      | 请求发生错误时返回的对象，包括网络错误和业务错误，如果请求成功则为空，更多详情请参见 [错误码](https://cloud.tencent.com/document/product/436/7730) 文档 | Object |
| data     | 请求成功时返回的对象，如果请求发生错误，则为空               | Object |
| Bucket   | 分片上传的目标存储桶，格式为 BucketName-APPID，如：examplebucket-1250000000 | String |
| Key      | 对象键（Object 的名称），对象在存储桶中的唯一标识，详情请参见 [对象概述](https://cloud.tencent.com/document/product/436/13324) | String |
...
> !
>
> 1. 如果目标对象和源对象不属于同一个地域，且目标对象分块会超过5GB, 那么需要使用复制对象或者 [分块上传对象](https://cloud.tencent.com/document/product/436/35649#.E5.88.86.E7.89.87.E4.B8.8A.E4.BC.A0.E5.AF.B9.E8.B1.A1) 的接口来复制对象。
