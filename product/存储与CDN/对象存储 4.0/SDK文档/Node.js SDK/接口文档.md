...
|   Key | 对象键，对象在存储桶中的唯一标识。 [对象键说明](https://cloud.tencent.com/document/product/436/13324) | String |
...
| Bucket| Bucket 的名称。命名规则为{name}-{appid} ，此处填写的存储桶名称必须为此格式 |   String|   是| 
| Region | Bucket 所在区域。枚举值请见：[Bucket 地域信息](https://cloud.tencent.com/document/product/436/6224)|String|是|
| Key | 对象键，对象在存储桶中的唯一标识。 [对象键说明](https://cloud.tencent.com/document/product/436/13324) | String | 是 |
