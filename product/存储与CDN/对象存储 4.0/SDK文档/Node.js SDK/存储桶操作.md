...
| - - Location    | 存储桶所在地域。枚举值请参阅 [地域和访问域名](https://cloud.tencent.com/document/product/436/6224) 文档，例如 ap-guangzhou，ap-beijing，ap-hongkong 等 | String |
...
| - - DisplayName    | 存储桶持有者的名称                                           | String      |
| - - ID             | 存储桶持有者的完整 ID<br>格式：qcs::cam::uin/&lt;OwnerUin>:uin/&lt;SubUin> <br>如果是主帐号，&lt;OwnerUin> 和 &lt;SubUin> 是同一个值 | String      |
