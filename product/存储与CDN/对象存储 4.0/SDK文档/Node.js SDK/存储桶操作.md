...
| GrantRead        | 赋予被授权者读取存储桶的权限，格式：id="[OwnerUin]"。可使用半角逗号（,）分隔多组被授权者，<br>例如`'id="qcs::cam::uin/100000000001:uin/100000000001", id="qcs::cam::uin/100000000002:uin/100000000002"'`` | String | 否   |
