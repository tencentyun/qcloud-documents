...
cos.putBucketPolicy({
    ...
    Policy: {
        ...
        "Statement": [{
            ...
            "Resource": ["qcs::cos:COS_REGION:uid/1250000000:examplebucket-1250000000/*"],
        }]
    },
}, function(err, data) {
    console.log(err || data);
...
| - - resource  | 相关的资源标识字符串列表<br>格式：`qcs::cos:<Region>:uid/<AppId>:<ShortBucketName>/*`<br>例如：`qcs::cos:COS_REGION:uid/1250000000:examplebucket/*` | StringArray | 是   |
...
| - - - resource  | 相关的资源标识字符串列表<br>格式：`qcs::cos:<Region>:uid/&ltAppId>:<ShortBucketName>/*`<br>例如：`qcs::cos:COS_REGION:uid/1250000000:examplebucket/*` | StringArray |
