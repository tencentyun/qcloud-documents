        ...
        <td rowspan="4">存储桶</td>
    	 ...
    	 <tr>
    		...
    		<tr>
    			...
    			<td >API 文档中涉及的接口参数均为 COS 保留字段，包括但不限于：</br>acl、uploads、policy、cors、delete、versions、location、referer、lifecycle、versioning、</br>notification、replication、website、logging、tagging、accelerate、domain、inventory、origin、</br>object-lock、encryption、intelligenttiering、symlink 等。</td>
    		</tr>
</table>
