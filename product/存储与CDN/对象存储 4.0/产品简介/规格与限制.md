...
<br>如需更高 QPS，请参见 <a href="/document/product/436/13653">请求速率与性能优化</a>。</td>
        ...
        <td>带宽</td>
    			<td>限制</td>
					<td>中国大陆公有云地域默认带宽为15Gbit/s、其他地域为10Gbit/s。如果带宽达到该阈值，请求会触发流控。如果有更高带宽需求，请联系 <a href="https://cloud.tencent.com/document/product/436/6239">售后工程师</a>。</td>	
    </tr>
    	 <tr>
        <td rowspan="3">存储类型</td>
    			<td>标准存储（多 AZ）/标准存储限制</td>
    			<td>计费限制：<br>存储时间、存储单元无限制。<br>标准存储计费详情，请参见 <a href="https://cloud.tencent.com/document/product/436/6239">产品定价</a>。</td>
    </tr>
    	 <tr>
        <td>低频存储（多 AZ）/低频存储限制</td>
    			<td>计费限制：<br>存储时间不足30天，按30天计算。<br>存储单元不足64KB，按64KB计算。<br>低频存储计费详情，请参见 <a href="https://cloud.tencent.com/document/product/436/6239">产品定价</a>。</td>
    </tr>
    	 <tr>
        <td>归档存储限制</td>
    			<td>计费限制：<br>存储时间不足90天，按90天计算。<br>存储单元不足64KB，按64KB计算。<br>归档存储计费详情，请参见 <a href="https://cloud.tencent.com/document/product/436/6239">产品定价</a>。</td>				
    </tr>
     <tr>
        <td rowspan="3">存储桶</td>
    			<td>限制</td>
    	 ...
    	 <tr>
    		...
    		<tr>
    			<td >存储类型转化</td>
    			<td >标准转低频：最小1天。<br>标准/低频转归档：最小1天。<br>注意：标准存储（多 AZ）和低频存储（多 AZ）暂不支持沉降为低频存储和归档存储类型。</td>
    		</tr>
    		 <tr>
    			<td >过期删除</td>
