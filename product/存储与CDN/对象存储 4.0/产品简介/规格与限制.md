<table>
 ...
        <td>带宽</td>
        ...
        <td rowspan="4">存储类型</td>
    			<td>标准存储（多AZ）限制</td>
    			<td>计费限制：<br>存储时间、存储单元无限制<br>标准存储（多AZ）计费详情，请参见 <a href="https://cloud.tencent.com/document/product/436/6239">费用说明</a></td>
    </tr>
    	 <tr>
    			<td>标准存储限制</td>
 ...
    			<td>规则数量</td>
    		...
    		<tr>
    			<td >存储类型转化</td>
    			<td >标准转低频：最小1天<br>标准/低频转归档：最小1天<br>注意：标准存储(多AZ)暂不支持沉降为低频存储和归档存储类型 </td>
    		</tr>
    		 <tr>
    			<td >过期删除</td>
