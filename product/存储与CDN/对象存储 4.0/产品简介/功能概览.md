<table>
 ...
    			<td> 每个存储桶中，对象数不限</td>
    		<tr>
    			<td rowspan="4">对象</td>
    			<td>限制</td>
    			<td >键<sup><font color="#3300ff">注</font></sup>长度最大 850 B <br> 
                     键<sup><font color="#3300ff" size=-2><a href="#add">注</a></font></sup>长度最大 850 B 
...
<a name="add"> </a><!-- 定义锚点 --> 
> <a name="add"><font color="#3300ff">**注：**</font></a>
