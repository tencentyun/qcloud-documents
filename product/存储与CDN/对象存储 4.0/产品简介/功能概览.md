...
<table>
   ...
   <tr>
      <td>媒体处理</td>
      <td>针对已存在于存储桶中的文件，您可以创建任务进行媒体处理操作。目前支持创建文件转码、视频截帧、视频转动图和智能封面四种任务，操作指引请参见 <a href="https://cloud.tencent.com/document/product/436/48985">创建媒体处理任务</a></td>
   </tr>
   <tr>
      <td>内容审核</td>
      <td>内容审核服务基于腾讯云数据万象，开启之后，新增的图片、视频和音频文件会在上传时自动进行检测，并支持自动冻结（禁止公有读访问）已检测的违规内容，详情请参见 <a href="https://cloud.tencent.com/document/product/436/45435">  内容审核概述</a></td>
   </tr>
   <tr>
      <td>语音识别</td>
   ...
   <tr>
      ...
      <td>COS 支持多种传输协议，包括 HTTP1.0/1.1协议、QUIC 和 HTTP2.0协议，同时支持 TLS1.0,1.1,1.2加密协议。其中 QUIC 和 HTTP2.0正在内测阶段，如需使用请通过 <a href="https://cloud.tencent.com/online-service">在线支持</a> 或 <a href="https://console.cloud.tencent.com/workorder/category">提交工单</a> 联系我们，我们将为您开通白名单。</td>
   </tr>
</table>
