...
<table>
   ...
   <tr>
      ...
      <td>COS 支持多种传输协议，包括 HTTP1.0/1.1协议、QUIC 和 HTTP2.0协议，同时支持 TLS1.0,1.1,1.2加密协议。其中 QUIC 和 HTTP2.0为内测协议，如需使用请通过 <a href="https://cloud.tencent.com/online-service">在线支持</a> 或 <a href="https://console.cloud.tencent.com/workorder/category">提交工单</a> 联系我们，我们将为您开通白名单。</td>
   </tr>
</table>
