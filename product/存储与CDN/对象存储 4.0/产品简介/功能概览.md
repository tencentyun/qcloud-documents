...
<table>
   ...
   <tr>
      <td>对象操作</td>
      <td>多种存储类型：根据对象访问频度的高低，COS 提供四种对象的存储类型：标准存储（多AZ）、标准存储、低频存储、归档存储，详情请参见 <a href="https://cloud.tencent.com/document/product/436/33417">存储类型</a><br>对象/文件夹：上传、查询、下载、复制和删除操作，具体操作请参见 <a href="https://cloud.tencent.com/document/product/436/13321">对象管理</a> 目录下的文档</td>
   </tr>
   <tr>
