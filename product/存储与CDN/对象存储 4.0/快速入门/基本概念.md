...
```
**其中 example 表示 Bucket 名称、12345678 表示 APPID、.cosgz.myqcloud.com 表示 COS 地域标识。a.doc 表示上传到 Bucket 根目录下的文件。**
...
```
 
**其中 example 表示 Bucket 名称、12345678 表示 APPID、.cosgz.myqcloud.com 表示 CDN 加速标识、a.doc 表示上传到 Bucket 根目录下的文件。**
