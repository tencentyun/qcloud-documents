...
> 注意：为方便用户使用，原迁移工具和本地同步工具已升级合并为COS Migration 工具，原迁移工具和本地同步工具即将下线，对您造成的不便我们深表歉意！

| 工具 | 功能说明 | 版本限制|
|---------|---------|---------|
| [COSCMD 工具](/doc/product/436/10976) | 本工具支持用户使用简单的命令行指令实现对对象的批量上传、下载、删除等操作。| 适用于 COS V4、V5 版本 |
| [COS Migration 工具](/document/product/436/15392)| 本工具支持用户从本地、其他云存储等多种源数据地址迁移至COS。| 适用于 COS V4、V5 版本 |
