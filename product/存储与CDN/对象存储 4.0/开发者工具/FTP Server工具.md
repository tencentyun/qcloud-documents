...
- 依赖包：
 - [cos-python-sdk-v5](https://github.com/tencentyun/cos-python-sdk-v5) （≥1.6.5）
...
## 常见问题
如您在使用 FTP Server 工具过程中，有报错或对上传限制有疑问，请参见 [FTP Server 工具类常见问题](https://cloud.tencent.com/document/product/436/30742)。
