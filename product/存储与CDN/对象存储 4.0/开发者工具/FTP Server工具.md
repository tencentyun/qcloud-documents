COS FTP Server 支持通过 FTP 协议直接操作 COS 中的对象和目录，包括上传文件、下载文件、删除文件以及创建文件夹等。
## 使用环境
### 系统环境
...
### 下载与安装
下载链接：[COS FTP Server 工具](https://mc.qcloudimg.com/static/archive/02732b3693a90b8b6f4d7f01a40801b3/cos-ftp-server-V5-master.zip)。
...
#### 其他问题，请在工单上附上完整的`cos_v5.log`日志，便于我们进一步排查和解决问题。
