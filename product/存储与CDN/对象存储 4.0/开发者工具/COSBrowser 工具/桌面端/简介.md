...
| [设置网络代理](https://cloud.tencent.com/document/product/436/38103#settingNetworkAgent)       | 支持设置网络代理来访问 COS                                   |
| [设置传输并发数](https://cloud.tencent.com/document/product/436/38103#settransfers)     | 支持设置文件上传、下载的传输并发数                           |
| [设置传输分块数](https://cloud.tencent.com/document/product/436/38103#setblocks)     | 支持设置文件分块上传、下载的分块数                           |
| [设置传输失败重试数](https://cloud.tencent.com/document/product/436/38103#setupretry) | 支持设置文件上传、下载失败时的重试次数                       |
| [设置上传二次校验](https://cloud.tencent.com/document/product/436/38103#setupupload)   | 支持对上传至存储桶中的文件进行二次校验                       |
| [设置上传计算 md5](https://cloud.tencent.com/document/product/436/38103#setupmd5)   | 支持对上传至存储桶中的文件计算其 md5 并添加至自定义的 Headers |
| [本地日志](https://cloud.tencent.com/document/product/436/38103#viewlog)           | 支持将用户对 COSBrowser 的操作记录以本地日志的形式保存       |
