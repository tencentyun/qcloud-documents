...
| 名称              | 描述                                       | 有效值      |
| --------------- | ---------------------------------------- | -------- |
| app_id          | 需要进行操作的 APPID，可从控制台获取，参考 [APP ID 和密钥](/doc/product/436/6247)。 | APPID 数字 |
| secret_id       | APPID 对应的秘钥 ID，可从控制台获取，参考 [APP ID 和密钥](/doc/product/436/6247)。 | 字符串      |
| secret_key      | APPID 对应的秘钥 Key，可从控制台获取，参考 [APP ID 和密钥](/doc/product/436/6247)。 | 字符串      |
| bucket          | 指定要同步的 bucket 名称， 需要提前在控制台建立，参考 [创建 Bucket](/doc/product/436/6245)。 | 字符串      |
