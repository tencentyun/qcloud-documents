...
```
# appid 信息(可在 https://console.qcloud.com/capi 查看)
appid=12500000
...
# 用户的bucket名称
bucket=mybucket
# bucket的region信息. COS地域的简称请参照 https://www.qcloud.com/document/product/436/6224
region=ap-beijing-1
...
| region          | 存储桶所属地域。枚举值为 [可用地域](https://www.qcloud.com/document/product/436/6224) 中适用于 XML API 的地域简称，如 ap-beijing 等。 | 字符串      |
