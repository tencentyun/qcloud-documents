...
public class Demo {
    private static FileSystem initFS() throws IOException {
        ...
        conf.set("fs.cosn.userinfo.secretId", "AKIDkJcePt62i7F5ewxhAMHvIPEm32i7E4ex");
        conf.set("fs.cosn.userinfo.secretKey", "4rMaYFenfGbhW4LL4WgZCYdRxCAsJTMy");
        conf.set("fs.ofs.user.appid", "1259378398");
