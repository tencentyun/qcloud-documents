...
命令格式为：`hadoop fs -ls -R cosn://bucket-appid/<路径>`或`hadoop fs -ls -R /<路径>`(需要配置fs.defaultFS选项为 cosn://bucket-appid) ，下例中以名称为 hdfs-test-1252681929 的 bucket 为例，可在其后面加上具体路径。
