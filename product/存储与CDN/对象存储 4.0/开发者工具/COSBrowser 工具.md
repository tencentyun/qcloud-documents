...
>!
>- COS Browser 运行时将使用系统配置的代理来尝试网络连接，请确保您的代理配置正常或停用无法连接互联网的代理配置。Windows 用户可在操作系统的“Internet 选项”中查询，macOS 用户可在“网络偏好设置”中查询。
...
## 软件界面
![](https://main.qcloudimg.com/raw/6b36f6090281ac7925544ac42bbef55c.png)
