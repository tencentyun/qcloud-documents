...
自2022年7月1日至2022年9月1日，COS **存储容量、请求及数据取回**计费项将由**按月结算**陆续升级为**按日结算**，便于您通过日结账单做更精细的费用管理。本次发布将按用户分批升级，升级时间分别为7月1日、8月1日、9月1日。具体升级时间，以您收到的通知（站内信、邮件及短信）为准。您已出账的账单不变，不会受到影响，您无须做任何操作。关于计费模式与账单统计周期，请见 [账单介绍](https://cloud.tencent.com/document/product/555/30250#.E8.AE.A1.E8.B4.B9.E6.A8.A1.E5.BC.8F.E4.B8.8E.E8.B4.A6.E5.8D.95.E7.BB.9F.E8.AE.A1.E5.91.A8.E6.9C.9F)。
...
自2022年7月1日至2022年9月1日，按月结算将陆续升级为按日结算。升级时间分别为7月1日、8月1日、9月1日。具体升级时间，请以通知（站内信、邮件及短信）中的升级时间为准。升级完成后，将在次日出上一天的账单，请您留意账单变化。
