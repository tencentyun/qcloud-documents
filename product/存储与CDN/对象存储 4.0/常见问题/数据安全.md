...
最长 2 小时，即 7200 秒。有关临时密钥的介绍请参阅 [临时密钥生成及使用指引](https://cloud.tencent.com/document/product/436/14048)。
...
COS 的 ACL + Policy 数量限制是 1000 条，当设置的 相关 ACL 或 Policy 策略大于 1000 条时，会出现此报错，因此建议删除无用的 ACL 或 Policy 策略。
...
详情请参阅 [授权子账号访问 COS ](https://cloud.tencent.com/document/product/436/11714)，创建子账号，并对其授权。
