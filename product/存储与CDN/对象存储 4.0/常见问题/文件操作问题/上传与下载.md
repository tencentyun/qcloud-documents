...
您可以通过 [对象存储控制台](https://console.cloud.tencent.com/cos5) 将对象自定义 Headers 中的 Content-Disposition 参数值设为 attachment。控制台操作指南请参见 [自定义 Headers](https://cloud.tencent.com/document/product/436/13361)。
