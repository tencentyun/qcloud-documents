...
-447错误码是由于图片分辨率超出限制或动图帧数过多导致图片处理失败。请将图片长宽限制在9999像素以内。针对动图，原图宽 x 高 x 帧数不超过1亿像素，动图请限制帧数。
...
暂不支持上传时添加水印。您可以使用数据万象服务，在访问图片时，为图片添加水印，目前支持 [文字水印](https://cloud.tencent.com/document/product/436/44888) 、[图片水印](https://cloud.tencent.com/document/product/436/44887)、[盲水印](https://cloud.tencent.com/document/product/436/46782) 三种。
