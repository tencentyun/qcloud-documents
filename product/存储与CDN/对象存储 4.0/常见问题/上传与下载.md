...
在上传文件时，在头部中指定 Content-Type 字段为您所需的类型，并计算签名后携带签名链接上传即可。有关头部信息的介绍请参见 [PUT Object](https://cloud.tencent.com/document/product/436/7749)，有关签名链接介绍请参见 [请求签名](https://cloud.tencent.com/document/product/436/7778)。

### 如何在上传时限制文件大小？

在上传文件时，在头部中指定 Content-Length 字段为您所需限制的文件大小，并计算签名后携带签名链接上传即可。有关头部信息的介绍请参见 [PUT Object](https://cloud.tencent.com/document/product/436/7749)，有关签名链接介绍请参见 [请求签名](https://cloud.tencent.com/document/product/436/7778)。
