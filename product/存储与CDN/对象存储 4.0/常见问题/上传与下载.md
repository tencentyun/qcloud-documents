...
可通过 [SDK 方式](https://cloud.tencent.com/document/product/436/8629) 批量上传或是使用 [COSBrowser 工具](https://cloud.tencent.com/document/product/436/11366) 批量上传。


### COS 如何批量下载文件？

可以使用 [COSBrowser 工具](https://cloud.tencent.com/document/product/436/11366) 批量下载文件。
