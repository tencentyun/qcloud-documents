...
假设主账户 A 名下的存储桶需要授权给主账户 B 下的子账户 B0 操作权限，您需要先授予主账号 B 操作 A 名下存储桶的权限，在通过主账户 B 授予子账号 B0 操作 A 名下存储桶的权限。详情操作可参见 [授予其他主帐号下的子帐号操作名下存储桶的权限](https://cloud.tencent.com/document/product/436/38648)。
