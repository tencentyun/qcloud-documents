...
您可以借助 COS 团队为开发者提供的 [自助诊断工具](https://console.cloud.tencent.com/cos/diagnose/), 自助诊断工具可以通过请求的RequestId，帮助您进行操作异常的诊断。
...
COS 团队为开发者提供了 [自助诊断工具](https://console.cloud.tencent.com/cos/diagnose/), 自助诊断工具可以通过请求的RequestId，帮助您进行操作异常的诊断。
