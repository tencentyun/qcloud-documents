...
![](https://qcloudimg.tencent-cloud.cn/raw/afff907aa9276e621486a4e80f24466b.png)
 - **回源模式**：可根据实际需求选择回源模式。
 ...
 - **透传指定请求头部**：此处可以添加您想透传给源站的请求中带有的头部信息。若选择重定向回源类型，则不设置该项。
...
<dx-tabs>
::: 异步回源
![](https://qcloudimg.tencent-cloud.cn/raw/2aa6e85862c42080284a4fc4ed094712.png)
...
>!
>- 对于备份回源地址设置，您可选择不设置、固定文件设置或者前后缀设置。
>- 指定前缀和指定后缀的配置可以同时生效。
>
...
:::
::: 重定向
![](https://qcloudimg.tencent-cloud.cn/raw/ff671c282406dd439e8b03877afddb3f.png)
 - **回源地址**：只需填入域名或 IP 地址，支持域名或 IP 地址后面添加端口号。无需加上前缀`http://`或`https://`。
正确示例地址如下：
```shell
abc.example.com
