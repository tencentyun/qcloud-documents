...
4. 在左侧导航栏中，选择**域名与传输管理 > 自定义源站域名**，单击**添加域名**，配置如下选项。
  ...
  - **源站类型**：分为以下几种
  - （1）默认源站：默认源站，存储桶未开启静态网站和全球加速功能。
  - （2）静态网站：存储桶开启了静态网站功能，即为静态网站源站。如果您的自定义域名需要用作静态网站，请使用静态网站源站并开启存储桶的静态网站功能。
  - （3）全球加速源站：存储桶开启了全球加速功能，即为全球加速源站。如果您的自定义域名需要用作全球加速，请使用全球加速源站并开启存储桶的全球加速功能。
