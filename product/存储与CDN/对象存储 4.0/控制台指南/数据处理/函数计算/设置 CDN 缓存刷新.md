...
> - 已上线云函数的地域均已支持 CDN 缓存刷新功能，包括有广州、上海、北京、成都、中国香港、新加坡、孟买、多伦多、硅谷等，更多支持地域可查看 [云函数产品文档](https://cloud.tencent.com/document/product/583)。
...
![](https://qcloudimg.tencent-cloud.cn/raw/f0a56743ed6fc735ba696cf3bb2571b3.png)
	- **函数名称**：函数名称作为函数的唯一标识名称，其中函数名称前缀您可以根据业务场景进行自定义，且创建后不可修改。您可以在 [云函数控制台](https://console.cloud.tencent.com/scf/list?rid=1&ns=default) 上查看该函数。
