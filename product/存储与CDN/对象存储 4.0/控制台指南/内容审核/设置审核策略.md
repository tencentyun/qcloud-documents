...
<table>
   ...
   <tr>
      <td rowspan="10">图片审核策略、视频审核策略、<br>音频审核策略、文本审核策略、文档审核策略、网页审核策略</td>
...
>! 
> 低质内容检测将产生额外的费用，具体如下：
> - 低质量图片检测：将产生数据万象[图片质量检测费用](https://cloud.tencent.com/document/product/436/58964#.E5.9B.BE.E7.89.87.E8.B4.A8.E9.87.8F.E8.AF.84.E4.BC.B0.E8.B4.B9.E7.94.A8)。
> - 无人直播检测：将产生数据万象[人体识别费用](https://cloud.tencent.com/document/product/436/58964#.E5.85.B6.E4.BB.96.E8.B4.B9.E7.94.A8)。
## 操作步骤
