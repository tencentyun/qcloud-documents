...
审核策略创建完毕后，在配置 [增量审核](https://cloud.tencent.com/document/product/436/47247) 、创建 [存量审核任务](https://cloud.tencent.com/document/product/436/54462) 、调用 [内容审核 API 接口](https://cloud.tencent.com/document/product/436/54061) 时，您需要选择对应的策略，即可在审核时按自定义的分类进行审核。
