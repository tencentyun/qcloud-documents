...
**访问存储桶列表受限示例**：
![新](https://main.qcloudimg.com/raw/bcdd7dccbdafc41e74ce60965db41715.jpg)

**访问统计数据受限示例**：
![新](https://main.qcloudimg.com/raw/a1139c7b0530348639c253913a3079bc.jpg)

**子账号**需要通过 [添加访问路径](#.E6.B7.BB.E5.8A.A0.E8.AE.BF.E9.97.AE.E8.B7.AF.E5.BE.84) 的方式访问存储桶，或者主账号为子账号 [添加预设策略](#.E6.B7.BB.E5.8A.A0.E9.A2.84.E8.AE.BE.E7.AD.96.E7.95.A5) QcloudCOSGetServiceAccess（获取存储桶列表访问权限）的方式来访问存储桶列表。
...
主账号需事先授予子账号某一存储桶的用户权限，详情请参见 [设置访问权限](https://cloud.tencent.com/document/product/436/13315)。
...
![](https://main.qcloudimg.com/raw/cac5cb854f87abb43acb9a2cce1fae61.jpg)
...
>?至此您已完成通过主账号为子账号添加预设策略，此时通过子账号登录 COS 控制台，即可正常查看存储桶列表和统计数据。
