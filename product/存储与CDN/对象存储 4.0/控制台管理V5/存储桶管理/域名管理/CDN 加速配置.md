...
1. 登录 [对象存储控制台](https://console.cloud.tencent.com/cos5) ，单击左侧【存储桶列表】菜单栏，选择需要配置域名的存储桶并进入，如下图所示： 
![](https://main.qcloudimg.com/raw/b90ad17947a0ec530db87210f4b9027d.png)
2. 单击上方的【域名管理】项，找到**自定义加速域名**栏后，单击【添加域名】，输入待绑定的自定义域名（如 ` www.example.com`），选择开启**回源鉴权**，最后单击右侧的【保存】即可添加域名，配置项说明如下：
**域名：**：请确保输入的域名已备案，并已在 DNS 服务商处设置好对应的 CNAME，详情请参阅 [CNAME 配置 ](https://cloud.tencent.com/document/product/228/3121)。
**回源鉴权：**：对于私有读存储桶，请开启**回源鉴权**以保护源站。
![](https://main.qcloudimg.com/raw/0bfbd7e43e19f9bf8e0d42e2957fc1b8.png)
3. 单击【保存】后，**CDN 鉴权**栏会出现 CDN 鉴权功能开关，可开启自定义域名 CDN 鉴权。
