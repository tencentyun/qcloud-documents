...
![](https://main.qcloudimg.com/raw/86692d29516692d217197d2867688a76.png)

- **规则名称**：为您的生命周期规则设置名称，便于管理；

 - **应用范围**：本生命周期规则可以作用于整个存储桶，也可以作用于存储桶下某一个特定的前缀，如`doc/` ；当选择 “指定前缀” 时，则需要填写前缀。
...
4. 配置好生命周期规则后，单击【确定】保存。当需要停止生命周期规则时，只需要将对应规则的状态修改为 **关闭** 即可。
![](https://main.qcloudimg.com/raw/a8e57022d7120da05aa9d2d088eb4145.png)
