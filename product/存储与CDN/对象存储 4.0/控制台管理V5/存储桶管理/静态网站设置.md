...
## 设置步骤
1. 登录 [对象存储控制台](https://console.cloud.tencent.com/cos5)，单击左侧菜单栏【存储桶列表】，单击需要设置静态网站的存储桶（如 example-1253833564），进入存储桶。

2. 单击顶部的【权限管理】项，找到 **存储桶访问权限**，选择公共权限为 **公有读私有写**。

3. 单击顶部的【基础配置】，下拉找到 **静态网站**，单击【编辑】，然后单击【当前状态】的开启按钮，展开静态网站配置项。

4. 依次选择配置项，选择是否强制 HTTPS（可选），填写索引文档，错误文档（可选），设置网站的重定向规则（可选），设置完毕单击【保存】即可。
![staticweb](https://main.qcloudimg.com/raw/645c5a8a709fbd0b509e7f91bb9f2dfb.png)
