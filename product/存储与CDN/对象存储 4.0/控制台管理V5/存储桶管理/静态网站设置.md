...
![](https://main.qcloudimg.com/raw/4a2d5891e12fa4f9ef940a00f826769f.png)

#### 配置前缀匹配
1. 当你将文件夹从 docs/ 重命名为 documents/ 后，用户在访问 docs/ 文件夹会产生错误。所以，您可以将前缀 docs/ 的请求重定向至 documents/。
![](https://main.qcloudimg.com/raw/8647eb58fba53ed61d871761212097d0.png)

2. 当您删除了 images/ 文件夹（即，删除了具有前缀 images/ 的所有对象）。您可以添加重定向规则，将具有前缀 images/ 的任何对象的请求重定向至 test.html 页面。
![](https://main.qcloudimg.com/raw/c05a95a6f99cea7bcf309c66ac821b4d.png)
