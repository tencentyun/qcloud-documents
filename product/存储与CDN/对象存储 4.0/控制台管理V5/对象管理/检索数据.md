...
- 控制台中的检索功能最大支持对128MB的文件进行40M以下的数据提取，如果您需要处理更大的文件或提取更多的数据，请使用 API 或者 SDK。
...
4. 在存储桶的“文件列表”模块下，找到需要进行检索的对象，在其右侧操作栏中，单击【检索】。
   ![](https://main.qcloudimg.com/raw/886728a4029547bb691f4eb3840fde63.png)
5. 进入控制台检索功能页面，根据实际情况选择您进行检索的文件类型，标题字段，分隔符以及压缩格式。
   ![](https://main.qcloudimg.com/raw/69a2c01de686dfa7f08030b05226ca17.png)
6. 单击【选择 SQL 模板】，可以勾选您所想进行检索的模板句式，然后单击【确定】。
   ![](https://main.qcloudimg.com/raw/d1aa65bf17715dacb81ddd12097cd3db.png)
7. 您可以根据实际文件在文本框中对语句进行编辑，编辑完成后，单击【运行SQL】。
   ![](https://main.qcloudimg.com/raw/fe6cb26ab9aeb38b3d269352bd8fe946.png)
8. 待运行完毕后，可以在最下方的文本框中直接查看前100条结果，如果想获得完整数据，可单击【导出检索结果】。
   ![](https://main.qcloudimg.com/raw/d241d3356cd75a9ecdaec6d6f84f984b.png)
