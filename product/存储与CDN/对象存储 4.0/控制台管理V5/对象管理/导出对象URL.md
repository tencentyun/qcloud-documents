...
>若您需要导出的对象地址数量＞100个，请通过API或SDK导出。详情请参考[GET Bucket（List Objects）](https://cloud.tencent.com/document/product/436/7734)
...
5. 勾选需要导出URL的对象，单击上方的【更多操作】>【导出URL】。
...
8. 在导出文件中，可查看对象名称及对象地址信息。请在有效期内查看对象URL。
