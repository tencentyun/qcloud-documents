...
## 通过子账号查询操作步骤
通过子账号查询监控报表，您需要首先授予子账号查询监控报表的权限，此后才能使用子账号通过控制台查询监控报表。有关权限配置的步骤详述如下。

### 配置子账号访问监控报表权限

#### 通过策略模板配置

1. 使用根账号登录[访问管理控制台](https://console.cloud.tencent.com/cam)，单击已创建的子账号。

![Aaron Swartz](https://main.qcloudimg.com/raw/019543ed805a1ea3a816ae15342fd574.png)

2. 在策略列表中搜索`QcloudMonitorFullAcess`策略，点击确定添加至该子账号中，即可使用该子账号查阅云监控报表。

![Aaron Swartz](https://main.qcloudimg.com/raw/c1ffcc2c93a36a9c565b78b549b01d9b.png)

> **注意**：策略模板将授予访问云监控的所有权限，如您需要保护账号安全，可自定义配置子账户读权限的访问策略。

#### 通过自定义访问策略配置

1. 使用根账号登录[访问管理控制台](https://console.cloud.tencent.com/cam)，点击策略模块，新建自定义策略。

![Aaron Swartz](https://main.qcloudimg.com/raw/63c631abf08ab7c80a8fb0828cb48288.png)

2. 选择按策略语法创建。

![Aaron Swartz](https://main.qcloudimg.com/raw/e71e8dbf06d2f3b4df88784f813dc3b9.png)

3. 选择按照空白模板创建策略。

![Aaron Swartz](https://main.qcloudimg.com/raw/a4b3dd5e4b661a24ac7db48a6df5a063.png)
...
![Aaron Swartz](https://main.qcloudimg.com/raw/cb2296575e4be7a5fc207641ebdbebce.png)

5. 点击创建策略。策略创建成功后，您可对子账户授权相应策略。步骤与**通过策略模板配置**一致。
