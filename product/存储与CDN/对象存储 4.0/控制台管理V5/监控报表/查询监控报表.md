...
1. 使用根账号登录 [管理控制台](https://console.cloud.tencent.com/cam)，单击已创建的子账号。
![Aaron Swartz](https://main.qcloudimg.com/raw/019543ed805a1ea3a816ae15342fd574.png)

2. 在策略列表中搜索`QcloudMonitorFullAcess`策略，单击确定添加至该子账号中，即可使用该子账号查阅云监控报表。
...
1. 使用根账号登录[访问管理控制台](https://console.cloud.tencent.com/cam)，单击策略模块，新建自定义策略。
...
3. 选择按照空白模板创建策略。
![Aaron Swartz](https://main.qcloudimg.com/raw/6addac8460468c1cea359609051d2c3c.png)
...
5. 单击创建策略。策略创建成功后，您可对子账户授权相应策略。步骤与 [通过策略模板配置](#celie) 一致。
