...
| Bucket Endpoint | 格式为 `cos.<region>.myqcloud.com`，其中 region 为存储桶所在地域，详情请参见 [地域与访问域名](https://cloud.tencent.com/document/product/436/6224)。 |
...
>? 更多有关配置文件的操作，请参见 [config 命令](https://cloud.tencent.com/document/product/436/63679)。
