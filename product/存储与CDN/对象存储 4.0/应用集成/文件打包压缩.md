...
6. 单击【使用引导】，可以看到该函数所需要配置的参数字段说明，其中的 ClientContext 参数以 json 格式传入，配置示例请参见 [通过 API 进行多文件打包压缩](https://cloud.tencent.com/document/product/436/58581)。
![](https://main.qcloudimg.com/raw/2da92dc5049d59e7ab0f69be76d729c2.png)
7. 单击【下一步】，可以进入调用测试页面，单击【点击调用】，控制台会根据上一步配置的参数，对该函数发起调用，并可在【响应结果】中查看函数响应结果。
