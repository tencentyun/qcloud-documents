...
- MongoDB 数据备份函数备份的是腾讯云 MongoDB 数据库的备份文件，若您此前并未开启 MongoDB 数据库备份，则无法执行备份函数。有关腾讯云 MongoDB 数据库备份的更多信息，可查看 [MongoDB](https://cloud.tencent.com/document/product/240/7108)。
