...
|1.0.0 |  2021年6月1日  |   1. 基于 namespace 的读写策略与 TTL 管理<br>2. 基于 Hive Table 维度以及 Table Partition 维度的预热<br>3. 兼容存量 COSN 用户的路径兼容，实现透明加速<br>4. Fluid 集成 GooseFS<br>5. 集成了 CHDFS 支持   | [点此下载](https://cos-data-lake-release-1253960454.cos.ap-guangzhou.myqcloud.com/goosefs-1.0.0-bin.tar.gz) |
