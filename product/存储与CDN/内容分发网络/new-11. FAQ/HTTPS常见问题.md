...
+ 配置了HTTPS证书后，浏览器反馈证书不受信任？
	...
	+ 您可以申请腾讯云提供的免费证书，或在腾讯云上购买证书，[点击前往](https://console.qcloud.com/ssl)。

+ HTTPS 支持哪些版本的SSL/TSL安全协议？
	+ CDN HTTPS目前支持的 ssl\_protocols：TLSv1、TLSv1.1、TLSv1.2。

+ 配置证书时，提示证书链不齐全？
	+ CDN 目前支持的是 PEM 格式的证书，在上传时，需要把CA的证书贴在域名证书后，进行上传，具体方法 [点击查看](https://www.qcloud.com/document/product/228/6303#.E8.AF.81.E4.B9.A6.E9.93.BE.E8.A1.A5.E9.BD.90) 。
