...
<img src="https://qcloudimg.tencent-cloud.cn/raw/e1d2d756e3d9f84e715e14cc6a82135e.png" width="70%">
...
| 源站地址 | 自有源站：<br/>1. 支持设置多个 IP 作为源站，回源时会进行轮询回源。<br/>2. 多 IP 场景可配置权重回源，格式为 IP：端口:权重(1 - 100)，端口可省略，即 IP::权重。<br/>3.  支持配置多个域名作为源站，此域名需要与业务加速域名不一致。<br/><br/>COS 源：<br/>1. 下拉选框选择需要设置为源站的存储桶。<br/>2. 若存储桶为私有读写，需要先授权 CDN 服务对存储桶的访问权限，否则会导致回源失败。 |
