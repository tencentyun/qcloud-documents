...
- 遵循源站：遵循源站的 Cache-Control 头部
	...
	- 若源站对应的 HTTP Response Header 中无 Cache-Control 字段，则：
		CDN 节点不缓存资源
...
>?
>- 若“强制缓存”选择“是”，则CDN 节点缓存资源的时间按照此处配置的时间
>- 若“强制缓存”选择“否”且源站的 Cache-Control字段为no-cache/no-store/private，即使配置了缓存时间，CDN 节点也不缓存资源。
