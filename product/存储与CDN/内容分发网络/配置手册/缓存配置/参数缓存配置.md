...
![](https://main.qcloudimg.com/raw/ae95cc359eddd77586f53f100c5b77b2.png)

### 修改配置

可以直接单击开关按钮，开启或关闭配置，开启参数缓存配置时，可以选择是否保留指定参数，配置下发全网生效时间大约为5分钟：
- 不保留：过滤全部参数。
![img](https://main.qcloudimg.com/raw/e2c9e8e28e9689ea87ec8ed247b24b1e.png)
- 保留指定参数：可指定要保留的参数，多个参数之间用“;”隔开，最多可输入6个参数。未指定的参数将会被过滤。
![](https://main.qcloudimg.com/raw/2dc03ed9d51b575bcc1ee8a113869651.png)
...
当访问`http://www.test.com/1.jpg?version`时，仅会精准匹配 URL 请求中的 version 参数。
