...
| [状态码缓存配置](https://cloud.tencent.com/doc/product/228/6290) | 404 状态码缓存时间配置     |
| [HTTP头部缓存](https://cloud.tencent.com/doc/product/228/6290) | 头部缓存策略配置          |
...
| 配置名称                                     | 功能描述      |
| ---------------------------------------- | --------- |
| [鉴权配置](https://cloud.tencent.com/document/product/228/13677) | 配置 URL 鉴权 |
