...
1. 登录 [CDN 控制台](https://console.cloud.tencent.com/cdn)，在菜单栏里选择【插件中心】，完成 APK 动态打包插件功能的相关配置。
...
- 签名方式：当前支持对采用安卓 V1/V2 签名方式的 APK 进行动态打包，V2签名支持 WALLE/VASDOLLY 等开源多渠道打包方案。同时支持将住注释信息写入指定的自定义 Block ID。
