...
**IPV6 源站**
支持添加一个 IPV6 源站，可支持 IPV6 回源，在源站配置中无法变更，仅在添加域名时，加速类型为 ECDN 动静加速和 ECDN 动态加速，加速区域为中国境内时可选择开启。
...
>!
>- 热备源的源站类型不支持 COS 源和第三方对象存储。如果您有 COS 源或者第三方对象存储需要作为热备源，可以在自有源中填写公网访问地址。
