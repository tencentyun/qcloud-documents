...
开启头部缓存配置时，除以下头部外，其他源站返回头部均会缓存在节点：
...
X-Error-Info
X-Server-Time
Content-Disposition（注意：由于此版本该头部暂未缓存，下载型业务请勿开启此开关）
Set-Cookie
X-Daa-Tunnel
X-Verify-Code
```

![](https://mc.qcloudimg.com/static/img/cab95f85e796663f03fea12c80373748/cache-config-10.png)
