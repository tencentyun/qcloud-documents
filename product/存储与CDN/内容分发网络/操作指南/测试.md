...
<thead>
	<tr>
		<th colspan = "2"scope="col" style="width: 136px;text-align: center;font-weight:700;">计费模式</th>
...
<tbody>
	...
	<tr>
		...
		<td>一次性付费，可选择1个月或6个月有效期的流量包，支持自动续订。</td>
		<td>仅适用于按流量计费，在流量计费模式下会优先抵扣流量包。若当前计费方式为峰值带宽，流量包余量将会冻结，直至切换回按流量计费方式后才能使用。</td>
