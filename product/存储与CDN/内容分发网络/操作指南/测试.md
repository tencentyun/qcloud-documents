<table style="width:720px;">
    ...
    <tr>
        <th style="width:80px;padding:0;">
            <div style="border-top:40px #D6D3D6 solid;width:0px;height:0px; border-left:80px #BDBABD solid;position:relative;">
                <b style ="font-size:14px;font-weight:700;display:block;position:absolute;top:-40px;left:-40px;width:35px;">规格</b>
                <em style = "font-size:14px;font-weight:700;display:block;position:absolute;top:-20px;left:-75px;width:55x;">有效期</em>
            </div>
        </th>
 ...
 <th style="width:80px;padding:0;text-align:center;font-weight:700;">1PB</th>
    ...
    <tr>
        <td style="font-weight:700;">1个月</td>
    ...
    <tr>
        <td style="font-weight:700;">6个月</td>
