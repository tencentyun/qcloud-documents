...
## 计费总览表
CDN 为您提供了带宽峰值、月流量、日峰带宽取月均、月95带宽、大客户月流量的计费模式。其中日峰带宽取月均、月95带宽、大客户月流量的计费模式仅支持 CDN 月消费金额大于10万或预期超过10万的用户。欢迎拨打95716或 [提交工单](https://console.cloud.tencent.com/workorder/category/create?level1_id=83&level2_id=85&level1_name=%E5%AD%98%E5%82%A8%E4%B8%8ECDN&level2_name=%E5%86%85%E5%AE%B9%E5%88%86%E5%8F%91%E7%BD%91%E7%BB%9C%20%20CDN) 咨询更多详情。
...
<tbody>
	<tr>
		...
		<td><li>计费方式：带宽计费<li>付费方式：后付费按日结算<li>计费规则：采用阶梯到达模式<li> <a href="#m1">费用计算示例</a><br></td>
		<td colspan="1" rowspan="2">前一天00:00:00 - 23:59:59产生的总消耗，会在第二天18:00前进行计算扣费。</td>
		<td>获取每日的带宽峰值进行计费。每5分钟统计一个带宽数据，每日得到288个值，取其中的最大值。</td>
	</tr>
	<tr>
		<td style="text-align: center; ">月流量</td>
		<td><li>计费方式：流量计费<li>付费方式：后付费按日结算<li>计费规则：月度阶梯累进结算<li><a href="#m2">费用计算示例</a></td>
		<td>按照每日从腾讯云 CDN 节点流出的实际流量计费。</td>
	</tr>
	<tr>
		<td style="text-align: center; ">日峰带宽取月均</td>
		<td><li>计费方式：带宽计费<li>付费方式：后付费按月结算<li>计费规则：计费点的峰值带宽按照合同约定的单价计费<li><a href="#m3">费用计算示例</a></td>
	...
	<tr>
		...
		<td><li>计费方式：带宽计费<li>付费方式：后付费按月结算<li>计费规则：计费点的峰值带宽按照合同约定的单价计费<li><a href="#m4">费用计算示例</a></td>
	...
	<tr>
		...
		<td><li>计费方式：流量计费<li>付费方式：后付费按月结算<li>计费规则：月度累计使用的所有流量和，根据合同价格计算费用</td>
