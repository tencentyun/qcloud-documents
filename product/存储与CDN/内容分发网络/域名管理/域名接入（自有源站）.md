...
源站类型可分为自有源和 COS 源。
 ...
 + COS源：若您想使用腾讯云 [对象存储](https://cloud.tencent.com/product/cos.html) 存储静态加速内容，可以直接使用 COS 源接入方式，将域名接入 CDN。接入方式如下：
     ...
     2. 若对应项目下无存储桶，您需要登录 [COS 控制台](https://console.cloud.tencent.com/cos5) 创建存储桶（创建详情请参见 [创建存储桶](https://cloud.tencent.com/document/product/436/13309)），或联系您的开发商账号为您分配对应的存储桶使用权限。
