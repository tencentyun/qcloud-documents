...
> **注**：热备源站暂时不支持 HTTPS 回源，配置了热备源站的域名在配置证书时，请勿选择 HTTPS 回源。
...
![](https://mc.qcloudimg.com/static/img/377338ffeec12b884007118707185000/origin.png)

## 修改源站
您可以在 CDN 控制台中对主源站类型进行修改，支持自有源站、COS 源站相互切换。
> **注**：仅支持修改用户自行接入的域名的源站，不支持修改 [对象存储](https://cloud.tencent.com/product/cos) 中 Bucket 自动创建的 CDN 加速域名的源站。
