...
您可在CDN接入时配置缓存时间，详情查看[域名接入（自有源）](https://www.qcloud.com/doc/product/228/5734) 或 [域名接入（COS源）](https://www.qcloud.com/doc/product/228/5735)。您也可以登录[CDN控制台](https://console.qcloud.com/cdn)，选择**域名管理** 页面，点击要修改回源HOST配置的域名右侧**管理**按钮：
