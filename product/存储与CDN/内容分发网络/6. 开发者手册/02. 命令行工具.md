...
--urls http://xxxxxxxtang.sp.oa.com/test.php 
--urls http://www.test.com/1.html
```
...
--cacheMode custom 
--cache [[0,\"all\",1023448]] --refer [1,[\"www.baidu.com\",\"www.qq.com\"]] --fwdHost www.test.org --fullUrl off
```
...
--host www.test.com --projectId 0 
--hostType cname --origin 1.1.1.1
```
