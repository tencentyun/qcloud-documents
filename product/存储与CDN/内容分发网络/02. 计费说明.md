...
详细价格算法请参考[价格总览](https://www.qcloud.com/doc/product/228/6539)，您也可以使用 [价格计算器](https://buy.qcloud.com/calculator/cdn) 估算价格。

## 流量包使用
选择流量计费的客户，可以使用流量包抵扣，更多详情[点击查看](https://www.qcloud.com/doc/product/228/2949#.E6.B5.81.E9.87.8F.E5.8C.85)。
