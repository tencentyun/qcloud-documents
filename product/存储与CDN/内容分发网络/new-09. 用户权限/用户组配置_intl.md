User group is user for the management of a group of sub-users with the same permissions. All sub-users in a user group can be associated with the same policy in a centralized way.
