...
<p>QUIC 访问属于增值服务，目前腾讯云 CDN 正在免费内测中。<strong>后续进行线上计费时，我们会提前推送消息给您，请您关注确认。</strong><br><br>
...
QUIC 访问增值服务将按 QUIC 请求数次数计费，按量后付费，详细说明请见 <a href="#m8">计费说明</a>。</p>
</blockquote>
...
|-------|-------|------|------|-----|
|QUIC 请求数计费|	若您已使用 [QUIC 访问功能](https://cloud.tencent.com/document/product/228/51800)，将按 QUIC 请求数次数计费。	|后付费月度结算</br>|无阶梯一口价	|参见 [计费详情](#m7)|
...
### QUIC 请求数计费[](id:m7)	
若您已使用 [QUIC 访问功能](https://cloud.tencent.com/document/product/228/51800)，将按 QUIC 请求数次数计费：按量后付费，月度结算。
