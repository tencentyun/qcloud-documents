...
1. 在 [访问管理控制台](https://console.cloud.tencent.com/cam/overview)，单击左侧菜单中的【策略】，进入管理页面。
2. 单击【新建自定义策略】，在弹框中选择【按产品功能或项目权限创建】。
3. 填写策略名，选择【项目管理】作为服务类型，单击【下一步】。
4. 单击开启【管理 CDN 业务项目内云资源】。
5. 单击【下一步】，进入关联对象页面中。
6. 单击右侧操作栏下的【关联对象】，选择关联指定项目或对象并单击【确认】。
7. 最后单击【完成】，完成策略创建。
...
1. 在 [访问管理控制台](https://console.cloud.tencent.com/cam/overview)，单击左侧菜单中的【策略】，进入管理页面。
2. 单击【新建自定义策略】，在弹框中选择【按产品功能或项目权限创建】，进入”配置服务类型“页面。
3. 填写策略名，选择【内容分发网络】作为服务类型，单击【下一步】，进入“开启权限”页面。
4. 开启所需功能集合，如单击开启【查看消耗数据及统计量】。
5. 单击【下一步】，进入关联对象页面。
6. 单击右侧操作栏下的【关联对象】，选择关联指定项目或对象并单击【确认】。
7. 最后单击【完成】，完成策略创建。
