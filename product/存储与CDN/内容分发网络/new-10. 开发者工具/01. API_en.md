Tencent Cloud CDN provides developers with a variety of APIs to cater for the operation & maintenance practices of different developers. For more details, please refer to [Tencent Cloud API Documentation](http://www.qcloud.com/doc/api/231/%E7%AE%80%E4%BB%8B).
...
| Set caching rules                  | [UpdateCache](https://www.qcloud.com/doc/api/231/3934) | Set the cache rules corresponding to the domain name according to the domain ID. |
...
| Query domain information by domain name | [GetHostInfoByHost](https://www.qcloud.com/doc/api/231/3938) | Query the details of domains by domain name. Multiple domain query is supported. |
| Query domain information by domain ID   | [GetHostInfoById](https://www.qcloud.com/doc/api/231/3939) | Query the details of domains by domain ID. Multiple domain query is supported. |
