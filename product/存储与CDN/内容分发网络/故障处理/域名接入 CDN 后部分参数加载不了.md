...
## 处理步骤
1. 登录 [CDN 控制台](https://console.cloud.tencent.com/cdn)，选择【域名管理】找到对应的域名配置， 查看【缓存配置】>【缓存键规则配置】的“过滤参数”项：检查 CDN 配置域名是否开启过滤参数缓存功能。是，请执行 [步骤2](#step)。
![](https://main.qcloudimg.com/raw/a1d55e9e76febf5eb5b4671ac088e15c.png)
[](id:step2)
2. 在缓存键规则配置中对应规则的操作栏，单击【修改】，在弹出的“修改规则”框关闭过滤参数功能，然后单击【保存】。
