...
- 支持设置回调地址 Callback 获取检测结果，或通过 [查询音频审核任务结果接口](https://cloud.tencent.com/document/product/1533/64195) 主动轮询获取审核结果详情。
...
>? Authorization: Auth String（详情请参见 [请求签名](https://cloud.tencent.com/document/product/1533/64192) 文档）。
>

#### 请求头

此接口仅使用公共请求头部，详情请参见 [公共请求头部](https://cloud.tencent.com/document/product/1533/64189) 文档。
...
此接口仅返回公共响应头部，详情请参见 [公共响应头部](https://cloud.tencent.com/document/product/1533/64191) 文档。
...
该请求操作无特殊错误信息，常见的错误信息请参见 [错误码](https://cloud.tencent.com/document/product/1533/64193) 文档。
