### GCD 配置需要多久？
GCD 配置完成时间通常在30分钟内，若您配置后等待时间超过30分钟，您可及时 [提交工单](https://console.cloud.tencent.com/workorder/category) 联系我们协助您处理。
...
### 域名被封禁如何解封？
需要 [提交工单](https://console.cloud.tencent.com/workorder/category)，由运维人员处理。
