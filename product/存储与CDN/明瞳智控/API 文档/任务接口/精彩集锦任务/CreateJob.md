...
| 节点名称（关键字） | 父节点                     | 描述                           | 类型   | 是否必选 |
| ------------------ | -------------------------- | ------------------------------ | ------ | ---- |
| Mode               | Request.Operation.AI | 分析类型，可选值为 Highlights               | String | 是   |
| Highlights         | Request.Operation.AI | 精彩集锦参数                           | Container    | 是   |

Container 类型 Highlights 的具体数据描述如下：
...
<Response>
        <JobsDetail>
                ...
                <Operation>
                        ...
                        <Notify>
                                <ContentType>JSON</ContentType>
                                <Url>http://82.156.245.21:9081/receiveCallback/2021-11-24-iss-ai</Url>
                        </Notify>
                </Operation>
