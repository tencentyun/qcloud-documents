...
明瞳智控的数据处理基于 [数据万象CI](https://cloud.tencent.com/document/product/460)，数据处理部分的费用由数据万象 CI 收取，具体费用可参考数据万象 [产品定价](https://cloud.tencent.com/document/product/460/6970)。
