...
![](https://main.qcloudimg.com/raw/d9e20fd0d6f4fd7ad3bf586e13fdfa4b.jpg)
3. 单击【确定】，即可创建完成。
...
2. 单击【创建项目】，输入项目名称、项目描述，选择服务地域、接入类型、上传地址等信息，单击【保存】，即可创建项目。
...
2. 单击【创建模版】，输入相关信息，即可完成转码、截图模版的创建，在数据上传的同时能够自动触发视频处理。
