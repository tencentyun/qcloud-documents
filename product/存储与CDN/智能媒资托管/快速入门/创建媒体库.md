...
2. 进入新创建的存储桶，单击左侧存储桶列表中的【概览】。
![](https://main.qcloudimg.com/raw/c8789987804cfb22b110b2ff1ebacb57.jpg)
查看概览中的基本信息，记录存储桶名称和所属地域中的英文部分。
![](https://main.qcloudimg.com/raw/202cdbf8e9e8d31fcd54f4ba5737575f.png)
3. 在左侧菜单中，选择【数据处理】>【媒体处理】，单击【编辑】，开启媒体处理功能。媒体处理目前主要用于视频文件的封面提取，如果不开启，相关功能将无法使用。
