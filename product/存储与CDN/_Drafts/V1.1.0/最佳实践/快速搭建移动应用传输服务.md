...
```
[program:myapp]
command=signer_release_path/venv/bin/gunicorn -w4 -b0.0.0.0:5000 myapp:app    
directory=flask_path                                              
startsecs=0   
stopwaitsecs=0    
autostart=false                                                                        
autorestart=false                                                             
stdout_logfile=signer_release_path/log/gunicorn.log                          
stderr_logfile=signer_release_path/log/gunicorn.err                     
```
