...
3. 示例（仅作示例，无实际意义）：
    ...
    * test.com 规则会命中 https://test.com 和 http://test.com
    * *.test.com 规则会命中域名 test.com
    * test.com 规则会命中域名 test.com
    * test.com:8080 不会命中域名 test.com
...
4. 设置了存储通 test 的防盗链白名单，允许 a.com 访问，但是 a.com 下的网页播放器却不能播放 test 下的视频文件？
