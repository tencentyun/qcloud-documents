...
![](http://rickenwang-1253653367.cosgz.myqcloud.com/resources/D23DE47F-CCF8-4B7E-A751-3BB91D0DCA1C.png)
...
应用服务器启动后，直接用浏览器访问 [http://ip:port/sign]() 地址，如果返回了临时密钥JSON字符串，则说明应用服务器临时密钥服务正常运行。

### 应用APP接入应用服务器临时密钥服务 

&nbsp; &nbsp; 在COS XML终端SDK中，您可以很方便的将应用服务器的临时密钥服务接入到SDK中，下面以Android为例：
...
public class YourSessionCredentialProvider extends BasicLifecycleCredentialProvider {
    ...
    protected QCloudLifecycleCredentials fetchNewCredentials() throws QCloudClientException {
        ...
        // 1、访问应用服务器 http://ip:port/sign 获取临时密钥JSON字符串
        // ...
...
```
现在您就可以通过<code>cosXmlService</code>对象的各种接口来访问COS服务了。[COS XML Android SDK](https://cloud.tencent.com/document/product/436/11238)、[COS XML IOS SDK](https://cloud.tencent.com/document/product/436/11280)。
