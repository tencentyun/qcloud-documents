...
| ------------------ | ------- | -------------------------------------------------------- | --------- | ---- | ----- |
| Mode               | Request | 接入类型                                              | String    | 否   | HTTP,RTMP,GB28181 |
| Status             | Request | 项目状态                                              | String    | 否   | 1. Active 表示启用 </br>2. Paused 表示停用 |
| Name               | Request | 项目名称 仅支持中文、英文、数字、\_、-和\*                    | String    | 否   | 长度不超过50 |
...
| Status             | Request.TemplateList | 模板启用状态 | String    | 是   | 无  | 1. On 表示启用 </BR>2. Off 表示停用 |
