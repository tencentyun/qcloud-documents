...
ECDN 已正式接入腾讯腾讯云可观测平台系统，当前版本支持的告警指标包括：
...
## 监控配置入口
登录 [腾讯云可观测平台控制台](https://console.cloud.tencent.com/monitor/policylist)，在左侧目录中，单击**告警策略**，进入管理页面。
