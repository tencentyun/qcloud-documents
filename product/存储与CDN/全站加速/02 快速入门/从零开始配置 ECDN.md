...
## 步骤三：接入域名
您需为您的加速业务接入加速域名。ECDN 通过加速域名把源站资源缓存到 ECDN 加速节点，用户可就近获取所需资源，实现资源访问加速。详情请参见 <a href="https://cloud.tencent.com/document/product/570/10361" hotrep="document.guide.3149.linkdomain">接入域名</a>。
