...
>!
>- 新增的加速域名包含中国境内区域，根据相关法规必须通过 [工信部域名备案](http://beian.miit.gov.cn/) 或接入 [腾讯云网站备案](https://cloud.tencent.com/product/ba?from=qcloudProductBa)，且未接入过腾讯云 CDN 或 腾讯云 ECDN，已接入 CDN 的域名需下线删除后，才能添加到 ECDN 平台。
