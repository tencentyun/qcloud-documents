...
在构造签名前，必须先获取腾讯云账号的 API 密钥对，其中包含 SecretID 和 SecretKey。建议使用子账号密钥，授权遵循 [最小权限指引](https://cloud.tencent.com/document/product/436/38618)，降低使用风险，子账号密钥获取可参考 [子账号访问密钥管理](https://cloud.tencent.com/document/product/598/37140)。
