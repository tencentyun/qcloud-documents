...
- 支持设置回调地址 Callback 获取检测结果，或通过 [查询文本审核任务结果接口](https://cloud.tencent.com/document/product/1534/64485) 主动轮询获取审核结果详情。
...
> - 当选择 Object 时，审核结果为异步返回，可通过 [查询文本审核任务结果](https://cloud.tencent.com/document/product/1534/64485) API 接口获取返回结果。
...
- 选择`Object`时，接口响应为异步返回，可通过 [查询文本审核任务结果](https://cloud.tencent.com/document/product/1534/64485) 接口查看审核的结果。
...
该请求操作无特殊错误信息，常见的错误信息请参见 [错误码](https://cloud.tencent.com/document/product/1534/64487) 文档。
