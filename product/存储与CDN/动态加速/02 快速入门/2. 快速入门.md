...
**步骤预览**
![](https://mc.qcloudimg.com/static/img/83bf88faf4e4b2bb0204c4fff1578fc1/dsa_start.png)

## 第一步：开通 DSA 服务
目前 DSA 处于内测阶段，在使用 DSA 服务前，您需要获取内测资格以及进行实名认证。若您的账号已经开通了 DSA 服务，请直接跳到第二步。开通 DSA 服务流程如下。
1. 进入 [DSA](https://www.qcloud.com/product/dsa) 产品页面,单击【立即申请】进入申请页面。
...
3. 内测申请通过后，登录 [DSA 控制台](https://console.qcloud.com/dsa) 可以看到实名认证指引，单击【前往认证】可进行实名认证。
