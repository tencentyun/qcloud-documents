...
2. 已完成实名认证的用户，可直接进入 [DSA 控制台](https://console.cloud.tencent.com/dsa) 页面，单击【产品计费说明】可以前往查看产品资费说明，单击【立即开通服务】可以自助开通服务。
...
<span id="yuming"></span>
## 添加域名配置
1. 登录 [DSA 控制台](https://console.cloud.tencent.com/dsa)，在左侧菜单中，单击【域名管理】，进入管理页面。
2. 单击【添加域名】。
