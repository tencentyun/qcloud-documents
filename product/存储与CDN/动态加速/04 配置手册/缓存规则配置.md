...
1. 登录 [DSA 控制台](https://console.cloud.tencent.com/dsa)。
2. 在 [【<strong>域名管理</strong>】](https://console.cloud.tencent.com/dsa/access) 页面，单击域名右侧的【<strong>管理</strong>】。   
3. 进入域名配置管理页面，在<strong>【基本配置】</strong>页面下<strong>内容缓存配置</strong>模块，进行内容缓存规则配置管理。   
...
4. 在<strong>内容缓存配置</strong>模块，单击 【<strong>添加缓存规则</strong>】 或 【<strong>修改</strong>】，可弹出缓存规则配置框。  
