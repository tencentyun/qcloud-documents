...
### 配置流程
1. 登录 [DSA 控制台](https://console.qcloud.com/dsa)，单击左侧菜单栏的【域名管理】进入 **域名管理** 页面，在页面中单击您要配置的域名右侧的【管理】进入域名配置页面。
...
4. 配置生效时间约为 5 分钟，在下方的表格中可以查看添加的 Http Header。单击 Header 右侧的【修改】或【删除】可以对该 Header 进行相应操作。
