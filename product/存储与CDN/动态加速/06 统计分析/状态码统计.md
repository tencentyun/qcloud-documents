DSA 状态码统计为您提供状态码监控数据查询功能。您可以登录 [DSA 控制台](https://console.cloud.tencent.com/dsa)，在左侧菜单中，单击【统计分析】，进入 [状态码统计](https://console.cloud.tencent.com/dsa/statistics/status) 页面体验该功能。
...
<table>
   <tr>
      <td style="width:55px">类别</td>
      <td style="width:70px">状态码</td>
      <td>状态码含义</td>
      <td>处理建议</td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <tr>
      <td>513</td>
      <td>DSA 边缘过载，通常是客户请求数突发或被 cc 攻击。</td>
      <td>请确认域名业务是否正常突发。</td>
   </tr>
    <tr>
      <td>522</td>
      <td>针对 HTTP 的 DSA 内部建连失败或 DSA 回源建连接失败。</td>
   ...
   <tr>
    ...
    <tr>
      <td>533</td>
      <td>DSA 边缘与 DSA 中转传输失败，读取超时或建连失败。</td>
      <td>请 提交工单 联系我们处理。</td>
   </tr>
    <tr>
      <td>538</td>
      <td>针对 HTTPS 的 SSL 握手失败，DSA 内部传输失败或 DSA 回源 SSL 握手失败。</td>
