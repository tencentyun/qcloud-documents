...
您可以前往 Fluid 官方页面 [Fluid Releases](https://github.com/fluid-cloudnative/fluid/releases) 中下载 Fluid 0.6.0 以上版本；默认情况下，推荐使用最新版本。
...
解压 `fluid-0.8.0.tgz`，修改默认`values.yaml`文件：
```yaml
runtime:
