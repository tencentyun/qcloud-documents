CFS 文件存储支持传输加密及存储加密功能。您可以在创建文件系统的时候启用存储加密，在挂载文件系统的时候启用传输加密。体验文件加密功能，请填写 [文件存储加密功能申请表](https://cloud.tencent.com/apply/p/alop3uh2szt) 申请使用。
...
```
若在云主机公共镜像中启用 Stunnel 异常， 可 [提交工单](https://console.cloud.tencent.com/workorder/category) 报障。
