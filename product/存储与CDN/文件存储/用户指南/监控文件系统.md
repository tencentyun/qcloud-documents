...
![](https://main.qcloudimg.com/raw/8b7547c37be5369db41ea52313c9e075.png)

### 查看文件系统性能监控

单击上图中的任意一个文件系统 ID/名称，进入到详情页面。用户可以自行选择对应时间区间窗口，查看监控文件系统的使用情况。
![](https://main.qcloudimg.com/raw/80a4d1060727de66826f0ff0f2c2d6ff.png)
...
| 读取带宽     | 文件系统平均每秒钟读取的数据量 | MB/s | 单文件系统 |
| 写入带宽     | 文件系统平均每秒钟写入的数据量 | MB/s | 单文件系统 |
...
![](https://main.qcloudimg.com/raw/c41a4beb301851b144cac313b24378ff.png)
