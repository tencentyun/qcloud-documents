...
前往  [CFS云监控控制台](https://console.cloud.tencent.com/monitor/product/cfs)，在【云监控】>【云产品监控】>【文件存储】页面可查看各个文件系统健康状态、查看告警信息等。
![](https://main.qcloudimg.com/raw/ed67087d48ce9796f46da2eef774cad1.png)
...
进入到告警策略页面，用户可以查看到绑定到该文件系统上的告警策略；可以单击策略名查看策略详情或进行解绑的操作。
![](https://main.qcloudimg.com/raw/c41a4beb301851b144cac313b24378ff.png)

## 设置告警

腾讯云支持基于监控指标，为文件系统配置告警及通知策略。若您希望新建策略或为文件系统绑定策略，可以前往  [云监控告警策略](https://console.cloud.tencent.com/monitor/policylist)。
在【云监控】>【告警管理】>【告警策略】页面进行操作，告警策略设置请参考 [云监控告警服务指引](https://cloud.tencent.com/document/product/248/6126)。
