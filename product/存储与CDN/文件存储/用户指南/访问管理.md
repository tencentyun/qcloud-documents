...
| 资源 | Resource     | 可被操作的资源：<br>文件存储的所有资源写法为 qcs::cfs::* <br>指定地区的所有资源写法为 qcs::cfs::gz::*<br>指定用户下所有地区所有资源写法为 qcs::cfs::uin/27700000::*<br>指定用户下指定地区所有文件系统写法为 qcs::cfs::sh::uin/27700000::filesystem/* <br>指定用户下指定用户组系统写法为 qcs::cfs::uin/27700000::pgroup/pgroup-doxpcqh<br>注意：策略中的 UIN 必须为主账号 UIN  (后面的文件系统或权限组资源必须属于该主账号)  |
...
上述参数设置完成后，单击【添加声明】，则为该自定义策略添加了一条声明。您可以重复上述操作，添加多条声明。若有重复或冲突的策略，他们之间的关系及生效结果请参见 [评估逻辑](https://cloud.tencent.com/document/product/598/10605)。
