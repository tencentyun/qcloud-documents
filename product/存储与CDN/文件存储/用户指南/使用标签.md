...
[标签](https://tcloud-doc.isd.com/document/product/651) 是腾讯云提供的用于标识云上资源的标记，是一个键-值对（Key-Value）。标签可以帮助您从各种维度（例如业务，用途，负责人等）方便的对云资源进行分类管理。
需要注意的是，腾讯云不会使用您设定的标签，标签仅用于您对腾讯云资源的管理。本文档指导您对文件存储资源进行编辑标签的操作。
...
3. 在弹出的"新建文件系统"配置窗口中，在下面找到【标签】配置项，单击【添加】，为该文件系统增加标签信息。（此处只能添加已经存在的标签）
...
<img src="https://main.qcloudimg.com/raw/b0a09fab2eefa0c0cf3e6478e70ae25a.png" width="80%">
