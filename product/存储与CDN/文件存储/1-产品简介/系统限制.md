...
<table> 
    <tr align="center">
        ...
        <td width="10%" colspan="2">Turbo标准型</td>
        <td width="10%" colspan="2">Turbo性能型</td>
    <tr align="center">
        <td width="10%" >产品规格</td>
        <td width="10%" >推荐范围</td>
        <td width="10%" >产品规格</td>
    ...
    <tr align="center" >
        <td>支持协议</td>
        <td colspan="4">NFS/SMB</td>
        <td colspan="4">POSIX/MPI</td>
    </tr>
    <tr align="center" >
        <td>支持操作系统</td>
        <td colspan="2">Linux/Windows</td>
...
- 若需要更高规格（支持更多文件数、目录数等）的turbo系列，可提交工单与我们联系。
