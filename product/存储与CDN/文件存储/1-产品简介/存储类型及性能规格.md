...
<table> 
    <tr align="center">
        ...
        <th style="width: 30%;" colspan="2">标准型</th>
        <th style="width: 30%;" colspan="2">性能型</th>
        <th style="width: 30%;" colspan="2">吞吐型</th>
    <tr align="center">
        <td style="width: 10%;">产品名称</td>
        <td style="width: 15%;">通用标准型</td>
        <td style="width: 15%;">Turbo 标准型</td>
        <td style="width: 15%;">通用性能型</td>
        <td style="width: 15%;">Turbo 性能型 </td>
        <td style="width: 30%;">吞吐型 </td>
    </tr>
    <tr align="center">
        <td>产品定位</td>
