...
Because clients of Windows， Linux 3.10 and its previous kernel versions (eg CentOS 6.* ) are incompatible with the NFS 4.0 protocol, they cannot work normally after being mounted with NFS 4.0. Use NFS 3.0 to mount such clients.
