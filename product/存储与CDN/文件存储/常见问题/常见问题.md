...
可参考文档：[使用 CFS 创建网络文件系统（Windows）](https://cloud.tencent.com/document/product/582/11524)

### Windows IIS 无法使用 mapped driver，怎么办？
按照 [使用 CFS 创建网络文件系统（Windows）](https://cloud.tencent.com/document/product/582/11524) 中的步骤，配置正确的 NFS 客户端程序并修改注册（添加访问用户）表。
