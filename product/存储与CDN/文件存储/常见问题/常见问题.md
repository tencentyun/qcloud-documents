### CFS 支持哪些平台？
支持在腾讯云内网使用，例如云主机的 Linux 、 Unix、 Windows 等客户端、容器、SCF 云函数、批量计算、裸金属实例等；同时，通过打通 VPN、专线接入或者云联网（[查看更多](https://cloud.tencent.com/document/product/215/36699)） ，客户 IDC 或其他平台的计算节点也可以访问 CFS。
...
### 文件存储支持哪些访问协议？
NFS v3.0/v4.0 及 CIFS/SMB2.0/SMB3.0 协议，CIFS/SMB 协议文件系统公测中，更多信息请参阅 [CIFS/SMB公测说明](https://cloud.tencent.com/document/product/582/9553#cifs.2Fsmb-.E5.85.AC.E6.B5.8B.E8.AF.B4.E6.98.8E)。
