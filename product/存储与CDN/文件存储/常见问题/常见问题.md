...
**查看方法**
1. 您可以在 "费用中心->账单管理->账单明细->资源 ID 账单" 列表中， 单击表头中右上角的“齿轮”设置按钮，在弹窗中勾选 "扩展字段1"。
![](https://main.qcloudimg.com/raw/b46613599b5a3540c872ecd6b7f6c72b.png)
2. 单击确认，将表格拉到最后，在**扩展字段1**列中，您可以看到计费时被合并的地区 "北京、广州、上海、成都"的说明。
