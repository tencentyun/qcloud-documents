...
### 免费套餐
截止到 2017 年 12 月 31 日，每个 CFS 的用户（主账户和协作者账户视为一个用户---相同 APPID）可以享受 10 GB 的免费存储量，每个计费周期内若用量超出免费额度，超出部分将按阶梯价格收取费用。
...
地区 | 中国大陆（含金融专区） | 香港
------- | ------- | -------|
阶梯价格| 0-10TB  0.35 元/GB/月 | 1TB 以内  0.63 元/GB/月 
       | 10TB以上 0.33 元/GB/月 | 1TB - 10TB  0.58 元/GB/月
...
该小时 CFS 总费用 = （500+105.6-10）*0.63/30/24= 0.5216 元
