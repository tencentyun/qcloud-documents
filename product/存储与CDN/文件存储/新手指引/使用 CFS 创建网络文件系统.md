...
### 1.1 Linux 云服务器
本步骤主要介绍如何快速创建和配置腾讯云云服务器 Linux 实例。如果需要使用 Windows 系统的云服务器，请参考步骤 1.2 Windows 云服务器。
#### 1.1.1 准备与选型
...
### 1.2 Windows 云服务器
本文档主要介绍如何快速创建和配置腾讯云云服务器 Windows 实例。如果需要使用 linux 系统的云服务器，请参考步骤 1.1 Linux 云服务器。
