...
* 	 挂载 CFS 根目录：mount -t nfs -o vers=3,nolock,proto=tcp 10.10.19.12:/local/mntdir
* 	 挂载 CFS 子目录 subfolder：mount -t nfs -o vers=3,nolock,proto=tcp 10.10.19.12:/subfolder /local/test
