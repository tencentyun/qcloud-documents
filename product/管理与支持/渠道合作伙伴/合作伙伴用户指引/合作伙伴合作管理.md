### 腾讯云的产品
如果您想了解腾讯云的产品，单击 [文档中心](https://cloud.tencent.com/document/product) 查看更多信息。
...
在腾讯云审核通过贵公司的合作伙伴资质申请以后，请第一时间完成双方的合作伙伴协议签署。
...
您可以按以下路径下载：腾讯云控制台 > 渠道管理 > 公司信息 > [电子授权书](https://console.cloud.tencent.com/partners/authorize)。
