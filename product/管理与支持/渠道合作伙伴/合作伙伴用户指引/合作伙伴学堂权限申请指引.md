...
1. 员工进入 [合作伙伴学堂](https://partner.cloud.tencent.com/partner-university) 首页。
   申请腾讯云账号后，请先在腾讯云后台进行账号实名认证。若员工还没有申请权限，可以单击 [申请权限](https://cloudpartner.lexiangla.com/?company_from=cloudpartner) 进行申请。
2. 员工进入权限申请页面，填写申请信息：
