...
## 操作步骤
为了保证服务商可自动接收到客户在云市场发生的购买、续费、退款等一系列行为的消息通知，云市场提供了发货接口的 API 文档，需服务商参考 [《云市场软件服务接入-SaaS商品自动交付接入方案》](https://main.qcloudimg.com/raw/7c06454f1397d886788472c13a9c402b.pdf) 进行 API 接口开发，以实现相关消息通知功能，主要包括创建实例、续费通知、配置变更通知、退款通知等。
