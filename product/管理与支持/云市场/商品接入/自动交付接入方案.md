...
- 在服务商管理控制台的【[在线接口调试](https://console.cloud.tencent.com/serviceprovider/ondebug)】页面进行对应的接口调试，发布接口前必须将“创建实例”、“续费实例”、“实例过期”、“实例销毁”等接口调试成功，“实例配置变更”可选择性进行调试。
...
| extendInfo              | JSON    |  是       | 支持 comment、templateId、ccnId 三个字段                               |
