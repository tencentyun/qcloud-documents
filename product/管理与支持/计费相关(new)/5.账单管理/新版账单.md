...
- 添加和管理自定义标签可前往 [资源标签添加页](https://console.cloud.tencent.com/tag/resources)。
- 于账单下载页下载的账单明细文件带自定义标签字段，此功能目前还在灰度阶段，如需开通白名单请联系您的客户经理或提交工单。
- 账单明细仅支持查看当月及此后月份添加的自定义标签键和标签值。例如：2月10日添加的标签键和标签值，可于2月账单明细中查看，1月及此前月份的账单则无法查看此标签键和标签值。
- 可于账单明细最后几列查看自定义标签键和标签值，按需筛选排序。
  ![](https://main.qcloudimg.com/raw/4d95316b5b05eb303ae511db929f6e4a.png)
