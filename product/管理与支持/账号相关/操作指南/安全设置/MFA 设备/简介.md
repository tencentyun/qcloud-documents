...
MFA，Multi-FactorAuthentication，即多因子认证，是一种简单有效的安全认证方法。它可以在用户名和密码之外，再增加一层保护。MFA 设备，又叫动态口令卡或 Token 卡，是提供这种安全认证方法的设备。目前腾讯云提供两种 MFA 设备： 硬件 MFA 设备和虚拟 MFA 设备 。
...
<table>
	...
	<tr><td>小程序云开发（TCB）</td>
	<td>
	<ul  style="margin: 0;"><li>数据库索引删除</li>
	<li>删除数据库集合</li>
	<li>更改数据库权限</li>
	<li>修改存储权限</li>
	<li>更改云函数配置</li></ul>
