...
腾讯云提供自助服务让你可以根据需要，在[合同管理](console.qcloud.com/account/contract)页面自助申请合同。
在线可以申请的合同种类包括：
...
## 在线申请合同流程
step1:  在[合同管理](console.qcloud.com/account/contract)页面，点击【申请合同】按钮
...
## 如何申请纸质合同
step 1: 在[合同管理](console.qcloud.com/account/contract)页面选中需要申请线下盖章的合同
...
快递发出后，你可以在[合同管理](console.qcloud.com/account/contract)页面查看快递单号。
