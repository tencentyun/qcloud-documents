为了保障您的腾讯云账号登录不受 QQ 、微信等安全策略影响，加强腾讯云账号安全，建议您为腾讯云账号绑定微信或邮箱登录方式，具体操作指引可以参考以下文档：
...
若您已忘记账号登录方式，可以通过  [自助申请](https://cloud.tencent.com/services/apply-login)  登录账号。
...
### 员工已经离职，且不记得账号下的资源，如何找回账号？

您可以联系 [在线客服](https://cloud.tencent.com/online-service)，提供企业证件资料后，获取账号信息。

### 安全手机不可用，该如何登录？

腾讯云账号不支持直接使用安全手机登录，若您在登录时需要验证手机，且手机不可用，您可以点击登录按钮右下方 使用备选校验方式 代替手机验证。
