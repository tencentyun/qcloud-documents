<<<<<<< HEAD:product/管理与支持/定价中心/计算/CVM 实例配置.md
下面将按可用区分别介绍各可用区内云服务器的配置。有关每种实例类型相关介绍可参考 [实例类型](/doc/product/439/6832)
=======
下面将按可用区分别介绍各可用区内云服务器的配置。有关每种实例类型相关介绍可参考 [实例类型](/doc/product/439/6812)
>>>>>>> origin/master:product/管理与支持/定价中心/计算/CVM 实例配置.md
...
需要申请试用，请点击 [这里](http://www.qcloud.com/event/cvm2.html)。
