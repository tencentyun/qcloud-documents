...
### 计费示例
按共享带宽包计费模式下，假设用户在新加坡使用公网网络，1月削峰后的计费带宽（详情请参见 [削峰规则](https://cloud.tencent.com/document/product/684/15255#.E5.8F.82.E6.95.B0.E8.AF.B4.E6.98.8E)）为10Mbps，则总费用为：108 元/Mbps/月 × 10Mbps = 1080（元）
