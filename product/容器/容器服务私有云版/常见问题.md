...
<table>
	...
	<td>TKE 企业版是腾讯云容器独立部署的商业化产品，由腾讯云容器团队和灵雀云合作研发。相对于开源版 TKE Stack 具备更丰富的产品功能，同时也提供商业级的支持和咨询服务。</td>
	</tr>
</table>
...
### TKE 企业版是否具备体验环境？
具备。如果您需要体验，请 [立即申请](https://cloud.tencent.com/apply/p/jdccz8k9ids)，通过后即可开始体验。
