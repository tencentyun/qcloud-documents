...
## 前提条件
已具备2个可使用节点，其中1个节点机型至少配置8核16G内存。另1个节点无特殊要求，作为 installer 节点使用。本文均以操作系统为 CentOS 7.6 的腾讯云云服务器为例。可参考 [快速配置 Linux 云服务器](https://tcloud-doc.isd.com/document/product/213/2936) 进行创建。
