...
本文档可以指导您使用 TDMQ Pulsar 版时，将自己当前私有网络 VPC 中的资源和TDMQ Pulsar 版开通互访，以保证您部署的生产者/消费者客户端能正常和TDMQ Pulsar 版通信。
...
>
> 您可以选择将您的集群升级至最新版本，具体说明请参考[集群版本更新记录](https://cloud.tencent.com/document/product/1179/55958)。
