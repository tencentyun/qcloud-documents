...
### 场景2：设置调用链 Tag
设置 `user=12345678` 的标签，用户可以在控制台调用链查询界面通过标签 custom.user=12345678 来检索调用链。注意需要添加“custom.”前缀查询。调用链标签的具体使用方法参见 [调用链](https://cloud.tencent.com/document/product/649/16622)。
<dx-codeblock>
:::  java
