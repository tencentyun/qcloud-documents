...
|SDK 版本号|新增特性|
|----|----|
|1.29.x|<li>新增微服务网关增加单元化功能</li><li>补齐 Spring Cloud Gateway 网关的服务治理能力</li><li>微服务网关支持托管外部 API</li><li>支持云上 Spring Cloud 应用平滑迁移 TSF。</li> <li>调用链支持 CMQ、PostgreSQL</li> |
