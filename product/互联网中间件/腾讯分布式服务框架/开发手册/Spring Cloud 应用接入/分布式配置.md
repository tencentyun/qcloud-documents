...
1. 完成轻量级服务注册中心的安装和启动，参考[轻量级服务注册中心](<https://cloud.tencent.com/document/product/649/16618>)
2. 服务已连接到轻量级服务注册中心

用户可以使用轻量级服务注册中心下发动态配置，下面以 provider-demo 为例说明更新 具体步骤如下：

1. 浏览器访问 consul [控制台]([http://127.0.0.1:8500](http://127.0.0.1:8500/)) 

2. 单击菜单栏 **Key/Value**

3. 点击 **Create**，在配置新建界面填写 key 和 value ，其中 
