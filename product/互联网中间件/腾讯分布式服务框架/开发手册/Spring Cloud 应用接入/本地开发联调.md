...
>? 注：TSF 1.29.5-Finchley-RELEASE、1.29.1-Greenwich-RELEASE、1.29.3-Hoxton-Higher-RELEASE 之前的版本必须需要设置以上参数才能在本地环境正常启动，否则会报错。 
...
如果本地网关调用的微服务名不是provider-demo，则想要修改分组 API 配置中的微服务名，即需要修改 api.json 里的 serviceName 属性的值（修改下图中红框标出的内容）：
![](https://qcloudimg.tencent-cloud.cn/raw/d7a7ae31a5a570181efa9c3a009a05e0.png)
