...
|---|---|---|
|Dockerfile|||
|jdk-8u171-linux-x64.tar.gz|Linux 64位 JDK| [ Oracle JDK ](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)|
|provider-demo-0.0.1-SNAPSHOT.jar|Spring Cloud 微服务 jar 包|[provider-demo-0.0.1-SNAPSHOT.jar ](https://main.qcloudimg.com/raw/8a71b41fee7908a6a9a3bd5ef03572d5/provider-demo-0.0.1-SNAPSHOT.jar) |
|start.sh|启动脚本，用于以下目的：<br>1. 支持 stdout 标准输出日志显示<br>2. 支持部署应用时设置  JVM  启动参数 |[start.sh ](https://main.qcloudimg.com/raw/d7a7565333eda38bbe79834d3224b775/start.sh) |
