...
>!对于1.12.0及之前版本的 TSF，要支持 stdout 日志，需要在启动命令中使用 start.sh 启动。以下代码片段为使用 start.sh 启动的示例。[start.sh 下载>>](https://main.qcloudimg.com/raw/d7a7565333eda38bbe79834d3224b775/start.sh)。
