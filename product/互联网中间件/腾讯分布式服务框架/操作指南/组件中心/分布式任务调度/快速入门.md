...
## 前提条件
开始使用分布式任务调度之前，请确保您已正确配置 [Maven 环境](https://cloud.tencent.com/document/product/649/20231)。
...
详细参数说明请参考 [任务管理使用指南](https://cloud.tencent.com/document/product/649/41400)。
![](https://main.qcloudimg.com/raw/8a15a829903fa6dc43e0352047dd3db2.png)
...
![](https://main.qcloudimg.com/raw/c9b8f8f0f22b62fabe5babf78979bc96.png)

### 步骤5：停止任务执行
任务执行完成之前，您可通过单击操作列的【停止执行】，手动强行终止任务的此次执行。

>?关于控制台操作的详细说明请参考 [任务管理使用指南](https://cloud.tencent.com/document/product/649/41400) 和 [执行记录使用指南](https://cloud.tencent.com/document/product/649/41642)。
