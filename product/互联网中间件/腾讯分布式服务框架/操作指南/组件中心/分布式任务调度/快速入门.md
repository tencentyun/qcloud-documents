...
2. 您可以选择基于TSF官方提供的demo实现快速开发（参考[Demo 下载](https://github.com/tencentyun/tsf-simple-demo)）
...
3. 在控制台新建任务之前，您需提前部署好执行任务的服务实例/节点，具体可参照[应用管理](https://cloud.tencent.com/document/product/649/13686)完成应用程序包的发布部署。
