...
2. 设置部署信息。
 ...
 - **更新方式**：选择部署的更新方式。
    ...
    - 更新策略：滚动更新方式可以设置更新策略，详情参考 [Kubernetes Deployment 滚动更新策略](https://kubernetes.io/zh/docs/concepts/workloads/controllers/deployment/#%E7%AD%96%E7%95%A5)。
