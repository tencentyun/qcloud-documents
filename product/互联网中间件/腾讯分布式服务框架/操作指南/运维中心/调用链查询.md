...
4. 根据查询结果，可以单击【TraceID】进入具体慢业务或出错业务，查看调用链详情。
   ![](https://main.qcloudimg.com/raw/a5ca26e8da1ac60f1f14396d8a73b8cf.png)
>?
>- 当前调用链查询功能支持查询消息队列组件（Kafka、CMQ、RocketMQ）、网关组件（微服务网关、API 网关）、数据库（Redis、MySQL、postgerSQL、MongoDB）和 httpclien (RestTemplate, Feign) 调用详情。
>- 不支持展示服务名为大写字母。
...
3. 在 TraceID 查询中，在搜索框中输入目标 TraceID，单击**查询**。
   ...
   ![](https://main.qcloudimg.com/raw/8a9477da0416dca5eb4298b3e309a9d1.png)
