...
- 版本号 `1.12.0-Edgware-RELEASE`  ，基于 Spring Cloud Edgware 版本SDK, 支持 springboot 1.5.x
- 版本号 `1.12.0-Finchley-RELEASE`  ，基于 Spring Cloud Finchley 版本SDK，支持 spring boot 2.0.x
