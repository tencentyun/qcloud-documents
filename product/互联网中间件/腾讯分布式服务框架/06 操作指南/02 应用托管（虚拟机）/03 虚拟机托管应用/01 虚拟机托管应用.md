...
<tbody><tr>
<td>jar</td>
<td>启动命令固定为 java -jar；支持 JDK 版本 KNOA JDK8，KNOA JDK11，KNOA JDK11，OPEN JDK8和 OPEN JDK17；支持用户设置启动参数</td>
</tr>
<tr>
<td>war</td>
...
9. 设置服务预热策略。当更新方式选择**滚动更新**时，建议开启服务预热，关于服务预热的作用和配置详情参见[服务预热]()。
...
12. 设置 Agent 配置信息。请选择需要挂载的 Agent，并填写版本号，如不填写将默认为您安装最新稳定版本。
    ...
    - 可观测 Agent：如您使用 Spring Cloud 2020，请勾选本选项。相关开发文档，请参考[使用 Agent 进行无侵入应用开发](https://cloud.tencent.com/document/product/649/79176)。
