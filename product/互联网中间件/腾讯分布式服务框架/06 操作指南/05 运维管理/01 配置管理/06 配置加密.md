...
1. 确保使用最新的 TSF SDK，参见 [Spring Cloud 应用概述](https://cloud.tencent.com/document/product/649/36285)。
2. 按照 [配置管理](https://cloud.tencent.com/document/product/649/16620) 添加了代码注释。
