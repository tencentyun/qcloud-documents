...
![](https://qcloudimg.tencent-cloud.cn/raw/4946ec6bf3d6f7ac34c95645fbbfa55c.png)
...
4. 通过**执行日志**可以查看执行实例的最新执行日志信息并支持模糊搜索；单击**更多**可以对正在执行中的节点执行**停止执行**，对已经完成的分片实例执行**重新执行**并产生新的执行流水记录历史执行版本，单击**分片参数**可以查看该分片对应的分片参数信息。
