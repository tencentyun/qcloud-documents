...
该任务指导用户依托TSF Mesh技术以服务形式托管Node.js和Nginx，最终验证Node.js与Nginx可以以服务形式注册、发现及成功调用。概要架构图如下：
...
Sidecar：和服务运行在同一个 Pod 中，与 Pod 共享网络，服务感受不到Sidecar的存在。

- Sidecar 代理服务向注册中心注册服务相关信息，以便其他服务发现自身。
- Sidecar 作为 Pod 内服务的 HTTP 代理，可以自动发现其他服务。

Consul Cluster：管理和配置Sidecar来执行策略并收集遥测。
...
1. 准备Node.js应用代码。
   ...
   可参考[demo](https://tsf-doc-attachment-1300555551.cos.ap-guangzhou.myqcloud.com/%E5%85%AC%E6%9C%89%E4%BA%91/tsf%20nodejs%20demo/tsf-nodejs-demo-john.zip)中配置文件进行构建，其它语言的TSF mesh的demo示例可参考[TSF Mesh Demo](https://cloud.tencent.com/document/product/649/30436)。

2. 制作Node.js+express应用镜像，详细操作参考[制作容器镜像](https://cloud.tencent.com/document/product/649/17007)。
3. 上传到腾讯云镜像仓库，详细操作参考[镜像仓库](https://cloud.tencent.com/document/product/649/16695)。

4. 部署Node.js应用：
   1. [创建应用](https://cloud.tencent.com/document/product/649/13686#.E5.88.9B.E5.BB.BA.E5.BA.94.E7.94.A8)。应用类型选择Mesh应用。
   2. 在左侧导航栏选择【部署组】>【新建部署组】，创建Node.js的部署组。
