...
### 创建策略时出现 resouce 字段格式错误

如果在填写策略中出现报错：resource字段格式错误，请检查一下几个步骤
1. 主账号id是多少，该id需要填写在授权策略中。
2. 主账号是否点击过概览页，如果没有点击，也会在授权中报错。概览页链接：https://console.cloud.tencent.com/tsf
3. 主账号在填写时，不需要尖括号
![](https://main.qcloudimg.com/raw/32e807e852eceeddc29ca05f57ec777c.png)
