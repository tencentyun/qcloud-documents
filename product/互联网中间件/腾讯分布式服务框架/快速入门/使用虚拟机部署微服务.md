...
在使用虚拟机部署微服务之前，请参考[协作者与子账号使用TSF](https://cloud.tencent.com/document/product/649/16869)文档检查自己是否已经有权限使用TSF产品的全部功能。
