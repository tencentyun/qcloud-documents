...
3. 设置集群的基本信息。
   ...
   - 标签：用于分类管理资源，详情参见 [标签](https://cloud.tencent.com/document/product/649/53869)。此处不填写。
   - 备注：集群的描述，不超过200个字符。
   - 数据集：将新建的集群添加到已有数据集中，详情参见 [数据集管理](https://cloud.tencent.com/document/product/649/38326)。此处不填写。
