...
2. 单击左侧导航栏 **应用管理**。
3. 在应用列表上方单击【新建应用】。
![](https://main.qcloudimg.com/raw/e0dcfe97f41d9ca71cff4397174a1e8f.png)
4. 设置应用信息后，单击【提交】按钮。
 - 应用类型: 选择容器应用。
...
### 步骤 5：创建镜像和推送镜像到仓库
在执行这些操作前，请确保执行命令的机器上已安装 `docker` ，同时制作镜像和上传镜像的机器可以访问 `ccr.ccs.tencentyun.com`。
