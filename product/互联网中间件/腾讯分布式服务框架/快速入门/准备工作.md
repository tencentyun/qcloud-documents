...
1. 应用 **主账号**登录 [TSF 控制台](https://console.cloud.tencent.com/tsf?rid=1)，进入概览页。由于没有授权腾讯微服务平台 TSF 服务角色权限无法访问其他云产品资源。
...
>?子账号使用 TSF 请参考 [访问管理](https://cloud.tencent.com/document/product/649/55570) 进行访问授权。
