...
3. 选择**腾讯云产品服务**，参考下图设置角色相关信息。
   - 选择【腾讯微服务平台】
     ![](https://main.qcloudimg.com/raw/9e5a976fa5eac3b0ef1b61cb99cc200c.png)
...
说明：腾讯微服务平台 TSF 于2019年10月11日升级了对企业客户的权限管理能力，支持配置为不同子账号配置灵活的操作、数据集权限。在根据本文为主账号、子账号、协作者配置使用 TSF 访问其他云产品权限后，子账号和协作者使用 TSF 平台还请参考文档管理中心。
