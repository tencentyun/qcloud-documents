...
![](https://main.qcloudimg.com/raw/d2f6c5fd7c2b6350bda76797cdbeb37a.png)
...
2.5 使用同样方式，绑定 `QcloudCamSubaccountsAuthorizeRoleFull` 预设策略。可选是否绑定 `QcloudTSFFullAccess` 预设策略（推荐绑定）。
...
4. 从策略列表中选择 `QcloudCCRFullAccess`  和 `QcloudCCSFullAccess` 策略。
![](https://main.qcloudimg.com/raw/3d9ce124a9a13d222ef23202f4098eff.png)
5. 单击【确定】，绑定策略。该策略会显示在用户的策略列表中。
![](https://main.qcloudimg.com/raw/18fed4e7c9824780e6c949734c653fff.jpg)
