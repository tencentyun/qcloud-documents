>  // 参考文档：http://tapd.oa.com/MiddlewareProduct/markdown_wikis/#1010159661007392583 (发布文档时，需要删除这一行)
...
> 注：本地配置和线上配置同时支持（需要符合spring-config源生规范）。

__本地YAML__

配置在application.yml或application-*.yml
