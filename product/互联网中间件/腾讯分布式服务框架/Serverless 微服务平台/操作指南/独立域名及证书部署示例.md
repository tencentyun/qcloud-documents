...
1. 登录 [TSF 控制台](https://console.cloud.tencent.com/tsf/app?rid=1)，在左侧导航栏选择【[部署管理](https://console.cloud.tencent.com/tsf/group)】。
2. 在部署组管理页，选择已创建的 Serverless 部署，打开外网访问生效状态。


![](https://ask.qcloudimg.com/draft/6936539/eki3hxg9ky.png)

​

1. 单击【API 网关访问服务名】进入 API 网关服务详情页。


![](https://ask.qcloudimg.com/draft/6936539/va7zcybsk4.png)
...
1. 配置 CNAME 解析完成后，在服务内配置绑定自定义域名（请确保先配置 CNAME 解析，再配置绑定）。
2. 若需要解绑，需先删除服务内绑定的自定义域名，再删除自定义域名的 CNAME。
...
[上一](https://cloud.tencent.com/document/product/649/38962)
