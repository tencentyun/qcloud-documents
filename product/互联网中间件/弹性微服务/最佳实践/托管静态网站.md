...
弹性微服务通过 **应用实例+CFS** 的方式提供静态网站资源托管的能力，本文以业界流行的静态网站服务 [Hugo](https://gohugo.io/) 为例，为您提供静态资源托管的最佳实践。下述将通过 Hugo 生成个人静态博客，然后通过弹性微服务部署反向代理应用，配合 CFS 管理静态资源，最后通过弹性微服务提供的访问配置，在公网上提供对个人静态博客的访问。
