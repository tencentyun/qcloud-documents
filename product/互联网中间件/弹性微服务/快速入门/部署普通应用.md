## 操作场景
本文以 Java 开发的 Demo 应用程序，采用 JAR 包上传部署方式，向您展示如何将您的非微服务应用部署在弹性微服务上，并让您的应用可以被公网访问。
...
本文以 Java Spring Boot 开发的 Demo 应用为例，[下载应用 JAR 包](https:/tem-demo-1254962064.cos.ap-shanghai.myqcloud.com/hello-world-0.0.1-SNAPSHOT.jar)（鼠标右键另存为链接）。
...
2. 单击【新建】，进入新建应用页面，填写应用信息。
 ![](https://main.qcloudimg.com/raw/bb9d23ce0ce3e96bf552e6d0a84cddd5.png)
...
>?如果您还未配置**容器镜像仓库**，或者在点击【下一步】时出现报错，请参考 [未配置容器镜像仓库的解决方案](https://cloud.tencent.com/document/product/1371/56950)。
>
4. 单击【提交】，并在弹框中单击【确定】，前往部署应用。
5. 在部署应用页面，根据您的应用具体情况配置相关参数。
![](https://main.qcloudimg.com/raw/0078dacbaf61a799f88a52b45a680bda.png)
	- 上传程序包：上传您的程序包。
	- 发布环境：选择刚刚创建好的环境。
...
![](https://main.qcloudimg.com/raw/a42ae9c50b476226de5fc81afa34e87e.png)
