...
为演示使用不同注册中心的Spring Cloud微服务应用，我们为您准备了两组生产者-消费者 Demo 应用，分别使用了 Consul 和 Eureka 两种注册中心。
...
6. 待部署的应用实例开始运行后，可进入微服务引擎控制台的 [注册中心](https://console.cloud.tencent.com/tse/registry?rid=4) 选择相应注册中心，查看 provider 应用是否注册成功。
![](https://main.qcloudimg.com/raw/95d1ce414fba79c2c8e9c06d91adfff6.png)
7. 重复**步骤1-6**，完成部署 consumer 应用。
