...
1. 使用 TSE 的权限，您可以通过授予子账号 QcloudTSEFullAccess 策略给予子账号使用 TSE 的全量权限。
2. 要将角色（及其许可策略）传递至 TSE 服务，用户必须具有**传递角色**至服务的许可，即创建 tse_PassRole 策略，详细操作参考 [授予 tse_PassRole 策略](#授予tse_PassRole策略)。
...
6. 填写策略名和内容，并单击**创建策略**。
   ![](https://qcloudimg.tencent-cloud.cn/raw/18cc1aff8964a83ff666b6d5a602a2e8.png)
