...
2. 使用 TSE 的权限，您可以通过授予子账号 QcloudTSEFullAccess 策略给予子账号使用TSE的全量权限。
...
3. 从策略列表中筛选出**步骤一**中的创建的策略（ 如`tse_PassRole`）。
 ![img](https://main.qcloudimg.com/raw/aa7fe4222b67ab2e4bdb9c364eea96b1.png)
4. 单击【确定】，绑定策略。该策略会显示在用户的策略列表中。
![img](https://main.qcloudimg.com/raw/f92babbe1176257335956ccd99c54c98.png)
