...
2. 在注册中心页面，单击目标实例的“实例Id”后，进入【基本信息】页面。基本信息包括实例的名称、状态、规格、版本、副本数量、内网访问方式、私有网络ID/名称、子网ID/名称、存储方式、实例节点信息。
![](https://github.com/chaoziyao63/PM-/blob/main/TSE/%E6%93%8D%E4%BD%9C%E6%8C%87%E5%8D%97/resources/1.1%2B1.2/351618245554_.pic_hd.jpg)
