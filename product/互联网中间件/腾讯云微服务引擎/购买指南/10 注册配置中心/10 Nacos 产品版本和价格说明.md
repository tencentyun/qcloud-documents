本章节主要介绍微服务引擎 TSE 注册配置中心 Nacos 的产品版本和计费模式。

## 产品版本

Nacos 按照版本分为标准版和开发版，两个版本的对比如下：
...
Nacos 提供按量计费（后付费）和包年包月（预付费）两种购买方式。
...
>- **计费示例**：您选了 2核4GB 规格的标准版 nacos 引擎，节点数为3，实例运行时间为2小时，那么总费用为1.05 × 3 × 2 = 6.3元。
...
>- **计费示例**：您选了 2核4GB 规格的标准版 nacos 引擎，节点数为3，实例运行时间为1个月，那么总费用为294 × 3 × 1 = 882元。
