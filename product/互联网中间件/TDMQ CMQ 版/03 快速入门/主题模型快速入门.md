...
> ?
>
> 以下示例以 Java 语言客户端说明，其他语言客户端接入请参考 [SDK 文档]()。
...
以上是 CMQ 的生产和消费方式的简单介绍，更多操作可参考 [Demo](https://tdmq-1300957330.cos.ap-guangzhou.myqcloud.com/TDMQ-demo/tdmq-cmq-demo/tdmq-cmq-Java-sdk-demo.zip)。
