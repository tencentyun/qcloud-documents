...
本文介绍数据接入平台的 HTTP 数据接入功能中的发送消息结合实际应用场景提供建议。
...
1. 在 [任务列表](https://console.cloud.tencent.com/ckafka/datahub-task) 页面，单击目标任务的操作栏的**更多** > **暂停**，可暂停任务。
2. 出现右上角的提示，则任务暂停成功。
![](https://qcloudimg.tencent-cloud.cn/raw/bb41fbb2c0a0b1165debe1bef0249264.png)
