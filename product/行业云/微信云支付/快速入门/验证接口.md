## 验证说明
- 完成注册后，服务商即可调用云支付接口。
- 云支付提供一个工具 [Demo](https://mc.qcloudimg.com/static/archive/b875e0166d488063adf0d9b26e295f90/Demo.zip)，可以验证服务商相关的账户等信息的正确性。要了解工具中如何调用云支付提供的 SDK，请参考[云支付SDK的API介绍文档>>](/document/product/569/8694)。
...
![](https://mc.qcloudimg.com/static/img/9838818f7b38fd42a4d14fae5d41a522/image.png)

### 刷卡支付相关验证

#### 刷卡支付验证

输入用户微信客户端的零钱包收付款里的授权码/订单号等信息，点击 **刷卡支付** 按钮，支付受理成功。支付是否成功，还需要通过查单接口去确认。

>注：订单号的前10位是云支付分配给子商户的云支付商户号。

![](https://mc.qcloudimg.com/static/img/732a213828f547ba0d84a90608b17dd7/image.png)

#### 查单验证

点击 **查询订单** 按钮，查询订单的支付结果。

![](https://mc.qcloudimg.com/static/img/e7862546ddf8db0443ed07571198e881/image.png)

#### 撤单验证

点击 **撤销订单** 按钮进行撤单。

![](https://mc.qcloudimg.com/static/img/f86a5f18d7e2d4683f9a1f4299aacbb4/image.png)
