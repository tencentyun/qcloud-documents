...
- 见[注册信息](https://www.qcloud.com/document/product/569/8695)文档。 
  ...
  在使用一码支付时需要将服务商的微信公众号的运营授权给腾讯云支付，服务商只需要将网页域名授权给腾讯云支付即可。具体操作：在添加服务商信息后点击确认按钮，会在浏览器上弹出一个新的页面，新的页面为微信开放平台的授权二维码，服务商需要用手机微信客户端扫描一下这个二维码，然后在手机端进行授权操作，授权成功后页面会弹出一个授权成功的提示。
