图片处理 IP 由 [数据万象 CI](https://cloud.tencent.com/document/product/460) 提供。腾讯云数据万象服务通过签名来验证请求的合法性。开发者通过将签名授权给客户端，使其具备上传下载及管理指定资源的能力。
...
4. 进入 [访问管理](https://console.cloud.tencent.com/cam/capi) API 密钥管理页面，获取 SecretId 和 SecretKey。
