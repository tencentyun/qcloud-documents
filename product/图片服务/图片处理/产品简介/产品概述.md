...
图片处理（Image Processing，IP）是由腾讯云 [数据万象](https://cloud.tencent.com/document/product/460) 提供的功能丰富、低成本、高可靠的图片处理服务。您可以进行灵活的图像编辑，如图片旋转、裁剪、转码、缩放等，并且提供 Guetzli 压缩、TPG 转码、HEIF 转码等图片瘦身解决方案，图片或文字水印、独有盲水印等版权保护解决方案，满足多种业务场景下的图片需求。
