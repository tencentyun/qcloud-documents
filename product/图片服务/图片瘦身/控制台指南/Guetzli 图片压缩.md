...
1. 开发者可通过控制台开通服务，开通后该存储桶中的图片在下载时会进行 Guetzli 压缩，并将压缩后的图片更新至 CDN 节点（如已开通 [CDN 服务](https://cloud.tencent.com/document/product/228)）。
...
3. 单击【样式】页签，开启 Guetzli 图片压缩功能，即可使用。
