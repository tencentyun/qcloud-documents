...
版权保护服务由腾讯云 [数据万象](https://cloud.tencent.com/document/product/460) 提供，盲水印功能是数据万象提供的全新水印模式。通过该功能，您可将水印图以不可见的形式添加到原图信息中，并不会对原图质量产生太大影响。在图片被盗取后，您可对疑似被盗取的资源进行盲水印提取，验证图片归属。
...
盲水印是付费服务，使用时需在相应存储桶配置页中通过开关开通服务。每个账户拥有三千次免费额度，超出后进行计费。具体费用请参见 [计费项](https://cloud.tencent.com/document/product/1234/44625)。
