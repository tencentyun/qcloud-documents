...
版权保护服务由腾讯云 [数据万象](https://cloud.tencent.com/document/product/460) 提供，数据万象按照**实际使用量付费**，采用**后付费**方式，次月3 - 7日会出本月账单，进行账号扣费。版权保护功能的详细计费项说明和价格等，请参见 [计费项](https://cloud.tencent.com/document/product/1234/44625)。
