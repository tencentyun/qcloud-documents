...
| 后台404错误数 | 请求后端服务失败，请求所希望的资源未被在后端服务器上发现，此类错误个数的统计 | 按照所选择的时间粒度统计求和 | 次   |
| 后台502错误数 | API 网关尝试执行后端请求时，从后端服务器接收到无效的响应，此类错误个数的统计 | 按照所选择的时间粒度统计求和 | 次   |

有关更多如何使用 API 网关的监控指标内容，请参见 [API 网关监控接口文档](https://cloud.tencent.com/document/product/248/35386)。
