监控组件离线判断条件：当一台云服务的监控组件持续5分钟未上报数据，平台认为该云服务器的监控组件已处于离线状态。
...
**问题排查方式：** 腾讯云的内网DNS配置可以参考 [内网 DNS 访问和设置](https://cloud.tencent.com/document/product/213/5225#dns-.E6.9C.8D.E5.8A.A1.E5.99.A8.E5.9C.B0.E5.9D.80)。
