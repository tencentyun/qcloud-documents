...
<span id="step1"></span>
#### 腾讯云内网下载地址
复制腾讯云内网下载地址，前往内网浏览器打开下载地址并下载监控组件，下载地址如下。
```plaintext
...
2. 运行该程序，即可进行自动化安装。
   安装成功时如下图所示：
    i. 运行服务，可查看到 QCloud BaradAgent Monitor 和 QCloud Stargate Manager 服务，并且为运行状态。
    ![](https://main.qcloudimg.com/raw/fa88598d5d632b66867c0f3749058b14.jpg)
   ii. 运行任务管理器，可查看到 BaradAgent 和 sgagent 进程。
