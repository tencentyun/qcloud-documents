...
| Instances.N.Dimensions.1.Name | Region | ECM 地域 | 输入 String 类型维度名称：Region|
| Instances.N.Dimensions.1.Value | Region | ECM 地域，可在 ECM 产品中使用 [DescribeNode](https://cloud.tencent.com/document/api/1108/42567) 接口查询 Region 列表 | 输入 ECM 具体地域，例如：ap-zhengzhou-ecm |
| Instances.N.Dimensions.2.Name | ISP | 节点运营商 | 输入 String 类型维度名称：ISP |
| Instances.N.Dimensions.2.Value | ISP | 节点具体运营商，可在 ECM 产品中使用 [DescribeNode](https://cloud.tencent.com/document/api/1108/42567) 接口查询 Region 支持的 ISP 列表 | 输入节点具体运营商，例如："CTCC"电信;"CUCC"联通;"CMCC"移动 |
...
&Namespace=QCE/ECM
&Instances.N.Dimensions.1.Name=Region
&Instances.N.Dimensions.1.Value=ECM 具体地域
&Instances.N.Dimensions.2.Name=ISP
&Instances.N.Dimensions.2.Value=节点具体运营商
