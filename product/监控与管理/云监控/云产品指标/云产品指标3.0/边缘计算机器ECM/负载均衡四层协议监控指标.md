...
| InPkg      | 入包量     | 在统计周期内，负载均衡每秒接到的请求数据包数量     | 个/秒 | 10、60S、300S、3600S、86400S |
| InTraffic  | 入带宽     | 在统计周期内，客户端通过外网访问负载均衡所用的带宽 | Mbps  | 10、60S、300S、3600S、86400S |
| OutPkg     | 出包量     | 在统计周期内，负载均衡每秒发出的数据包数量         | 个/秒 | 10、60S、300S、3600S、86400S |
| OutTraffic | 出带宽     | 在统计周期内，负载均衡访问外网所用的带宽           | Mbps  | 10、60S、300S、3600S、86400S |
