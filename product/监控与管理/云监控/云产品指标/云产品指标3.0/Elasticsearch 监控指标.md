...
| JvmOldMemUsageAvg | 平均 JVM old 区内存使用率 | ES 集群各节点 JVM old 区内存使用率的平均值 | ES 集群各节点 JVM old 区的平均内存使用率 | %        | uInstanceId | 60s、300s          |
| JvmOldMemUsageMax | 最大 JVM old 区内存使用率 | ES 集群各节点 JVM old 区内存使用率的最大值 | ES 集群各节点 JVM old 区的最大内存使用率 | %        | uInstanceId | 60s、300s          |
