...
| Connum        | 活跃连接数             | 个      | 4、7   |
| NewConn       | 新增连接数             | 个/s    | 4      |
| Intraffic     | 公网入带宽             | Mbps    | 4、7   |
| Outtraffic    | 公网出宽带             | Mbps    | 4、7   |
| Inpkg         | 入包量                 | 个/秒   | 4、7   |
| Outpkg        | 出包量                 | 个/秒   | 4、7   |
| InactiveConn  | 非活跃连接数           | 个      | 4、7   |
| ConcurConn    | 并发连接数             | 个      | 4      |
| AccOuttraffic | 外网出流量             | MByte   | 4、7   |
| ClbHttp3xx    | CLB 返回的3xx状态码     | 个/分钟 | 7      |
| ClbHttp404    | CLB 返回的404状态码     | 个/分钟 | 7      |
| ClbHttp4xx    | CLB 返回的4xx状态码     | 个/分钟 | 7      |
| ClbHttp502    | CLB 返回的502状态码     | 个/分钟 | 7      |
| ClbHttp5xx    | CLB 返回的5xx状态码     | 个/分钟 | 7      |
| Http2xx       | 后端 rs 返回的2xx 状态码 | 个/分钟 | 7      |
| Http3xx       | 后端 rs 返回的3xx 状态码 | 个/分钟 | 7      |
| Http404       | 后端 rs 返回的404状态码  | 个/分钟 | 7      |
| Http4xx       | 后端 rs 返回的4xx状态码  | 个/分钟 | 7      |
| Http502       | 后端 rs 返回的502状态码  | 个/分钟 | 7      |
| Http5xx       | 后端 rs 返回的5xx状态码  | 个/分钟 | 7      |
| ReqAvg        | 平均请求时间           | 毫秒    | 7      |
| ReqMax        | 最大请求时间           | 毫秒    | 7      |
| RspAvg        | 平均响应时间           | 毫秒    | 7      |
| RspMax        | 最大响应时间           | 毫秒    | 7      |
| RspTimeout    | 响应超时个数           | 个/分钟 | 7      |
| SuccReq       | 每分钟成功请求数       | 个/分钟 | 7      |
| TotalReq      | 每秒请求数             | 个      | 7      |
