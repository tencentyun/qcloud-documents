...
| 指标英文名    | 指标中文名         | 单位    | 统计周期     |
| ------------- | ------------------ | ------- | ------------ |
| AccOuttraffic | 外网出流量         | MB      | 10s、60、300 |
| ClbHttp3xx    | CLB 返回的3xx状态码 | 个/分钟 | 60、300      |
| ClbHttp404    | CLB 返回的404状态码 | 个/分钟 | 60、300      |
| ClbHttp4xx    | CLB 返回的4xx状态码 | 个/分钟 | 60、300      |
| ClbHttp502    | CLB 返回的502状态码 | 个/分钟 | 60、300      |
| ClbHttp5xx    | CLB 返回的5xx状态码 | 个/分钟 | 60、300      |
| ConNum        | 公网连接数         | 个      | 60、300      |
| Http2xx       | 2xx状态码         | 个/分钟 | 60、300      |
| Http3xx       | 3xx状态码         | 个/分钟 | 60、300      |
| Http404       | 404状态码          | 个/分钟 | 60、300      |
| Http4xx       | 4xx状态码          | 个/分钟 | 60、300      |
| Http502       | 502状态码          | 个/分钟 | 60、300      |
| Http5xx       | 5xx状态码          | 个/分钟 | 60、300      |
| InactiveConn  | 非活跃连接数       | 个      | 60、300      |
| InPkg         | 入包量             | 个/秒   | 10、60、300  |
| InTraffic     | 公网入带宽         | Mbps    | 10、60、300  |
| NewConn       | 新增连接数         | 个/秒   | 60、300      |
| OutPkg        | 公网出包量         | 个/秒   | 10、60、300  |
| OutTraffic    | 公网出带宽         | Mbps    | 10、60、300  |
| ReqAvg        | 平均请求时间       | 毫秒    | 60、300      |
| ReqMax        | 请求最大时延       | 毫秒    | 60、300      |
| RspAvg        | 平均响应时间       | 毫秒    | 60、300      |
| RspMax        | 最大响应时间       | 毫秒    | 60、300      |
| RspTimeout    | 响应超时个数       | 个/分钟 | 60、300      |
| SuccReq       | 每分钟成功请求数   | 个/分钟 | 60、300      |
| TotalReq      | 每秒请求数         | 个      | 60、300      |
