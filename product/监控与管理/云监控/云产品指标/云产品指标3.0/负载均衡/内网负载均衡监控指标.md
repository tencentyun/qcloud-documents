...
| 指标英文名 | 指标中文名 | 单位  | 统计周期       |
| ---------- | ---------- | ----- | -------------- |
| ConNum     | 当前连接数 | 个    | 60、300、86400 |
| InPkg      | 入包量     | 个/秒 | 60、300、86400 |
| InTraffic  | 入带宽     | Mbps  | 60、300、86400 |
| NewConn    | 新增连接数 | 个/秒 | 60、300、86400 |
| OutPkg     | 出包量     | 个/秒 | 60、300、86400 |
| OutTraffic | 出带宽     | Mbps  | 60、300、86400 |
