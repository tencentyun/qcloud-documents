...
| Instances.N.Dimensions.1.name  | vpcId            | 私有网络 ID的维度名称         | 输入String类型维度名称：vpcId                                |
...
内网负载均衡支持以下两种维度组合的查询方式，两种入参取值如下：<br>

1.内网负载均衡维度，入参取值如下：

&Namespace=QCE/LB_PRIVATE<br>
...
&Instances.N.Dimensions.2.Value为端口号 <br>
&Instances.N.Dimensions.3.Name=protocol<br>
&Instances.N.Dimensions.3.Value为协议类型<br>