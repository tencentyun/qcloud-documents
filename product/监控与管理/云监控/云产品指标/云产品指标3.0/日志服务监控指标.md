...
| ------------------- | ---------- | ---- | ------------ | ------------------------ |
| TrafficWrite        | 写流量     | MB   | uin、TopicId | 60s、300s、3600s、 86400s |
| TrafficIndex        | 索引流量   | MB   | uin、TopicId | 60s、300s、3600s、 86400s |
...
| StorageLog          | 日志存储量 | MB   | uin、TopicId | 60s、300s、3600s、 86400s |
| StorageIndex        | 索引存储量 | MB   | uin、TopicId | 60s、300s、3600s、 86400s |
