...
| StorageMin       | 内存使用量       | %     | 实际使用内存容量，包含数据和缓存部分                         | instanceid |
| StorageUsMin     | 内容使用率       | MB    | 实际使用内存和申请总内存之比                                 | instanceid |
...
| StorageMin       | 内存使用量         | %     | 实际使用内存容量，包含数据和缓存部分                         | instanceid |
| StorageUsMin     | 内存使用率         | MB    | 实际使用内存和申请总内存之比                                 | instanceid |
...
| StorageMin       | 内存使用量   | %     | 实际使用内存容量，包含数据和缓存部分                         | instanceid、clusterid |
| StorageUsMin     | 内存使用率   | MB    | 实际使用内存和申请总内存之比                                 | instanceid、clusterid |
