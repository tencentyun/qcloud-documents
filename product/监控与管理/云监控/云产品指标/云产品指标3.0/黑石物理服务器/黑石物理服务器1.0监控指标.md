...
| Instances.N.Dimensions.0.Value | instanceId | 黑石物理服务器具体实例 ID        | 输入实例具体ID，例如：cpm-test，可通过查询黑石物理服务器接口 [DescribeDevice](https://cloud.tencent.com/document/product/386/6728) 获得 |
