...
| K8sContainer<br/>RateCpuCoreUsedRequest       | CPU 利用率（占Request）               | %        | 必填维度：tke_cluster_instance_id、<br>workload_name<br/>选填维度（必选其中任一维度）：namespace、node_role、node、un_instance_id、pod_name、       container_name、container_id、workload_kind | 60s、<br/>300s、<br/>3600s、<br/>86400s |
