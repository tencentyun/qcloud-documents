...
| Instances.N.Dimensions.2.Value | namespace   | 具体的空间名称，[查询服务列表](https://cloud.tencent.com/document/product/457/9440) 接口中返回的namespace（命名空间）字段 | 输入命名空间具体名称，例如： default |

## 入参说明

查询容器服务服务维度监控数据，入参取值如下：<br>
