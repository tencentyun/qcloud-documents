...
| 2xxResponseRate | 2xx 状态码占比 | 当前存储桶出现 2xx 错误占比率 | 次   | appid、bucket |
| 3xxResponseRate | 3xx 状态码占比 | 当前存储桶出现 3xx 错误占比率 | 次   | appid、bucket |
| 4xxResponseRate | 4xx 状态码占比 | 当前存储桶出现 4xx 错误占比率 | 次   | appid、bucket |
| 5xxResponseRate | 5xx 状态码占比 | 当前存储桶出现 5xx 错误占比率 | 次   | appid、bucket |
...
| 400ResponseRate | 400 状态码占比 | 当前存储桶出现 400 错误占比率 | 次   | appid、bucket |
| 403ResponseRate | 403 状态码占比 | 当前存储桶出现 403 错误占比率 | 次   | appid、bucket |
| 404ResponseRate | 404 状态码占比 | 当前存储桶出现 404 错误占比率  | 次   | appid、bucket |
| 500ResponseRate | 500 状态码占比 | 当前存储桶出现 500 错误占比率  | 次   | appid、bucket |
| 501ResponseRate | 501 状态码占比 | 当前存储桶出现 501 错误占比率 | 次   | appid、bucket |
| 502ResponseRate | 502 状态码占比 | 当前存储桶出现 502 错误占比率 | 次   | appid、bucket |
| 503ResponseRate | 502 状态码占比 | 当前存储桶出现 503 错误占比率 | 次   | appid、bucket |
