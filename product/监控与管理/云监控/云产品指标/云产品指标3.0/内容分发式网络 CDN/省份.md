...
| ------------- | -------------- | -------------- | ---- | ----------------------------- |
| Bandwidth     | 带宽           | 带宽           | Mbps | domain,isp,projectid,province |
| Traffic       | 流量           | 流量           | MB   | domain,isp,projectid,province |
| HitTraffic    | 命中缓存的流量 | 命中缓存的流量 | MB   | domain,isp,projectid,province |
| RequestTotal  | 总请求次数     | 总请求次数     | 次   | domain,isp,projectid,province |
| HttpStatus2xx | 状态码2xx      | 状态码2xx      | 次   | domain,isp,projectid,province |
| HttpStatus3xx | 状态码3xx      | 状态码3xx      | 次   | domain,isp,projectid,province |
| HttpStatus4xx | 状态码4xx      | 状态码4xx      | 次   | domain,isp,projectid,province |
| HttpStatus5xx | 状态码5xx      | 状态码5xx      | 次   | domain,isp,projectid,province |
