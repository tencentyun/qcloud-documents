...
| HttpStatus5xxRate   | 5xx状态码占比             | 次   | projectId、domain |
| HttpStatusErrorRate | 错误状态码占比（4xx+5xx） | 次   | projectId、domain |
| BackOriginHttp200   | 回源状态码200             | 次   | projectId、domain |
| BackOriginHttp206   | 回源状态码206             | 次   | projectId、domain |
| BackOriginHttp2xx   | 回源状态码302             | 次   | projectId、domain |
| BackOriginHttp302   | 回源状态码304             | 次   | projectId、domain |
| BackOriginHttp304   | 回源状态码401             | 次   | projectId、domain |
| BackOriginHttp3xx   | 回源状态码403             | 次   | projectId、domain |
| BackOriginHttp401   | 回源状态码404             | 次   | projectId、domain |
| BackOriginHttp403   | 回源状态码500             | 次   | projectId、domain |
| BackOriginHttp404   | 回源状态码502             | 次   | projectId、domain |
| BackOriginHttp4xx   | 回源状态码2xx             | 次   | projectId、domain |
| BackOriginHttp500   | 回源状态码3xx             | 次   | projectId、domain |
| BackOriginHttp502   | 回源状态码4xx             | 次   | projectId、domain |
