...
|DiskTota|磁盘分区利用率 |	磁盘分区已使用容量和总容量的百分比（区分磁盘）|%|InstanceId、diskname|   60s、300s、<br/>3600s、86400s|
|DiskUsage    |磁盘分区总容量 |磁盘分区总容量  |% |InstanceId、diskname|   60s、300s、<br/>3600s、86400s|
