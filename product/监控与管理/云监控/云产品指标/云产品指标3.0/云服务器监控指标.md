...
> - DiskReadTraffic、DiskWriteTraffic、DiskUsage、DiskIoAwait 指标支持 QCE/CVM 和
[QCE/BLOCK_STORAGE](https://cloud.tencent.com/document/product/248/45411) 两种命名空间，命名空间不同，支持的维度也不同。
