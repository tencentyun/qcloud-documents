...
| MediaRequsetSuccessRate | 媒体处理请求成功率 | 统计媒体处理任务成功次数在总次数中的比例 | 次   | appid、bucket |
...
| FaceEffectsFailRequests          | 人脸特效请求数           | 人脸特效请求调用次数         | 次   | appid、bucket |
...
| FaceIdentityCheckFailRequests    | 人脸核身请求数           | 人脸核身请求调用次数         | 次   | appid、bucket |
