...
| ImageRecognizeLogSuccessRequests        | LOGO识别请求成功数 | LOGO识别请求调用成功次数 | C    | appid、bucket |
| ImageAutoTranslationBlockSuccessRequests      | 同步翻译请求成功数 | 同步翻译请求调用成功次数 | C    | appid、bucket |
