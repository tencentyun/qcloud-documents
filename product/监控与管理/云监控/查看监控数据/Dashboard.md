...
2. 在弹窗中选择所需订阅的产品类型、关注的指标以及实例对象
   ...
   支持自定义图表类型（曲线图/折线图）![1](http://mc.qcloudimg.com/static/img/8a707f720633464440b72a77b84a4268/image.png)

3. 添加的新图表默认展示在面板最下方的空位，用户可拖拽图表改变面板中图表的排序；也可以拖拽图表边框，改变图表的大小。

   ![2](http://mc.qcloudimg.com/static/img/c7b133dc81f171ae5bb7dedb6af6d65d/image.png)
...
4. 可通过拖拽改变监控面板的顺序![7](http://mc.qcloudimg.com/static/img/8a5d8e65e9c0674ca3e3d1f870868d6e/image.png)
