...
## Windows 安装指引
1) 用户 [登录 Windows 实例](/doc/product/213/5435)后，内网访问 `http://mirrors.tencentyun.com/install/monitor/windows-stargate-installer.exe` 下载安装包 `windows-stargate-installer.exe`。
