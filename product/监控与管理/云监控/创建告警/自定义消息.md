...
- API：使用发送自定义消息内容api，传递指定消息策略ID与告警内容，将告警信息推送至对应消息策略。
...
1） 通过登陆登录【腾讯云控制台】[自定义消息页面](https://console.cloud.tencent.com/monitor/message) 获取对应告警分发目的策略的策略ID。
...
![](https://main.qcloudimg.com/raw/37829fc4a64767acb5a8eabe35813538.png)
4）（可选）在右上侧搜索框内输入告警消息内容关键字或者调用cagent_toolsCVM的内网ip，检索对应的告警记录。
![](https://main.qcloudimg.com/raw/05e040c20f319f267065017abdeff565.png)
