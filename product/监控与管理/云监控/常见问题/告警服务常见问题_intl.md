...
Yes. A CVM can only be bound with one alarm policy. For example: CVM "1.1.1.1" has been associated with alarm policy A. If a user associates CVM "1.1.1.1" with alarm policy B, the association with alarm policy A will be automatically canceled.
