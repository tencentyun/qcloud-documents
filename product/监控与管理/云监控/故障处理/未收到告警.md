...
2. 在用户列表中单击对应的用户名称，进入用户详情页。
	...
	- 微信认证：请参考  [微信渠道](https://cloud.tencent.com/document/product/248/50414) 进行认证。
...
3. 查看告警接收对象是否包含未收到告警的用户。若出现“未设置”或没有此用户，请参考  [创建告警接收组](https://cloud.tencent.com/document/product/248/50408) 添加用户到告警接收组。
...
> ?进行此步骤前请确保您的微信渠道是否认证，如未认证请参考 [微信渠道](https://cloud.tencent.com/document/product/248/50414) 进行认证。
