...
下列将通过Demo演示，为您介绍如何使用  <dx-tag-link link="https://cloud.tencent.com/document/api/248/51287" tag="API">创建告警策略接口</dx-tag-link>等接口创建云服务器-基础监控告警策略。
...
2. 将 准备好的个人密钥对应复制到对应的 SecretId、SecretKey 文本框。
