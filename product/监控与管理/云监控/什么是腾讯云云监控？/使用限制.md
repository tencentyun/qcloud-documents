...
<table>
	...
	<tr>
		...
		<td>接口调用</td>
		<td>每个主账号的免费请求额度为100万次/月，超出免费额度后如需继续使用 API 接口请求监控数据，请在开通页手动开通“API 请求按量付费”，详细计费说明和开通方法请参见 <a href="https://cloud.tencent.com/document/product/248/77914">云监控 API 计费说明。 </a> </td>
	</tr>
</table>
