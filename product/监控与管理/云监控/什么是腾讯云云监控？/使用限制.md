...
<table>
	...
	<tr>
		...
		<td>监控面板默认最大限制为20个。如需增量请 <a href="https://console.cloud.tencent.com/workorder/category">提交工单</a> 申请。</td>
	</tr>
	<tr>
		<td nowrap="nowrap">监控图表</td>
		<td>监控图表默认可绑定实例上限为50个。如需增量请 <a href="https://console.cloud.tencent.com/workorder/category">提交工单</a> 申请。</td>
	</tr>
	<tr>
		<td rowspan="4">告警</td>
