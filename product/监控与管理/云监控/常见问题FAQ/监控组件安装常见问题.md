...
1. [登录到Windows 实例](https://www.qcloud.com/document/product/213/5435) 后，内网访问`http://mirrors.tencentyun.com/install/monitor/windows-stargate-installer.exe` ， 下载安装包 `windows-stargate-installer.exe`。
