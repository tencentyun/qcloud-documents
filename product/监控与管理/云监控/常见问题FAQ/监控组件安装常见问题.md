...
1. [登录到Windows 实例](https://www.qcloud.com/document/product/213/5435) 后，从`http://mirrors.tencentyun.com/install/monitor/windows-stargate-installer.exe` ， 下载安装包 `windows-stargate-installer.exe`。请注意：  
内网，可直接下载使用；  
外网，进入虚拟机后才能使用。  
