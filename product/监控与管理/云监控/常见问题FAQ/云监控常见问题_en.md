...
Log in to Tencent Cloud Console, click "Cloud Products" - "Cloud Monitor" to and enter the CVM list. If you see a yellow exclamation mark on a CVM, the Monitor Agent is not installed in the CVM. You can click to export IP addresses of these CVMs based on the note on the top.
