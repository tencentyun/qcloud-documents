...
<table>
    ...
    <tr>
        ...
        <td>云监控全面继承开源 Prometheus 监控能力。不仅提供高可用的 Prometheus 托管服务，还高度集成可视化 Grafana。Prometheus 托管服务和腾讯云容器服务（TKE）自动集成，免去用户搭建运维及开发成本。</td>
        <td>2020-09-23</td>
        <td>
         <a href="https://cloud.tencent.com/document/product/248/48686">Promethues 托管服务简介</a>         </td>
	<tr>
        <td>Dashboard 全新改版</td>
        <td>大幅度提高了图表配置的灵活性和监控数据的可视化能力，同时集中解决了 Dashboard 1.0 历史遗留的痛点。<br>
