...
- 已创建 [腾讯云容器服务—托管版集群](https://cloud.tencent.com/document/product/457/32189#.E4.BD.BF.E7.94.A8.E6.A8.A1.E6.9D.BF.E6.96.B0.E5.BB.BA.E9.9B.86.E7.BE.A4.3Cspan-id.3D.22templatecreation.22.3E.3C.2Fspan.3E)：在腾讯云容器服务中创建 Kubernetes 集群。
...
3. 在告警策略管理页中单击【新建】，在弹框中配置告警策略信息。
 ...
 - **注释**：可使用默认模板也可自定，表示允许 用户自定义各告警渠中的告警内容。                                       
 - **告警通知**：支持自定义告警通知模板，包含模板名称、通知类型、接收对象接收渠道等，详情请参见 [通知模板](https://cloud.tencent.com/document/product/248/48955)。
![](https://main.qcloudimg.com/raw/6dcb2bb691f6df60d70fe58f10c5b539.png)
