...
2. 申请开通云监控 [Prometheus 托管服务](https://cloud.tencent.com/apply/p/cb3dj6vzk8s)。Prometheus 托管服务暂不收费，您需要申请开通。
...
2. 单击【集成容器服务】> 选择对应的容器集群 >【安装】来进行自动化集成，在安装弹框中可以选择需要集成的基础监控组件，整体集成操作为异步操作，大约需要2 - 3分钟，监控状态显示 “已安装” 即装成功。
