...
* 用户可通过 Dashbaord 订阅最关心的监控指标，并通过定期巡检/大屏展示dashbaord面板的方式掌握核心实例的性能状况。
* 用户可通过 Dashboard 订阅一个业务/集群下的总性能状况。直观地了解资源总体情况，避免逐个查阅监控数据的效率问题。

Dashboard的具体使用方式可参考：[配置 Dashboarad](https://cloud.tencent.com/document/product/248/13119)

#### 通过流量监控查看

流量监控为用户提供了云服务器公网流量监控功能，展示了用户账号下所有云服务器外网出带宽的汇总数据。

登录 [云监控控制台](https://console.cloud.tencent.com/monitor)，单击流量监控，进入管理页面。
...
2. [配置 Dashboarad](https://cloud.tencent.com/document/product/248/13119)。
