...
3. [配置 Dashboard](https://cloud.tencent.com/document/product/248/46747)。
4. 在 Dashboard 页面，找到您想导出数据的监控项，在其上方单击 `...`，如下图所示。
![](https://qcloudimg.tencent-cloud.cn/raw/47f4b4764dbdb11a8fb34c71b2c2b65b.png)
5. 单击**导出数据**，导出对应的实例监控详情列表。
