云监控支持通过访问管理（CAM）实现主账号对子账号的权限控制。您可以参考本文档管理子账号访问权限。
...
<table>
	...
	<tr>
		...
		<td rowspan="2"><li>在已授予云产品策略的前提下，授予子账号“QcloudMonitorFullAccess”权限，子账号能正常使用云监控所有功能。<br><li>若只授予子账号“QcloudMonitorReadOnlyAccess”权限，子账号只是无法新建告警策略，其它功能可正常使用。</td>
	</tr>
	<tr>
