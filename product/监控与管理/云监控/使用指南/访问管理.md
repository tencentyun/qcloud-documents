...
> ?
> - 本文以产品类型—云服务器为例，介绍云服务器常见权限配置。其余产品可参下列场景介绍和 [云监控相关的云产品策略](#.E4.BA.91.E7.9B.91.E6.8E.A7.E7.9B.B8.E5.85.B3.E7.9A.84.E4.BA.91.E4.BA.A7.E5.93.81.E7.AD.96.E7.95.A5)。
> - 文档开通对应云产品权限。
