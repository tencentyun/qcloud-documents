Dashboard支持最近访问面板、收藏面板和自定义面板三种方式切换查看。本文将为您介绍新建 Dashboard后如何查看 Dashboard。
...
2. 在左侧导航栏中点击【Dashboard列表】，进入Dashboard 列表页。

### 全屏查看
1. 在 Dashboard 列表中找到你需要查看的 Dashboard，单击对应的面板名，进入 Dashboard管理页。
...
可按键盘中的【Esc】或单击右上角的关闭按钮【![](https://main.qcloudimg.com/raw/a17845392bb1de1adc043d86fc738244.png)】退出全屏。
...
2. 如下图单击 面板区的【![](https://main.qcloudimg.com/raw/86958abf68c7e937324b89b7a043fd0e.png)】，即可进行最近访问面板、收藏面板和自定义面板三种方式切换查看。
 ...
 - 收藏面板：展示您所收藏的所有面板。
 - 自定义面板：展示您所自定义的所有面板。
![](https://main.qcloudimg.com/raw/47736500875951a662e9c704605d603f.png)

>? 
>
>- 如需收藏面板请参步骤 [收藏 Dashboard ](在线文档)。

### 调整 Dashboard 时间跨度和刷新频率

Dashboard 默认展示近12小时的数据，监控数据默认实时刷新。 

-  通过 Dashboard 右上角的时间选择控件，可调整面板中所有图表展示的数据区间和粒度。用户可回顾历史监控数据、进行排障定位问题。 ![](https://main.qcloudimg.com/raw/d89d4ce295991fa2feaa33b2c864d4f8.png)
