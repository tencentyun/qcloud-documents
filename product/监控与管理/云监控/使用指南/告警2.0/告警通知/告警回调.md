...
![](https://qcloudimg.tencent-cloud.cn/raw/f95a5bf3ad265f07511b483a0eda5d3f.png)

### 将告警消息投递到云函数（SCF）

您可以通过云监控告警回调功能，将告警消息投递到腾讯云云函数（SCF），再通过云函数的 Serverless 无服务架构函数计算提供回调消息的处理及响应。如需了解更多使用场景可参考 [云函数](https://cloud.tencent.com/document/product/583/9199)。
...
您可以参考上述填写格式，在通知模板-告警回调填入云函数信息。例如：SCF:gz/default/example-alarm-callback/$LATEST

![](https://qcloudimg.tencent-cloud.cn/raw/5f533d6a370f9ba181d15251ce3dd47e.png)
...
> ? 如需获取产品策略类型和命名空间，请参见 [产品策略类型](https://cloud.tencent.com/document/product/248/50397) 和 [云产品指标](https://cloud.tencent.com/document/product/248/6140)。
