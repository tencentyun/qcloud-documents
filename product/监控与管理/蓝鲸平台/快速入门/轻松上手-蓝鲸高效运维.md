...
步骤1： 点击打开蓝鲸桌面上的【 Agent 安装2.0】应用，如下图所示。
...
（3）创建好的流程，单击【保存】进行保存。原子里的参数，需要保存为流程里的参数。在单击【保存】时会有提示，一键设置就完成了。
![标准运维](https://mc.qcloudimg.com/static/img/b302868d5d5faf6f8ae86c5cd5977dbc/51.jpg)  

步骤2：执行一个流程。

（1）选择【任务流程】，单击【新建任务】，填写数据流程的参数，就可以执行流程了。  
