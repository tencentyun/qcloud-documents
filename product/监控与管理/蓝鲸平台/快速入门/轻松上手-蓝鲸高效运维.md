...
- 配置平台：配置业务与服务器的关系。为什么要先操作配置平台呢？配置平台是一切操作的基础，可以配置业务，以及业务下有哪些服务器，业务的负责人，方便用户分权限和隔离来管理服务器（需要用户自己进入”资源池“，将腾讯云的业务和服务器会同步到配置平台）。
- 安装 Agent ：Agent 占用空间小，不影响服务器使用，是命令执行、文件传输、数据上报的基础。
