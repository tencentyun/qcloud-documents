...
2. 通过 [密钥管理系统控制台](https://console.cloud.tencent.com/kms2/whitebox) 或 [API](https://cloud.tencent.com/document/product/573/45805) 的方式，将收集到的设备指纹列表上传并绑定到指定的白盒密钥上。详细说明和操作步骤请参见 [设备指纹绑定功能详解](https://cloud.tencent.com/document/product/573/45919)。
