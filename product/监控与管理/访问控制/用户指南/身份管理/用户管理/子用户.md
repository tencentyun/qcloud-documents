...
### 管理子账号的登录密码
1.	登录腾讯云控制台，进入 [用户管理](https://console.cloud.tencent.com/cam)。 
2.	在用户列表中选择需要修改密码的子用户，选择具体【用户名称】，进入用户详情页。
3.	在用户详情页中选择【安全】>【访问安全】>【控制台登录管理】，单击【管理】，即可设置当前用户密码。如下图所示：
 ![](https://main.qcloudimg.com/raw/670c2dae02d10213c9ce521cad3e091d.png)
4.	如您需要当前子用户可以通过登录控制台访问腾讯云，请在【控制台访问】中选择启用。
5.	为子用户设置新密码，您可以通过以下两种方式。
  - 使用系统生成的随机密码：
若您在【访问密码】中选择【自动生成的密码】，系统会自动生成控制台登录密码。您可以复制保存，如有需要可以点击【下载.csv】保存密码。
  - 使用用户自定义密码：
若您在【访问密码】中选择【自定义密码】，输入您为该子用户设置的控制台登录密码。
6. 如您需要当前用户自行重置密码，可勾选【需要重置密码】，子用户在下次登录成功后将被要求重新设置控制台登录密码。
