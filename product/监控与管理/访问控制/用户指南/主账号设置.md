...
主账号默认拥有账号下腾讯云所有资源，无需授权，可以任意访问其任何资源。因此，不建议您使用主账号对资源进行操作，应创建子账号并按照最小权限原则赋予策略，使用权限范围有限的子账号操作您的云资源。更多账号权限的使用建议请参阅 [安全最佳实践](https://cloud.tencent.com/document/product/598/10592)。
...
如果您想了解如何修改主账号用于安全验证的安全手机或安全邮箱，请参阅  [邮箱手机号码方面常见问题](https://cloud.tencent.com/document/product/378/17357)。
