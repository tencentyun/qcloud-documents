...
1. 进入 [Azure AD 门户页](https://portal.azure.com/#home)，单击左侧导航面板中，单击【Azure Active Directory】。如下图所示：
...
>?<sup>1</sup>用户名格式为：用户名@域名，其中用户名您可以自定义，域名可以单击左侧【Azure Active Directory】> 概述，查看您之前设置的【初始域名】，您可以复制保存用户名、密码留用。
