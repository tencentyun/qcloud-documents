...
3. 单击**创建你自己的应用程序**打开“创建你自己的应用程序”窗口，选择**集成未在库中找到的任何其他应用程序(非库)**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/95f42f9dc39f57d6372deb3655701fcb.png)
4. 填写**名称**，单击**添加**，即可完成 Azure AD 应用程序的创建。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/2f161741e376cf475e2c4c0ff6a5a561.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/e96cc6350286720dd406b8b19b9350eb.png)
...
>
3. 在 “SAML 单一登录”概览界面，单击“属性和索赔”右上角的<image style="margin:0;" src="https://main.qcloudimg.com/raw/836588594e0a214b5951ee5207fc2353.png">，打开“用户属性声明”编辑页面。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/ff12dfd0cf7f40a7c8856c61ca9e8310.png)
4. 在“属性和索赔”编辑页面，单击**添加新的声明**，进入“管理声明”页面。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/94a45334b6de9588e992972ad1407d05.png)
5. 在“管理用户声明”页面，增加以下两条声明，并单击**保存**。
<table>
<thead>
<tr>
<th>名称</th>
...
>
1.	单击左侧导航栏 **Azure Active Directory**，单击**用户>所有用户**。
2. <span id="step2"></span>单击左上角**+新用户>新建用户**，在“用户”页面填写**姓名**、**用户名**，勾选**显示密码**，信息无误后单击下方**创建**完成创建。
...
4. 单击**添加用户/组**，选择 [步骤2](#step2) 您创建的用户，单击**选择**。
5. 跳转到“添加分配”页面，确认后单击**分配**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/57f768601f341d0a7a8eb16023d1827f.png)
6. 在左侧导航栏中，选择 **Azure Active Directory**>**企业应用程序**> 您创建的应用程序 ，进入应用程序概览页面。
7. 单击**单一登录**，打开 “SAML 单一登录”概览界面，单击**测试**。如下图所示：
![](https://qcloudimg.tencent-cloud.cn/raw/6586022a3ecdf0ce3dd13ae5e24a88eb.png)
