...
3. 在 “Display Name” 中输入应用名 ，并单击【SAVE】，即可完成应用程序的创建，（本文以 “test” 为示例）。如下图所示：
...
1. 登录并访访问 [OneLogin 应用管理页](https://xiaoyu.onelogin.com/apps)，单击已创建的 “test” 应用，跳转至应用编辑页。
2. 单击【Configuration】，输入以下内容，并选择【SAVE】。如下图所示：
...
7. 使用 [步骤3](#step3) 创建的帐户登录 OneLogin ，访问上述创建的 SAML 应用 “test”。如下图所示：
![](https://main.qcloudimg.com/raw/3a45e770e6bcaa01fb9bc9ba22f25200.png)
9. 登录成功之后即可跳转至腾讯云控制台。如下图所示：
