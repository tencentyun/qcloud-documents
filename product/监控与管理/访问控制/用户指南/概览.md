...
<dx-tabs>
::: <b>具有\sQcloudCamSummaryAccess\s策略</b>
具有 QcloudCamSummaryAccess 策略权限的用户登录控制台，可查看所有模块的信息，如下图示：
>?主账号、管理员用户（AdministratorAccess）均已包含该策略权限。

![](https://main.qcloudimg.com/raw/ad421aaff75cffa4ea2687167d210394.png)
:::
::: <b>没有\sQcloudCamSummaryAccess\s策略</b>
没有 QcloudCamSummaryAccess 策略权限的用户登录控制台，只能查看 **登录链接** 和 **上次登录信息**，如下图示：
...
![](https://main.qcloudimg.com/raw/c597ded80b09bc305522439d60ce7d79.png)
:::
</dx-tabs>
