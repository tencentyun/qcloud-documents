...
```
>?对象存储 COS 的资源六段式为  qcs::cos:$region:uid/$appid:$bucketname-$appid/$ResourcesPath，其中 $ResourcesPath 为具体的资源路径，且 $ResourcesPath 中不能使用上述策略变量，完整的COS 存储桶 Bucket 的资源六段式如下：qcs::cos:ap-guangzhou:uid/1250000000:examplebucket-1250000000/path_1/path_2/pic.jpeg。
