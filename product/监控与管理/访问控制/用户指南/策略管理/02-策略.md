...
4. 单击【创建策略】。其中策略名称是自动生成的，前缀policygen是固定的，后面的数字是根据创建的时间来确定的，策略内容也是自动生成的，是我们之前选择的服务和操作所对应的，我们可以在策略内容里面进行微调，有相关问题的话，可以单击左下方【策略语法说明】和【支持业务列表】。
![](https://mc.qcloudimg.com/static/img/e544dff9d49760af82f582a169583710/image.png)


### 按业务权限创建：

1. 登录腾轮云控制台，进入 [策略管理](https://console.qcloud.com/cam/policy)页面，单击【自定义策略】,并单击【按业务权限创建】。
...
2. 选择模版类型，并输入关键字进行搜索，选择其中一个模版，然后单击【下一步】。在这里我们以模版类型为全部模版，关键字为a搜索，并选择AdministratorAccess模版。
![](https://mc.qcloudimg.com/static/img/4a3abf6b7ed48f1dc78360db6cad4e1d/image.png)

3. 编辑策略内容，单击【创建策略】。其中策略名称是自动生成的，其中前缀policygen是固定的，后面的数字是根据创建的时间来确定的，有相关问题的话，可以单击左下方【策略语法说明】和【支持业务列表】。
