...
2. 策略管理方式默认为预设策略，请您选择其中一项您想要使用的策略，单击该策略的名称。
...
4. 请您勾选出您想要进行操作的用户或者用户组，单击【解除用户/用户组】。
...
2. 策略管理方式默认为预设策略，单击【自定义策略】，请您选择其中一项您想要使用的策略，单击该策略的名称。
...
### 用户关联预设策略
1. 登录腾讯云控制台，进入 [访问管理](https://console.cloud.tencent.com/cam)页面，单击【用户管理】，单击你想要操作的用户的名称。
...
4. 勾选出您想要关联的自定义策略，单击【确定】。
![](https://mc.qcloudimg.com/static/img/d82e0b52bb9ed8ccbd12dbb222e9858b/image.png)

### 用户组关联预设策略

1. 登录腾讯云控制台，进入 [访问管理](https://console.cloud.tencent.com/cam)页面，单击【用户组管理】，单击你想要操作的用户组的名称。
