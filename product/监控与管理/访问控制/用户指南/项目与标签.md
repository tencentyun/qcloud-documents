...
[项目管理](https://cloud.tencent.com/document/product/378/8192) 是基于项目维度对资源进行集中管理。您可以将支持项目功能的云产品资源添加至项目，并通过【新建自定义策略】>【[按产品功能或项目权限创建](https://console.cloud.tencent.com/cam/policy/create)】生成项目管理策略。您可将项目策略关联至项目相关用户或用户组，以允许用户拥有项目资源的操作权限。
>? 
