...
如果您已针对资源创建了标签，并且希望能够给子账号赋予一类或多类标签附着的资源访问权限，您需要通过【[按标签授权](https://console.cloud.tencent.com/cam/policy/createByTag)】创建自定义策略。详情请参阅 [按照标签授权](https://cloud.tencent.com/document/product/598/10601#.E6.8C.89.E6.A0.87.E7.AD.BE.E6.8E.88.E6.9D.83)。
