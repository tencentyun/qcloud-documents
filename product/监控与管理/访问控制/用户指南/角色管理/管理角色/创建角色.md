...
公司 A 企业账号 CompanyExampleA（ownerUin 为 12345），创建⼀个角色并将信任实体设置为公司B的企业账号 CompanyExampleB（ownerUin 为 67890）。
...
经过上⾯的步骤，公司 A 企业账号 CompanyExampleA（ownerUin 为 12345） 完成了将角色的创建和授权。
