...
对表中信息进行如下定义：
1. 服务：支持 CAM 的云服务的名称，单击链接至对应产品服务文档方便您快速获取相关信息。
2. 策略语法：当前服务是否支持通过策略语法进行权限管理，“√”表示支持，“-”表示暂不支持。
3. 云 API：当前服务是否支持通过云 API 进行权限管理，“√”表示支持，“-”表示暂不支持。
4. 控制台：当前服务是否支持在控制台进行权限管理，“√”表示支持，“-”表示暂不支持。
5. 授权粒度：当前服务提供的最小授权粒度。
6. 临时证书（STS）：当前服务是否支持通过临时证书进行权限管理，“√”表示支持，“-”表示暂不支持。
7. 角色：当前服务是否支持角色，支持角色的服务展示服务别名，“-”表示暂不支持。
...
| ------------------------------------------------------------ | -------- | ------ | ------ | -------- | -------- | ---- |
| [云服务器](https://cloud.tencent.com/document/product/213/10314) | ✔        | ✔      | ✔      | 资源级   | ✔        |   cvm.qcloud.com  |
| 安全组                                                       | ✔        | ✔      | ✔      | 资源级   | ✔        | -    |
| [黑石物理服务器](https://cloud.tencent.com/document/product/386/13245) | ✔        | ✔      | ✔      | 资源级   | ✔        | -    |
| [云硬盘](https://cloud.tencent.com/document/product/362)     | ✔        | ✔      | ✔      | 资源级   | ✔        | -    |
| [容器服务-集群](https://cloud.tencent.com/document/product/457/11542) | ✔        | ✔      | ✔      | 资源级   | ✔        | ccs.qcloud.com    |
| [容器服务-镜像仓库](https://cloud.tencent.com/document/product/457/11527) | ✔        | ✔      | ✔      | 资源级   | ✔        | ccs.qcloud.com    |
| [容器服务-持续集成](https://cloud.tencent.com/document/product/457/11542) | ✔        | ✔      | ✔      | 资源级   | ✔        | ccs.qcloud.com    |
| [弹性伸缩](https://cloud.tencent.com/document/product/377)   | ✔        | ✔      | ✔      | 服务级   | -        | -    |
| [无服务器云函数](https://cloud.tencent.com/document/product/583/18014) | ✔        | ✔      | ✔      | 资源级   | ✔        | scf.qcloud.com    |
| [批量计算](https://cloud.tencent.com/document/product/599)   | ✔        | ✔      | ✔      | 资源级   | ✔        | -    |
| [对象存储](https://cloud.tencent.com/document/product/436/12469) | ✔        | ✔      | ✔      | 资源级   | ✔        | cos.qcloud.com   |
...
| [日志服务](https://cloud.tencent.com/document/product/614)   | ✔        | -      | ✔      | 服务级   | -        |  cls.cloud.tencent.com |
...
| [消息队列 CKafka](https://cloud.tencent.com/document/product/597/17989) | ✔        | ✔      | ✔      | 资源级   | ✔        | ckafka.qcloud.com   |
| 消息订阅                                                     | ✔        | -      | ✔      | 服务级   | -        | - |
...
| [流计算服务](https://cloud.tencent.com/document/product/849) | ✔        | ✔      | ✔      | 服务级   | ✔        | scs.qcloud.com       |
...
| [物联网通信](https://cloud.tencent.com/document/product/634) | ✔        | ✔      | ✔      | 服务级   | ✔        |  iotcloud.qcloud.com    |
...
| [云审计](https://cloud.tencent.com/document/product/629)     | ✔        | ✔      | ✔      | 操作级   | ✔        | cloudaudit.cloud.tencent.com    |
| [万象优图](https://cloud.tencent.com/document/product/460)   | ✔        | -      | ✔      | 服务级   | -        | - |
| [微信云支付](https://cloud.tencent.com/document/product/569) | ✔        | -      | ✔      | 服务级   | -        | - |
| [云数据库 MongoDB](https://cloud.tencent.com/document/product/240)         |-        | -      | -      | -   | -        | mongodb.qcloud.com    |
| [腾讯云应用服务平台](https://cloud.tencent.com/document/product/876)     |-        | -      | -      | -   | -        | tcb.cloud.tencent.com    |
| [分布式服务框架](https://cloud.tencent.com/document/product/649)     |-        | -      | -      | -   | -        | tsf.qcloud.com    |
| [织云](https://cloud.tencent.com/document/product/609)                |-        | -      | -      | -   | -        | zhiyun.cloud.tencent.com    |
| [宙斯盾安全防护](https://cloud.tencent.com/product/aegis)       |-        | -      | -      | -   | -        |  aegis.qcloud.com    |
| [API 网关](https://cloud.tencent.com/document/product/628)         |-        | -      | -      | -   | -        | apigateway.qcloud.com    |
| [物联网套件](https://cloud.tencent.com/document/product/568)         |-        | -      | -      | -   | -        | iotsuite.cloud.tencent.com    |
| [蓝鲸平台](https://cloud.tencent.com/document/product/274/3463)         |-        | -      | -      | -   | -        | blueking.cloud.tencent.com    |
| 媒体转码服务 |-        | -      | -      | -   | -        | mts.tencent.com    |
...
| 服务                                           | 角色 |
| ---------------------------------------------- | ---- |
| [腾讯区块链开发平台](https://trustsql.qq.com/) |  baas.qq.com    |
