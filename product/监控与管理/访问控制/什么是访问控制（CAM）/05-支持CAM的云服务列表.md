...
| 弹性伸缩 | 支持 | 支持  |支持| 服务级 | 支持 
| 大禹 | 支持 | 支持  |支持| 服务级 | 支持 
| 测试服务 | 支持 | 不支持  |支持| 服务级 | 不支持 
| 游戏服务 | 支持 | 不支持  |支持| 服务级 | 不支持 
| 消息服务 | 支持 | 支持  |支持| 服务级 | 支持 
| 云波测 | 支持 | 不支持  |支持| 服务级 | 不支持 
...
说明：
1)“云 API”是指云 API 是否接入了 CAM，“控制台”是指控制台是否接入了CAM。 
