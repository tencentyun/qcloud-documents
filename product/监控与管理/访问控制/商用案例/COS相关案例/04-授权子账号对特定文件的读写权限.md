企业账号 CompanyExample（ownerUin 为12345678，appId 为1250000000）下有一个子账号 Developer，该子账号需要拥有对企业账号 CompanyExample 的 COS 服务的上海地域名为 Bucket1 的存储桶的 dir1 目录下对象 Object1 的读写权限。
