...
<tr>
		<td>云数据库 Memcached</td>![](https://qcloudimg.tencent-cloud.cn/raw/e44f99977b5cb8d1b41be76693bf6721.png)
...
部分服务支持一键安装 Agent ，详情请参考 [支持服务列表](#s1)
1. 登录 [云监控 Prometheus 控制台](https://console.cloud.tencent.com/monitor/prometheus)。
2. 在实例列表中，选择对应的 Prometheus 实例。
3. 进入实例详情页，单击**集成中心**。
4. 在集成中心选择支持一键安装的服务，单击模块左下角的**安装**按钮。
   ![](https://qcloudimg.tencent-cloud.cn/raw/7bf9ca2f3f583a8322ec909fc0235fc4.png)
5. 在集成列表页，填写指标采集名称和地址等信息，并单击保存即可。如下图以 Kafka 为例：
   ![](https://qcloudimg.tencent-cloud.cn/raw/6d462239a32f9066b95865558f3448b3.png)
...
4. 在集成中心选择对应的服务。您可以单击**接入指南**查看接入指引，接入成功后即可实时监控对应的服务。您还可以单击 **Dashboard 安装/升级**按钮安装或升级该服务的 Grafana Dashboard。
   ![](https://qcloudimg.tencent-cloud.cn/raw/8bd2248112b1e49b9e9b65ae5e35a8a3.png)
