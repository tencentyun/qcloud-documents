...
sum by (cluster) (kube_node_status_allocatable_memory_bytes)  >(count by (cluster) (kube_node_status_allocatable_memory_bytes)-1)  /count by (cluster) (kube_node_status_allocatable_memory_bytes)</td>
<td>5m</td>
...
<td>5m</td>
<td>集群内 CPU 配额超过可分配 CPU 总量<br>注意：注册集群需删除 `resource="cpu"`</td>
</tr>
<tr>
<td>集群内存配额过载</td>
...
<td>5m</td>
<td>集群内内存配额超过可分配内存总量<br>注意：注册集群需删除 `resource="memory"`</td>
</tr>
<tr>
<td>配额资源快使用完</td>
...
<td>15m</td>
<td>配额资源使用率超过90%<br>注意：注册集群需删除` type="used"`</td>
</tr>
<tr>
<td>CPU 执行周期受限占比高</td>
