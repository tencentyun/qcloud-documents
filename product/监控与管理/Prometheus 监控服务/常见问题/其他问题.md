...
目前只能通过api导出，参考 [HTTP API Reference](https://grafana.com/docs/grafana/latest/http_api/)
...
暂不支持，只能通过API拉取。详情请参考 [监控数据查询](https://cloud.tencent.com/document/product/1416/56026)。

### Prometheus支持哪些云产品？

云服务器、云数据库 MongoDB、云数据库 MySQL、云数据库 PostgreSQL、云数据库 Redis、ElasticSearch、容器服务等。详情请查看 [集成中心](https://cloud.tencent.com/document/product/1416/55782)。
