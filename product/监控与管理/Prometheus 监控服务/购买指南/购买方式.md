...
<tr>
<td>数据存储时间</td>
<td>选择数据保存的时长，详情请参见 <a href = "https://cloud.tencent.com/document/product/1416/65379">按量计费</a>。</td>
</tr>
<tr>
<td>实例名称</td>
<td>输入该实例的名称。</td>
...
<tr>
<td>标签</td>
<td>输入该实例的标签（可选），标签配置可参考<a href = "https://cloud.tencent.com/document/product/1416/55785">标签管理</a>。</td>
</tr>
<tr>
<td>购买时长</td>
<td>选择购买的时长。</td>
...
2. 填写完后阅读并勾选相关协议条款，并单击**立即购买**。
3. 在支付页面，您可通过余额支付、网银支付、微信支付、QQ 钱包支付等方式进行支付。
...
## 后续操作
 ...
 [快速使用云监控 Prometheus 监控服务](https://cloud.tencent.com/document/product/1416/55778)。
