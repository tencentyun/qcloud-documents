...
### 查看事件详情
1. 若您需查看某一事件的详细信息，单击列表中事件前的 <img src="https://main.qcloudimg.com/raw/01149711e1d47fd4bbd2051a58b7211d.png" style="margin:-1px 0px">。
2. 在展开的模块中，选择【查看事件】。如下图所示：
![](https://main.qcloudimg.com/raw/19f3f3534a634bd844cff46a55f020cb.png)
3. 可在右侧模块中查看事件详细信息，字段说明请参考 [附录](#appendix)。
...
<table>
<tr>
<th>名称</th><th>类型</th><th>示例</th><th>描述</th>
</tr>
<tr>
