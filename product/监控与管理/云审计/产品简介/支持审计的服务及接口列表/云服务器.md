...
| 销毁云主机 V3                      | cvm  | PurgeInstances                           |
| 重启云主机 V3                      | cvm  | RebootInstances                          |
| 释放 EIPV3                      | cvm  | ReleaseAddresses                         |
| 续费云盘                         | cvm  | RenewCbsStorage                          |
| 续费 CDH 实例                      | cvm  | RenewHosts                               |
| 续费云主机                        | cvm  | RenewInstances                           |
| 重装云主机 V3                      | cvm  | ResetInstance                            |
...
| 创建云主机 V3                      | cvm  | RunInstances                             |
| 启动云主机 V3                      | cvm  | StartInstances                           |
| 关闭云主机 V3                      | cvm  | StopInstances                            |
| 同步镜像 V3                       | cvm  | SyncImages                               |
| 销毁云硬盘                        | cvm  | TerminateCbsStorages                     |
| 删除云主机 V3                      | cvm  | TerminateInstances                       |
