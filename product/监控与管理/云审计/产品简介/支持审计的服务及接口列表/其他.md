...
| 数据库管理            | 用于检查资源连通性。               | dmc       | CheckDmcResourceRoute                    |
| 数据库管理            | 用于 dmc 资源创建使用。                 | dmc       | CreateDmcResource                        |
| 数据库管理            | 用于创建 dmc 资源用户信息。           | dmc       | CreateDmcResourceUser                    |
| 数据库管理            | 用于拉取 dmc 资源列表。              | dmc       | DescribeDmcResources                     |
| 数据库管理            | 用于 dmc 资源销毁。                  | dmc       | DestroyDmcResource                       |
| 数据库管理            | 用于修改 dmc 资源名称。             | dmc       | ModifyDmcResourceName                    |
| 数据库管理            | 用于 dmc 资源用户信息修改。           | dmc       | ModifyDmcResourceUser                    |
| 数据库管理            | 用于修改 dmc 资源 vip/vport 。 | dmc       | ModifyDmcResourceVipVport                |
