...
## API Description
This API (DeleteResourceTag) is used to disassociate resources on Tencent Cloud from tags.
...
```
https://domain/v2/index.php?Action=DeleteResourceTag&tagKey=t1&tagValue=v1&resource=qcs::cvm:ap-beijing:uin/1234567:instance/ins-123&<Common request parameters>
```
### Output example
