...
- 根据资源的地域、类型以及标签来搜索资源，查看到的资源将会以列表的形式展示。具体操作请参考 [查看绑定资源](https://cloud.tencent.com/document/product/651/56720)。

更多操作请参考 [操作指南](https://cloud.tencent.com/document/product/651/56715)。
