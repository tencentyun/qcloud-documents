...
- 若您还未使用 SkyWalking，建议 [下载最新版本 Java Agent](http://skywalking.apache.org/downloads/?spm=a2c4g.11186623.2.12.65355968AbUoDc)。将压缩包解压到相应目录。

### 步骤 3：配置相应参数及名称

Skywalking Agent 支持多种方式完成参数配置，不同配置方式之间可以彼此组合，下面给出配置方式及其示例。

#### 方法 1：使用 agent.config 文件配置
