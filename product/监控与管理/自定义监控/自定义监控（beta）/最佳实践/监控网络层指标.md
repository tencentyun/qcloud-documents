...
1. 下载 [ServerMonior.py]() 文件，获取采集和上报数据 Demo。
...
1. 确认用户消息通道已验证，可在 [CAM 鉴权](https://console.cloud.tencent.com/cam) 页面查看验证情况。
	 ![](https://main.qcloudimg.com/raw/40d8fc368c138745c17a12621e82ccf4.jpg)
...
Tcp 连接失败数大于0，5分钟后收到短信告警，短信内容如下：
