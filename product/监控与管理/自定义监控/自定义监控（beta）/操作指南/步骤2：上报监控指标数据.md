...
2. 获取上报 Demo
   ...
   > ? 
   > 1. 不建议使用参数 AnnounceIp 上报主机 IP，建议使用 AnnounceInstance 进行 IP 或实例名的上报。
   > 2. Region 可查询可用 [地域列表](#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8)。
   > 3. AnnounceTimestamp 自行指定上报的时间戳，为空时默认上报当前时间。
   > 4. 更多详细说明请参考 [输入参数说明](#.E8.BE.93.E5.85.A5.E5.8F.82.E6.95.B0)。
...
![](https://main.qcloudimg.com/raw/830746b3220b8849d424f3e7398c759f.jpg)
   4. 获取 Demo
      ...
      ![](https://main.qcloudimg.com/raw/e99fad00f96748ef775b551798f9f6ce.jpg)
