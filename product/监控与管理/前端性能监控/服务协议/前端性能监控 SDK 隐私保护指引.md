...
| **个人信息** | **获取信息&用途**                                            |
| ------------ | ------------------------------------------------------------ |
| 网络类型     | 获取终端用户通过什么网络类型访问第三方平台，如3G、4G、5G、WIFI 等，根据网络类型分类可视化展示前端性能状况。 |
| 操作系统     | 获取终端用户访问第三方平台时所使用的操作系统，如 Macos、Windows、IOS 等，根据操作系统分类可视化展示前端性能状况。 |
| 运营商类型   | 获取终端用户通过什么运营商访问第三方平台，如移动、联通、电信等，根据运营商类型分类可视化展示前端性能状况。 |
| 地区         | 获取终端用户通过哪些地域访问第三方平台，如广东、福建等，根据地域分类可视化展示前端性能状况。 |
| 设备型号     | 获取终端用户通过哪些设备访问第三方平台，如广东、福建等，根据设备型号分类可视化展示前端性能状况。 |
| 设备 UA       | 获取终端用户通过什么浏览器版本访问第三方平台，并根据浏览器版本分类展示前端性能状况。 |
