...
>? 1. 引入的包应当足够的轻量，确保压测脚本能够顺利执行。 2. PTS 不是 NodeJS，所以三方脚本中加载 NodeJS 库不会生效。 3. 不支持 TypeScript 语法。 4.不支持浏览器中的函数，例如 setTimeout，XMLRequest 等。
...
文档：https://github.com/brix/crypto-js
...
文档：https://github.com/ricmoo/aes-js
