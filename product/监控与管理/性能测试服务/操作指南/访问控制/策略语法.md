...
访问策略语言描述了策略的基本元素和用法，有关策略语言的说明请参考 [CAM 策略管理](htpts://cloud.tencent.com/document/product/598/10600)。
