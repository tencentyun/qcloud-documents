...
- TCCLI 依赖于 TencentCloudApi Python SDK，如果 TencentCloudApi Python SDK 的版本号小于要安装 TCCLI 版本号，在安装 TCCLI 时会自动升级 TencentCloudApi Python SDK。如需查看 TCCLI 最新版本相关，请前往 [github 仓库](https://github.com/TencentCloud/tencentcloud-cli)。
</dx-alert>
