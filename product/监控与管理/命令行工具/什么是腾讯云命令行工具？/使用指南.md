...
容器服务 TKE 支持安装 Nginx-ingress 扩展组件，使用 Nginx-ingress 来接入 Ingress 流量。关于 Nginx-ingress 组件的更多介绍，请参见 [Nginx-ingress 说明](https://cloud.tencent.com/document/product/457/51260)。本文将介绍 Nginx-ingress 组件的一些常见最佳实践指引。
...
6. 创建 Ingress 时指定具体的 IngressClass 将 Ingress 绑定到具体的 Nginx Ingress 实例上。您可通过控制台或 YAML 创建 Ingress：
<dx-tabs>
::: 通过控制台创建\sIngress
