...
<td style='padding-left:6%;'><li>基础底码编辑器<br><li>支持小程序、H5 <br><li>支持数据后台展示</td>
...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=ame&amp;Version=2019-09-16&amp;Action=DescribePackageItems" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn" target="_blank"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
