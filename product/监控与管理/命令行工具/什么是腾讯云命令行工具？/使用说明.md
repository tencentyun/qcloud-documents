...
- 已 [创建云函数](https://tcloud-doc.isd.com/document/product/583/19806?!preview&!editLang=zh#.E5.88.9B.E5.BB.BA.E5.87.BD.E6.95.B0) 并开启公网访问。
...
4. 您可以将多个函数上报后关联至同一个应用，便可以查看调用链路的情况。如下图所示：
