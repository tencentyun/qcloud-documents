...
<tr>
<td>s3Url</td>
<td>对象存储 COS 兼容的 S3 API 访问地址。请注意该访问地址中的域名不是上述创建 COS 存储桶的公网访问域名，须使用格式为 <code>https://cos.region.myqcloud.com</code> 的 URL，例如地域是广州的话，参数值为 <code>https://cos.ap-guangzhou.myqcloud.com</code></td>
</tr>
</tbody></table>
