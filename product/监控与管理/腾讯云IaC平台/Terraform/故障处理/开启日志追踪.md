...
```
如下图所示，可查看 Terraform 本地文件夹会生成一个 `terraform.log` 的文件。文件记录了 tencentcloud provider 定义的日志输出。
![](https://qcloudimg.tencent-cloud.cn/raw/345ef1676030a314f123ec3f8ad52c61.png)
