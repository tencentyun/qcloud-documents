...
3. 确认 Plan 操作的执行结果是否符合预期，重点关注是否有资源 destory、add 的情况，确认无误后，单击【下一步】。
   ![image-20200710154824278](https://main.qcloudimg.com/raw/03d4e9c359bced382f2340841f8256d1.png)
   >?因为是导入存量资源，正常情况是不应该出现有资源创建、修改、删除的操作，若 Plan 结果中显示 add、change、destroy 的资源数不为0，请终止后续的操作，检查是否编辑了上一步提到的 ForceNew 参数。若仍有疑问，请 [提交工单](https://console.cloud.tencent.com/workorder/category)，联系 TIC 团队确认后，再执行后续的操作。
