...
| 错误     | 用于展示当前用于或实例错误曲线图和错误列表                 | [错误](https://cloud.tencent.com/document/product/1349/52253)     |
| 事务追踪 | 用于展示当前应用或实例所属的的事务                        | [事务追踪](https://cloud.tencent.com/document/product/1349/52249) |
| 服务接口 | 展示当前应用或实例所属的的服务接口                         | [服务接口](https://cloud.tencent.com/document/product/1349/52258) |
