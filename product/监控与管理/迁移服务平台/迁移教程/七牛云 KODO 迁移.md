...
3. 设置要迁移的文件来源。
此处迁移源服务提供商应选择七牛云 KODO，并在下方 AccessKey，SecretKey 文本框中输入七牛云 AK，SK 密钥。填入密钥后，单击下拉框右侧**刷新**按钮，即可获取源对象存储桶列表。
![](https://main.qcloudimg.com/raw/3dff45f757e801795c85978748dc4a1f.jpg)
4. 选择文件存储方式。
