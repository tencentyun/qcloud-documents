...
3. 设置要迁移的文件来源。
此处迁移源服务提供商应选择 UCLOUD UFile，并在下方 AccessKey，SecretKey 文本框中输入 UCLOUD API 密钥。源对象存储桶列表可在填入密钥后单击下拉框右侧刷新按钮获取。
![](https://main.qcloudimg.com/raw/59cc09f54f381f7557bdc4226f8371c8.jpg)
4. 选择文件存储方式。
