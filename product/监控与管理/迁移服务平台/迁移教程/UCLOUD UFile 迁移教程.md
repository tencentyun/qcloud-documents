...
下文将详细介绍当源对象存储部署在 UCLOUD UFile 时，如何配置全托管公网迁移任务，实现数据迁移。
...
3. 设置要迁移的文件来源。
此处迁移源服务提供商应选择 UCLOUD UFile，并在下方 AccessKey，SecretKey 文本框中输入 UCLOUD API 密钥。填入密钥后，单击“迁移桶名称”下拉框右侧的**刷新**按钮，即可获取源对象存储桶列表。
![](https://main.qcloudimg.com/raw/8618d432e64b585b0e153a4a89d9b3a2.jpg)
4. 选择文件存储方式。
