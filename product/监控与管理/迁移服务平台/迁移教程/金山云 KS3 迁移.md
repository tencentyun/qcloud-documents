...
3. 设置要迁移的文件来源。
此处迁移源服务提供商应选择金山云 KS3，并在下方 AccessKey，SecretKey 文本框中输入先前新建用于迁移的金山云子用户 AccessKeyID，AccessKeySecret。填入密钥后，单击下拉框右侧的**刷新**按钮，即可获取源对象存储桶列表。
![](https://main.qcloudimg.com/raw/41215ca2a165e82b7289d16cbd092b00.jpg)
4. 选择文件存储方式。
