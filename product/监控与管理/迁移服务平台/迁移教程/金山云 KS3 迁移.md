...
下文将详细介绍当源对象存储部署在金山云 KS3 时，如何配置全托管公网迁移任务，实现数据迁移。
...
3. 设置要迁移的文件来源。
此处迁移源服务提供商应选择金山云 KS3，并在下方 AccessKey，SecretKey 文本框中输入先前新建用于迁移的金山云子用户 AccessKeyID，AccessKeySecret。源对象存储桶列表可在填入密钥后单击下拉框右侧刷新按钮获取。
![](https://main.qcloudimg.com/raw/11fcefcb6e3e1715d608bcf1bc513ec9.jpg)
4. 选择文件存储方式。
