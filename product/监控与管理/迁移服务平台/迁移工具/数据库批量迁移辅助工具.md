...
## 步骤1：获取工具
前往下载 [数据库批量迁移辅助工具](https://tools-release-1256125716.cos.ap-shanghai.myqcloud.com/package/batch-dts-cmd/batch-dts-cmd_v1.1.3.zip)。 
...
<td>22</td>
<td>CvmInstanceId</td>
<td>CVM 实例短 ID，格式如：ins-olgl39y8，与云主机控制台页面显示的实例 ID 相同。如果是 CVM 自建实例，需要传递此字段，无效可填写“-”</td>
</tr>
<tr>
<td>23</td>
<td>SrcSupplier</td>
