...
4. 设置要迁移的文件来源。
  ...
  ![](https://qcloudimg.tencent-cloud.cn/raw/7d94f8e82f1a0a1afa20db046d85516f.png)
...
11.	选择迁移模式。
 ...
 - 新建迁移任务后手动下载 Agent 启动迁移：选择 Agent 模式迁移，用户在单击“新建并启动”后，将仅创建任务配置，需要用户手动下载 Agent 在迁移源一侧的服务器上部署之后才会正式启动迁移。
