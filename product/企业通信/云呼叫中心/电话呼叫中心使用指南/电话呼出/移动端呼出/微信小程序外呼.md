...
- APP外呼：坐席需在APP中外呼用户电话，即可从APP调起小程序发起外呼
...
## 通话结束后获取参数
腾讯云呼叫中心小程序在点击关闭按钮后，会尝试返回上一个小程序。如需获取通话结束时的参数，参考文档 [返回到上一个小程序](https://developers.weixin.qq.com/miniprogram/dev/api/navigate/wx.navigateBackMiniProgram.html)。
extraData：
