...
## 新建收号（无需参数对接）[](id:new)
1. 登录 [云呼叫中心管理工作台](xxxxxxxxx)，在左侧导航栏点击“电话客服-收号设置”按钮进入电话客服设置页面。
2. 在收号设置页面单击“新建”按钮，新建一个收号任务。
3. 在新建收号窗口设置以下内容。
<table>
   <tr>
   ...
   <tr>
      <td>收号名称</td>
      <td>收号名称用于坐席在通话中单击“收号”按钮时识别并选择需要收号的内容（如：收取订单号）。</td>
   </tr>
   <tr>
      <td>通话中收号放音</td>
...
![](https://qcloudimg.tencent-cloud.cn/raw/88f58a14dbe74b0606068cb10205b56d.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/f86f4a5ccdd15dda208d05f0339e8583.png)