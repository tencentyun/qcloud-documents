...
## 跳转到TCCC联络小程序平台
我们提供了TCCC联络小程序平台，可以方便您在微信小程序里、企业微信里、自有APP内打开 **TCCC联络小程序** 完成视频客服。
...
| channelId    | string | 是  | 视频入口ID，参考[复制视频入口ID](#copyChannelId)。  |
...
![](https://tccc.qcloud.com/assets/doc/user/images/docs/miniTestDemoVideo.png)
...
![](https://tccc.qcloud.com/assets/doc/user/images/docs/miniConfig.png)
