...
<table>
   <tr>
      <th width="0px" style="text-align:center">计费分类</td>
      <th width="0px" style="text-align:center">计费项</td>
      <th width="200px"  style="text-align:center">服务说明</td>
      <th width="130px" style="text-align:center">价格</td>
...
<table>
   <tr>
      ...
      <th width="0px" style="text-align:center">套餐包通话时长
（分钟）</td>
      <th width="0px"  style="text-align:center">套餐内单价
（元/分钟）</td>
      <th width="0px"  style="text-align:center">套餐包价格
（元）</td>
   </tr>
   <tr>
      <td rowspan='3'>固定号码呼出
