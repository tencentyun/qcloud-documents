...
### 步骤4：初始化 SDK
开发者页面使用上一步中获取的 Token 和 URL 初始化 SDK，[示例代码](https://cloud.tencent.com/document/product/679/49749#Examples) 在 SDK快速入门 的 初始化SDK 章节已给出。
后续的 SDK 中的接口调用参见 SDK快速入门 和 SDK API 章节即可。
