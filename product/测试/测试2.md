...
PiggyMetrics 只一个 Dubbo 容器化的 Demo 项目，因此容器镜像服务个人版完全满足需求。但对于企业用户，推荐使用 [企业版 TCR](https://console.cloud.tencent.com/tcr)。如需使用镜像仓库，请见文档 [镜像仓库基本操作](https://cloud.tencent.com/document/product/1141/41811)。
