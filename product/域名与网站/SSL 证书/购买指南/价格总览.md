...
- 1个私有 CA 服务实例默认包含1个中间证书，若需购买更多中间证书，[启用私有 CA 实例]() 即可购买。**每个中间 CA 费用为：6000.00元/个/月**。
- 1个中间证书默认包含10个私有证书额度，若需购买更多私有证书，[启用中间 CA 实例]() 后即可购买。私有证书额度以10为单位进阶梯计费，每10个私有证书额度费用为：**100.00元/10个**。
