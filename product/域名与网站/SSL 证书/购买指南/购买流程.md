...
### 步骤4：选择证书年限
由于苹果和谷歌根存储政策的变化，自2020年9月1日起，政策禁止使用有效期超过13个月（397天）新颁发的 SSL/TLS 证书。因此，自2020年9月1日起，全球 CA 认证机构不再签发有效期超过13个月（397天）的 SSL 证书。但您可以腾讯云购买支持**多年期证书年限的 SSL 证书。前一张证书有效期到期前30天以内，29天以外，腾讯云证书系统将为您自动申请第二张证书，CA 机构审核通过后将自动颁发。**
...
>? 您在提交资料过程中，如勾选使用 [我的资料](https://console.cloud.tencent.com/ssl/info) 中已通过审核的公司信息、管理人信息以及域名信息申请 TrustAsia 泛域名证书，则无需进行域名所有权认证。
