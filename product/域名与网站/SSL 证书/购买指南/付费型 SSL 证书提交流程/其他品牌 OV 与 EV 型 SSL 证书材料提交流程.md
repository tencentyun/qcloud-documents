...
>
2. 填写公司信息。请如实填写公司名称（全称），公司部门，公司所在城市与地址以及公司座机号码，可选择已有公司信息。
3. 填写管理人消息。请如实填写管理人姓名，职位，电话以及邮箱，可选择已有管理人信息。
4. 填写联系人信息，可勾选【和管理员保持一致】。
5. 单击【下一步】，进入 [步骤2](#message)。

**[粘贴 CSR](id:csr2)**
1. 将已准备好的 CSR 信息粘贴至文本框中，即可识别您的域名信息，并填写公司信息（可选择已有公司信息）、管理人信息（可选择已有管理人信息）以及联系人信息（可勾选【和管理员保持一致】）。如下图所示：
...
>- 若您购买的是多年期的证书并且使用已通过审核的公司信息与管理人信息，则无需此步操作。
>
