...
>
5. 完成域名身份验证后，您可以在 [SSL 证书管理控制台](https://console.cloud.tencent.com/ssl)，选择您需要安装的证书，单击【下载】，将下载的证书安装至您对应的服务器中。具体操作请您查看 [如何选择证书类型？](https://cloud.tencent.com/document/product/400/4143)
