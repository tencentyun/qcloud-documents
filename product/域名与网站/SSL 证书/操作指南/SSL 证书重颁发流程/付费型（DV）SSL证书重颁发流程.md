...
1. 选择您需要重颁发的付费型（DV）SSL 证书，单击展开【更多】，选择【重颁发】。如下图所示：
...
![](https://main.qcloudimg.com/raw/28c50c2ac83db56720da63ee4cedda7c.png)
 - **复用证书CSR**：使用该证书重颁发前的 CSR。
 - **在线生成CSR**：由平台生成和管理您的 CSR。
 - **粘贴已有CSR**：使用已有的 CSR 内容添加到该证书。
...
5. 付费型（DV）SSL 证书会根据初次申请时的验证方式进行验证，验证方可查看 [详情](https://cloud.tencent.com/document/product/400/4142#.E6.89.8B.E5.8A.A8-dns-.E9.AA.8C.E8.AF.81)。
6. 单击【确认申请】，提交证书重颁发申请。
![](https://main.qcloudimg.com/raw/e218e49062a1365ffff9311e9cfbff69.png)
7. 您可以单击【查看证书详情】查看重颁发证书详情并根据指引进行域名验证证。如下图所示：
