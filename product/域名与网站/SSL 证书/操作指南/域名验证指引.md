...
>- 对于 www 开头的域名，例如 `www.tencent.com`，除了对该域名进行文件验证，还需对其主域名 `tencent.com` 添加文件验证。
> 
...
>?
 ...
 >- 可以支持301/302跳转，跳转次数不超过2次，跳转目的地址跟被检测域名需在同一主域。对于 www 开头的域名，例如 `www.tencent.com`，除了对该域名进行文件验证，还需对其主域名 `tencent.com` 添加文件验证。
 >
