...
2. 在 “我的证书” 页面，单击待手动 DNS 验证的 SSL 证书的 【查看验证】，进入 “验证域名” 页面。如下图所示：<span id="details"></span>
![](https://main.qcloudimg.com/raw/9ac52314097299c62b0061be6b0b4a92.png)
3. 添加解析记录。
...
### 文件验证
1. 登录 [SSL 证书管理控制台](https://console.cloud.tencent.com/ssl)。
2. 在 “我的证书” 页面，单击待文件验证的 SSL 证书的 【查看验证】，进入 “验证域名” 页面。如下图所示：

![](https://main.qcloudimg.com/raw/27bc5693672ae390d8c6a58903ee599d.png)
