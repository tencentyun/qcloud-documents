...
2. 在弹出的 “上传证书” 的窗口中，选择您需求勾选所需上传的证书种类。
...
![](https://main.qcloudimg.com/raw/c870b92aead518a7581fc468cff5ebf2.png)
 - **备注名**：请输入证书备注名。
 - **签名证书**：
- 通常证书是以 .crt 或 .pem 等为扩展名的文件，请使用相应文本编辑器打开证书文件。
- 证书格式以“-----BEGIN CERTIFICATE-----”开头，以“-----END CERTIFICATE-----”结尾。
- 证书内容请包含完整的证书链。
 - **签名私钥**：
- 通常私钥是以 .key 或 .pem 等为扩展名的文件，请使用相应文本编辑器打开私钥文件。
...
- 私钥格式以“-----BEGIN PRIVATE KEY-----”开头，以“-----END PRIVATE KEY-----”结尾。
 ...
 >?腾讯云DNSPod 国密证书默认只提供一个  .key 或 .pem 等为扩展名的文件，在签名私钥和加密私钥都需填写这个私钥文件。
