...
请您按照流程图调用相关 SSL 证书接口，证书签发后可通过下载证书（DownloadCertificate）接口进行证书下载操作。如下图所示：
...
请您按照流程图调用相关 SSL 证书接口，该类目品牌证书将由 CA 机构联系您完成域名验证操作，具体验证操作请参考 [DNS 解析验证](https://cloud.tencent.com/document/product/400/4142#.E6.89.8B.E5.8A.A8-dns-.E9.AA.8C.E8.AF.81) 或 [文件验证](https://cloud.tencent.com/document/product/400/4142#.E6.96.87.E4.BB.B6.E9.AA.8C.E8.AF.81)。
