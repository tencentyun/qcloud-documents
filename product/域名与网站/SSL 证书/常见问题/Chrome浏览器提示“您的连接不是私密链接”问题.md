...
该 CT 错误经确认是 Chrome 浏览器53、54版本的内核问题，该 BUG 导致与 SecureSite CA 机构颁发的 SSL 证书出现不兼容问题，SecureSite CA 机构所有2016年6月1日之后的证书都会被此问题影响出现 CT 错误的情况，Chrome 方面在第一时间通过自动补丁方式处理了此问题，并在55版本修复此问题。
...
SecureSite 官方声明：	https://www.symantec.com/connect/blogs/chrome-53-bug-affecting-symantec-ssltls-certificates
