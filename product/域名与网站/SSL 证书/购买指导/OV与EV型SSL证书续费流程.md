...
### 续费证书时效保障
对于续费新证书，除正常续费时长外，原证书未用完的时间会增补到新证书里面，并会额外获得1 - 90天不等的赠送时长（沃通证书续费新证书，在颁发通过后可多补偿30天的赠送时长）。客户不会因续费造成证书使用时间上的损失。   
...
### 步骤3：证书审核
#### 非沃通类 OV/EV 型付费证书需上传确认函并等待审核
>?非沃通类 OV/EV 型付费证书即指 DNSPod 证书以及其他品牌 OV/EV 型付费证书。
>
...
#### DV 型付费证书需完成域名身份验证（沃通、DNSPod类 OV/EV 型付费证书除人工审核外，还需要进行域名验证）
