...
2. 在 “我的证书” 页面，选择已购买到的国密证书行，单击【提交资料】。
...
1. 填写域名信息。如下图所示：
![](https://main.qcloudimg.com/raw/6fa42523e81df56c0e83240d6c2b37f9.png)

主要参数信息如下：
 - **证书绑定域名**：填写绑定证书的域名。即绑定证书的域名或者IP，请填写单个域名或者IP。例如tencent.com、ssl.tencent.com、example.ssl.tencent.com、1.1.1.1。
...
![](https://main.qcloudimg.com/raw/cec419c471e4cc902ae60bd775936e28.png)

2. 勾选验证方式后，单击【下一步】，进入“上传确认函” 页面。


### 步骤3：上传确认函
1. 单击【下载确认函模板】，进行申请书信息补充填写。如下图所示：
![](https://main.qcloudimg.com/raw/dd58deea2db89a93a337c35a5ff69669.png)
...
### 步骤4：验证域名
1. 请根据 “选择验证” 页面的提示信息，进行域名验证。如DNS 验证方式，如下图所示：
![](https://main.qcloudimg.com/raw/7735086b9bfa0141584e202b883755e5.png)

 - **自动 DNS 验证**：域名验证操作请参考：[自动DNS验证](https://cloud.tencent.com/document/product/400/4142#.E6.93.8D.E4.BD.9C.E6.AD.A5.E9.AA.A4)。
...
4. 完成域名验证操作后，可单击【查看域名验证状态】查看验证操作是否成功。

### 步骤5：通过人工审核
1.验证域名成功后，将进入人工审核，人工审核通过后将正式签发证书。
>?
