## 操作场景
国密证书企业型 OV 与增强型 EV SSL证书在购买成功后，需要进行相关材料提交。证书购买流程请参考 [购买流程](https://cloud.tencent.com/document/product/400/47285)。
...
>?
>- 首次域名验证通过后，该域名验证将保留13个月。13个月内该域名以相同公司名称申请国密 DNSPod 品牌 OV 与 EV 型 SSL 证书，将不执行域名验证的操作。
