...
## 操作步骤
 >!如证书需部署至云直播，请先在 [云直播管理控制台](https://console.cloud.tencent.com/ddos/) 接入域名，否则无法部署 SSL 证书。具体操作请参考 [添加自有域名](https://cloud.tencent.com/document/product/267/20381)。
 >
...
3. 在弹出的 “选择部署类型” 窗口中，选择【云直播】，勾选需要部署到云直播的域名。如下图所示：
![](https://main.qcloudimg.com/raw/633c2f1f6d066902a7970adbd79898e5.png)
4. 单击【确定】，等待配置成功后，您可以前往 [云直播管理控制台](https://console.cloud.tencent.com/ddos/) 查看详情。如下图所示：
