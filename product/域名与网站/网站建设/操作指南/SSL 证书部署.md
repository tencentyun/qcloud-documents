...
## 操作步骤
### 证书申请
1. 证书与私钥文件您可在 [SSL 证书控制台](https://console.cloud.tencent.com/ssl) 申请后进行下载，服务器类型选择**Nginx**。如下图所示：

![](https://qcloudimg.tencent-cloud.cn/raw/f32e02c9f42ccb4391e0860097dd7a5a.png)

申请SSL证书操作详情参见：[SSL 证书申请流程](https://cloud.tencent.com/document/product/400/43473)。
