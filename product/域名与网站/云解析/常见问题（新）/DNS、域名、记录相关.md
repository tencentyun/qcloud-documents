...
### 域名的解析状态提示域名 DNS 未修改怎么解决 ？
域名的解析状态提示域名 DNS 未修改可能由以下原因造成，您可以通过以下内容进行排查与修复：
- 新注册的域名系统未及时同步，需等待系统更新同步，请您耐心等待。  
- 域名 DNS 不是非腾讯云，需将域名 DNS 修改为腾讯云 DNS。详情请参考：[修改域名 DNS 服务器](https://cloud.tencent.com/document/product/302/5518)。
- 域名被注册商设置停止解析，请联系您的域名注册商处理。  
- 修改 DNS 服务器地址解析存在0 - 72小时生效期，请您耐心等待解析生效 。
