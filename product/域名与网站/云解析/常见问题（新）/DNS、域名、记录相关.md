...
对于普通网民来说，建议使用更安全的递归 DNS，例如腾讯云的公共 DNS 119.29.29.29。一般情况下，公共 DNS 被劫持的可能性较小，如果 119.29.29.29 返回的结果是正确的，就说明授权 DNS 服务是正常的。对于广大站长来说，建议做好在域名注册商处的帐号安全，并使用技术实力强大的供应商提供的授权 DNS 服务。
