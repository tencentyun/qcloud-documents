...
>- 若 DNS 生效检测未显示【该域名解析正常】，请参考 [域名解析不生效](https://cloud.tencent.com/document/product/302/53973) 进行排查。
> - 若 DNS 生效检测显示【该域名解析正常】，但查看记录值与您添加的记录值不一致，请耐心等待解析生效，刷新时间为您填写的 TTL 值，单位为秒。
