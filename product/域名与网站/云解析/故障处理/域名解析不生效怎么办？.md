...
### 域名已过期
域名过期会导致域名解析失效，若**域名到期日**显示检查已过期，需前往域名注册商处确认域名到期时间。如已经到期，请尽快续费，续费成功后解析将在0 - 48小时内恢复正常。
...
### 域名 DNS 服务器非腾讯云 DNS 服务器
请在域名注册商处确认 DNS 服务器已更改为腾讯云指定的 [DNS 地址](https://cloud.tencent.com/document/product/302/9070)，否则影响解析生效。如 DNS 已修改为腾讯云 DNS 服务器，因解析在全球生效时间是0 - 48小时，这期间也有可能影响解析生效，请耐心等待。
