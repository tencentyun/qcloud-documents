...
## 可能原因
请在 [域名自助检测](https://domaintool.cloud.tencent.com/) 中输入您需要检测的域名，并根据检查结果进行排查。
例如，域名检测输入 `dnspod.cn`。如下图所示：
![](https://main.qcloudimg.com/raw/2032bfee89442f6001e95915397af5be.png)
**可能导致域名未生效的原因：**
...
## 解决办法
### 域名状态为 Clienthold 或 Serverhold
通过检测工具查询，若【域名状态】处显示为 Clienthold 或 Serverhold，则会导致解析无法生效。主要是由于域名**未实名认证**或**命名审核不通过**。
- 若您的域名在腾讯云注册，请先进行 [域名实名认证](https://cloud.tencent.com/document/product/242/6707)。
- 若您的域名非腾讯云注册，请咨询您的域名注册商。
![](https://main.qcloudimg.com/raw/e14066edacd2eb074938169f6bb3152b.png)

### 域名已过期
域名过期会导致域名解析失效，若【域名到期日】处检查已过期，需前往域名注册商处确认域名到期时间。如已经到期，请尽快续费，续费成功后解析将在0 - 72小时内恢复正常。
- 若您的域名在腾讯云注册，续费操作详情请参考 [域名续费](https://cloud.tencent.com/document/product/242/9644)。
- 若您的域名非腾讯云注册，请咨询您的域名注册商。
![](https://main.qcloudimg.com/raw/decd963088caf25e0cc47a26053dd710.png)
...
- 若您的域名非腾讯云注册，请咨询您的域名注册商。
![](https://main.qcloudimg.com/raw/c7863c719af5cc6d23b31454402cdd38.png)
