...
2. 在 “域名解析列表” 中，可查看全部已注册的域名。如下图所示：
>?若您需添加解析的域名未在腾讯云注册，请单击【添加解析】，在弹出 “添加解析” 窗口中，填写需要解析的域名。  
>- 若您需将添加解析的域名转入腾讯云管理。详情操作请参考：[域名转入腾讯云](https://cloud.tencent.com/document/product/242/3645)。
>- 若您添加解析的域名未在注册商注册，暂时无法添加到 DNS 解析。详情操作请参考：[域名注册](https://cloud.tencent.com/document/product/242/9595)。
>
