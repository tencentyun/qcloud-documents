...
3. <span id="w">单击【添加记录】，填写以下记录信息。如下图所示：</span>
...
4. <span id="q">单击【保存】，完成添加。如下图所示：</span>
5. 重复执行 [步骤3](#w) 和 [步骤4](#q)，添加其他 A 记录。请根据实际需求设置线路类型和记录值。
例如下图，添加一条 A 记录，线路类型为联通，记录值为8.8.8.8，即表示除了联通用户之外的所有用户，都会指向 10.10.10.10。
