[DNS 解析套餐](https://buy.cloud.tencent.com/cns) 为 **预付费包年结算** 方式计费，解析套餐只可绑定单个一级域名（例如 qcloud.com、qq.com），同时提供了套餐更换域名的功能。
>!腾讯云提供五种 DNS 解析套餐：免费套餐、个人专业版套餐、企业基础版套餐、企业标准版套餐、企业旗舰版套餐。**注册域名后 DNS 解析套餐为免费套餐，无需购买**。
