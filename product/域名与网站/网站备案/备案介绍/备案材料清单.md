...
<tr>
<td>域名实名认证截图</td>
<td>非腾讯云注册购买的域名，需提供 “域名实名认证信息” 截图。请您在域名注册商处获取实名认证信息，截图中需包含域名、域名所有者、所有者证件类型、所有者证件号码、域名过期时间。</td>
</tr>
<tr>
<td>暂住证/居住证</td>
...
| 域名实名认证截图             |非腾讯云注册购买的域名，需提供 “域名实名认证信息” 截图。请您在域名注册商处获取实名认证信息，截图中需包含域名、域名所有者、所有者证件类型、所有者证件号码、域名过期时间。 |
