...
申请备案时填报的备案主体信息应与域名所有者实名认证信息相符。
 ...
 - 单位备案：备案主办单位名称或主体负责人需要与域名所有者实名认证信息保持一致（比对信息为：姓名、证件类型、证件号码）。
如域名所有者为单位、单位主要负责人或高级管理人员，则需提供相关证明材料（仅部分省份，具体可参考 [各省管局规则](https://cloud.tencent.com/document/product/243/3474)），示例如下：
