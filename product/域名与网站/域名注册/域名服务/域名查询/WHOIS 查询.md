...
>
![](https://main.qcloudimg.com/raw/b3cbdbeeb993c2990751c901db333d6b.png)
 - 域名所有者：不进行展示，如您需要获取，请联系域名注册商。
 - 所有者联系邮箱：不进行展示，如您需要获取，请联系域名注册商。
 - 注册商：域名当前的注册商，例如 Xin Net Corp。
 - 注册日期：域名注册日期。
 ...
 - DNS 服务器：使用不同套餐版本的解析分别为不同集群，每种集群对应的 DNS 地址是不同的。具体可以查看 [DNS节点分布说明](https://cloud.tencent.com/document/product/302/9070)。
