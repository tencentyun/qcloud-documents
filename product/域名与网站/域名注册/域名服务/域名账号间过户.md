...
>- 转移完成后，解析权限仍在 A 账号，B 账号持有人将对域名享有一切管理权限，包括修改域名信息、账号转移等。如 B 账号需要获取解析权限，可在 DNS 解析 DNSPod 控制台单击【添加解析】，完成添加后，即可获取该域名下的所有解析。具体操作可参考 [域名解析转入](https://cloud.tencent.com/document/product/302/8555)。
