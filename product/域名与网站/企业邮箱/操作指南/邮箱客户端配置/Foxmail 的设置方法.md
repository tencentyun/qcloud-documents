...
Windows 版本的 Foxmail 客户端支持微信扫码、手机验证码、帐号密码3种方式新建腾讯企业邮箱。
登录 Foxmail 邮箱，在弹出的 “新建帐号” 窗口中，单击【腾讯企业邮】，进入 “新建帐号” 页面。
>!默认使用 IMAP 服务器接收类型，如您需 POP3 服务器为接收类型请使用帐号密码方式。
>
#### 方式1：微信扫码登录
使用微信扫码即可设置成功。如下图所示：
>?如该微信已绑定多个腾讯企业邮箱，请根据实际需求选择帐号。
>
![](https://main.qcloudimg.com/raw/1ab11c2780d12859bb5dd13a7c55675f.png)
#### 方式2：手机验证码登录
单击【手机验证码】，输入手机号和正确验证码即可设置成功。
#### 方式3：帐号密码登录
1. 单击【帐号密码】，输入邮箱帐号及密码即可设置成功。
...
#### 方式1：自动配置
>!自动配置企业邮箱将默认使用 IMAP 服务器接收类型，如您需 POP3 服务器为接收类型请使用手动配置方式。
>
1. 进入 Foxmail for Mac 客户端，在顶部菜单栏选择【文件】>【添加邮箱帐户】，在弹出的 “设置邮箱帐户” 窗口中输入完整的电子邮件地址和密码。如下图所示：
...
#### 方式2：手动配置
1. 进入 Foxmail for Mac 客户端，在顶部菜单栏选择 【文件】>【添加邮箱帐户】，在弹出的 “设置邮箱帐户” 窗口中输入完整的企业邮箱地址和密码。
