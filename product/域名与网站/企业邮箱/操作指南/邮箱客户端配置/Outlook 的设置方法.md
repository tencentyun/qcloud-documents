...
3. 在 “选择服务” 页面中，选择**Exchange ActiveSync 兼容服务(A)**，并单击**下一页**。如下图所示：
![](https://main.qcloudimg.com/raw/fe3d5ae988ce684b101fcaa070395d83.png)
4. 在 “服务器设置” 页面中，输入姓名、邮箱账号、邮件服务器以及密码。如下图所示：
![](https://main.qcloudimg.com/raw/aa7ce4988e60d3fcb4a926a1dca70572.png)
    - **您的姓名**：请填写您的姓名。
    - **电子邮件地址**：请填写您的企业邮箱账号。
    - **邮件服务器**：请填写腾讯企业邮件服务器 `ex.exmail.qq.com`。
    - **用户名**：请填写您的企业邮箱账号。
    - **密码**：请填写您设置的邮箱密码（如已开启安全登录则需要使用客户端邮箱专用密码）。
5. 单击**下一页**，即可配置成功。如下图所示：
