...
<tbody>
  ...
  <tr>
    ...
    <td>Joomla</td>
    <td><ul style="margin:0px"><li>文件存储（CFS）</li><li>云原生数据库 TDSQL-C（MySQL for Serverless）</li><li>云托管（CloudBase Run）</li></ul></td>
    <td><a href="跳转" target="_blank" rel="noopener noreferrer">Joomla 规格说明</a></td>
  </tr>
	  <tr>
    <td>Ghost</td>
    <td><ul style="margin:0px"><li>文件存储（CFS）</li><li>云原生数据库 TDSQL-C（MySQL for Serverless）</li><li>云托管（CloudBase Run）</li></ul></td>
    <td><a href="跳转" target="_blank" rel="noopener noreferrer">Ghost 规格说明</a></td>
  </tr>
	  <tr>
    <td>Z-BlogPHP</td>
    <td><ul style="margin:0px"><li>文件存储（CFS）</li><li>云原生数据库 TDSQL-C（MySQL for Serverless）</li><li>云托管（CloudBase Run）</li></ul></td>
    <td><a href="跳转" target="_blank" rel="noopener noreferrer">Z-BlogPHP 规格说明</a></td>
  </tr>
		  <tr>
    <td>CodiMD</td>
    <td><ul style="margin:0px"><li>文件存储（CFS）</li><li>云原生数据库 TDSQL-C（MySQL for Serverless）</li><li>云托管（CloudBase Run）</li></ul></td>
    <td><a href="跳转" target="_blank" rel="noopener noreferrer">CodiMD 规格说明</a></td>
  </tr>
		  <tr>
    <td>YOURLS</td>
    <td><ul style="margin:0px"><li>云托管（CloudBase Run）</li><li>云原生数据库 TDSQL-C（MySQL for Serverless）</li></ul></td>
    <td><a href="跳转" target="_blank" rel="noopener noreferrer">YOURLS 规格说明</a></td>
  </tr>
