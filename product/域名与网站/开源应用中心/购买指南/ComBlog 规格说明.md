## ComBlog 规格说明
若您在腾讯云开源应用中心正式开通 ComBlog 应用实例，将默认使用以下规格云资源：
...
## 费用计算示例
您在腾讯云开源应用中心使用已正式开通的 ComBlog 应用实例，某天使用云托管0.5GB流量以及4小时运行时间，文件存储空间为1GiB，云原生数据库一天中使用了1GB的存储空间，以及在一天的4个小时内，均为0.5个 CCU 的量，则将产生以下费用：
