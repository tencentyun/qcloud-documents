...
![](https://main.qcloudimg.com/raw/2fe5e4795f89f91b6c299f452a820c4c.png)
>?
...
## 步骤2：添加解析
>!
>- 绑定域名成功后，若您的域名已托管在 DNSPod ，系统将为您自动进行 CNAME 解析配置。您无需进行以下操作。等待解析生效后，即可访问应用。
>- 如您的域名未托管在 DNSPod，您可以通过手动解析的方式为您的域名添加解析，具体解析请按以下步骤进行操作。
