...
您可以通过 [SQL Server 控制台](https://console.cloud.tencent.com/sqlserver) 查看和修改部分参数，并可以在控制台查询参数修改历史。
...
2. 在实例管理页面，选择【参数设置】页，选择目标参数所在行，在“当前运行参数值”列，单击![img](https://main.qcloudimg.com/raw/788902e3f8c335cf17de420f7181c2a8.png)修改参数值。
