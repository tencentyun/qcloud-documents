...
2. 在实例管理页面，选择【数据库管理】页，在目标数据库所在行，选择“操作”列的【其它】>【开启/关闭变更数据捕获】。
...
您可以通过【数据库管理】页右上角的“当前任务”，查看“开启变更数据捕获CDC”或者“关闭变更数据捕获CDC”任务的创建进度。<br>
...
2. 在实例管理页面，选择【数据库管理】页，勾选目标数据库行，选择列表上方的【批量管理】>【批量开启/关闭变更数据捕获】。
...
您可以通过【数据库管理】页右上角的“当前任务”，查看“开启变更数据捕获CDC”或者“关闭变更数据捕获CDC”任务的创建进度。
<img src="https://main.qcloudimg.com/raw/6f040fc745fd0a2b652cae2188010cc6.png" style="zoom:50%;" />
