...
所有版本的主实例及只读实例
## 注意事项
- 我们目前仅支持从基础网络切换成私有网络，不支持逆向操作。
- 切换后，VPC网络访问立即生效，原有基础网络的访问将保留24小时，请在24小时内将该实例相关联的实例迁至VPC网络，以保证相关实例的访问。
- 若旧IP地址的回收时间设置为0小时，更换网络后会立即回收旧IP地址，届时您将只能通过VPC网络访问该实例。
...
4. 待实例状态恢复为“**运行中**”时，完成从基础网络转VPC网络。