...
```
"resource":[ "qcs::sqlserver:ap-guangzhou:uin/653339763:instanceId/mssql-m8oh024t"]
```

您还可以使用 * 通配符指定属于特定账户的所有实例，如下所示：
```
"resource":[ "qcs::sqlserver:ap-guangzhou:uin/653339763:instanceId/*"]
```
...
| 资源   | 授权策略中的资源描述方法                                     |
| :----- | :----------------------------------------------------------- |
| 实例   | ```qcs::sqlserver:$region:$account:instanceId/$instanceId``` |
