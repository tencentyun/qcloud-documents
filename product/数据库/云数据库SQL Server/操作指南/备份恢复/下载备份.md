...
3. 在实例管理页，选择**备份管理**页，可通过选择数据备份列表或日志备份列表查看对应备份文件。
   - 若备份文件形式设置为打包备份，则在备份列表的**操作**列，单击**下载**，进入下载页，选择与实例同地域的备份即下载的备份为本地备份，选择与实例不同地域的备份即下载的备份为跨地域备份。![](https://qcloudimg.tencent-cloud.cn/raw/762de618d7b15c39747dd5e89d2d3ee6.png)
   - 若备份文件形式设置为单库备份，则在备份列表的**操作**列，选择**查看详情** > **下载**，进入下载页，下载该实例中每一个数据库的备份文件。
![](https://qcloudimg.tencent-cloud.cn/raw/20f4aa57d3e94ba95dc444b15bf33f37.png)
