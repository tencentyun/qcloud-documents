...
## 各版本功能概览及差异列表
<table>
<tr><td rowspan=2>模块</td><td rowspan=2>功能</th><td>双节点（原高可用版及集群版）</td><td>单节点（原基础版）</td></tr>
<tr>
...
<td>创建和删除帐号</td><td rowspan=3>支持</td><td rowspan=3>支持</td></tr>
<tr><td>支持读写权限</td></tr>
<tr><td>管理员帐号</td></tr>
<tr><td>Sa 帐号</td><td>不支持</td><td>支持</td></tr>
