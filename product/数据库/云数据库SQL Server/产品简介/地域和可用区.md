...
- [负载均衡](https://cloud.tencent.com/document/product/214) 当前默认支持同地域流量转发，绑定本地域的云数据库实例。如果开通 [跨地域绑定](https://cloud.tencent.com/document/product/214/48180) 功能，则可支持负载均衡跨地域绑定云数据库实例。
