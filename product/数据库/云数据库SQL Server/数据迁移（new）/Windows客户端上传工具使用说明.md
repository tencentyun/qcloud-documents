## 工具使用方法
1、将“[Windows客户端上传工具](https://mc.qcloudimg.com/static/archive/d49d5676cc0cffc72d14bbcbc987d62f/upload-tool.zip)”下载至本地后，将其解压到任意文件夹（注：文件夹路径请勿包涵中文），解压后的文件目录结构如下：
