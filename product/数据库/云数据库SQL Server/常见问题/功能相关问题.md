...
云数据库 SQL Server 禁止通过 Microsoft SQL Server Management 执行创建、删除数据库、创建、删除或修改帐号操作，支持在 [SQL Server 控制台](https://console.cloud.tencent.com/sqlserver) 单击实例名进入管理页面，在 【帐号管理】页创建、删除帐号或修改帐号权限。
