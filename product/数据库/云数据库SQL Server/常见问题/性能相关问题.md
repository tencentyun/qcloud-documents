...
云数据库 SQL Server 目前提供多个可选地域，另外对金融机构和企业，可 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请开通上海金融、深圳金融专区。详细介绍请参见 [地域和可用区](https://cloud.tencent.com/document/product/238/7520)。
