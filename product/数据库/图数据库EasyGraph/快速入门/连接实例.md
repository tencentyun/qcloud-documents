...
<img src="https://main.qcloudimg.com/raw/e0415b997ff5f0ee45c964fe78982fda.png"  style="zoom:80%;">

## 连接方式
连接图数据库 KonisGraph 的方式有2种，分别是图数据管理平台，参考 [图数据管理]()，和云服务器 CVM 连接。

其中，云服务器 CVM 连接图数据库 KonisGraph 步骤依次为：gremlin-console 连接、图的元数据操作、图数据的读写。
连接的注意事项如下：
...
## 云服务器连接
### 步骤1：gremlin-console 连接步骤
1. [登录 CVM]()，下载 [apache-tinkerpop-gremlin-console-3.5.1-bin](https://www.apache.org/dyn/closer.lua/tinkerpop/3.5.1/apache-tinkerpop-gremlin-console-3.5.1-bin.zip)。
