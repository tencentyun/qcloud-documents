...
## [图数据库 KonisGraph 的资源路径](id:lujing)
...
```
"resource":[ "qcs::konisgraph:bj:uin/12345678:instance/kgraph-iot9kpl3"]
```

您还可以使用 * 通配符指定属于特定账户的所有实例，如下所示：
```
"resource":[ "qcs::konisgraph:bj:uin/12345678:instance/*"]
```
