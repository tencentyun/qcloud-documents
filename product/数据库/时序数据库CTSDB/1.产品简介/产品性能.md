## 测试工具 ##
[测试工具下载](https://main.qcloudimg.com/raw/f3bb72aaf33c60f6cb259b9ed3e01938.zip)
## 集群配置 ##
...
命令如下
	...
	curl -XPUT {ctsdb_ip_port}/_metric/ctsdb_bench?pretty -d '{ 
	"tags": {
	"host": "string"
	},
	"fields":{
...
> 其中，{ctsdb_ip_port} 为腾讯云提供的CTSDB访问端口。


- 2.写入数据

使用脚本批量写入，ctsdb_benchmark\bin目录下参数如下：
...
脚本输出分为三部分，param：选项参数，qps：每段时间间隔内的qps，result：最终结果。具体如下所示：
