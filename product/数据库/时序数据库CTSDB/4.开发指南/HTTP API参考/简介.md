...
## 命名规则 
CTSDB 中 metric（表）、tags（维度列）、fields（指标列） 的命名应简明扼要，tags、fields 详细介绍可参见 [请求内容](https://cloud.tencent.com/document/product/652/13604#.E8.AF.B7.E6.B1.82.E5.86.85.E5.AE.B9)：
