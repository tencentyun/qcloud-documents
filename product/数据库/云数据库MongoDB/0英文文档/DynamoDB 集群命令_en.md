...
<table class="table-striped">
	<tbody>
		...
		<tr>
			...
			<tr>
			<td>Returned parameter: Backfilling</td>
			<td>No</td>
		</tr>
		<tr>
			<td>Returned parameter: ProvisionedThroughput</td>
			<td>No</td>
		</tr>
		<tr>
			<td>Returned parameter: LatestStreamArn</td>
			<td>No</td>
		</tr>
		<tr>
			<td>Returned parameter: LatestStreamLabel</td>
			<td>No</td>
		</tr>
		<tr>
			<td>Returned parameter: StreamSpecification</td>
			<td>No</td>
		</tr>
		...
		<tr>
			<td>Returned parameter: ConsumedCapacity</td>
			<td>No</td>
		</tr>
		<tr>
			<td>Returned parameter: ItemCollectionMetrics</td>
			<td>No</td>
		</tr>	
