本文从系统架构、地域与可用区、版本与存储、连接数等方面，说明使用云数据库 MongoDB 实例一些要求与限制，帮助您选择适合自身业务的规格。
...
<td>清远一区<br> ap-qingyuan-1</td></tr>
<tr>
...
<tr>
<td>港澳台地区（中国台北）<br>ap-taibei</td>
<td>台北一区（中国台北节点可用于覆盖港澳台地区）<br>ap-taibei-1</td></tr>
</tbody></table>
