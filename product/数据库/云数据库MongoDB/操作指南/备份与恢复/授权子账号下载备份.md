...
如下示例中：
 - uid 为125xxx，可在 [账号信息](https://console.cloud.tencent.com/developer) 页面的“APPID”处获取。
 - COS 存储桶路径为 cmongo-gz-backup-1257588757，可在 [MongoDB 控制台](https://console.cloud.tencent.com/mongodb) 的备份下载页面获取。
![](https://main.qcloudimg.com/raw/aa3c4a1d1c7e407657b8d8feaf97e253.png)
策略语法：
```
{
    "version": "2.0",
    "statement": [
        {
            "action": "cos:*",
            "effect": "allow",
            "resource": "qcs::cos::uid/125xxx:cmongo-gz-backup-1257588757/*"
        }
    ]
}
```
