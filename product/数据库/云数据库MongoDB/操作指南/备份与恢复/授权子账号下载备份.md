...
如下示例中：
 ...
 - COS 存储桶路径为 cmongo-gz-backup-1257588757，可从 [MongoDB 控制台](https://console.cloud.tencent.com/mongodb) 备份下载页面获取。
![](https://main.qcloudimg.com/raw/3af713ad58f2bb431cdbf938357ab2bd.png)
策略语法：
```
{
    "version": "2.0",
