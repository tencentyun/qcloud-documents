...
如下示例中，uid 为125xxx8757，可从 [账号信息](https://console.cloud.tencent.com/developer) 页面获取；COS 存储桶路径为 cmongo-gz-backup-125xxx8757，可从 [MongoDB 控制台](https://console.cloud.tencent.com/mongodb) 备份下载页面获取。
策略语法：
```
{
    "version": "2.0",
