...
如下示例中，uid 为125xxx7，可从 [账号信息](https://console.cloud.tencent.com/developer) 页面的“APPID”处获取；COS 存储桶路径为 cmongo-gz-backup-1257588757，可从 [MongoDB 控制台](https://console.cloud.tencent.com/mongodb) 备份下载页面获取。
策略语法：
```
{
    "version": "2.0",
    "statement": [
        {
            "action": "cos:*",
            "effect": "allow",
            "resource": "qcs::cos::uid/125xxx7:cmongo-gz-backup-1257588757/*"
        }
    ]
}
```
