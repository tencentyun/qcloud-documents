...
## 6.3	USER_COL_COMMENTS ##
USER_COL_COMMENTS 在当前用户拥有的表和视图的列上显示注释。其列（OWNER除外）与 ALL_COL_COMMENTS 中的列相同。

## 6.4	USER_CONSTRAINTS ##
