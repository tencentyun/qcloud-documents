...
>- SSL 连接加密目前为内测阶段，如需使用，请 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请。
...
您可以在 [TDSQL MySQL版 控制台](https://console.cloud.tencent.com/tdsqld/instance-tdmysql)，单击实例 ID 进入实例管理页，在**数据安全性** > **连接加密**中配置 SSL 加密。
