...
[**安全组**](https://cloud.tencent.com/document/product/239/30911)：对 Tendis 实例进行安全的访问控制，指定进入实例的 IP、协议及端口规则。

[**地域和可用区**](https://cloud.tencent.com/document/product/239/4106)：Tendis 实例和其他资源的物理位置。
