云数据库 Tendis 提供多地域的支持，目前支持国内主要大区和部分海外大区，如果可用区不满足业务要求，您也可以 [提交工单](https://console.cloud.tencent.com/workorder/category) 申请部署支持。
...
<tbody>
	...
	<tr>
		<td rowspan="1">华东地区（上海）<br>ap-shanghai</td>
