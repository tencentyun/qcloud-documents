...
1. 登录 [Tendis 购买页](https://buy.cloud.tencent.com/tendis)，根据实际需求选择各项配置信息，确认无误后，单击【立即购买】。
 ...
 - **地域**：选择您业务需要部署 Tendis 的地域。建议您选择与云服务器同一个地域，不同地域的云产品内网不通，购买后不能更换。
...
2. 支付完成后，返回实例列表，会看到实例显示“发货中”（大概需要3min - 5min中，请耐心等待），待实例状态变为“运行中”，即可正常使用。
