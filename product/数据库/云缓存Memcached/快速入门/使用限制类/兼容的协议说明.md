1.云数据库 Memcached 基于标准的 Memcached 协议以及接口，我们假定开发者在使用云数据库 Memcached 服务的时候，已经对 Memcached 有了一定的了解。

开发者可参见 [Memcached 官网](http://memcached.org/) 的介绍了解 Memcached。

Memcached 开源扩展库载及 API 说明（C++/PHP/Java/Python/Ruby/Perl...等多语言扩展库），请参见 [memcached](https://code.google.com/archive/p/memcached/downloads)。
