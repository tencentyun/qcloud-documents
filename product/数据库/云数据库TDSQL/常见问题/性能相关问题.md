...
强同步机制是将数据写入从机日志（落盘）即返回应答；此时数据尚需要通过日志写入表中，因此确实会有延迟。 [详见强同步原理](https://www.qcloud.com/document/product/237/1057#2.1-mariadb(tdsql).E5.BC.82.E6.AD.A5.E5.A4.9A.E7.BA.BF.E7.A8.8B.E5.BC.BA.E5.90.8C.E6.AD.A5.E5.A4.8D.E5.88.B6.E6.8A.80.E6.9C.AF.EF.BC.88.E5.BC.BA.E5.90.8C.E6.AD.A5.E5.A4.8D.E5.88.B6.EF.BC.895) 。
