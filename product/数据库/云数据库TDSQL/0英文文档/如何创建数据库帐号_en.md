...
Before using MariaDB (TDSQL) service, you need to enter the management page of instance to create a database account for login, and set the access permissions.
...
### 3. Set permissions
The permissions of MariaDB (TDSQL) are at object level, including 19 common permissions. It can also be used to set permissions for objects such as table, view, function, trigger, etc.
