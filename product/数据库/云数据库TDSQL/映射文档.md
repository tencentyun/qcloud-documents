云数据库 MariaDB（曾用名关系型数据库 CDB for TDSQL）API 2.0 版本接口将于2020年3月31日下线，调用 API V2 版接口届时将不可用，请尽快迁移至相对应的 API 3.0 接口。
...
| CdbTdsqlGetInstanceCount           | 获取实例列表梳理     | 该接口取消                     | 采用 CdbTdsqlGetInstanceList 统计                              |
