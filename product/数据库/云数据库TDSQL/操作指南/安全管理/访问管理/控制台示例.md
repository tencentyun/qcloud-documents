>!云数据库 MariaDB 支持访问管理（Cloud Access Management，CAM）功能，自2018年12月6日起进行公测。您可以通过策略语法进行配置。
...
>!云数据库 MariaDB 的在访问控制的接口关键词为 mariadb；详情请参考 [产品更名详情](https://cloud.tencent.com/document/product/557/35149)。
