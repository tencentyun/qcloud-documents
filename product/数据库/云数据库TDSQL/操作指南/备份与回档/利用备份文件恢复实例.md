...
## 通过备份文件恢复数据库（未加密）
通过如下视频，您可以了解 MariaDB 的备份恢复过程：
<div class="doc-video-mod"><iframe src="https://cloud.tencent.com/edu/learning/quick-play/2680-51923?source=gw.doc.media&withPoster=1&notip=1"></iframe></div>
