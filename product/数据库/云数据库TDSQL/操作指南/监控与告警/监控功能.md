...
|耗时(1ms- 5ms)请求数（DML Latency 1ms- 5ms）|次/秒|SQL语句执行时间的综合统计。|
|耗时(5ms - 20ms)请求数（DML Latency 5ms - 20ms）|次/秒|SQL语句执行时间的综合统计。|
|耗时(20ms - 30ms)请求数（DML Latency 20ms - 30ms）|次/秒|SQL语句执行时间的综合统计。|
