...
>?性能趋势目前支持云数据库 MySQL（不含单节点 - 基础型）、云原生数据库 TDSQL-C（TDSQL-C for MySQL）、自建数据库 MySQL、云数据库Redis。
>
...
<td>Key信息</th><td>Key信息（总数、过期数、驱逐数）</td></tr>
<tr>
<td rowspan=2 >内存</td>
<td>内存使用量</td></tr>
<tr><td>内存使用率</td></tr>
