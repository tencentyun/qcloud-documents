...
![](https://main.qcloudimg.com/raw/400bed3d34b4c49fef2da371630d31dd.png)
- **从已有规则中选择**
为审计组中的实例直接选择已创建的审计规则，列表支持查看、修改及删除规则。
>!
>- 删除规则同时会从所有应用该规则的审计组中移除该规则。
>- 当规则已绑定其它审计组中的审计实例时，该规则不支持修改。
> 
![](https://main.qcloudimg.com/raw/f64892a97e51a5bc98ccffead02824ce.png)

## 添加内置规则
为审计组中的实例选择已有的内置规则，内置规则支持查看，不支持删除。
![](https://main.qcloudimg.com/raw/e36908cdce1b71b43b4f3c3c56d27b6c.png)
内置规则的规则级别及规则内容说明如下：
- **高危操作**
 - 风险级别：高。
