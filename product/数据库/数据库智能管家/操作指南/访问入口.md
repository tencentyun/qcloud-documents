...
## Redis 控制台
- 方式一：在 [Redis 实例列表](https://console.cloud.tencent.com/redis)，单击【一键诊断】，可跳转至 DBbrain 的实例概览页。
- 方式二：在 [Redis 控制台](https://console.cloud.tencent.com/redis) 左侧导航，单击【诊断优化】，可跳转至 DBbrain 的实例诊断优化页。
