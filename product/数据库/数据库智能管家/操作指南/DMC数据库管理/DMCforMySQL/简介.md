...
目前支持云数据库 MySQL 、云数据库 MariaDB 及云数据库 CynosDB（兼容 MySQL 版）。此外，DMC 还内嵌了 PhpMyAdmin（PMA）管理工具，以便用户对数据库进行快捷、高效的管理操作。

DMC 有如下两版控制台：
- [DMC 管理（旧版）](https://cloud.tencent.com/document/product/1130/40941)：提供库表级操作、实例会话管理、实时监控、InnoDB 锁等待功能。
- [DMC 管理（新版）](https://cloud.tencent.com/document/product/1130/43455)：提供库表级操作、实例会话管理、SQL 窗口功能。
