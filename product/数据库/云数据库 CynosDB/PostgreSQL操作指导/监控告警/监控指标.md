...
## 控制台监控
为方便用户查看和掌握实例的运行信息，TDSQL-C PostgreSQL 提供了丰富的性能监控项，用户可登录 [TDSQL-C PostgreSQL 控制台](https://console.cloud.tencent.com/cynosdb?dbType=POSTGRESQL) ，在对应实例详情页的【实例监控】页签查看。
...
| 内存使用率         | memory_usage_rate      | %    | 实例实际内存使用率，包括shard buffer与page cache |
