...
## 日志级别
PostgreSQL 数据库的日志可记录多种级别的信息，如 DEBUG5、DEBUG4、DEBUG3、DEBUG2、DEBUG1、INFO、NOTICE、WARNING、ERROR、 LOG、FATAL和PANIC，当前 TDSQL-C PostgreSQL版 默认记录的错误日志为 ERROR 级别以及之后的所有级别的日志。
