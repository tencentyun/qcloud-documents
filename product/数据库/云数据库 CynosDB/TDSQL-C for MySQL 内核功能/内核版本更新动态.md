本文为您介绍 TDSQL-C MySQL 版内核版本更新动态，如需升级，请参见 [升级内核小版本](https://cloud.tencent.com/document/product/1003/61541)，如需了解各个内核版本的发布时间，请参见 [内核版本发布时间](https://cloud.tencent.com/document/product/1003/61514#NHFBSJ)。
<dx-tabs>
