...
<td>2022-12-16</td>
<td><li><a href="" target="_blank">参数公式</a><li><a href="https://cloud.tencent.com/document/product/1003/62741" target="_blank">使用参数模板</a></td></tr>
<tr>
<td>TDSQL-C MySQL 版发布新版审计服务</td>
<td>TDSQL-C MySQL 版支持发布新版审计服务，支持全审计和规则审计，具备数据采集完整性、可靠性，数据防篡改，数据传输完整性，数据存储完整性等特性。</td>
<td>2022-12-15</td>
