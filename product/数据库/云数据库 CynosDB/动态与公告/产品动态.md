...
<tr>
<td>支持实例级独立 IP 地址</td>
<td>TDSQL-C MySQL 版支持为集群下读写实例或任一只读实例设置独立网络 IP 地址，可通过对应地址连接访问集群下的指定实例。</td>
<td>2023-03-13</td>
<td><a href="https://cloud.tencent.com/document/product/1003/79712" target="_blank">修改内网地址</a></td></tr>
</table>
