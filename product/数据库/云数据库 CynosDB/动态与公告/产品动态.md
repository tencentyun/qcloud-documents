...
<td>2022-06-30</td>
<td><a href="跳转到购买指南数据库审计计费说明" target="_blank">数据库审计计费说明</a></td></tr>
<tr>
<td>支持 SSL 加密</td>
...
<td><a href="跳转到操作指南修改日志保存时长" target="_blank">修改日志保存时长</a></td></tr>
<tr>
<td>MySQL 审计搜索优化</td>
<td>支持模糊搜索、支持多 SQL 类型同时作为条件进行过滤、搜索时间段解除24小时限制。</td>
<td><a href="跳转到操作指南的查看审计日志" target="_blank">查看审计日志</a></td></tr>
</tbody></table>
...
<td>2020-07</td>
<td><a href="链接到操作里开通数据库审计" target="_blank">开通数据库审计</a></td></tr>
</tbody></table>
