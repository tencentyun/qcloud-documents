...
| 资源类型                                                | 授权策略中的资源描述方法                                     |
| --------------------------------------------------- | ------------------------------------------------------------ |
| CynosDB [实例相关](https://cloud.tencent.com/document/product/213/10314#CVMCorrelation) |`qcs::cynosdb:$region::instance/*`    `qcs::cynosdb:$region:$account:instanceId/$instanceId` |
