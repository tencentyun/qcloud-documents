...
<dx-tabs>
::: 页签视图
1. 在 **[集群列表](https://console.cloud.tencent.com/cynosdb)** 页左侧单击集群，进入集群管理页。
2. 在集群管理页部署方式处，以及集群详情的架构里可以分别看到该集群的部署方式以及主备可用区。
![](https://qcloudimg.tencent-cloud.cn/raw/6135cbdfa72be29a8d4af064b5782450.png)
:::
::: 列表视图
