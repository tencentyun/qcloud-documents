...
分析型数据库TDSQL-A PostgreSQL版支持资源级授权，您可以指定子账号拥有特定资源的接口权限。
...
| ----------------------- | ------------------------ |---------------------------------------------------- |
| DescribeAccounts        | 查询云数据库实例账号     |  `qcs::tdapg:gz:uin/2113345772:instance/tdapg-i8edslnn` |
...
| ResetAccountPassword  | 重置云数据库账号密码   |  `qcs:: tdapg:gz:uin/2113345772:instance/tdapg-i8edslnn` |
