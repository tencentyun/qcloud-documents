...
NOTICE:  Replica identity is needed for shard table, please add to this table through "alter table" command.tdapg
CREATE TABLE
postgres=# 
```
...
## 插入数据
```
postgres=# insert into t_jsonb values(1,'{"col1":1,"col2":"tdapg"}');
INSERT 0 1
postgres=# insert into t_jsonb values(2,'{"col1":1,"col2":"tdapg","col3":"pgxz"}');
INSERT 0 1
...
```
postgres=# insert into t_jsonb values(3,'{"col1":1,"col2":"tdapg","col2":"pgxz"}');
INSERT 0 1
postgres=# select * from t_jsonb;
 id |                   f_jsonb                    
----+----------------------------------------------
...
### 更新原来的元素
```
postgres=# update t_jsonb set f_jsonb = f_jsonb || '{"col2":"tdapg"}'::jsonb where id=3;     
UPDATE 1
