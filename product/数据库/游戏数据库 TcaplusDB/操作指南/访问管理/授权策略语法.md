...
**resource**：各产品的具体资源详情，如集群为 cluster/19168929215 或者 cluster/\*；其中集群，表格组，表格是级联关系，下表描述了 TcaplusDB 能够使用的资源和对应的资源描述方法。
...
| 表格   | qcs::tcaplusdb:$region:$account:table/$tableId 或者<br>qcs::tcaplusdb:$region:$account:cluster/$clusterId/tablegroup/$tablegroupId/table/$tableId |
