...
请 [下载最新的 Tcaplus SDK 版本](https://cloud.tencent.com/document/product/596/31925)，选择对应的平台，例如 Windows、Linux 等。
...
TcaplusDB 支持的地区可在 [控制台](https://console.cloud.tencent.com/tcaplusdb/app) 查看。
