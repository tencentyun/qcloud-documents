...
1. 登录 DBS 控制台，在左侧导航选择**备份策略**，进入备份策略模板页面。
...
1. 登录 DBS 控制台，在左侧导航单击**备份策略**，进入备份策略模板页面。
...
3. 在弹出的对话框中单击**确定**。
   ...
   <img src="https://qcloudimg.tencent-cloud.cn/raw/37d67cc0bbca405b9f02095dab910da5.png" style="zoom:67%;" />
