...
## Step 3
In the "New Server Registry" dialog, enter name, CVM IP address, port number, user name and password. You can find the CVM IP address and port number from "Private Network Address" in the PGSQL instance management page.
