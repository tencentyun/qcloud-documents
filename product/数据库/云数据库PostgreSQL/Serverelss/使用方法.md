本文为您介绍通过云 API 创建 PostgreSQL for Serverless 实例，以及连接实例的具体操作。
...
- 如您需要销毁实例，可通过 [DeleteServerlessDBInstance](https://cloud.tencent.com/document/product/409/42761) 接口可销毁实例。
>!实例销毁后，数据无法恢复，请谨慎操作。
