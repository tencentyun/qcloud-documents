...
Select the instance(s) you want to initialize, click "Batch Initialize", enter admin username and password to complete initialization process for selected instances.
