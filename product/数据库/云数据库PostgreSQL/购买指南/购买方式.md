...
>
 ...
 - **数据库版本**：PostgreSQL 的不同数据库内核版本之间存在功能差异，详见：[10](https://www.postgresql.org/docs/10/static/index.html)、[11](https://www.postgresql.org/docs/11/index.html)、[12](https://www.postgresql.org/docs/12/release-12-4.html)、[13](https://www.postgresql.org/docs/13/index.html)、[14](https://www.postgresql.org/docs/14/index.html) 的官网介绍。
