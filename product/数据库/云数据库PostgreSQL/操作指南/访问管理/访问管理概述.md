...
## 解决方案
您可以通过子帐号实现不同的人管理不同的服务来规避以上的问题。默认情况下，子帐号没有使用PostgreSQL 的权利或者PostgreSQL 相关资源的权限。因此，我们就需要创建策略来允许子帐号使用他们所需要的资源或权限。
...
| 在策略中定义操作            | [PostgreSQL 的操作](https://cloud.tencent.com/document/product/596/42903#cz) |
| 在策略中定义资源            | [PostgreSQL 的资源路径](https://cloud.tencent.com/document/product/596/42903#zylj) |
| PostgreSQL 支持的资源级权限 | [PostgreSQL 支持的资源级权限](https://cloud.tencent.com/document/product/596/42904) |
