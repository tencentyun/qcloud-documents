...
```
2. 配置转发规则，如下示例是将26.xx.x.2:6379的访问转发至10.0.0.5:6379内网 Redis 实例。
>?本示例中，云服务器外网地址为26.xx.x.2:6379、内网地址为10.0.0.12，Redis 实例内网地址为10.0.0.5:6379。
>
```
...
4. 通过26.xx.xx.2:6379即可连接内网 Redis 实例。
