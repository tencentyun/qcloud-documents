...
腾讯云CKV 是基于腾讯在分布式缓存领域多年技术沉淀，打造的一款高可用、高可靠的 Redis 服务平台。社区版Redis引擎基于社区版Redis2.8版本打造，4.0版本即将上线，社区版提供原生的Redis体验，丰富的场景支持。社区版Redis支持灵活的部署架构：单机版、主从版、集群版，能够满足不同的业务场景。
