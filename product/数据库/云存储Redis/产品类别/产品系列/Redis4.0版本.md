### Redis4.0 简介
Redis4.0 版本是腾讯云 Redis 团队基于社区版 4.0 全新打造的一个版本，采用分布式架构，4.0 版本将提供最大的灵活性、可用性、高达 1000 万 QPS 的高性能，通过一个产品形态支持单机、主从、集群以及多副本集，支持垂直和水平扩容和缩容，做到最大的灵活性。Redis4.0 支持水平方向 3～128 分片的扩展，垂直方向支持 0～5 个副本集的扩展，扩容、缩容、迁移过程业务几乎无感知，做到最大的系统可用性。<br><br>
