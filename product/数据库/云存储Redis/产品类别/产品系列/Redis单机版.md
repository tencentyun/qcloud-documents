...
### Redis单机版简介
Redis单机版是针对特定场景的版本，采用单个数据库节点部署架构，兼容Redis 2.8版本的协议和命令，近期会推出兼容Redis 4.0的版本。与主从版本相比，它只包含一个节点，数据只有一份，**不提供数据持久化和备份**，适用于数据可靠性要求不高的纯缓存业务场景使用。
![](https://main.qcloudimg.com/raw/ebcd1b3ea26a4e7665811a9a148cd216.png)
