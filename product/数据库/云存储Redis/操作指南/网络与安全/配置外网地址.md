...
3. 外网访问开通后将受到安全组网络访问策略的控制，请在安全组入站规则中配置访问数据库的来源信息，并放通协议端口（需同时放开内外网端口，内网端口默认为6379）。具体操作，请参见 [Redis 安全组配置](https://cloud.tencent.com/document/product/239/30911)。
