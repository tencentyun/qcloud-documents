使用云数据库 Redis 过程中，可能碰到访问实例、维护实例、建立数据库和数据备份与恢复等相关问题。本文将为您介绍云数据库 Redis 实例以及相关产品使用过程中的常用操作。
...
- [备份数据](https://cloud.tencent.com/document/product/239/30821)
- [恢复数据](https://cloud.tencent.com/document/product/239/30902)

### 导入导出

- [导入数据](https://cloud.tencent.com/document/product/239/30906)
- [迁移数据](https://cloud.tencent.com/document/product/239/30907)
