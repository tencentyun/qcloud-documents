...
>?Redis 4.0及之前的版本支持在 [Redis 控制台](https://console.cloud.tencent.com/redis) 的**系统监控** > **监控指标**，查看 top key 分析，5.0及之后的版本仅支持在 [数据库智能管家 DBbrain](https://console.cloud.tencent.com/dbbrain/board) 进行 top key 分析，详情请参见 [大 Key 分析](https://cloud.tencent.com/document/product/1130/58864)。
>
