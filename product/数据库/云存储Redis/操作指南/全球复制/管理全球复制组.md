...
| API 接口 | 接口含义 | 
|---------|---------|
| [CreateReplicationGroup](https://cloud.tencent.com/document/product/239/68400) | 创建复制组接口 | 
| [DeleteReplicationInstance](https://cloud.tencent.com/document/api/239/68399) | 删除复制组成员 | 
| [AddReplicationInstance](https://cloud.tencent.com/document/api/239/68401) | 添加复制组成员 | 
| [DescribeReplicationGroup](https://cloud.tencent.com/document/api/239/71554) | 查询复制组 | 
| [ChangeMasterInstance](https://cloud.tencent.com/document/api/239/77862) | 复制组实例切主 | 
| [ChangeInstanceRole](https://cloud.tencent.com/document/api/239/77863) | 复制组实例更换角色 | 
