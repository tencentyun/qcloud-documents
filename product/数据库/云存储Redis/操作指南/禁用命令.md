...
云数据库 Redis 2.8 标准版、4.0标准版、4.0集群版支持配置`disable-command-list`参数来禁用部分命令，如果您的控制台不可见`disable-command-list`参数，可 [提交工单](https://console.cloud.tencent.com/workorder/category) 升级后台版本，版本升级会有链接闪断。
...
### 取消禁用命令
在【当前运行参数值】禁用列表中删除相应的命令即可取消命令禁用。
