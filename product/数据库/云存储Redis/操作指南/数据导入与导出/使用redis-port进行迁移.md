...
### 工具介绍
[redis-port下载（linux64位）](https://main.qcloudimg.com/raw/778e813f94a0e726936f7682919690d2/redis-port.tgz)
...
- 支持目标实例为Redis 2.8，3.0，3.2，4.0版本，以及云数据库的所有版本（包括Redis 2.8单机版、Redis 2.8主从版、Redis 4.0集群版、CKV 主从版、CKV集群版）；
