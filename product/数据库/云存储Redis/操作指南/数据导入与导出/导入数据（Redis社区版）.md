...
- 支持导入 RDB 文件至 Redis 2.8 主从版、4.0 集群版，支持导入 Redis 4.0 及以下版本的 RDB 文件。
...
## 前提条件
 - 使用工具前需先清空目标 CRS 实例，否则会出现`【ERROR】 restore error: ERR Target key name is busy. for key: xxx `报错。
