借助 [数据传输服务](https://cloud.tencent.com/document/product/571)（Data Transmission Service，DTS），以及 [redis-port](https://cloud.tencent.com/document/product/239/33786) 集合中的 Redis-sync、redis-dump 与 redis-restore 迁移工具，云数据库Redis 为您提供了多种数据迁移方案，可满足多种业务场景下 Redis 的数据迁移需求。 
