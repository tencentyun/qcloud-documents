...
>!开启副本只读功能，可能会导致数据读取不一致 (副本节点数据延后于主节点)，请先确认业务是否能允许数据不一致。

## 操作步骤
1. 登录 [云数据库 Redis 控制台](https://console.cloud.tencent.com/redis)， 在实例列表页，单击实例名称，进入实例管理页面。
2. 选择【数据库管理】>【账号管理】页，单击副本只读按钮，开启读写分离。
![](https://main.qcloudimg.com/raw/8496eac43f864a21c93816581ad5cdd5.png)
3. 在弹出的对话框，确认信息无误后，单击【确认】即可。
![](https://main.qcloudimg.com/raw/90c054551a76e0d839b89cf1c85437a7.png)
