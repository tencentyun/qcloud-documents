## 1 Service Limits of Cluster Instances
...
<p>Size limit of Key: 127 Byte; size limit of value data under a single key: 1,000,000 Byte.<br />
If there is no request for 30 minutes, CRS long connection will be automatically broken. Please make a reconnection attempt in business.<br />
&nbsp;</p>
...
### 1.5 Notes About Cluster Instance Transactions
...
## 2 Service Limits of Master/Slave Instances

### 2.1 Currently Unsupported Commands
