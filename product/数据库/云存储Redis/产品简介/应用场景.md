...
游戏场景中，可以将非角色数据，如积分排行榜，存储在 Redis 中进行快速访问，Redis 原生自带的 SortedSet 数据类型能帮助您开发玩家数据。
...
### 电商展示
电商展示中，可以将商品展示、购物推荐等数据存储在 Redis 中进行快速访问，同时在大型促销秒杀活动中，Redis 达10W级的 QPS 能轻松应对高并发访问。
