...
<table>  
 ...
 <td >0 - 5副本</td>  
  <td >支持</td>  
   <td >兼容 Redis2.8、Redis4.0 版本协议，2.8标准版支持0副本，适合纯缓存场景，超高性价比；4.0标准版支持容量和副本扩缩容，扩缩容平滑无闪断。<br>主从热备架构，数据实时同步，故障秒级切换。
   </td>  
 </tr>  
 <tr>  
  <tr>  
 ...
 <td >1 - 5副本</td>  
  <td >支持</td>  
   <td >兼容 Redis 4.0 版本协议，集群架构，支持3 - 128分片的扩展，最大支持 4TB 容量，性能可达到千万 QPS。<br>主从热备架构，数据实时同步，故障秒级切换。</td>  
 </tr>  
</table>  
