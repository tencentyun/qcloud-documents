### Redis4.0 集群版简介
Redis集群版是腾讯云 Redis 团队基于社区版 4.0 全新打造的一个版本，采用分布式架构，Redis 集群版本将提供最大的灵活性、可用性、高达 1000 万 QPS 的高性能，支持垂直和水平扩容和缩容，做到最大的灵活性。Redis 集群版支持水平方向 3～128 分片的扩展，垂直方向支持 1～5 个副本集的扩展，扩容、缩容、迁移过程业务几乎无感知，做到最大的系统可用性。<br><br>
