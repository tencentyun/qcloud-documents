...
| DMC 支持命令        | DMC（Database Management Console）是腾讯云的一款数据库管理工具，可便捷地访问实例、查看实例的关键指标信息、运行 Redis 命令等。具体信息，请参见 [DMC 支持命令](https://cloud.tencent.com/document/product/239/76290)。 |     
