...
<tr>
<td>支持系统默认模板</td>
<td>云数据库Redis已支持在控制台的参数模板页，提供系统默认模板功能，展示的架构版本包括2.8标准架构、4.0标准架构、4.0集群架构、5.0标准架构和5.0集群架构。</td>
<td>2021-11</td>
<td><a href="https://cloud.tencent.com/document/product/239/58210" target="">使用参数模板</td>
</tr>
<tr>
<td>支持开启外网地址</td>
