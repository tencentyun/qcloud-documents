...
![](https://main.qcloudimg.com/raw/66f301d87eb0a39b7d8aae8037f94cc7.png)
...
- 云服务器（CVM）采用私有网络（VPC），MySQL 采用基础网络。建议参考 [切换私有网络服务](https://cloud.tencent.com/document/product/213/20278) 或 [配置网络](https://cloud.tencent.com/document/product/239/30910) 更换网络。
- CVM 采用基础网络，Redis 采用 VPC。建议参考 [切换私有网络服务](https://cloud.tencent.com/document/product/213/20278) 或 [配置网络](https://cloud.tencent.com/document/product/239/30910) 更换网络。
- CVM 与 Redis 在同一地域内，但属于不同的 VPC 网络。建议参考 [切换私有网络服务](https://cloud.tencent.com/document/product/213/20278) 或 [配置网络](https://cloud.tencent.com/document/product/239/30910) 更换网络。
- CVM 与 Redis 不在同一地域内，属于不同的 VPC 网络。建议在两个 VPC 网络之间建立 [云联网](https://cloud.tencent.com/document/product/877) 链接。
- CVM 与 Redis 为不同账号，属于不同的 VPC 网络。建议在两个 VPC 网络之间建立 [云联网](https://cloud.tencent.com/document/product/877) 链接。
