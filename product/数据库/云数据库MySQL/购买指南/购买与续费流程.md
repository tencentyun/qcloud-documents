...
![][image-2]
2. 选择配置属性：       
	* 选择所需的计费模式，支持包年包月和按量计费两种模式。（按量计费购买前需要实名认证，详见 <a href="https://www.qcloud.com/document/product/378/3629">实名认证指引</a>）
	* 选择地域和可用区。地域说明请参见 <a href="https://www.qcloud.com/document/product/236/8458">地域和可用区</a>。
	* 选择网络环境，支持基础网络和私有网络。基础网络和私有网络的区别请参见 <a href="https://www.qcloud.com/document/product/213/5227">网络环境</a>。
	* 选择实例规格和所需的硬盘。
	* 选择数据复制方式。关于数据库实例复制方式的区别可参见 <a href="https://www.qcloud.com/document/product/236/7913">数据库实例复制</a>。
...
## 计费流程
包年包月是一种预付费的计费模式，详情请参见 <a href="https://www.qcloud.com/document/product/555/9618" target"_blank">预付费计费说明</a>。  
按量计费是一种后付费的计费模式，详情请参见 <a href="https://www.qcloud.com/document/product/555/9617" target"_blank">按量计费说明</a>。  
计费流程请参见 <a href="https://www.qcloud.com/document/product/555/7437" target"_blank">计费流程说明</a>。
