...
<tr>
<td>产品架构（名称）升级</td>
<td>云数据库 MySQL 产品架构升级为单节点（原基础版）、双节点（原高可用版）以及三节点（原金融版），增加隔离策略为基础型、通用型和独享型（敬请期待），各架构功能均保持不变。</td>
<td>2021-03</td>
<td><a href="https://cloud.tencent.com/document/product/236/47905" target="_blank">架构概述</a></td></tr>
</tbody></table>
