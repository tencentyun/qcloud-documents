## 1. 控制台迁移数据
1. 通过云数据库控制台下载备份文件。（详见：<a href="https://www.qcloud.com/document/product/236/7274" target="_blank">下载备份文件<a/>）
...
更多字符集编码问题，请参考 <a href="https://www.qcloud.com/document/product/236/7259#document_charset_6" target="_blank">使用限制</a>，字符集说明。
