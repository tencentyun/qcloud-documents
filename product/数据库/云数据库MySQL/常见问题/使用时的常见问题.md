...
## 4 使用云数据库的注意事项？
详见：[云数据库操作限制](/document/product/236/7269#7-操作限制 )
...
## 22 云数据库的连接数有限制吗？
详见：[云数据库链接数限制](/document/product/236/7269#2-连接数限制)

## 23 云数据库的binlog保存时间是多久？

详见：[云数据库的binlog保存时间说明](/document/product/236/7269#5-云数据库的binlog保存时间说明 )
...
国内地域的云数据库外网访问已正式发布，使用方式请参考：[外网访问](/document/product/236/7264)
