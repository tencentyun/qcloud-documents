...
1. 在**日志 AAS 分析**下单击**创建分析任务**，选择时间段，单击**确定**。
2. 在任务列表单击**查看 SQL 分析**，进入 SQL 分析页。
3. 在 SQL 分析页，可选择 SQL Type、Host、User、SQL Code 等维度的视图，并可选择时间段拉伸视图来查看具体时间点的数据。
![](https://qcloudimg.tencent-cloud.cn/raw/107471ea42d259345a377f4bf5cc3f3e.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/b18d6e0210df0c62061b5fb24012771c.png)
...
- 单击**定期报告**，可配置自动生成健康报告的时间周期。 
![](https://qcloudimg.tencent-cloud.cn/raw/df2c75612a454d67b92cfe579a6acbb3.png)
