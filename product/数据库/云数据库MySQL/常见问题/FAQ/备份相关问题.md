...
### 3. MySQL 怎么设置备份方式？
在实例列表页，单击实例，进入【备份管理】，再点击【自动备份设置】，即可进行设置备份方式。
