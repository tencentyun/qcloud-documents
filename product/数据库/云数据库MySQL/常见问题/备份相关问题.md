...
由于 MySQL binlog 会占用大量的存储空间，所以云数据库只保存最近5天的 binlog。另外，如果 binlog 数据量增加太快，服务器磁盘存储不下5天的 binlog，需要人工删除 binlog，释放空间，请参见 <a href="https://cloud.tencent.com/document/product/236/7259" target="_blank">云数据库的 binlog 保存时间说明</a>。
