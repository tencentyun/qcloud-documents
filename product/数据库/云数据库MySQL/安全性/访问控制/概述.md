...
>**注意事项**
> 
> - **目前CDB接入CAM权限体系处于灰度阶段，处于灰度地域内的CDB用户可尝鲜CAM。灰度地域有：首尔。**
> - **强烈建议**用户使用CAM策略来管理CDB资源和授权CDB操作，对于存量分项目权限的用户体验不变，但不建议再继续使用分项目权限来管理资源与授权操作。
> - CDB暂时不支持相关生效条件设置

| 任务 | 链接 | 
|:---------|:---------|
|了解策略基本结构|[策略语法](https://cloud.tencent.com/document/product/236/14466?!preview&lang=cn/#celueyufa)|
|在策略中定义操作| [CDB的操作](https://cloud.tencent.com/document/product/236/14466?!preview&lang=cn/#caozuo) | 
|在策略中定义资源|[CDB的资源路径](https://cloud.tencent.com/document/product/236/14466?!preview&lang=cn/#ziyuanlujing)|
|CDB支持的资源级权限|[CDB支持的资源级权限](https://cloud.tencent.com/document/product/236/14467?!preview&lang=cn)|
|控制台示例|[控制台示例](https://cloud.tencent.com/document/product/236/14468?!preview&lang=cn )|