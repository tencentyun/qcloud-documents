...
查看各规格对应的 [QPS 官方压测数据](https://cloud.tencent.com/document/product/236/8842#.3Ca-id.3D.22cscs.22.3E.E6.B5.8B.E8.AF.95.E5.8F.82.E6.95.B0.3C.2Fa.3E)，与当前实例的 QPS 数据进行比较，调整对应的 [MySQL CPU 和内存规格](https://cloud.tencent.com/document/product/236/19707)。
