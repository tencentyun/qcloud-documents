## 游戏应用典型场景
游戏等需要弹性扩容和快速回档的业务。
CDB for MySQL 对计算资源的弹性伸缩能力，赋予您更高的生产力，分钟级部署游戏分区数据库。借助 CDB 任意时间点回档功能及支持批量操作的特性，您可以随时随地恢复到任意时间点，为游戏回档提供支持。
...
## 电商场景
稳定应对高并发流量，轻松迎接突发业务高峰，云数据库 CDB for MySQL 高性能特性以及 Redis 快速读写能力帮您在活动大促时解决访问高峰带来的请求压力。
