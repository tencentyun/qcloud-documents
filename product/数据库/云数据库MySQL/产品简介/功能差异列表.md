...
| [只读实例](https://cloud.tencent.com/document/product/236/7270)    | 支持（仅 MySQL 5.6、5.7）| 支持|支持   |- | 
| [灾备实例](https://cloud.tencent.com/document/product/236/7272)    | 支持（仅 MySQL 5.6、5.7）| 支持|-      |-  | 
