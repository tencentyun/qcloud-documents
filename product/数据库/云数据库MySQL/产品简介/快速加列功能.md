...
- 内核小版本：20190830及以上
>?新购实例默认为最新内核版本，查看内核版本可参见 [查看内核小版本](https://cloud.tencent.com/document/product/236/42538)，内核版本更新情况可参见 [内核版本更新动态](https://cloud.tencent.com/document/product/236/42539)。
