云数据库 MySQL 目前支持以下版本：MySQL 5.7 / MySQL 5.6 / MySQL 5.5，各个版本相关特性，请查看[官方文档]()。以下是 MySQL 官方服务生命周期支持策略：
...
> **特别注意**
> MySQL 5.5 官方延长服务截止至2018年12月，过期后没有明确的服务支持说明，可能问题修复周期很长，强烈建议您使用更高版本的MySQL。
> MySQL 5.6 及其以上版本不再支持 MyISAM 存储引擎，建议您使用性能更好、更稳定的InnoDB引擎。
> 目前仅MySQL 5.6 版本支持三种复制方式：异步、半同步、强同步；其余版本还仅支持异步方式。