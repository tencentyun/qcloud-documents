您可以通过 [MySQL控制台](https://console.cloud.tencent.com/cdb) 或 [API](https://cloud.tencent.com/document/product/236/15860) 修改参数，通常会涉及到如何配置参数的取值问题。对于某些重要参数，不恰当的参数取值会导致实例性能问题，本文将介绍一些重要参数的优化建议，以指导您更好地配置参数。
