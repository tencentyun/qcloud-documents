数据库实例规则页面展示支持配置规则的实例、基本信息、已选规则、及提供对实例规则的配置操作入口。
...
#### 数据库实例规则页面详情
 - 规则页面默认显示已配置规则和未配置规则的实例，不显示不支持配置规则的实例，可勾选【查看未配规则的实例】和【显示不支持的实例】，对实例进行筛选。
...
![](https://main.qcloudimg.com/raw/8226a46820a7c908bd1655592174e549.png)
 ...
 - 列表展示实例的基本信息、规则配置操作入口，包含实例 ID /名称、内网地址、已选规则及操作，其中操作包含[【添加规则】](https://cloud.tencent.com/document/product/1130/48518)、[【重选规则】和【解绑规则】](https://cloud.tencent.com/document/product/1130/48520)，可进行数据库实例敏感数据发现规则的配置。
