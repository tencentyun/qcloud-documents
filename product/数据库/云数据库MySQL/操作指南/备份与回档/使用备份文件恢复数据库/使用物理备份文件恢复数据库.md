...
## 前提条件
- 下载并安装 XtraBackup 工具，下载地址请参见 [Percona XtraBackup 官网](https://www.percona.com/downloads/Percona-XtraBackup-2.4/LATEST/)。
 - MySQL 5.6、5.7 请选择 Percona XtraBackup 2.4.6 及以上的版本，安装介绍请参见  [Percona XtraBackup 2.4](https://www.percona.com/doc/percona-xtrabackup/2.4/installation.html?spm=a2c4g.11186623.2.14.4d8653a6QmHkgI)。
 - MySQL 8.0 请选择 Percona XtraBackup 8.0.22-15 及以上版本，安装介绍请参见 [Percona XtraBackup 8.0](https://www.percona.com/downloads/Percona-XtraBackup-LATEST/#)。
