...
```
 - 通过二进制包安装
通过 [xtrabackup-download](https://www.percona.com/downloads/XtraBackup/LATEST/)  下载相应操作系统版本的 xtrabackup 二进制包。
