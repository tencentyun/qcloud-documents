...
![](https://qcloudimg.tencent-cloud.cn/raw/4e7d3bdacd99d7c60be4c9eced373ec2.png)
...
3. 在选择服务和操作页面，选择各项配置，单击**下一步**。
 ...
 - 资源(Resource)：请参见 [资源描述方式](https://cloud.tencent.com/document/product/598/10606)，选择全部资源，表示可以操作所有 MySQL 实例的审计日志。
 - 条件(Condition)：选填，设置上述授权的生效条件。
![](https://qcloudimg.tencent-cloud.cn/raw/d4c40c941ed990675e361769efd68a51.png)
4. 在**关联用户/用户组/角色**页面，按命名规范，输入“策略名称”（例如 SQLAuditFullAccess）和“描述”后，单击**完成**。
![](https://qcloudimg.tencent-cloud.cn/raw/150a7fb30d39a0303ce1b0183318c93d.png)
