...
<td>2022-2</td>
<td><a href="链接到连接池简介" target="_blank">连接池简介</a></td></tr>
<tr>
<tr>
<td>数据库代理功能优化和更新</td>
<td>云数据库 MySQL 数据库代理功能优化和更新，支持升级代理内核小版本、转网功能、自助配置调整，性能更加卓越和便捷。</td>
<td>2022-2</td>
<td><a href="链接到升级数据库代理内核小版本" target="_blank">升级代理内核小版本</a><br
><a href="链接到数据库代理的更换网络" target="_blank">更换网络</a><br
><a href="链接到调整数据库代理配置" target="_blank">调整配置</a></td></tr>
<tr>
</tbody></table>
