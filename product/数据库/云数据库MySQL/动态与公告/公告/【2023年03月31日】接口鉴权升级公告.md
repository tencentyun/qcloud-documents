尊敬的腾讯云用户，根据腾讯云安全防范要求，2023年03月31日，腾讯云将对云数据库 MySQL 直连 API 接口增加 CAM 鉴权访问，为保证升级后您可以正常使用对应接口，请在2023年03月31日前登录腾讯云 [访问管理控制台](https://console.cloud.tencent.com/cam/policy) 添加对应接口的授权访问。
