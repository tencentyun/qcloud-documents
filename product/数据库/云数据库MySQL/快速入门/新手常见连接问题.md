在连接 MySQL 实例，如果遇到无法连接实例的问题 ，那如何解决呢？本文为您介绍常见的无法连接场景，及对应解决方案。
...
| 常见原因 | 具体原因 | 解决方案 | 
|---------|---------|---------|
| 网络问题 | CVM 采用私有网络（VPC），MySQL 采用基础网络 |推荐将 MySQL 从基础网络切换为 VPC 网络 |
...
### 网络类型问题
若云服务器（CVM）和 MySQL 的网络类型不一致，则 CVM 无法直接通过内网连接 MySQL。
