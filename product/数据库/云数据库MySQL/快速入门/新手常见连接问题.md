...
现象3：从数据库管理 DMC 平台连接登录云数据库MySQL，连接失败。
...
### 现象3解决思路
- 确认登录帐号的主机限制中，已对该地域 DMC 服务器的全部 IP 授权，授权请参见 [修改授权访问的主机地址](https://cloud.tencent.com/document/product/236/35796)。您也可以直接使用%，放通所有 IP，仅由安全组来限制数据库访问来源。
...
#### [CVM 与 MySQL 均为 VPC，但地域不同](id:cmvbt)
