...
The data synchronization feature offered by DTS implements real-time data synchronization between two CDB instances and is applicable to scenarios such as remote disaster recovery. Now, data synchronization is only supported for CDB for MySQL instances.
- Data Subscription
