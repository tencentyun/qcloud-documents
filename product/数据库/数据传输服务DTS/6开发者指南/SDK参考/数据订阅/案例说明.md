本文将一个简单案例来说明数据订阅中拉取对应表到本地文件的功能，并且提供简易 [Demo下载](https://main.qcloudimg.com/raw/f145138da95d16063a3219f030f24625/LocalDemo.zip) 。以下操作将在 Centos 操作系统中完成。
### 配置环境
1. Java环境配置
```
 yum install ava-1.8.0-openjdk-devel 
```
...
### 选择数据订阅
1. 登录 [数据传输DTS控制台](https://console.qcloud.com/dtsnew/migrate/page)，选择左侧的 **数据订阅**，进入数据订阅页面。
