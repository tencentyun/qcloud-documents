...
<table >
<tr><th width="25%">适用场景</th><th width="15%">接入类型</th><th width="60%">操作指引</th></tr>
<tr>
...
<td>专线接入/VPN接入</td>
<td><li><a href="补充连接">配置 VPN 与 IDC 之间的互通</a>。</li>
<li>添加 DTS 服务器的 SNAT IP 地址到自建库的白名单中（通常为自建数据库的防火墙），使源数据库与 DTS 迁移实例可以连通。</li></td></tr>
<tr>
<td>云联网</td>
<td><li><a href="补充连接">配置通过云联网实现 VPC 和 IDC 之间的互通</a>。</li>
