...
<li>数据同步支持 DML 过滤支持的链接增加，新增 MariaDB/Percona/TDSQL-C MySQL 同步链路。</li>
<li>Where 条件过滤支持的链路增加，新增 MariaDB/Percona/TDSQL-C MySQL 同步链路。</li><li>TDSQL-C MySQL 之间的同步任务，支持 DML 非必选。</li>
</td>
<td>2022-04</td>
<td>-</td></tr><tr>
<td>支持跳过校验项内容</td>
