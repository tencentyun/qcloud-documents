...
<tr>
<td>迁移、同步计费功能增强</td>
<td><li>迁移、同步的按量计费任务支持销毁后恢复。</li><li>数据同步支持在任务结束或失败后进行重置。</li><li>数据同步支持按量计费转包年包月。</li></td>
<td>2022-04</td>
<td><a href="https://cloud.tencent.com/document/product/571/71332" target="_blank">任务状态说明</a></td></tr>
<tr>
<td>支持跳过校验项内容</td>
