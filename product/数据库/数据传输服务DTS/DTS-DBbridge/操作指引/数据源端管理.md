...
- 源端管理首页按不同的数据库类型，以及具体支持数据库来进行统计展示全局的面貌。
 ![](http://faguo.027cgb.com/632590/DTS-DBbridge/DataSource/pic1.png)
...
- 单个删除和批量删除 Oracle 源端时，需在弹出窗进行二次确认。
 ![](http://faguo.027cgb.com/632590/DTS-DBbridge/DataSource/pic2.png)
...
![](http://faguo.027cgb.com/632590/DTS-DBbridge/DataSource/pic3.png)
...
![](http://faguo.027cgb.com/632590/DTS-DBbridge/DataSource/pic4.png)
3. 测试连接成功后，单击【修改】。

## TDSQL 源端管理
TDSQL在创建数据源端时支持选择集群类型，其他基本功能与 Oracle 一致。
![](http://faguo.027cgb.com/632590/DTS-DBbridge/DataSource/pic5.png)

## TBase 源端管理
TBase在创建数据源端时支持录入Kafka集群信息，其他基本功能与 Oracle 一致。
![](http://faguo.027cgb.com/632590/DTS-DBbridge/DataSource/pic6.png)
