...
- [基本匹配](#.E5.9F.BA.E6.9C.AC.E5.8C.B9.E9.85.8D)
- [元字符](#.E5.85.83.E5.AD.97.E7.AC.A6)
  - [英文句号](#.E8.8B.B1.E6.96.87.E5.8F.A5.E5.8F.B7)
  - [字符集](#.E5.AD.97.E7.AC.A6.E9.9B.86)
     - [否定字符集](#.E5.90.A6.E5.AE.9A.E5.AD.97.E7.AC.A6.E9.9B.86)
  - [重复](#.E9.87.8D.E5.A4.8D)
     - [星号](#.E6.98.9F.E5.8F.B7)
     - [加号](#.E5.8A.A0.E5.8F.B7)
     - [问号](#.E9.97.AE.E5.8F.B7)
  - [花括号](#.E8.8A.B1.E6.8B.AC.E5.8F.B7)
  - [字符组](#.E5.AD.97.E7.AC.A6.E7.BB.84)
  - [分支结构](#.E5.88.86.E6.94.AF.E7.BB.93.E6.9E.84)
  - [转义特殊字符](#.E8.BD.AC.E4.B9.89.E7.89.B9.E6.AE.8A.E5.AD.97.E7.AC.A6)
  - [定位符](#.E5.AE.9A.E4.BD.8D.E7.AC.A6)
     - [插入符号](#.E5.85.A5.E7.AC.A6.E5.8F.B7)
     - [美元符号](#.E7.BE.8E.E5.85.83.E7.AC.A6.E5.8F.B7)
- [简写字符集](#.E7.AE.80.E5.86.99.E5.AD.97.E7.AC.A6.E9.9B.86)
- [断言](#.E6.96.AD.E8.A8.80)
  - [正向先行断言](#.E6.AD.A3.E5.90.91.E5.85.88.E8.A1.8C.E6.96.AD.E8.A8.80)
  - [负向先行断言](#.E8.B4.9F.E5.90.91.E5.85.88.E8.A1.8C.E6.96.AD.E8.A8.80)
  - [正向后行断言](#.E6.AD.A3.E5.90.91.E5.90.8E.E8.A1.8C.E6.96.AD.E8.A8.80)
  - [负向后行断言](#.E8.B4.9F.E5.90.91.E5.90.8E.E8.A1.8C.E6.96.AD.E8.A8.80)
- [标记](#.E6.A0.87.E8.AE.B0)
  - [不区分大小写](#.E4.B8.8D.E5.8C.BA.E5.88.86.E5.A4.A7.E5.B0.8F.E5.86.99)
  - [全局搜索](#.E5.85.A8.E5.B1.80.E6.90.9C.E7.B4.A2)
  - [多行匹配](#.E5.A4.9A.E8.A1.8C.E5.8C.B9.E9.85.8D)
- [常用正则表达式](#.E5.B8.B8.E7.94.A8.E6.AD.A3.E5.88.99.E8.A1.A8.E8.BE.BE.E5.BC.8F)
...
|&#92;|转义符，它可以还原元字符原来的含义，允许您匹配保留字符 <code>[ ] ( ) { } . * + ? ^ $ \ &#124;</code>|
|^|匹配行的开始|
|$|匹配行的结束|
...
<table>
	<tbody>
		<tr>
			...
			<td><center>
				<span style="font-size:14px;">表达式</span><br>
			</td>
		</tr>	 
		<tr>
			<td><center>
				<span style="font-size:14px;">正整数</span><br>
			</td>		
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">负整数</span><br>
			</td>		
			<td>
				<span style="font-size:14px;">^-\d+$</span><br>
			</td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">电话号码</span><br>
			</td>			
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">电话代码</span><br>
			</td>		
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">整数</span><br>
		</td> 	
			<td>
				<span style="font-size:14px;">^-?\d+$</span><br>
			</td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">字母数字字符</span><br>
			</td>		
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">带空格的字母数字字符</span><br>
			</td>	
			<td>
				<span style="font-size:14px;">^[a-zA-Z0-9 ]*$</span><br>
			</td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">密码</span><br>
			</td>	
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">电子邮件</span><br>
			</td>		
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">IPv4 地址</span><br>
			</td>	
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">小写字母</span><br>
			</td>	
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">大写字母</span><br>
			</td>
			<td>
				<span style="font-size:14px;">^([A-Z])*$</span><br>
			</td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">网址</span><br>
			</td>			
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">VISA 信用卡号码</span><br>
			</td>
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">日期 <br>(MM/DD/YYYY)</span><br>
			</td>	
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">日期<br> (YYYY/MM/DD)</span><br>
			</td>		
			<td>
		...
		<tr>
			<td><center>
				<span style="font-size:14px;">万事达信用卡号码</span><br>
			</td>	
			<td>
