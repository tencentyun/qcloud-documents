...
| [MySQL > MariaDB](https://cloud.tencent.com/document/product/571/71742) | 入云 | <li>自建 MySQL 5.5、5.6、5.7、8.0<li>云数据库 MySQL 5.5、5.6、5.7、8.0 | 云数据库 MariaDB 5.7、8.0、10.0、10.1 | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [MariaDB > MariaDB](https://cloud.tencent.com/document/product/571/71742)                                | 入云         | <li>自建 MariaDB 5.7、8.0、10.0、10.1<li>云数据库 MariaDB 5.7、8.0、10.0、10.1 | 云数据库 MariaDB 5.7、8.0、10.0、10.1                    | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [Percona > MariaDB](https://cloud.tencent.com/document/product/571/71742)                                | 入云         | 自建 Percona 5.5、5.6、5.7、8.0                              | 云数据库 MariaDB 5.7、8.0、10.0、10.1                    | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
...
| [MariaDB > TDSQL-C MySQL](https://cloud.tencent.com/document/product/571/59970) | 入云 | <li>自建 MariaDB 5.7、8.0、10.0、10.1<li>云数据库 MariaDB 5.7、8.0、10.0、10.1 | 云原生数据库 TDSQL-C 5.7、8.0 | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [Percona > TDSQL-C MySQL](https://cloud.tencent.com/document/product/571/59970) | 入云         | 自建 Percona 5.5、5.6、5.7、8.0                              | 云原生数据库 TDSQL-C 5.7、8.0                            | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
...
| [MySQL > TDSQL MySQL（TDStrore）](https://cloud.tencent.com/document/product/571/71755) | 入云 | <li>自建 MySQL 5.6、5.7、8.0<li>云数据库 MySQL 5.6、5.7、8.0 | 云数据库 TDSQL  MySQL（TDStrore） | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [MariaDB > TDSQL MySQL（TDStrore）](https://cloud.tencent.com/document/product/571/71755) | 入云 | <li>自建 MariaDB 5.7、8.0、10.0、10.1</li><li>云数据库 MariaDB 5.7、8.0、10.0、10.1</li> | 云数据库 TDSQL  MySQL（TDStrore） | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [Percona > TDSQL MySQL（TDStrore）](https://cloud.tencent.com/document/product/571/71755) | 入云 | 自建 Percona 5.5、5.6、5.7、8.0 | 云数据库 TDSQL  MySQL（TDStrore） | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [TDSQL MySQL > TDSQL MySQL（TDStrore）](https://cloud.tencent.com/document/product/571/71755) | 入云 | 云数据库 TDSQL  MySQL 5.7、8.0、10.0、10.1 | 云数据库 TDSQL  MySQL（TDStrore） | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
...
| [TDSQL-C PostgreSQL >  PostgreSQL](https://cloud.tencent.com/document/product/571/59975) | 入云 | 云原生数据库 TDSQL-C PostgreSQL 10.17 | 云数据库 PostgreSQL 10、11、12、13 | <li>全量迁移<li>结构迁移<li>全量 + 增量迁移 |
