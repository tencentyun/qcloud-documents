...
| [MySQL > MariaDB](新增) | 入云 | <li>自建 MySQL 5.5、5.6、5.7、8.0<li>云数据库 MySQL 5.5、5.6、5.7、8.0 | 云数据库 MariaDB 5.7、8.0、10.0、10.1 | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [MariaDB > MariaDB](同上新增)                                | 入云         | <li>自建 MariaDB 5.7、8.0、10.0、10.1<li>云数据库 MariaDB 5.7、8.0、10.0、10.1 | 云数据库 MariaDB 5.7、8.0、10.0、10.1                    | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [Percona > MariaDB](同上新增)                                | 入云         | 自建 Percona 5.5、5.6、5.7、8.0                              | 云数据库 MariaDB 5.7、8.0、10.0、10.1                    | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
...
| [MySQL > TDSQL MySQL（TDStrore）](新增) |  | <li>自建 MySQL 5.6、5.7、8.0<li>云数据库 MySQL 5.6、5.7、8.0 | 云数据库 TDSQL  MySQL（TDStrore） | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [MariaDB > TDSQL MySQL（TDStrore）](新增) |  | <li>自建 MariaDB 5.7、8.0、10.0、10.1</li><li>云数据库 MariaDB 5.7、8.0、10.0、10.1</li> | 云数据库 TDSQL  MySQL（TDStrore） | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [Percona > TDSQL MySQL（TDStrore）](新增) |  | 自建 Percona 5.5、5.6、5.7、8.0 | 云数据库 TDSQL  MySQL（TDStrore） | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
| [TDSQL MySQL > TDSQL MySQL（TDStrore）](新增) |  | 云数据库 TDSQL  MySQL 5.7、8.0、10.0、10.1 | 云数据库 TDSQL  MySQL（TDStrore） | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
