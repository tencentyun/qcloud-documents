...
| [MySQL > TDSQL-C](https://cloud.tencent.com/document/product/571/58688) | 入云 | <ul><li>自建 MySQL 5.5、5.6、5.7、8.0<li>云数据库 MySQL 5.5、5.6、5.7、8.0<li>第三方云厂商<ul><li>阿里云 RDS 5.5、5.6、5.7、8.0<li>阿里云 PolarDB 5.6、5.7、8.0<li>AWS RDS MySQL 5.6、5.7、8.0<li>AWS Aurora MySQL 5.6、5.7 | 云原生数据库 TDSQL-C 5.7、8.0 | <li>结构迁移<li>全量迁移<li>全量 + 增量迁移 |
