...
![](https://main.qcloudimg.com/raw/359252c69a0d08f6f21d0fac81d837bf.png)
...
出错原因： 您当前创建迁移任务使用的是子账号/协作者，并且当前子账号没有 sts:AssumeRole 权限。
解决方法：
- 使用主账号来创建迁移任务。
- 请求当前主账号持有人，按照下面操作步骤为子账号授权，子账号授权角色请参见 [文档](https://cloud.tencent.com/document/product/598/19422)。
