...
- 待迁移源端阿里云 PolarDB MySQL 能够通过公网访问，需要将阿里云 PolarDB MySQL 的公开可用性设置为是，支持版本：MySQL 5.6、MySQL 5.7、MySQL 8.0。
- 需要您在源端实例中创建迁移帐号。
  - “整个实例”迁移，需要的帐号权限如下：
```
...
<tr>
<td>数据库版本	</td><td>选择 PolarDB 5.6、PolarDB 5.7 或 PolarDB 8.0。</td></tr>
<tr>
