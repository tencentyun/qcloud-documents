...
<td>支持 MariaDB/Percona 数据迁移到 TDSQL MySQL，同时支持 TDSQL MySQL 数据迁移到MySQL/TDSQL/MariaDB/Percona。</td>
<td>2021-10</td>
<td><a href="新增的文档链接" target="_blank">TDSQL MySQL 到 TDSQL MySQL 的迁移</a></td></tr>
    <tr>
<td>支持 TDSQL MySQL 数据同步</td>
<td>支持 TDSQL 与 MySQL/TDSQL/MariaDB/Percona 之间的单向同步和双向同步。</td>
<td>2021-10</td>
<td><a href="新增的文档链接" target="_blank">TDSQL MySQL 数据同步至 TDSQL MySQL</a></td></tr>
    <tr>
<td>支持 PostgreSQL 9.4、9.5、9.6版本的增量迁移</td>
<td>支持 PostgreSQL 9.4、9.5、9.6版本的增量迁移。</td>
<td>2021-10</td>
