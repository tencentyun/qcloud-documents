...
1. 登录 [双螺旋控制台](https://console.cloud.tencent.com/helix)，单击进入项目管理页面。
...
1. 进入[双螺旋控制台](https://console.cloud.tencent.com/helix)，选择左侧菜单【数据管理】>【私有文件】。
2. 进入私有文件页面，在项目下拉框中，选择刚才对应的项目，进入计划用于存放数据的文件夹。
3. 单击【上传文件】，弹出上传文件对话框，单击【选择文件】。
![上传文件对话框](https://main.qcloudimg.com/raw/4b7696c61aa9761a5fd015e7207bfe20.png)
4. 在对话框中选择要上传的本地原始数据文件，再单击【确认上传】将文件上传至云端。
