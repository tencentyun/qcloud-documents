...
1. 登录 [腾讯工蜂平台](https://git.cloud.tencent.com/) 后，在主界面上，单击右边的【 New project 】按钮 或者 单击右上角的创建项目图标。
