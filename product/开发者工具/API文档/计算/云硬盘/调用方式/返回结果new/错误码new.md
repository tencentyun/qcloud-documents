...
不同模块可能产生的错误情况是不一样的，与负载均衡模块相关的错误代码如下表。
**注意：1、此表中的“错误代码”指的是message的()中的错误码，而非code错误码！“错误描述”指的是message中的错误文字描述。
2、message在部分终端（例如浏览器），中文会显示成unicode编码，需要解码。**
