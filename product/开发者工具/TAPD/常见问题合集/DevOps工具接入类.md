...
不是的，TAPD DevOps 解决方案支持主流工具集成，你可以根据需要，将业务正在使用的工具接入 TAPD。目前仅持续集成工具必须接入方可使用，其它工具可以根据业务需要灵活决定是否启用。
...
不是的，每个 TAPD 项目可以关联多个 Jenkins，每个 Jenkins Job 也可以关联多个 TAPD 项目，你可以根据团队持续集成需要进行添加。
