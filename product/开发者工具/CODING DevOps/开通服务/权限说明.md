...
在使用腾讯云 CODING Devops 产品的过程中，为了能够调取相关云资源，会遇到需要进行服务授权的场景。在使用该产品的过程中主要涉`CODING_QCSRole`角色，本文档会展示此角色所包含的预设策略详情。
...
该策略与 预设策略 QcloudAccessForCODINGRole 同时授权，无需额外操作。
