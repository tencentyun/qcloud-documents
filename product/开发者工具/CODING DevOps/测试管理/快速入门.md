...
## 创建测试计划
测试计划由测试用例组成，分为迭代测试、发布测试、普通测试三种类型。它能够让测试人员清晰的看到目前测试进度，及时记录测试结果与相应的评级。详情请参考 [创建测试计划](https://cloud.tencent.com/document/product/1114/59730)
...
![](https://help-assets.codehub.cn/enterprise/20220114164142.png)
