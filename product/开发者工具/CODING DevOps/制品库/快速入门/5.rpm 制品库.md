...
![](https://main.qcloudimg.com/raw/653e442e93104003314af89fec37bb18.png)
输入登录密码后，将生成的代码复制至本地的 `/etc/yum.repos.d/rpm-go.repo` 文件中，如果没有该文件请新建。
![](https://main.qcloudimg.com/raw/0d40c1d350b8cf48fd174f2e88934767.png)
...
![](https://main.qcloudimg.com/raw/5cedc7f38607851fbedc54953445ff51.png)

## [拉取制品](id:pull)
运行页面指引上的命令，完成拉取操作。
![](https://main.qcloudimg.com/raw/284ce46aea9ab307b0db5a5a2ccdaaaf.png)

## [制品代理](id:proxy)
rpm 仓库已有默认代理地址，可以自定义配置其他地址。
![](https://main.qcloudimg.com/raw/70cd5e85feee180f26c0790ee77f08a8.png)
