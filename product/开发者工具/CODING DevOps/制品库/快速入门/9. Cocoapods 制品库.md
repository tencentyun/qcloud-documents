本文为您介绍如何使用 CODING 的 Cocoapods 制品库。
...
## [新建 Demo 项目](id:init)
本节对如何快速创建一个 Demo Cocoapods 制品提供指引。在任意目录执行创建命令，并根据命令行提示选择需要的示例模版：
```bash
...
![](https://main.qcloudimg.com/raw/50821c083c3949a9d32ae3e5adecf7d7.png)
复制命令至您的 `~/.netrc` 文件中。若没有该文件，运行 `vim ~/.netrc` 新建并粘贴内容。
![](https://main.qcloudimg.com/raw/d3c0f2994c2bcf1934091b31386ea315.png)

## 推送制品
按照页面指引执行命令。
![](https://main.qcloudimg.com/raw/7ce0dce571303efce2247869103cb611.png)
