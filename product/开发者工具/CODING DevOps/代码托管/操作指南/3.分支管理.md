...
3. 选择左侧菜单【代码仓库】>【分支】，进入分支页面。

## 分支

进入项目后，选择【代码仓库】>【分支】，在页面左上方可以输入分支名来筛选分支，单击右上方【新建代码分支】即可新建分支。

页面主体部分显示默认分支和分支列表。项目会有一个默认的 master 分支，在右侧保护分支设置中可以为项目设置多个保护分支。

分支列表会显示当前相比于默认分支提前或落后多少提交，右侧设有新建合并请求的快速入口。
![](https://main.qcloudimg.com/raw/6a144f11e99c34151c68e381420bc9e1.png)
...
![](https://main.qcloudimg.com/raw/253b7c969df99eaafdbcab4d1f11e023.png)

## 分支设置

### 设置默认分支

在分支页面的右上角单击【保护分支设置】，即可进入分支设置界面修改默认分支，仅项目管理员有权限作出变更修改。
![](https://main.qcloudimg.com/raw/604cfa5241243f3fd6e5ff3f0d6b6e8b.png)
...
![](https://main.qcloudimg.com/raw/b51f498a766ea937c8d9bbb682580243.png)

### 分支管理员

分支管理员为可选项。添加分支管理员后，所有合并请求需要分支管理员提前设置【允许合并】。分支管理员默认也受保护分支限制，需创建合并请求修改分支。若将其设置为【允许直接 Push】，分支管理员则可以直接修改分支。

进入分支中的保护分支设置，在弹窗中进行增减分支管理员，可以修改分支管理员的直接 Push 权限。
![](https://main.qcloudimg.com/raw/cef3c483ade99d1faec9fb5c7ea5afb1.png)
