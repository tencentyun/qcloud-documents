...
关于使用 Git 提交代码，请阅读代码托管[快速入门](https://cloud.tencent.com/document/product/1112/36433)文档 ，您也可以通过阅读 CODING 工程师参与翻译的[《Pro Git》](https://git-scm.com/book/zh/v2)进一步掌握 Git 这个强大的版本控制系统。
...
### Push 提示其他错误怎么办？
请参考[文档]((https://cloud.tencent.com/document/product/1112/36433))并确保您执行了正确的操作，如果仍然报错请发送邮件到我们的支持邮箱：**support@coding.net**，并提供我们以下信息，以便工程师为您解决问题：
- Git 报错信息。
- 执行 git --version 的结果。
