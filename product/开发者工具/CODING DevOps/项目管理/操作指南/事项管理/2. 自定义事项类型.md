...
事项类型是项目协同中的主体，例如需求与任务都可以被抽象为【事项类型】。你可以新增如【运维】事项类型、修改类型图标、定义其在项目中的 [属性](https://cloud.tencent.com/document/product/1113/58821) 与 [工作流](https://cloud.tencent.com/document/product/1113/58822)。事项类型依照场景分为团队全局类型与项目级类型，需先行定义全局事项类型，再在项目内应用生效。
