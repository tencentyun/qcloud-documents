...
-   CODING 将项目权限组统一集中在团队设置中心进行配置与管理，单个项目内不支持权限组配置。详情请参见 [配置项目权限方案](/docs/admin/permission/project.html)。
-   如需了解团队负责人或管理员如何从团队的视角集中管理项目成员，请参见 [团队管理员指南——管理项目成员](/docs/admin/member/members-project.html)。
...
>?用户组是人员容器，代表一类用户的集合，通常由团队负责人或管理员进行配置。详情请参见 [用户组](/docs/admin/permission/user-group.html)。
