...
![](https://main.qcloudimg.com/raw/e9f8757b686242a50dad58cc484ee1d9.png)
...
缺陷的变更与修改都会记录在活动日志中，可以通过【查看该版本】按时间查看所有历史版本。支持版本回溯，可以选择任意历史版本进行恢复，详情请参见 [版本管理](/docs/collaboration/customize/version-control.html)。
