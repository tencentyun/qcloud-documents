...
所有会议内容都可以在 CODING 中使用 Wiki 进行记录，CODING Wiki 是一个应交流需要，可随时进行“增删改”的知识库，可用于记录整个项目的来龙去脉，展示当前项目状态，让项目成员更好地进行文档书写及协作，方便团队复盘、查阅并进行知识沉淀。详情可查阅[《文档管理 - Wiki》](https://help.coding.net/docs/document/wiki.html)。
