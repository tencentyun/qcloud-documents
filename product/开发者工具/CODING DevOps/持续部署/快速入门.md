...
单击访问本示例使用的项目 [代码地址](https://wzw-test.coding.net/p/demo-for-cd/d/demo-for-cd/git)。

**CODING + Serverless 持续部署**

- [快速发布演示](https://wzw-test-generic.pkg.coding.net/demo-for-cd/cd-video/CODING-Serverless-Demo.mov)
- [配置过程说明](https://wzw-test-generic.pkg.coding.net/demo-for-cd/cd-video/CODING-Serverless-Config.mov)
- [代码仓库](https://wzw-test.coding.net/p/demo-for-serverless/d/demo-for-serverless/git)

**CODING + Kubernetes 持续部署**

- [快速发布演示](https://wzw-test-generic.pkg.coding.net/demo-for-cd/cd-video/CODING-Kubernetes-Demo.mov)
- [配置过程说明](https://wzw-test-generic.pkg.coding.net/demo-for-cd/cd-video/CODING-Kubernetes-Config.mp4)
- [代码仓库](https://wzw-test.coding.net/p/cd-show/d/cd-show/git)
