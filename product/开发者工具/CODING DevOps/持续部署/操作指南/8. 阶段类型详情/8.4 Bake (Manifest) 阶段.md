...
Bake（Manifest） 可以帮助您打包和部署应用，一般用于开发和部署频率高的应用。
>?如果只是一次性安装第三方包，不推荐使用 Bake（Manifest）。
...
如下图提供一个完整的 Bake(Manifest) 阶段配置示例：
![](https://qcloudimg.tencent-cloud.cn/raw/090d72ad5a7f2d5c98c8d39f08d44123.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/6c225038e9e56eace0e9ae1fb331ad89.png)
