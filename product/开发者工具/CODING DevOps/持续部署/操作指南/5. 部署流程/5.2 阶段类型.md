...
## 通用类型
编辑部署流程时可以为阶段选择阶段类型。
![](https://qcloudimg.tencent-cloud.cn/raw/ad6c3f96630fff2cd5681e742b729d43.png)
...
![](https://qcloudimg.tencent-cloud.cn/raw/838253df7b47c3c3e5008da31020e16e.png)
<!--#### 从集群中查找镜像
...
### 人工确认
在执行下一步之前等待人工确认。可以在人工确认阶段增加指引说明帮助确认人进行人工确认，或者添加输入选项让用户选择。这些输入选项可以决定下游阶段的执行行为。例如，可以使用预置条件检查来确保只有满足特定的条件时才执行相应的阶段。
...
![](https://qcloudimg.tencent-cloud.cn/raw/f3de48c81a1fc719ac40c0aef5ea7535.png)
