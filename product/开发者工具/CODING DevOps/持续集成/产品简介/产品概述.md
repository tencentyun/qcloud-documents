...
## 什么是 CODING 持续集成
CODING 持续集成是 [CODING DevOps](https://cloud.tencent.com/product/coding) 的子产品， 其全面兼容 Jenkins 的持续集成服务，支持 Java、Python、Node.js 等主流语言，并且支持 Docker 镜像构建，图形化编排，高配集群多 Job 并行构建全面提速您的构建任务。支持主流的 Git 代码仓库，包括 CODING 代码托管、GitHub、GitLab 等等。在构建依赖拉取方面，使用专用网络优化包括 Maven，NPM 等主流镜像源，保证拉取速度，进一步提升构建速度。
