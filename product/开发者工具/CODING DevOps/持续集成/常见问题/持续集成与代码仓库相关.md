...
![](https://help-assets.codehub.cn/enterprise/20220111160053.png)

### [检出代码时提示网络连接异常怎么办？](#connect-fail)

**问题描述：**使用持续集成检出代码时报错并提示连接异常。

**解决办法：**造成此问题的原因有可能是构建计划使用了关联仓库，而关联仓库的 OAuth 鉴权已过期。你可以参考[本文](/docs/repo/manage/sync-relate.html#modify)重新授权并关联外部仓库。
