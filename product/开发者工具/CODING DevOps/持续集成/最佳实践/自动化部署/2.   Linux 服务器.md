...
1.  在云计算（比如腾讯云）的网页控制台创建 SSH 密钥对，把私钥录入 CODING 凭据管理，把公钥加载到服务器。也可以使用命令手动创建，把私钥 `id_rsa` 录入 CODING 凭据管理，把公钥 `id_rsa.pub` 的内容复制到服务器的 `~/.ssh/authorized_keys`，详情请参见 [凭据管理](https://cloud.tencent.com/document/product/1113/48846)。
	- 腾讯云 创建 SSH 密钥对
	![腾讯云 创建 SSH 密钥对](https://main.qcloudimg.com/raw/66685bdab117dd7737ca2ac5ab0e3e7d.png)
	- 腾讯云 下载 SSH 私钥
	![腾讯云 下载 SSH 私钥](https://main.qcloudimg.com/raw/fb12cb58d961354360ece0d98beb21f0.png)
	- 腾讯云 服务器 绑定 SSH 公钥
	![腾讯云 服务器 绑定 SSH 公钥](https://main.qcloudimg.com/raw/d1a423e56353a272b9e98b40f736e285.png)
	- CODING 凭据管理 录入 SSH 私钥
	![CODING 凭据管理 录入 SSH 私钥](https://main.qcloudimg.com/raw/c767d31624d7db0269f8bfd240079e84.png)
