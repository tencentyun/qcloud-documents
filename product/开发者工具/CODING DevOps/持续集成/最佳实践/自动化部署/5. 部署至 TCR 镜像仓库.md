...
## [触发任务](id:trigger)
1. 配置完成后，触发持续集成任务即可自动构建制品并完成发布。你可以在构建过程中查询各项步骤的运行详情与完成情况。
...
>? 如果你希望通过手动方式直接推送制品至 TCR 镜像仓库，详情请参见[推送拉取镜像](https://cloud.tencent.com/document/product/1141/39287#.E6.AD.A5.E9.AA.A47.EF.BC.9A.E6.8E.A8.E9.80.81.E6.8B.89.E5.8F.96.E9.95.9C.E5.83.8F)。
