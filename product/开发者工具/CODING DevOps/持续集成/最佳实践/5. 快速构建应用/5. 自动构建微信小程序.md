...
作为一个前端开发，在开发微信小程序的时候，我们应该都遇到过这样的场景：
我们双手正在在键盘上飞舞，像写诗一样认真的编写每一行代码，脑海里想着解耦合、设计模式、抽象和分层的时候。突然之间，
产品经理轻轻拍了拍了您肩膀，假装满怀歉意的跟您说：“我需要一个最新测试环境的体验二维码“。
于是您端起了印着“和气生财”的马克杯，喝了口水，开始了一波操作。
```shell
1. git stash
...
搞定后，您活动了一下有些许酸疼的手指，切回分支恢复进度，脑海里努力得回忆着刚刚得思路。
这时，测试工程师突然又找您，他也想要一个测试环境的二维码，这时候您又看了看一眼您的马克杯，黯然神伤...
