...
3. 最终会在当前文件夹下面生成名为 `Java-android.p12` 的证书文件。使用 Android Studio 进行签名非常快捷，请参见 [《使用 Android Studio 对应用进行签名》](https://developer.android.com/studio/publish/app-signing?hl=zh-cn#sign-apk) 了解更多。
