本文为您介绍如何将 React 项目发布至腾讯云 COS 服务。
...
## 配置构建计划[](id:deploy-ci)
进入项目后，进入左侧菜单栏的**持续集成**功能，单击右上角的**创建构建计划**并选择 React + COS 模板。
...
1. CDN 服务常用于静态网站加速，能够提升网站的访问速度。单击前往 COS 存储桶中的**域名与传输管理** > **默认 CDN 加速域名**，开启默认 CDN 加速域名。
