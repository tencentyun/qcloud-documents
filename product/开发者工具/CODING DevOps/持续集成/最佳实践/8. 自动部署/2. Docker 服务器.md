...
<img style="width:600px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/43f93775fd11551735331c200bee2810.png" />

## 获取制品仓库信息
1. 按照提示一键获取 Docker 仓库的用户名与密码，并将其录入持续集成的环境变量中。
<img style="width:700px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/75e8e22a0d7c0215fcf47c077b106027.png" />
2. 在构建计划详情中的变量与缓存处填写。
<img style="width:700px; max-width: inherit;" src="https://qcloudimg.tencent-cloud.cn/raw/17fbbc714d6c60732b66975255a9cd05.png" />
    ...
    stage('部署') {
      steps {
        ...
        script {
          ...
          withCredentials([sshUserPrivateKey(credentialsId: "c4af855d-xxxx-xxxx-xxxx-xxxx6ae3441c", keyFileVariable: 'id_rsa')]) {
