...
![](https://help-assets.codehub.cn/enterprise/20200327142526.png)
...
![](https://help-assets.codehub.cn/enterprise/20200327143449.png)
...
----   |---------|-----------   |-------
Linux | amd64 | 64-bit | [点击下载](https://coding-public-generic.pkg.coding.net/cci/release/cci-agent/linux/amd64/cci-agent)
Linux | 386 | 32-bit | [点击下载](https://coding-public-generic.pkg.coding.net/cci/release/cci-agent/linux/386/cci-agent)
Linux | arm | 32-bit | [点击下载](https://coding-public-generic.pkg.coding.net/cci/release/cci-agent/linux/arm/cci-agent)
macOS | amd64 | 64-bit | [点击下载](https://coding-public-generic.pkg.coding.net/cci/release/cci-agent/darwin/amd64/cci-agent)
macOS | 386 | 32-bit | [点击下载](https://coding-public-generic.pkg.coding.net/cci/release/cci-agent/darwin/386/cci-agent)
Windows | amd64 | 64-bit | [点击下载](https://coding-public-generic.pkg.coding.net/cci/release/cci-agent/windows/amd64/cci-agent.exe)
Windows | 386 | 32-bit | [点击下载](https://coding-public-generic.pkg.coding.net/cci/release/cci-agent/windows/386/cci-agent.exe)
