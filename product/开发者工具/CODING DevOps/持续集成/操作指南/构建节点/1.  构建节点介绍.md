...
CODING 支持接入自定义的物理机 / 虚拟机 / 容器作为构建节点，您可以通过脚本或手动的方式接入节点。目前支持 [macOS](https://cloud.tencent.com/document/product/1115/47859)、[Windows](https://cloud.tencent.com/document/product/1115/47861)、[Linux](https://cloud.tencent.com/document/product/1115/47863) 环境接入自定义构建节点。
