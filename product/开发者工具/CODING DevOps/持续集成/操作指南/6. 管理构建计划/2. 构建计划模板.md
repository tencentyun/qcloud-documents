...
### 触发规则[](id:trigger)
支持代码源触发、定时触发及手动触发。与普通构建计划下的触发规则设置方式一致，具体说明请参考 [触发规则](https://cloud.tencent.com/document/product/1115/66287)。

### 变量与缓存[](id:variable)
您可以在此处添加构建计划的环境变量。在手动启动构建任务时，环境变量也将作为启动参数的默认值，具体配置说明请参考 [环境变量](https://cloud.tencent.com/document/product/1115/66288)。
