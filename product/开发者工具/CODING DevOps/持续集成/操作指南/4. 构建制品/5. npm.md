...
## 功能介绍
本文将给出如何使用持续集成任务构建 Npm 制品的示例 Jenkinsfile。构建完成后可以使用预置插件便捷的上传至 CODING 制品仓库中。在使用该功能之前，请确保您对  Npm 类型制品库有初步了解，详情请参见 [Npm](https://cloud.tencent.com/document/product/1116/46530)。
...
```
### 如何创建凭据?
请参见 [使用凭据进行认证](https://cloud.tencent.com/document/product/1113/48846)。
