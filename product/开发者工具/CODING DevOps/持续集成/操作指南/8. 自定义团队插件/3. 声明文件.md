...
>! 插件参数不等同于开发者自身脚本参数，虽然大部分情况下插件参数与执行参数相同。具体差别可以参考 [插件运行机制](https://cloud.tencent.com/document/product/1115/67817#mechanism-detail)。
...
关于插件如何运行可以单击 [了解详情](https://cloud.tencent.com/document/product/1115/67817#operating-mechanism)。
...
若想了解更多 status 信息, 请单击阅读 [状态上报](https://cloud.tencent.com/document/product/1115/67817#report-1)。
