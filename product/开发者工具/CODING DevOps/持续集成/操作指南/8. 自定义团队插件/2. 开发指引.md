...
## 插件上传[](id:upload)
单击团队首页右上角的齿轮图标 <img src ="https://help-assets.codehub.cn/enterprise/20210928153255.png" style ="margin:0"> 进入团队设置中心，在「功能设置」→「构建插件」中上传插件文件。

![](https://help-assets.codehub.cn/enterprise/20211014103947.png)本文为您介绍如何开发自定义团队插件。
...
<table>
   <tr>
      ...
      <th width="0px"  style="text-align:center">XXXXX</td>
      <th width="0px"  style="text-align:center">XXXXX</td>
   </tr>
   <tr>
      <td>`variabels`</td>
