...
## 基础使用[](id:basic)
团队首页右上角的齿轮图标 <img src ="https://qcloudimg.tencent-cloud.cn/raw/4cc36d442b9da7c5fbe69383fc8b00a1.png" style ="margin:0"> 进入团队设置中心，单击**功能设置** > **构建插件**，您可以在此处看到官方插件、团队插件与个人提交但未公开的插件。在插件详情中查看名称、描述与版本号。
...
![](https://qcloudimg.tencent-cloud.cn/raw/8cf9e1aa6e95df8e0c0552bed5873c71.png)
:::
::: 文本编辑器
