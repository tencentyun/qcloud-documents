...
获取密钥（ 密钥获取⽅式⻅下⽂） 后到 `tencentcloud-sdk-androidsoe/TAIDemo/app/src/main/java/com/tencent/taidemo/PrivateInfo.java` 根据需要填写 AppId、secretId、secretKey、soeAppId 和 hcmAppId（token 不需要填写）。
...
|sentenceInfoSet |List<TAIOralEvaluationWord>| 断句中间结果 |
