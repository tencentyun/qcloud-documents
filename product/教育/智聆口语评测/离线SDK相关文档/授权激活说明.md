...
### 2. 下载、修改、运行
- Android：集成步骤
 1. 添加 SDK 依赖：TAISDK 已经发布到 Maven Central 库，您可以通过配置 gradle 自动下载更新。
```
implementation 'com.tencent.edu:TAISDK-offline:1.0.1.74'
```
 2. 同步SDK：单击 Sync Now，如果您的网络连接 Maven Central 没有问题，SDK 会自动下载集成到工程里。
